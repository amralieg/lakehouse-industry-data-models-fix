...
-- Total cross-domain FK constraints: 1125
--
-- EXECUTION ORDER:
...
-- ========= beneficiary --> communication (6 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`beneficiary`.`needs_assessment` ADD CONSTRAINT `fk_beneficiary_needs_assessment_community_engagement_event_id` FOREIGN KEY (`community_engagement_event_id`) REFERENCES `vibe_ngo_v1`.`communication`.`community_engagement_event`(`community_engagement_event_id`);
...
ALTER TABLE `vibe_ngo_v1`.`beneficiary`.`entitlement` ADD CONSTRAINT `fk_beneficiary_entitlement_constituent_id` FOREIGN KEY (`constituent_id`) REFERENCES `vibe_ngo_v1`.`donor`.`constituent`(`constituent_id`);
...
ALTER TABLE `vibe_ngo_v1`.`beneficiary`.`end_user_verification` ADD CONSTRAINT `fk_beneficiary_end_user_verification_field_financial_service_provider_id` FOREIGN KEY (`field_financial_service_provider_id`) REFERENCES `vibe_ngo_v1`.`field`.`field_financial_service_provider`(`field_financial_service_provider_id`);
...
ALTER TABLE `vibe_ngo_v1`.`beneficiary`.`community_intervention` ADD CONSTRAINT `fk_beneficiary_community_intervention_community_partner_org_id` FOREIGN KEY (`community_partner_org_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`partner_org`(`partner_org_id`);
...
-- ========= beneficiary --> program (19 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`beneficiary`.`community_intervention` ADD CONSTRAINT `fk_beneficiary_community_intervention_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
ALTER TABLE `vibe_ngo_v1`.`beneficiary`.`needs_assessment` ADD CONSTRAINT `fk_beneficiary_needs_assessment_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
-- ========= communication --> compliance (7 constraint(s)) =========
...
-- ========= communication --> field (8 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`communication`.`plan` ADD CONSTRAINT `fk_communication_plan_country_office_id` FOREIGN KEY (`country_office_id`) REFERENCES `vibe_ngo_v1`.`field`.`country_office`(`country_office_id`);
...
-- ========= communication --> program (10 constraint(s)) =========
...
-- ========= communication --> technology (2 constraint(s)) =========
...
-- ========= communication --> workforce (13 constraint(s)) =========
...
-- ========= compliance --> field (4 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`compliance`.`statutory_registration` ADD CONSTRAINT `fk_compliance_statutory_registration_system_platform_id` FOREIGN KEY (`system_platform_id`) REFERENCES `vibe_ngo_v1`.`technology`.`system_platform`(`system_platform_id`);
...
-- ========= field --> beneficiary (10 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`field`.`field_distribution_line` ADD CONSTRAINT `fk_field_field_distribution_line_financial_service_provider_id` FOREIGN KEY (`financial_service_provider_id`) REFERENCES `vibe_ngo_v1`.`beneficiary`.`financial_service_provider`(`financial_service_provider_id`);
ALTER TABLE `vibe_ngo_v1`.`field`.`field_distribution_line` ADD CONSTRAINT `fk_field_field_distribution_line_registrant_id` FOREIGN KEY (`registrant_id`) REFERENCES `vibe_ngo_v1`.`beneficiary`.`registrant`(`registrant_id`);
...
ALTER TABLE `vibe_ngo_v1`.`field`.`country_office` ADD CONSTRAINT `fk_field_country_office_exchange_rate_id` FOREIGN KEY (`exchange_rate_id`) REFERENCES `vibe_ngo_v1`.`finance`.`exchange_rate`(`exchange_rate_id`);
...
ALTER TABLE `vibe_ngo_v1`.`field`.`country` ADD CONSTRAINT `fk_field_country_exchange_rate_id` FOREIGN KEY (`exchange_rate_id`) REFERENCES `vibe_ngo_v1`.`finance`.`exchange_rate`(`exchange_rate_id`);
ALTER TABLE `vibe_ngo_v1`.`field`.`distribution_line` ADD CONSTRAINT `fk_field_distribution_line_exchange_rate_id` FOREIGN KEY (`exchange_rate_id`) REFERENCES `vibe_ngo_v1`.`finance`.`exchange_rate`(`exchange_rate_id`);
ALTER TABLE `vibe_ngo_v1`.`field`.`distribution_line` ADD CONSTRAINT `fk_field_distribution_line_gl_account_id` FOREIGN KEY (`gl_account_id`) REFERENCES `vibe_ngo_v1`.`finance`.`gl_account`(`gl_account_id`);
...
ALTER TABLE `vibe_ngo_v1`.`field`.`wash_intervention` ADD CONSTRAINT `fk_field_wash_intervention_safeguarding_incident_id` FOREIGN KEY (`safeguarding_incident_id`) REFERENCES `vibe_ngo_v1`.`safeguarding`.`safeguarding_incident`(`safeguarding_incident_id`);
...
-- ========= field --> supply (6 constraint(s)) =========
-- Requires: field schema, supply schema
ALTER TABLE `vibe_ngo_v1`.`field`.`field_distribution_line` ADD CONSTRAINT `fk_field_field_distribution_line_commodity_id` FOREIGN KEY (`commodity_id`) REFERENCES `vibe_ngo_v1`.`supply`.`commodity`(`commodity_id`);
ALTER TABLE `vibe_ngo_v1`.`field`.`field_distribution_line` ADD CONSTRAINT `fk_field_field_distribution_line_warehouse_id` FOREIGN KEY (`warehouse_id`) REFERENCES `vibe_ngo_v1`.`supply`.`warehouse`(`warehouse_id`);
...
-- ========= field --> technology (7 constraint(s)) =========
...
-- ========= field --> workforce (12 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`field`.`assessment_participation` ADD CONSTRAINT `fk_field_assessment_participation_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
-- ========= finance --> partnership (2 constraint(s)) =========
-- Requires: finance schema, partnership schema
ALTER TABLE `vibe_ngo_v1`.`finance`.`finance_face_form` ADD CONSTRAINT `fk_finance_finance_face_form_micro_assessment_id` FOREIGN KEY (`micro_assessment_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`micro_assessment`(`micro_assessment_id`);
ALTER TABLE `vibe_ngo_v1`.`finance`.`finance_face_form` ADD CONSTRAINT `fk_finance_finance_face_form_partner_org_id` FOREIGN KEY (`partner_org_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`partner_org`(`partner_org_id`);
...
ALTER TABLE `vibe_ngo_v1`.`finance`.`finance_face_form` ADD CONSTRAINT `fk_finance_finance_face_form_intervention_id` FOREIGN KEY (`intervention_id`) REFERENCES `vibe_ngo_v1`.`program`.`intervention`(`intervention_id`);
...
-- ========= grant --> donor (8 constraint(s)) =========
-- Requires: grant schema, donor schema
ALTER TABLE `vibe_ngo_v1`.`grant`.`award` ADD CONSTRAINT `fk_grant_award_award_constituent_id` FOREIGN KEY (`award_constituent_id`) REFERENCES `vibe_ngo_v1`.`donor`.`constituent`(`constituent_id`);
...
ALTER TABLE `vibe_ngo_v1`.`grant`.`proposal` ADD CONSTRAINT `fk_grant_proposal_proposal_constituent_id` FOREIGN KEY (`proposal_constituent_id`) REFERENCES `vibe_ngo_v1`.`donor`.`constituent`(`constituent_id`);
...
ALTER TABLE `vibe_ngo_v1`.`grant`.`award_site_allocation` ADD CONSTRAINT `fk_grant_award_site_allocation_country_office_id` FOREIGN KEY (`country_office_id`) REFERENCES `vibe_ngo_v1`.`field`.`country_office`(`country_office_id`);
...
ALTER TABLE `vibe_ngo_v1`.`grant`.`award_site_allocation` ADD CONSTRAINT `fk_grant_award_site_allocation_intervention_id` FOREIGN KEY (`intervention_id`) REFERENCES `vibe_ngo_v1`.`program`.`intervention`(`intervention_id`);
...
ALTER TABLE `vibe_ngo_v1`.`grant`.`proposal` ADD CONSTRAINT `fk_grant_proposal_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
ALTER TABLE `vibe_ngo_v1`.`grant`.`award_site_allocation` ADD CONSTRAINT `fk_grant_award_site_allocation_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
-- ========= mel --> program (19 constraint(s)) =========
-- Requires: mel schema, program schema
ALTER TABLE `vibe_ngo_v1`.`mel`.`indicator` ADD CONSTRAINT `fk_mel_indicator_country_programme_document_id` FOREIGN KEY (`country_programme_document_id`) REFERENCES `vibe_ngo_v1`.`program`.`country_programme_document`(`country_programme_document_id`);
...
-- ========= partnership --> communication (5 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`partnership`.`agreement` ADD CONSTRAINT `fk_partnership_agreement_plan_id` FOREIGN KEY (`plan_id`) REFERENCES `vibe_ngo_v1`.`communication`.`plan`(`plan_id`);

-- ========= partnership --> compliance (10 constraint(s)) =========
...
-- ========= partnership --> field (1 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`partnership`.`spot_check` ADD CONSTRAINT `fk_partnership_spot_check_finance_face_form_id` FOREIGN KEY (`finance_face_form_id`) REFERENCES `vibe_ngo_v1`.`finance`.`finance_face_form`(`finance_face_form_id`);
ALTER TABLE `vibe_ngo_v1`.`partnership`.`agreement` ADD CONSTRAINT `fk_partnership_agreement_finance_fund_id` FOREIGN KEY (`finance_fund_id`) REFERENCES `vibe_ngo_v1`.`finance`.`finance_fund`(`finance_fund_id`);
...
ALTER TABLE `vibe_ngo_v1`.`partnership`.`programme_visit` ADD CONSTRAINT `fk_partnership_programme_visit_intervention_id` FOREIGN KEY (`intervention_id`) REFERENCES `vibe_ngo_v1`.`program`.`intervention`(`intervention_id`);
ALTER TABLE `vibe_ngo_v1`.`partnership`.`partnership_face_form` ADD CONSTRAINT `fk_partnership_partnership_face_form_intervention_id` FOREIGN KEY (`intervention_id`) REFERENCES `vibe_ngo_v1`.`program`.`intervention`(`intervention_id`);
...
-- ========= partnership --> safeguarding (3 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`partnership`.`agreement` ADD CONSTRAINT `fk_partnership_agreement_risk_assessment_id` FOREIGN KEY (`risk_assessment_id`) REFERENCES `vibe_ngo_v1`.`safeguarding`.`risk_assessment`(`risk_assessment_id`);

-- ========= partnership --> technology (8 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`partnership`.`agreement` ADD CONSTRAINT `fk_partnership_agreement_system_platform_id` FOREIGN KEY (`system_platform_id`) REFERENCES `vibe_ngo_v1`.`technology`.`system_platform`(`system_platform_id`);
...
-- ========= partnership --> workforce (18 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`partnership`.`programme_visit` ADD CONSTRAINT `fk_partnership_programme_visit_programme_staff_member_id` FOREIGN KEY (`programme_staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
ALTER TABLE `vibe_ngo_v1`.`partnership`.`spot_check` ADD CONSTRAINT `fk_partnership_spot_check_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
ALTER TABLE `vibe_ngo_v1`.`partnership`.`agreement` ADD CONSTRAINT `fk_partnership_agreement_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);

-- ========= program --> compliance (11 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`program`.`humanitarian_response_plan` ADD CONSTRAINT `fk_program_humanitarian_response_plan_emergency_id` FOREIGN KEY (`emergency_id`) REFERENCES `vibe_ngo_v1`.`field`.`emergency`(`emergency_id`);
...
ALTER TABLE `vibe_ngo_v1`.`program`.`program` ADD CONSTRAINT `fk_program_program_primary_staff_member_id` FOREIGN KEY (`primary_staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
-- ========= safeguarding --> beneficiary (2 constraint(s)) =========
...
-- ========= safeguarding --> field (6 constraint(s)) =========
-- Requires: safeguarding schema, field schema
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`safeguarding_incident` ADD CONSTRAINT `fk_safeguarding_safeguarding_incident_country_id` FOREIGN KEY (`country_id`) REFERENCES `vibe_ngo_v1`.`field`.`country`(`country_id`);
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`safeguarding_incident` ADD CONSTRAINT `fk_safeguarding_safeguarding_incident_project_site_id` FOREIGN KEY (`project_site_id`) REFERENCES `vibe_ngo_v1`.`field`.`project_site`(`project_site_id`);
...
-- ========= safeguarding --> grant (1 constraint(s)) =========
...
-- ========= safeguarding --> partnership (5 constraint(s)) =========
-- Requires: safeguarding schema, partnership schema
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`support_service_referral` ADD CONSTRAINT `fk_safeguarding_support_service_referral_partner_org_id` FOREIGN KEY (`partner_org_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`partner_org`(`partner_org_id`);
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`psea_network_membership` ADD CONSTRAINT `fk_safeguarding_psea_network_membership_partner_org_id` FOREIGN KEY (`partner_org_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`partner_org`(`partner_org_id`);
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`misconduct_disclosure` ADD CONSTRAINT `fk_safeguarding_misconduct_disclosure_partner_org_id` FOREIGN KEY (`partner_org_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`partner_org`(`partner_org_id`);
...
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`psea_network` ADD CONSTRAINT `fk_safeguarding_psea_network_partner_org_id` FOREIGN KEY (`partner_org_id`) REFERENCES `vibe_ngo_v1`.`partnership`.`partner_org`(`partner_org_id`);

-- ========= safeguarding --> program (1 constraint(s)) =========
...
-- ========= safeguarding --> volunteer (2 constraint(s)) =========
-- Requires: safeguarding schema, volunteer schema
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`safeguarding_training_completion` ADD CONSTRAINT `fk_safeguarding_safeguarding_training_completion_volunteer_id` FOREIGN KEY (`volunteer_id`) REFERENCES `vibe_ngo_v1`.`volunteer`.`volunteer`(`volunteer_id`);
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`safeguarding_policy_acknowledgment` ADD CONSTRAINT `fk_safeguarding_safeguarding_policy_acknowledgment_volunteer_id` FOREIGN KEY (`volunteer_id`) REFERENCES `vibe_ngo_v1`.`volunteer`.`volunteer`(`volunteer_id`);

-- ========= safeguarding --> workforce (16 constraint(s)) =========
-- Requires: safeguarding schema, workforce schema
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`psea_policy` ADD CONSTRAINT `fk_safeguarding_psea_policy_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`focal_point` ADD CONSTRAINT `fk_safeguarding_focal_point_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`org_unit`(`org_unit_id`);
...
ALTER TABLE `vibe_ngo_v1`.`safeguarding`.`audit` ADD CONSTRAINT `fk_safeguarding_audit_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`org_unit`(`org_unit_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ADD CONSTRAINT `fk_supply_goods_receipt_beneficiary_needs_assessment_id` FOREIGN KEY (`beneficiary_needs_assessment_id`) REFERENCES `vibe_ngo_v1`.`beneficiary`.`beneficiary_needs_assessment`(`beneficiary_needs_assessment_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` ADD CONSTRAINT `fk_supply_cold_chain_equipment_country_id` FOREIGN KEY (`country_id`) REFERENCES `vibe_ngo_v1`.`field`.`country`(`country_id`);
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` ADD CONSTRAINT `fk_supply_cold_chain_equipment_project_site_id` FOREIGN KEY (`project_site_id`) REFERENCES `vibe_ngo_v1`.`field`.`project_site`(`project_site_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing` ADD CONSTRAINT `fk_supply_gavi_cofinancing_country_office_id` FOREIGN KEY (`country_office_id`) REFERENCES `vibe_ngo_v1`.`field`.`country_office`(`country_office_id`);
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing_tracking` ADD CONSTRAINT `fk_supply_gavi_cofinancing_tracking_country_id` FOREIGN KEY (`country_id`) REFERENCES `vibe_ngo_v1`.`field`.`country`(`country_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing_tracking` ADD CONSTRAINT `fk_supply_gavi_cofinancing_tracking_award_id` FOREIGN KEY (`award_id`) REFERENCES `vibe_ngo_v1`.`grant`.`award`(`award_id`);
...
-- ========= technology --> workforce (18 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`technology`.`it_procurement` ADD CONSTRAINT `fk_technology_it_procurement_it_requesting_staff_member_id` FOREIGN KEY (`it_requesting_staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
ALTER TABLE `vibe_ngo_v1`.`technology`.`cab_meeting` ADD CONSTRAINT `fk_technology_cab_meeting_cab_staff_member_id` FOREIGN KEY (`cab_staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
-- ========= volunteer --> field (25 constraint(s)) =========
...
ALTER TABLE `vibe_ngo_v1`.`volunteer`.`volunteer_deployment2` ADD CONSTRAINT `fk_volunteer_volunteer_deployment2_country_office_id` FOREIGN KEY (`country_office_id`) REFERENCES `vibe_ngo_v1`.`field`.`country_office`(`country_office_id`);
...
ALTER TABLE `vibe_ngo_v1`.`volunteer`.`volunteer_deployment2` ADD CONSTRAINT `fk_volunteer_volunteer_deployment2_intervention_id` FOREIGN KEY (`intervention_id`) REFERENCES `vibe_ngo_v1`.`program`.`intervention`(`intervention_id`);
...
ALTER TABLE `vibe_ngo_v1`.`volunteer`.`incident_report` ADD CONSTRAINT `fk_volunteer_incident_report_it_incident_id` FOREIGN KEY (`it_incident_id`) REFERENCES `vibe_ngo_v1`.`technology`.`it_incident`(`it_incident_id`);
...
ALTER TABLE `vibe_ngo_v1`.`volunteer`.`volunteer_redeployment` ADD CONSTRAINT `fk_volunteer_volunteer_redeployment_staff_member_id` FOREIGN KEY (`staff_member_id`) REFERENCES `vibe_ngo_v1`.`workforce`.`staff_member`(`staff_member_id`);
...
-- ========= workforce --> field (2 constraint(s)) =========
...
-- ========= workforce --> safeguarding (1 constraint(s)) =========
-- Requires: workforce schema, safeguarding schema
ALTER TABLE `vibe_ngo_v1`.`workforce`.`disciplinary_case` ADD CONSTRAINT `fk_workforce_disciplinary_case_investigation_id` FOREIGN KEY (`investigation_id`) REFERENCES `vibe_ngo_v1`.`safeguarding`.`investigation`(`investigation_id`);
