...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`employee` (
    ...
    `primary_employee_position_id` BIGINT COMMENT 'FK to workforce.position.position_id — Employees fill positions. This is the core link between the person and the authorized headcount slot.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`position` (
    ...
    `position_job_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` (
    ...
    `qualification_name` STRING COMMENT '',
    `qualification_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`talent_acquisition` (
    ...
    `candidate_email` STRING COMMENT '',
    `candidate_name` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` (
    ...
    `primary_compensation_plan_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`time_entry` (
    ...
    `compliance_flag` BOOLEAN COMMENT 'Indicates whether the entry meets applicable labor law and safety compliance.',
    `cost_center_code` STRING COMMENT 'Financial cost center to which labor cost is allocated.',
    `entry_date` DATE COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`training` (
    ...
    `primary_training_course_id` BIGINT COMMENT '',
    ...
    `training_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` (
    ...
    `equipment_group` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` (
    ...
    `site_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` (
    ...
    `engagement_end_date` DATE COMMENT '',
    `engagement_start_date` DATE COMMENT '',
    `engagement_status` STRING COMMENT '',
    ...
    `hourly_rate_usd` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`cleanroom_access` (
    ...
    `cleanroom_class` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`export_control` (
    ...
    `citizenship_country` STRING COMMENT '',
    ...
    `classification_date` DATE COMMENT '',
    `ear_eligible_flag` BOOLEAN COMMENT '',
    ...
    `itar_eligible_flag` BOOLEAN COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`safety_event` (
    ...
    `safety_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` (
    ...
    `course_category` STRING COMMENT '',
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` ADD CONSTRAINT `fk_workforce_employee_primary_employee_position_id` FOREIGN KEY (`primary_employee_position_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`position`(`position_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training` ADD CONSTRAINT `fk_workforce_training_training_employee_id` FOREIGN KEY (`training_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` ADD CONSTRAINT `fk_workforce_site_assignment_site_employee_id` FOREIGN KEY (`site_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` ADD CONSTRAINT `fk_workforce_training_course_prerequisite_training_course_id` FOREIGN KEY (`prerequisite_training_course_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`training_course`(`training_course_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` SET TAGS ('dbx_subdomain' = 'people_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` ALTER COLUMN `position_id` SET TAGS ('dbx_business_glossary_term' = 'Position Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` ALTER COLUMN `primary_employee_position_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Position Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` ALTER COLUMN `email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` ALTER COLUMN `phone_number` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` ALTER COLUMN `social_security_number` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`position` SET TAGS ('dbx_subdomain' = 'people_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` SET TAGS ('dbx_subdomain' = 'people_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Code (COST_CENTER_CODE)');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_value_regex' = '^[0-9]{4}$');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `primary_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `primary_contact_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`competency` SET TAGS ('dbx_subdomain' = 'people_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` SET TAGS ('dbx_subdomain' = 'talent_acquisition');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Identifier');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`shift_schedule` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`talent_acquisition` SET TAGS ('dbx_subdomain' = 'talent_acquisition');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`talent_acquisition` ALTER COLUMN `candidate_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employment_event` SET TAGS ('dbx_subdomain' = 'compensation_benefits');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` SET TAGS ('dbx_subdomain' = 'compensation_benefits');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `compensation_plan_id` SET TAGS ('dbx_classification' = 'confidential');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `compensation_plan_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `base_salary_amount` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `base_salary_amount` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `employee` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `employee` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`time_entry` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`time_entry` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training` SET TAGS ('dbx_subdomain' = 'talent_acquisition');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training` ALTER COLUMN `training_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training` ALTER COLUMN `training_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` ALTER COLUMN `certification_id` SET TAGS ('dbx_business_glossary_term' = 'Certification Document ID (CERT_DOC_ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` ALTER COLUMN `site_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` ALTER COLUMN `site_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` SET TAGS ('dbx_subdomain' = 'compliance_safety');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` ALTER COLUMN `contractor_address` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` ALTER COLUMN `contractor_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` ALTER COLUMN `contractor_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`cleanroom_access` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`export_control` SET TAGS ('dbx_subdomain' = 'compliance_safety');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`export_control` ALTER COLUMN `employee_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`safety_event` SET TAGS ('dbx_subdomain' = 'compliance_safety');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` SET TAGS ('dbx_subdomain' = 'compensation_benefits');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` ALTER COLUMN `compensation_plan_status` SET TAGS ('dbx_classification' = 'confidential');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` ALTER COLUMN `compensation_plan_status` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`skill` SET TAGS ('dbx_subdomain' = 'people_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`job` SET TAGS ('dbx_subdomain' = 'people_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`shift_pattern` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` SET TAGS ('dbx_subdomain' = 'talent_acquisition');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` ALTER COLUMN `prerequisite_training_course_id` SET TAGS ('dbx_business_glossary_term' = 'Prerequisite Training Course Id');
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` ALTER COLUMN `prerequisite_training_course_id` SET TAGS ('dbx_self_ref_fk' = 'true');
