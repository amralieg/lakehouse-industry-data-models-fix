...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`routing` (
    ...
    `routing_version` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` (
    ...
    `planned_order_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` (
    ...
    `primary_batch_employee_id` BIGINT COMMENT 'Reference to the quality assurance personnel who performed final batch release. Links to workforce master data.',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`oee_record` (
    ...
    `good_units_produced` DECIMAL(18,2) COMMENT 'Count of units that passed quality inspection and met specifications, calculated as Total Units Produced - Total Units Rejected.',
    ...
    `total_units_produced` DECIMAL(18,2) COMMENT 'Total count of units produced during the shift, including both good units and rejected units.',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`downtime_event` (
    ...
    `primary_downtime_employee_id` BIGINT COMMENT 'Identifier of the production operator who reported or was present during the downtime event.',
    ...
    `downtime_reason_code` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`changeover` (
    ...
    `cleaning_validated_flag` BOOLEAN COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` (
    ...
    `batch_record_id` BIGINT COMMENT '',
    ...
    `actual_yield` DECIMAL(18,2) COMMENT '',
    ...
    `planned_yield` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`gmp_event` (
    ...
    `gmp_reported_by_employee_id` BIGINT COMMENT '',
    ...
    `capa_required_flag` BOOLEAN COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_confirmation` (
    ...
    `production_confirmed_by_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` (
    ...
    `within_spec_flag` BOOLEAN COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`equipment` (
    ...
    `equipment_production_line_id` BIGINT COMMENT '',
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` ADD CONSTRAINT `fk_manufacturing_production_order_planned_order_id` FOREIGN KEY (`planned_order_id`) REFERENCES `vibe_consumer_goods_v1`.`manufacturing`.`planned_order`(`planned_order_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility` SET TAGS ('dbx_subdomain' = 'facility_infrastructure');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility` SET TAGS ('dbx_ssot_owner' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility` SET TAGS ('dbx_ssot_role' = 'canonical');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility` SET TAGS ('dbx_ssot_reference' = 'distribution.distribution_facility');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_line` SET TAGS ('dbx_subdomain' = 'facility_infrastructure');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_line` ALTER COLUMN `energy_certificate_id` SET TAGS ('dbx_business_glossary_term' = 'Energy Certificate Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`work_center` SET TAGS ('dbx_subdomain' = 'facility_infrastructure');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_bom` SET TAGS ('dbx_subdomain' = 'process_definition');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`routing` SET TAGS ('dbx_subdomain' = 'process_definition');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` SET TAGS ('dbx_subdomain' = 'order_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` ALTER COLUMN `marketing_brand_id` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` ALTER COLUMN `marketing_brand_id` SET TAGS ('dbx_pii_type' = 'tax_id');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` SET TAGS ('dbx_subdomain' = 'order_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `marketing_brand_id` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `marketing_brand_id` SET TAGS ('dbx_pii_type' = 'tax_id');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `primary_batch_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Quality Inspector ID');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `primary_batch_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `primary_batch_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `routing_version` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` ALTER COLUMN `routing_version` SET TAGS ('dbx_pii_type' = 'tax_id');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`oee_record` SET TAGS ('dbx_subdomain' = 'performance_monitoring');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`oee_record` ALTER COLUMN `actual_operating_time_minutes` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`oee_record` ALTER COLUMN `actual_operating_time_minutes` SET TAGS ('dbx_pii_type' = 'tax_id');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`oee_record` ALTER COLUMN `shift_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`oee_record` ALTER COLUMN `shift_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`downtime_event` SET TAGS ('dbx_subdomain' = 'performance_monitoring');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`downtime_event` ALTER COLUMN `primary_downtime_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Operator ID');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`downtime_event` ALTER COLUMN `primary_downtime_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`downtime_event` ALTER COLUMN `primary_downtime_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`changeover` SET TAGS ('dbx_subdomain' = 'performance_monitoring');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` SET TAGS ('dbx_subdomain' = 'performance_monitoring');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` ALTER COLUMN `routing_operation_number` SET TAGS ('dbx_sensitivity' = 'card_bank');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` ALTER COLUMN `routing_operation_number` SET TAGS ('dbx_pii_type' = 'card_bank');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` ALTER COLUMN `routing_operation_number` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` ALTER COLUMN `routing_operation_number` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` ALTER COLUMN `routing_operation_number` SET TAGS ('dbx_mask_non_prod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` ALTER COLUMN `routing_operation_number` SET TAGS ('dbx_pii_kind' = 'card_bank');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`gmp_event` SET TAGS ('dbx_subdomain' = 'performance_monitoring');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_confirmation` SET TAGS ('dbx_subdomain' = 'order_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` SET TAGS ('dbx_subdomain' = 'performance_monitoring');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` ALTER COLUMN `parameter_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` ALTER COLUMN `parameter_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`planned_order` SET TAGS ('dbx_subdomain' = 'order_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`equipment` SET TAGS ('dbx_subdomain' = 'facility_infrastructure');
