...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_defect` (
    ...
    `lot_fk` BIGINT COMMENT 'FK to packaging.assembly_lot.assembly_lot_id — Defects are identified on specific lots. Required for lot disposition decisions and DPPM calculations.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`material_lot` (
    ...
    `primary_material_substrate_bom_id` BIGINT COMMENT 'FK to packaging.substrate_bom.substrate_bom_id — Material lots received are matched to substrate BOM line items for consumption tracking.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`inspection_result` (
    ...
    `assembly_lot_id` BIGINT COMMENT '',
    ...
    `inspected_timestamp` TIMESTAMP COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` (
    ...
    `package_type_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`customer_requirement` (
    ...
    `package_type_id` BIGINT COMMENT 'FK to packaging.package_type.package_type_id — Customer requirements specify required package types. Needed to validate assembly orders against customer specs.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_step_record` (
    ...
    `lot_fk` BIGINT COMMENT 'FK to packaging.assembly_lot.assembly_lot_id — Every step execution record references the lot being processed. This is the core traceability link from step-level data to lot identity.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` (
    ...
    `operator_in_charge` DECIMAL(18,2) COMMENT 'Name or employee identifier of the primary operator responsible for the line.',
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`material_lot` ADD CONSTRAINT `fk_packaging_material_lot_primary_material_substrate_bom_id` FOREIGN KEY (`primary_material_substrate_bom_id`) REFERENCES `vibe_semiconductors_v1`.`packaging`.`substrate_bom`(`substrate_bom_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order` ALTER COLUMN `order_id` SET TAGS ('dbx_business_glossary_term' = 'Sales Order Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order` ALTER COLUMN `sku_id` SET TAGS ('dbx_business_glossary_term' = 'Sku Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order` ALTER COLUMN `test_program_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`package_type` SET TAGS ('dbx_subdomain' = 'package_engineering');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`osat_vendor` SET TAGS ('dbx_subdomain' = 'assembly_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`substrate_bom` SET TAGS ('dbx_subdomain' = 'package_engineering');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ALTER COLUMN `order_id` SET TAGS ('dbx_business_glossary_term' = 'Customer Order Identifier (ORDER_ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ALTER COLUMN `fabrication_wafer_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Wafer Lot Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ALTER COLUMN `package_type_id` SET TAGS ('dbx_business_glossary_term' = 'Packaging Package Type Id');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ALTER COLUMN `package_type_id` SET TAGS ('dbx_internal' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_defect` SET TAGS ('dbx_subdomain' = 'quality_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_defect` ALTER COLUMN `lot_fk` SET TAGS ('dbx_business_glossary_term' = 'Assembly Defect Lot Fk');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`package_qualification` SET TAGS ('dbx_subdomain' = 'quality_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`reliability_stress_test` SET TAGS ('dbx_subdomain' = 'quality_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`reliability_stress_test` ALTER COLUMN `package_type_id` SET TAGS ('dbx_business_glossary_term' = 'Package ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`material_lot` SET TAGS ('dbx_subdomain' = 'assembly_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`material_lot` ALTER COLUMN `substrate_bom_id` SET TAGS ('dbx_business_glossary_term' = 'Substrate Bom Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`inspection_result` SET TAGS ('dbx_subdomain' = 'quality_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` SET TAGS ('dbx_subdomain' = 'package_engineering');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `change_owner_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `change_owner_name` SET TAGS ('dbx_pii_class' = 'person_name');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `change_owner_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `change_owner_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`customer_requirement` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`customer_requirement` SET TAGS ('dbx_subdomain' = 'package_engineering');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`customer_requirement` ALTER COLUMN `package_type_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Package Type Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_step_record` SET TAGS ('dbx_subdomain' = 'assembly_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_step_record` ALTER COLUMN `lot_fk` SET TAGS ('dbx_business_glossary_term' = 'Assembly Step Record Lot Fk');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` SET TAGS ('dbx_subdomain' = 'assembly_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` ALTER COLUMN `packaging_line_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` ALTER COLUMN `packaging_line_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` ALTER COLUMN `packaging_line_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` SET TAGS ('dbx_subdomain' = 'quality_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `osat_partner_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `osat_partner_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `osat_partner_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `responsible_engineer` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `test_suite_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `test_suite_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `test_suite_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
