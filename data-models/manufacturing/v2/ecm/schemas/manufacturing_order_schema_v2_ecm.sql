...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`order`.`order_hold` (
    ...
    `order_hold_releasing_user_employee_id` BIGINT COMMENT 'Identifier of the user or system that released the hold.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` (
    `order_amendment_id` BIGINT COMMENT 'System‑generated unique identifier for the order amendment record.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`order`.`order_line` (
    ...
    `line_id` BIGINT COMMENT 'add column line_id (BIGINT) with FK to order.line.line_id - product.order_line appears to duplicate order.line; if not a duplicate it must link to the canonical order line',
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ADD CONSTRAINT `fk_order_order_hold_order_header_id` FOREIGN KEY (`order_header_id`) REFERENCES `vibe_manufacturing_v1`.`order`.`order_header`(`order_header_id`);
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ADD CONSTRAINT `fk_order_order_hold_superseding_hold_id` FOREIGN KEY (`superseding_hold_id`) REFERENCES `vibe_manufacturing_v1`.`order`.`order_hold`(`order_hold_id`);
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ADD CONSTRAINT `fk_order_order_amendment_line_id` FOREIGN KEY (`line_id`) REFERENCES `vibe_manufacturing_v1`.`order`.`line`(`line_id`);
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ADD CONSTRAINT `fk_order_order_amendment_order_header_id` FOREIGN KEY (`order_header_id`) REFERENCES `vibe_manufacturing_v1`.`order`.`order_header`(`order_header_id`);
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` ADD CONSTRAINT `fk_order_order_line_line_id` FOREIGN KEY (`line_id`) REFERENCES `vibe_manufacturing_v1`.`order`.`line`(`line_id`);
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` ADD CONSTRAINT `fk_order_order_line_order_header_id` FOREIGN KEY (`order_header_id`) REFERENCES `vibe_manufacturing_v1`.`order`.`order_header`(`order_header_id`);
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`delivery` SET TAGS ('dbx_subdomain' = 'fulfillment_delivery');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`delivery_item` SET TAGS ('dbx_subdomain' = 'fulfillment_delivery');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_rma` SET TAGS ('dbx_subdomain' = 'returns_pricing');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`rma_line` SET TAGS ('dbx_subdomain' = 'returns_pricing');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`fulfillment_sla` SET TAGS ('dbx_subdomain' = 'fulfillment_delivery');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`goods_issue` SET TAGS ('dbx_subdomain' = 'fulfillment_delivery');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`proof_of_delivery` SET TAGS ('dbx_subdomain' = 'fulfillment_delivery');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`pricing_condition` SET TAGS ('dbx_subdomain' = 'returns_pricing');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`condition_type` SET TAGS ('dbx_subdomain' = 'returns_pricing');
...
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` SET TAGS ('dbx_subdomain' = 'order_management');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `order_hold_id` SET TAGS ('dbx_business_glossary_term' = 'Order Hold ID');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `order_header_id` SET TAGS ('dbx_business_glossary_term' = 'Order ID');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Placed By User ID');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `order_hold_releasing_user_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Releasing User ID');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `order_hold_releasing_user_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `order_hold_releasing_user_employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `superseding_hold_id` SET TAGS ('dbx_business_glossary_term' = 'Superseding Hold Id');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `superseding_hold_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `amount` SET TAGS ('dbx_business_glossary_term' = 'Hold Amount');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `comments` SET TAGS ('dbx_business_glossary_term' = 'Hold Comments');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `compliance_flag` SET TAGS ('dbx_business_glossary_term' = 'Compliance Flag');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_category` SET TAGS ('dbx_business_glossary_term' = 'Hold Category');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_category` SET TAGS ('dbx_value_regex' = 'financial|operational|quality|customer|regulatory|other');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_number` SET TAGS ('dbx_business_glossary_term' = 'Hold Number');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_source` SET TAGS ('dbx_business_glossary_term' = 'Hold Source');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_source` SET TAGS ('dbx_value_regex' = 'system|user');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_status` SET TAGS ('dbx_business_glossary_term' = 'Hold Status');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_status` SET TAGS ('dbx_value_regex' = 'active|released|cancelled|escalated');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_type` SET TAGS ('dbx_business_glossary_term' = 'Hold Type');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `hold_type` SET TAGS ('dbx_value_regex' = 'credit_limit|export_compliance|quality_quarantine|customer_dispute|pricing_approval|other');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `is_system_generated` SET TAGS ('dbx_business_glossary_term' = 'System Generated Indicator');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `outcome` SET TAGS ('dbx_business_glossary_term' = 'Hold Outcome');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `outcome` SET TAGS ('dbx_value_regex' = 'resolved|unresolved|escalated|cancelled');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `placed_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Hold Placement Timestamp');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `priority` SET TAGS ('dbx_business_glossary_term' = 'Hold Priority');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `priority` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `reason` SET TAGS ('dbx_business_glossary_term' = 'Hold Reason');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `release_conditions` SET TAGS ('dbx_business_glossary_term' = 'Release Conditions');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `release_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Hold Release Timestamp');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `target_resolution_date` SET TAGS ('dbx_business_glossary_term' = 'Target Resolution Date');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_hold` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` SET TAGS ('dbx_subdomain' = 'order_management');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `order_amendment_id` SET TAGS ('dbx_business_glossary_term' = 'Order Amendment Identifier (OAID)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `customer_account_id` SET TAGS ('dbx_business_glossary_term' = 'Customer Identifier (CUST_ID)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approver User Identifier (APP_USER_ID)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `line_id` SET TAGS ('dbx_business_glossary_term' = 'Related Order Line Identifier (LINE_ID)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `order_header_id` SET TAGS ('dbx_business_glossary_term' = 'Sales Order Identifier (SO_ID)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `amendment_number` SET TAGS ('dbx_business_glossary_term' = 'Amendment Number (AMEND_NO)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `amendment_status` SET TAGS ('dbx_business_glossary_term' = 'Amendment Status (AMEND_STATUS)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `amendment_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|processed|closed');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `amendment_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Amendment Event Timestamp (AMEND_TS)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `amendment_type` SET TAGS ('dbx_business_glossary_term' = 'Amendment Type (AMEND_TYPE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `amendment_type` SET TAGS ('dbx_value_regex' = 'quantity_change|delivery_date_change|address_change|price_change|line_addition|line_deletion');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date (APP_DATE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status (APP_STATUS)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected|escalated');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `change_document_reference` SET TAGS ('dbx_business_glossary_term' = 'Change Document Reference (DOC_REF)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `change_request_date` SET TAGS ('dbx_business_glossary_term' = 'Change Request Date (REQ_DATE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `comments` SET TAGS ('dbx_business_glossary_term' = 'Amendment Comments (COMMENTS)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (CREATED_TS)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (CURR_CD)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective From Date (EFF_FROM)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Effective Until Date (EFF_UNTIL)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Critical Amendment Indicator (IS_CRITICAL)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_address` SET TAGS ('dbx_business_glossary_term' = 'Original Shipping Address (ORIG_ADDR)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_address` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_address` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_amount` SET TAGS ('dbx_business_glossary_term' = 'Original Monetary Amount (ORIG_AMT)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Original Delivery Date (ORIG_DEL_DATE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_price` SET TAGS ('dbx_business_glossary_term' = 'Original Unit Price (ORIG_PRICE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `original_quantity` SET TAGS ('dbx_business_glossary_term' = 'Original Quantity (ORIG_QTY)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `priority_code` SET TAGS ('dbx_business_glossary_term' = 'Amendment Priority (PRIORITY_CD)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `priority_code` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `reason_code` SET TAGS ('dbx_business_glossary_term' = 'Amendment Reason Code (REASON_CD)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `requested_by` SET TAGS ('dbx_business_glossary_term' = 'Requested By (REQ_BY)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `requested_by` SET TAGS ('dbx_value_regex' = 'customer|internal');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_address` SET TAGS ('dbx_business_glossary_term' = 'Revised Shipping Address (REV_ADDR)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_address` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_address` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_amount` SET TAGS ('dbx_business_glossary_term' = 'Revised Monetary Amount (REV_AMT)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Revised Delivery Date (REV_DEL_DATE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_price` SET TAGS ('dbx_business_glossary_term' = 'Revised Unit Price (REV_PRICE)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `revised_quantity` SET TAGS ('dbx_business_glossary_term' = 'Revised Quantity (REV_QTY)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `sla_actual_minutes` SET TAGS ('dbx_business_glossary_term' = 'SLA Actual Minutes (SLA_ACT_MIN)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `sla_target_minutes` SET TAGS ('dbx_business_glossary_term' = 'SLA Target Minutes (SLA_TGT_MIN)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_amendment` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp (UPDATED_TS)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` SET TAGS ('dbx_subdomain' = 'order_management');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` SET TAGS ('dbx_association_edges' = 'product.sku_master,order.order_header');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` ALTER COLUMN `bundle_id` SET TAGS ('dbx_business_glossary_term' = 'Bundle Id (Foreign Key)');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` ALTER COLUMN `order_header_id` SET TAGS ('dbx_business_glossary_term' = 'Order Line - Sales Order Id');
ALTER TABLE `vibe_manufacturing_v1`.`order`.`order_line` ALTER COLUMN `sku_master_id` SET TAGS ('dbx_business_glossary_term' = 'Order Line - Sku Master Id');
