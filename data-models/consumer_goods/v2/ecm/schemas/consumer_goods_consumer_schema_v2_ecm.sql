...
-- Generated on: 2026-07-10 13:03:41
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`consumer`.`dtc_order` (
    ...
    `dtc_purchase_order_id` BIGINT COMMENT 'Foreign key linking to procurement.purchase_order. Business justification: Required for Order Fulfillment Tracking report linking each consumer DTC order to the procurement purchase order that supplied the goods.',
    `carbon_emission_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`consumer`.`consent_session` (
    ...
    `shopper_id` BIGINT COMMENT 'add column shopper_id (BIGINT) with FK to consumer.shopper.shopper_id - a consent session must identify which consumer/shopper initiated it',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`consumer`.`survey` (
    ...
    `marketing_brand_id` BIGINT COMMENT 'add column marketing_brand_id (BIGINT) with FK to marketing.marketing_brand.marketing_brand_id - surveys are typically brand-specific and need brand context',
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`loyalty_account` ALTER COLUMN `carbon_offset_id` SET TAGS ('dbx_business_glossary_term' = 'Carbon Offset Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`preference` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`consent_record` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`consent_event` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`dtc_order` ALTER COLUMN `dtc_purchase_order_id` SET TAGS ('dbx_business_glossary_term' = 'Purchase Order Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`cltv_record` SET TAGS ('dbx_subdomain' = 'loyalty_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`communication_preference` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`referral` SET TAGS ('dbx_subdomain' = 'loyalty_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`loyalty_program` SET TAGS ('dbx_subdomain' = 'loyalty_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`consent_session` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`preference_center` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`preference_center` ALTER COLUMN `email_opt_in` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`preference_center` ALTER COLUMN `email_opt_in` SET TAGS ('dbx_pii_email' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`preference_center` ALTER COLUMN `phone_opt_in` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`preference_center` ALTER COLUMN `phone_opt_in` SET TAGS ('dbx_pii_phone' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`data_subject_request` SET TAGS ('dbx_subdomain' = 'consent_preferences');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`panel` ALTER COLUMN `ethnicity` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`panel` ALTER COLUMN `gender` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`loyalty_tier` SET TAGS ('dbx_subdomain' = 'loyalty_engagement');
