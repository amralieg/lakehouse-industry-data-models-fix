...
-- Generated on: 2026-07-10 12:37:15
-- Total cross-domain FK constraints: 1322
--
-- EXECUTION ORDER:
...
ALTER TABLE `vibe_construction_v1`.`bid`.`bid_risk` ADD CONSTRAINT `fk_bid_bid_risk_permit_condition_id` FOREIGN KEY (`permit_condition_id`) REFERENCES `vibe_construction_v1`.`compliance`.`permit_condition`(`permit_condition_id`);
...
ALTER TABLE `vibe_construction_v1`.`bid`.`trade_package` ADD CONSTRAINT `fk_bid_trade_package_agreement_id` FOREIGN KEY (`agreement_id`) REFERENCES `vibe_construction_v1`.`contract`.`agreement`(`agreement_id`);
...
-- ========= bid --> hr (14 constraint(s)) =========
-- Requires: bid schema, hr schema
ALTER TABLE `vibe_construction_v1`.`bid`.`subcontractor_prequalification` ADD CONSTRAINT `fk_bid_subcontractor_prequalification_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`bid`.`bid_risk` ADD CONSTRAINT `fk_bid_bid_risk_owner_employee_id` FOREIGN KEY (`owner_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`bid`.`clarification` ADD CONSTRAINT `fk_bid_clarification_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`bid`.`tender` ADD CONSTRAINT `fk_bid_tender_quality_plan_id` FOREIGN KEY (`quality_plan_id`) REFERENCES `vibe_construction_v1`.`quality`.`quality_plan`(`quality_plan_id`);
...
-- ========= bid --> sustainability (12 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`bid`.`tender` ADD CONSTRAINT `fk_bid_tender_sustainability_plan_id` FOREIGN KEY (`sustainability_plan_id`) REFERENCES `vibe_construction_v1`.`sustainability`.`sustainability_plan`(`sustainability_plan_id`);
...
ALTER TABLE `vibe_construction_v1`.`bid`.`approval` ADD CONSTRAINT `fk_bid_approval_sustainability_plan_id` FOREIGN KEY (`sustainability_plan_id`) REFERENCES `vibe_construction_v1`.`sustainability`.`sustainability_plan`(`sustainability_plan_id`);
...
ALTER TABLE `vibe_construction_v1`.`client`.`segment` ADD CONSTRAINT `fk_client_segment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`compliance`.`privacy_obligation` ADD CONSTRAINT `fk_compliance_privacy_obligation_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_construction_v1`.`hr`.`org_unit`(`org_unit_id`);
...
ALTER TABLE `vibe_construction_v1`.`compliance`.`pci_control` ADD CONSTRAINT `fk_compliance_pci_control_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
ALTER TABLE `vibe_construction_v1`.`compliance`.`pci_assessment` ADD CONSTRAINT `fk_compliance_pci_assessment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`compliance`.`audit_report` ADD CONSTRAINT `fk_compliance_audit_report_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`compliance`.`env_monitoring` ADD CONSTRAINT `fk_compliance_env_monitoring_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`compliance`.`audit_report` ADD CONSTRAINT `fk_compliance_audit_report_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
-- ========= contract --> finance (1 constraint(s)) =========
-- Requires: contract schema, finance schema
ALTER TABLE `vibe_construction_v1`.`contract`.`subcontract_payment` ADD CONSTRAINT `fk_contract_subcontract_payment_payment_application_id` FOREIGN KEY (`payment_application_id`) REFERENCES `vibe_construction_v1`.`finance`.`payment_application`(`payment_application_id`);

-- ========= contract --> hr (13 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`contract`.`advance_payment` ADD CONSTRAINT `fk_contract_advance_payment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`contract`.`insurance_certificate` ADD CONSTRAINT `fk_contract_insurance_certificate_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`contract`.`dlp_register` ADD CONSTRAINT `fk_contract_dlp_register_wbs_element_id` FOREIGN KEY (`wbs_element_id`) REFERENCES `vibe_construction_v1`.`project`.`wbs_element`(`wbs_element_id`);
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contractual_notice` ADD CONSTRAINT `fk_contract_contractual_notice_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
-- ========= design --> contract (26 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`design`.`revision` ADD CONSTRAINT `fk_design_revision_revision_employee_id` FOREIGN KEY (`revision_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`design`.`workflow_approval` ADD CONSTRAINT `fk_design_workflow_approval_quaternary_workflow_initiated_by_employee_id` FOREIGN KEY (`quaternary_workflow_initiated_by_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`design`.`access_permission` ADD CONSTRAINT `fk_design_access_permission_primary_access_employee_id` FOREIGN KEY (`primary_access_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
ALTER TABLE `vibe_construction_v1`.`design`.`access_permission` ADD CONSTRAINT `fk_design_access_permission_quaternary_access_revoked_by_user_employee_id` FOREIGN KEY (`quaternary_access_revoked_by_user_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
ALTER TABLE `vibe_construction_v1`.`design`.`access_permission` ADD CONSTRAINT `fk_design_access_permission_quinary_access_created_by_user_employee_id` FOREIGN KEY (`quinary_access_created_by_user_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`design`.`review` ADD CONSTRAINT `fk_design_review_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= design --> project (35 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`inspection_record` ADD CONSTRAINT `fk_equipment_inspection_record_firm_profile_id` FOREIGN KEY (`firm_profile_id`) REFERENCES `vibe_construction_v1`.`bid`.`firm_profile`(`firm_profile_id`);
...
-- ========= equipment --> compliance (4 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset` ADD CONSTRAINT `fk_equipment_asset_regulatory_change_id` FOREIGN KEY (`regulatory_change_id`) REFERENCES `vibe_construction_v1`.`compliance`.`regulatory_change`(`regulatory_change_id`);
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`hours` ADD CONSTRAINT `fk_equipment_hours_hours_employee_id` FOREIGN KEY (`hours_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= equipment --> procurement (5 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ADD CONSTRAINT `fk_equipment_insurance_policy_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_construction_v1`.`procurement`.`vendor`(`vendor_id`);
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset` ADD CONSTRAINT `fk_equipment_asset_current_location_site_construction_project_id` FOREIGN KEY (`current_location_site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`functional_location` ADD CONSTRAINT `fk_equipment_functional_location_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
-- ========= finance --> bid (2 constraint(s)) =========
-- Requires: finance schema, bid schema
ALTER TABLE `vibe_construction_v1`.`finance`.`payment_application` ADD CONSTRAINT `fk_finance_payment_application_firm_profile_id` FOREIGN KEY (`firm_profile_id`) REFERENCES `vibe_construction_v1`.`bid`.`firm_profile`(`firm_profile_id`);
ALTER TABLE `vibe_construction_v1`.`finance`.`lien_waiver` ADD CONSTRAINT `fk_finance_lien_waiver_firm_profile_id` FOREIGN KEY (`firm_profile_id`) REFERENCES `vibe_construction_v1`.`bid`.`firm_profile`(`firm_profile_id`);
...
ALTER TABLE `vibe_construction_v1`.`finance`.`payment_application` ADD CONSTRAINT `fk_finance_payment_application_agreement_id` FOREIGN KEY (`agreement_id`) REFERENCES `vibe_construction_v1`.`contract`.`agreement`(`agreement_id`);
...
ALTER TABLE `vibe_construction_v1`.`finance`.`payment_application` ADD CONSTRAINT `fk_finance_payment_application_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= finance --> project (35 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`finance`.`payment_application` ADD CONSTRAINT `fk_finance_payment_application_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`finance`.`cost_center` ADD CONSTRAINT `fk_finance_cost_center_waste_target_id` FOREIGN KEY (`waste_target_id`) REFERENCES `vibe_construction_v1`.`sustainability`.`waste_target`(`waste_target_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ADD CONSTRAINT `fk_material_conformance_certificate_submission_id` FOREIGN KEY (`submission_id`) REFERENCES `vibe_construction_v1`.`bid`.`submission`(`submission_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ADD CONSTRAINT `fk_material_requisition_requisition_employee_id` FOREIGN KEY (`requisition_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ADD CONSTRAINT `fk_material_wastage_wastage_employee_id` FOREIGN KEY (`wastage_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= material --> project (15 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ADD CONSTRAINT `fk_material_batch_lot_project_site_assignment_id` FOREIGN KEY (`project_site_assignment_id`) REFERENCES `vibe_construction_v1`.`project`.`site`(`project_site_assignment_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ADD CONSTRAINT `fk_material_specification_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_header` ADD CONSTRAINT `fk_material_mto_header_project_site_assignment_id` FOREIGN KEY (`project_site_assignment_id`) REFERENCES `vibe_construction_v1`.`project`.`site`(`project_site_assignment_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`mto_header` ADD CONSTRAINT `fk_material_mto_header_source_site_id` FOREIGN KEY (`source_site_id`) REFERENCES `vibe_construction_v1`.`project`.`site`(`project_site_assignment_id`);
...
ALTER TABLE `vibe_construction_v1`.`procurement`.`purchase_requisition` ADD CONSTRAINT `fk_procurement_purchase_requisition_bid_opportunity_id` FOREIGN KEY (`bid_opportunity_id`) REFERENCES `vibe_construction_v1`.`bid`.`bid_opportunity`(`bid_opportunity_id`);
...
ALTER TABLE `vibe_construction_v1`.`procurement`.`approval_workflow` ADD CONSTRAINT `fk_procurement_approval_workflow_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= procurement --> project (17 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`procurement`.`rfq_line` ADD CONSTRAINT `fk_procurement_rfq_line_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`procurement`.`delivery_schedule` ADD CONSTRAINT `fk_procurement_delivery_schedule_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
-- ========= procurement --> site (2 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`procurement`.`delivery_schedule` ADD CONSTRAINT `fk_procurement_delivery_schedule_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_construction_v1`.`site`.`site`(`site_id`);
...
ALTER TABLE `vibe_construction_v1`.`project`.`forecast` ADD CONSTRAINT `fk_project_forecast_forecast_prepared_by_user_employee_id` FOREIGN KEY (`forecast_prepared_by_user_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
ALTER TABLE `vibe_construction_v1`.`project`.`regulatory_oversight` ADD CONSTRAINT `fk_project_regulatory_oversight_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ADD CONSTRAINT `fk_quality_lab_test_firm_profile_id` FOREIGN KEY (`firm_profile_id`) REFERENCES `vibe_construction_v1`.`bid`.`firm_profile`(`firm_profile_id`);
...
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ADD CONSTRAINT `fk_quality_corrective_action_quaternary_corrective_last_modified_by_employee_id` FOREIGN KEY (`quaternary_corrective_last_modified_by_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ADD CONSTRAINT `fk_quality_ndt_record_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= quality --> project (37 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ADD CONSTRAINT `fk_quality_checklist_execution_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
-- ========= quality --> sustainability (4 constraint(s)) =========
-- Requires: quality schema, sustainability schema
ALTER TABLE `vibe_construction_v1`.`quality`.`ncr` ADD CONSTRAINT `fk_quality_ncr_esg_report_id` FOREIGN KEY (`esg_report_id`) REFERENCES `vibe_construction_v1`.`sustainability`.`esg_report`(`esg_report_id`);
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ADD CONSTRAINT `fk_quality_ndt_record_craft_worker_id` FOREIGN KEY (`craft_worker_id`) REFERENCES `vibe_construction_v1`.`workforce`.`craft_worker`(`craft_worker_id`);
...
ALTER TABLE `vibe_construction_v1`.`safety`.`safety_audit` ADD CONSTRAINT `fk_safety_safety_audit_submission_id` FOREIGN KEY (`submission_id`) REFERENCES `vibe_construction_v1`.`bid`.`submission`(`submission_id`);
ALTER TABLE `vibe_construction_v1`.`safety`.`hse_plan` ADD CONSTRAINT `fk_safety_hse_plan_bid_opportunity_id` FOREIGN KEY (`bid_opportunity_id`) REFERENCES `vibe_construction_v1`.`bid`.`bid_opportunity`(`bid_opportunity_id`);
...
ALTER TABLE `vibe_construction_v1`.`safety`.`risk_assessment` ADD CONSTRAINT `fk_safety_risk_assessment_design_submittal_id` FOREIGN KEY (`design_submittal_id`) REFERENCES `vibe_construction_v1`.`design`.`design_submittal`(`design_submittal_id`);
...
ALTER TABLE `vibe_construction_v1`.`safety`.`swms` ADD CONSTRAINT `fk_safety_swms_swms_employee_id` FOREIGN KEY (`swms_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
ALTER TABLE `vibe_construction_v1`.`safety`.`swms` ADD CONSTRAINT `fk_safety_swms_swms_prepared_by_employee_id` FOREIGN KEY (`swms_prepared_by_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`schedule`.`activity` ADD CONSTRAINT `fk_schedule_activity_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_construction_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
...
ALTER TABLE `vibe_construction_v1`.`schedule`.`activity` ADD CONSTRAINT `fk_schedule_activity_design_submittal_id` FOREIGN KEY (`design_submittal_id`) REFERENCES `vibe_construction_v1`.`design`.`design_submittal`(`design_submittal_id`);
...
-- ========= schedule --> project (15 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`site`.`lift_plan` ADD CONSTRAINT `fk_site_lift_plan_quaternary_lift_approved_by_employee_id` FOREIGN KEY (`quaternary_lift_approved_by_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`site`.`site` ADD CONSTRAINT `fk_site_site_manager_employee_id` FOREIGN KEY (`manager_employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= site --> procurement (6 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`site`.`work_front` ADD CONSTRAINT `fk_site_work_front_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`site`.`daily_log` ADD CONSTRAINT `fk_site_daily_log_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`site`.`material_delivery` ADD CONSTRAINT `fk_site_material_delivery_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`site`.`lift_plan` ADD CONSTRAINT `fk_site_lift_plan_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`site`.`shift_report` ADD CONSTRAINT `fk_site_shift_report_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ADD CONSTRAINT `fk_subcontractor_performance_scorecard_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);

-- ========= subcontractor --> project (9 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`back_charge` ADD CONSTRAINT `fk_subcontractor_back_charge_wbs_element_id` FOREIGN KEY (`wbs_element_id`) REFERENCES `vibe_construction_v1`.`project`.`wbs_element`(`wbs_element_id`);
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` ADD CONSTRAINT `fk_subcontractor_subcontractor_eot_claim_wbs_element_id` FOREIGN KEY (`wbs_element_id`) REFERENCES `vibe_construction_v1`.`project`.`wbs_element`(`wbs_element_id`);
...
-- ========= sustainability --> compliance (9 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`sustainability`.`waste_carrier` ADD CONSTRAINT `fk_sustainability_waste_carrier_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_construction_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
ALTER TABLE `vibe_construction_v1`.`sustainability`.`disposal_facility` ADD CONSTRAINT `fk_sustainability_disposal_facility_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_construction_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
...
ALTER TABLE `vibe_construction_v1`.`sustainability`.`carbon_offset` ADD CONSTRAINT `fk_sustainability_carbon_offset_asset_id` FOREIGN KEY (`asset_id`) REFERENCES `vibe_construction_v1`.`equipment`.`asset`(`asset_id`);
...
-- ========= sustainability --> hr (16 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`sustainability`.`embodied_carbon_assessment` ADD CONSTRAINT `fk_sustainability_embodied_carbon_assessment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_construction_v1`.`sustainability`.`biodiversity_assessment` ADD CONSTRAINT `fk_sustainability_biodiversity_assessment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
ALTER TABLE `vibe_construction_v1`.`sustainability`.`social_value_record` ADD CONSTRAINT `fk_sustainability_social_value_record_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_construction_v1`.`hr`.`employee`(`employee_id`);
...
-- ========= sustainability --> material (1 constraint(s)) =========
-- Requires: sustainability schema, material schema
ALTER TABLE `vibe_construction_v1`.`sustainability`.`embodied_carbon_assessment` ADD CONSTRAINT `fk_sustainability_embodied_carbon_assessment_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
...
-- ========= sustainability --> project (21 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`sustainability`.`biodiversity_assessment` ADD CONSTRAINT `fk_sustainability_biodiversity_assessment_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`sustainability`.`sustainability_audit` ADD CONSTRAINT `fk_sustainability_sustainability_audit_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
-- ========= workforce --> project (24 constraint(s)) =========
...
ALTER TABLE `vibe_construction_v1`.`workforce`.`agency_labor_order` ADD CONSTRAINT `fk_workforce_agency_labor_order_site_construction_project_id` FOREIGN KEY (`site_construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
...
ALTER TABLE `vibe_construction_v1`.`workforce`.`apprenticeship_progression` ADD CONSTRAINT `fk_workforce_apprenticeship_progression_construction_project_id` FOREIGN KEY (`construction_project_id`) REFERENCES `vibe_construction_v1`.`project`.`construction_project`(`construction_project_id`);
