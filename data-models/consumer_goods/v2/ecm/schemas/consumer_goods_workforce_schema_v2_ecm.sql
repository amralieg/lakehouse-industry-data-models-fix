...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`benefit_enrollment` (
    ...
    `payroll_group_id` BIGINT COMMENT 'add column payroll_group_id (BIGINT) with FK to workforce.payroll_group.payroll_group_id - benefit enrollments are processed through payroll groups',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`time_entry` (
    ...
    `cost_center_id` BIGINT COMMENT 'add column cost_center_id (BIGINT) with FK to finance.cost_center.cost_center_id - time entries must post to cost centers for labor cost allocation',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`training_course` (
    ...
    `org_unit_id` BIGINT COMMENT 'add column org_unit_id (BIGINT) with FK to workforce.org_unit.org_unit_id - training courses should be associated with the organizational unit responsible for delivery or requirement',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`safety_incident` (
    ...
    `manufacturing_facility_id` BIGINT COMMENT 'add column manufacturing_facility_id (BIGINT) with FK to manufacturing.manufacturing_facility.manufacturing_facility_id - safety incidents in CPG predominantly occur at manufacturing sites',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`labor_relation` (
    ...
    `employee_id` BIGINT COMMENT 'add column employee_id (BIGINT) with FK to workforce.employee.employee_id - labor relations records must link to the employee or representative involved',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`applicant` (
    ...
    `job_profile_id` BIGINT COMMENT 'add column job_profile_id (BIGINT) with FK to workforce.job_profile.job_profile_id - applicants apply for specific job profiles and this link enables pipeline analytics',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`workforce`.`payroll_period` (
    ...
    `payroll_group_id` BIGINT COMMENT 'add column payroll_group_id (BIGINT) with FK to workforce.payroll_group.payroll_group_id - payroll periods are defined per payroll group',
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` ADD CONSTRAINT `fk_workforce_org_unit_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_consumer_goods_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`position` ADD CONSTRAINT `fk_workforce_position_recruiting_requisition_id` FOREIGN KEY (`recruiting_requisition_id`) REFERENCES `vibe_consumer_goods_v1`.`workforce`.`recruiting_requisition`(`recruiting_requisition_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`position` ADD CONSTRAINT `fk_workforce_position_supervisor_position_id` FOREIGN KEY (`supervisor_position_id`) REFERENCES `vibe_consumer_goods_v1`.`workforce`.`position`(`position_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`benefit_enrollment` ADD CONSTRAINT `fk_workforce_benefit_enrollment_payroll_group_id` FOREIGN KEY (`payroll_group_id`) REFERENCES `vibe_consumer_goods_v1`.`workforce`.`payroll_group`(`payroll_group_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`employee` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center ID');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Manager Employee ID');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`position` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`position` ALTER COLUMN `recruiting_requisition_id` SET TAGS ('dbx_business_glossary_term' = 'Requisition Identifier (ID)');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`position` ALTER COLUMN `supervisor_position_id` SET TAGS ('dbx_business_glossary_term' = 'Supervisor Position Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`job_profile` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`payroll_record` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Payroll Approved By User ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`performance_review` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Identifier (Employee ID)');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`performance_review` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`performance_review` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`training_record` SET TAGS ('dbx_subdomain' = 'safety_training');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`training_course` SET TAGS ('dbx_subdomain' = 'safety_training');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`safety_incident` SET TAGS ('dbx_subdomain' = 'safety_training');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`shift_schedule` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`labor_relation` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`enrollment` SET TAGS ('dbx_subdomain' = 'safety_training');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`applicant` ALTER COLUMN `expected_salary` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`applicant` ALTER COLUMN `expected_salary` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` SET TAGS ('dbx_subdomain' = 'employee_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_internal' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `emergency_contact_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `emergency_contact_name` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `latitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ALTER COLUMN `longitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`payroll_group` ALTER COLUMN `compensation_grade` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`payroll_group` ALTER COLUMN `compensation_grade` SET TAGS ('dbx_pii_financial' = 'true');
