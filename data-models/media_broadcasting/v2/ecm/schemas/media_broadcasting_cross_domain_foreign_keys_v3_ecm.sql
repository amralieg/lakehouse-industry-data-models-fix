-- Cross-Domain Foreign Keys for Business:  | Version: v3_ecm
-- Generated on: 2026-07-10 19:30:42
-- Total cross-domain FK constraints: 1440
--
-- EXECUTION ORDER:
...
ALTER TABLE `vibe_media_broadcasting_v1`.`advertising`.`ad_inventory` ADD CONSTRAINT `fk_advertising_ad_inventory_program_title_id` FOREIGN KEY (`program_title_id`) REFERENCES `vibe_media_broadcasting_v1`.`content`.`title`(`title_id`);
...
-- ========= advertising --> workforce (2 constraint(s)) =========
-- Requires: advertising schema, workforce schema
ALTER TABLE `vibe_media_broadcasting_v1`.`advertising`.`ad_inventory` ADD CONSTRAINT `fk_advertising_ad_inventory_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= audience --> compliance (26 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`nielsen_rating` ADD CONSTRAINT `fk_audience_nielsen_rating_nielsen_political_ad_record_id` FOREIGN KEY (`nielsen_political_ad_record_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`political_ad_record`(`political_ad_record_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`viewership_record` ADD CONSTRAINT `fk_audience_viewership_record_privacy_request_id` FOREIGN KEY (`privacy_request_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`privacy_request`(`privacy_request_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`reach_frequency_report` ADD CONSTRAINT `fk_audience_reach_frequency_report_sox_control_id` FOREIGN KEY (`sox_control_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`sox_control`(`sox_control_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`reach_frequency_report` ADD CONSTRAINT `fk_audience_reach_frequency_report_reach_political_ad_record_id` FOREIGN KEY (`reach_political_ad_record_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`political_ad_record`(`political_ad_record_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`reach_frequency_report` ADD CONSTRAINT `fk_audience_reach_frequency_report_reach_sox_control_id` FOREIGN KEY (`reach_sox_control_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`sox_control`(`sox_control_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`guarantee` ADD CONSTRAINT `fk_audience_guarantee_content_rating_id` FOREIGN KEY (`content_rating_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`content_rating`(`content_rating_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`nielsen_rating` ADD CONSTRAINT `fk_audience_nielsen_rating_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`cost_center`(`cost_center_id`);
...
-- ========= audience --> scheduling (11 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`guarantee` ADD CONSTRAINT `fk_audience_guarantee_network_channel_id` FOREIGN KEY (`network_channel_id`) REFERENCES `vibe_media_broadcasting_v1`.`scheduling`.`channel`(`channel_id`);
...
-- ========= audience --> workforce (7 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`audience`.`measurement_methodology` ADD CONSTRAINT `fk_audience_measurement_methodology_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`billing`.`syndication_license_fee` ADD CONSTRAINT `fk_billing_syndication_license_fee_content_rating_id` FOREIGN KEY (`content_rating_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`content_rating`(`content_rating_id`);
...
-- ========= billing --> content (6 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`billing`.`billing_line` ADD CONSTRAINT `fk_billing_billing_line_title_id` FOREIGN KEY (`title_id`) REFERENCES `vibe_media_broadcasting_v1`.`content`.`title`(`title_id`);
...
-- ========= billing --> finance (28 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`billing`.`billing_line` ADD CONSTRAINT `fk_billing_billing_line_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`billing`.`billing_line` ADD CONSTRAINT `fk_billing_billing_line_finance_cost_center_id` FOREIGN KEY (`finance_cost_center_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`cost_center`(`cost_center_id`);
...
-- ========= billing --> technology (13 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`billing`.`credit_memo` ADD CONSTRAINT `fk_billing_credit_memo_transmission_equipment_id` FOREIGN KEY (`transmission_equipment_id`) REFERENCES `vibe_media_broadcasting_v1`.`technology`.`transmission_equipment`(`transmission_equipment_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`billing`.`credit_memo` ADD CONSTRAINT `fk_billing_credit_memo_credit_transmission_equipment_id` FOREIGN KEY (`credit_transmission_equipment_id`) REFERENCES `vibe_media_broadcasting_v1`.`technology`.`transmission_equipment`(`transmission_equipment_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`content`.`genre` ADD CONSTRAINT `fk_content_genre_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`content`.`taxonomy` ADD CONSTRAINT `fk_content_taxonomy_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`content`.`content_library` ADD CONSTRAINT `fk_content_content_library_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`content`.`content_portfolio` ADD CONSTRAINT `fk_content_content_portfolio_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= distribution --> billing (4 constraint(s)) =========
...
-- ========= distribution --> compliance (28 constraint(s)) =========
...
-- ========= distribution --> sales (10 constraint(s)) =========
...
-- ========= distribution --> scheduling (9 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`distribution`.`playout` ADD CONSTRAINT `fk_distribution_playout_schedule_slot_id` FOREIGN KEY (`schedule_slot_id`) REFERENCES `vibe_media_broadcasting_v1`.`scheduling`.`schedule_slot`(`schedule_slot_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`distribution`.`device_type` ADD CONSTRAINT `fk_distribution_device_type_maintenance_work_order_id` FOREIGN KEY (`maintenance_work_order_id`) REFERENCES `vibe_media_broadcasting_v1`.`technology`.`maintenance_work_order`(`maintenance_work_order_id`);
...
-- ========= distribution --> workforce (23 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`distribution`.`app_version` ADD CONSTRAINT `fk_distribution_app_version_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`distribution`.`drm_policy` ADD CONSTRAINT `fk_distribution_drm_policy_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`distribution`.`playout` ADD CONSTRAINT `fk_distribution_playout_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`distribution`.`channel_compliance` ADD CONSTRAINT `fk_distribution_channel_compliance_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`finance`.`revenue_recognition_event` ADD CONSTRAINT `fk_finance_revenue_recognition_event_content_rating_id` FOREIGN KEY (`content_rating_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`content_rating`(`content_rating_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`finance`.`intercompany_transaction` ADD CONSTRAINT `fk_finance_intercompany_transaction_regulatory_filing_id` FOREIGN KEY (`regulatory_filing_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`regulatory_filing`(`regulatory_filing_id`);
...
-- ========= finance --> workforce (23 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`finance`.`project_assignment` ADD CONSTRAINT `fk_finance_project_assignment_project_manager_employee_id` FOREIGN KEY (`project_manager_employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`finance`.`cost_center_authorization` ADD CONSTRAINT `fk_finance_cost_center_authorization_granted_by_employee_id` FOREIGN KEY (`granted_by_employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`finance`.`cost_center_authorization` ADD CONSTRAINT `fk_finance_cost_center_authorization_revoked_by_employee_id` FOREIGN KEY (`revoked_by_employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`finance`.`recurring_entry_template` ADD CONSTRAINT `fk_finance_recurring_entry_template_created_by_employee_id` FOREIGN KEY (`created_by_employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= mediaasset --> technology (6 constraint(s)) =========
...
-- ========= mediaasset --> workforce (12 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`mediaasset`.`storage_location` ADD CONSTRAINT `fk_mediaasset_storage_location_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`mediaasset`.`legal_hold` ADD CONSTRAINT `fk_mediaasset_legal_hold_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`partner`.`deal_negotiation` ADD CONSTRAINT `fk_partner_deal_negotiation_demographic_segment_id` FOREIGN KEY (`demographic_segment_id`) REFERENCES `vibe_media_broadcasting_v1`.`audience`.`demographic_segment`(`demographic_segment_id`);
...
-- ========= partner --> billing (2 constraint(s)) =========
...
-- ========= partner --> scheduling (11 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`partner`.`affiliate_agreement` ADD CONSTRAINT `fk_partner_affiliate_agreement_affiliate_station_channel_id` FOREIGN KEY (`affiliate_station_channel_id`) REFERENCES `vibe_media_broadcasting_v1`.`scheduling`.`channel`(`channel_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`partner`.`affiliate_agreement` ADD CONSTRAINT `fk_partner_affiliate_agreement_network_channel_id` FOREIGN KEY (`network_channel_id`) REFERENCES `vibe_media_broadcasting_v1`.`scheduling`.`channel`(`channel_id`);
...
-- ========= production --> content (17 constraint(s)) =========
...
-- ========= production --> finance (13 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`production`.`rental_agreement` ADD CONSTRAINT `fk_production_rental_agreement_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`production`.`rating_submission` ADD CONSTRAINT `fk_production_rating_submission_schedule_slot_id` FOREIGN KEY (`schedule_slot_id`) REFERENCES `vibe_media_broadcasting_v1`.`scheduling`.`schedule_slot`(`schedule_slot_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`production`.`equipment_type` ADD CONSTRAINT `fk_production_equipment_type_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);

-- ========= rights --> audience (5 constraint(s)) =========
-- Requires: rights schema, audience schema
ALTER TABLE `vibe_media_broadcasting_v1`.`rights`.`clearance_request` ADD CONSTRAINT `fk_rights_clearance_request_guarantee_id` FOREIGN KEY (`guarantee_id`) REFERENCES `vibe_media_broadcasting_v1`.`audience`.`guarantee`(`guarantee_id`);
...
-- ========= rights --> compliance (12 constraint(s)) =========
...
-- ========= rights --> workforce (19 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`rights`.`rights_territory` ADD CONSTRAINT `fk_rights_rights_territory_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`rights`.`holder` ADD CONSTRAINT `fk_rights_holder_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`rights`.`rights_audit_session` ADD CONSTRAINT `fk_rights_rights_audit_session_auditor_employee_id` FOREIGN KEY (`auditor_employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`sales_scatter_order` ADD CONSTRAINT `fk_sales_sales_scatter_order_ad_billing_order_id` FOREIGN KEY (`ad_billing_order_id`) REFERENCES `vibe_media_broadcasting_v1`.`billing`.`ad_billing_order`(`ad_billing_order_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`sales_product` ADD CONSTRAINT `fk_sales_sales_product_product_id` FOREIGN KEY (`product_id`) REFERENCES `vibe_media_broadcasting_v1`.`billing`.`product`(`product_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`content_license_deal` ADD CONSTRAINT `fk_sales_content_license_deal_content_rating_id` FOREIGN KEY (`content_rating_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`content_rating`(`content_rating_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`isci_creative` ADD CONSTRAINT `fk_sales_isci_creative_content_clearance_id` FOREIGN KEY (`content_clearance_id`) REFERENCES `vibe_media_broadcasting_v1`.`content`.`content_clearance`(`content_clearance_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`ad_pod` ADD CONSTRAINT `fk_sales_ad_pod_program_title_id` FOREIGN KEY (`program_title_id`) REFERENCES `vibe_media_broadcasting_v1`.`content`.`title`(`title_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`dai_event` ADD CONSTRAINT `fk_sales_dai_event_revenue_recognition_event_id` FOREIGN KEY (`revenue_recognition_event_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`revenue_recognition_event`(`revenue_recognition_event_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`campaign_funding` ADD CONSTRAINT `fk_sales_campaign_funding_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`cost_center`(`cost_center_id`);

-- ========= sales --> mediaasset (9 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`sales_proposal` ADD CONSTRAINT `fk_sales_sales_proposal_media_asset_id` FOREIGN KEY (`media_asset_id`) REFERENCES `vibe_media_broadcasting_v1`.`mediaasset`.`media_asset`(`media_asset_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`dai_event` ADD CONSTRAINT `fk_sales_dai_event_content_asset_id` FOREIGN KEY (`content_asset_id`) REFERENCES `vibe_media_broadcasting_v1`.`mediaasset`.`media_asset`(`media_asset_id`);
...
-- ========= sales --> scheduling (26 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`campaign` ADD CONSTRAINT `fk_sales_campaign_subscriber_id` FOREIGN KEY (`subscriber_id`) REFERENCES `vibe_media_broadcasting_v1`.`subscriber`.`subscriber`(`subscriber_id`);
...
-- ========= sales --> workforce (34 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`sales_contact` ADD CONSTRAINT `fk_sales_sales_contact_last_modified_by_user_employee_id` FOREIGN KEY (`last_modified_by_user_employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`sales`.`rfp` ADD CONSTRAINT `fk_sales_rfp_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_media_broadcasting_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= scheduling --> billing (5 constraint(s)) =========
...
-- ========= subscriber --> audience (7 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`subscriber`.`household` ADD CONSTRAINT `fk_subscriber_household_market_coverage_id` FOREIGN KEY (`market_coverage_id`) REFERENCES `vibe_media_broadcasting_v1`.`audience`.`market_coverage`(`market_coverage_id`);
...
-- ========= subscriber --> billing (5 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`subscriber`.`offer` ADD CONSTRAINT `fk_subscriber_offer_revenue_stream_id` FOREIGN KEY (`revenue_stream_id`) REFERENCES `vibe_media_broadcasting_v1`.`finance`.`revenue_stream`(`revenue_stream_id`);
...
-- ========= talent --> compliance (4 constraint(s)) =========
-- Requires: talent schema, compliance schema
ALTER TABLE `vibe_media_broadcasting_v1`.`talent`.`guild_affiliation` ADD CONSTRAINT `fk_talent_guild_affiliation_regulatory_filing_id` FOREIGN KEY (`regulatory_filing_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`regulatory_filing`(`regulatory_filing_id`);
ALTER TABLE `vibe_media_broadcasting_v1`.`talent`.`contract` ADD CONSTRAINT `fk_talent_contract_content_rating_id` FOREIGN KEY (`content_rating_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`content_rating`(`content_rating_id`);
...
ALTER TABLE `vibe_media_broadcasting_v1`.`talent`.`residual_payment` ADD CONSTRAINT `fk_talent_residual_payment_regulatory_filing_id` FOREIGN KEY (`regulatory_filing_id`) REFERENCES `vibe_media_broadcasting_v1`.`compliance`.`regulatory_filing`(`regulatory_filing_id`);
...
-- ========= talent --> technology (4 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`technology`.`noc_alert` ADD CONSTRAINT `fk_technology_noc_alert_distribution_agreement_id` FOREIGN KEY (`distribution_agreement_id`) REFERENCES `vibe_media_broadcasting_v1`.`partner`.`distribution_agreement`(`distribution_agreement_id`);
...
-- ========= workforce --> scheduling (7 constraint(s)) =========
...
ALTER TABLE `vibe_media_broadcasting_v1`.`workforce`.`work_schedule` ADD CONSTRAINT `fk_workforce_work_schedule_work_scheduling_daypart_id` FOREIGN KEY (`work_scheduling_daypart_id`) REFERENCES `vibe_media_broadcasting_v1`.`scheduling`.`daypart`(`daypart_id`);
