-- Schema for Domain: provider | Business:  | Version: v3_ecm
-- Generated on: 2026-07-10 20:47:18
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`provider`.`specialty` (
    ...
    `provider_contract_id` BIGINT COMMENT 'Foreign key linking to contract.provider_contract. Business justification: Specialty Contract Participation Report needs a link between specialty and the specific contract governing that specialty.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` (
    ...
    `practice_medicare_provider_id` BIGINT COMMENT 'Medicare provider identifier (PTAN or legacy OSCAR number) for this practice location. Required for Medicare Advantage claims.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` (
    ...
    `provider_outreach_date` DATE COMMENT 'Date when the outreach event was conducted or attempted. Primary business event date for this transaction.',
    ...
    `method` STRING COMMENT 'Communication channel or medium used to conduct the outreach event with the provider.. Valid values are `phone|email|mail|portal|fax|in_person`',
    ...
    `provider_outreach_status` STRING COMMENT 'Current lifecycle status of the outreach event, tracking progression from initiation through completion or cancellation.. Valid values are `scheduled|in_progress|completed|cancelled|failed`',
    `timestamp` TIMESTAMP COMMENT 'Precise date and time when the outreach event was initiated or conducted, supporting detailed audit trails and SLA tracking.',
    `provider_outreach_type` STRING COMMENT 'Category of outreach activity conducted with the provider. Determines the business purpose and workflow for the outreach event.. Valid values are `directory_verification|credentialing_follow_up|contract_execution|network_recruitment|data_quality_correction|recredentialing_reminder`',
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ADD CONSTRAINT `fk_provider_practice_location_practice_medicare_provider_id` FOREIGN KEY (`practice_medicare_provider_id`) REFERENCES `vibe_health_insurance_v1`.`provider`.`provider`(`provider_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` SET TAGS ('dbx_subdomain' = 'credential_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` ALTER COLUMN `accepting_new_patients_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` ALTER COLUMN `certifying_board_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` ALTER COLUMN `fellowship_program_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` ALTER COLUMN `specialty_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`specialty` ALTER COLUMN `subspecialty_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` SET TAGS ('dbx_subdomain' = 'provider_registry');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `practice_medicare_provider_id` SET TAGS ('dbx_business_glossary_term' = 'Medicare Provider Identifier (ID)');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `primary_provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Identifier (ID)');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `accepting_new_patients_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `county_name` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `location_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`practice_location` ALTER COLUMN `tax_identifier` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`license` SET TAGS ('dbx_subdomain' = 'credential_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`license` ALTER COLUMN `continuing_education_hours_required` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`license` ALTER COLUMN `continuing_education_required_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`license` ALTER COLUMN `issuing_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`license` ALTER COLUMN `number` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`affiliation` SET TAGS ('dbx_subdomain' = 'provider_registry');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`affiliation` ALTER COLUMN `accepting_new_patients_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`affiliation` ALTER COLUMN `admitting_privileges_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`affiliation` ALTER COLUMN `billing_npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`affiliation` ALTER COLUMN `department_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`affiliation` ALTER COLUMN `tin` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` SET TAGS ('dbx_subdomain' = 'provider_registry');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `group_medicare_provider_id` SET TAGS ('dbx_business_glossary_term' = 'Medicare Provider Identifier (ID)');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `accepting_new_patients` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `aco_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `county` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `doing_business_as_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `group_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `group_npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`group_practice` ALTER COLUMN `state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` SET TAGS ('dbx_subdomain' = 'provider_registry');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `accepting_new_patients_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `county_name` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `facility_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `parent_organization_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `quality_rating` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`facility` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `accepting_new_patients_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `directory_display_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `practice_county` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `practice_location_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `practice_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`directory_entry` ALTER COLUMN `tin` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` SET TAGS ('dbx_subdomain' = 'credential_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` ALTER COLUMN `npi_registry_sync_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` ALTER COLUMN `deactivation_reason_code` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` ALTER COLUMN `deactivation_reason_description` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`npi_registry_sync` ALTER COLUMN `nppes_deactivation_date` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`sanction` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`sanction` ALTER COLUMN `reinstatement_date` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`exclusion_screening` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`exclusion_screening` ALTER COLUMN `cms_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`exclusion_screening` ALTER COLUMN `screened_by_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`exclusion_screening` ALTER COLUMN `state_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`participation_status` ALTER COLUMN `accepting_new_patients_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`participation_status` ALTER COLUMN `continuity_of_care_end_date` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`participation_status` ALTER COLUMN `participation_status_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`dea_registration` SET TAGS ('dbx_subdomain' = 'credential_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`dea_registration` ALTER COLUMN `dea_registration_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`dea_registration` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Provider Provider Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`dea_registration` ALTER COLUMN `registration_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`dea_registration` ALTER COLUMN `registration_status` SET TAGS ('dbx_value_regex' = 'active|expired|revoked|surrendered|pending');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`dea_registration` ALTER COLUMN `registration_type` SET TAGS ('dbx_value_regex' = 'individual|organization');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`obligation_compliance` SET TAGS ('dbx_subdomain' = 'compliance_screening');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`obligation_compliance` ALTER COLUMN `obligation_compliance_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Obligation Compliance - Provider Obligation Compliance Id');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`obligation_compliance` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Obligation Compliance - Regulatory Obligation Id');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`obligation_compliance` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Obligation Compliance - Provider Provider Id');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`obligation_compliance` ALTER COLUMN `compliance_status` SET TAGS ('dbx_business_glossary_term' = 'Compliance Status');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`obligation_compliance` ALTER COLUMN `last_assessment_date` SET TAGS ('dbx_business_glossary_term' = 'Last Assessment Date');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`audit_assignment` ALTER COLUMN `audit_assignment_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Audit Assignment - Provider Audit Assignment Id');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`audit_assignment` ALTER COLUMN `audit_engagement_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Audit Assignment - Audit Engagement Id');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`audit_assignment` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Audit Assignment - Provider Provider Id');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`audit_assignment` ALTER COLUMN `audit_period_end` SET TAGS ('dbx_business_glossary_term' = 'Audit Period End');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`audit_assignment` ALTER COLUMN `audit_period_start` SET TAGS ('dbx_business_glossary_term' = 'Audit Period Start');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`audit_assignment` ALTER COLUMN `audit_scope` SET TAGS ('dbx_business_glossary_term' = 'Audit Scope');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`outreach_campaign` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`outreach_campaign` SET TAGS ('dbx_subdomain' = 'outreach_engagement');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`outreach_campaign` ALTER COLUMN `campaign_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`outreach_campaign` ALTER COLUMN `campaign_target_audience_gender` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`outreach_campaign` ALTER COLUMN `campaign_target_audience_income_range` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` SET TAGS ('dbx_subdomain' = 'provider_registry');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Account Manager Employee Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `accreditation_program_id` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Program Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `accreditation_survey_id` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Survey Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `delegated_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Delegated Credentialing Entity Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider` ALTER COLUMN `license_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_directory_verification` SET TAGS ('dbx_subdomain' = 'outreach_engagement');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_directory_verification` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` SET TAGS ('dbx_subdomain' = 'outreach_engagement');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `accepting_patients_verified_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_outreach_date` SET TAGS ('dbx_business_glossary_term' = 'Outreach Date');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `method` SET TAGS ('dbx_business_glossary_term' = 'Outreach Method');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `method` SET TAGS ('dbx_value_regex' = 'phone|email|mail|portal|fax|in_person');
...
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `staff_member_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_outreach_status` SET TAGS ('dbx_business_glossary_term' = 'Outreach Status');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_outreach_status` SET TAGS ('dbx_value_regex' = 'scheduled|in_progress|completed|cancelled|failed');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `timestamp` SET TAGS ('dbx_business_glossary_term' = 'Outreach Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_outreach_type` SET TAGS ('dbx_business_glossary_term' = 'Outreach Type');
ALTER TABLE `vibe_health_insurance_v1`.`provider`.`provider_outreach` ALTER COLUMN `provider_outreach_type` SET TAGS ('dbx_value_regex' = 'directory_verification|credentialing_follow_up|contract_execution|network_recruitment|data_quality_correction|recredentialing_reminder');
