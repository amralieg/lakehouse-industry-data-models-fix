...
-- Generated on: 2026-07-10 13:03:47
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`sales`.`account_hierarchy` (
    ...
    `parent_trade_account_id` BIGINT COMMENT 'add column parent_trade_account_id (BIGINT) with FK to sales.trade_account.trade_account_id - account hierarchy needs a parent account reference to form the tree structure, not just a single FK',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`sales`.`edi_trading_partner` (
    ...
    `channel_classification_id` BIGINT COMMENT 'add column channel_classification_id (BIGINT) with FK to customer.channel_classification.channel_classification_id - EDI partners operate within specific channel classifications',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`sales`.`order` (
    ...
    `channel_classification_id` BIGINT COMMENT 'add column channel_classification_id (BIGINT) with FK to customer.channel_classification.channel_classification_id - orders should capture which channel they originated from for channel analytics',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`sales`.`compliance_assignment` (
    ...
    `employee_id` BIGINT COMMENT 'add column employee_id (BIGINT) with FK to workforce.employee.employee_id - compliance assignments need an owner/assignee',
...
-- ========= FOREIGN KEYS =========
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_contact` ADD CONSTRAINT `fk_sales_account_contact_reports_to_contact_id` FOREIGN KEY (`reports_to_contact_id`) REFERENCES `vibe_consumer_goods_v1`.`sales`.`account_contact`(`account_contact_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`trade_account` ALTER COLUMN `inventory_storage_location_id` SET TAGS ('dbx_business_glossary_term' = 'Default Storage Location Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_contact` ALTER COLUMN `reports_to_contact_id` SET TAGS ('dbx_business_glossary_term' = 'Reports To Contact Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_assortment` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_pricing_agreement` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_compliance_record` ALTER COLUMN `esg_commitment_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Commitment Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`pricing_agreement` ALTER COLUMN `esg_commitment_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Commitment Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`pricing_agreement` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_call` ALTER COLUMN `rep_id` SET TAGS ('dbx_business_glossary_term' = 'Sales Representative Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`pos_transaction` SET TAGS ('dbx_subdomain' = 'order_revenue');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`return_order` ALTER COLUMN `purchase_order_id` SET TAGS ('dbx_business_glossary_term' = 'Purchase Order Id (Foreign Key)');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`return_order` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`quota` ALTER COLUMN `rep_id` SET TAGS ('dbx_business_glossary_term' = 'Sales Representative ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`distribution_point` ALTER COLUMN `manufacturing_facility_id` SET TAGS ('dbx_business_glossary_term' = 'Manufacturing Facility Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`distribution_point` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `actual_distance_km` SET TAGS ('dbx_business_glossary_term' = 'Actual Distance (Kilometers)');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `actual_duration_hours` SET TAGS ('dbx_business_glossary_term' = 'Actual Duration (Hours)');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `actual_stop_count` SET TAGS ('dbx_business_glossary_term' = 'Actual Stop Count');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_confirmation_status` SET TAGS ('dbx_business_glossary_term' = 'Delivery Confirmation Status');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_confirmation_status` SET TAGS ('dbx_value_regex' = 'confirmed|pending|rejected|partial|exception');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_day_of_week` SET TAGS ('dbx_business_glossary_term' = 'Delivery Day of Week');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_day_of_week` SET TAGS ('dbx_value_regex' = 'monday|tuesday|wednesday|thursday|friday|saturday');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_execution_date` SET TAGS ('dbx_business_glossary_term' = 'Delivery Execution Date');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_frequency` SET TAGS ('dbx_business_glossary_term' = 'Delivery Frequency');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `delivery_frequency` SET TAGS ('dbx_value_regex' = 'daily|weekly|biweekly|monthly|on_demand|custom');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `distribution_channel` SET TAGS ('dbx_business_glossary_term' = 'Distribution Channel');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `division` SET TAGS ('dbx_business_glossary_term' = 'Division');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `estimated_distance_km` SET TAGS ('dbx_business_glossary_term' = 'Estimated Distance (Kilometers)');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `estimated_duration_hours` SET TAGS ('dbx_business_glossary_term' = 'Estimated Duration (Hours)');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `exception_count` SET TAGS ('dbx_business_glossary_term' = 'Exception Count');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `exception_notes` SET TAGS ('dbx_business_glossary_term' = 'Exception Notes');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `geographic_territory` SET TAGS ('dbx_business_glossary_term' = 'Geographic Territory');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `modified_by` SET TAGS ('dbx_business_glossary_term' = 'Modified By');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `otif_compliance_flag` SET TAGS ('dbx_business_glossary_term' = 'On Time In Full (OTIF) Compliance Flag');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `planned_stop_count` SET TAGS ('dbx_business_glossary_term' = 'Planned Stop Count');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `receiver_signature_captured_flag` SET TAGS ('dbx_business_glossary_term' = 'Receiver Signature Captured Flag');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_end_time` SET TAGS ('dbx_business_glossary_term' = 'Route End Time');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_name` SET TAGS ('dbx_business_glossary_term' = 'Route Name');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_number` SET TAGS ('dbx_business_glossary_term' = 'Route Number');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_optimization_score` SET TAGS ('dbx_business_glossary_term' = 'Route Optimization Score');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_start_time` SET TAGS ('dbx_business_glossary_term' = 'Route Start Time');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_status` SET TAGS ('dbx_business_glossary_term' = 'Route Status');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_status` SET TAGS ('dbx_value_regex' = 'active|inactive|suspended|planned|retired');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_type` SET TAGS ('dbx_business_glossary_term' = 'Route Type');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `route_type` SET TAGS ('dbx_value_regex' = 'regular|emergency|seasonal|promotional|new_store|special');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `sales_organization` SET TAGS ('dbx_business_glossary_term' = 'Sales Organization');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `sap_sd_route_number` SET TAGS ('dbx_business_glossary_term' = 'SAP Sales and Distribution (SD) Route Number');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `settlement_amount` SET TAGS ('dbx_business_glossary_term' = 'Settlement Amount');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `total_cases_delivered` SET TAGS ('dbx_business_glossary_term' = 'Total Cases Delivered');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `total_quantity_delivered` SET TAGS ('dbx_business_glossary_term' = 'Total Quantity Delivered');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `total_quantity_returned` SET TAGS ('dbx_business_glossary_term' = 'Total Quantity Returned');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `vehicle_code` SET TAGS ('dbx_business_glossary_term' = 'Vehicle ID');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_route` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_amount` SET TAGS ('dbx_business_glossary_term' = 'Delivery Amount');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_confirmation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Delivery Confirmation Timestamp');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_exception_flag` SET TAGS ('dbx_business_glossary_term' = 'Delivery Exception Flag');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_notes` SET TAGS ('dbx_business_glossary_term' = 'Delivery Notes');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_number` SET TAGS ('dbx_business_glossary_term' = 'Delivery Number');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_status` SET TAGS ('dbx_business_glossary_term' = 'Delivery Status');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_status` SET TAGS ('dbx_value_regex' = 'completed|partial|rejected|cancelled|pending');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_time` SET TAGS ('dbx_business_glossary_term' = 'Delivery Time');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_type` SET TAGS ('dbx_business_glossary_term' = 'Delivery Type');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `delivery_type` SET TAGS ('dbx_value_regex' = 'regular|emergency|promotional|new_store');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Discount Amount');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `distribution_channel_code` SET TAGS ('dbx_business_glossary_term' = 'Distribution Channel Code');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `division_code` SET TAGS ('dbx_business_glossary_term' = 'Division Code');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `exception_notes` SET TAGS ('dbx_business_glossary_term' = 'Exception Notes');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `exception_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Exception Reason Code');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `exception_reason_code` SET TAGS ('dbx_value_regex' = 'damaged|expired|wrong_product|quantity_dispute|store_closed|access_denied');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `gps_latitude` SET TAGS ('dbx_business_glossary_term' = 'GPS Latitude');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `gps_latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `gps_latitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `gps_longitude` SET TAGS ('dbx_business_glossary_term' = 'GPS Longitude');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `gps_longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `gps_longitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `net_settlement_amount` SET TAGS ('dbx_business_glossary_term' = 'Net Settlement Amount');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `otif_status` SET TAGS ('dbx_business_glossary_term' = 'On Time In Full (OTIF) Status');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `otif_status` SET TAGS ('dbx_value_regex' = 'on_time_in_full|late_in_full|on_time_partial|late_partial');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payment Method');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'cash|check|credit|edi|account');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `payment_reference_number` SET TAGS ('dbx_business_glossary_term' = 'Payment Reference Number');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `return_amount` SET TAGS ('dbx_business_glossary_term' = 'Return Amount');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `sales_organization_code` SET TAGS ('dbx_business_glossary_term' = 'Sales Organization Code');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `sap_sd_delivery_number` SET TAGS ('dbx_business_glossary_term' = 'SAP Sales and Distribution (SD) Delivery Number');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `scheduled_delivery_time` SET TAGS ('dbx_business_glossary_term' = 'Scheduled Delivery Time');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `signature_captured_flag` SET TAGS ('dbx_business_glossary_term' = 'Signature Captured Flag');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `signature_image_reference` SET TAGS ('dbx_business_glossary_term' = 'Signature Image Reference');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `store_receiver_name` SET TAGS ('dbx_business_glossary_term' = 'Store Receiver Name');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `store_receiver_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `store_receiver_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `total_cases_delivered` SET TAGS ('dbx_business_glossary_term' = 'Total Cases Delivered');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `total_cases_returned` SET TAGS ('dbx_business_glossary_term' = 'Total Cases Returned');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `total_units_delivered` SET TAGS ('dbx_business_glossary_term' = 'Total Units Delivered');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `total_units_returned` SET TAGS ('dbx_business_glossary_term' = 'Total Units Returned');
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_dsd_delivery` ALTER COLUMN `vehicle_code` SET TAGS ('dbx_business_glossary_term' = 'Vehicle ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`sales_vmi_agreement` ALTER COLUMN `sales_vmi_agreement_status` SET TAGS ('dbx_business_glossary_term' = 'Agreement Status');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`call` ALTER COLUMN `rep_id` SET TAGS ('dbx_business_glossary_term' = 'Sales Call - Sales Rep Id');
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`compliance_assignment` SET TAGS ('dbx_subdomain' = 'direct_delivery');
