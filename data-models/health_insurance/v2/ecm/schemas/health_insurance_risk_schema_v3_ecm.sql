-- Schema for Domain: risk | Business:  | Version: v3_ecm
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` (
    ...
    `health_plan_id` BIGINT COMMENT 'add column plan_health_plan_id (BIGINT) with FK to plan.health_plan.health_plan_id - rate development is performed for specific health plans',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` (
    ...
    `legal_entity_id` BIGINT COMMENT 'add column finance_legal_entity_id (BIGINT) with FK to finance.legal_entity.legal_entity_id - RBC calculations are performed at legal entity level',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`risk`.`score_run` (
    ...
    `data_quality_flag` BOOLEAN COMMENT 'Indicator of the overall data quality for the run.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` (
    ...
    `employee_id` BIGINT COMMENT 'add column workforce_employee_id (BIGINT) with FK to workforce.employee.employee_id - assumption sets require actuary sign-off tracking',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` (
    ...
    `employer_underwriting_case_id` BIGINT COMMENT '',
    ...
    `number` STRING COMMENT 'External case number assigned to the underwriting decision, used for tracking and communication.',
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`member_risk_score` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`member_risk_score` ALTER COLUMN `model_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`hcc_mapping` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`raps_submission` SET TAGS ('dbx_subdomain' = 'score_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`raps_submission` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Submission User Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`raps_submission` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`raps_submission` ALTER COLUMN `submission_file_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` SET TAGS ('dbx_subdomain' = 'actuarial_modeling');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` ALTER COLUMN `rating_area` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` ALTER COLUMN `rating_period_end` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rate_development` ALTER COLUMN `rating_period_start` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`ibnr_reserve` SET TAGS ('dbx_subdomain' = 'actuarial_modeling');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`ibnr_reserve` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`ibnr_reserve` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`ibnr_reserve` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`ibnr_reserve` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`ibnr_reserve` ALTER COLUMN `reserve_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` SET TAGS ('dbx_subdomain' = 'reinsurance_protection');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurance_arrangement_id` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Arrangement Identifier (RA_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Reinsurer Identifier (REINSURER_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `aggregate_attachment_amount` SET TAGS ('dbx_business_glossary_term' = 'Aggregate Attachment Amount (AGG_ATTACH_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `aggregate_attachment_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `aggregate_attachment_factor` SET TAGS ('dbx_business_glossary_term' = 'Aggregate Attachment Factor Percentage (AGG_ATTACH_FACTOR)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `aggregate_attachment_factor` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `arrangement_number` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Arrangement Number (RA_NUM)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `arrangement_number` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `attachment_point` SET TAGS ('dbx_business_glossary_term' = 'Attachment Point Amount (ATTACHMENT_POINT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `attachment_point` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `attachment_point_currency` SET TAGS ('dbx_business_glossary_term' = 'Attachment Point Currency Code (ATTACHMENT_CURR)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `attachment_point_currency` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `coinsurance_percentage` SET TAGS ('dbx_business_glossary_term' = 'Coinsurance Percentage (COINSURANCE_PCT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `coinsurance_percentage` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `corridor_percentage` SET TAGS ('dbx_business_glossary_term' = 'Corridor Percentage (CORRIDOR_PCT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `corridor_percentage` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (CREATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective Date (EFF_FROM)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Expiration Date (EXPIRY_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `lob_coverage` SET TAGS ('dbx_business_glossary_term' = 'Line of Business Coverage (LOB_COVERAGE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `lob_coverage` SET TAGS ('dbx_value_regex' = 'medical|dental|vision|pharmacy|hospital|rx');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `maximum_liability` SET TAGS ('dbx_business_glossary_term' = 'Maximum Liability Amount (MAX_LIAB)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `maximum_liability` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `maximum_recovery_limit` SET TAGS ('dbx_business_glossary_term' = 'Maximum Recovery Limit (MAX_RECOVERY)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `maximum_recovery_limit` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `premium_ceded` SET TAGS ('dbx_business_glossary_term' = 'Ceded Premium Amount (PREMIUM_CED)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `premium_ceded` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurer_name` SET TAGS ('dbx_business_glossary_term' = 'Reinsurer Name (REINSURER_NAME)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurer_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `specific_deductible` SET TAGS ('dbx_business_glossary_term' = 'Specific Deductible Amount (SPEC_DED)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `specific_deductible` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurance_arrangement_status` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Arrangement Status (STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurance_arrangement_status` SET TAGS ('dbx_value_regex' = 'draft|active|suspended|terminated|expired');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `reinsurance_arrangement_status` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_deductible` SET TAGS ('dbx_business_glossary_term' = 'Stop‑Loss Deductible Amount (STOP_LOSS_DED)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_deductible` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_limit` SET TAGS ('dbx_business_glossary_term' = 'Stop‑Loss Limit Amount (STOP_LOSS_LIMIT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_limit` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_threshold` SET TAGS ('dbx_business_glossary_term' = 'Stop‑Loss Threshold Amount (STOP_LOSS_THRESHOLD)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_threshold` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_type` SET TAGS ('dbx_business_glossary_term' = 'Stop‑Loss Type (STOP_LOSS_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `stop_loss_type` SET TAGS ('dbx_value_regex' = 'specific|aggregate');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `treaty_terms` SET TAGS ('dbx_business_glossary_term' = 'Treaty Terms Description (TREATY_TERMS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `treaty_terms` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `treaty_type` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Treaty Type (TREATY_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `treaty_type` SET TAGS ('dbx_value_regex' = 'quota_share|excess_of_loss|aggregate_stop_loss|specific_stop_loss');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_arrangement` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Last Updated Timestamp (UPDATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` SET TAGS ('dbx_subdomain' = 'reinsurance_protection');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_business_glossary_term' = 'Claimant Identifier (CLAIMANT_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `reinsurance_arrangement_id` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Arrangement Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `reinsurance_arrangement_id` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `acknowledgment_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Acknowledgment Timestamp (ACKNOWLEDGMENT_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `attachment_point_amount` SET TAGS ('dbx_business_glossary_term' = 'Attachment Point Amount (ATTACHMENT_POINT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claim_number` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Claim Number (CLAIM_NUMBER)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claim_status` SET TAGS ('dbx_business_glossary_term' = 'Claim Status (CLAIM_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claim_status` SET TAGS ('dbx_value_regex' = 'open|closed|cancelled|pending');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claim_type` SET TAGS ('dbx_business_glossary_term' = 'Claim Type (CLAIM_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claim_type` SET TAGS ('dbx_value_regex' = 'stop_loss|specific');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claimant_type` SET TAGS ('dbx_business_glossary_term' = 'Claimant Type (CLAIMANT_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `claimant_type` SET TAGS ('dbx_value_regex' = 'member|group');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `covered_end_date` SET TAGS ('dbx_business_glossary_term' = 'Coverage End Date (COVERED_END_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `covered_start_date` SET TAGS ('dbx_business_glossary_term' = 'Coverage Start Date (COVERED_START_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp (CREATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (CURRENCY_CODE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `is_aggregated` SET TAGS ('dbx_business_glossary_term' = 'Is Aggregated (IS_AGGREGATED)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `loss_category` SET TAGS ('dbx_business_glossary_term' = 'Loss Category (LOSS_CATEGORY)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `loss_category` SET TAGS ('dbx_value_regex' = 'medical|dental|vision|pharmacy|hospital|other');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `loss_description` SET TAGS ('dbx_business_glossary_term' = 'Loss Description (LOSS_DESCRIPTION)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Adjuster Notes (NOTES)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `payment_received_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Payment Received Timestamp (PAYMENT_RECEIVED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `recoverable_amount` SET TAGS ('dbx_business_glossary_term' = 'Recoverable Amount (RECOVERABLE_AMOUNT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `recovery_status` SET TAGS ('dbx_business_glossary_term' = 'Recovery Status (RECOVERY_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `recovery_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected|paid');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reporting Flag (REGULATORY_REPORTING)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `reporting_period` SET TAGS ('dbx_business_glossary_term' = 'Reporting Period (REPORTING_PERIOD)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `reporting_period` SET TAGS ('dbx_value_regex' = 'Q1|Q2|Q3|Q4|Annual');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `reporting_period` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `submission_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Submission Timestamp (SUBMISSION_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `total_incurred_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Incurred Amount (TOTAL_INCURRED)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`reinsurance_claim` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp (UPDATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` SET TAGS ('dbx_subdomain' = 'actuarial_modeling');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `rbc_calculation_id` SET TAGS ('dbx_business_glossary_term' = 'Risk-Based Capital (RBC) Calculation ID');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `action_threshold_status` SET TAGS ('dbx_value_regex' = 'no_action|company_action|regulatory_action|authorized_control|mandatory_control');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `calculation_method` SET TAGS ('dbx_business_glossary_term' = 'RBC Calculation Method');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `calculation_method` SET TAGS ('dbx_value_regex' = 'standard|custom');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `calculation_number` SET TAGS ('dbx_business_glossary_term' = 'RBC Calculation Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `calculation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'RBC Calculation Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `company_code` SET TAGS ('dbx_business_glossary_term' = 'Company ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `h0_asset_risk` SET TAGS ('dbx_business_glossary_term' = 'H0 Asset Risk Charge');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `h1_underwriting_risk` SET TAGS ('dbx_business_glossary_term' = 'H1 Underwriting Risk Charge');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `h1_underwriting_risk` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `h2_credit_risk` SET TAGS ('dbx_business_glossary_term' = 'H2 Credit Risk Charge');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `h3_business_risk` SET TAGS ('dbx_business_glossary_term' = 'H3 Business Risk Charge');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `h4_admin_expense_risk` SET TAGS ('dbx_business_glossary_term' = 'H4 Administrative Expense Risk Charge');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'RBC Calculation Notes');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `rbc_status` SET TAGS ('dbx_value_regex' = 'no_action|company_action|regulatory_action|authorized_control|mandatory_control');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `total_adjusted_capital` SET TAGS ('dbx_business_glossary_term' = 'Total Adjusted Capital (TAC)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`rbc_calculation` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` SET TAGS ('dbx_subdomain' = 'reinsurance_protection');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `adjustment_payment_id` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Payment Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approver Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Contract Identifier (PCI)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (Member_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `adjustment_amount` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Amount (AA)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `adjustment_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `adjustment_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Reason Code (ARC)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `adjustment_reason_description` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Reason Description (ARD)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `business_event_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Business Event Timestamp (BET)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `cms_notification_date` SET TAGS ('dbx_business_glossary_term' = 'CMS Notification Date (CMSND)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (CC)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `gross_amount` SET TAGS ('dbx_business_glossary_term' = 'Gross Payment Amount (GPA)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `gross_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_business_glossary_term' = 'Lifecycle Status (LFS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|processed|closed|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `net_amount` SET TAGS ('dbx_business_glossary_term' = 'Net Payment Amount (NPA)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `net_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_effective_date` SET TAGS ('dbx_business_glossary_term' = 'Payment Effective Date (PED)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payment Method (PMTH)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'electronic_fund_transfer|check|wire');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_source` SET TAGS ('dbx_business_glossary_term' = 'Payment Source (PSRC)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_source` SET TAGS ('dbx_value_regex' = 'CMS|Internal|Third_Party');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_status` SET TAGS ('dbx_business_glossary_term' = 'Payment Status (PS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_status` SET TAGS ('dbx_value_regex' = 'pending|received|reconciled|rejected|adjusted');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_type` SET TAGS ('dbx_business_glossary_term' = 'Payment Type (PTYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_type` SET TAGS ('dbx_value_regex' = 'receipt|charge');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `payment_year` SET TAGS ('dbx_business_glossary_term' = 'Payment Year (PY)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `processing_date` SET TAGS ('dbx_business_glossary_term' = 'Processing Date (PD)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `program_type` SET TAGS ('dbx_business_glossary_term' = 'Program Type (PT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `program_type` SET TAGS ('dbx_value_regex' = 'ACA_Risk_Adjustment|Medicare_Advantage|Reinsurance|CSR');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `reconciliation_flag` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Flag (RF)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `record_audit_created` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (RCT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `record_audit_updated` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp (RUT)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`adjustment_payment` ALTER COLUMN `risk_score` SET TAGS ('dbx_business_glossary_term' = 'Risk Score (RS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` SET TAGS ('dbx_subdomain' = 'score_management');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `prospective_risk_model_id` SET TAGS ('dbx_business_glossary_term' = 'Prospective Risk Model Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Model Owner');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `prospective_risk_model_description` SET TAGS ('dbx_business_glossary_term' = 'Model Description');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective From Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Effective Until Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `input_period_end` SET TAGS ('dbx_business_glossary_term' = 'Input Data Period End');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `input_period_start` SET TAGS ('dbx_business_glossary_term' = 'Input Data Period Start');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `is_production` SET TAGS ('dbx_business_glossary_term' = 'Production Flag');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `last_run_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Model Run Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `model_code` SET TAGS ('dbx_business_glossary_term' = 'Risk Model Code');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `model_name` SET TAGS ('dbx_business_glossary_term' = 'Risk Model Name');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `model_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `model_status` SET TAGS ('dbx_value_regex' = 'active|inactive|draft|pending|deprecated');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `population_segment` SET TAGS ('dbx_value_regex' = 'Medicare|Medicaid|Commercial|EmployerGroup');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `risk_model_type` SET TAGS ('dbx_value_regex' = 'CMS-HCC|RxHCC|HHS-HCC|CDPS');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `risk_score_max` SET TAGS ('dbx_business_glossary_term' = 'Maximum Expected Risk Score');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `risk_score_min` SET TAGS ('dbx_business_glossary_term' = 'Minimum Expected Risk Score');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `run_date` SET TAGS ('dbx_business_glossary_term' = 'Model Run Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`prospective_risk_model` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Model Version Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`score_run` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Actuarial Sign‑off User Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`score_run` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`score_run` ALTER COLUMN `model_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`radv_audit` SET TAGS ('dbx_subdomain' = 'score_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`radv_audit` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Created By');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`radv_audit` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`radv_audit` ALTER COLUMN `contract_number` SET TAGS ('dbx_business_glossary_term' = 'CMS Contract Number (CN)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` SET TAGS ('dbx_subdomain' = 'actuarial_modeling');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Pool Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `reinsurance_arrangement_id` SET TAGS ('dbx_business_glossary_term' = 'Reinsurance Arrangement Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `reinsurance_arrangement_id` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_code` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Code');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `geographic_scope` SET TAGS ('dbx_business_glossary_term' = 'Geographic Scope (ISO 3166-1 Alpha-3)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `geographic_scope` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `is_excluded_from_mlr` SET TAGS ('dbx_business_glossary_term' = 'MLR Exclusion Flag');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `line_of_business` SET TAGS ('dbx_business_glossary_term' = 'Line of Business (LOB)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `line_of_business` SET TAGS ('dbx_value_regex' = 'individual|group|medicare|medicaid|exchange');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `market_segment` SET TAGS ('dbx_value_regex' = 'commercial|government|individual|small_group|large_group');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_name` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Name');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pmpm` SET TAGS ('dbx_business_glossary_term' = 'Pool Per Member Per Month (PMPM)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `regulatory_basis` SET TAGS ('dbx_value_regex' = 'ACA|CMS|State');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `risk_score_stddev` SET TAGS ('dbx_business_glossary_term' = 'Risk Score Standard Deviation');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `state_code` SET TAGS ('dbx_business_glossary_term' = 'State Code (ISO 3166-2)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `state_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{2}$');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_status` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Status');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_status` SET TAGS ('dbx_value_regex' = 'active|inactive|closed|pending|suspended');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `total_incurred_claims` SET TAGS ('dbx_business_glossary_term' = 'Total Incurred Claims Amount');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `total_paid_claims` SET TAGS ('dbx_business_glossary_term' = 'Total Paid Claims Amount');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_type` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Type');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `pool_type` SET TAGS ('dbx_value_regex' = 'single|merged|small_group|large_group|individual');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`pool` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` SET TAGS ('dbx_subdomain' = 'actuarial_modeling');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_id` SET TAGS ('dbx_business_glossary_term' = 'Actuarial Assumption Set Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_signoff_date` SET TAGS ('dbx_business_glossary_term' = 'Actuarial Sign‑off Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_signoff_name` SET TAGS ('dbx_business_glossary_term' = 'Actuarial Sign‑off Name');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_signoff_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_signoff_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Approval Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_code` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Code');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `data_source` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Data Source');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `is_peer_reviewed` SET TAGS ('dbx_business_glossary_term' = 'Peer Review Completed Indicator');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `is_regulatory_compliant` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Compliance Indicator');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `lapse_rate` SET TAGS ('dbx_business_glossary_term' = 'Policy Lapse Rate');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `loss_development_factor_age_to_age` SET TAGS ('dbx_business_glossary_term' = 'Age‑to‑Age Loss Development Factor');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `loss_development_factor_cumulative` SET TAGS ('dbx_business_glossary_term' = 'Cumulative Loss Development Factor');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `methodology_description` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Methodology');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_name` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Name');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Notes');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `peer_review_status` SET TAGS ('dbx_value_regex' = 'not_started|in_progress|completed|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `purpose` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Purpose');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_status` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Status');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_status` SET TAGS ('dbx_value_regex' = 'draft|active|inactive|retired|pending_approval');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `trend_rate_medical_cost` SET TAGS ('dbx_business_glossary_term' = 'Medical Cost Trend Rate');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `trend_rate_pharmacy` SET TAGS ('dbx_business_glossary_term' = 'Pharmacy Trend Rate');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `trend_rate_utilization` SET TAGS ('dbx_business_glossary_term' = 'Utilization Trend Rate');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_type` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Type');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `actuarial_assumption_set_type` SET TAGS ('dbx_value_regex' = 'trend|loss_development|credibility|mortality|lapse|pharmacy_trend');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `updated_by` SET TAGS ('dbx_business_glossary_term' = 'Record Updated By');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `updated_by` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `updated_by` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Assumption Set Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Record Created By');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `created_by` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`actuarial_assumption_set` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` SET TAGS ('dbx_subdomain' = 'reinsurance_protection');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `audit_engagement_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Engagement Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `delegated_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Delegated Credentialing Entity Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Underwriter Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_business_glossary_term' = 'Applicant Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `record_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Credential Record Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `employer_underwriting_case_id` SET TAGS ('dbx_ssot_reference' = 'employer.employer_underwriting_case');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `age_gender_distribution_index` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `applicant_type` SET TAGS ('dbx_value_regex' = 'individual|group|small_group|large_group');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `is_self_insured` SET TAGS ('dbx_business_glossary_term' = 'Self-Insured Flag');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `lob` SET TAGS ('dbx_business_glossary_term' = 'Line of Business (LOB)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `medical_underwriting_status` SET TAGS ('dbx_value_regex' = 'cleared|pending|exempt|rejected');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `medical_underwriting_status` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Underwriting Case Number (UCN)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `number` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `premium_rate_type` SET TAGS ('dbx_value_regex' = 'fixed|per_member|per_employee');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `rating_period` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `regulatory_submission_status` SET TAGS ('dbx_value_regex' = 'not_submitted|submitted|accepted|rejected');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `reinsurance_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `review_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `risk_classification` SET TAGS ('dbx_value_regex' = 'low|medium|high|very_high');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `risk_underwriting_case_status` SET TAGS ('dbx_business_glossary_term' = 'Underwriting Case Status');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `risk_underwriting_case_status` SET TAGS ('dbx_value_regex' = 'pending|approved|declined|rated|withdrawn');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `risk_underwriting_case_status` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `underwriting_rule_set` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `underwriting_tier` SET TAGS ('dbx_value_regex' = 'tier1|tier2|tier3|tier4');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `underwriting_tier` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_underwriting_case` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` SET TAGS ('dbx_subdomain' = 'reinsurance_protection');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `risk_cms_submission_id` SET TAGS ('dbx_business_glossary_term' = 'Cms Submission Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Submission User ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `cms_acknowledgment_status` SET TAGS ('dbx_value_regex' = 'received|processed|accepted|rejected|pending');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `contract_number` SET TAGS ('dbx_business_glossary_term' = 'Contract / PBP Number');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = 'USD|EUR|GBP|CAD|JPY');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `encounter_type` SET TAGS ('dbx_value_regex' = 'inpatient|outpatient|professional|pharmacy|other');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `record_count` SET TAGS ('dbx_business_glossary_term' = 'Total Record Count');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `risk_adjustment_factor` SET TAGS ('dbx_business_glossary_term' = 'Risk Adjustment Factor (HCC)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `risk_adjustment_score` SET TAGS ('dbx_business_glossary_term' = 'Risk Adjustment Score (RAF)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_batch_number` SET TAGS ('dbx_business_glossary_term' = 'Submission Batch Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_checksum` SET TAGS ('dbx_business_glossary_term' = 'Submission Checksum (MD5)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_file_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_file_size` SET TAGS ('dbx_business_glossary_term' = 'Submission File Size (bytes)');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_status` SET TAGS ('dbx_value_regex' = 'pending|submitted|accepted|rejected|error');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_type` SET TAGS ('dbx_business_glossary_term' = 'Submission Type (RAPS/EDPS)');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `submission_type` SET TAGS ('dbx_value_regex' = 'RAPS|EDPS');
...
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `transition_flag` SET TAGS ('dbx_business_glossary_term' = 'RAPS-to-EDPS Transition Flag');
ALTER TABLE `vibe_health_insurance_v1`.`risk`.`risk_cms_submission` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
