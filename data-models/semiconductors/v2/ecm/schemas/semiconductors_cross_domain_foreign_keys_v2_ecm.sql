...
-- Generated on: 2026-06-24 00:02:30
-- Total cross-domain FK constraints: 1348
--
-- EXECUTION ORDER:
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`export_license_usage` ADD CONSTRAINT `fk_compliance_export_license_usage_fabrication_wafer_lot_id` FOREIGN KEY (`fabrication_wafer_lot_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot`(`fabrication_wafer_lot_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`technology_control_plan` ADD CONSTRAINT `fk_compliance_technology_control_plan_fabrication_technology_node_id` FOREIGN KEY (`fabrication_technology_node_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_technology_node`(`fabrication_technology_node_id`);

-- ========= compliance --> product (1 constraint(s)) =========
-- Requires: compliance schema, product schema
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`technology_control_plan` ADD CONSTRAINT `fk_compliance_technology_control_plan_process_node_id` FOREIGN KEY (`process_node_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`process_node`(`process_node_id`);

-- ========= compliance --> quality (1 constraint(s)) =========
-- Requires: compliance schema, quality schema
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`compliance_audit_finding` ADD CONSTRAINT `fk_compliance_compliance_audit_finding_quality_audit_finding_id` FOREIGN KEY (`quality_audit_finding_id`) REFERENCES `vibe_semiconductors_v1`.`quality`.`quality_audit_finding`(`quality_audit_finding_id`);

-- ========= compliance --> sales (1 constraint(s)) =========
-- Requires: compliance schema, sales schema
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`restricted_party_screening` ADD CONSTRAINT `fk_compliance_restricted_party_screening_channel_partner_id` FOREIGN KEY (`channel_partner_id`) REFERENCES `vibe_semiconductors_v1`.`sales`.`channel_partner`(`channel_partner_id`);

-- ========= compliance --> shared (16 constraint(s)) =========
-- Requires: compliance schema, shared schema
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`export_license` ADD CONSTRAINT `fk_compliance_export_license_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`export_license_usage` ADD CONSTRAINT `fk_compliance_export_license_usage_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`eccn_classification` ADD CONSTRAINT `fk_compliance_eccn_classification_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`restricted_party_screening` ADD CONSTRAINT `fk_compliance_restricted_party_screening_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`reach_svhc_declaration` ADD CONSTRAINT `fk_compliance_reach_svhc_declaration_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`substance_inventory` ADD CONSTRAINT `fk_compliance_substance_inventory_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`compliance_audit_finding` ADD CONSTRAINT `fk_compliance_compliance_audit_finding_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`conflict_minerals_declaration` ADD CONSTRAINT `fk_compliance_conflict_minerals_declaration_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`trade_compliance_hold` ADD CONSTRAINT `fk_compliance_trade_compliance_hold_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`declaration_substance` ADD CONSTRAINT `fk_compliance_declaration_substance_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);

-- ========= compliance --> supply (2 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`regulatory_filing` ADD CONSTRAINT `fk_compliance_regulatory_filing_test_program_id` FOREIGN KEY (`test_program_id`) REFERENCES `vibe_semiconductors_v1`.`test`.`test_program`(`test_program_id`);

-- ========= compliance --> workforce (19 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`certification` ADD CONSTRAINT `fk_compliance_certification_owner_employee_id` FOREIGN KEY (`owner_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`audit_event` ADD CONSTRAINT `fk_compliance_audit_event_primary_lead_auditor_employee_id` FOREIGN KEY (`primary_lead_auditor_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`regulatory_filing` ADD CONSTRAINT `fk_compliance_regulatory_filing_regulatory_submitter_employee_id` FOREIGN KEY (`regulatory_submitter_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`trade_compliance_hold` ADD CONSTRAINT `fk_compliance_trade_compliance_hold_trade_placed_by_employee_id` FOREIGN KEY (`trade_placed_by_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`obligation_register` ADD CONSTRAINT `fk_compliance_obligation_register_owner_employee_id` FOREIGN KEY (`owner_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`compliance`.`technology_control_plan` ADD CONSTRAINT `fk_compliance_technology_control_plan_technology_authorized_personnel_employee_id` FOREIGN KEY (`technology_authorized_personnel_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_design_registration` ADD CONSTRAINT `fk_customer_customer_design_registration_fab_tool_id` FOREIGN KEY (`fab_tool_id`) REFERENCES `vibe_semiconductors_v1`.`equipment`.`fab_tool`(`fab_tool_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`account` ADD CONSTRAINT `fk_customer_account_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_design_registration` ADD CONSTRAINT `fk_customer_customer_design_registration_project_id` FOREIGN KEY (`project_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`project`(`project_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_ltb_notification` ADD CONSTRAINT `fk_customer_customer_ltb_notification_technology_roadmap_id` FOREIGN KEY (`technology_roadmap_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`technology_roadmap`(`technology_roadmap_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`contact` ADD CONSTRAINT `fk_customer_contact_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`design`.`tapeout` ADD CONSTRAINT `fk_design_tapeout_chips_act_obligation_id` FOREIGN KEY (`chips_act_obligation_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`chips_act_obligation`(`chips_act_obligation_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`design`.`eda_tool` ADD CONSTRAINT `fk_design_eda_tool_certification_id` FOREIGN KEY (`certification_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`certification`(`certification_id`);
ALTER TABLE `vibe_semiconductors_v1`.`design`.`rule_set` ADD CONSTRAINT `fk_design_rule_set_certification_id` FOREIGN KEY (`certification_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`certification`(`certification_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`design`.`verification_plan` ADD CONSTRAINT `fk_design_verification_plan_budget_plan_id` FOREIGN KEY (`budget_plan_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`budget_plan`(`budget_plan_id`);
...
-- ========= design --> workforce (16 constraint(s)) =========
...
-- ========= equipment --> compliance (8 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`recipe_execution` ADD CONSTRAINT `fk_equipment_recipe_execution_eccn_classification_id` FOREIGN KEY (`eccn_classification_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`eccn_classification`(`eccn_classification_id`);
...
-- ========= equipment --> fabrication (11 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_event` ADD CONSTRAINT `fk_equipment_maintenance_event_ar_invoice_id` FOREIGN KEY (`ar_invoice_id`) REFERENCES `vibe_semiconductors_v1`.`invoice`.`ar_invoice`(`ar_invoice_id`);
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`recipe_execution` ADD CONSTRAINT `fk_equipment_recipe_execution_invoice_line_id` FOREIGN KEY (`invoice_line_id`) REFERENCES `vibe_semiconductors_v1`.`invoice`.`invoice_line`(`invoice_line_id`);
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` ADD CONSTRAINT `fk_equipment_tool_warranty_ar_invoice_id` FOREIGN KEY (`ar_invoice_id`) REFERENCES `vibe_semiconductors_v1`.`invoice`.`ar_invoice`(`ar_invoice_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` ADD CONSTRAINT `fk_equipment_maintenance_contract_vendor_supplier_id` FOREIGN KEY (`vendor_supplier_id`) REFERENCES `vibe_semiconductors_v1`.`supply`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot` ADD CONSTRAINT `fk_fabrication_fabrication_wafer_lot_customer_design_win_id` FOREIGN KEY (`customer_design_win_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`customer_design_win`(`customer_design_win_id`);
...
-- ========= fabrication --> invoice (1 constraint(s)) =========
-- Requires: fabrication schema, invoice schema
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`equipment_run` ADD CONSTRAINT `fk_fabrication_equipment_run_ar_invoice_id` FOREIGN KEY (`ar_invoice_id`) REFERENCES `vibe_semiconductors_v1`.`invoice`.`ar_invoice`(`ar_invoice_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`fabrication_lot_genealogy` ADD CONSTRAINT `fk_fabrication_fabrication_lot_genealogy_order_id` FOREIGN KEY (`order_id`) REFERENCES `vibe_semiconductors_v1`.`order`.`order`(`order_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`equipment_run` ADD CONSTRAINT `fk_fabrication_equipment_run_cooling_optimization_run_id` FOREIGN KEY (`cooling_optimization_run_id`) REFERENCES `vibe_semiconductors_v1`.`process`.`cooling_optimization_run`(`cooling_optimization_run_id`);
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`equipment_run` ADD CONSTRAINT `fk_fabrication_equipment_run_cooling_process_id` FOREIGN KEY (`cooling_process_id`) REFERENCES `vibe_semiconductors_v1`.`process`.`cooling_process`(`cooling_process_id`);
...
-- ========= fabrication --> research (1 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot` ADD CONSTRAINT `fk_fabrication_fabrication_wafer_lot_quote_id` FOREIGN KEY (`quote_id`) REFERENCES `vibe_semiconductors_v1`.`sales`.`quote`(`quote_id`);
...
-- ========= fabrication --> supply (4 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`fabrication`.`fab_run_card` ADD CONSTRAINT `fk_fabrication_fab_run_card_purchase_order_id` FOREIGN KEY (`purchase_order_id`) REFERENCES `vibe_semiconductors_v1`.`supply`.`purchase_order`(`purchase_order_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_account_id` FOREIGN KEY (`account_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`account`(`account_id`);
...
-- ========= finance --> equipment (3 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` ADD CONSTRAINT `fk_finance_asset_depreciation_equipment_fab_id` FOREIGN KEY (`equipment_fab_id`) REFERENCES `vibe_semiconductors_v1`.`equipment`.`equipment_fab`(`equipment_fab_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ADD CONSTRAINT `fk_finance_cost_center_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ADD CONSTRAINT `fk_finance_cost_center_primary_cost_employee_id` FOREIGN KEY (`primary_cost_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= inventory --> equipment (4 constraint(s)) =========
...
-- ========= inventory --> fabrication (14 constraint(s)) =========
-- Requires: inventory schema, fabrication schema
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ADD CONSTRAINT `fk_inventory_inventory_wafer_lot_fab_run_card_id` FOREIGN KEY (`fab_run_card_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fab_run_card`(`fab_run_card_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ADD CONSTRAINT `fk_inventory_inventory_wafer_lot_work_center_id` FOREIGN KEY (`work_center_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`work_center`(`work_center_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ADD CONSTRAINT `fk_inventory_inventory_wafer_lot_wafer_start_authorization_id` FOREIGN KEY (`wafer_start_authorization_id`) REFERENCES `vibe_semiconductors_v1`.`order`.`wafer_start_authorization`(`wafer_start_authorization_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_valuation` ADD CONSTRAINT `fk_inventory_stock_valuation_channel_partner_id` FOREIGN KEY (`channel_partner_id`) REFERENCES `vibe_semiconductors_v1`.`sales`.`channel_partner`(`channel_partner_id`);

-- ========= inventory --> shared (1 constraint(s)) =========
-- Requires: inventory schema, shared schema
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`raw_material` ADD CONSTRAINT `fk_inventory_raw_material_unit_of_measure_id` FOREIGN KEY (`unit_of_measure_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`unit_of_measure`(`unit_of_measure_id`);
...
-- ========= invoice --> compliance (4 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`invoice`.`invoice_line` ADD CONSTRAINT `fk_invoice_invoice_line_reach_svhc_declaration_id` FOREIGN KEY (`reach_svhc_declaration_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`reach_svhc_declaration`(`reach_svhc_declaration_id`);
...
-- ========= invoice --> product (5 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`invoice`.`invoice_line` ADD CONSTRAINT `fk_invoice_invoice_line_defect_record_id` FOREIGN KEY (`defect_record_id`) REFERENCES `vibe_semiconductors_v1`.`quality`.`defect_record`(`defect_record_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`invoice`.`invoice_line` ADD CONSTRAINT `fk_invoice_invoice_line_yield_record_id` FOREIGN KEY (`yield_record_id`) REFERENCES `vibe_semiconductors_v1`.`quality`.`yield_record`(`yield_record_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`invoice`.`ar_invoice` ADD CONSTRAINT `fk_invoice_ar_invoice_test_program_id` FOREIGN KEY (`test_program_id`) REFERENCES `vibe_semiconductors_v1`.`test`.`test_program`(`test_program_id`);
...
-- ========= order --> equipment (1 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_nre_milestone` ADD CONSTRAINT `fk_order_order_nre_milestone_finance_nre_milestone_id` FOREIGN KEY (`finance_nre_milestone_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone`(`finance_nre_milestone_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_line` ADD CONSTRAINT `fk_order_order_line_invoice_line_id` FOREIGN KEY (`invoice_line_id`) REFERENCES `vibe_semiconductors_v1`.`invoice`.`invoice_line`(`invoice_line_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_line` ADD CONSTRAINT `fk_order_order_line_project_id` FOREIGN KEY (`project_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`project`(`project_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ADD CONSTRAINT `fk_packaging_assembly_lot_fabrication_wafer_lot_id` FOREIGN KEY (`fabrication_wafer_lot_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot`(`fabrication_wafer_lot_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ADD CONSTRAINT `fk_packaging_assembly_change_notice_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order` ADD CONSTRAINT `fk_packaging_assembly_order_order_id` FOREIGN KEY (`order_id`) REFERENCES `vibe_semiconductors_v1`.`order`.`order`(`order_id`);
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ADD CONSTRAINT `fk_packaging_assembly_lot_order_id` FOREIGN KEY (`order_id`) REFERENCES `vibe_semiconductors_v1`.`order`.`order`(`order_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order` ADD CONSTRAINT `fk_packaging_assembly_order_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`sku`(`sku_id`);
...
-- ========= packaging --> quality (5 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order` ADD CONSTRAINT `fk_packaging_assembly_order_test_program_id` FOREIGN KEY (`test_program_id`) REFERENCES `vibe_semiconductors_v1`.`test`.`test_program`(`test_program_id`);
...
-- ========= packaging --> workforce (11 constraint(s)) =========
...
-- ========= process --> compliance (6 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`opc_rule_set` ADD CONSTRAINT `fk_process_opc_rule_set_eda_tool_id` FOREIGN KEY (`eda_tool_id`) REFERENCES `vibe_semiconductors_v1`.`design`.`eda_tool`(`eda_tool_id`);

-- ========= process --> equipment (18 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`cooling_optimization_run` ADD CONSTRAINT `fk_process_cooling_optimization_run_fab_tool_id` FOREIGN KEY (`fab_tool_id`) REFERENCES `vibe_semiconductors_v1`.`equipment`.`fab_tool`(`fab_tool_id`);

-- ========= process --> fabrication (55 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`spc_control_chart` ADD CONSTRAINT `fk_process_spc_control_chart_fabrication_wafer_lot_id` FOREIGN KEY (`fabrication_wafer_lot_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot`(`fabrication_wafer_lot_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`process_qualification` ADD CONSTRAINT `fk_process_process_qualification_fab_site_id` FOREIGN KEY (`fab_site_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fab_site`(`fab_site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`implant_condition` ADD CONSTRAINT `fk_process_implant_condition_photomask_id` FOREIGN KEY (`photomask_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`photomask`(`photomask_id`);
ALTER TABLE `vibe_semiconductors_v1`.`process`.`deposition_condition` ADD CONSTRAINT `fk_process_deposition_condition_fab_site_id` FOREIGN KEY (`fab_site_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fab_site`(`fab_site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`litho_condition` ADD CONSTRAINT `fk_process_litho_condition_fab_site_id` FOREIGN KEY (`fab_site_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fab_site`(`fab_site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`doe_experiment` ADD CONSTRAINT `fk_process_doe_experiment_fab_site_id` FOREIGN KEY (`fab_site_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fab_site`(`fab_site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`cooling_optimization_run` ADD CONSTRAINT `fk_process_cooling_optimization_run_fabrication_wafer_lot_id` FOREIGN KEY (`fabrication_wafer_lot_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot`(`fabrication_wafer_lot_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`recipe` ADD CONSTRAINT `fk_process_recipe_raw_material_id` FOREIGN KEY (`raw_material_id`) REFERENCES `vibe_semiconductors_v1`.`inventory`.`raw_material`(`raw_material_id`);

-- ========= process --> invoice (2 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`doe_experiment` ADD CONSTRAINT `fk_process_doe_experiment_ar_invoice_id` FOREIGN KEY (`ar_invoice_id`) REFERENCES `vibe_semiconductors_v1`.`invoice`.`ar_invoice`(`ar_invoice_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`yield_loss_event` ADD CONSTRAINT `fk_process_yield_loss_event_order_id` FOREIGN KEY (`order_id`) REFERENCES `vibe_semiconductors_v1`.`order`.`order`(`order_id`);

-- ========= process --> product (18 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`process_qualification` ADD CONSTRAINT `fk_process_process_qualification_ic_catalog_id` FOREIGN KEY (`ic_catalog_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`ic_catalog`(`ic_catalog_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`implant_condition` ADD CONSTRAINT `fk_process_implant_condition_ic_catalog_id` FOREIGN KEY (`ic_catalog_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`ic_catalog`(`ic_catalog_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`cmp_condition` ADD CONSTRAINT `fk_process_cmp_condition_ic_catalog_id` FOREIGN KEY (`ic_catalog_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`ic_catalog`(`ic_catalog_id`);
ALTER TABLE `vibe_semiconductors_v1`.`process`.`litho_condition` ADD CONSTRAINT `fk_process_litho_condition_ic_catalog_id` FOREIGN KEY (`ic_catalog_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`ic_catalog`(`ic_catalog_id`);
...
-- ========= process --> quality (1 constraint(s)) =========
...
-- ========= process --> research (6 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`cooling_optimization_run` ADD CONSTRAINT `fk_process_cooling_optimization_run_research_program_id` FOREIGN KEY (`research_program_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`research_program`(`research_program_id`);

-- ========= process --> shared (1 constraint(s)) =========
-- Requires: process schema, shared schema
ALTER TABLE `vibe_semiconductors_v1`.`process`.`process_site_map` ADD CONSTRAINT `fk_process_process_site_map_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`process_step` ADD CONSTRAINT `fk_process_process_step_position_id` FOREIGN KEY (`position_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`position`(`position_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`deposition_condition` ADD CONSTRAINT `fk_process_deposition_condition_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`process_supply_agreement` ADD CONSTRAINT `fk_process_process_supply_agreement_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`process`.`cooling_optimization_run` ADD CONSTRAINT `fk_process_cooling_optimization_run_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= product --> customer (9 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_ltb_notification` ADD CONSTRAINT `fk_product_product_ltb_notification_ssot_customer_ltb_notification_id` FOREIGN KEY (`ssot_customer_ltb_notification_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`customer_ltb_notification`(`customer_ltb_notification_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_sample_request` ADD CONSTRAINT `fk_product_product_sample_request_ssot_customer_sample_request_id` FOREIGN KEY (`ssot_customer_sample_request_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`customer_sample_request`(`customer_sample_request_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`product`.`license_allocation` ADD CONSTRAINT `fk_product_license_allocation_account_id` FOREIGN KEY (`account_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`account`(`account_id`);
...
-- ========= product --> shared (17 constraint(s)) =========
-- Requires: product schema, shared schema
ALTER TABLE `vibe_semiconductors_v1`.`product`.`ic_catalog` ADD CONSTRAINT `fk_product_ic_catalog_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`sku` ADD CONSTRAINT `fk_product_sku_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`family` ADD CONSTRAINT `fk_product_family_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`process_node` ADD CONSTRAINT `fk_product_process_node_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_spec` ADD CONSTRAINT `fk_product_product_spec_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`bom` ADD CONSTRAINT `fk_product_bom_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`bom_line` ADD CONSTRAINT `fk_product_bom_line_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`pcn` ADD CONSTRAINT `fk_product_pcn_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_ltb_notification` ADD CONSTRAINT `fk_product_product_ltb_notification_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_ip_core` ADD CONSTRAINT `fk_product_product_ip_core_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_qualification_program` ADD CONSTRAINT `fk_product_product_qualification_program_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`compliance_cert` ADD CONSTRAINT `fk_product_compliance_cert_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`errata` ADD CONSTRAINT `fk_product_errata_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`configuration_rule` ADD CONSTRAINT `fk_product_configuration_rule_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`site`(`site_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`product_sample_request` ADD CONSTRAINT `fk_product_product_sample_request_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`license_agreement` ADD CONSTRAINT `fk_product_license_agreement_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`license_allocation` ADD CONSTRAINT `fk_product_license_allocation_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`product`.`license_agreement` ADD CONSTRAINT `fk_product_license_agreement_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_semiconductors_v1`.`product`.`license_allocation` ADD CONSTRAINT `fk_product_license_allocation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);

-- ========= quality --> compliance (6 constraint(s)) =========
-- Requires: quality schema, compliance schema
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` ADD CONSTRAINT `fk_quality_inspection_lot_export_license_id` FOREIGN KEY (`export_license_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`export_license`(`export_license_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` ADD CONSTRAINT `fk_quality_nonconformance_report_export_license_id` FOREIGN KEY (`export_license_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`export_license`(`export_license_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` ADD CONSTRAINT `fk_quality_quality_audit_finding_compliance_audit_finding_id` FOREIGN KEY (`compliance_audit_finding_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`compliance_audit_finding`(`compliance_audit_finding_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` ADD CONSTRAINT `fk_quality_inspection_lot_ic_design_project_id` FOREIGN KEY (`ic_design_project_id`) REFERENCES `vibe_semiconductors_v1`.`design`.`ic_design_project`(`ic_design_project_id`);
...
-- ========= quality --> fabrication (23 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` ADD CONSTRAINT `fk_quality_spc_chart_wafer_id` FOREIGN KEY (`wafer_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`wafer`(`wafer_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`yield_record` ADD CONSTRAINT `fk_quality_yield_record_profit_center_id` FOREIGN KEY (`profit_center_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`profit_center`(`profit_center_id`);
...
-- ========= quality --> process (15 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` ADD CONSTRAINT `fk_quality_quality_qualification_program_product_qualification_program_id` FOREIGN KEY (`product_qualification_program_id`) REFERENCES `vibe_semiconductors_v1`.`product`.`product_qualification_program`(`product_qualification_program_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` ADD CONSTRAINT `fk_quality_quality_kgd_certification_research_program_id` FOREIGN KEY (`research_program_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`research_program`(`research_program_id`);
...
-- ========= quality --> workforce (29 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` ADD CONSTRAINT `fk_quality_audit_auditor_employee_id` FOREIGN KEY (`auditor_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` ADD CONSTRAINT `fk_quality_quality_hold_quality_employee_id` FOREIGN KEY (`quality_employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= research --> design (3 constraint(s)) =========
...
-- ========= research --> fabrication (13 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_technology_node` ADD CONSTRAINT `fk_research_research_technology_node_fabrication_technology_node_id` FOREIGN KEY (`fabrication_technology_node_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_technology_node`(`fabrication_technology_node_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_integration_run` ADD CONSTRAINT `fk_research_process_integration_run_fabrication_wafer_lot_id` FOREIGN KEY (`fabrication_wafer_lot_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_wafer_lot`(`fabrication_wafer_lot_id`);
...
-- ========= research --> product (8 constraint(s)) =========
...
-- ========= research --> shared (1 constraint(s)) =========
-- Requires: research schema, shared schema
ALTER TABLE `vibe_semiconductors_v1`.`research`.`program_partner_collaboration` ADD CONSTRAINT `fk_research_program_partner_collaboration_currency_id` FOREIGN KEY (`currency_id`) REFERENCES `vibe_semiconductors_v1`.`shared`.`currency`(`currency_id`);

-- ========= research --> supply (2 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`program_partner_collaboration` ADD CONSTRAINT `fk_research_program_partner_collaboration_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_semiconductors_v1`.`supply`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`program_partner_collaboration` ADD CONSTRAINT `fk_research_program_partner_collaboration_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= sales --> customer (17 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_forecast` ADD CONSTRAINT `fk_sales_sales_forecast_fab_tool_id` FOREIGN KEY (`fab_tool_id`) REFERENCES `vibe_semiconductors_v1`.`equipment`.`fab_tool`(`fab_tool_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_design_win` ADD CONSTRAINT `fk_sales_sales_design_win_finished_good_id` FOREIGN KEY (`finished_good_id`) REFERENCES `vibe_semiconductors_v1`.`inventory`.`finished_good`(`finished_good_id`);
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`booking` ADD CONSTRAINT `fk_sales_booking_inventory_wafer_lot_id` FOREIGN KEY (`inventory_wafer_lot_id`) REFERENCES `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot`(`inventory_wafer_lot_id`);
...
-- ========= sales --> process (7 constraint(s)) =========
-- Requires: sales schema, process schema
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`opportunity` ADD CONSTRAINT `fk_sales_opportunity_process_flow_id` FOREIGN KEY (`process_flow_id`) REFERENCES `vibe_semiconductors_v1`.`process`.`process_flow`(`process_flow_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_design_registration` ADD CONSTRAINT `fk_sales_sales_design_registration_process_flow_id` FOREIGN KEY (`process_flow_id`) REFERENCES `vibe_semiconductors_v1`.`process`.`process_flow`(`process_flow_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`activity` ADD CONSTRAINT `fk_sales_activity_experimental_lot_id` FOREIGN KEY (`experimental_lot_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`experimental_lot`(`experimental_lot_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`activity` ADD CONSTRAINT `fk_sales_activity_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_semiconductors_v1`.`supply`.`material_master`(`material_master_id`);

-- ========= sales --> test (1 constraint(s)) =========
-- Requires: sales schema, test schema
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`quote_line` ADD CONSTRAINT `fk_sales_quote_line_test_program_id` FOREIGN KEY (`test_program_id`) REFERENCES `vibe_semiconductors_v1`.`test`.`test_program`(`test_program_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`goods_receipt` ADD CONSTRAINT `fk_supply_goods_receipt_export_license_usage_id` FOREIGN KEY (`export_license_usage_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`export_license_usage`(`export_license_usage_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`goods_receipt` ADD CONSTRAINT `fk_supply_goods_receipt_account_id` FOREIGN KEY (`account_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`account`(`account_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`supplier_scorecard` ADD CONSTRAINT `fk_supply_supplier_scorecard_account_id` FOREIGN KEY (`account_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`account`(`account_id`);
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`disruption_event` ADD CONSTRAINT `fk_supply_disruption_event_account_id` FOREIGN KEY (`account_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`account`(`account_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`purchase_order` ADD CONSTRAINT `fk_supply_purchase_order_order_id` FOREIGN KEY (`order_id`) REFERENCES `vibe_semiconductors_v1`.`order`.`order`(`order_id`);

-- ========= supply --> product (3 constraint(s)) =========
...
-- ========= supply --> research (5 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`supplier_scorecard` ADD CONSTRAINT `fk_supply_supplier_scorecard_project_id` FOREIGN KEY (`project_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`project`(`project_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`supply`.`product_change_notification` ADD CONSTRAINT `fk_supply_product_change_notification_project_id` FOREIGN KEY (`project_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`project`(`project_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`insertion` ADD CONSTRAINT `fk_test_insertion_fab_tool_id` FOREIGN KEY (`fab_tool_id`) REFERENCES `vibe_semiconductors_v1`.`equipment`.`fab_tool`(`fab_tool_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`parametric_measurement` ADD CONSTRAINT `fk_test_parametric_measurement_fabrication_process_step_id` FOREIGN KEY (`fabrication_process_step_id`) REFERENCES `vibe_semiconductors_v1`.`fabrication`.`fabrication_process_step`(`fabrication_process_step_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`test_program` ADD CONSTRAINT `fk_test_test_program_finished_good_id` FOREIGN KEY (`finished_good_id`) REFERENCES `vibe_semiconductors_v1`.`inventory`.`finished_good`(`finished_good_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`final_test_run` ADD CONSTRAINT `fk_test_final_test_run_device_architecture_id` FOREIGN KEY (`device_architecture_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`device_architecture`(`device_architecture_id`);
...
-- ========= test --> workforce (11 constraint(s)) =========
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` ADD CONSTRAINT `fk_workforce_fab_operator_qualification_certification_id` FOREIGN KEY (`certification_id`) REFERENCES `vibe_semiconductors_v1`.`compliance`.`certification`(`certification_id`);
