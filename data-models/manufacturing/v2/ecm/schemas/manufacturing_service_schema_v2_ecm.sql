...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`request` (
    ...
    `warranty_expiration_date` DECIMAL(18,2) COMMENT 'Date on which the asset warranty expires.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` (
    ...
    `registration_date` DECIMAL(18,2) COMMENT 'Date when the warranty was entered into the warranty management system.',
    `registration_status` DECIMAL(18,2) COMMENT 'Indicates whether the warranty has been formally registered in the system.. Valid values are `registered|unregistered|pending`',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`service_rma` (
    ...
    `warranty_expiration_date` DECIMAL(18,2) COMMENT 'Date when the associated warranty expires.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`field_service_order` (
    ...
    `warranty_expiration_date` DECIMAL(18,2) COMMENT 'Date when the applicable warranty for the equipment expires.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`installed_base` (
    ...
    `operational_status` DECIMAL(18,2) COMMENT 'Current operational condition of the installed equipment.. Valid values are `running|degraded|stopped|decommissioned`',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`knowledge_article` (
    ...
    `parts_required` BOOLEAN COMMENT 'List of part numbers or SKUs needed for the repair.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`bulletin` (
    ...
    `sku_master_id` BIGINT COMMENT '',
    `action_required` BOOLEAN COMMENT 'Detailed description of the service action(s) that must be performed.',
    ...
    `expiration_date` DECIMAL(18,2) COMMENT 'Date after which the bulletin is no longer applicable.',
    ...
    `parts_required` BOOLEAN COMMENT 'Comma‑separated list of part numbers and quantities needed to comply.',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`service_contract_line` (
    ...
    `discount_type` DECIMAL(18,2) COMMENT 'Method used to calculate the discount.. Valid values are `percentage|fixed|none`',
    ...
    `price_unit` DECIMAL(18,2) COMMENT 'Billing unit associated with the price.. Valid values are `per_year|per_month|per_incident|per_hour|per_unit`',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`contract_line` (
    ...
    `auto_renew_flag` BOOLEAN COMMENT 'Whether this line renews automatically.',
    ...
    `coverage_type` STRING COMMENT 'Type of coverage provided (parts, labor, full, preventive).',
    ...
    `entitlement_units` DECIMAL(18,2) COMMENT 'Number of service entitlement units included on this line.',
    `last_modified_timestamp` TIMESTAMP COMMENT 'Timestamp the line was last modified.',
    `line_amount` DECIMAL(18,2) COMMENT 'Contracted amount for this line.',
    `line_number` STRING COMMENT '',
    `line_price` DECIMAL(18,2) COMMENT '',
    `line_price_amount` DECIMAL(18,2) COMMENT 'Business attribute for contract_line.',
    `line_status` STRING COMMENT '',
    `line_value` DECIMAL(18,2) COMMENT '',
    `line_value_amount` DECIMAL(18,2) COMMENT '',
    `notes` STRING COMMENT '',
    `quantity` DECIMAL(18,2) COMMENT '',
    `renewal_term_months` BIGINT COMMENT 'Renewal term length in months',
    `response_time_hours` DECIMAL(18,2) COMMENT 'Guaranteed response time in hours for this coverage.',
    `service_level` STRING COMMENT 'Service level tier applicable to this line.',
    `sla_response_hours` BIGINT COMMENT 'Contracted SLA response time in hours',
    `start_date` TIMESTAMP COMMENT '',
    `contract_line_status` STRING COMMENT 'Line status (active, expired, suspended, cancelled)',
    `unit_price` DECIMAL(18,2) COMMENT 'Unit price applied to this line.',
    `contract_line_description` STRING COMMENT 'Description of the contracted service or product',
    `line_description` STRING COMMENT 'Description of the contract line',
    `line_quantity` DECIMAL(18,2) COMMENT 'Quantity specified in the line',
    `line_unit_price` DECIMAL(18,2) COMMENT 'Unit price for the line',
    `line_total_value` DECIMAL(18,2) COMMENT 'Total value of the line',
    `line_start_date` DATE COMMENT 'Start date of the contract line',
    `line_end_date` DATE COMMENT 'End date of the contract line',
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Id (Foreign Key)');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` ALTER COLUMN `line_id` SET TAGS ('dbx_business_glossary_term' = 'Order Line Id (Foreign Key)');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` ALTER COLUMN `request_equipment_register_id` SET TAGS ('dbx_business_glossary_term' = 'Asset ID');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` ALTER COLUMN `shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Shipment Id (Foreign Key)');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` ALTER COLUMN `contact_email` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`request` ALTER COLUMN `contact_phone` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract` ALTER COLUMN `escalation_contact_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract` ALTER COLUMN `escalation_contact_phone` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract` ALTER COLUMN `manager_email` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` SET TAGS ('dbx_preserved' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` SET TAGS ('dbx_ssot_group' = 'warranty');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` SET TAGS ('dbx_ssot_role' = 'consumer');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` SET TAGS ('dbx_ssot_status' = 'resolved');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` SET TAGS ('dbx_ssot_owner' = 'asset.asset_warranty');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` ALTER COLUMN `service_warranty_id` SET TAGS ('dbx_ssot_ref' = 'asset.asset_warranty');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` ALTER COLUMN `registration_status` SET TAGS ('dbx_value_regex' = 'registered|unregistered|pending');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_rma` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`field_service_order` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`field_service_order` ALTER COLUMN `site_address` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`installed_base` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`installed_base` ALTER COLUMN `site_address` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_entitlement` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`sla_milestone` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`sla_milestone` ALTER COLUMN `request_id` SET TAGS ('dbx_business_glossary_term' = 'Service Request Identifier');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`sla_milestone` ALTER COLUMN `milestone_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `address_line1` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `address_line2` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `email_address` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `full_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `phone_number` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `phone_number` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `primary_contact_method` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer` ALTER COLUMN `primary_contact_method` SET TAGS ('dbx_mask' = 'non-prod');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`zone` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`zone` ALTER COLUMN `zone_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_capa_record` SET TAGS ('dbx_subdomain' = 'request_management');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_capa_record` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_capa_record` ALTER COLUMN `quaternary_service_preventive_action_owner_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Preventive Action Owner ID');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_capa_record` ALTER COLUMN `quaternary_service_preventive_action_owner_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_capa_record` ALTER COLUMN `quaternary_service_preventive_action_owner_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`satisfaction_survey` SET TAGS ('dbx_subdomain' = 'request_management');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`satisfaction_survey` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`satisfaction_survey` ALTER COLUMN `request_id` SET TAGS ('dbx_business_glossary_term' = 'Service Request ID');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`knowledge_article` SET TAGS ('dbx_subdomain' = 'technical_knowledge');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`knowledge_article` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`bulletin` SET TAGS ('dbx_subdomain' = 'technical_knowledge');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`bulletin` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_subdomain' = 'preventive_scheduling');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_preserved' = 'true');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_ssot_group' = 'pm_schedule');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_ssot_role' = 'consumer');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_ssot_status' = 'resolved');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_ssot_owner' = 'asset.asset_pm_schedule');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` ALTER COLUMN `service_pm_schedule_id` SET TAGS ('dbx_ssot_ref' = 'asset.asset_pm_schedule');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract_line` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract_line` ALTER COLUMN `price_unit` SET TAGS ('dbx_value_regex' = 'per_year|per_month|per_incident|per_hour|per_unit');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`remote_diagnostic_session` SET TAGS ('dbx_subdomain' = 'technical_knowledge');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`remote_diagnostic_session` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`part_consumption` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` ALTER COLUMN `coverage_type` SET TAGS ('dbx_business_glossary_term' = 'Coverage Type');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` ALTER COLUMN `entitlement_units` SET TAGS ('dbx_business_glossary_term' = 'Entitlement Units');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` ALTER COLUMN `line_amount` SET TAGS ('dbx_business_glossary_term' = 'Line Amount');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` ALTER COLUMN `response_time_hours` SET TAGS ('dbx_business_glossary_term' = 'Response Time Hours');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` ALTER COLUMN `service_level` SET TAGS ('dbx_business_glossary_term' = 'Service Level');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`engineer_assignment` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`task_checklist` SET TAGS ('dbx_subdomain' = 'preventive_scheduling');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`task_checklist` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` SET TAGS ('dbx_subdomain' = 'field_operations');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `address_line1` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `address_line2` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `email_address` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `manager_email` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `manager_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `manager_phone` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `phone_number` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` ALTER COLUMN `phone_number` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`holiday_calendar` SET TAGS ('dbx_subdomain' = 'preventive_scheduling');
ALTER TABLE `vibe_manufacturing_v1`.`service`.`holiday_calendar` SET TAGS ('dbx_preserved' = 'true');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`holiday_calendar` ALTER COLUMN `holiday_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
