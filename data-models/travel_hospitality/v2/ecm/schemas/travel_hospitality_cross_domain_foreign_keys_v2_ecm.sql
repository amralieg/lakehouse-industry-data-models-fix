...
-- Total cross-domain FK constraints: 1328
--
-- EXECUTION ORDER:
...
-- ========= channel --> finance (7 constraint(s)) =========
...
-- ========= channel --> inventory (8 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_inventory_allocation` ADD CONSTRAINT `fk_channel_channel_inventory_allocation_primary_channel_room_type_id` FOREIGN KEY (`primary_channel_room_type_id`) REFERENCES `vibe_travel_hospitality_v1`.`inventory`.`room_type`(`room_type_id`);
...
-- ========= channel --> procurement (7 constraint(s)) =========
-- Requires: channel schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`ota_partner` ADD CONSTRAINT `fk_channel_ota_partner_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`gds_connection` ADD CONSTRAINT `fk_channel_gds_connection_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_contract` ADD CONSTRAINT `fk_channel_channel_contract_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`metasearch_listing` ADD CONSTRAINT `fk_channel_metasearch_listing_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_negotiated_rate` ADD CONSTRAINT `fk_channel_channel_negotiated_rate_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= channel --> workforce (1 constraint(s)) =========
-- Requires: channel schema, workforce schema
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel` ADD CONSTRAINT `fk_channel_channel_workforce_employee_id` FOREIGN KEY (`workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion` ADD CONSTRAINT `fk_compliance_compliance_training_completion_program_config_id` FOREIGN KEY (`program_config_id`) REFERENCES `vibe_travel_hospitality_v1`.`loyalty`.`program_config`(`program_config_id`);
...
-- ========= compliance --> procurement (42 constraint(s)) =========
-- Requires: compliance schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_tertiary_obligation_updated_by_user_employee_id` FOREIGN KEY (`tertiary_obligation_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`permit_renewal` ADD CONSTRAINT `fk_compliance_permit_renewal_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`audit_finding` ADD CONSTRAINT `fk_compliance_audit_finding_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`corrective_action` ADD CONSTRAINT `fk_compliance_corrective_action_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident` ADD CONSTRAINT `fk_compliance_health_safety_incident_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident` ADD CONSTRAINT `fk_compliance_health_safety_incident_tertiary_health_updated_by_user_employee_id` FOREIGN KEY (`tertiary_health_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`incident_investigation` ADD CONSTRAINT `fk_compliance_incident_investigation_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`incident_investigation` ADD CONSTRAINT `fk_compliance_incident_investigation_tertiary_incident_updated_by_user_employee_id` FOREIGN KEY (`tertiary_incident_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`privacy_incident` ADD CONSTRAINT `fk_compliance_privacy_incident_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`privacy_incident` ADD CONSTRAINT `fk_compliance_privacy_incident_tertiary_privacy_updated_by_user_employee_id` FOREIGN KEY (`tertiary_privacy_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`dpia` ADD CONSTRAINT `fk_compliance_dpia_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`food_safety_cert` ADD CONSTRAINT `fk_compliance_food_safety_cert_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`food_safety_cert` ADD CONSTRAINT `fk_compliance_food_safety_cert_tertiary_food_updated_by_user_employee_id` FOREIGN KEY (`tertiary_food_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`fire_safety_record` ADD CONSTRAINT `fk_compliance_fire_safety_record_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`ada_assessment` ADD CONSTRAINT `fk_compliance_ada_assessment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion` ADD CONSTRAINT `fk_compliance_compliance_training_completion_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion` ADD CONSTRAINT `fk_compliance_compliance_training_completion_tertiary_compliance_updated_by_user_employee_id` FOREIGN KEY (`tertiary_compliance_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`risk_register` ADD CONSTRAINT `fk_compliance_risk_register_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`risk_register` ADD CONSTRAINT `fk_compliance_risk_register_risk_employee_id` FOREIGN KEY (`risk_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`risk_register` ADD CONSTRAINT `fk_compliance_risk_register_risk_updated_by_user_employee_id` FOREIGN KEY (`risk_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`regulatory_filing` ADD CONSTRAINT `fk_compliance_regulatory_filing_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy` ADD CONSTRAINT `fk_compliance_policy_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy` ADD CONSTRAINT `fk_compliance_policy_tertiary_policy_updated_by_user_employee_id` FOREIGN KEY (`tertiary_policy_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_tertiary_policy_escalated_to_user_employee_id` FOREIGN KEY (`tertiary_policy_escalated_to_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_tertiary_quinary_policy_updated_by_user_employee_id` FOREIGN KEY (`tertiary_quinary_policy_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`third_party_due_diligence` ADD CONSTRAINT `fk_compliance_third_party_due_diligence_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`environmental_compliance` ADD CONSTRAINT `fk_compliance_environmental_compliance_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`whistleblower_report` ADD CONSTRAINT `fk_compliance_whistleblower_report_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_reviewer_employee_id` FOREIGN KEY (`reviewer_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_sanction_employee_id` FOREIGN KEY (`sanction_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_sanction_updated_by_user_employee_id` FOREIGN KEY (`sanction_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_compliance_last_modified_by_user_employee_id` FOREIGN KEY (`compliance_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_primary_calendar_employee_id` FOREIGN KEY (`primary_calendar_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_primary_compliance_responsible_owner_employee_id` FOREIGN KEY (`primary_compliance_responsible_owner_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`regulatory_requirement` ADD CONSTRAINT `fk_compliance_regulatory_requirement_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= event --> compliance (12 constraint(s)) =========
...
-- ========= event --> procurement (13 constraint(s)) =========
-- Requires: event schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`account` ADD CONSTRAINT `fk_event_account_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`proposal` ADD CONSTRAINT `fk_event_proposal_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_booking` ADD CONSTRAINT `fk_event_event_booking_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_space_allocation` ADD CONSTRAINT `fk_event_event_space_allocation_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_tertiary_beo_modified_by_user_employee_id` FOREIGN KEY (`tertiary_beo_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`lost_business` ADD CONSTRAINT `fk_event_lost_business_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_class_enrollment` ADD CONSTRAINT `fk_event_event_class_enrollment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo_attendant_assignment` ADD CONSTRAINT `fk_event_beo_attendant_assignment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`staffing_assignment` ADD CONSTRAINT `fk_event_staffing_assignment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= experience --> compliance (5 constraint(s)) =========
...
-- ========= experience --> guest (11 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_predictive_score` ADD CONSTRAINT `fk_experience_guest_predictive_score_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`profile`(`profile_id`);
...
-- ========= experience --> procurement (17 constraint(s)) =========
-- Requires: experience schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_feedback` ADD CONSTRAINT `fk_experience_guest_feedback_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_case` ADD CONSTRAINT `fk_experience_service_case_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_case` ADD CONSTRAINT `fk_experience_service_case_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_case` ADD CONSTRAINT `fk_experience_service_case_tertiary_service_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_service_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`case_activity` ADD CONSTRAINT `fk_experience_case_activity_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_recovery_action` ADD CONSTRAINT `fk_experience_service_recovery_action_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_recovery_action` ADD CONSTRAINT `fk_experience_service_recovery_action_tertiary_service_created_by_employee_id` FOREIGN KEY (`tertiary_service_created_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`experience_special_request` ADD CONSTRAINT `fk_experience_experience_special_request_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`amenity_fulfillment` ADD CONSTRAINT `fk_experience_amenity_fulfillment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_interaction` ADD CONSTRAINT `fk_experience_guest_interaction_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_interaction` ADD CONSTRAINT `fk_experience_guest_interaction_tertiary_guest_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_guest_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_experience_enrollment` ADD CONSTRAINT `fk_experience_guest_experience_enrollment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`reputation_alert` ADD CONSTRAINT `fk_experience_reputation_alert_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= experience --> property (24 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`profit_center` ADD CONSTRAINT `fk_finance_profit_center_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_payroll_run_id` FOREIGN KEY (`payroll_run_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`payroll_run`(`payroll_run_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_tertiary_journal_posted_by_user_employee_id` FOREIGN KEY (`tertiary_journal_posted_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`ar_payment` ADD CONSTRAINT `fk_finance_ar_payment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`budget_line` ADD CONSTRAINT `fk_finance_budget_line_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`budget_line` ADD CONSTRAINT `fk_finance_budget_line_procurement_position_id` FOREIGN KEY (`procurement_position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_position`(`procurement_position_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`management_fee` ADD CONSTRAINT `fk_finance_management_fee_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`owner_distribution` ADD CONSTRAINT `fk_finance_owner_distribution_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`payment_run` ADD CONSTRAINT `fk_finance_payment_run_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`payment_run` ADD CONSTRAINT `fk_finance_payment_run_payment_employee_id` FOREIGN KEY (`payment_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`capex_request` ADD CONSTRAINT `fk_finance_capex_request_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`capex_request` ADD CONSTRAINT `fk_finance_capex_request_capex_requestor_employee_id` FOREIGN KEY (`capex_requestor_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_run` ADD CONSTRAINT `fk_finance_allocation_run_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_run` ADD CONSTRAINT `fk_finance_allocation_run_allocation_employee_id` FOREIGN KEY (`allocation_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`gl_batch` ADD CONSTRAINT `fk_finance_gl_batch_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= finance --> workforce (3 constraint(s)) =========
-- Requires: finance schema, workforce schema
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_rule_set` ADD CONSTRAINT `fk_finance_allocation_rule_set_created_by_user_workforce_employee_id` FOREIGN KEY (`created_by_user_workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_rule_set` ADD CONSTRAINT `fk_finance_allocation_rule_set_last_modified_by_user_workforce_employee_id` FOREIGN KEY (`last_modified_by_user_workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_rule_set` ADD CONSTRAINT `fk_finance_allocation_rule_set_workforce_employee_id` FOREIGN KEY (`workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
...
-- ========= fnb --> procurement (29 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`fnb_outlet` ADD CONSTRAINT `fk_fnb_fnb_outlet_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`menu` ADD CONSTRAINT `fk_fnb_menu_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check` ADD CONSTRAINT `fk_fnb_pos_check_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check` ADD CONSTRAINT `fk_fnb_pos_check_tertiary_pos_manager_employee_id` FOREIGN KEY (`tertiary_pos_manager_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check_line` ADD CONSTRAINT `fk_fnb_pos_check_line_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`void_transaction` ADD CONSTRAINT `fk_fnb_void_transaction_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`room_service_order` ADD CONSTRAINT `fk_fnb_room_service_order_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`banquet_menu_package` ADD CONSTRAINT `fk_fnb_banquet_menu_package_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`stock_transaction` ADD CONSTRAINT `fk_fnb_stock_transaction_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`discount` ADD CONSTRAINT `fk_fnb_discount_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`food_safety_inspection` ADD CONSTRAINT `fk_fnb_food_safety_inspection_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`waste_log` ADD CONSTRAINT `fk_fnb_waste_log_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`storage_location` ADD CONSTRAINT `fk_fnb_storage_location_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_physical_counted_by_employee_id` FOREIGN KEY (`physical_counted_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_physical_counter_employee_id` FOREIGN KEY (`physical_counter_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_physical_supervisor_employee_id` FOREIGN KEY (`physical_supervisor_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= guest --> procurement (11 constraint(s)) =========
-- Requires: guest schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`preference` ADD CONSTRAINT `fk_guest_preference_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`guest_group_block` ADD CONSTRAINT `fk_guest_guest_group_block_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`vip_designation` ADD CONSTRAINT `fk_guest_vip_designation_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`vip_designation` ADD CONSTRAINT `fk_guest_vip_designation_tertiary_vip_approved_by_employee_id` FOREIGN KEY (`tertiary_vip_approved_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`note` ADD CONSTRAINT `fk_guest_note_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`note` ADD CONSTRAINT `fk_guest_note_tertiary_note_resolved_by_staff_employee_id` FOREIGN KEY (`tertiary_note_resolved_by_staff_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`identity_document` ADD CONSTRAINT `fk_guest_identity_document_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`profile_merge_history` ADD CONSTRAINT `fk_guest_profile_merge_history_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`relationship` ADD CONSTRAINT `fk_guest_relationship_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`relationship` ADD CONSTRAINT `fk_guest_relationship_tertiary_relationship_last_modified_by_staff_employee_id` FOREIGN KEY (`tertiary_relationship_last_modified_by_staff_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`privacy_request` ADD CONSTRAINT `fk_guest_privacy_request_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= housekeeping --> compliance (14 constraint(s)) =========
-- Requires: housekeeping schema, compliance schema
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`cleaning_task` ADD CONSTRAINT `fk_housekeeping_cleaning_task_compliance_training_completion_id` FOREIGN KEY (`compliance_training_completion_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion`(`compliance_training_completion_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_policy_acknowledgment_id` FOREIGN KEY (`policy_acknowledgment_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment`(`policy_acknowledgment_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection` ADD CONSTRAINT `fk_housekeeping_inspection_reputation_alert_id` FOREIGN KEY (`reputation_alert_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`reputation_alert`(`reputation_alert_id`);
...
-- ========= housekeeping --> fnb (4 constraint(s)) =========
...
-- ========= housekeeping --> procurement (29 constraint(s)) =========
-- Requires: housekeeping schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_assignment` ADD CONSTRAINT `fk_housekeeping_hk_assignment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`cleaning_task` ADD CONSTRAINT `fk_housekeeping_cleaning_task_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection` ADD CONSTRAINT `fk_housekeeping_inspection_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection` ADD CONSTRAINT `fk_housekeeping_inspection_primary_inspection_employee_id` FOREIGN KEY (`primary_inspection_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection_deficiency` ADD CONSTRAINT `fk_housekeeping_inspection_deficiency_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_handoff` ADD CONSTRAINT `fk_housekeeping_maintenance_handoff_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_schedule` ADD CONSTRAINT `fk_housekeeping_hk_schedule_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_schedule` ADD CONSTRAINT `fk_housekeeping_hk_schedule_tertiary_hk_modified_by_user_employee_id` FOREIGN KEY (`tertiary_hk_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_procurement_position_id` FOREIGN KEY (`procurement_position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_position`(`procurement_position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`linen_management` ADD CONSTRAINT `fk_housekeeping_linen_management_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`supply_consumption` ADD CONSTRAINT `fk_housekeeping_supply_consumption_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`lost_and_found` ADD CONSTRAINT `fk_housekeeping_lost_and_found_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_primary_deep_employee_id` FOREIGN KEY (`primary_deep_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`laundry_order` ADD CONSTRAINT `fk_housekeeping_laundry_order_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`laundry_order` ADD CONSTRAINT `fk_housekeeping_laundry_order_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`public_area` ADD CONSTRAINT `fk_housekeeping_public_area_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`public_area` ADD CONSTRAINT `fk_housekeeping_public_area_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`housekeeping_training_completion` ADD CONSTRAINT `fk_housekeeping_housekeeping_training_completion_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_work_inspected_by_employee_id` FOREIGN KEY (`work_inspected_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_work_requested_by_employee_id` FOREIGN KEY (`work_requested_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= housekeeping --> spa (5 constraint(s)) =========
...
-- ========= housekeeping --> workforce (5 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`team` ADD CONSTRAINT `fk_housekeeping_team_workforce_employee_id` FOREIGN KEY (`workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_request` ADD CONSTRAINT `fk_housekeeping_maintenance_request_workforce_employee_id` FOREIGN KEY (`workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_request` ADD CONSTRAINT `fk_housekeeping_maintenance_request_maintenance_assigned_to_employee_id` FOREIGN KEY (`maintenance_assigned_to_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_request` ADD CONSTRAINT `fk_housekeeping_maintenance_request_maintenance_reported_by_employee_id` FOREIGN KEY (`maintenance_reported_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`control` ADD CONSTRAINT `fk_inventory_control_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_status` ADD CONSTRAINT `fk_inventory_room_status_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`control` ADD CONSTRAINT `fk_inventory_control_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_block` ADD CONSTRAINT `fk_inventory_room_block_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_block` ADD CONSTRAINT `fk_inventory_room_block_tertiary_room_modified_by_user_employee_id` FOREIGN KEY (`tertiary_room_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`out_of_order` ADD CONSTRAINT `fk_inventory_out_of_order_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`out_of_order` ADD CONSTRAINT `fk_inventory_out_of_order_tertiary_out_closed_by_user_employee_id` FOREIGN KEY (`tertiary_out_closed_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`inventory_overbooking_policy` ADD CONSTRAINT `fk_inventory_inventory_overbooking_policy_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`inventory_overbooking_policy` ADD CONSTRAINT `fk_inventory_inventory_overbooking_policy_tertiary_inventory_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_inventory_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`los_restriction` ADD CONSTRAINT `fk_inventory_los_restriction_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`channel_inventory_map` ADD CONSTRAINT `fk_inventory_channel_inventory_map_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`change_audit` ADD CONSTRAINT `fk_inventory_change_audit_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_amenity` ADD CONSTRAINT `fk_inventory_room_amenity_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`tier_history` ADD CONSTRAINT `fk_loyalty_tier_history_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`points_ledger` ADD CONSTRAINT `fk_loyalty_points_ledger_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`accrual_rule` ADD CONSTRAINT `fk_loyalty_accrual_rule_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`redemption_rule` ADD CONSTRAINT `fk_loyalty_redemption_rule_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`loyalty_enrollment` ADD CONSTRAINT `fk_loyalty_loyalty_enrollment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`benefit_entitlement` ADD CONSTRAINT `fk_loyalty_benefit_entitlement_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`benefit_entitlement` ADD CONSTRAINT `fk_loyalty_benefit_entitlement_tertiary_benefit_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_benefit_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`benefit_redemption` ADD CONSTRAINT `fk_loyalty_benefit_redemption_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`promotion` ADD CONSTRAINT `fk_loyalty_promotion_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`program_config` ADD CONSTRAINT `fk_loyalty_program_config_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`member_segment` ADD CONSTRAINT `fk_loyalty_member_segment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`certificate` ADD CONSTRAINT `fk_loyalty_certificate_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= marketing --> compliance (3 constraint(s)) =========
...
-- ========= marketing --> procurement (17 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`campaign_execution` ADD CONSTRAINT `fk_marketing_campaign_execution_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`guest_segment` ADD CONSTRAINT `fk_marketing_guest_segment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`survey_program` ADD CONSTRAINT `fk_marketing_survey_program_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`survey_program` ADD CONSTRAINT `fk_marketing_survey_program_tertiary_survey_modified_by_user_employee_id` FOREIGN KEY (`tertiary_survey_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`brand` ADD CONSTRAINT `fk_marketing_brand_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`consent` ADD CONSTRAINT `fk_marketing_consent_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`experiment` ADD CONSTRAINT `fk_marketing_experiment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`experiment` ADD CONSTRAINT `fk_marketing_experiment_tertiary_experiment_modified_by_user_employee_id` FOREIGN KEY (`tertiary_experiment_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`marketing_calendar` ADD CONSTRAINT `fk_marketing_marketing_calendar_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`marketing_calendar` ADD CONSTRAINT `fk_marketing_marketing_calendar_tertiary_marketing_modified_by_user_employee_id` FOREIGN KEY (`tertiary_marketing_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`leave_request` ADD CONSTRAINT `fk_procurement_leave_request_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_disciplinary_action` ADD CONSTRAINT `fk_procurement_procurement_disciplinary_action_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee` ADD CONSTRAINT `fk_procurement_procurement_employee_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit` ADD CONSTRAINT `fk_procurement_procurement_org_unit_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`shift_template` ADD CONSTRAINT `fk_procurement_shift_template_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`time_entry` ADD CONSTRAINT `fk_procurement_time_entry_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`payroll_run` ADD CONSTRAINT `fk_procurement_payroll_run_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`leave_request` ADD CONSTRAINT `fk_procurement_leave_request_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
...
-- ========= procurement --> property (36 constraint(s)) =========
-- Requires: procurement schema, property schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee` ADD CONSTRAINT `fk_procurement_procurement_employee_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_position` ADD CONSTRAINT `fk_procurement_procurement_position_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit` ADD CONSTRAINT `fk_procurement_procurement_org_unit_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`shift_template` ADD CONSTRAINT `fk_procurement_shift_template_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_schedule` ADD CONSTRAINT `fk_procurement_procurement_schedule_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`time_entry` ADD CONSTRAINT `fk_procurement_time_entry_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`payroll_run` ADD CONSTRAINT `fk_procurement_payroll_run_ownership_entity_id` FOREIGN KEY (`ownership_entity_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`ownership_entity`(`ownership_entity_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`payroll_run` ADD CONSTRAINT `fk_procurement_payroll_run_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`leave_request` ADD CONSTRAINT `fk_procurement_leave_request_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`workforce_safety_incident` ADD CONSTRAINT `fk_procurement_workforce_safety_incident_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_enrollment` ADD CONSTRAINT `fk_procurement_procurement_enrollment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_supply_agreement` ADD CONSTRAINT `fk_procurement_procurement_supply_agreement_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`vendor_touchpoint_service` ADD CONSTRAINT `fk_procurement_vendor_touchpoint_service_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`category_buyer_assignment` ADD CONSTRAINT `fk_procurement_category_buyer_assignment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_therapist_certification` ADD CONSTRAINT `fk_procurement_procurement_therapist_certification_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`payroll_period` ADD CONSTRAINT `fk_procurement_payroll_period_ownership_entity_id` FOREIGN KEY (`ownership_entity_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`ownership_entity`(`ownership_entity_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`payroll_period` ADD CONSTRAINT `fk_procurement_payroll_period_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_job_requisition` ADD CONSTRAINT `fk_procurement_procurement_job_requisition_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_disciplinary_action` ADD CONSTRAINT `fk_procurement_procurement_disciplinary_action_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);

-- ========= procurement --> spa (1 constraint(s)) =========
...
-- ========= procurement --> workforce (5 constraint(s)) =========
-- Requires: procurement schema, workforce schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`leave_request` ADD CONSTRAINT `fk_procurement_leave_request_workforce_benefit_plan_id` FOREIGN KEY (`workforce_benefit_plan_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_benefit_plan`(`workforce_benefit_plan_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_enrollment` ADD CONSTRAINT `fk_procurement_procurement_enrollment_workforce_benefit_plan_id` FOREIGN KEY (`workforce_benefit_plan_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_benefit_plan`(`workforce_benefit_plan_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`project` ADD CONSTRAINT `fk_procurement_project_manager_workforce_employee_id` FOREIGN KEY (`manager_workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`project` ADD CONSTRAINT `fk_procurement_project_sponsor_workforce_employee_id` FOREIGN KEY (`sponsor_workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`project` ADD CONSTRAINT `fk_procurement_project_workforce_employee_id` FOREIGN KEY (`workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
...
-- ========= property --> procurement (6 constraint(s)) =========
-- Requires: property schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_facility` ADD CONSTRAINT `fk_property_property_facility_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_outlet` ADD CONSTRAINT `fk_property_property_outlet_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_outlet` ADD CONSTRAINT `fk_property_property_outlet_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
...
-- ========= reservation --> procurement (11 constraint(s)) =========
-- Requires: reservation schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`booking_status_history` ADD CONSTRAINT `fk_reservation_booking_status_history_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`cancellation` ADD CONSTRAINT `fk_reservation_cancellation_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`reservation_group_block` ADD CONSTRAINT `fk_reservation_reservation_group_block_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`reservation_rate_plan` ADD CONSTRAINT `fk_reservation_reservation_rate_plan_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`reservation_special_request` ADD CONSTRAINT `fk_reservation_reservation_special_request_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`deposit_ledger` ADD CONSTRAINT `fk_reservation_deposit_ledger_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`waitlist` ADD CONSTRAINT `fk_reservation_waitlist_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`waitlist` ADD CONSTRAINT `fk_reservation_waitlist_tertiary_waitlist_modified_by_user_employee_id` FOREIGN KEY (`tertiary_waitlist_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`room_assignment` ADD CONSTRAINT `fk_reservation_room_assignment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`room_assignment` ADD CONSTRAINT `fk_reservation_room_assignment_tertiary_room_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_room_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`walk_record` ADD CONSTRAINT `fk_reservation_walk_record_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_rate_plan` ADD CONSTRAINT `fk_revenue_revenue_rate_plan_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pricing_override` ADD CONSTRAINT `fk_revenue_pricing_override_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
...
-- ========= revenue --> experience (7 constraint(s)) =========
-- Requires: revenue schema, experience schema
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`dynamic_rate_rule` ADD CONSTRAINT `fk_revenue_dynamic_rate_rule_gss_score_id` FOREIGN KEY (`gss_score_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`gss_score`(`gss_score_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`demand_forecast` ADD CONSTRAINT `fk_revenue_demand_forecast_gss_score_id` FOREIGN KEY (`gss_score_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`gss_score`(`gss_score_id`);
...
-- ========= revenue --> finance (26 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitive_set` ADD CONSTRAINT `fk_revenue_competitive_set_finance_budget_id` FOREIGN KEY (`finance_budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`finance_budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`segment_program_eligibility` ADD CONSTRAINT `fk_revenue_segment_program_eligibility_program_config_id` FOREIGN KEY (`program_config_id`) REFERENCES `vibe_travel_hospitality_v1`.`loyalty`.`program_config`(`program_config_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_rate_plan` ADD CONSTRAINT `fk_revenue_revenue_rate_plan_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`dynamic_rate_rule` ADD CONSTRAINT `fk_revenue_dynamic_rate_rule_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pricing_override` ADD CONSTRAINT `fk_revenue_pricing_override_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pricing_override` ADD CONSTRAINT `fk_revenue_pricing_override_primary_pricing_employee_id` FOREIGN KEY (`primary_pricing_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`rate_availability` ADD CONSTRAINT `fk_revenue_rate_availability_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`demand_forecast` ADD CONSTRAINT `fk_revenue_demand_forecast_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`inventory_control` ADD CONSTRAINT `fk_revenue_inventory_control_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`performance_actuals` ADD CONSTRAINT `fk_revenue_performance_actuals_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitive_set` ADD CONSTRAINT `fk_revenue_competitive_set_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`str_benchmark` ADD CONSTRAINT `fk_revenue_str_benchmark_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitor_rate` ADD CONSTRAINT `fk_revenue_competitor_rate_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pickup_report` ADD CONSTRAINT `fk_revenue_pickup_report_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_overbooking_policy` ADD CONSTRAINT `fk_revenue_revenue_overbooking_policy_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_budget` ADD CONSTRAINT `fk_revenue_revenue_budget_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_negotiated_rate` ADD CONSTRAINT `fk_revenue_revenue_negotiated_rate_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`total_revenue_actuals` ADD CONSTRAINT `fk_revenue_total_revenue_actuals_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);

-- ========= revenue --> property (26 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`inventory_control` ADD CONSTRAINT `fk_revenue_inventory_control_primary_inventory_property_id` FOREIGN KEY (`primary_inventory_property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitor_rate` ADD CONSTRAINT `fk_revenue_competitor_rate_primary_competitor_property_id` FOREIGN KEY (`primary_competitor_property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_overbooking_policy` ADD CONSTRAINT `fk_revenue_revenue_overbooking_policy_revenue_property_id` FOREIGN KEY (`revenue_property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`retail_transaction` ADD CONSTRAINT `fk_spa_retail_transaction_channel_id` FOREIGN KEY (`channel_id`) REFERENCES `vibe_travel_hospitality_v1`.`channel`.`channel`(`channel_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_spa_facility_fire_safety_record_id` FOREIGN KEY (`fire_safety_record_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`fire_safety_record`(`fire_safety_record_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`membership` ADD CONSTRAINT `fk_spa_membership_service_case_id` FOREIGN KEY (`service_case_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`service_case`(`service_case_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_spa_facility_content_asset_id` FOREIGN KEY (`content_asset_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`content_asset`(`content_asset_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`appointment` ADD CONSTRAINT `fk_spa_appointment_attribution_event_id` FOREIGN KEY (`attribution_event_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`attribution_event`(`attribution_event_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`treatment_menu` ADD CONSTRAINT `fk_spa_treatment_menu_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`therapist` ADD CONSTRAINT `fk_spa_therapist_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`therapist` ADD CONSTRAINT `fk_spa_therapist_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`therapist` ADD CONSTRAINT `fk_spa_therapist_procurement_position_id` FOREIGN KEY (`procurement_position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_position`(`procurement_position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_spa_facility_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_spa_facility_procurement_org_unit_id` FOREIGN KEY (`procurement_org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_org_unit`(`procurement_org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`appointment` ADD CONSTRAINT `fk_spa_appointment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`appointment_package` ADD CONSTRAINT `fk_spa_appointment_package_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`charge` ADD CONSTRAINT `fk_spa_charge_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`retail_transaction` ADD CONSTRAINT `fk_spa_retail_transaction_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`membership_visit` ADD CONSTRAINT `fk_spa_membership_visit_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`fitness_class` ADD CONSTRAINT `fk_spa_fitness_class_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`fitness_class` ADD CONSTRAINT `fk_spa_fitness_class_fitness_modified_by_user_employee_id` FOREIGN KEY (`fitness_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`fitness_class_session` ADD CONSTRAINT `fk_spa_fitness_class_session_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_class_enrollment` ADD CONSTRAINT `fk_spa_spa_class_enrollment_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`golf_tee_time` ADD CONSTRAINT `fk_spa_golf_tee_time_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`amenity_pricing` ADD CONSTRAINT `fk_spa_amenity_pricing_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`amenity_pricing` ADD CONSTRAINT `fk_spa_amenity_pricing_tertiary_amenity_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_amenity_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`cancellation_log` ADD CONSTRAINT `fk_spa_cancellation_log_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`wellness_program` ADD CONSTRAINT `fk_spa_wellness_program_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`wellness_program` ADD CONSTRAINT `fk_spa_wellness_program_tertiary_wellness_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_wellness_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`group_booking` ADD CONSTRAINT `fk_spa_group_booking_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);
...
-- ========= spa --> workforce (1 constraint(s)) =========
-- Requires: spa schema, workforce schema
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`product_line` ADD CONSTRAINT `fk_spa_product_line_workforce_employee_id` FOREIGN KEY (`workforce_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee`(`workforce_employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`procurement_benefit_plan` ADD CONSTRAINT `fk_workforce_procurement_benefit_plan_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`procurement_compensation_plan` ADD CONSTRAINT `fk_workforce_procurement_compensation_plan_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);

-- ========= workforce --> procurement (2 constraint(s)) =========
-- Requires: workforce schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`procurement_compensation_plan` ADD CONSTRAINT `fk_workforce_procurement_compensation_plan_procurement_position_id` FOREIGN KEY (`procurement_position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_position`(`procurement_position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`procurement_compensation_plan` ADD CONSTRAINT `fk_workforce_procurement_compensation_plan_procurement_employee_id` FOREIGN KEY (`procurement_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_employee`(`procurement_employee_id`);

-- ========= workforce --> property (6 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`workforce_employee` ADD CONSTRAINT `fk_workforce_workforce_employee_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`workforce_org_unit` ADD CONSTRAINT `fk_workforce_workforce_org_unit_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`procurement_benefit_plan` ADD CONSTRAINT `fk_workforce_procurement_benefit_plan_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`procurement_compensation_plan` ADD CONSTRAINT `fk_workforce_procurement_compensation_plan_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
