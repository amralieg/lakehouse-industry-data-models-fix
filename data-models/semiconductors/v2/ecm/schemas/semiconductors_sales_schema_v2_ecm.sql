...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`sales`.`territory` (
    ...
    `site_id` BIGINT COMMENT 'add column site_id (BIGINT) with FK to shared.site.site_id - sales territories map to geographic sites/regions',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`sales`.`campaign` (
    ...
    `family_id` BIGINT COMMENT 'add column product_family_id (BIGINT) with FK to product.family.family_id - marketing campaigns target specific product families',
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_design_win` SET TAGS ('dbx_subdomain' = 'design_engagement');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_design_win` ALTER COLUMN `process_flow_id` SET TAGS ('dbx_business_glossary_term' = 'Process Process Flow Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_nre_agreement` SET TAGS ('dbx_subdomain' = 'design_engagement');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_nre_agreement` ALTER COLUMN `milestone_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`customer_contract` ALTER COLUMN `test_program_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`territory` SET TAGS ('dbx_subdomain' = 'channel_coverage');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`territory` ALTER COLUMN `territory_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_forecast` SET TAGS ('dbx_subdomain' = 'contract_pricing');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_forecast` ALTER COLUMN `scenario_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`booking` SET TAGS ('dbx_subdomain' = 'contract_pricing');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`lead` ALTER COLUMN `company_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`channel_partner` SET TAGS ('dbx_subdomain' = 'channel_coverage');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`channel_partner` ALTER COLUMN `legal_entity_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`channel_partner` ALTER COLUMN `partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_design_registration` SET TAGS ('dbx_subdomain' = 'design_engagement');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`sales_design_registration` ALTER COLUMN `sales_rep_firm_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`rebate_program` ALTER COLUMN `program_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`activity` ALTER COLUMN `process_step_id` SET TAGS ('dbx_business_glossary_term' = 'Process Process Step Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`partner_inventory` SET TAGS ('dbx_subdomain' = 'channel_coverage');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`opportunity_project_assignment` SET TAGS ('dbx_subdomain' = 'design_engagement');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`lead_program_interest` SET TAGS ('dbx_subdomain' = 'design_engagement');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`campaign` SET TAGS ('dbx_subdomain' = 'channel_coverage');
...
ALTER TABLE `vibe_semiconductors_v1`.`sales`.`campaign` ALTER COLUMN `campaign_name` SET TAGS ('dbx_pii_detected' = 'true');
