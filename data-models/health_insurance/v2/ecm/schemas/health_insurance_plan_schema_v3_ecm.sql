-- Schema for Domain: plan | Business:  | Version: v3_ecm
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`plan`.`submission` (
    ...
    `number` STRING COMMENT 'External reference number assigned to the submission by the organization.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` (
    ...
    `plan_created_by_user_employee_id` BIGINT COMMENT 'Identifier of the internal user who created the amendment record.',
    `plan_updated_by_user_employee_id` BIGINT COMMENT 'Identifier of the internal user who last modified the amendment record.',
    ...
    `requestor_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` (
    ...
    `crosswalk_health_plan_id` BIGINT COMMENT 'Identifier of the health plan being discontinued or replaced.',
    `health_plan_id` BIGINT COMMENT 'Identifier of the health plan that will replace the prior plan.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` (
    ...
    `compliance_regulatory_obligation_id` BIGINT COMMENT 'Identifier for the compliance regulatory obligation',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` (
    ...
    `contract_provider_contract_id` BIGINT COMMENT 'SSOT reference to contract.contract_provider_contract',
    `health_plan_id` BIGINT COMMENT 'Foreign key linking to the health_plan entity',
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ADD CONSTRAINT `fk_plan_crosswalk_crosswalk_health_plan_id` FOREIGN KEY (`crosswalk_health_plan_id`) REFERENCES `vibe_health_insurance_v1`.`plan`.`health_plan`(`health_plan_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Ledger Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `pbm_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Pbm Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `hcc_score` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`health_plan` ALTER COLUMN `plan_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`benefit_package` SET TAGS ('dbx_subdomain' = 'benefit_design');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`benefit_package` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`benefit_package` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Pharmacy Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`benefit_package` ALTER COLUMN `package_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`benefit` SET TAGS ('dbx_subdomain' = 'benefit_design');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`benefit` ALTER COLUMN `benefit_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`cost_share_rule` SET TAGS ('dbx_subdomain' = 'benefit_design');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`cost_share_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`year` ALTER COLUMN `budget_id` SET TAGS ('dbx_business_glossary_term' = 'Budget Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`year` ALTER COLUMN `cms_plan_submission_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`year` ALTER COLUMN `plan_year_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `sbc_document_id` SET TAGS ('dbx_business_glossary_term' = 'Summary of Benefits and Coverage (SBC) Document ID');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'SBC Approval Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `author` SET TAGS ('dbx_business_glossary_term' = 'SBC Author');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `checksum_sha256` SET TAGS ('dbx_business_glossary_term' = 'SBC SHA‑256 Checksum');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `checksum_sha256` SET TAGS ('dbx_value_regex' = '^[a-fA-F0-9]{64}$');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `cost_sharing_highlights` SET TAGS ('dbx_business_glossary_term' = 'SBC Cost‑Sharing Highlights');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `coverage_example` SET TAGS ('dbx_business_glossary_term' = 'SBC Coverage Example');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `coverage_example` SET TAGS ('dbx_value_regex' = 'birth|chronic|surgery|preventive|mental_health');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'SBC Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_category` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Category');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_category` SET TAGS ('dbx_value_regex' = 'individual|group|government');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_number` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Number');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_size_bytes` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Size (Bytes)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_title` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Title');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_type` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_type` SET TAGS ('dbx_value_regex' = 'sbc|sbc_amendment|sbc_translation');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `document_url` SET TAGS ('dbx_business_glossary_term' = 'SBC Document URL');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'SBC Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'SBC Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `format` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Format');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `format` SET TAGS ('dbx_value_regex' = 'pdf|html|xml');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `is_current` SET TAGS ('dbx_business_glossary_term' = 'SBC Current Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `language` SET TAGS ('dbx_business_glossary_term' = 'SBC Language');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `language` SET TAGS ('dbx_value_regex' = 'en|es|fr|zh|ar');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `regulatory_submission_status` SET TAGS ('dbx_business_glossary_term' = 'SBC Regulatory Submission Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `regulatory_submission_status` SET TAGS ('dbx_value_regex' = 'not_submitted|submitted|approved|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `revision_number` SET TAGS ('dbx_business_glossary_term' = 'SBC Revision Number');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `sbc_version` SET TAGS ('dbx_business_glossary_term' = 'SBC Version Code');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `sbc_document_status` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Lifecycle Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `sbc_document_status` SET TAGS ('dbx_value_regex' = 'draft|active|archived|retracted');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `submission_date` SET TAGS ('dbx_business_glossary_term' = 'SBC Submission Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'SBC Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`sbc_document` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'SBC Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rate` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rate` SET TAGS ('dbx_subdomain' = 'premium_pricing');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rate` ALTER COLUMN `rate_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rate` ALTER COLUMN `rating_area_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rate` ALTER COLUMN `tobacco_use_indicator` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rate` ALTER COLUMN `underwriting_class_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` SET TAGS ('dbx_subdomain' = 'product_catalog');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` ALTER COLUMN `sbc_document_id` SET TAGS ('dbx_business_glossary_term' = 'Summary of Benefits and Coverage Document ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` ALTER COLUMN `county` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` ALTER COLUMN `is_state_funded` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` ALTER COLUMN `service_area_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_service_area` ALTER COLUMN `state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Submission ID');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `ap_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Ap Invoice Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Reviewer ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Submitter ID');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_date` SET TAGS ('dbx_business_glossary_term' = 'Submission Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Plan Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Plan Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `fee_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Fee Currency Code');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `filing_fee_adjustment` SET TAGS ('dbx_business_glossary_term' = 'Filing Fee Adjustment');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `filing_fee_gross` SET TAGS ('dbx_business_glossary_term' = 'Filing Fee Gross Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `filing_fee_net` SET TAGS ('dbx_business_glossary_term' = 'Filing Fee Net Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `filing_reference_number` SET TAGS ('dbx_business_glossary_term' = 'Filing Reference Number');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `hpms_plan_code` SET TAGS ('dbx_business_glossary_term' = 'HPMS Plan ID');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `is_annual_filing` SET TAGS ('dbx_business_glossary_term' = 'Is Annual Filing');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Submission Notes');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Submission Number');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `plan_type` SET TAGS ('dbx_business_glossary_term' = 'Plan Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `regulatory_body` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Body');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `regulatory_body` SET TAGS ('dbx_value_regex' = 'cms|state_doi|other');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `regulatory_submission_deadline` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Submission Deadline');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `regulatory_submission_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `rejection_date` SET TAGS ('dbx_business_glossary_term' = 'Rejection Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `rejection_reason` SET TAGS ('dbx_business_glossary_term' = 'Rejection Reason');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `reviewer_comments` SET TAGS ('dbx_business_glossary_term' = 'Reviewer Comments');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_status` SET TAGS ('dbx_business_glossary_term' = 'Submission Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|approved|rejected|withdrawn');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submitter_role` SET TAGS ('dbx_business_glossary_term' = 'Submitter Role');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submitter_role` SET TAGS ('dbx_value_regex' = 'internal|external|broker|agency');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_type` SET TAGS ('dbx_business_glossary_term' = 'Submission Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `submission_type` SET TAGS ('dbx_value_regex' = 'qhp|medicare_advantage|medicaid|state_bid|rate_filing');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `updated_by` SET TAGS ('dbx_business_glossary_term' = 'Updated By');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `withdrawal_date` SET TAGS ('dbx_business_glossary_term' = 'Withdrawal Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `withdrawal_reason` SET TAGS ('dbx_business_glossary_term' = 'Withdrawal Reason');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`submission` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_amendment_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Amendment Identifier (PLAN_AMENDMENT_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `amendment_id` SET TAGS ('dbx_business_glossary_term' = 'Contract Amendment Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan Identifier (PLAN_ID)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Amendment Approval User Identifier (APPROVAL_USER_ID)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_created_by_user_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User Identifier (CREATED_BY_USER_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_created_by_user_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_created_by_user_employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_updated_by_user_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Updated By User Identifier (UPDATED_BY_USER_ID)');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `sbc_document_id` SET TAGS ('dbx_business_glossary_term' = 'SBC Document Identifier (SBC_DOC_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `amendment_number` SET TAGS ('dbx_business_glossary_term' = 'Amendment Number (AMENDMENT_NO)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `amendment_type` SET TAGS ('dbx_business_glossary_term' = 'Amendment Type (AMENDMENT_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `amendment_type` SET TAGS ('dbx_value_regex' = 'benefit_change|cost_share_change|network_change|service_area_change|formulary_update');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `approval_comment` SET TAGS ('dbx_business_glossary_term' = 'Amendment Approval Comment (APPROVAL_COMMENT)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `change_summary` SET TAGS ('dbx_business_glossary_term' = 'Amendment Change Summary (CHANGE_SUMMARY)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `cms_filing_reference` SET TAGS ('dbx_business_glossary_term' = 'CMS Filing Reference (CMS_FILING_REF)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `compliance_flag` SET TAGS ('dbx_business_glossary_term' = 'Compliance Flag (COMPLIANCE_FLAG)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `cost_share_change_details` SET TAGS ('dbx_business_glossary_term' = 'Cost Share Change Details (COST_SHARE_CHANGE_DETAILS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (CREATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_amendment_description` SET TAGS ('dbx_business_glossary_term' = 'Amendment Description (AMENDMENT_DESC)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `doi_filing_reference` SET TAGS ('dbx_business_glossary_term' = 'Department of Insurance Filing Reference (DOI_FILING_REF)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Amendment Effective Date (EFFECTIVE_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Amendment Effective End Date (EFFECTIVE_END_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `effective_year` SET TAGS ('dbx_business_glossary_term' = 'Amendment Effective Plan Year (EFFECTIVE_PLAN_YEAR)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `formulary_change_details` SET TAGS ('dbx_business_glossary_term' = 'Formulary Change Details (FORMULARY_CHANGE_DETAILS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `impact_estimated_cost` SET TAGS ('dbx_business_glossary_term' = 'Estimated Total Cost Impact (ESTIMATED_COST_IMPACT)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `impact_estimated_member_cost` SET TAGS ('dbx_business_glossary_term' = 'Estimated Member Cost Impact (ESTIMATED_MEMBER_COST_IMPACT)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `impact_estimated_provider_cost` SET TAGS ('dbx_business_glossary_term' = 'Estimated Provider Cost Impact (ESTIMATED_PROVIDER_COST_IMPACT)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `impacted_benefit_package_ids` SET TAGS ('dbx_business_glossary_term' = 'Impacted Benefit Package Identifiers (IMPACTED_BENEFIT_PKG_IDS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `member_notification_date` SET TAGS ('dbx_business_glossary_term' = 'Member Notification Date (MEMBER_NOTIFICATION_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `member_notification_required` SET TAGS ('dbx_business_glossary_term' = 'Member Notification Required Flag (MEMBER_NOTIFICATION_REQ)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `network_change_details` SET TAGS ('dbx_business_glossary_term' = 'Network Change Details (NETWORK_CHANGE_DETAILS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `reason_code` SET TAGS ('dbx_business_glossary_term' = 'Amendment Reason Code (AMENDMENT_REASON_CD)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `reason_description` SET TAGS ('dbx_business_glossary_term' = 'Amendment Reason Description (AMENDMENT_REASON_DESC)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `regulatory_approval_date` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Approval Date (REG_APPROVAL_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `regulatory_approval_status` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Approval Status (REG_APPROVAL_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `regulatory_approval_status` SET TAGS ('dbx_value_regex' = 'pending|approved|denied');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `review_deadline` SET TAGS ('dbx_business_glossary_term' = 'Amendment Review Deadline (REVIEW_DEADLINE)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `review_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `service_area_change_details` SET TAGS ('dbx_business_glossary_term' = 'Service Area Change Details (SERVICE_AREA_CHANGE_DETAILS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_amendment_status` SET TAGS ('dbx_business_glossary_term' = 'Amendment Lifecycle Status (AMENDMENT_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `plan_amendment_status` SET TAGS ('dbx_value_regex' = 'draft|pending|approved|denied|implemented|retracted');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `status_reason` SET TAGS ('dbx_business_glossary_term' = 'Amendment Status Reason (STATUS_REASON)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `triggers_sbc_generation` SET TAGS ('dbx_business_glossary_term' = 'Triggers SBC Document Generation Flag (TRIGGERS_SBC_GEN)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Last Updated Timestamp (UPDATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `version` SET TAGS ('dbx_business_glossary_term' = 'Amendment Version Number (AMENDMENT_VERSION)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_amendment` ALTER COLUMN `requestor_employee_id` SET TAGS ('dbx_renamed_from' = 'employee_id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` SET TAGS ('dbx_subdomain' = 'benefit_design');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `hsa_hra_config_id` SET TAGS ('dbx_business_glossary_term' = 'Health Savings Account / Health Reimbursement Arrangement Configuration ID');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Trustee / Custodian Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `account_type` SET TAGS ('dbx_business_glossary_term' = 'Account Type (HSA/HRA/FSA/LPFSA)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `account_type` SET TAGS ('dbx_value_regex' = 'HSA|HRA|FSA|LPFSA');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `catch_up_contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Catch‑Up Contribution Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `catch_up_contribution_eligible` SET TAGS ('dbx_business_glossary_term' = 'Catch‑Up Contribution Eligibility');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_frequency` SET TAGS ('dbx_business_glossary_term' = 'Contribution Frequency');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_frequency` SET TAGS ('dbx_value_regex' = 'monthly|quarterly|annually');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_limit_amount` SET TAGS ('dbx_business_glossary_term' = 'Contribution Limit Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_limit_type` SET TAGS ('dbx_business_glossary_term' = 'Contribution Limit Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_limit_type` SET TAGS ('dbx_value_regex' = 'per_year|per_month');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_method` SET TAGS ('dbx_business_glossary_term' = 'Contribution Method');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_method` SET TAGS ('dbx_value_regex' = 'pre_tax|post_tax|after_tax');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_source` SET TAGS ('dbx_business_glossary_term' = 'Contribution Source');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `contribution_source` SET TAGS ('dbx_value_regex' = 'employer|employee|both');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `hsa_hra_config_description` SET TAGS ('dbx_business_glossary_term' = 'Configuration Description');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `eligibility_hdpp` SET TAGS ('dbx_business_glossary_term' = 'HDHP Eligibility Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `employee_contribution_limit` SET TAGS ('dbx_business_glossary_term' = 'Employee Contribution Limit');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `employer_contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Employer Contribution Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `grace_period_option` SET TAGS ('dbx_business_glossary_term' = 'Grace Period Option');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `grace_period_option` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `irs_minimum_deductible` SET TAGS ('dbx_business_glossary_term' = 'IRS Minimum Deductible Threshold');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `irs_out_of_pocket_max` SET TAGS ('dbx_business_glossary_term' = 'IRS Out‑of‑Pocket Maximum Threshold');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `plan_year_end_date` SET TAGS ('dbx_business_glossary_term' = 'Plan Year End Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `plan_year_start_date` SET TAGS ('dbx_business_glossary_term' = 'Plan Year Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `regulatory_compliance_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Compliance Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `rollover_allowed` SET TAGS ('dbx_business_glossary_term' = 'Rollover Allowed Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `rollover_limit_amount` SET TAGS ('dbx_business_glossary_term' = 'Rollover Limit Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `hsa_hra_config_status` SET TAGS ('dbx_business_glossary_term' = 'Configuration Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `hsa_hra_config_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|retired');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `trustee_custodian_name` SET TAGS ('dbx_business_glossary_term' = 'Trustee / Custodian Name');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `trustee_custodian_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`hsa_hra_config` ALTER COLUMN `use_it_or_lose_it_flag` SET TAGS ('dbx_business_glossary_term' = 'Use‑It‑Or‑Lose‑It Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rx_benefit_config` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`rx_benefit_config` SET TAGS ('dbx_subdomain' = 'benefit_design');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`network_config` SET TAGS ('dbx_subdomain' = 'product_catalog');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`network_config` ALTER COLUMN `network_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` SET TAGS ('dbx_subdomain' = 'product_catalog');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Crosswalk Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Prior Health Plan Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Successor Health Plan Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Effective End Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Effective Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `is_mandatory` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Mandatory Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `member_notification_required` SET TAGS ('dbx_business_glossary_term' = 'Member Notification Required Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Notes');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `notification_method` SET TAGS ('dbx_business_glossary_term' = 'Member Notification Method');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `notification_method` SET TAGS ('dbx_value_regex' = 'email|mail|portal|phone');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `notification_sent_date` SET TAGS ('dbx_business_glossary_term' = 'Member Notification Sent Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `reason` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Reason');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `region` SET TAGS ('dbx_business_glossary_term' = 'Geographic Region');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `regulatory_submission_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Submission Flag');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `sequence` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Sequence Number');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_status` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Lifecycle Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|retired');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_type` SET TAGS ('dbx_business_glossary_term' = 'Crosswalk Type (Auto‑Renewal, Member‑Directed, CMS‑Mandated)');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `crosswalk_type` SET TAGS ('dbx_value_regex' = 'auto_renewal|member_directed|cms_mandated');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`crosswalk` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` SET TAGS ('dbx_subdomain' = 'product_catalog');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `status_history_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Status History ID');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Triggering User ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `audit_created_by` SET TAGS ('dbx_business_glossary_term' = 'Audit Created By');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `audit_created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Audit Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `audit_source_system` SET TAGS ('dbx_business_glossary_term' = 'Audit Source System');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `comments` SET TAGS ('dbx_business_glossary_term' = 'Comments');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `compliance_flag` SET TAGS ('dbx_business_glossary_term' = 'Compliance Review Required');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `is_legacy` SET TAGS ('dbx_business_glossary_term' = 'Is Legacy Transition');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `market_segment` SET TAGS ('dbx_business_glossary_term' = 'Market Segment');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `new_status` SET TAGS ('dbx_business_glossary_term' = 'New Plan Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `plan_type` SET TAGS ('dbx_business_glossary_term' = 'Plan Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `prior_status` SET TAGS ('dbx_business_glossary_term' = 'Prior Plan Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `reason_code` SET TAGS ('dbx_business_glossary_term' = 'Reason Code');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `reason_code` SET TAGS ('dbx_value_regex' = 'regulatory_action|market_withdrawal|merger|non_renewal|compliance_suspension|other');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `reason_description` SET TAGS ('dbx_business_glossary_term' = 'Reason Description');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `region` SET TAGS ('dbx_business_glossary_term' = 'Geographic Region');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `regulatory_action_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Action Reference');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `state_code` SET TAGS ('dbx_business_glossary_term' = 'State Code');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `transition_effective_date` SET TAGS ('dbx_business_glossary_term' = 'Transition Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `transition_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Transition Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `triggered_by` SET TAGS ('dbx_business_glossary_term' = 'Triggered By');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `triggered_by` SET TAGS ('dbx_value_regex' = 'system|user|automated_process');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `triggered_by_system_name` SET TAGS ('dbx_business_glossary_term' = 'Triggering System Name');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`status_history` ALTER COLUMN `triggered_by_system_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` SET TAGS ('dbx_subdomain' = 'premium_pricing');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` SET TAGS ('dbx_association_edges' = 'plan.health_plan,employer.employer_group');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `offering_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Offering - Plan Offering Id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Offering - Employer Group Id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Offering - Health Plan Id');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `offering_code` SET TAGS ('dbx_business_glossary_term' = 'Offering Code');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Contribution Amount');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `contribution_percent` SET TAGS ('dbx_business_glossary_term' = 'Contribution Percent');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `contribution_tier` SET TAGS ('dbx_business_glossary_term' = 'Contribution Tier');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `contribution_type` SET TAGS ('dbx_business_glossary_term' = 'Contribution Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `employee_contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Employee Contribution');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `family_contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Family Contribution');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `offering_name` SET TAGS ('dbx_business_glossary_term' = 'Offering Name');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `offering_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `open_enrollment_end_date` SET TAGS ('dbx_business_glossary_term' = 'Open Enrollment End');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `open_enrollment_start_date` SET TAGS ('dbx_business_glossary_term' = 'Open Enrollment Start');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `offering_status` SET TAGS ('dbx_business_glossary_term' = 'Offering Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`offering` ALTER COLUMN `offering_type` SET TAGS ('dbx_business_glossary_term' = 'Offering Type');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` SET TAGS ('dbx_subdomain' = 'premium_pricing');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` SET TAGS ('dbx_association_edges' = 'plan.health_plan,care.care_program');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` ALTER COLUMN `program_coverage_id` SET TAGS ('dbx_business_glossary_term' = 'Programcoverage - Program Coverage Id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Programcoverage - Health Plan Id');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` ALTER COLUMN `program_id` SET TAGS ('dbx_business_glossary_term' = 'Programcoverage - Care Program Id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`program_coverage` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` SET TAGS ('dbx_subdomain' = 'regulatory_compliance');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` SET TAGS ('dbx_association_edges' = 'plan.health_plan,compliance.regulatory_obligation');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` SET TAGS ('dbx_ssot_owner' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` SET TAGS ('dbx_ssot_entity' = 'regulatory_obligation');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` ALTER COLUMN `plan_regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Regulatory Obligation - Plan Regulatory Obligation Id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Regulatory Obligation - Health Plan Id');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` ALTER COLUMN `compliance_status` SET TAGS ('dbx_business_glossary_term' = 'Compliance Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` ALTER COLUMN `last_assessment_date` SET TAGS ('dbx_business_glossary_term' = 'Last Assessment Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_regulatory_obligation` ALTER COLUMN `next_due_date` SET TAGS ('dbx_business_glossary_term' = 'Next Due Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` SET TAGS ('dbx_subdomain' = 'premium_pricing');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` SET TAGS ('dbx_association_edges' = 'plan.health_plan,contract.provider_contract');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` ALTER COLUMN `plan_provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Provider Contract - Plan Provider Contract Id');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Provider Contract - Health Plan Id');
...
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` ALTER COLUMN `provider_network_participation_id` SET TAGS ('dbx_business_glossary_term' = 'Network Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` ALTER COLUMN `contract_status` SET TAGS ('dbx_business_glossary_term' = 'Contract Status');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Contract Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`plan`.`plan_provider_contract` ALTER COLUMN `termination_date` SET TAGS ('dbx_business_glossary_term' = 'Contract Termination Date');
