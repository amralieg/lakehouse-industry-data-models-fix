...
-- Total cross-domain FK constraints: 782
--
-- EXECUTION ORDER:
...
ALTER TABLE `vibe_restaurants_v1`.`finance`.`journal_entry_line` ADD CONSTRAINT `fk_finance_journal_entry_line_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `vibe_restaurants_v1`.`guest`.`profile`(`profile_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`journal_entry_line` ADD CONSTRAINT `fk_finance_journal_entry_line_journal_profile_id` FOREIGN KEY (`journal_profile_id`) REFERENCES `vibe_restaurants_v1`.`guest`.`profile`(`profile_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ar_invoice` ADD CONSTRAINT `fk_finance_ar_invoice_ar_profile_id` FOREIGN KEY (`ar_profile_id`) REFERENCES `vibe_restaurants_v1`.`guest`.`profile`(`profile_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ar_payment` ADD CONSTRAINT `fk_finance_ar_payment_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `vibe_restaurants_v1`.`guest`.`profile`(`profile_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`finance`.`journal_entry_line` ADD CONSTRAINT `fk_finance_journal_entry_line_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`journal_entry_line` ADD CONSTRAINT `fk_finance_journal_entry_line_journal_vendor_procurement_supplier_id` FOREIGN KEY (`journal_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ap_invoice` ADD CONSTRAINT `fk_finance_ap_invoice_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ap_invoice` ADD CONSTRAINT `fk_finance_ap_invoice_ap_vendor_procurement_supplier_id` FOREIGN KEY (`ap_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ap_invoice_line` ADD CONSTRAINT `fk_finance_ap_invoice_line_purchase_order_id` FOREIGN KEY (`purchase_order_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`purchase_order`(`purchase_order_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ap_invoice_line` ADD CONSTRAINT `fk_finance_ap_invoice_line_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ap_payment` ADD CONSTRAINT `fk_finance_ap_payment_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`ap_payment` ADD CONSTRAINT `fk_finance_ap_payment_ap_vendor_procurement_supplier_id` FOREIGN KEY (`ap_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`fixed_asset` ADD CONSTRAINT `fk_finance_fixed_asset_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`fixed_asset` ADD CONSTRAINT `fk_finance_fixed_asset_fixed_vendor_procurement_supplier_id` FOREIGN KEY (`fixed_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`tax_posting` ADD CONSTRAINT `fk_finance_tax_posting_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`tax_posting` ADD CONSTRAINT `fk_finance_tax_posting_tax_vendor_procurement_supplier_id` FOREIGN KEY (`tax_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`finance`.`bank_statement_line` ADD CONSTRAINT `fk_finance_bank_statement_line_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
-- ========= finance --> restaurant (23 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`health_inspection` ADD CONSTRAINT `fk_foodsafety_health_inspection_stock_location_id` FOREIGN KEY (`stock_location_id`) REFERENCES `vibe_restaurants_v1`.`inventory`.`stock_location`(`stock_location_id`);
...
-- ========= foodsafety --> procurement (8 constraint(s)) =========
-- Requires: foodsafety schema, procurement schema
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`sanitation_schedule` ADD CONSTRAINT `fk_foodsafety_sanitation_schedule_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`allergen_incident` ADD CONSTRAINT `fk_foodsafety_allergen_incident_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`illness_report` ADD CONSTRAINT `fk_foodsafety_illness_report_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`food_recall` ADD CONSTRAINT `fk_foodsafety_food_recall_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`food_recall` ADD CONSTRAINT `fk_foodsafety_food_recall_primary_food_procurement_supplier_id` FOREIGN KEY (`primary_food_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`pest_control_log` ADD CONSTRAINT `fk_foodsafety_pest_control_log_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`pest_control_log` ADD CONSTRAINT `fk_foodsafety_pest_control_log_pest_service_provider_procurement_supplier_id` FOREIGN KEY (`pest_service_provider_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`receiving_inspection` ADD CONSTRAINT `fk_foodsafety_receiving_inspection_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);

-- ========= foodsafety --> realestate (5 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`health_inspection` ADD CONSTRAINT `fk_foodsafety_health_inspection_health_unit_id` FOREIGN KEY (`health_unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`food_safety_certification` ADD CONSTRAINT `fk_foodsafety_food_safety_certification_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`foodsafety_supplier_certification` ADD CONSTRAINT `fk_foodsafety_foodsafety_supplier_certification_supply_supplier_id` FOREIGN KEY (`supply_supplier_id`) REFERENCES `vibe_restaurants_v1`.`supply`.`supply_supplier`(`supply_supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`foodsafety`.`environmental_monitoring` ADD CONSTRAINT `fk_foodsafety_environmental_monitoring_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_restaurants_v1`.`workforce`.`employee`(`employee_id`);

-- ========= franchise --> finance (4 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`franchise`.`sales_report` ADD CONSTRAINT `fk_franchise_sales_report_financial_period_id` FOREIGN KEY (`financial_period_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`financial_period`(`financial_period_id`);

-- ========= franchise --> loyalty (1 constraint(s)) =========
-- Requires: franchise schema, loyalty schema
ALTER TABLE `vibe_restaurants_v1`.`franchise`.`franchisee` ADD CONSTRAINT `fk_franchise_franchisee_program_id` FOREIGN KEY (`program_id`) REFERENCES `vibe_restaurants_v1`.`loyalty`.`program`(`program_id`);

-- ========= franchise --> marketing (1 constraint(s)) =========
-- Requires: franchise schema, marketing schema
ALTER TABLE `vibe_restaurants_v1`.`franchise`.`marketing_fund_contribution` ADD CONSTRAINT `fk_franchise_marketing_fund_contribution_fund_id` FOREIGN KEY (`fund_id`) REFERENCES `vibe_restaurants_v1`.`marketing`.`fund`(`fund_id`);

-- ========= franchise --> realestate (2 constraint(s)) =========
...
-- ========= franchise --> restaurant (8 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`franchise`.`development_schedule` ADD CONSTRAINT `fk_franchise_development_schedule_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`franchise`.`performance_scorecard` ADD CONSTRAINT `fk_franchise_performance_scorecard_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`guest`.`guest_allergen_profile` ADD CONSTRAINT `fk_guest_guest_allergen_profile_stock_item_id` FOREIGN KEY (`stock_item_id`) REFERENCES `vibe_restaurants_v1`.`inventory`.`stock_item`(`stock_item_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`guest`.`guest_communication` ADD CONSTRAINT `fk_guest_guest_communication_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `vibe_restaurants_v1`.`marketing`.`campaign`(`campaign_id`);
ALTER TABLE `vibe_restaurants_v1`.`guest`.`guest_communication` ADD CONSTRAINT `fk_guest_guest_communication_content_template_id` FOREIGN KEY (`content_template_id`) REFERENCES `vibe_restaurants_v1`.`marketing`.`content_template`(`content_template_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`guest`.`complaint` ADD CONSTRAINT `fk_guest_complaint_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`guest`.`guest_communication` ADD CONSTRAINT `fk_guest_guest_communication_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`physical_count` ADD CONSTRAINT `fk_inventory_physical_count_journal_entry_id` FOREIGN KEY (`journal_entry_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`journal_entry`(`journal_entry_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`food_cost_period` ADD CONSTRAINT `fk_inventory_food_cost_period_financial_period_id` FOREIGN KEY (`financial_period_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`financial_period`(`financial_period_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`food_cost_period` ADD CONSTRAINT `fk_inventory_food_cost_period_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `vibe_restaurants_v1`.`marketing`.`campaign`(`campaign_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`stock_item` ADD CONSTRAINT `fk_inventory_stock_item_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`stock_item` ADD CONSTRAINT `fk_inventory_stock_item_stock_procurement_supplier_id` FOREIGN KEY (`stock_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`receiving_order` ADD CONSTRAINT `fk_inventory_receiving_order_purchase_order_id` FOREIGN KEY (`purchase_order_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`purchase_order`(`purchase_order_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`receiving_order` ADD CONSTRAINT `fk_inventory_receiving_order_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`waste_log` ADD CONSTRAINT `fk_inventory_waste_log_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`waste_log` ADD CONSTRAINT `fk_inventory_waste_log_waste_vendor_procurement_supplier_id` FOREIGN KEY (`waste_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`replenishment_order` ADD CONSTRAINT `fk_inventory_replenishment_order_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`vendor_item` ADD CONSTRAINT `fk_inventory_vendor_item_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`vendor_item` ADD CONSTRAINT `fk_inventory_vendor_item_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`lot_tracking` ADD CONSTRAINT `fk_inventory_lot_tracking_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
-- ========= inventory --> realestate (6 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`stock_location` ADD CONSTRAINT `fk_inventory_stock_location_stock_equipment_equipment_asset_id` FOREIGN KEY (`stock_equipment_equipment_asset_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`equipment_asset`(`equipment_asset_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`inventory`.`inventory_ingredient_usage` ADD CONSTRAINT `fk_inventory_inventory_ingredient_usage_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`loyalty`.`reward` ADD CONSTRAINT `fk_loyalty_reward_franchisee_id` FOREIGN KEY (`franchisee_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`franchisee`(`franchisee_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`loyalty`.`challenge` ADD CONSTRAINT `fk_loyalty_challenge_franchisee_id` FOREIGN KEY (`franchisee_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`franchisee`(`franchisee_id`);
...
-- ========= loyalty --> realestate (3 constraint(s)) =========
-- Requires: loyalty schema, realestate schema
ALTER TABLE `vibe_restaurants_v1`.`loyalty`.`member` ADD CONSTRAINT `fk_loyalty_member_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`site`(`site_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`loyalty`.`loyalty_segment` ADD CONSTRAINT `fk_loyalty_loyalty_segment_trade_area_id` FOREIGN KEY (`trade_area_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`trade_area`(`trade_area_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`loyalty`.`points_ledger` ADD CONSTRAINT `fk_loyalty_points_ledger_points_unit_id` FOREIGN KEY (`points_unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`loyalty`.`challenge_enrollment` ADD CONSTRAINT `fk_loyalty_challenge_enrollment_challenge_unit_id` FOREIGN KEY (`challenge_unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
-- ========= marketing --> foodsafety (2 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_execution` ADD CONSTRAINT `fk_marketing_campaign_execution_agreement_id` FOREIGN KEY (`agreement_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`agreement`(`agreement_id`);
...
-- ========= marketing --> guest (4 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`marketing_guest_segment` ADD CONSTRAINT `fk_marketing_marketing_guest_segment_guest_segment_id` FOREIGN KEY (`guest_segment_id`) REFERENCES `vibe_restaurants_v1`.`guest`.`guest_segment`(`guest_segment_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` ADD CONSTRAINT `fk_marketing_media_buy_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` ADD CONSTRAINT `fk_marketing_media_buy_media_vendor_procurement_supplier_id` FOREIGN KEY (`media_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`local_store_marketing` ADD CONSTRAINT `fk_marketing_local_store_marketing_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_spend` ADD CONSTRAINT `fk_marketing_campaign_spend_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_spend` ADD CONSTRAINT `fk_marketing_campaign_spend_campaign_vendor_procurement_supplier_id` FOREIGN KEY (`campaign_vendor_procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);

-- ========= marketing --> realestate (1 constraint(s)) =========
-- Requires: marketing schema, realestate schema
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign` ADD CONSTRAINT `fk_marketing_campaign_trade_area_id` FOREIGN KEY (`trade_area_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`trade_area`(`trade_area_id`);

-- ========= marketing --> restaurant (9 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_roi` ADD CONSTRAINT `fk_marketing_campaign_roi_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);

-- ========= marketing --> supply (3 constraint(s)) =========
-- Requires: marketing schema, supply schema
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign` ADD CONSTRAINT `fk_marketing_campaign_ingredient_id` FOREIGN KEY (`ingredient_id`) REFERENCES `vibe_restaurants_v1`.`supply`.`ingredient`(`ingredient_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`menu`.`menu_lto` ADD CONSTRAINT `fk_menu_menu_lto_franchisee_id` FOREIGN KEY (`franchisee_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`franchisee`(`franchisee_id`);
...
-- ========= menu --> procurement (2 constraint(s)) =========
-- Requires: menu schema, procurement schema
ALTER TABLE `vibe_restaurants_v1`.`menu`.`recipe_ingredient` ADD CONSTRAINT `fk_menu_recipe_ingredient_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`menu`.`item_86_event` ADD CONSTRAINT `fk_menu_item_86_event_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
-- ========= menu --> restaurant (8 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`menu`.`menu_lto` ADD CONSTRAINT `fk_menu_menu_lto_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`menu`.`combo_component` ADD CONSTRAINT `fk_menu_combo_component_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`order`.`guest_order` ADD CONSTRAINT `fk_order_guest_order_territory_id` FOREIGN KEY (`territory_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`territory`(`territory_id`);
...
-- ========= order --> realestate (8 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`order`.`payment` ADD CONSTRAINT `fk_order_payment_site_id` FOREIGN KEY (`site_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`site`(`site_id`);
...
-- ========= order --> restaurant (22 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`purchase_order` ADD CONSTRAINT `fk_procurement_purchase_order_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`cost_center`(`cost_center_id`);

-- ========= procurement --> franchise (2 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`purchase_order` ADD CONSTRAINT `fk_procurement_purchase_order_franchisee_id` FOREIGN KEY (`franchisee_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`franchisee`(`franchisee_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`purchase_order` ADD CONSTRAINT `fk_procurement_purchase_order_stock_location_id` FOREIGN KEY (`stock_location_id`) REFERENCES `vibe_restaurants_v1`.`inventory`.`stock_location`(`stock_location_id`);

-- ========= procurement --> order (2 constraint(s)) =========
-- Requires: procurement schema, order schema
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`supplier_invoice` ADD CONSTRAINT `fk_procurement_supplier_invoice_tax_id` FOREIGN KEY (`tax_id`) REFERENCES `vibe_restaurants_v1`.`order`.`tax`(`tax_id`);
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`procurement_item` ADD CONSTRAINT `fk_procurement_procurement_item_order_item_id` FOREIGN KEY (`order_item_id`) REFERENCES `vibe_restaurants_v1`.`order`.`order_item`(`order_item_id`);

-- ========= procurement --> restaurant (4 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`purchase_order` ADD CONSTRAINT `fk_procurement_purchase_order_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`purchase_order` ADD CONSTRAINT `fk_procurement_purchase_order_purchase_unit_id` FOREIGN KEY (`purchase_unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`requisition` ADD CONSTRAINT `fk_procurement_requisition_department_id` FOREIGN KEY (`department_id`) REFERENCES `vibe_restaurants_v1`.`workforce`.`department`(`department_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`procurement`.`purchase_order` ADD CONSTRAINT `fk_procurement_purchase_order_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_restaurants_v1`.`workforce`.`employee`(`employee_id`);

-- ========= realestate --> finance (12 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`facility` ADD CONSTRAINT `fk_realestate_facility_legal_entity_id` FOREIGN KEY (`legal_entity_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`legal_entity`(`legal_entity_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`property_acquisition` ADD CONSTRAINT `fk_realestate_property_acquisition_acquiring_legal_entity_id` FOREIGN KEY (`acquiring_legal_entity_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`legal_entity`(`legal_entity_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`tenant` ADD CONSTRAINT `fk_realestate_tenant_tax_id` FOREIGN KEY (`tax_id`) REFERENCES `vibe_restaurants_v1`.`order`.`tax`(`tax_id`);

-- ========= realestate --> procurement (4 constraint(s)) =========
-- Requires: realestate schema, procurement schema
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`nro_project` ADD CONSTRAINT `fk_realestate_nro_project_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`maintenance_work_order` ADD CONSTRAINT `fk_realestate_maintenance_work_order_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`maintenance_contract` ADD CONSTRAINT `fk_realestate_maintenance_contract_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
-- ========= realestate --> restaurant (7 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`rent_payment` ADD CONSTRAINT `fk_realestate_rent_payment_rent_unit_id` FOREIGN KEY (`rent_unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
ALTER TABLE `vibe_restaurants_v1`.`realestate`.`capex_budget` ADD CONSTRAINT `fk_realestate_capex_budget_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
-- ========= restaurant --> franchise (4 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`restaurant`.`equipment_asset` ADD CONSTRAINT `fk_restaurant_equipment_asset_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
-- ========= restaurant --> workforce (19 constraint(s)) =========
-- Requires: restaurant schema, workforce schema
ALTER TABLE `vibe_restaurants_v1`.`restaurant`.`unit` ADD CONSTRAINT `fk_restaurant_unit_department_id` FOREIGN KEY (`department_id`) REFERENCES `vibe_restaurants_v1`.`workforce`.`department`(`department_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`supply_supplier` ADD CONSTRAINT `fk_supply_supply_supplier_legal_entity_id` FOREIGN KEY (`legal_entity_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`legal_entity`(`legal_entity_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`supply_invoice` ADD CONSTRAINT `fk_supply_supply_invoice_ap_invoice_id` FOREIGN KEY (`ap_invoice_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`ap_invoice`(`ap_invoice_id`);
...
-- ========= supply --> procurement (18 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`goods_receipt` ADD CONSTRAINT `fk_supply_goods_receipt_purchase_order_id` FOREIGN KEY (`purchase_order_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`purchase_order`(`purchase_order_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`goods_receipt` ADD CONSTRAINT `fk_supply_goods_receipt_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`goods_receipt_line` ADD CONSTRAINT `fk_supply_goods_receipt_line_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`supplier_contract` ADD CONSTRAINT `fk_supply_supplier_contract_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`contract_price` ADD CONSTRAINT `fk_supply_contract_price_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`supplier_performance` ADD CONSTRAINT `fk_supply_supplier_performance_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`inbound_shipment` ADD CONSTRAINT `fk_supply_inbound_shipment_purchase_order_id` FOREIGN KEY (`purchase_order_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`purchase_order`(`purchase_order_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`inbound_shipment` ADD CONSTRAINT `fk_supply_inbound_shipment_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`quality_inspection` ADD CONSTRAINT `fk_supply_quality_inspection_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`recall_event` ADD CONSTRAINT `fk_supply_recall_event_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`commodity_category` ADD CONSTRAINT `fk_supply_commodity_category_category_id` FOREIGN KEY (`category_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`category`(`category_id`);
ALTER TABLE `vibe_restaurants_v1`.`supply`.`supply_contract` ADD CONSTRAINT `fk_supply_supply_contract_procurement_supplier_id` FOREIGN KEY (`procurement_supplier_id`) REFERENCES `vibe_restaurants_v1`.`procurement`.`supplier`(`supplier_id`);
...
-- ========= supply --> restaurant (6 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`supply`.`supplier_performance` ADD CONSTRAINT `fk_supply_supplier_performance_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`labor_forecast` ADD CONSTRAINT `fk_workforce_labor_forecast_financial_period_id` FOREIGN KEY (`financial_period_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`financial_period`(`financial_period_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`labor_budget` ADD CONSTRAINT `fk_workforce_labor_budget_financial_period_id` FOREIGN KEY (`financial_period_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`financial_period`(`financial_period_id`);
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`payroll_group` ADD CONSTRAINT `fk_workforce_payroll_group_legal_entity_id` FOREIGN KEY (`legal_entity_id`) REFERENCES `vibe_restaurants_v1`.`finance`.`legal_entity`(`legal_entity_id`);

-- ========= workforce --> franchise (1 constraint(s)) =========
-- Requires: workforce schema, franchise schema
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`department` ADD CONSTRAINT `fk_workforce_department_franchisee_id` FOREIGN KEY (`franchisee_id`) REFERENCES `vibe_restaurants_v1`.`franchise`.`franchisee`(`franchisee_id`);

-- ========= workforce --> realestate (8 constraint(s)) =========
...
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`onboarding` ADD CONSTRAINT `fk_workforce_onboarding_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`facility`(`facility_id`);
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`training_completion` ADD CONSTRAINT `fk_workforce_training_completion_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`facility`(`facility_id`);
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`performance_review` ADD CONSTRAINT `fk_workforce_performance_review_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`facility`(`facility_id`);
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`leave_request` ADD CONSTRAINT `fk_workforce_leave_request_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_restaurants_v1`.`realestate`.`facility`(`facility_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`certification` ADD CONSTRAINT `fk_workforce_certification_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
...
ALTER TABLE `vibe_restaurants_v1`.`workforce`.`scheduling_template` ADD CONSTRAINT `fk_workforce_scheduling_template_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `vibe_restaurants_v1`.`restaurant`.`unit`(`unit_id`);
