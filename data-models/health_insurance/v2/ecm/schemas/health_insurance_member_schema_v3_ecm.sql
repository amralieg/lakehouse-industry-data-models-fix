-- Schema for Domain: member | Business:  | Version: v3_ecm
-- Generated on: 2026-07-10 20:47:17
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`member`.`subscriber` (
    ...
    `address_id` BIGINT COMMENT 'FK to member.address',
    ...
    `typed_attr_regex_removed_1` DATE COMMENT '',
    `typed_attr_regex_removed_2` DATE COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`member`.`household` (
    ...
    `number` STRING COMMENT 'Unique household identifier assigned by the core administration system.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`member`.`consent` (
    ...
    `consent_witnessed_by_employee_id` BIGINT COMMENT 'Identifier of the system user who entered the consent.',
    ...
    `consenting_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`member`.`disenrollment` (
    ...
    `disenrollment_health_plan_id` BIGINT COMMENT 'Identifier of the health plan the member was enrolled in before disenrollment.',
    `health_plan_id` BIGINT COMMENT 'Identifier of a new plan if the member re‑enrolls immediately after disenrollment.',
    ...
    `number` STRING COMMENT 'Business identifier assigned to the disenrollment event, used for external reporting and audit.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`member`.`member_communication` (
    ...
    `number` STRING COMMENT 'Human‑readable identifier assigned to the communication for tracking and reference.',
    ...
    `member_communication_type` STRING COMMENT 'Category of the outbound/inbound communication (e.g., Explanation of Benefits, Welcome Kit, ID Card, Annual Notice of Change, Evidence of Coverage, Summary of Benefits and Coverage).. Valid values are `EOB|WELCOME_KIT|ID_CARD|ANOC|EOC|SBC`',
...
-- ========= FOREIGN KEYS =========
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ADD CONSTRAINT `fk_member_subscriber_address_id` FOREIGN KEY (`address_id`) REFERENCES `vibe_health_insurance_v1`.`member`.`address`(`address_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `address_id` SET TAGS ('dbx_business_glossary_term' = 'Member Address Id');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `address_id` SET TAGS ('dbx_internal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `address_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `address_id` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `primary_contact_method` SET TAGS ('dbx_pii_sensitive' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `race_ethnicity` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `tobacco_use_status` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `typed_attr_regex_removed_1` SET TAGS ('dbx_value_regex_removed' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`subscriber` ALTER COLUMN `typed_attr_regex_removed_2` SET TAGS ('dbx_value_regex_removed' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`dependent` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`dependent` ALTER COLUMN `transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`identity` ALTER COLUMN `city` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`identity` ALTER COLUMN `ethnicity` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`identity` ALTER COLUMN `primary_contact_method` SET TAGS ('dbx_pii_sensitive' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`identity` ALTER COLUMN `state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_contact` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_contact` ALTER COLUMN `address_type` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_contact` ALTER COLUMN `census_tract` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_contact` ALTER COLUMN `county_fips` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_contact` ALTER COLUMN `language_preference` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `income_source` SET TAGS ('dbx_value_regex' = 'employment|self_employed|investment|government|other');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `income_source` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `income_verification_flag` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `is_hispanic` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `is_veteran` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `language_preference` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `household_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`household` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Household Number (HHLD_NUM)');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`lob_assignment` SET TAGS ('dbx_subdomain' = 'care_assignment');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`lob_assignment` ALTER COLUMN `star_rating_cohort` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`lob_assignment` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`cobra_continuant` ALTER COLUMN `election_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`cobra_continuant` ALTER COLUMN `payment_frequency` SET TAGS ('dbx_value_regex' = 'monthly|quarterly|annual');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`cobra_continuant` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'auto_debit|check|credit_card|other');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`cobra_continuant` ALTER COLUMN `cobra_continuant_status` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`pcp_assignment` SET TAGS ('dbx_subdomain' = 'care_assignment');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`cob_record` ALTER COLUMN `other_carrier_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` SET TAGS ('dbx_subdomain' = 'member_identity');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Updated By User ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `consent_witnessed_by_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User ID');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `consent_witnessed_by_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `consent_witnessed_by_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `is_electronic_signature` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `signature_timestamp` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`consent` ALTER COLUMN `consenting_employee_id` SET TAGS ('dbx_renamed_from' = 'employee_id');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`disenrollment` ALTER COLUMN `disenrollment_health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Prior Plan ID');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`disenrollment` ALTER COLUMN `disenrollment_health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`disenrollment` ALTER COLUMN `disenrollment_health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`disenrollment` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'New Plan ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`disenrollment` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Disenrollment Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`segment` SET TAGS ('dbx_subdomain' = 'care_assignment');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`segment` ALTER COLUMN `hcc_risk_score_tier` SET TAGS ('dbx_value_regex' = '1|2|3|4|5');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`segment` ALTER COLUMN `segment_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`segment` ALTER COLUMN `star_rating_cohort` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`id_card` SET TAGS ('dbx_subdomain' = 'member_identity');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`authorized_representative` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`authorized_representative` ALTER COLUMN `license_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`policy` SET TAGS ('dbx_subdomain' = 'coverage_eligibility');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`policy` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`authorization_document` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Id');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`authorization_document` ALTER COLUMN `provider_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`authorization_document` ALTER COLUMN `provider_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`authorization_document` ALTER COLUMN `member_gender` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`assignment_rule` SET TAGS ('dbx_subdomain' = 'care_assignment');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`assignment_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` SET TAGS ('dbx_subdomain' = 'coverage_eligibility');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `member_eligibility_span_id` SET TAGS ('dbx_business_glossary_term' = 'Member Eligibility Span Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `benefit_package_id` SET TAGS ('dbx_business_glossary_term' = 'Benefit Package Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Group Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (Member ID)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `provider_network_id` SET TAGS ('dbx_business_glossary_term' = 'Network Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `pool_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Pool Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `cobro_end_date` SET TAGS ('dbx_business_glossary_term' = 'COBRA End Date');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `cobro_start_date` SET TAGS ('dbx_business_glossary_term' = 'COBRA Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `coverage_type` SET TAGS ('dbx_business_glossary_term' = 'Coverage Type');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `coverage_type` SET TAGS ('dbx_value_regex' = 'medical|dental|vision|rx|wellness');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Eligibility Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `eligibility_source` SET TAGS ('dbx_business_glossary_term' = 'Eligibility Source');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `eligibility_source` SET TAGS ('dbx_value_regex' = '834|manual|cms|portal');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `eligibility_status` SET TAGS ('dbx_business_glossary_term' = 'Eligibility Status');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `eligibility_status` SET TAGS ('dbx_value_regex' = 'active|terminated|suspended|cobra|pending');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `enrollment_type` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Type');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `enrollment_type` SET TAGS ('dbx_value_regex' = 'new|renewal|change|reinstatement');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `gap_in_coverage_flag` SET TAGS ('dbx_business_glossary_term' = 'Gap In Coverage Flag');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `is_primary_coverage` SET TAGS ('dbx_business_glossary_term' = 'Primary Coverage Indicator');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `line_of_business` SET TAGS ('dbx_business_glossary_term' = 'Line of Business (LOB)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `line_of_business` SET TAGS ('dbx_value_regex' = 'commercial|medicare|medicaid|chip');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `premium_currency` SET TAGS ('dbx_business_glossary_term' = 'Premium Currency (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `premium_currency` SET TAGS ('dbx_value_regex' = '[A-Z]{3}');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `retroactive_eligibility_flag` SET TAGS ('dbx_business_glossary_term' = 'Retroactive Eligibility Flag');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `subscriber_relationship_code` SET TAGS ('dbx_business_glossary_term' = 'Subscriber Relationship Code (SRC)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `subscriber_relationship_code` SET TAGS ('dbx_value_regex' = 'self|spouse|child|parent|other');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `termination_date` SET TAGS ('dbx_business_glossary_term' = 'Eligibility Termination Date');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `termination_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Termination Reason Code (TRC)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `termination_reason_code` SET TAGS ('dbx_value_regex' = 'member_request|non_payment|plan_change|death|other');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_eligibility_span` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_enrollment` SET TAGS ('dbx_association_edges' = 'member.subscriber,care.care_program');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_enrollment` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_communication` SET TAGS ('dbx_subdomain' = 'member_identity');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_communication` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Communication Provider Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_communication` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Communication Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_communication` ALTER COLUMN `member_communication_type` SET TAGS ('dbx_business_glossary_term' = 'Communication Type');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_communication` ALTER COLUMN `member_communication_type` SET TAGS ('dbx_value_regex' = 'EOB|WELCOME_KIT|ID_CARD|ANOC|EOC|SBC');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` SET TAGS ('dbx_subdomain' = 'member_identity');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Grievance Provider Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Grievance Number (GRV_NUM)');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` ALTER COLUMN `source` SET TAGS ('dbx_business_glossary_term' = 'Grievance Source (GRV_SRC)');
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` ALTER COLUMN `source` SET TAGS ('dbx_value_regex' = 'call_center|online_portal|mail|in_person');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_grievance` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_lifecycle_event` SET TAGS ('dbx_subdomain' = 'member_identity');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_lifecycle_event` ALTER COLUMN `cms_reporting_indicator` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`member`.`member_lifecycle_event` ALTER COLUMN `relocation_state_code` SET TAGS ('dbx_pii_person_data' = 'true');
