...
-- Generated on: 2026-07-10 13:03:45
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` (
    ...
    `batch_modified_by_user_employee_id` BIGINT COMMENT 'User identifier of the person who last modified the batch release record. Required for audit trail and 21 CFR Part 11 compliance.',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`quality`.`audit_program` (
    ...
    `manufacturing_facility_id` BIGINT COMMENT 'add column manufacturing_facility_id (BIGINT) with FK to manufacturing.manufacturing_facility.manufacturing_facility_id - audit programs target specific manufacturing facilities',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`quality`.`audit_checklist` (
    ...
    `manufacturing_facility_id` BIGINT COMMENT 'add column manufacturing_facility_id (BIGINT) with FK to manufacturing.manufacturing_facility.manufacturing_facility_id - audit checklists are often facility-specific for GMP compliance',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` (
    ...
    `compliance_flag` BOOLEAN COMMENT 'Key compliance framework(s) the laboratory adheres to.',
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`inspection_lot` ALTER COLUMN `carbon_emission_id` SET TAGS ('dbx_business_glossary_term' = 'Carbon Emission Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`inspection_result` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Inspector ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`nonconformance` SET TAGS ('dbx_subdomain' = 'compliance_assurance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`nonconformance` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Closed By User ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`capa` SET TAGS ('dbx_subdomain' = 'compliance_assurance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`capa` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Closed By ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` SET TAGS ('dbx_subdomain' = 'batch_stability');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Qualified Person (QP) ID');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ALTER COLUMN `batch_modified_by_user_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Modified By User ID');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ALTER COLUMN `batch_modified_by_user_employee_id` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ALTER COLUMN `prototype_id` SET TAGS ('dbx_business_glossary_term' = 'Prototype Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`quality_stability_study` SET TAGS ('dbx_subdomain' = 'batch_stability');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`stability_result` SET TAGS ('dbx_subdomain' = 'batch_stability');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`gmp_audit` SET TAGS ('dbx_subdomain' = 'audit_supplier');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`gmp_audit` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Lead Auditor ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`audit_finding` SET TAGS ('dbx_subdomain' = 'audit_supplier');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`supplier_assessment` SET TAGS ('dbx_subdomain' = 'audit_supplier');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`product_complaint` SET TAGS ('dbx_subdomain' = 'compliance_assurance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`product_complaint` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Investigation Assigned Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`product_complaint` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`regulatory_hold` SET TAGS ('dbx_subdomain' = 'compliance_assurance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`specification` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Specification Approved By Employee Id');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`specification` ALTER COLUMN `employee_id` SET TAGS ('dbx_internal' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`lab_test_request` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Requestor Employee ID');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`lab_test_request` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`lab_test_request` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`lab_test_request` ALTER COLUMN `inspection_lot_number` SET TAGS ('dbx_business_glossary_term' = 'Quality Control (QC) Inspection Lot Number');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`lab_test_request` ALTER COLUMN `sample_code` SET TAGS ('dbx_business_glossary_term' = 'Sample Identification Number');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`notification` SET TAGS ('dbx_subdomain' = 'compliance_assurance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`notification` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Closed By User ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`control_chart` SET TAGS ('dbx_subdomain' = 'laboratory_testing');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`control_chart` ALTER COLUMN `specification_id` SET TAGS ('dbx_business_glossary_term' = 'Control Chart Specification Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`change_control` SET TAGS ('dbx_subdomain' = 'compliance_assurance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`change_control` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Initiator Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`change_control` ALTER COLUMN `change_description` SET TAGS ('dbx_business_glossary_term' = 'Change Description');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`audit_program` SET TAGS ('dbx_subdomain' = 'audit_supplier');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`audit_checklist` SET TAGS ('dbx_subdomain' = 'audit_supplier');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` ALTER COLUMN `latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` ALTER COLUMN `latitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` ALTER COLUMN `longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` ALTER COLUMN `longitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` ALTER COLUMN `laboratory_name` SET TAGS ('dbx_business_glossary_term' = 'Name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`laboratory` ALTER COLUMN `laboratory_status` SET TAGS ('dbx_business_glossary_term' = 'Status');
