...
-- Generated on: 2026-07-10 13:03:43
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`logistics`.`customs_declaration` (
    ...
    `jurisdiction_id` BIGINT COMMENT 'add column jurisdiction_id (BIGINT) with FK to regulatory.jurisdiction.jurisdiction_id - customs declarations are filed in specific jurisdictions',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`logistics`.`transport_unit` (
    ...
    `carrier_id` BIGINT COMMENT 'add column carrier_id (BIGINT) with FK to logistics.carrier.carrier_id - transport units (containers, trailers) are owned/managed by carriers',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`logistics`.`vehicle` (
    ...
    `carrier_id` BIGINT COMMENT 'add column carrier_id (BIGINT) with FK to logistics.carrier.carrier_id - vehicles belong to or are operated by a carrier',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`logistics`.`consolidation` (
    ...
    `distribution_facility_id` BIGINT COMMENT 'add column distribution_facility_id (BIGINT) with FK to distribution.distribution_facility.distribution_facility_id - consolidations occur at a specific facility and need location context',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`logistics`.`handling_unit` (
    ...
    `logistics_shipment_id` BIGINT COMMENT 'add column logistics_shipment_id (BIGINT) with FK to logistics.logistics_shipment.logistics_shipment_id - handling units travel within shipments and need that association',
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`carrier` ALTER COLUMN `esg_commitment_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Commitment Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`lane` SET TAGS ('dbx_subdomain' = 'freight_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`lane` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Backup Carrier ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`logistics_shipment` ALTER COLUMN `batch_record_id` SET TAGS ('dbx_business_glossary_term' = 'Batch Record Id (Foreign Key)');
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`logistics_shipment` ALTER COLUMN `campaign_flight_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Flight Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`logistics_shipment` ALTER COLUMN `marketing_event_id` SET TAGS ('dbx_business_glossary_term' = 'Marketing Event Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`delivery` ALTER COLUMN `carrier_code` SET TAGS ('dbx_business_glossary_term' = 'Carrier Code');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_order` SET TAGS ('dbx_subdomain' = 'freight_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`route` ALTER COLUMN `vehicle_code` SET TAGS ('dbx_business_glossary_term' = 'Vehicle ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_invoice` SET TAGS ('dbx_subdomain' = 'freight_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_audit_result` SET TAGS ('dbx_subdomain' = 'freight_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_audit_result` ALTER COLUMN `freight_invoice_number` SET TAGS ('dbx_business_glossary_term' = 'Freight Invoice Number');
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_audit_result` ALTER COLUMN `freight_invoice_number` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`tracking_event` SET TAGS ('dbx_subdomain' = 'transport_visibility');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`tracking_event` ALTER COLUMN `shipment_leg_number` SET TAGS ('dbx_business_glossary_term' = 'Shipment Leg Number');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`cold_chain_log` SET TAGS ('dbx_subdomain' = 'transport_visibility');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`transport_exception` SET TAGS ('dbx_subdomain' = 'transport_visibility');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`third_party_provider` ALTER COLUMN `esg_commitment_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Commitment Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`customs_declaration` SET TAGS ('dbx_subdomain' = 'delivery_operations');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_cost` SET TAGS ('dbx_subdomain' = 'freight_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`freight_rate` SET TAGS ('dbx_subdomain' = 'freight_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`transport_unit` ALTER COLUMN `gps_latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`transport_unit` ALTER COLUMN `gps_latitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`transport_unit` ALTER COLUMN `gps_longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`transport_unit` ALTER COLUMN `gps_longitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`vehicle` SET TAGS ('dbx_subdomain' = 'shipment_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`consolidation` ALTER COLUMN `carrier_name` SET TAGS ('dbx_business_glossary_term' = 'Carrier Name');
