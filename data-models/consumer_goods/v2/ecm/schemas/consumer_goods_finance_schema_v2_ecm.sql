...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`finance`.`bank_account` (
    ...
    `company_code_id` BIGINT COMMENT 'add column company_code_id (BIGINT) with FK to finance.company_code.company_code_id - bank accounts belong to a specific company code entity',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`finance`.`company_code` (
    ...
    `controlling_area_id` BIGINT COMMENT 'add column controlling_area_id (BIGINT) with FK to finance.controlling_area.controlling_area_id - company codes operate within a controlling area in SAP FI/CO architecture',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`finance`.`revenue_contract` (
    ...
    `trade_account_id` BIGINT COMMENT 'add column trade_account_id (BIGINT) with FK to sales.trade_account.trade_account_id - revenue contracts are with specific trade customers',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`finance`.`party` (
    ...
    `supplier_id` BIGINT COMMENT 'add column supplier_id (BIGINT) with FK to procurement.supplier.supplier_id - finance.party is isolated with only inbound from netting_run and material_ledger_posting; it needs outbound links to identify what business entity the party repre',
    `trade_account_id` BIGINT COMMENT 'add column trade_account_id (BIGINT) with FK to sales.trade_account.trade_account_id - party should resolve to either a supplier or customer trade account for intercompany and netting purposes',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`finance`.`contract_party` (
    ...
    `party_id` BIGINT COMMENT 'Identifier of the upstream or parent party in a hierarchical relationship (e.g., holding company).',
    `represented_by_contract_party_id` BIGINT COMMENT 'Self-referencing FK on contract_party (represented_by_contract_party_id)',
    `trade_account_id` BIGINT COMMENT 'add column trade_account_id (BIGINT) with FK to sales.trade_account.trade_account_id - contract parties should resolve to trade accounts in B2B context',
    ...
    `tax_identification_number` STRING COMMENT 'Government‑issued tax identifier for the party (e.g., EIN, VAT).',
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`cost_center` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`cost_center` ALTER COLUMN `profit_center_code` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Code');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`cost_center` ALTER COLUMN `profit_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`profit_center` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`gl_account` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`ledger` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Posting User ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry_line` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry_line` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Code');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry_line` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry_line` ALTER COLUMN `profit_center_code` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Code');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`journal_entry_line` ALTER COLUMN `profit_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`cogs_allocation` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`standard_cost` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`finance_budget` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`finance_budget` ALTER COLUMN `gl_account_code` SET TAGS ('dbx_business_glossary_term' = 'General Ledger (GL) Account Code');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`finance_budget` ALTER COLUMN `profit_center_code` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Code');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`fixed_asset` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`intercompany_transaction` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`finance_accrual` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`finance_accrual` ALTER COLUMN `gl_account_code` SET TAGS ('dbx_business_glossary_term' = 'General Ledger (GL) Account Code');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`finance_accrual` ALTER COLUMN `gl_account_code` SET TAGS ('dbx_value_regex' = '^[0-9]{6,10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`sox_control` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`revenue_recognition` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`payment_run` SET TAGS ('dbx_subdomain' = 'receivables_payables');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`bank_account` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`company_code` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`chart_of_accounts` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`controlling_area` SET TAGS ('dbx_subdomain' = 'controlling_structures');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`netting_run` SET TAGS ('dbx_subdomain' = 'receivables_payables');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`revenue_contract` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`performance_obligation` SET TAGS ('dbx_subdomain' = 'asset_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`material_ledger_posting` SET TAGS ('dbx_subdomain' = 'ledger_postings');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` SET TAGS ('dbx_subdomain' = 'receivables_payables');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` ALTER COLUMN `postal_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` ALTER COLUMN `postal_code` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` ALTER COLUMN `primary_address_line1` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` ALTER COLUMN `primary_address_line1` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` ALTER COLUMN `primary_address_line2` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`party` ALTER COLUMN `primary_address_line2` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`contract_party` SET TAGS ('dbx_subdomain' = 'receivables_payables');
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`contract_party` ALTER COLUMN `party_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Party Id');
