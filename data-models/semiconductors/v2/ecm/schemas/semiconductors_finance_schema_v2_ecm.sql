...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` (
    ...
    `capex_requestor_employee_id` BIGINT COMMENT '',
    ...
    `payback_period_months` STRING COMMENT '',
    ...
    `roi_percent` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`fixed_asset` (
    ...
    `is_capitalized` BOOLEAN COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` (
    ...
    `equipment_fab_id` BIGINT COMMENT 'Identifier of the fab facility that owns the asset.',
    ...
    `net_book_value` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`internal_order` (
    ...
    `planned_amount` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`wbs_element` (
    ...
    `parent_wbs_element_id` BIGINT COMMENT '',
    ...
    `wbs_description` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`wafer_cost_model` (
    ...
    `company_code` STRING COMMENT '',
    `cost_per_wafer` DECIMAL(18,2) COMMENT '',
    ...
    `fixed_cost_per_wafer` DECIMAL(18,2) COMMENT '',
    ...
    `process_node_nm` STRING COMMENT '',
    ...
    `variable_cost_per_wafer` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` (
    ...
    `billed_amount` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` (
    ...
    `compliance_flag` BOOLEAN COMMENT 'Indicates whether the milestone record complies with SOX reporting requirements.',
    ...
    `milestone_amount` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`budget_plan` (
    ...
    `budget_plan_status` STRING COMMENT '',
    `total_budget_amount` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` (
    ...
    `budgeted_amount` DECIMAL(18,2) COMMENT '',
    `company_code` STRING COMMENT '',
    `compliance_flag` BOOLEAN COMMENT 'Indicates regulatory compliance relevance (e.g., SOX, SEC).',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` (
    ...
    `amortization_period_months` STRING COMMENT '',
    `amortization_start_date` DATE COMMENT '',
    ...
    `expensed_amount` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_transaction` (
    ...
    `is_eliminated` BOOLEAN COMMENT '',
    `receiver_company_code` STRING COMMENT '',
    ...
    `sender_company_code` STRING COMMENT '',
    ...
    `transaction_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_entry` (
    ...
    `elimination_flag` BOOLEAN COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`standard_cost` (
    ...
    `standard_cost_status` STRING COMMENT '',
    ...
    `total_standard_cost` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`transfer_price` (
    ...
    `margin_pct` DECIMAL(18,2) COMMENT 'Margin percentage on transfer price',
    `margin_rate` DECIMAL(18,2) COMMENT 'Target profit margin percentage applied to the cost base, expressed as a percent.',
    `markup_pct` DECIMAL(18,2) COMMENT 'Markup percentage applied to transfer price',
    `markup_percent` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`tax_provision` (
    ...
    `provision_amount` DECIMAL(18,2) COMMENT '',
    ...
    `statutory_rate` DECIMAL(18,2) COMMENT 'Statutory tax rate for the jurisdiction',
    ...
    `taxable_income` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_unit` (
    ...
    `consolidation_group_id` BIGINT COMMENT '',
    ...
    `ownership_percent` DECIMAL(18,2) COMMENT '',
    ...
    `unit_code` STRING COMMENT '',
    `unit_name` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_agreement` (
    ...
    `agreement_amount` DECIMAL(18,2) COMMENT '',
    `agreement_date` DATE COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`amortization_schedule` (
    ...
    `rd_capitalization_id` BIGINT COMMENT '',
    ...
    `amortized_amount` DECIMAL(18,2) COMMENT '',
    ...
    `amortization_schedule_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` (
    ...
    `functional_currency` STRING COMMENT '',
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` ADD CONSTRAINT `fk_finance_capex_request_to_fixed_asset_id` FOREIGN KEY (`to_fixed_asset_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`fixed_asset`(`fixed_asset_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_allocation` ADD CONSTRAINT `fk_finance_cost_allocation_tertiary_receiver_cost_center_id` FOREIGN KEY (`tertiary_receiver_cost_center_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` ADD CONSTRAINT `fk_finance_rd_capitalization_amortization_schedule_id` FOREIGN KEY (`amortization_schedule_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`amortization_schedule`(`amortization_schedule_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`tax_provision` ADD CONSTRAINT `fk_finance_tax_provision_primary_reversal_of_tax_provision_id` FOREIGN KEY (`primary_reversal_of_tax_provision_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`tax_provision`(`tax_provision_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Owner Identifier');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `primary_cost_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Manager Identifier');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `primary_cost_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `primary_cost_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`gl_account` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`profit_center` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Manager Identifier (PC_MGR_ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry` ALTER COLUMN `account_id` SET TAGS ('dbx_business_glossary_term' = 'Customer ID (CUSTOMER_ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry_line` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry_line` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` SET TAGS ('dbx_subdomain' = 'capital_investment');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` ALTER COLUMN `vendor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`fixed_asset` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`fixed_asset` SET TAGS ('dbx_subdomain' = 'capital_investment');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` SET TAGS ('dbx_subdomain' = 'capital_investment');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` ALTER COLUMN `equipment_fab_id` SET TAGS ('dbx_business_glossary_term' = 'Fabrication Facility Identifier (ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wbs_element` SET TAGS ('dbx_subdomain' = 'cost_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wbs_element` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wbs_element` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` SET TAGS ('dbx_subdomain' = 'intercompany_transfer');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` SET TAGS ('dbx_ssot' = 'secondary');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` SET TAGS ('dbx_ssot_owner' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approved By User ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` ALTER COLUMN `sales_nre_agreement_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` SET TAGS ('dbx_subdomain' = 'intercompany_transfer');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` SET TAGS ('dbx_ssot_for' = 'order.order_nre_milestone');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` SET TAGS ('dbx_ssot_owner' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` SET TAGS ('dbx_ssot' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` SET TAGS ('dbx_ssot_authoritative' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` ALTER COLUMN `compliance_flag` SET TAGS ('dbx_physical_type' = 'BOOLEAN');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_plan` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_plan` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_plan` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_plan` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` ALTER COLUMN `compliance_flag` SET TAGS ('dbx_physical_type' = 'BOOLEAN');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` SET TAGS ('dbx_subdomain' = 'capital_investment');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` ALTER COLUMN `auditor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Code (COST_CENTER)');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_transaction` SET TAGS ('dbx_subdomain' = 'intercompany_transfer');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_entry` SET TAGS ('dbx_subdomain' = 'consolidation_reporting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_entry` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`standard_cost` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`transfer_price` SET TAGS ('dbx_subdomain' = 'intercompany_transfer');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`tax_provision` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`tax_provision` ALTER COLUMN `primary_reversal_of_tax_provision_id` SET TAGS ('dbx_business_glossary_term' = 'Reversed Tax Provision Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`depreciation_run` SET TAGS ('dbx_subdomain' = 'capital_investment');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_unit` SET TAGS ('dbx_subdomain' = 'consolidation_reporting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_unit` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_unit` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_group` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_group` SET TAGS ('dbx_subdomain' = 'consolidation_reporting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_agreement` SET TAGS ('dbx_subdomain' = 'intercompany_transfer');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_agreement` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_agreement` ALTER COLUMN `internal_owner` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`amortization_schedule` SET TAGS ('dbx_subdomain' = 'capital_investment');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`amortization_schedule` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` SET TAGS ('dbx_subdomain' = 'ledger_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `email_address` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `phone_number` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `tax_identification_number` SET TAGS ('dbx_sensitivity' = 'pii');
