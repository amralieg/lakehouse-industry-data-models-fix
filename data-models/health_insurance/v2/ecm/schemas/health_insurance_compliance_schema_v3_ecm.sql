...
-- Generated on: 2026-07-10 20:47:14
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` (
    ...
    `subscriber_id` BIGINT COMMENT 'add column member_subscriber_id (BIGINT) with FK to member.subscriber.subscriber_id - FWA cases often involve specific member fraud',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` (
    ...
    `mlr_reporting_health_plan_id` BIGINT COMMENT 'Foreign key to the health plan for which the MLR is being calculated.',
    ...
    `source_health_plan_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` (
    ...
    `training_completed_by_employee_id` BIGINT COMMENT 'Identifier of the system user who created the record.',
    `training_program_id` BIGINT COMMENT 'Identifier of the training program or course.',
    `training_updated_by_user_employee_id` BIGINT COMMENT 'Identifier of the system user who last modified the record.',
    ...
    `trainee_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` (
    ...
    `regulatory_obligation_id` BIGINT COMMENT 'Foreign key linking to compliance.regulatory_obligation. Business justification: Attestations are issued for specific regulatory obligations; linking provides direct traceability.',
    `provider_contract_id` BIGINT COMMENT 'Foreign key linking to contract.provider_contract. Business justification: Required: Attestations certify that a given contract complies with applicable regulations.',
    ...
    `compliance_attestation_date` DATE COMMENT 'Date on which the attestation was signed or formally executed.',
    ...
    `number` STRING COMMENT 'External reference number assigned to the attestation by the organization or regulatory body.',
    ...
    `compliance_attestation_status` STRING COMMENT 'Current lifecycle state of the attestation.. Valid values are `draft|submitted|approved|rejected|revoked|expired`',
    ...
    `compliance_attestation_type` STRING COMMENT 'Category of the compliance attestation (e.g., HIPAA Security, ACA, CMS). [ENUM-REF-CANDIDATE: hipaa_security|hipaa_privacy|aca|cms|erisa|state_doi|ncqa|urac — 8 candidates stripped; promote to reference product]',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_regulatory_obligation` (
    `compliance_regulatory_obligation_id` BIGINT COMMENT '',
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_submission` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_submission` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Officer ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_submission` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_submission` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_engagement` ALTER COLUMN `contract_audit_id` SET TAGS ('dbx_business_glossary_term' = 'Follow-up Audit ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_engagement` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_engagement` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_engagement` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Lead Auditor Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_engagement` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_engagement` ALTER COLUMN `risk_rating` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_finding` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Related Claim Identifier (CLM_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_finding` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Auditor Identifier (AUD_ID)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_finding` ALTER COLUMN `related_policy_number` SET TAGS ('dbx_business_glossary_term' = 'Related Policy Number (POL_NUM)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`audit_finding` ALTER COLUMN `related_system` SET TAGS ('dbx_business_glossary_term' = 'Related System (SYS)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'CAP Owner ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `compliance_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `cap_milestone_id` SET TAGS ('dbx_business_glossary_term' = 'Cap Milestone ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `corrective_action_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Plan ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Milestone Owner ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `reviewer_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Milestone Reviewer ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `actual_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Completion Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `actual_start_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `completion_percentage` SET TAGS ('dbx_business_glossary_term' = 'Completion Percentage');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `compliance_category` SET TAGS ('dbx_business_glossary_term' = 'Compliance Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `escalated_flag` SET TAGS ('dbx_business_glossary_term' = 'Escalated Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `evidence_documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Evidence Documentation URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Is Critical Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `milestone_code` SET TAGS ('dbx_business_glossary_term' = 'Milestone Code (Unique Identifier)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `milestone_description` SET TAGS ('dbx_business_glossary_term' = 'Milestone Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `milestone_name` SET TAGS ('dbx_business_glossary_term' = 'Milestone Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `milestone_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `milestone_type` SET TAGS ('dbx_business_glossary_term' = 'Milestone Type (e.g., Documentation, Training, Process Change, System Update, Audit, Review)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `milestone_type` SET TAGS ('dbx_value_regex' = 'documentation|training|process_change|system_update|audit|review');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Milestone Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `planned_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Planned Completion Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `planned_start_date` SET TAGS ('dbx_business_glossary_term' = 'Planned Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `priority` SET TAGS ('dbx_business_glossary_term' = 'Milestone Priority');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `priority` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Risk Level');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|moderate|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `cap_milestone_status` SET TAGS ('dbx_business_glossary_term' = 'Milestone Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `cap_milestone_status` SET TAGS ('dbx_value_regex' = 'not_started|in_progress|completed|blocked|deferred|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`cap_milestone` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` SET TAGS ('dbx_subdomain' = 'privacy_enforcement');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `baa_id` SET TAGS ('dbx_business_glossary_term' = 'Baa Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `breach_report_id` SET TAGS ('dbx_business_glossary_term' = 'External Breach Report ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Incident Owner Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Business Associate ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `state_notification_date` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_incident` ALTER COLUMN `state_notified` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` SET TAGS ('dbx_subdomain' = 'privacy_enforcement');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_notification_id` SET TAGS ('dbx_business_glossary_term' = 'Breach Notification ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_incident_id` SET TAGS ('dbx_business_glossary_term' = 'Breach Incident ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `corrective_action_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Plan ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Notification Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `affected_member_count` SET TAGS ('dbx_business_glossary_term' = 'Affected Member Count');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `affected_provider_count` SET TAGS ('dbx_business_glossary_term' = 'Affected Provider Count');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_category` SET TAGS ('dbx_business_glossary_term' = 'Breach Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_category` SET TAGS ('dbx_value_regex' = 'unauthorized_access|theft|loss|improper_disclosure|hacking|malware');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_disclosure_date` SET TAGS ('dbx_business_glossary_term' = 'Breach Disclosure Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_discovery_date` SET TAGS ('dbx_business_glossary_term' = 'Breach Discovery Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `compliance_status` SET TAGS ('dbx_business_glossary_term' = 'Compliance Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `compliance_status` SET TAGS ('dbx_value_regex' = 'compliant|non_compliant|pending_review');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `content_version` SET TAGS ('dbx_business_glossary_term' = 'Content Version');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `deadline_date` SET TAGS ('dbx_business_glossary_term' = 'Deadline Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `deadline_date` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `deadline_met` SET TAGS ('dbx_business_glossary_term' = 'Deadline Met Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `deadline_met` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `delivery_confirmation` SET TAGS ('dbx_business_glossary_term' = 'Delivery Confirmation');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `media_outlet_name` SET TAGS ('dbx_business_glossary_term' = 'Media Outlet Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `media_outlet_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_content_hash` SET TAGS ('dbx_business_glossary_term' = 'Notification Content Hash');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_date` SET TAGS ('dbx_business_glossary_term' = 'Notification Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_method` SET TAGS ('dbx_business_glossary_term' = 'Notification Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_method` SET TAGS ('dbx_value_regex' = 'mail|email|substitute_notice|fax|phone');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Notification Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_type` SET TAGS ('dbx_business_glossary_term' = 'Notification Type (Individual, HHS, Media, State Regulator)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `notification_type` SET TAGS ('dbx_value_regex' = 'individual|hhs|media|state_regulator');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `number_of_recipients` SET TAGS ('dbx_business_glossary_term' = 'Number of Recipients');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `regulatory_body_notified` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Body Notified');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `regulatory_body_notified` SET TAGS ('dbx_value_regex' = 'hhs|ocr|state|media');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `risk_assessment_score` SET TAGS ('dbx_business_glossary_term' = 'Risk Assessment Score');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `risk_assessment_score` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_notification_status` SET TAGS ('dbx_business_glossary_term' = 'Notification Record Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `breach_notification_status` SET TAGS ('dbx_value_regex' = 'draft|sent|failed|cancelled|archived');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_notification` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`hipaa_privacy_request` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`hipaa_privacy_request` SET TAGS ('dbx_subdomain' = 'privacy_enforcement');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`hipaa_privacy_request` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Processing Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`hipaa_privacy_request` ALTER COLUMN `appeal_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` SET TAGS ('dbx_subdomain' = 'privacy_enforcement');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `phi_disclosure_log_id` SET TAGS ('dbx_business_glossary_term' = 'PHI Disclosure Log ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `hipaa_privacy_request_id` SET TAGS ('dbx_business_glossary_term' = 'Disclosure Request ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (Member ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `policy_document_id` SET TAGS ('dbx_business_glossary_term' = 'Reference Document ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `authorization_basis` SET TAGS ('dbx_business_glossary_term' = 'Authorization Basis');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `authorization_basis` SET TAGS ('dbx_value_regex' = 'patient_consent|court_order|public_health_authority|law_enforcement_request|research_approval|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `compliance_status` SET TAGS ('dbx_business_glossary_term' = 'Compliance Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `compliance_status` SET TAGS ('dbx_value_regex' = 'compliant|non_compliant|under_review');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `disclosure_method` SET TAGS ('dbx_business_glossary_term' = 'Disclosure Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `disclosure_method` SET TAGS ('dbx_value_regex' = 'electronic|fax|mail|oral|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `disclosure_status` SET TAGS ('dbx_business_glossary_term' = 'Disclosure Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `disclosure_status` SET TAGS ('dbx_value_regex' = 'pending|completed|rejected|revoked');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `disclosure_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Disclosure Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `is_authorized` SET TAGS ('dbx_business_glossary_term' = 'Is Authorized Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Disclosure Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `phi_category` SET TAGS ('dbx_business_glossary_term' = 'PHI Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `phi_category` SET TAGS ('dbx_value_regex' = 'demographics|diagnosis|treatment|payment|eligibility|utilization');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `purpose_of_disclosure` SET TAGS ('dbx_business_glossary_term' = 'Purpose of Disclosure');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `recipient_name` SET TAGS ('dbx_business_glossary_term' = 'Recipient Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `recipient_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `recipient_name` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `recipient_type` SET TAGS ('dbx_business_glossary_term' = 'Recipient Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `recipient_type` SET TAGS ('dbx_value_regex' = 'public_health|law_enforcement|research|legal|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`phi_disclosure_log` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` SET TAGS ('dbx_subdomain' = 'privacy_enforcement');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `baa_id` SET TAGS ('dbx_business_glossary_term' = 'Business Associate Agreement Identifier (BAA_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Responsible Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `agreement_number` SET TAGS ('dbx_business_glossary_term' = 'Agreement Number (AGREEMENT_NUMBER)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `agreement_status` SET TAGS ('dbx_business_glossary_term' = 'Agreement Status (AGREEMENT_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `agreement_status` SET TAGS ('dbx_value_regex' = 'active|terminated|pending|draft|suspended');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `amendment_count` SET TAGS ('dbx_business_glossary_term' = 'Amendment Count (AMENDMENT_COUNT)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `audit_rights` SET TAGS ('dbx_business_glossary_term' = 'Audit Rights (AUDIT_RIGHTS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `audit_rights` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `breach_notification_requirements` SET TAGS ('dbx_business_glossary_term' = 'Breach Notification Requirements (BREACH_NOTIFICATION_REQUIREMENTS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `breach_notification_requirements` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `business_associate_name` SET TAGS ('dbx_business_glossary_term' = 'Business Associate Name (BUSINESS_ASSOCIATE_NAME)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `business_associate_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `business_associate_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `business_associate_type` SET TAGS ('dbx_business_glossary_term' = 'Business Associate Type (BUSINESS_ASSOCIATE_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `business_associate_type` SET TAGS ('dbx_value_regex' = 'vendor|tpa|pbm|clearinghouse|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (CREATED_TIMESTAMP)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `data_disposal_method` SET TAGS ('dbx_business_glossary_term' = 'Data Disposal Method (DATA_DISPOSAL_METHOD)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `data_disposal_method` SET TAGS ('dbx_value_regex' = 'destroy|deidentify|archive|return|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `data_retention_period_months` SET TAGS ('dbx_business_glossary_term' = 'Data Retention Period (MONTHS) (DATA_RETENTION_PERIOD_MONTHS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date (EFFECTIVE_END_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date (EFFECTIVE_START_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `governing_law` SET TAGS ('dbx_business_glossary_term' = 'Governing Law (GOVERNING_LAW)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `jurisdiction` SET TAGS ('dbx_business_glossary_term' = 'Jurisdiction (JURISDICTION)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `last_amendment_date` SET TAGS ('dbx_business_glossary_term' = 'Last Amendment Date (LAST_AMENDMENT_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `permitted_phis` SET TAGS ('dbx_business_glossary_term' = 'Permitted PHI Types (PERMITTED_PHIS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `permitted_phis` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference (REGULATORY_REFERENCE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `renewal_notice_period_days` SET TAGS ('dbx_business_glossary_term' = 'Renewal Notice Period (DAYS) (RENEWAL_NOTICE_PERIOD_DAYS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `renewal_option` SET TAGS ('dbx_business_glossary_term' = 'Renewal Option (RENEWAL_OPTION)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `renewal_option` SET TAGS ('dbx_value_regex' = 'auto|manual|none');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `scope_of_phi_use` SET TAGS ('dbx_business_glossary_term' = 'Scope of PHI Use (SCOPE_OF_PHI_USE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `scope_of_phi_use` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `security_obligations` SET TAGS ('dbx_business_glossary_term' = 'Security Obligations (SECURITY_OBLIGATIONS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `security_obligations` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `subcontractor_allowed` SET TAGS ('dbx_business_glossary_term' = 'Subcontractor Allowed Flag (SUBCONTRACTOR_ALLOWED)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `subcontractor_details` SET TAGS ('dbx_business_glossary_term' = 'Subcontractor Details (SUBCONTRACTOR_DETAILS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `subcontractor_details` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `termination_clause` SET TAGS ('dbx_business_glossary_term' = 'Termination Clause (TERMINATION_CLAUSE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `termination_clause` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`baa` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp (UPDATED_TIMESTAMP)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` SET TAGS ('dbx_subdomain' = 'fraud_investigation');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Investigator Identifier (INVESTIGATOR_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_case` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` SET TAGS ('dbx_subdomain' = 'fraud_investigation');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `fwa_referral_id` SET TAGS ('dbx_business_glossary_term' = 'Fraud Waste Abuse Referral ID (FWA_REFERRAL_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `fwa_case_id` SET TAGS ('dbx_business_glossary_term' = 'Associated Case Identifier (CASE_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (MEMBER_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Identifier (EMPLOYEE_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `allegation_description` SET TAGS ('dbx_business_glossary_term' = 'Allegation Description (ALLEG_DESC)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (CREATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (CURRENCY_CD)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = 'USD|EUR|GBP|CAD|JPY');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `due_date` SET TAGS ('dbx_business_glossary_term' = 'Due Date (DUE_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `escalation_flag` SET TAGS ('dbx_business_glossary_term' = 'Escalation Flag (ESCALATION_FLAG)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `estimated_loss_amount` SET TAGS ('dbx_business_glossary_term' = 'Estimated Loss Amount (EST_LOSS_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `evidence_reference` SET TAGS ('dbx_business_glossary_term' = 'Evidence Reference (EVID_REF)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes (NOTES)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `priority` SET TAGS ('dbx_business_glossary_term' = 'Priority (PRIORITY)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `priority` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `provider_npi` SET TAGS ('dbx_business_glossary_term' = 'Provider National Provider Identifier (PROVIDER_NPI)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `provider_npi` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `provider_npi` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `referral_date` SET TAGS ('dbx_business_glossary_term' = 'Referral Date (REF_DATE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `referral_number` SET TAGS ('dbx_business_glossary_term' = 'Referral Number (REF_NUM)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `referral_source` SET TAGS ('dbx_business_glossary_term' = 'Referral Source (REF_SOURCE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `referral_source` SET TAGS ('dbx_value_regex' = 'internal_detection|employee|member|provider|external_agency');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `referral_type` SET TAGS ('dbx_business_glossary_term' = 'Referral Type (REF_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `referral_type` SET TAGS ('dbx_value_regex' = 'fraud|waste|abuse|billing_error|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `fwa_referral_status` SET TAGS ('dbx_business_glossary_term' = 'Referral Status (REF_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `fwa_referral_status` SET TAGS ('dbx_value_regex' = 'new|in_review|assigned|closed|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `subject_type` SET TAGS ('dbx_business_glossary_term' = 'Subject Type (SUBJ_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `subject_type` SET TAGS ('dbx_value_regex' = 'member|provider|employee|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `triage_outcome` SET TAGS ('dbx_business_glossary_term' = 'Triage Outcome (TRIAGE_OUTCOME)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `triage_outcome` SET TAGS ('dbx_value_regex' = 'opened|closed|dismissed|escalated|pending');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`fwa_referral` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp (UPDATED_TS)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Calculated By Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Product Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `mlr_reporting_health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `mlr_reporting_health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `mlr_reporting_health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `audit_finding_reference` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Reference');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `reporting_year` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`mlr_calculation` ALTER COLUMN `source_health_plan_id` SET TAGS ('dbx_renamed_from' = 'health_plan_id');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_program` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_program` SET TAGS ('dbx_subdomain' = 'accreditation_quality');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_program` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Business Owner Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_program` ALTER COLUMN `accrediting_body` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_program` ALTER COLUMN `program_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_program` ALTER COLUMN `rating` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` SET TAGS ('dbx_subdomain' = 'accreditation_quality');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `accreditation_survey_id` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Survey ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `accreditation_program_id` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Program ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Survey Conductor Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `accreditation_decision` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Decision');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `accreditation_decision` SET TAGS ('dbx_value_regex' = 'accredited|conditionally_accredited|not_accredited|pending');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `end_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Survey End Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `evidence_documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Evidence Documentation URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `final_score` SET TAGS ('dbx_business_glossary_term' = 'Final Survey Score');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Survey Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `preliminary_findings` SET TAGS ('dbx_business_glossary_term' = 'Preliminary Findings');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `rating` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Rating');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `rating` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `recommendation` SET TAGS ('dbx_business_glossary_term' = 'Accreditation Recommendation');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Survey Risk Level');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|moderate|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `start_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Survey Start Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `accreditation_survey_status` SET TAGS ('dbx_business_glossary_term' = 'Survey Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `accreditation_survey_status` SET TAGS ('dbx_value_regex' = 'scheduled|in_progress|completed|closed|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_location` SET TAGS ('dbx_business_glossary_term' = 'Survey Location');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_method` SET TAGS ('dbx_business_glossary_term' = 'Survey Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_method` SET TAGS ('dbx_value_regex' = 'onsite|remote|hybrid');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_number` SET TAGS ('dbx_business_glossary_term' = 'Survey Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_region_code` SET TAGS ('dbx_business_glossary_term' = 'Survey Region Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_region_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_scope` SET TAGS ('dbx_business_glossary_term' = 'Survey Scope');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_type` SET TAGS ('dbx_business_glossary_term' = 'Survey Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `survey_type` SET TAGS ('dbx_value_regex' = 'initial|renewal|focused|ad_hoc');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`accreditation_survey` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` SET TAGS ('dbx_subdomain' = 'policy_training');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_document_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Document Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Approver Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `primary_policy_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Owner Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `reviewer_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Reviewer Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Policy Approval Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Policy Approval Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `archive_date` SET TAGS ('dbx_business_glossary_term' = 'Policy Archive Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_document_category` SET TAGS ('dbx_business_glossary_term' = 'Policy Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `compliance_area` SET TAGS ('dbx_business_glossary_term' = 'Compliance Area');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `confidentiality_level` SET TAGS ('dbx_business_glossary_term' = 'Policy Confidentiality Level');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `confidentiality_level` SET TAGS ('dbx_value_regex' = 'public|internal|confidential|restricted');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `distribution_scope` SET TAGS ('dbx_business_glossary_term' = 'Policy Distribution Scope');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `document_format` SET TAGS ('dbx_business_glossary_term' = 'Policy Document Format');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `document_format` SET TAGS ('dbx_value_regex' = 'pdf|docx|html');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `document_size_bytes` SET TAGS ('dbx_business_glossary_term' = 'Policy Document Size (Bytes)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `document_url` SET TAGS ('dbx_business_glossary_term' = 'Policy Document URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Policy Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Policy Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `is_archived` SET TAGS ('dbx_business_glossary_term' = 'Is Archived Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `is_confidential` SET TAGS ('dbx_business_glossary_term' = 'Is Confidential Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `next_review_date` SET TAGS ('dbx_business_glossary_term' = 'Next Policy Review Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_code` SET TAGS ('dbx_business_glossary_term' = 'Policy Document Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_name` SET TAGS ('dbx_business_glossary_term' = 'Policy Document Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_owner_department` SET TAGS ('dbx_business_glossary_term' = 'Policy Owner Department');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `regulatory_citations` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Citations');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `review_date` SET TAGS ('dbx_business_glossary_term' = 'Policy Review Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `review_outcome` SET TAGS ('dbx_business_glossary_term' = 'Policy Review Outcome');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `review_outcome` SET TAGS ('dbx_value_regex' = 'approved|revised|retired');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `review_type` SET TAGS ('dbx_business_glossary_term' = 'Policy Review Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `review_type` SET TAGS ('dbx_value_regex' = 'annual|triggered|regulatory_change');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `revision_summary` SET TAGS ('dbx_business_glossary_term' = 'Policy Revision Summary');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_document_status` SET TAGS ('dbx_business_glossary_term' = 'Policy Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `policy_document_status` SET TAGS ('dbx_value_regex' = 'draft|active|suspended|retired');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `updated_by` SET TAGS ('dbx_business_glossary_term' = 'Record Updated By');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Policy Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_document` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Record Created By');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` SET TAGS ('dbx_subdomain' = 'policy_training');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `policy_review_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Review ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approver ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `policy_document_id` SET TAGS ('dbx_business_glossary_term' = 'Policy ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `primary_policy_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Reviewer ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `approver_name` SET TAGS ('dbx_business_glossary_term' = 'Approver Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `approver_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `approver_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `attachment_count` SET TAGS ('dbx_business_glossary_term' = 'Attachment Count');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `compliance_category` SET TAGS ('dbx_business_glossary_term' = 'Compliance Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `compliance_category` SET TAGS ('dbx_value_regex' = 'privacy|security|financial|clinical|operational');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `evidence_documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Evidence Documentation URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Critical Review Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `next_review_date` SET TAGS ('dbx_business_glossary_term' = 'Next Review Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Review Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `outcome` SET TAGS ('dbx_business_glossary_term' = 'Review Outcome');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `outcome` SET TAGS ('dbx_value_regex' = 'approved_as_is|revised|retired|deferred');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `outcome_date` SET TAGS ('dbx_business_glossary_term' = 'Outcome Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `policy_version` SET TAGS ('dbx_business_glossary_term' = 'Policy Version');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_date` SET TAGS ('dbx_business_glossary_term' = 'Review Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_duration_days` SET TAGS ('dbx_business_glossary_term' = 'Review Duration (Days)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_number` SET TAGS ('dbx_business_glossary_term' = 'Policy Review Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_score` SET TAGS ('dbx_business_glossary_term' = 'Review Score');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_status` SET TAGS ('dbx_business_glossary_term' = 'Review Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_status` SET TAGS ('dbx_value_regex' = 'pending|in_progress|completed|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_type` SET TAGS ('dbx_business_glossary_term' = 'Review Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `review_type` SET TAGS ('dbx_value_regex' = 'annual|triggered|regulatory_change|ad_hoc');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `reviewer_name` SET TAGS ('dbx_business_glossary_term' = 'Reviewer Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `reviewer_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `reviewer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `revision_summary` SET TAGS ('dbx_business_glossary_term' = 'Revision Summary');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Risk Level');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `sign_off_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Sign‑Off Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`policy_review` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` SET TAGS ('dbx_subdomain' = 'policy_training');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `training_program_id` SET TAGS ('dbx_business_glossary_term' = 'Training Program Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Owner Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'External Provider Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `accessibility_features` SET TAGS ('dbx_business_glossary_term' = 'Accessibility Features');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `assessment_type` SET TAGS ('dbx_business_glossary_term' = 'Assessment Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `assessment_type` SET TAGS ('dbx_value_regex' = 'quiz|exam|survey');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `attachment_count` SET TAGS ('dbx_business_glossary_term' = 'Attachment Count');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `attempt_interval_days` SET TAGS ('dbx_business_glossary_term' = 'Attempt Interval (Days)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `certificate_identifier` SET TAGS ('dbx_business_glossary_term' = 'Certificate Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `certification_required` SET TAGS ('dbx_business_glossary_term' = 'Certification Required');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `completion_deadline` SET TAGS ('dbx_business_glossary_term' = 'Completion Deadline');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `completion_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `compliance_category` SET TAGS ('dbx_business_glossary_term' = 'Compliance Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `compliance_category` SET TAGS ('dbx_value_regex' = 'privacy|security|fraud|quality|regulatory');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `content_version` SET TAGS ('dbx_business_glossary_term' = 'Content Version');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `cost_usd` SET TAGS ('dbx_business_glossary_term' = 'Program Cost (USD)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `delivery_method` SET TAGS ('dbx_business_glossary_term' = 'Delivery Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `delivery_method` SET TAGS ('dbx_value_regex' = 'online|instructor_led|blended|self_paced');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `training_program_description` SET TAGS ('dbx_business_glossary_term' = 'Training Program Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `external_provider_name` SET TAGS ('dbx_business_glossary_term' = 'External Provider Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `external_provider_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `format` SET TAGS ('dbx_business_glossary_term' = 'Training Format');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `format` SET TAGS ('dbx_value_regex' = 'video|document|quiz|simulation|webinar');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `is_archived` SET TAGS ('dbx_business_glossary_term' = 'Archived Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `is_external_provider` SET TAGS ('dbx_business_glossary_term' = 'External Provider Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `language` SET TAGS ('dbx_business_glossary_term' = 'Language');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `last_review_date` SET TAGS ('dbx_business_glossary_term' = 'Last Review Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `last_updated_by` SET TAGS ('dbx_business_glossary_term' = 'Last Updated By');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `mandatory_flag` SET TAGS ('dbx_business_glossary_term' = 'Mandatory Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `max_attempts` SET TAGS ('dbx_business_glossary_term' = 'Maximum Attempts');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `owner_role` SET TAGS ('dbx_business_glossary_term' = 'Owner Role');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `owner_role` SET TAGS ('dbx_value_regex' = 'compliance_officer|hr|training_manager');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `passing_score_threshold` SET TAGS ('dbx_business_glossary_term' = 'Passing Score Threshold');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `passing_score_unit` SET TAGS ('dbx_business_glossary_term' = 'Passing Score Unit');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `passing_score_unit` SET TAGS ('dbx_value_regex' = 'percent');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `program_code` SET TAGS ('dbx_business_glossary_term' = 'Training Program Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `program_name` SET TAGS ('dbx_business_glossary_term' = 'Training Program Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `program_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `program_type` SET TAGS ('dbx_business_glossary_term' = 'Training Program Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `program_type` SET TAGS ('dbx_value_regex' = 'hipaa|fwa|aca|code_of_conduct|cultural_competency|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `regulatory_mandate` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Mandate');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `regulatory_mandate` SET TAGS ('dbx_value_regex' = 'HIPAA|CMS_FWA|ACA|NCQA|URAC');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `review_frequency_months` SET TAGS ('dbx_business_glossary_term' = 'Review Frequency (Months)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Risk Level');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `training_program_status` SET TAGS ('dbx_business_glossary_term' = 'Training Program Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `training_program_status` SET TAGS ('dbx_value_regex' = 'active|inactive|retired|draft|pending');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `target_audience` SET TAGS ('dbx_business_glossary_term' = 'Target Audience');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `target_audience` SET TAGS ('dbx_value_regex' = 'employee|delegate|provider|contractor|management');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `training_hours` SET TAGS ('dbx_business_glossary_term' = 'Training Hours');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_program` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Program Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` SET TAGS ('dbx_subdomain' = 'policy_training');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_completion_id` SET TAGS ('dbx_business_glossary_term' = 'Training Completion ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_completed_by_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_completed_by_employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_completed_by_employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_program_id` SET TAGS ('dbx_business_glossary_term' = 'Training Program ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_updated_by_user_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Updated By User ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_updated_by_user_employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_updated_by_user_employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `assessment_score` SET TAGS ('dbx_business_glossary_term' = 'Assessment Score (Percent)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `attestation_text` SET TAGS ('dbx_business_glossary_term' = 'Attestation Text');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `attestation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Attestation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `certificate_number` SET TAGS ('dbx_business_glossary_term' = 'Certificate ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `certificate_url` SET TAGS ('dbx_business_glossary_term' = 'Certificate URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `completion_number` SET TAGS ('dbx_business_glossary_term' = 'Training Completion Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `completion_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Completion Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `compliance_requirements_met_flag` SET TAGS ('dbx_business_glossary_term' = 'Compliance Requirements Met Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `cost_usd` SET TAGS ('dbx_business_glossary_term' = 'Training Cost (USD)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `delivery_method` SET TAGS ('dbx_business_glossary_term' = 'Delivery Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `delivery_method` SET TAGS ('dbx_value_regex' = 'online|classroom|virtual|self_paced');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Certificate Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `hours_completed` SET TAGS ('dbx_business_glossary_term' = 'Hours Completed');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `is_external_training` SET TAGS ('dbx_business_glossary_term' = 'External Training Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `location` SET TAGS ('dbx_business_glossary_term' = 'Training Location');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `pass_fail_status` SET TAGS ('dbx_business_glossary_term' = 'Pass/Fail Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `pass_fail_status` SET TAGS ('dbx_value_regex' = 'pass|fail');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `renewal_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Renewal Required Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `scheduled_date` SET TAGS ('dbx_business_glossary_term' = 'Scheduled Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_completion_status` SET TAGS ('dbx_business_glossary_term' = 'Training Completion Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_completion_status` SET TAGS ('dbx_value_regex' = 'pending|completed|failed|revoked');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `total_hours_required` SET TAGS ('dbx_business_glossary_term' = 'Total Hours Required');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_category` SET TAGS ('dbx_business_glossary_term' = 'Training Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_category` SET TAGS ('dbx_value_regex' = 'hipaa|fwa|ncqa|erisa|state|other');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_type` SET TAGS ('dbx_business_glossary_term' = 'Training Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `training_type` SET TAGS ('dbx_value_regex' = 'mandatory|optional|refresher');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `vendor_name` SET TAGS ('dbx_business_glossary_term' = 'Vendor Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `vendor_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`training_completion` ALTER COLUMN `trainee_employee_id` SET TAGS ('dbx_renamed_from' = 'employee_id');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` SET TAGS ('dbx_subdomain' = 'fraud_investigation');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `employee_screening_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Screening ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `compliance_attestation_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Attestation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Critical Screening Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `match_detail` SET TAGS ('dbx_business_glossary_term' = 'Match Detail');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Screening Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `performed_by` SET TAGS ('dbx_business_glossary_term' = 'Performed By Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `performed_by` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `performed_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `performed_by_name` SET TAGS ('dbx_business_glossary_term' = 'Performed By Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `performed_by_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `performed_by_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `re_screening_due_date` SET TAGS ('dbx_business_glossary_term' = 'Rescreening Due Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `resolution_action` SET TAGS ('dbx_business_glossary_term' = 'Resolution Action');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `resolution_action` SET TAGS ('dbx_value_regex' = 'none|investigate|escalate|clear|terminate');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `resolution_date` SET TAGS ('dbx_business_glossary_term' = 'Resolution Completion Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `screening_reference` SET TAGS ('dbx_business_glossary_term' = 'Screening Reference Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `screening_result` SET TAGS ('dbx_business_glossary_term' = 'Screening Result');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `screening_result` SET TAGS ('dbx_value_regex' = 'clear|match|potential_match');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `screening_source` SET TAGS ('dbx_business_glossary_term' = 'Screening Source');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `screening_source` SET TAGS ('dbx_value_regex' = 'OIG_LEIE|SAM|STATE_MEDICAID|CMS|OTHER');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `screening_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Screening Event Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `source_reference` SET TAGS ('dbx_business_glossary_term' = 'Source Reference ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `employee_screening_status` SET TAGS ('dbx_business_glossary_term' = 'Screening Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `employee_screening_status` SET TAGS ('dbx_value_regex' = 'pending|completed|reviewed|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `subject_identifier` SET TAGS ('dbx_business_glossary_term' = 'Screened Subject Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `subject_identifier` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `subject_identifier` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `subject_type` SET TAGS ('dbx_business_glossary_term' = 'Screened Subject Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `subject_type` SET TAGS ('dbx_value_regex' = 'employee|provider|vendor|delegate');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`employee_screening` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `erisa_filing_id` SET TAGS ('dbx_business_glossary_term' = 'ERISA Filing ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Officer ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `acceptance_date` SET TAGS ('dbx_business_glossary_term' = 'Acceptance Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `attachment_count` SET TAGS ('dbx_business_glossary_term' = 'Attachment Count');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `audit_trail_reference` SET TAGS ('dbx_business_glossary_term' = 'Audit Trail ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `fee_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Fee Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `fee_currency_code` SET TAGS ('dbx_value_regex' = 'USD|CAD|EUR|GBP|JPY|CHF');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_date` SET TAGS ('dbx_business_glossary_term' = 'Filing Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_description` SET TAGS ('dbx_business_glossary_term' = 'Filing Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_due_date` SET TAGS ('dbx_business_glossary_term' = 'Filing Due Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Filing Fee Amount (USD)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_fee_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_fee_amount` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_method` SET TAGS ('dbx_business_glossary_term' = 'Filing Method (Submission Method)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_method` SET TAGS ('dbx_value_regex' = 'electronic|paper|fax');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_period_end` SET TAGS ('dbx_business_glossary_term' = 'Filing Period End Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_period_start` SET TAGS ('dbx_business_glossary_term' = 'Filing Period Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_status` SET TAGS ('dbx_business_glossary_term' = 'Filing Status (ERISA Filing Status)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_status` SET TAGS ('dbx_value_regex' = 'pending|submitted|accepted|rejected|withdrawn|closed');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_type` SET TAGS ('dbx_business_glossary_term' = 'Filing Type (ERISA Filing Type)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `filing_type` SET TAGS ('dbx_value_regex' = 'Form_5500|Summary_Annual_Report|Summary_Plan_Description|COBRA_Notice|QMCSO_Response');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Is Critical (Critical Filing Indicator)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `is_fwa_monitoring` SET TAGS ('dbx_business_glossary_term' = 'FWA Monitoring Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `last_reminder_sent_date` SET TAGS ('dbx_business_glossary_term' = 'Last Reminder Sent Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes (Free Text)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year (Calendar Year of the Benefit Plan)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `regulator_acknowledged_date` SET TAGS ('dbx_business_glossary_term' = 'Regulator Acknowledged Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `regulator_acknowledged_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulator Acknowledged Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `regulatory_body` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Body (Governing Agency)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `regulatory_body` SET TAGS ('dbx_value_regex' = 'DOL|IRS|CMS|State_DOI');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference (Statutory Citation)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `rejection_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Rejection Reason Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `reminder_schedule` SET TAGS ('dbx_business_glossary_term' = 'Reminder Schedule (Filing Reminder Frequency)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `reminder_schedule` SET TAGS ('dbx_value_regex' = 'none|weekly|biweekly|monthly');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Risk Level (Compliance Risk Rating)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `submission_number` SET TAGS ('dbx_business_glossary_term' = 'Submission Number (Regulatory Submission Identifier)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`erisa_filing` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` SET TAGS ('dbx_subdomain' = 'regulatory_oversight');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `state_fair_hearing_id` SET TAGS ('dbx_business_glossary_term' = 'State Fair Hearing Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `state_fair_hearing_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Hearing Officer ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `adverse_action_type` SET TAGS ('dbx_business_glossary_term' = 'Adverse Action Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `adverse_action_type` SET TAGS ('dbx_value_regex' = 'denial|reduction|termination|no_action');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `appeal_filed_date` SET TAGS ('dbx_business_glossary_term' = 'Appeal Filed Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `appeal_filed_flag` SET TAGS ('dbx_business_glossary_term' = 'Appeal Filed Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `attachment_url` SET TAGS ('dbx_business_glossary_term' = 'Attachment URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `compliance_deadline_met` SET TAGS ('dbx_business_glossary_term' = 'Compliance Deadline Met');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `compliance_deadline_met` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_date` SET TAGS ('dbx_business_glossary_term' = 'Hearing Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_duration_minutes` SET TAGS ('dbx_business_glossary_term' = 'Hearing Duration (Minutes)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_location` SET TAGS ('dbx_business_glossary_term' = 'Hearing Location');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_officer_name` SET TAGS ('dbx_business_glossary_term' = 'Hearing Officer Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_officer_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_officer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_outcome` SET TAGS ('dbx_business_glossary_term' = 'Hearing Outcome');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_outcome` SET TAGS ('dbx_value_regex' = 'upheld|reversed|settlement|dismissed|withdrawn');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_request_number` SET TAGS ('dbx_business_glossary_term' = 'Hearing Request Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_type` SET TAGS ('dbx_business_glossary_term' = 'Hearing Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `hearing_type` SET TAGS ('dbx_value_regex' = 'in_person|virtual|phone');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `implementation_deadline` SET TAGS ('dbx_business_glossary_term' = 'Implementation Deadline');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `implementation_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Critical Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_dob` SET TAGS ('dbx_business_glossary_term' = 'Member Date of Birth');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_dob` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_dob` SET TAGS ('dbx_pii_dob' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_name` SET TAGS ('dbx_business_glossary_term' = 'Member Full Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_state` SET TAGS ('dbx_business_glossary_term' = 'Member State');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `member_state` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `request_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Hearing Request Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `state_agency_code` SET TAGS ('dbx_business_glossary_term' = 'State Agency Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `state_agency_code` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `state_fair_hearing_status` SET TAGS ('dbx_business_glossary_term' = 'Hearing Request Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `state_fair_hearing_status` SET TAGS ('dbx_value_regex' = 'pending|scheduled|completed|closed|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`state_fair_hearing` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulatory_change_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Change ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Implementation Owner ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `prior_regulation_regulatory_change_id` SET TAGS ('dbx_business_glossary_term' = 'Prior Regulation ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `amendment_number` SET TAGS ('dbx_business_glossary_term' = 'Amendment Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `change_category` SET TAGS ('dbx_business_glossary_term' = 'Change Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `compliance_area` SET TAGS ('dbx_business_glossary_term' = 'Compliance Area');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `compliance_area` SET TAGS ('dbx_value_regex' = 'privacy|security|financial|clinical|operational');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `compliance_deadline` SET TAGS ('dbx_business_glossary_term' = 'Compliance Deadline');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `compliance_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `governing_body` SET TAGS ('dbx_business_glossary_term' = 'Governing Body');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `impact_assessment` SET TAGS ('dbx_business_glossary_term' = 'Impact Assessment');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `impacted_business_areas` SET TAGS ('dbx_business_glossary_term' = 'Impacted Business Areas');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `implementation_status` SET TAGS ('dbx_business_glossary_term' = 'Implementation Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `implementation_status` SET TAGS ('dbx_value_regex' = 'not_started|in_progress|completed|deferred|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `implementation_target_date` SET TAGS ('dbx_business_glossary_term' = 'Implementation Target Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `is_critical` SET TAGS ('dbx_business_glossary_term' = 'Is Critical Flag');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `jurisdiction` SET TAGS ('dbx_business_glossary_term' = 'Jurisdiction');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `publication_date` SET TAGS ('dbx_business_glossary_term' = 'Publication Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulation_code` SET TAGS ('dbx_business_glossary_term' = 'Regulation Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulation_name` SET TAGS ('dbx_business_glossary_term' = 'Regulation Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulation_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulation_type` SET TAGS ('dbx_business_glossary_term' = 'Regulation Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulation_type` SET TAGS ('dbx_value_regex' = 'federal|state|local|international|industry|internal');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulatory_reference_url` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `reporting_frequency_months` SET TAGS ('dbx_business_glossary_term' = 'Reporting Frequency (Months)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `reporting_frequency_months` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `required_response_actions` SET TAGS ('dbx_business_glossary_term' = 'Required Response Actions');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `risk_score` SET TAGS ('dbx_business_glossary_term' = 'Risk Score');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulatory_change_status` SET TAGS ('dbx_business_glossary_term' = 'Regulation Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `regulatory_change_status` SET TAGS ('dbx_value_regex' = 'draft|proposed|final|active|repealed|expired');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_change` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` SET TAGS ('dbx_subdomain' = 'privacy_enforcement');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_report_id` SET TAGS ('dbx_business_glossary_term' = 'Breach Report Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `corrective_action_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Plan Id');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `parent_breach_report_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Breach Report Id');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `parent_breach_report_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `affected_entity_description` SET TAGS ('dbx_business_glossary_term' = 'Affected Entity Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `affected_entity_type` SET TAGS ('dbx_business_glossary_term' = 'Affected Entity Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `audit_finding_date` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `audit_finding_description` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `audit_finding_status` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_amount` SET TAGS ('dbx_business_glossary_term' = 'Breach Amount');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_category` SET TAGS ('dbx_business_glossary_term' = 'Breach Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_cause` SET TAGS ('dbx_business_glossary_term' = 'Breach Cause');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_currency` SET TAGS ('dbx_business_glossary_term' = 'Breach Currency');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_date` SET TAGS ('dbx_business_glossary_term' = 'Breach Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_description` SET TAGS ('dbx_business_glossary_term' = 'Breach Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by` SET TAGS ('dbx_business_glossary_term' = 'Breach Initiated By');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_email` SET TAGS ('dbx_business_glossary_term' = 'Breach Initiated By Contact Email');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_email` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_email` SET TAGS ('dbx_pii_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_name` SET TAGS ('dbx_business_glossary_term' = 'Breach Initiated By Contact Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_phone` SET TAGS ('dbx_business_glossary_term' = 'Breach Initiated By Contact Phone');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_initiated_by_contact_type` SET TAGS ('dbx_business_glossary_term' = 'Breach Initiated By Contact Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_location` SET TAGS ('dbx_business_glossary_term' = 'Breach Location');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_severity` SET TAGS ('dbx_business_glossary_term' = 'Breach Severity');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `breach_type` SET TAGS ('dbx_business_glossary_term' = 'Breach Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `cap_action_description` SET TAGS ('dbx_business_glossary_term' = 'Cap Action Description');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `cap_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Cap Completion Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `cap_status` SET TAGS ('dbx_business_glossary_term' = 'Cap Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `notification_date` SET TAGS ('dbx_business_glossary_term' = 'Notification Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `notification_method` SET TAGS ('dbx_business_glossary_term' = 'Notification Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `notification_reference` SET TAGS ('dbx_business_glossary_term' = 'Notification Reference');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `notification_status` SET TAGS ('dbx_business_glossary_term' = 'Notification Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `number_of_affected_individuals` SET TAGS ('dbx_business_glossary_term' = 'Number Of Affected Individuals');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `regulatory_body` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Body');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `regulatory_filing_date` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Filing Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `regulatory_filing_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Filing Reference');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `regulatory_filing_status` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Filing Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `report_date` SET TAGS ('dbx_business_glossary_term' = 'Report Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `report_name` SET TAGS ('dbx_business_glossary_term' = 'Report Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `report_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `report_number` SET TAGS ('dbx_business_glossary_term' = 'Report Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `report_status` SET TAGS ('dbx_business_glossary_term' = 'Report Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `report_type` SET TAGS ('dbx_business_glossary_term' = 'Report Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`breach_report` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_obligation` ALTER COLUMN `is_state_specific` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_obligation` ALTER COLUMN `reporting_frequency_months` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`regulatory_obligation` ALTER COLUMN `submission_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` SET TAGS ('dbx_subdomain' = 'regulatory_oversight');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_attestation_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Attestation ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Attesting Officer ID');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `employee_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `attachment_count` SET TAGS ('dbx_business_glossary_term' = 'Attachment Count');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `attesting_officer_name` SET TAGS ('dbx_business_glossary_term' = 'Attesting Officer Name');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `attesting_officer_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `attesting_officer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_category` SET TAGS ('dbx_business_glossary_term' = 'Compliance Category');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_category` SET TAGS ('dbx_value_regex' = 'privacy|security|financial|operational|governance|risk');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_attestation_date` SET TAGS ('dbx_business_glossary_term' = 'Attestation Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `evidence_documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Evidence Documentation URL');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `is_confidential` SET TAGS ('dbx_business_glossary_term' = 'Is Confidential');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Attestation Notes');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Attestation Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `receipt_number` SET TAGS ('dbx_business_glossary_term' = 'Receipt Number');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `regulatory_body` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Body');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference Code');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Risk Level');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `risk_level` SET TAGS ('dbx_value_regex' = 'low|moderate|high|critical');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_attestation_status` SET TAGS ('dbx_business_glossary_term' = 'Attestation Status');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_attestation_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|approved|rejected|revoked|expired');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `submission_method` SET TAGS ('dbx_business_glossary_term' = 'Submission Method');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `submission_method` SET TAGS ('dbx_value_regex' = 'electronic|mail|fax|portal|api');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `submission_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Submission Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `summary` SET TAGS ('dbx_business_glossary_term' = 'Attestation Summary');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `compliance_attestation_type` SET TAGS ('dbx_business_glossary_term' = 'Attestation Type');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_attestation` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_regulatory_obligation` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_regulatory_obligation` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_regulatory_obligation` SET TAGS ('dbx_ssot_owner_domain' = 'plan');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_regulatory_obligation` SET TAGS ('dbx_ssot_owner_product' = 'plan_regulatory_obligation');
ALTER TABLE `vibe_health_insurance_v1`.`compliance`.`compliance_regulatory_obligation` SET TAGS ('dbx_ssot_entity' = 'regulatory_obligation');
