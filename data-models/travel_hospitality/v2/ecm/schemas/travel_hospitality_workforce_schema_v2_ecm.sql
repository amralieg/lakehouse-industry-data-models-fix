-- Schema for Domain: workforce | Business: Travel_Hospitality | Version: v2_ecm
...
CREATE OR REPLACE TABLE `vibe_travel_hospitality_v1`.`workforce`.`learning_course` (
    ...
    `property_id` BIGINT COMMENT 'add column property_id (BIGINT) with FK to property.property.property_id - learning courses are deployed at property level and this table only self-references and links to compliance.policy',
...
CREATE OR REPLACE TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` (
...
CREATE OR REPLACE TABLE `vibe_travel_hospitality_v1`.`workforce`.`disciplinary_action` (
    ...
    `employee_id` BIGINT COMMENT 'Unique identifier of the employee subject to the disciplinary action. Links to the employee master record in Oracle HCM Cloud or SAP S/4HANA HCM.',
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`leave_request` ADD CONSTRAINT `fk_workforce_leave_request_benefit_plan_id` FOREIGN KEY (`benefit_plan_id`) REFERENCES `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan`(`benefit_plan_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`learning_course` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`learning_course` ALTER COLUMN `property_id` SET TAGS ('dbx_business_glossary_term' = 'Property Identifier');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` SET TAGS ('dbx_subdomain' = 'compensation_benefits');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `benefit_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Benefit Plan ID');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `property_id` SET TAGS ('dbx_business_glossary_term' = 'Property ID');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `aca_compliant_flag` SET TAGS ('dbx_business_glossary_term' = 'Affordable Care Act (ACA) Compliant Flag');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `carrier_name` SET TAGS ('dbx_business_glossary_term' = 'Insurance Carrier Name');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `carrier_policy_number` SET TAGS ('dbx_business_glossary_term' = 'Carrier Policy Number');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `cobra_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Consolidated Omnibus Budget Reconciliation Act (COBRA) Eligible Flag');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `coinsurance_percentage` SET TAGS ('dbx_business_glossary_term' = 'Coinsurance Percentage');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `contribution_frequency` SET TAGS ('dbx_business_glossary_term' = 'Contribution Frequency');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `contribution_frequency` SET TAGS ('dbx_value_regex' = 'weekly|biweekly|semimonthly|monthly|annual');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `copay_amount` SET TAGS ('dbx_business_glossary_term' = 'Copay Amount');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `coverage_amount` SET TAGS ('dbx_business_glossary_term' = 'Coverage Amount');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `coverage_tier` SET TAGS ('dbx_business_glossary_term' = 'Coverage Tier');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `coverage_tier` SET TAGS ('dbx_value_regex' = 'employee_only|employee_spouse|employee_children|employee_family');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `deductible_amount` SET TAGS ('dbx_business_glossary_term' = 'Deductible Amount');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `dependent_coverage_allowed_flag` SET TAGS ('dbx_business_glossary_term' = 'Dependent Coverage Allowed Flag');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `eligibility_criteria` SET TAGS ('dbx_business_glossary_term' = 'Eligibility Criteria');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `employee_contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Employee Contribution Amount');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `employer_contribution_amount` SET TAGS ('dbx_business_glossary_term' = 'Employer Contribution Amount');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `enrollment_period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Period End Date');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `enrollment_period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Period Start Date');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `life_event_enrollment_allowed_flag` SET TAGS ('dbx_business_glossary_term' = 'Life Event Enrollment Allowed Flag');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `maximum_dependent_age` SET TAGS ('dbx_business_glossary_term' = 'Maximum Dependent Age');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `out_of_pocket_maximum` SET TAGS ('dbx_business_glossary_term' = 'Out-of-Pocket Maximum');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_code` SET TAGS ('dbx_business_glossary_term' = 'Benefit Plan Code');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,20}$');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_description` SET TAGS ('dbx_business_glossary_term' = 'Benefit Plan Description');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_document_url` SET TAGS ('dbx_business_glossary_term' = 'Plan Document Uniform Resource Locator (URL)');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_business_glossary_term' = 'Benefit Plan Name');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_status` SET TAGS ('dbx_business_glossary_term' = 'Benefit Plan Status');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|suspended|terminated');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_type` SET TAGS ('dbx_business_glossary_term' = 'Benefit Plan Type');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `plan_year` SET TAGS ('dbx_business_glossary_term' = 'Plan Year');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ALTER COLUMN `waiting_period_days` SET TAGS ('dbx_business_glossary_term' = 'Waiting Period Days');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`compensation_plan` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`compensation_plan` SET TAGS ('dbx_subdomain' = 'compensation_benefits');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`compensation_plan` ALTER COLUMN `compensation_plan_id` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`compensation_plan` ALTER COLUMN `compensation_plan_status` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`compensation_plan` ALTER COLUMN `compensation_plan_description` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`disciplinary_action` SET TAGS ('dbx_subdomain' = 'employee_relations');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`disciplinary_action` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee ID');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ALTER COLUMN `compensation_currency` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ALTER COLUMN `compensation_frequency` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ALTER COLUMN `salary_range_max` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ALTER COLUMN `salary_range_min` SET TAGS ('dbx_pii_person' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`leave_request` SET TAGS ('dbx_subdomain' = 'employee_relations');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`leave_request` ALTER COLUMN `benefit_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Accrual Plan ID');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_period` SET TAGS ('dbx_subdomain' = 'payroll_operations');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` SET TAGS ('dbx_subdomain' = 'payroll_operations');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ALTER COLUMN `total_gross_pay` SET TAGS ('dbx_classification' = 'restricted');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ALTER COLUMN `total_gross_pay` SET TAGS ('dbx_PII' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ALTER COLUMN `total_net_pay` SET TAGS ('dbx_classification' = 'restricted');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ALTER COLUMN `total_net_pay` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ALTER COLUMN `total_social_security_tax` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ALTER COLUMN `total_social_security_tax` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`performance_review` SET TAGS ('dbx_subdomain' = 'employee_relations');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`schedule` SET TAGS ('dbx_subdomain' = 'labor_scheduling');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`shift_template` SET TAGS ('dbx_subdomain' = 'labor_scheduling');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` SET TAGS ('dbx_subdomain' = 'labor_scheduling');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ALTER COLUMN `work_order_id` SET TAGS ('dbx_business_glossary_term' = 'Work Order ID');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ALTER COLUMN `device_identifier` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ALTER COLUMN `geolocation_latitude` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ALTER COLUMN `geolocation_latitude` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ALTER COLUMN `geolocation_longitude` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ALTER COLUMN `geolocation_longitude` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`workforce_safety_incident` SET TAGS ('dbx_subdomain' = 'employee_relations');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`workforce_safety_incident` ALTER COLUMN `medical_treatment_facility` SET TAGS ('dbx_classification' = 'confidential');
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`workforce_safety_incident` ALTER COLUMN `medical_treatment_facility` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`workforce_safety_incident` ALTER COLUMN `workers_compensation_claim_number` SET TAGS ('dbx_pii_person' = 'true');
