...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`commodity` (
    ...
    `intervention_id` BIGINT COMMENT 'P13: Connect program.commodity by adding column supply_category_code (BIGINT) with FK to program.intervention.intervention_id since commodity has zero outbound FKs. P13: connect_table: program.commodity** - add column supply_category_code (BI',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`vendor` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Preferred currency for transactions with the vendor, using ISO 4217 three-letter currency code (e.g., USD, EUR, GBP).',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`purchase_order` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for all monetary amounts on this purchase order (e.g., USD, EUR, GBP). Used for multi-currency procurement and exchange rate tracking.',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` (
    ...
    `batch_lot_id` BIGINT COMMENT 'Linked batch/lot for cold chain / expiry tracking.',
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for the cost amounts (e.g., USD, EUR, GBP).',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for the inventory valuation. Used for multi-currency financial reporting.',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`stock_movement` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for the cost fields. Typically the organizations functional currency (e.g., USD, EUR, GBP).',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO currency code for the budget amount (e.g., USD, EUR, GBP).',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`waybill` (
    ...
    `customs_declaration_number` DOUBLE COMMENT 'Official customs declaration or clearance document number for cross-border shipments. Required for international humanitarian aid movements.',
    ...
    `vehicle_registration` DOUBLE COMMENT 'Official registration or license plate number of the vehicle used for transport. Critical for security tracking and incident investigation.',
...
) COMMENT 'Waybill - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` (
    ...
    `batch_lot_id` BIGINT COMMENT 'Manufacturer batch or lot number for the donated commodity, used for quality control, recall management, and traceability.',
    ...
    `country_id` BIGINT COMMENT 'Three-letter ISO 3166-1 alpha-3 country code from which the in-kind donation was shipped.',
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for the estimated fair market value (e.g., USD, EUR, GBP).',
    ...
    `inkind_batch_lot_id` BIGINT COMMENT 'Linked batch/lot for cold chain / expiry tracking.',
    ...
    `receiving_country_id` BIGINT COMMENT 'Three-letter ISO 3166-1 alpha-3 country code where the in-kind donation was received.',
...
) COMMENT 'Inkind Donation - core entity in the supply domain supporting humanitarian operations.';
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`procurement_request` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for the estimated costs (e.g., USD, EUR, GBP). Essential for multi-currency grant management and financial reporting.',
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`rfq` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for all financial amounts in this RFQ (e.g., USD, EUR, GBP).',
    ...
    `evaluation_criteria` DECIMAL(18,2) COMMENT 'Documented criteria and weighting used to evaluate and score vendor bids (e.g., price 40%, technical quality 30%, delivery time 20%, past performance 10%).',
...
) COMMENT 'Rfq - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`shipment` (
    `shipment_id` BIGINT COMMENT 'Unique identifier for the shipment record. Primary key for the shipment entity.',
    `country_id` BIGINT COMMENT 'ISO 3166-1 alpha-3 country code for the shipment destination country (e.g., SYR, YEM, SDN for field operations).',
    `origin_country_id` BIGINT COMMENT 'ISO 3166-1 alpha-3 country code for the shipment origin country (e.g., USA, DNK, ARE for procurement hubs).',
    ...
    `cold_chain_monitored_flag` BOOLEAN COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    `cold_chain_shipment_flag` BOOLEAN COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    ...
    `temperature_excursion_flag` BOOLEAN COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
...
) COMMENT 'Shipment - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'Three-letter ISO 4217 currency code for all monetary values in this framework agreement (e.g., USD, EUR, GBP).',
...
) COMMENT 'Framework Agreement - core entity in the supply domain supporting humanitarian operations.';
...
) COMMENT 'Bid - core entity in the supply domain supporting humanitarian operations.';
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` (
    ...
    `supply_field_distribution_line_id` BIGINT COMMENT 'SSOT link to canonical field.field_distribution_line (single source of truth).',
...
) COMMENT 'Supply Distribution Line - core entity in the supply domain supporting humanitarian operations. [SSOT: dependent alias of canonical field.field_distribution_line; defer to canonical for shared attributes and link via field_distribution_line_id.]';
...
CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` (
    ...
    `partnership_agreement_id` BIGINT COMMENT 'Canonical SSOT reference to partnership.partnership_agreement (this product is a non-authoritative duplicate). SSOT link to canonical partnership.partnership_agreement.',
...
) COMMENT 'Supply Agreement - core entity in the supply domain supporting humanitarian operations. [SSOT: dependent alias of canonical partnership.partnership_agreement; defer to canonical for shared attributes and link via partnership_agreement_id.]';
...
) COMMENT 'Distribution Plan Line - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` (
    ...
    `exchange_rate_id` BIGINT COMMENT 'ISO 4217 three-letter currency code for the unit_cost_agreement. Partners may quote in local currency rather than USD.',
    ...
    `agreement_status` STRING COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    `end_date` DATE COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    ...
    `quality_certification` STRING COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    ...
    `start_date` DATE COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    ...
    `unit_price` DECIMAL(18,2) COMMENT 'Business justification: IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018',
    CONSTRAINT pk_commodity_supply_agreement PRIMARY KEY(`commodity_supply_agreement_id`)
) COMMENT 'Commodity Supply Agreement - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`batch_lot` (
    `batch_lot_id` BIGINT COMMENT 'Primary key',
    `commodity_id` BIGINT COMMENT 'FK to commodity',
    `warehouse_id` BIGINT COMMENT 'FK to warehouse',
    `batch_number` STRING COMMENT 'Batch/lot number',
    ...
    `quantity` STRING COMMENT 'Quantity in batch',
    `batch_lot_status` STRING COMMENT 'Status of batch',
    `storage_temperature_max_c` STRING COMMENT 'Max storage temp Celsius',
    `storage_temperature_min_c` STRING COMMENT 'Min storage temp Celsius',
    `unit_of_measure` STRING COMMENT 'Unit of measure',
    `vvm_stage` STRING COMMENT 'Vaccine vial monitor stage 1-4',
    `who_pq_status` STRING COMMENT 'WHO prequalification status',
    CONSTRAINT pk_batch_lot PRIMARY KEY(`batch_lot_id`)
) COMMENT 'Batch Lot - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` (
    `temperature_excursion_id` BIGINT COMMENT 'Primary key',
    `batch_lot_id` BIGINT COMMENT 'FK to batch lot',
    `cold_chain_equipment_id` BIGINT COMMENT 'FK to cold chain equipment',
    `warehouse_id` BIGINT COMMENT 'FK to warehouse',
    `corrective_action` STRING COMMENT 'Corrective action taken',
    `created_timestamp` TIMESTAMP COMMENT 'Record creation timestamp',
    `duration_minutes` STRING COMMENT 'Duration in minutes',
    `excursion_end_timestamp` TIMESTAMP COMMENT 'End of excursion',
    `excursion_start_timestamp` TIMESTAMP COMMENT 'Start of excursion',
    `impact_assessment` STRING COMMENT 'Impact assessment',
    `max_temperature_c` STRING COMMENT 'Max temperature recorded',
    `min_temperature_c` STRING COMMENT 'Min temperature recorded',
    `modified_timestamp` TIMESTAMP COMMENT 'Record last modified timestamp',
    `temperature_excursion_status` STRING COMMENT 'Status of the temperature excursion event (e.g., open, under investigation, resolved, escalated)',
    CONSTRAINT pk_temperature_excursion PRIMARY KEY(`temperature_excursion_id`)
) COMMENT 'Temperature Excursion - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` (
    `cold_chain_equipment_id` BIGINT COMMENT 'Unique identifier for the cold chain equipment asset (refrigerator, freezer, cold room, etc.)',
    `warehouse_id` BIGINT COMMENT 'FK to warehouse',
    `capacity_liters` STRING COMMENT 'Capacity in liters',
    `created_timestamp` TIMESTAMP COMMENT 'Record creation timestamp',
    `equipment_type` STRING COMMENT 'Type or category of cold chain equipment (e.g., solar refrigerator, ice-lined refrigerator, walk-in cold room)',
    `installation_date` DATE COMMENT 'Date when the cold chain equipment was installed and commissioned at the facility',
    `last_maintenance_date` DATE COMMENT 'Last maintenance date',
    `manufacturer` STRING COMMENT 'Manufacturer',
    `model_name` STRING COMMENT 'Model name',
    `modified_timestamp` TIMESTAMP COMMENT 'Record last modified timestamp',
    `operational_status` STRING COMMENT 'Operational status',
    `power_source` STRING COMMENT 'Power source type',
    `serial_number` STRING COMMENT 'Serial number',
    `temperature_range_max_c` STRING COMMENT 'Max operating temp',
    `temperature_range_min_c` STRING COMMENT 'Min operating temp',
    `who_pqs_code` STRING COMMENT 'WHO PQS code',
    CONSTRAINT pk_cold_chain_equipment PRIMARY KEY(`cold_chain_equipment_id`)
) COMMENT 'Cold Chain Equipment - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` (
    `vaccine_vial_monitor_state_id` BIGINT COMMENT 'Unique identifier for a recorded vaccine vial monitor (VVM) state observation',
    `batch_lot_id` BIGINT COMMENT 'FK to batch lot',
    `action_taken` STRING COMMENT 'Action taken based on VVM',
    `created_timestamp` TIMESTAMP COMMENT 'Record creation timestamp',
    `discard_flag` BOOLEAN COMMENT 'Whether vial discarded',
    `modified_timestamp` TIMESTAMP COMMENT 'Record last modified timestamp',
    `notes` STRING COMMENT 'Notes',
    `observation_timestamp` TIMESTAMP COMMENT 'When observed',
    `observer_name` STRING COMMENT 'Observer name',
    `vvm_stage` STRING COMMENT 'VVM stage 1-4',
    CONSTRAINT pk_vaccine_vial_monitor_state PRIMARY KEY(`vaccine_vial_monitor_state_id`)
) COMMENT 'Vaccine Vial Monitor State - core entity in the supply domain supporting humanitarian operations.';

CREATE OR REPLACE TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing` (
    `gavi_cofinancing_id` BIGINT COMMENT 'Primary key',
    `commodity_id` BIGINT COMMENT 'FK to commodity (vaccine)',
    `country_id` BIGINT COMMENT 'FK to country',
    `country_contribution_usd` STRING COMMENT 'Country contribution USD',
    `country_share_percent` DECIMAL(18,2) COMMENT 'Country co-financing share percent',
    `created_timestamp` TIMESTAMP COMMENT 'Record creation timestamp',
    `fiscal_year` STRING COMMENT 'Fiscal year',
    `gavi_contribution_usd` STRING COMMENT 'Gavi contribution USD',
    `gavi_share_percent` DECIMAL(18,2) COMMENT 'Gavi co-financing share percent',
    `modified_timestamp` TIMESTAMP COMMENT 'Record last modified timestamp',
    `gavi_cofinancing_status` STRING COMMENT 'Status',
    `total_cost_usd` STRING COMMENT 'Total cost USD',
    `transition_phase` STRING COMMENT 'Transition phase (initial/preparatory/accelerated)',
    CONSTRAINT pk_gavi_cofinancing PRIMARY KEY(`gavi_cofinancing_id`)
) COMMENT 'Gavi Cofinancing - core entity in the supply domain supporting humanitarian operations.';
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ADD CONSTRAINT `fk_supply_inkind_donation_batch_lot_id` FOREIGN KEY (`batch_lot_id`) REFERENCES `vibe_ngo_v1`.`supply`.`batch_lot`(`batch_lot_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ADD CONSTRAINT `fk_supply_inkind_donation_inkind_batch_lot_id` FOREIGN KEY (`inkind_batch_lot_id`) REFERENCES `vibe_ngo_v1`.`supply`.`batch_lot`(`batch_lot_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ADD CONSTRAINT `fk_supply_procurement_request_framework_agreement_id` FOREIGN KEY (`framework_agreement_id`) REFERENCES `vibe_ngo_v1`.`supply`.`framework_agreement`(`framework_agreement_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ADD CONSTRAINT `fk_supply_rfq_procurement_request_id` FOREIGN KEY (`procurement_request_id`) REFERENCES `vibe_ngo_v1`.`supply`.`procurement_request`(`procurement_request_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ADD CONSTRAINT `fk_supply_supply_agreement_framework_agreement_id` FOREIGN KEY (`framework_agreement_id`) REFERENCES `vibe_ngo_v1`.`supply`.`framework_agreement`(`framework_agreement_id`);
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ADD CONSTRAINT `fk_supply_supply_agreement_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_ngo_v1`.`supply`.`vendor`(`vendor_id`);
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ADD CONSTRAINT `fk_supply_distribution_plan_line_batch_lot_id` FOREIGN KEY (`batch_lot_id`) REFERENCES `vibe_ngo_v1`.`supply`.`batch_lot`(`batch_lot_id`);
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_category` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_code` SET TAGS ('pii_self_reference' = 'hierarchy');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `cold_chain_required_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `country_of_origin` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_description` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `donor_restricted_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `donor_restriction_notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `doses_per_vial` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `effective_end_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `effective_start_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `gavi_co_financed_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `gavi_co_financing_eligible_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `gavi_supported_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `harmonized_tariff_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `harmonized_tariff_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `harmonized_tariff_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `hazard_classification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `hazardous_material_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `in_kind_donation_eligible_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `kit_assembly_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `kit_component_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `last_modified_by` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_part_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_part_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `manufacturer_part_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `minimum_order_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_business_glossary_term' = 'Commodity Name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `commodity_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `procurement_lead_time_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `quality_certification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `reorder_point_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `shelf_life_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `special_handling_instructions` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `sphere_compliant_flag` SET TAGS ('pii_standard_reference' = 'Sphere Handbook 2018 minimum standards');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `standard_unit_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `storage_humidity_max_percent` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `storage_humidity_max_percent` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `storage_temperature_max_celsius` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `storage_temperature_max_celsius` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `storage_temperature_min_celsius` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `storage_temperature_min_celsius` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `subcategory` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `vaccine_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `volume_per_unit_cubic_meters` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `vvm_applicable_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `vvm_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `weight_per_unit_kg` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity` ALTER COLUMN `who_pq_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `country_id` SET TAGS ('pii_business_glossary_term' = 'Country Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `country_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `country_id` SET TAGS ('pii_standard_reference' = 'ISO 3166-1 alpha-3 country codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `country_office_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `staff_member_id` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `statutory_registration_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `access_restrictions` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_business_glossary_term' = 'Address Line 1');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_'pii_address'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_'pii_de_identified']' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line1` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_business_glossary_term' = 'Address Line 2');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_'pii_address'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_'pii_de_identified']' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `address_line2` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `admin_level_1` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `admin_level_2` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `city` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `cluster_affiliation` SET TAGS ('pii_standard_reference' = 'IASC Cluster Coordination Reference Module 2015');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_code` SET TAGS ('pii_self_reference' = 'hierarchy');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `cold_chain_capable_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `cold_chain_capacity_liters` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `cold_chain_capacity_liters` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `cold_chain_equipment_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `commissioning_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_'pii_email'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_'pii_classification' = 'pii_staff]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_email` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_'pii_phone'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_'pii_classification' = 'pii_staff]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `contact_phone` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `customs_bonded` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `decommissioning_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `emergency_access_24_7` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `facility_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `forklift_capacity_kg` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `forklift_capacity_kg` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `gis_accuracy_meters` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `hazmat_certified` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `last_inspection_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `latitude` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `latitude` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `loading_docks_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `longitude` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `longitude` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `managing_entity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_name` SET TAGS ('pii_business_glossary_term' = 'Warehouse Name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `warehouse_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `notes` SET TAGS ('pii_business_glossary_term' = 'Warehouse Notes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `operational_hours` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `operational_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `ownership_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `postal_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `postal_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `postal_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `security_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `storage_capacity_m3` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `storage_capacity_m3` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `storage_capacity_pallets` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `storage_capacity_pallets` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `temperature_controlled` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `temperature_range_max_c` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `temperature_range_min_c` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `vaccine_storage_certified_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `vaccine_storage_certified_flag` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `wms_system_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `wms_system_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`warehouse` ALTER COLUMN `wms_system_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_id` SET TAGS ('pii_business_glossary_term' = 'Vendor Identifier');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `system_platform_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_business_glossary_term' = 'Address Line 1');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_'pii_address'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_'pii_de_identified']' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_1` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_business_glossary_term' = 'Address Line 2');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_'pii_address'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_'pii_de_identified']' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `address_line_2` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `bank_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `bank_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `bank_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `bank_swift_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `bank_swift_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `bank_swift_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `blacklist_effective_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `blacklist_expiry_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `blacklist_flag` SET TAGS ('pii_business_glossary_term' = 'Blacklist Flag');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `blacklist_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `blacklist_reason` SET TAGS ('pii_business_glossary_term' = 'Blacklist Reason');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `blacklist_reason` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `city` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_code` SET TAGS ('pii_business_glossary_term' = 'Vendor Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_code` SET TAGS ('pii_self_reference' = 'hierarchy');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `commodity_categories` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `country_of_operation` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `fleet_size` SET TAGS ('pii_business_glossary_term' = 'Fleet Size');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `fleet_size` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `gmp_certification_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `humanitarian_network_membership` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `iso_certification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `last_performance_review_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `last_performance_score` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_name` SET TAGS ('pii_business_glossary_term' = 'Vendor Legal Name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `payment_terms_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `performance_tier` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `postal_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `postal_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `postal_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `prequalification_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `prequalification_expiry_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `prequalification_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_'pii_email'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_'pii_classification' = 'pii_staff]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_email` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_'pii_classification' = 'pii_staff]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_'pii_phone'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_'pii_classification' = 'pii_staff]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `primary_contact_phone` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `registration_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `state_province` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_'reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_'pii_classification' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_'lookup_review' = 'no_target]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `tax_identification_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `transport_modes_offered` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `un_vendor_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `un_vendor_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `un_vendor_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_type` SET TAGS ('pii_business_glossary_term' = 'Vendor Type');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `vendor_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `warehouse_capacity_sqm` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vendor` ALTER COLUMN `warehouse_capacity_sqm` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `country_office_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `donor_fund_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `framework_agreement_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `gl_account_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `rfq_id` SET TAGS ('pii_business_glossary_term' = 'Rfq Id (Foreign Key)');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `rfq_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `system_platform_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `tertiary_purchase_modified_by_user_user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `actual_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `approval_workflow_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `approved_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `commodity_category` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_'pii_address'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_'pii_de_identified']' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_address` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `donor_visibility_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `emergency_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `erp_document_reference` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `expected_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `freight_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `goods_receipt_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `incoterm` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `invoice_matching_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `payment_method` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `payment_terms` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `po_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `po_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `po_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `po_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `po_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `po_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `procurement_method` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `requested_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `subtotal_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `tax_amount` SET TAGS ('pii_business_glossary_term' = 'Tax Amount');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `tax_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order` ALTER COLUMN `total_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` SET TAGS ('pii_subdomain' = 'inventory_movement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `commodity_id` SET TAGS ('pii_business_glossary_term' = 'Commodity ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `finance_fund_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `gl_account_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `inkind_donation_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `intervention_id` SET TAGS ('pii_business_glossary_term' = 'Program ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `purchase_order_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `shipment_id` SET TAGS ('pii_business_glossary_term' = 'Shipment ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `shipment_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `vendor_id` SET TAGS ('pii_business_glossary_term' = 'Vendor ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `waybill_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `batch_number` SET TAGS ('pii_business_glossary_term' = 'Batch Number');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `batch_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `batch_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `batch_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `cold_chain_breach_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `condition_on_arrival` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `customs_clearance_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `customs_cleared` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `discrepancy_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `discrepancy_notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `donor_visibility_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `expiry_date` SET TAGS ('pii_business_glossary_term' = 'Expiry Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `expiry_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `freight_charges` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `inspection_required` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `inspection_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `lot_number` SET TAGS ('pii_business_glossary_term' = 'Lot Number');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `lot_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `lot_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `lot_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `manufacturing_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `notes` SET TAGS ('pii_business_glossary_term' = 'Receipt Notes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `quantity_ordered` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `quantity_received` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `quantity_rejected` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_date` SET TAGS ('pii_business_glossary_term' = 'Receipt Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_document_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_document_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_document_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `receipt_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `serial_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `serial_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `serial_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `storage_location_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `storage_location_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `storage_location_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `storage_location_code` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `total_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `unit_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `vvm_stage_on_receipt` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`goods_receipt` ALTER COLUMN `vvm_stage_on_receipt` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `country_id` SET TAGS ('pii_business_glossary_term' = 'Country Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `country_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `country_id` SET TAGS ('pii_standard_reference' = 'ISO 3166-1 alpha-3 country codes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `gl_account_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `batch_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `batch_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `batch_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `donor_restriction_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `expiration_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `in_kind_donation_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `last_movement_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `last_physical_count_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `last_updated_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `maximum_stock_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `pipeline_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `quantity_available` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `quantity_in_transit` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `quantity_on_hand` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `quantity_quarantined` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `quantity_reserved` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `reorder_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `snapshot_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `storage_condition` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `storage_condition` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `total_valuation` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `unit_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `warehouse_location` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inventory_balance` ALTER COLUMN `warehouse_location` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` SET TAGS ('pii_subdomain' = 'inventory_movement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `case_record_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `commodity_id` SET TAGS ('pii_business_glossary_term' = 'Commodity ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `audit_finding_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `distribution_event_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `finance_fund_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `gl_account_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `purchase_order_id` SET TAGS ('pii_business_glossary_term' = 'Purchase Order (PO) Number');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `purchase_order_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `stock_warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `vendor_id` SET TAGS ('pii_business_glossary_term' = 'Supplier ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `authorizing_officer_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `authorizing_officer_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `authorizing_officer_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `authorizing_officer_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `authorizing_officer_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `authorizing_officer_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `batch_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `batch_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `batch_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_business_glossary_term' = 'Carrier Name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `carrier_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `count_team_reference` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `expiry_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `in_kind_donation_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspection_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspector_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspector_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspector_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspector_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspector_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `inspector_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `movement_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `notes` SET TAGS ('pii_business_glossary_term' = 'Movement Notes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `quality_inspection_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reason_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reason_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reason_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reason_description` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reference_document_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reference_document_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reference_document_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `reference_document_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `serial_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `serial_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `serial_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `total_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `tracking_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `tracking_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `tracking_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `transport_mode` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `unit_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`stock_movement` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` SET TAGS ('pii_subdomain' = 'distribution_operations');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `budget_id` SET TAGS ('pii_standard_reference' = 'IATI budget element; IPSAS 24 Presentation of Budget Information');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `chs_self_assessment_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `community_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `country_office_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Budget Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `system_platform_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `actual_end_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `actual_start_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `approval_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `approval_required_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `beneficiary_category` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `coordination_cluster` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `distribution_duration_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `distribution_frequency` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `distribution_modality` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `distribution_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `estimated_budget_amount` SET TAGS ('pii_standard_reference' = 'IATI budget element; IPSAS 24 Presentation of Budget Information');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `estimated_total_volume_m3` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `estimated_total_weight_kg` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `funding_source` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin1` SET TAGS ('pii_sensitivity' = 'phi');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin1` SET TAGS ('pii_standard_reference' = 'OCHA Common Operational Datasets (COD); ISO 3166-2');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin1` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin2` SET TAGS ('pii_sensitivity' = 'phi');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin2` SET TAGS ('pii_standard_reference' = 'OCHA Common Operational Datasets (COD); ISO 3166-2');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin2` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin3` SET TAGS ('pii_sensitivity' = 'phi');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin3` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_admin3` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_country` SET TAGS ('pii_sensitivity' = 'phi');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_country` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `geographic_coverage_country` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `mel_indicator_alignment` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `plan_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `planned_end_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `planned_start_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `risk_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `sdg_alignment` SET TAGS ('pii_standard_reference' = 'UN Sustainable Development Goals indicator framework (A/RES/71/313)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `security_clearance_required` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `target_beneficiary_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan` ALTER COLUMN `target_household_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` SET TAGS ('pii_subdomain' = 'distribution_operations');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `budget_id` SET TAGS ('pii_standard_reference' = 'IATI budget element; IPSAS 24 Presentation of Budget Information');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `distribution_plan_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `distribution_warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `household_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `registrant_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `actual_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `approved_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `beneficiary_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `carrier_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `carrier_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `carrier_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `carrier_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `carrier_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `carrier_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `cold_chain_required_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `customs_clearance_required_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `customs_reference` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `delivery_instructions` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `dispatch_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `distribution_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_contact` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `driver_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `emergency_response_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `estimated_value_usd` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `household_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `in_kind_donation_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `medical_supplies_flag` SET TAGS ('pii_sensitivity' = 'phi');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `medical_supplies_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `nfi_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `order_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `order_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `order_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `order_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `order_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `priority_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `scheduled_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `special_handling_requirements` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `total_commodity_lines` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `total_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `total_volume_m3` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `total_weight_kg` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `transport_cost_usd` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `transport_mode` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `vehicle_registration` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_order` ALTER COLUMN `waybill_reference` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` SET TAGS ('pii_subdomain' = 'inventory_movement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `compliance_incident_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `distribution_order_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `gl_account_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `shipment_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `waybill_warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `actual_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `arrival_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `customs_clearance_required_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `customs_declaration_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `customs_declaration_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `customs_declaration_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `departure_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `discrepancy_notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `discrepancy_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `dispatch_date` SET TAGS ('pii_business_glossary_term' = 'Dispatch Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `dispatch_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `distance_km` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_contact_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_contact_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_contact_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_license_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_license_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_license_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_business_glossary_term' = 'Driver Full Name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `driver_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `estimated_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `hazardous_material_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `insurance_policy_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `insurance_policy_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `insurance_policy_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `insurance_required_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `priority_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `receipt_signature_captured_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `receipt_signature_captured_flag` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_'pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `received_by_title` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `remarks` SET TAGS ('pii_business_glossary_term' = 'Waybill Remarks');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `remarks` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `route_description` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `seal_intact_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `seal_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `seal_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `seal_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `shipment_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `shipment_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `temperature_controlled_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `temperature_max_celsius` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `temperature_min_celsius` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `total_dispatched_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `total_received_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `transport_cost_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `transport_cost_currency` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `vehicle_registration` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `waybill_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `waybill_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`waybill` ALTER COLUMN `waybill_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_subdomain' = 'procurement_sourcing');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_layer' = 'MVM');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_mvm' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_placement' = 'mvm');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_model_layer' = 'MVM');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_humanitarian_deployment' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_deployment_layer' = 'MVM');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` SET TAGS ('pii_mvm_promoted' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_business_glossary_term' = 'Batch Lot Number');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_lookup_link' = 'auto');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `community_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `constituent_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `country_id` SET TAGS ('pii_business_glossary_term' = 'Shipment Origin Country Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `country_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `country_id` SET TAGS ('pii_standard_reference' = 'ISO 3166-1 alpha-3 country codes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Valuation Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `finance_fund_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `gl_account_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `impact_story_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `inkind_batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receiving_country_id` SET TAGS ('pii_business_glossary_term' = 'Receiving Country Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receiving_country_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receiving_country_id` SET TAGS ('pii_standard_reference' = 'ISO 3166-1 alpha-3 country codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `regulatory_filing_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `shipment_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `acknowledgment_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `acknowledgment_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `allocation_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `allocation_status` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `condition_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `customs_clearance_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `customs_clearance_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donation_reference_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donation_reference_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donation_reference_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_business_glossary_term' = 'Donor Name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_staff' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_masking_policy' = 'person_name_mask');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_pattern' = 'person_name');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_classification' = 'pii');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_class' = 'pii_donor');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_restrictions` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_type` SET TAGS ('pii_business_glossary_term' = 'Donor Type');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `donor_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `estimated_fair_market_value` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `expiration_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `iati_reporting_flag` SET TAGS ('pii_standard_reference' = 'IATI Standard v2.03 (iatistandard.org)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `iati_transaction_type` SET TAGS ('pii_standard_reference' = 'IATI Standard v2.03 (iatistandard.org)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `notes` SET TAGS ('pii_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `quality_inspection_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `quality_inspection_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `quality_inspection_result` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `quantity` SET TAGS ('pii_business_glossary_term' = 'Quantity');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receipt_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receipt_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receiving_location_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receiving_location_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `receiving_location_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `restricted_use_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `tax_deductible_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`inkind_donation` ALTER COLUMN `valuation_method` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `award_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `budget_line_id` SET TAGS ('pii_standard_reference' = 'IATI budget element; IPSAS 24 Presentation of Budget Information');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `cost_center_id` SET TAGS ('pii_standard_reference' = 'IPSAS (International Public Sector Accounting Standards)');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `donor_fund_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `donor_requirement_id` SET TAGS ('pii_standard_reference' = '2 CFR 200 Subpart D; donor-specific grant conditions');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `framework_agreement_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `intervention_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `org_unit_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `tertiary_procurement_last_modified_by_user_user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `approval_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `approval_level_required` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `commodity_category` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `compliance_check_required` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_['confidential'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_'pii_address'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_'sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_'pii_de_identified']' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `delivery_address` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `donor_visibility_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `environmental_impact_assessment` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `estimated_total_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `estimated_unit_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `item_description` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `justification_narrative` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `local_procurement_preference` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `quantity_requested` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `rejection_reason` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `request_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `request_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `request_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `required_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `requisition_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `requisition_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `requisition_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `sole_source_justification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`procurement_request` ALTER COLUMN `urgency_level` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `country_office_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `procurement_request_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `project_site_id` SET TAGS ('pii_business_glossary_term' = 'Project Identifier');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `system_platform_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `attachment_count` SET TAGS ('pii_business_glossary_term' = 'Attachment Count');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `attachment_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `award_date` SET TAGS ('pii_business_glossary_term' = 'Award Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `award_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `awarded_amount` SET TAGS ('pii_business_glossary_term' = 'Awarded Amount');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `awarded_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `bid_opening_date` SET TAGS ('pii_business_glossary_term' = 'Bid Opening Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `bid_opening_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `cancellation_reason` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `cancellation_reason` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `clarification_deadline` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `commodity_category` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `created_timestamp` SET TAGS ('pii_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `delivery_deadline` SET TAGS ('pii_business_glossary_term' = 'Delivery Deadline');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `delivery_deadline` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `delivery_location` SET TAGS ('pii_business_glossary_term' = 'Delivery Location');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `delivery_location` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `delivery_location` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `donor_visibility` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `emergency_procurement` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `estimated_budget_amount` SET TAGS ('pii_standard_reference' = 'IATI budget element; IPSAS 24 Presentation of Budget Information');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `evaluation_completion_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `evaluation_criteria` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `incoterm` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `invited_vendor_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `issue_date` SET TAGS ('pii_business_glossary_term' = 'Issue Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `issue_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `item_description` SET TAGS ('pii_business_glossary_term' = 'Item Description');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `item_description` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `minimum_qualification_requirements` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `notes` SET TAGS ('pii_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `payment_terms` SET TAGS ('pii_business_glossary_term' = 'Payment Terms');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `payment_terms` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `procurement_method` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `procurement_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `published_url` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `quantity_requested` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `received_bid_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `responsive_bid_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `rfq_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `rfq_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `rfq_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `rfq_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `submission_deadline` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `title` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_business_glossary_term' = 'Unit of Measure (UoM)');
ALTER TABLE `vibe_ngo_v1`.`supply`.`rfq` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` SET TAGS ('pii_subdomain' = 'inventory_movement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `shipment_id` SET TAGS ('pii_business_glossary_term' = 'Shipment Identifier');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `country_id` SET TAGS ('pii_business_glossary_term' = 'Destination Country Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `country_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `country_id` SET TAGS ('pii_standard_reference' = 'ISO 3166-1 alpha-3 country codes');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_country_id` SET TAGS ('pii_business_glossary_term' = 'Origin Country Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_country_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_country_id` SET TAGS ('pii_standard_reference' = 'ISO 3166-1 alpha-3 country codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `project_site_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `system_platform_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `warehouse_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `actual_arrival_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `actual_departure_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `bill_of_lading_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `bill_of_lading_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `bill_of_lading_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_reference_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_reference_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `carrier_reference_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `cold_chain_monitored_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `cold_chain_shipment_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `container_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `container_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `container_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `container_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_broker_name` SET TAGS ('pii_['pii_de_identified'' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_broker_name` SET TAGS ('pii_'sensitivity' = 'pii]');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_broker_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_broker_name` SET TAGS ('pii_class' = 'pii_staff');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_broker_name` SET TAGS ('pii_PII' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_broker_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `customs_clearance_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `destination_location_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `destination_location_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `destination_location_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `destination_port_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `destination_port_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `destination_port_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `duty_exemption_reference` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `estimated_arrival_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `estimated_departure_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `freight_cost_usd` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `hazmat_classification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `import_permit_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `import_permit_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `import_permit_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `incoterm` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `insurance_policy_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `insurance_policy_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `insurance_policy_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `insured_value_usd` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `last_updated_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `number_of_cartons` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `number_of_pallets` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_location_name` SET TAGS ('pii_de_identified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_location_name` SET TAGS ('pii_sensitivity' = 'pii');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_location_name` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_port_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_port_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `origin_port_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `phytosanitary_certificate_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `phytosanitary_certificate_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `phytosanitary_certificate_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `reference_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `reference_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `reference_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `shipment_status` SET TAGS ('pii_business_glossary_term' = 'Shipment Status');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `shipment_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `shipment_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `special_handling_instructions` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `temperature_controlled` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `temperature_excursion_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `temperature_range_max_c` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `temperature_range_min_c` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `total_cargo_volume_m3` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `total_cargo_weight_kg` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`shipment` ALTER COLUMN `transport_mode` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `system_platform_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `country_office_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `donor_requirement_id` SET TAGS ('pii_standard_reference' = '2 CFR 200 Subpart D; donor-specific grant conditions');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `staff_member_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `user_account_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `renewed_framework_agreement_id` SET TAGS ('pii_relationship' = 'self_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `renewed_framework_agreement_id` SET TAGS ('pii_hierarchy_self_reference' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `renewed_framework_agreement_id` SET TAGS ('pii_self_reference' = 'hierarchy');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `renewed_framework_agreement_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `vendor_id` SET TAGS ('pii_business_glossary_term' = 'Vendor ID');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `agreement_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `agreement_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `agreement_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `agreement_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `agreement_title` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `agreement_type` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `approval_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `call_off_mechanism` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `commodity_categories` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `created_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `delivery_lead_time_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `discount_percentage` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `discount_percentage` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `donor_visibility_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `effective_end_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `effective_start_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `emergency_delivery_lead_time_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `geographic_scope` SET TAGS ('pii_sensitivity' = 'phi');
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `geographic_scope` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `incoterm` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `last_performance_review_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `maximum_order_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `maximum_order_value` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `minimum_order_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `payment_terms` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `performance_rating` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `pricing_structure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `quality_standards` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `renewal_option_count` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `renewal_terms` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `sole_source_justification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `termination_clause` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `termination_notice_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `total_orders_placed` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `total_value_utilized` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`framework_agreement` ALTER COLUMN `validity_period_months` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `rfq_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `vendor_id` SET TAGS ('pii_business_glossary_term' = 'Bid - Vendor Id');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `amount` SET TAGS ('pii_business_glossary_term' = 'Bid Amount');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `awarded_flag` SET TAGS ('pii_business_glossary_term' = 'Award Flag');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `awarded_flag` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `bid_status` SET TAGS ('pii_business_glossary_term' = 'Bid Status');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `bid_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `currency` SET TAGS ('pii_business_glossary_term' = 'Bid Currency');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `currency` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `financial_score` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `rank` SET TAGS ('pii_business_glossary_term' = 'Bid Rank');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `rank` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `rejection_reason` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `submission_date` SET TAGS ('pii_business_glossary_term' = 'Bid Submission Date');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `submission_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `technical_score` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `total_score` SET TAGS ('pii_business_glossary_term' = 'Total Bid Score');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `total_score` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `validity_days` SET TAGS ('pii_business_glossary_term' = 'Bid Validity Period');
ALTER TABLE `vibe_ngo_v1`.`supply`.`bid` ALTER COLUMN `validity_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_data_type' = 'association_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_subdomain' = 'distribution_operations');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_owner' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_group' = 'field.field_distribution_line__supply.supply_distribution_line');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_alias_of' = 'field.field_distribution_line');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_source' = 'field.field_distribution_line');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_role' = 'view_of_field_field_distribution_line');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_canonical' = 'field.field_distribution_line');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_counterpart' = 'field.field_distribution_line');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot' = 'mirror');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` SET TAGS ('pii_ssot_mirror_of' = 'field.field_distribution_line');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `distribution_order_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `field_distribution_line_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `supply_field_distribution_line_id` SET TAGS ('pii_ssot_link' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `batch_number` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `batch_number` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `batch_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `condition_on_dispatch` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `condition_on_receipt` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `expiry_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `line_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `line_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `line_total_value` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `quantity_discrepancy` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `quantity_dispatched` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `quantity_received` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `storage_location_code` SET TAGS ('pii_reference_code' = 'lookup_pending');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `storage_location_code` SET TAGS ('pii_lookup_review' = 'no_target');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `storage_location_code` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `storage_location_code` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_distribution_line` ALTER COLUMN `unit_value` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `purchase_order_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `line_number` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `line_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `line_total_amount` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `quantity_ordered` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `quantity_outstanding` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `quantity_received` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `requested_delivery_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`purchase_order_line` ALTER COLUMN `unit_price` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_data_type' = 'association_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_association_edges' = 'supply.commodity,supply.vendor');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_duplicate_of' = 'partnership.partnership_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_group' = 'partnership.partnership_agreement__supply.supply_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_alias_of' = 'partnership.partnership_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_source' = 'partnership.partnership_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_role' = 'view_of_partnership_partnership_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_canonical' = 'partnership.partnership_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_counterpart' = 'partnership.partnership_agreement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot' = 'mirror');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` SET TAGS ('pii_ssot_mirror_of' = 'partnership.partnership_agreement');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `framework_agreement_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `partnership_agreement_id` SET TAGS ('pii_ssot_canonical_ref' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `partnership_agreement_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `vendor_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `agreement_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `discount_percentage` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `discount_percentage` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `end_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `last_supply_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `lead_time_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `minimum_order_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `performance_rating` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `prequalification_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `quality_certification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `start_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `unit_price` SET TAGS ('pii_business_glossary_term' = 'Unit Price');
ALTER TABLE `vibe_ngo_v1`.`supply`.`supply_agreement` ALTER COLUMN `unit_price` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` SET TAGS ('pii_data_type' = 'association_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` SET TAGS ('pii_subdomain' = 'distribution_operations');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `batch_lot_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `distribution_plan_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `allocation_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `allocation_status` SET TAGS ('pii_detected' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `commodity_category` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `commodity_priority` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `created_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `estimated_unit_cost` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `last_modified_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `line_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `quantity_planned` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `total_commodity_items` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `total_estimated_value` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`distribution_plan_line` ALTER COLUMN `unit_of_measure` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` SET TAGS ('pii_data_type' = 'association_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` SET TAGS ('pii_subdomain' = 'catalog_management');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` SET TAGS ('pii_structure_pinned' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` SET TAGS ('pii_domain_verified' = 'true');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `commodity_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_business_glossary_term' = 'Agreement Currency');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_relationship' = 'lookup_reference');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `exchange_rate_id` SET TAGS ('pii_standard_reference' = 'ISO 4217 currency codes');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `partner_org_id` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `agreement_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `end_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `last_supply_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `lead_time_days` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `minimum_order_quantity` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `notes` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `performance_rating` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `prequalification_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `prequalification_expiry_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `prequalification_status` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `quality_certification` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `quality_certification_verified` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `start_date` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
...
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `unit_cost_agreement` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`commodity_supply_agreement` ALTER COLUMN `unit_price` SET TAGS ('pii_standard_reference' = 'IATI Activity Standard v2.03 (transaction); UNICEF Supply Division catalogue; WHO PQS/PQ standards; WFP LESS; Sphere Handbook 2018');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_subdomain' = 'cold_chain');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_health' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_vaccine' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` ALTER COLUMN `manufacturer_name` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` ALTER COLUMN `storage_temperature_max_c` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` ALTER COLUMN `storage_temperature_min_c` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`batch_lot` ALTER COLUMN `vvm_stage` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_subdomain' = 'inventory_movement');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_subdomain' = 'cold_chain');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_health' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_vaccine' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_incident' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`temperature_excursion` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_subdomain' = 'cold_chain');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_health' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_vaccine' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` ALTER COLUMN `capacity_liters` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`cold_chain_equipment` ALTER COLUMN `model_name` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_data_type' = 'reference_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_subdomain' = 'cold_chain');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_health' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_vaccine' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` SET TAGS ('pii_domain_verified' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` ALTER COLUMN `observer_name` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`vaccine_vial_monitor_state` ALTER COLUMN `vvm_stage` SET TAGS ('pii_detected' = 'true');
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing` SET TAGS ('pii_subdomain' = 'catalog_management');
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing` SET TAGS ('pii_domain' = 'supply');
ALTER TABLE `vibe_ngo_v1`.`supply`.`gavi_cofinancing` SET TAGS ('pii_domain_verified' = 'true');
