...
-- Generated on: 2026-07-10 12:17:26
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` SET TAGS ('dbx_subdomain' = 'wafer_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `fabrication_wafer_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Lot ID (Business Identifier)');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`raw_material` ALTER COLUMN `material_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`die_bank` SET TAGS ('dbx_subdomain' = 'wafer_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` SET TAGS ('dbx_subdomain' = 'wafer_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` ALTER COLUMN `layer_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` ALTER COLUMN `mask_set_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`storage_location` ALTER COLUMN `location_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`storage_location` ALTER COLUMN `osat_partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` SET TAGS ('dbx_subdomain' = 'wafer_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` ALTER COLUMN `ar_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Ar Invoice Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` ALTER COLUMN `hold_initiator_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` ALTER COLUMN `hold_release_authority_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`consignment_stock` SET TAGS ('dbx_subdomain' = 'material_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_valuation` SET TAGS ('dbx_subdomain' = 'material_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_kgd_certification` SET TAGS ('dbx_subdomain' = 'wafer_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` SET TAGS ('dbx_subdomain' = 'wafer_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` ALTER COLUMN `process_step_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`reservation` SET TAGS ('dbx_subdomain' = 'stock_control');
