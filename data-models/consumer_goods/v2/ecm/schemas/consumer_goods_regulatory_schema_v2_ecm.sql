...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` (
    `regulatory_region_id` BIGINT COMMENT 'Primary key for region',
    `jurisdiction_id` BIGINT COMMENT 'add column jurisdiction_id (BIGINT) with FK to regulatory.jurisdiction.jurisdiction_id - regions should map to regulatory jurisdictions for compliance reporting',
    ...
    `regulatory_region_code` STRING COMMENT 'Internal alphanumeric code used to reference the region within the enterprise.',
    ...
    `regulatory_region_description` STRING COMMENT 'Free‑form description providing additional context about the region.',
    ...
    `regulatory_region_name` STRING COMMENT 'Human‑readable name of the region (e.g., "Midwest", "Bavaria").',
    ...
    `regulatory_region_status` STRING COMMENT 'Current operational status of the region.',
    `time_zone` STRING COMMENT 'IANA time‑zone identifier representing the primary time zone of the region.',
    `regulatory_region_type` STRING COMMENT 'Category that defines the hierarchical level of the region.',
    ...
    CONSTRAINT pk_regulatory_region PRIMARY KEY(`regulatory_region_id`)
) COMMENT 'Master reference table for region. Referenced by region_id.';

CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`regulatory`.`region` (
    `region_id` BIGINT COMMENT 'Primary key for region',
    `jurisdiction_id` BIGINT COMMENT 'regions should map to regulatory jurisdictions for compliance reporting',
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ADD CONSTRAINT `fk_regulatory_regulatory_region_jurisdiction_id` FOREIGN KEY (`jurisdiction_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`jurisdiction`(`jurisdiction_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ADD CONSTRAINT `fk_regulatory_regulatory_region_parent_region_id` FOREIGN KEY (`parent_region_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region`(`regulatory_region_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`region` ADD CONSTRAINT `fk_regulatory_region_jurisdiction_id` FOREIGN KEY (`jurisdiction_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`jurisdiction`(`jurisdiction_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`submission` ALTER COLUMN `dossier_reference` SET TAGS ('dbx_business_glossary_term' = 'Dossier Reference');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`dossier` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Dossier Primary Contact Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`sds` SET TAGS ('dbx_subdomain' = 'substance_safety');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`ingredient_list` SET TAGS ('dbx_subdomain' = 'substance_safety');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`ingredient_list` ALTER COLUMN `jurisdiction_code` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Jurisdiction Code');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`label_version` SET TAGS ('dbx_subdomain' = 'labeling_obligations');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`compliance_obligation` SET TAGS ('dbx_subdomain' = 'labeling_obligations');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`compliance_obligation` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Obligation Responsible Owner Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`compliance_assessment` SET TAGS ('dbx_subdomain' = 'labeling_obligations');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`reach_substance` SET TAGS ('dbx_subdomain' = 'substance_safety');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`ifra_compliance_record` SET TAGS ('dbx_subdomain' = 'substance_safety');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`surveillance_event` SET TAGS ('dbx_subdomain' = 'market_enforcement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`product_recall` SET TAGS ('dbx_subdomain' = 'market_enforcement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`jurisdiction` SET TAGS ('dbx_subdomain' = 'labeling_obligations');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`restricted_substance` SET TAGS ('dbx_subdomain' = 'substance_safety');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_claim` SET TAGS ('dbx_subdomain' = 'registration_compliance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_claim` ALTER COLUMN `jurisdiction_code` SET TAGS ('dbx_business_glossary_term' = 'Jurisdiction Code');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_claim` ALTER COLUMN `jurisdiction_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`action` SET TAGS ('dbx_subdomain' = 'market_enforcement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`action` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Action Responsible Party Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`cpsc_filing` SET TAGS ('dbx_subdomain' = 'registration_compliance');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`cpsc_filing` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Submitted By Employee ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`change` SET TAGS ('dbx_subdomain' = 'market_enforcement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`change` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Change Responsible Owner Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` SET TAGS ('dbx_subdomain' = 'labeling_obligations');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `regulatory_region_id` SET TAGS ('dbx_business_glossary_term' = 'Region Identifier');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `parent_region_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Region Id');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `area_sq_km` SET TAGS ('dbx_business_glossary_term' = 'Area Sq Km');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `climate_zone` SET TAGS ('dbx_business_glossary_term' = 'Climate Zone');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `regulatory_region_code` SET TAGS ('dbx_business_glossary_term' = 'Code');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `regulatory_region_description` SET TAGS ('dbx_business_glossary_term' = 'Description');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective From');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Effective Until');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `external_reference` SET TAGS ('dbx_business_glossary_term' = 'External Reference');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `gdp_usd` SET TAGS ('dbx_business_glossary_term' = 'Gdp Usd');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `geographic_center_name` SET TAGS ('dbx_business_glossary_term' = 'Geographic Center Name');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `hierarchy_level` SET TAGS ('dbx_business_glossary_term' = 'Hierarchy Level');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `is_cross_border` SET TAGS ('dbx_business_glossary_term' = 'Is Cross Border');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `iso_country_code` SET TAGS ('dbx_business_glossary_term' = 'Iso Country Code');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `iso_region_code` SET TAGS ('dbx_business_glossary_term' = 'Iso Region Code');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `latitude_center` SET TAGS ('dbx_business_glossary_term' = 'Latitude Center');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `latitude_center` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `latitude_center` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `longitude_center` SET TAGS ('dbx_business_glossary_term' = 'Longitude Center');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `longitude_center` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `longitude_center` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `median_income_usd` SET TAGS ('dbx_business_glossary_term' = 'Median Income Usd');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `regulatory_region_name` SET TAGS ('dbx_business_glossary_term' = 'Name');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `population` SET TAGS ('dbx_business_glossary_term' = 'Population');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `primary_language` SET TAGS ('dbx_business_glossary_term' = 'Primary Language');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `regulatory_region_status` SET TAGS ('dbx_business_glossary_term' = 'Status');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `time_zone` SET TAGS ('dbx_business_glossary_term' = 'Time Zone');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `regulatory_region_type` SET TAGS ('dbx_business_glossary_term' = 'Type');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region` ALTER COLUMN `urbanization_rate` SET TAGS ('dbx_business_glossary_term' = 'Urbanization Rate');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`region` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_consumer_goods_v1`.`regulatory`.`region` ALTER COLUMN `region_id` SET TAGS ('dbx_business_glossary_term' = 'region Identifier');
