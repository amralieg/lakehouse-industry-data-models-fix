...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`fleet_assignment` (
    ...
    `cost_allocation_code` DECIMAL(18,2) COMMENT 'Cost center or cost allocation code for internal charge-back and financial reporting. Used to route equipment costs to the appropriate project budget line.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`hours` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Equipment Hours logged by Subcontractor crews are tracked for utilization, labor costing, and subcontractor performance measurement.',
    ...
    `rental_invoice_reference` DECIMAL(18,2) COMMENT 'External rental company invoice number or reference for rented equipment hours. Used for rental cost reconciliation and accounts payable matching.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`equipment_mobilization` (
    ...
    `cost_allocation_code` DECIMAL(18,2) COMMENT 'Cost center or Work Breakdown Structure (WBS) code to which the mobilization cost is allocated.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`fuel_transaction` (
    ...
    `invoice_number` DECIMAL(18,2) COMMENT 'Vendor invoice number associated with the fuel transaction. Used for accounts payable reconciliation.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`operator_certification` (
    ...
    `cost_currency_code` DECIMAL(18,2) COMMENT 'Three-letter ISO 4217 currency code for the certification cost amount. Enables multi-currency cost tracking for international operations.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`telematics_reading` (
    ...
    `operational_state` DECIMAL(18,2) COMMENT 'Current operational state of the equipment at the time of reading. Derived from engine status, movement, and sensor data. Enables real-time fleet status dashboards.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` (
    ...
    `premium_payment_frequency` DECIMAL(18,2) COMMENT 'The frequency at which premium payments are made to the insurer (annual, semi-annual, quarterly, monthly, or one-time lump sum).',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`asset_activity_assignment` (
    ...
    `actual_end_date` DATE COMMENT 'Business attribute actual_end_date for asset_activity_assignment',
    ...
    `actual_start_date` DATE COMMENT 'Business attribute actual_start_date for asset_activity_assignment',
    `allocated_hours` DECIMAL(18,2) COMMENT 'Business attribute allocated_hours for asset_activity_assignment',
    `assignment_cost` DECIMAL(18,2) COMMENT 'Total cost of the asset assignment.',
    ...
    `hourly_rate` DECIMAL(18,2) COMMENT 'Internal/rental hourly cost rate.',
    `is_critical` BOOLEAN COMMENT 'Whether the asset is critical to the activity.',
    `is_critical_resource` BOOLEAN COMMENT '',
    `planned_cost` DECIMAL(18,2) COMMENT 'Planned cost of the assignment.',
    `planned_end_date` DATE COMMENT 'Business attribute planned_end_date for asset_activity_assignment',
    `planned_hours` DECIMAL(18,2) COMMENT '',
    `planned_quantity` DECIMAL(18,2) COMMENT 'Quantity of the asset planned for the activity',
    `planned_start_date` DATE COMMENT 'Business attribute planned_start_date for asset_activity_assignment',
    ...
    `unit_of_measure` STRING COMMENT 'Unit of measure for quantities (hours, days).',
    `updated_timestamp` TIMESTAMP COMMENT 'Record update timestamp.',
    `utilization_pct` DECIMAL(18,2) COMMENT 'Utilization percentage of the asset.',
    `utilization_rate` DECIMAL(18,2) COMMENT 'Utilization rate of the asset on the activity as a percentage.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`equipment`.`fuel_point` (
    ...
    `operational_status` DECIMAL(18,2) COMMENT 'Current real‑time operational condition of the fuel point.',
...
) COMMENT 'Master reference table for fuel_point. Referenced by fuel_point_id. Canonical equipment.fuel_point entity (v2 curated).';
...
) COMMENT 'Master reference table for functional_location. Referenced by functional_location_id. Canonical equipment.functional_location entity (v2 curated).';
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset` ALTER COLUMN `compliance_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Calendar Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset_category` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fleet_assignment` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`hours` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`maintenance_plan` SET TAGS ('dbx_subdomain' = 'maintenance_planning');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`maintenance_order` SET TAGS ('dbx_subdomain' = 'maintenance_planning');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`maintenance_notification` SET TAGS ('dbx_subdomain' = 'maintenance_planning');
ALTER TABLE `vibe_construction_v1`.`equipment`.`maintenance_notification` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`inspection_record` SET TAGS ('dbx_subdomain' = 'maintenance_planning');
ALTER TABLE `vibe_construction_v1`.`equipment`.`inspection_record` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`equipment_mobilization` SET TAGS ('dbx_subdomain' = 'fleet_operations');
ALTER TABLE `vibe_construction_v1`.`equipment`.`equipment_mobilization` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_transaction` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_transaction` ALTER COLUMN `operator_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`operator_certification` SET TAGS ('dbx_subdomain' = 'operator_compliance');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`operator_certification` ALTER COLUMN `assessor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`telematics_reading` SET TAGS ('dbx_subdomain' = 'fleet_operations');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset_valuation` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset_valuation` ALTER COLUMN `appraiser_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `broker_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `claims_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `claims_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `claims_contact_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `insurer_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `insurer_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `insurer_contact_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`insurance_policy` ALTER COLUMN `insurer_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset_activity_assignment` SET TAGS ('dbx_subdomain' = 'operator_compliance');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`asset_activity_assignment` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` SET TAGS ('dbx_subdomain' = 'fleet_operations');
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `address` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `latitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `location_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `longitude` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `fuel_point_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `supplier_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`fuel_point` ALTER COLUMN `zip_code` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`functional_location` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`equipment`.`functional_location` ALTER COLUMN `functional_location_name` SET TAGS ('dbx_sensitivity' = 'pii');
