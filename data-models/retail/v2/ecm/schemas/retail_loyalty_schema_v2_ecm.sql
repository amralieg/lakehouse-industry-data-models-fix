...
-- ========= TABLES =========
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` (
...
) COMMENT '[References SSOT: compliance.compliance_program] Loyalty program configuration and rules. References compliance.compliance_program for regulatory compliance aspects of loyalty operations. Defines earn/burn rates, tier structures, and member benefits.';

CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` (
    ...
    `profile_id` BIGINT COMMENT 'Member customer profile',
    `loyalty_profile_id` BIGINT COMMENT 'Reference to the customer who holds this membership. Links to the customer domain for unified customer view.',
    ...
    `loyalty_tier_id` BIGINT COMMENT 'Current tier of the member',
...
) COMMENT '[SSOT Owner] Authoritative source for loyalty membership records. Tracks member enrollment, tier status, points balances, and activity history within loyalty programs.';
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` (
    ...
    `points_loyalty_membership_id` BIGINT COMMENT 'Reference to the loyalty membership account for which this points transaction was recorded.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` (
    ...
    `loyalty_program_id` BIGINT COMMENT 'Program this rule applies to',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`reward` (
    ...
    `loyalty_program_id` BIGINT COMMENT 'Program offering this reward',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`member_offer` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`member_segment` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`partner_program` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`referral` (
    ...
    `loyalty_program_id` BIGINT COMMENT 'Program context',
    ...
    `referral_loyalty_membership_id` BIGINT COMMENT 'Referring member',
    ...
    `source` STRING COMMENT 'Detailed source attribution for the referral. May include specific social media platform, email campaign identifier, or in-store associate identifier.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` (
...
-- ========= FOREIGN KEYS =========
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ADD CONSTRAINT `fk_loyalty_loyalty_membership_tier_id` FOREIGN KEY (`tier_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`tier`(`tier_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ADD CONSTRAINT `fk_loyalty_loyalty_membership_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ADD CONSTRAINT `fk_loyalty_loyalty_membership_loyalty_tier_id` FOREIGN KEY (`loyalty_tier_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`tier`(`tier_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ADD CONSTRAINT `fk_loyalty_loyalty_membership_referred_by_member_loyalty_membership_id` FOREIGN KEY (`referred_by_member_loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ADD CONSTRAINT `fk_loyalty_tier_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ADD CONSTRAINT `fk_loyalty_points_ledger_loyalty_membership_id` FOREIGN KEY (`loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ADD CONSTRAINT `fk_loyalty_points_ledger_partner_transaction_id` FOREIGN KEY (`partner_transaction_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`partner_transaction`(`partner_transaction_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ADD CONSTRAINT `fk_loyalty_points_ledger_points_loyalty_membership_id` FOREIGN KEY (`points_loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ADD CONSTRAINT `fk_loyalty_accrual_rule_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ADD CONSTRAINT `fk_loyalty_redemption_rule_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ADD CONSTRAINT `fk_loyalty_reward_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ADD CONSTRAINT `fk_loyalty_redemption_loyalty_membership_id` FOREIGN KEY (`loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ADD CONSTRAINT `fk_loyalty_redemption_member_offer_id` FOREIGN KEY (`member_offer_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`member_offer`(`member_offer_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ADD CONSTRAINT `fk_loyalty_redemption_partner_program_id` FOREIGN KEY (`partner_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`partner_program`(`partner_program_id`);
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ADD CONSTRAINT `fk_loyalty_member_offer_loyalty_membership_id` FOREIGN KEY (`loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ADD CONSTRAINT `fk_loyalty_member_offer_member_segment_id` FOREIGN KEY (`member_segment_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`member_segment`(`member_segment_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ADD CONSTRAINT `fk_loyalty_member_offer_reward_id` FOREIGN KEY (`reward_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`reward`(`reward_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ADD CONSTRAINT `fk_loyalty_engagement_campaign_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ADD CONSTRAINT `fk_loyalty_engagement_campaign_member_segment_id` FOREIGN KEY (`member_segment_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`member_segment`(`member_segment_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ADD CONSTRAINT `fk_loyalty_clienteling_interaction_loyalty_membership_id` FOREIGN KEY (`loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ADD CONSTRAINT `fk_loyalty_clienteling_interaction_member_offer_id` FOREIGN KEY (`member_offer_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`member_offer`(`member_offer_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ADD CONSTRAINT `fk_loyalty_member_segment_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ADD CONSTRAINT `fk_loyalty_partner_program_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ADD CONSTRAINT `fk_loyalty_partner_transaction_loyalty_membership_id` FOREIGN KEY (`loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ADD CONSTRAINT `fk_loyalty_partner_transaction_original_transaction_partner_transaction_id` FOREIGN KEY (`original_transaction_partner_transaction_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`partner_transaction`(`partner_transaction_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ADD CONSTRAINT `fk_loyalty_partner_transaction_partner_program_id` FOREIGN KEY (`partner_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`partner_program`(`partner_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ADD CONSTRAINT `fk_loyalty_referral_loyalty_program_id` FOREIGN KEY (`loyalty_program_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_program`(`loyalty_program_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ADD CONSTRAINT `fk_loyalty_referral_originating_referral_id` FOREIGN KEY (`originating_referral_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`referral`(`referral_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ADD CONSTRAINT `fk_loyalty_referral_loyalty_membership_id` FOREIGN KEY (`loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ADD CONSTRAINT `fk_loyalty_referral_referral_loyalty_membership_id` FOREIGN KEY (`referral_loyalty_membership_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`loyalty_membership`(`loyalty_membership_id`);
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ADD CONSTRAINT `fk_loyalty_campaign_storefront_deployment_engagement_campaign_id` FOREIGN KEY (`engagement_campaign_id`) REFERENCES `vibe_retail_v1`.`loyalty`.`engagement_campaign`(`engagement_campaign_id`);
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_subdomain' = 'program_configuration');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_owner' = 'compliance.compliance_program');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_authoritative_owner' = 'compliance.compliance_program');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_role' = 'authoritative');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_concept' = 'loyalty_program');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_resolution' = 'distinct_concept');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_authoritative_source' = 'compliance.compliance_program');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` SET TAGS ('dbx_ssot_reference' = 'compliance.compliance_program');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `compliance_program_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Program Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Program Manager Associate Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `annual_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Annual Fee Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `banner_affiliation` SET TAGS ('dbx_business_glossary_term' = 'Banner Affiliation');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `charitable_donation_enabled` SET TAGS ('dbx_business_glossary_term' = 'Charitable Donation Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,12}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `customer_service_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `customer_service_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `enrollment_eligibility_rule` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Eligibility Rule');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `enrollment_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Fee Amount');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_currency_name` SET TAGS ('dbx_business_glossary_term' = 'Points Currency Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_currency_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_earn_rate` SET TAGS ('dbx_business_glossary_term' = 'Points Earn Rate');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_expiry_duration_months` SET TAGS ('dbx_business_glossary_term' = 'Points Expiry Duration (Months)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_expiry_policy` SET TAGS ('dbx_business_glossary_term' = 'Points Expiry Policy');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_expiry_policy` SET TAGS ('dbx_value_regex' = 'never|rolling_months|calendar_year|fixed_date|activity_based');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `points_redemption_rate` SET TAGS ('dbx_business_glossary_term' = 'Points Redemption Rate');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `pos_integration_enabled` SET TAGS ('dbx_business_glossary_term' = 'Point of Sale (POS) Integration Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `privacy_policy_url` SET TAGS ('dbx_business_glossary_term' = 'Privacy Policy URL');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `privacy_policy_url` SET TAGS ('dbx_value_regex' = '^https?://.*$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_code` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_description` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_name` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_status` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_status` SET TAGS ('dbx_value_regex' = 'active|inactive|suspended|planned|retired');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_type` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `program_type` SET TAGS ('dbx_value_regex' = 'tiered|points_based|cashback|coalition|co_branded_card|subscription');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `referral_program_enabled` SET TAGS ('dbx_business_glossary_term' = 'Referral Program Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `target_customer_segment` SET TAGS ('dbx_business_glossary_term' = 'Target Customer Segment');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `terms_and_conditions_url` SET TAGS ('dbx_business_glossary_term' = 'Terms and Conditions URL');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `terms_and_conditions_url` SET TAGS ('dbx_value_regex' = '^https?://.*$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `tier_evaluation_period` SET TAGS ('dbx_business_glossary_term' = 'Tier Evaluation Period');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `tier_evaluation_period` SET TAGS ('dbx_value_regex' = 'calendar_year|rolling_12_months|program_year|lifetime');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `tier_qualification_metric` SET TAGS ('dbx_business_glossary_term' = 'Tier Qualification Metric');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `tier_qualification_metric` SET TAGS ('dbx_value_regex' = 'annual_spend|points_earned|transaction_count|hybrid');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_program` ALTER COLUMN `tier_structure_enabled` SET TAGS ('dbx_business_glossary_term' = 'Tier Structure Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` SET TAGS ('dbx_subdomain' = 'member_engagement');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` SET TAGS ('dbx_ssot_role' = 'authoritative');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` SET TAGS ('dbx_ssot_owner' = 'loyalty.loyalty_membership');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` SET TAGS ('dbx_ssot_concept' = 'membership');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Membership ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `tier_id` SET TAGS ('dbx_business_glossary_term' = 'Current Tier Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `loyalty_profile_id` SET TAGS ('dbx_business_glossary_term' = 'Customer ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Store ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `current_points_balance` SET TAGS ('dbx_business_glossary_term' = 'Current Points Balance');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `enrollment_channel` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Channel');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `enrollment_date` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `fraud_flag` SET TAGS ('dbx_business_glossary_term' = 'Fraud Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `language_preference` SET TAGS ('dbx_business_glossary_term' = 'Language Preference');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `last_activity_date` SET TAGS ('dbx_business_glossary_term' = 'Last Activity Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `last_purchase_date` SET TAGS ('dbx_business_glossary_term' = 'Last Purchase Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `last_redemption_date` SET TAGS ('dbx_business_glossary_term' = 'Last Redemption Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `lifetime_points_earned` SET TAGS ('dbx_business_glossary_term' = 'Lifetime Points Earned');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `lifetime_points_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Lifetime Points Redeemed');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `member_number` SET TAGS ('dbx_business_glossary_term' = 'Member Number');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `membership_status` SET TAGS ('dbx_business_glossary_term' = 'Membership Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `opt_in_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `points_expiring_soon` SET TAGS ('dbx_business_glossary_term' = 'Points Expiring Soon');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `status_effective_date` SET TAGS ('dbx_business_glossary_term' = 'Status Effective Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `status_reason` SET TAGS ('dbx_business_glossary_term' = 'Membership Status Reason');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `tier_expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Tier Expiry Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `tier_qualification_date` SET TAGS ('dbx_business_glossary_term' = 'Tier Qualification Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `total_spend_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Spend Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `total_transactions` SET TAGS ('dbx_business_glossary_term' = 'Total Transaction Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`loyalty_membership` ALTER COLUMN `vip_flag` SET TAGS ('dbx_business_glossary_term' = 'VIP (Very Important Person) Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` SET TAGS ('dbx_subdomain' = 'program_configuration');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `tier_id` SET TAGS ('dbx_business_glossary_term' = 'Tier ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `tier_code` SET TAGS ('dbx_business_glossary_term' = 'Tier Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `tier_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{2,20}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `display_order` SET TAGS ('dbx_business_glossary_term' = 'Display Order');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `downgrade_rule_description` SET TAGS ('dbx_business_glossary_term' = 'Downgrade Rule Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `grace_period_months` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `invitation_only_flag` SET TAGS ('dbx_business_glossary_term' = 'Invitation Only Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `lifetime_tier_flag` SET TAGS ('dbx_business_glossary_term' = 'Lifetime Tier Flag');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `maintenance_threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Maintenance Threshold Value');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `marketing_description` SET TAGS ('dbx_business_glossary_term' = 'Marketing Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `tier_name` SET TAGS ('dbx_business_glossary_term' = 'Tier Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `tier_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `points_earning_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Points Earning Multiplier');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `qualification_threshold_type` SET TAGS ('dbx_business_glossary_term' = 'Qualification Threshold Type');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `qualification_threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Qualification Threshold Value');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `rank` SET TAGS ('dbx_business_glossary_term' = 'Tier Rank');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `tier_status` SET TAGS ('dbx_business_glossary_term' = 'Tier Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`tier` ALTER COLUMN `upgrade_rule_description` SET TAGS ('dbx_business_glossary_term' = 'Upgrade Rule Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` SET TAGS ('dbx_subdomain' = 'member_engagement');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `points_ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Points Ledger ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Employee ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `gl_account_id` SET TAGS ('dbx_business_glossary_term' = 'Liability Gl Account Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Store ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Membership Id');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_role' = 'member');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `partner_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Partner Transaction Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `points_loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Membership ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `adjustment_reason` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Reason');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `base_currency_amount` SET TAGS ('dbx_business_glossary_term' = 'Base Currency Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `batch_number` SET TAGS ('dbx_business_glossary_term' = 'Batch ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `breakage_rate` SET TAGS ('dbx_business_glossary_term' = 'Breakage Rate');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `earn_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Earn Multiplier');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `is_promotional` SET TAGS ('dbx_business_glossary_term' = 'Is Promotional');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `new_tier` SET TAGS ('dbx_business_glossary_term' = 'New Tier');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `points_amount` SET TAGS ('dbx_business_glossary_term' = 'Points Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `points_liability_amount` SET TAGS ('dbx_business_glossary_term' = 'Points Liability Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `previous_tier` SET TAGS ('dbx_business_glossary_term' = 'Previous Tier');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `qualifying_points_amount` SET TAGS ('dbx_business_glossary_term' = 'Qualifying Points Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `qualifying_spend_amount` SET TAGS ('dbx_business_glossary_term' = 'Qualifying Spend Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `redemption_value_per_point` SET TAGS ('dbx_business_glossary_term' = 'Redemption Value Per Point');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `reversal_reason` SET TAGS ('dbx_business_glossary_term' = 'Reversal Reason');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `running_balance` SET TAGS ('dbx_business_glossary_term' = 'Running Balance');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `source_reference_type` SET TAGS ('dbx_business_glossary_term' = 'Source Reference Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `transaction_status` SET TAGS ('dbx_business_glossary_term' = 'Transaction Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `transaction_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Transaction Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`points_ledger` ALTER COLUMN `transaction_type` SET TAGS ('dbx_business_glossary_term' = 'Transaction Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` SET TAGS ('dbx_subdomain' = 'program_configuration');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `accrual_rule_id` SET TAGS ('dbx_business_glossary_term' = 'Accrual Rule ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `gl_account_id` SET TAGS ('dbx_business_glossary_term' = 'Liability Gl Account Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `product_brand_id` SET TAGS ('dbx_business_glossary_term' = 'Product Brand Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `tertiary_accrual_approved_by_user_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Approved By User ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `accrual_rule_status` SET TAGS ('dbx_business_glossary_term' = 'Accrual Rule Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `applicable_channel` SET TAGS ('dbx_business_glossary_term' = 'Applicable Channel');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `applicable_product_category` SET TAGS ('dbx_business_glossary_term' = 'Applicable Product Category');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approved Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `bonus_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Bonus Multiplier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `day_of_week_restriction` SET TAGS ('dbx_business_glossary_term' = 'Day of Week Restriction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `earning_basis` SET TAGS ('dbx_business_glossary_term' = 'Earning Basis');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `excluded_product_category` SET TAGS ('dbx_business_glossary_term' = 'Excluded Product Category');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `geographic_restriction` SET TAGS ('dbx_business_glossary_term' = 'Geographic Restriction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `maximum_points_per_transaction` SET TAGS ('dbx_business_glossary_term' = 'Maximum Points Per Transaction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `member_tier_eligibility` SET TAGS ('dbx_business_glossary_term' = 'Member Tier Eligibility');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `minimum_spend_threshold` SET TAGS ('dbx_business_glossary_term' = 'Minimum Spend Threshold');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `payment_method_restriction` SET TAGS ('dbx_business_glossary_term' = 'Payment Method Restriction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `points_per_unit` SET TAGS ('dbx_business_glossary_term' = 'Points Per Unit');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `pricing_strategy_alignment` SET TAGS ('dbx_business_glossary_term' = 'Pricing Strategy Alignment (EDLP/Hi-Lo)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `pricing_strategy_alignment` SET TAGS ('dbx_value_regex' = 'edlp|hi_lo|hybrid');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `rule_code` SET TAGS ('dbx_business_glossary_term' = 'Accrual Rule Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `rule_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{3,20}$');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_business_glossary_term' = 'Accrual Rule Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `rule_priority` SET TAGS ('dbx_business_glossary_term' = 'Rule Priority');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `stacking_allowed_flag` SET TAGS ('dbx_business_glossary_term' = 'Stacking Allowed Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `time_of_day_restriction` SET TAGS ('dbx_business_glossary_term' = 'Time of Day Restriction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`accrual_rule` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` SET TAGS ('dbx_subdomain' = 'program_configuration');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `redemption_rule_id` SET TAGS ('dbx_business_glossary_term' = 'Redemption Rule ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `product_brand_id` SET TAGS ('dbx_business_glossary_term' = 'Product Brand Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `combinable_with_promotions_flag` SET TAGS ('dbx_business_glossary_term' = 'Combinable With Promotions Flag');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `eligible_reward_types` SET TAGS ('dbx_business_glossary_term' = 'Eligible Reward Types');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `excluded_product_categories` SET TAGS ('dbx_business_glossary_term' = 'Excluded Product Categories');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `geographic_restriction` SET TAGS ('dbx_business_glossary_term' = 'Geographic Restriction');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `liability_impact_category` SET TAGS ('dbx_business_glossary_term' = 'Liability Impact Category');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `marketing_message` SET TAGS ('dbx_business_glossary_term' = 'Marketing Message');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `maximum_points_threshold` SET TAGS ('dbx_business_glossary_term' = 'Maximum Points Threshold');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `maximum_redemptions_per_day` SET TAGS ('dbx_business_glossary_term' = 'Maximum Redemptions Per Day');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `maximum_redemptions_per_member` SET TAGS ('dbx_business_glossary_term' = 'Maximum Redemptions Per Member');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `minimum_membership_tier` SET TAGS ('dbx_business_glossary_term' = 'Minimum Membership Tier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `minimum_points_threshold` SET TAGS ('dbx_business_glossary_term' = 'Minimum Points Threshold');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `partial_redemption_allowed_flag` SET TAGS ('dbx_business_glossary_term' = 'Partial Redemption Allowed Flag');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `redemption_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Redemption Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `redemption_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `redemption_rate` SET TAGS ('dbx_business_glossary_term' = 'Redemption Rate');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `redemption_rule_status` SET TAGS ('dbx_business_glossary_term' = 'Redemption Rule Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `requires_approval_flag` SET TAGS ('dbx_business_glossary_term' = 'Requires Approval Flag');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption_rule` ALTER COLUMN `terms_and_conditions_url` SET TAGS ('dbx_business_glossary_term' = 'Terms and Conditions URL');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` SET TAGS ('dbx_subdomain' = 'program_configuration');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Partner Vendor Identifier (ID)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `product_brand_id` SET TAGS ('dbx_business_glossary_term' = 'Product Brand Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `brand_restriction` SET TAGS ('dbx_business_glossary_term' = 'Brand Restriction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_category` SET TAGS ('dbx_business_glossary_term' = 'Reward Category');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `category_restriction` SET TAGS ('dbx_business_glossary_term' = 'Category Restriction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `channel_availability` SET TAGS ('dbx_business_glossary_term' = 'Channel Availability');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_code` SET TAGS ('dbx_business_glossary_term' = 'Reward Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,20}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `cost_to_business` SET TAGS ('dbx_business_glossary_term' = 'Cost to Business');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `cost_to_business` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `created_by_user` SET TAGS ('dbx_business_glossary_term' = 'Created By User');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `discount_type` SET TAGS ('dbx_business_glossary_term' = 'Discount Type');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `discount_value` SET TAGS ('dbx_business_glossary_term' = 'Discount Value');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `display_priority` SET TAGS ('dbx_business_glossary_term' = 'Display Priority');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `eligible_member_tiers` SET TAGS ('dbx_business_glossary_term' = 'Eligible Member Tiers');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `geographic_restriction` SET TAGS ('dbx_business_glossary_term' = 'Geographic Restriction');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `margin_percentage` SET TAGS ('dbx_business_glossary_term' = 'Margin Percentage');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `margin_percentage` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `maximum_discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Maximum Discount Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `minimum_purchase_amount` SET TAGS ('dbx_business_glossary_term' = 'Minimum Purchase Amount');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_name` SET TAGS ('dbx_business_glossary_term' = 'Reward Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `points_cost` SET TAGS ('dbx_business_glossary_term' = 'Points Cost');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `quantity_available` SET TAGS ('dbx_business_glossary_term' = 'Quantity Available');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `quantity_limit_per_member` SET TAGS ('dbx_business_glossary_term' = 'Quantity Limit Per Member');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `redemption_validity_days` SET TAGS ('dbx_business_glossary_term' = 'Redemption Validity Days');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_status` SET TAGS ('dbx_business_glossary_term' = 'Reward Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `reward_type` SET TAGS ('dbx_business_glossary_term' = 'Reward Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `terms_and_conditions` SET TAGS ('dbx_business_glossary_term' = 'Terms and Conditions');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `updated_by_user` SET TAGS ('dbx_business_glossary_term' = 'Updated By User');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`reward` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` SET TAGS ('dbx_subdomain' = 'member_engagement');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `redemption_id` SET TAGS ('dbx_business_glossary_term' = 'Redemption ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Marketing Campaign ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Member ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `member_offer_id` SET TAGS ('dbx_business_glossary_term' = 'Offer ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `partner_program_id` SET TAGS ('dbx_business_glossary_term' = 'Partner Organization ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`redemption` ALTER COLUMN `redemption_type` SET TAGS ('dbx_business_glossary_term' = 'Redemption Type');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `member_offer_id` SET TAGS ('dbx_business_glossary_term' = 'Member Offer ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Member ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `member_segment_id` SET TAGS ('dbx_business_glossary_term' = 'Segment ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `product_brand_id` SET TAGS ('dbx_business_glossary_term' = 'Product Brand Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `promo_offer_id` SET TAGS ('dbx_business_glossary_term' = 'Promo Offer Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `reward_id` SET TAGS ('dbx_business_glossary_term' = 'Reward Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `sku_id` SET TAGS ('dbx_business_glossary_term' = 'Sku Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `storefront_id` SET TAGS ('dbx_business_glossary_term' = 'Storefront Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `cluster_id` SET TAGS ('dbx_business_glossary_term' = 'Target Store Cluster Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `activation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Activation Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `bonus_points_amount` SET TAGS ('dbx_business_glossary_term' = 'Bonus Points Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `channel_applicability` SET TAGS ('dbx_business_glossary_term' = 'Channel Applicability');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `discount_type` SET TAGS ('dbx_business_glossary_term' = 'Discount Type');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `discount_value` SET TAGS ('dbx_business_glossary_term' = 'Discount Value');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `eligible_product_category` SET TAGS ('dbx_business_glossary_term' = 'Eligible Product Category');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `end_date` SET TAGS ('dbx_business_glossary_term' = 'Offer End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `estimated_liability_amount` SET TAGS ('dbx_business_glossary_term' = 'Estimated Liability Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `estimated_liability_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `excluded_product_category` SET TAGS ('dbx_business_glossary_term' = 'Excluded Product Category');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `expiration_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Expiration Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `minimum_quantity` SET TAGS ('dbx_business_glossary_term' = 'Minimum Quantity');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `minimum_spend_amount` SET TAGS ('dbx_business_glossary_term' = 'Minimum Spend Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `modified_by` SET TAGS ('dbx_business_glossary_term' = 'Modified By');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_code` SET TAGS ('dbx_business_glossary_term' = 'Offer Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,20}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_description` SET TAGS ('dbx_business_glossary_term' = 'Offer Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_name` SET TAGS ('dbx_business_glossary_term' = 'Offer Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_source` SET TAGS ('dbx_business_glossary_term' = 'Offer Source');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_status` SET TAGS ('dbx_business_glossary_term' = 'Offer Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_type` SET TAGS ('dbx_business_glossary_term' = 'Offer Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `offer_type` SET TAGS ('dbx_value_regex' = 'bonus_points|discount|free_item|early_access|experiential_reward|tier_upgrade');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `personalization_score` SET TAGS ('dbx_business_glossary_term' = 'Personalization Score');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `points_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Points Multiplier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `presentation_priority` SET TAGS ('dbx_business_glossary_term' = 'Presentation Priority');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `presentation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Presentation Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `redemption_count` SET TAGS ('dbx_business_glossary_term' = 'Redemption Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `redemption_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Redemption Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `start_date` SET TAGS ('dbx_business_glossary_term' = 'Offer Start Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `terms_and_conditions` SET TAGS ('dbx_business_glossary_term' = 'Terms and Conditions');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `trigger_type` SET TAGS ('dbx_business_glossary_term' = 'Trigger Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_offer` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` SET TAGS ('dbx_subdomain' = 'campaign_deployment');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `engagement_campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Engagement Campaign ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `member_segment_id` SET TAGS ('dbx_business_glossary_term' = 'Member Segment ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `actual_enrollment_count` SET TAGS ('dbx_business_glossary_term' = 'Actual Enrollment Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `actual_incremental_spend_amount` SET TAGS ('dbx_business_glossary_term' = 'Actual Incremental Spend Amount');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `actual_participation_count` SET TAGS ('dbx_business_glossary_term' = 'Actual Participation Count');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `actual_tier_upgrade_count` SET TAGS ('dbx_business_glossary_term' = 'Actual Tier Upgrade Count');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_business_glossary_term' = 'Approved By Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `bonus_points_amount` SET TAGS ('dbx_business_glossary_term' = 'Bonus Points Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_code` SET TAGS ('dbx_business_glossary_term' = 'Campaign Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{4,20}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_description` SET TAGS ('dbx_business_glossary_term' = 'Campaign Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_name` SET TAGS ('dbx_business_glossary_term' = 'Campaign Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_status` SET TAGS ('dbx_business_glossary_term' = 'Campaign Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `campaign_type` SET TAGS ('dbx_business_glossary_term' = 'Campaign Type');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `channel_email_flag` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `end_date` SET TAGS ('dbx_business_glossary_term' = 'Campaign End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `expected_enrollment_count` SET TAGS ('dbx_business_glossary_term' = 'Expected Enrollment Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `expected_participation_count` SET TAGS ('dbx_business_glossary_term' = 'Expected Participation Count');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `personalization_enabled_flag` SET TAGS ('dbx_business_glossary_term' = 'Personalization Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `points_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Points Multiplier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `qualifying_spend_threshold` SET TAGS ('dbx_business_glossary_term' = 'Qualifying Spend Threshold');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `qualifying_transaction_count` SET TAGS ('dbx_business_glossary_term' = 'Qualifying Transaction Count');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `target_incremental_spend_amount` SET TAGS ('dbx_business_glossary_term' = 'Target Incremental Spend Amount');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`engagement_campaign` ALTER COLUMN `target_tier_upgrade_count` SET TAGS ('dbx_business_glossary_term' = 'Target Tier Upgrade Count');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `clienteling_interaction_id` SET TAGS ('dbx_business_glossary_term' = 'Clienteling Interaction ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Associate ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `bopis_appointment_id` SET TAGS ('dbx_business_glossary_term' = 'Bopis Appointment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Store Department Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Order Header Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Store ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Member ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `member_offer_id` SET TAGS ('dbx_business_glossary_term' = 'Offer Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `pos_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Transaction ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `profile_id` SET TAGS ('dbx_business_glossary_term' = 'Customer ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `web_session_id` SET TAGS ('dbx_business_glossary_term' = 'Web Session Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `appointment_scheduled_flag` SET TAGS ('dbx_business_glossary_term' = 'Appointment Scheduled Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `customer_sentiment` SET TAGS ('dbx_business_glossary_term' = 'Customer Sentiment');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `customer_sentiment` SET TAGS ('dbx_value_regex' = 'very_positive|positive|neutral|negative|very_negative');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `follow_up_action_required` SET TAGS ('dbx_business_glossary_term' = 'Follow-Up Action Required Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `follow_up_action_type` SET TAGS ('dbx_business_glossary_term' = 'Follow-Up Action Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `follow_up_completed_flag` SET TAGS ('dbx_business_glossary_term' = 'Follow-Up Completed Flag');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_channel` SET TAGS ('dbx_business_glossary_term' = 'Interaction Channel');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_date` SET TAGS ('dbx_business_glossary_term' = 'Interaction Date');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_initiated_by` SET TAGS ('dbx_business_glossary_term' = 'Interaction Initiated By');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_location_type` SET TAGS ('dbx_business_glossary_term' = 'Interaction Location Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_notes` SET TAGS ('dbx_business_glossary_term' = 'Interaction Notes');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_notes` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_number` SET TAGS ('dbx_business_glossary_term' = 'Interaction Number');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_outcome` SET TAGS ('dbx_business_glossary_term' = 'Interaction Outcome');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_status` SET TAGS ('dbx_business_glossary_term' = 'Interaction Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Interaction Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `interaction_type` SET TAGS ('dbx_business_glossary_term' = 'Interaction Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `member_preferences_discussed` SET TAGS ('dbx_business_glossary_term' = 'Member Preferences Discussed');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `next_appointment_date` SET TAGS ('dbx_business_glossary_term' = 'Next Appointment Date');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `products_purchased` SET TAGS ('dbx_business_glossary_term' = 'Products Purchased');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `products_recommended` SET TAGS ('dbx_business_glossary_term' = 'Products Recommended');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `purchase_made_flag` SET TAGS ('dbx_business_glossary_term' = 'Purchase Made Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `total_interaction_value_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Interaction Value Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`clienteling_interaction` ALTER COLUMN `vip_tier_at_interaction` SET TAGS ('dbx_business_glossary_term' = 'VIP Tier at Interaction');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `member_segment_id` SET TAGS ('dbx_business_glossary_term' = 'Member Segment ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `audience_segment_id` SET TAGS ('dbx_business_glossary_term' = 'Marketing Audience Segment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Segment Owner Associate Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By User');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approved Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `assignment_method` SET TAGS ('dbx_business_glossary_term' = 'Assignment Method');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `assignment_method` SET TAGS ('dbx_value_regex' = 'rule_based|ml_model|manual|hybrid');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `average_annual_spend` SET TAGS ('dbx_business_glossary_term' = 'Average Annual Spend');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `average_ltv` SET TAGS ('dbx_business_glossary_term' = 'Average Customer Lifetime Value (CLTV)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `average_points_balance` SET TAGS ('dbx_business_glossary_term' = 'Average Points Balance');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `business_justification` SET TAGS ('dbx_business_glossary_term' = 'Business Justification');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `campaign_eligibility_flag` SET TAGS ('dbx_business_glossary_term' = 'Campaign Eligibility Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `definition_criteria` SET TAGS ('dbx_business_glossary_term' = 'Definition Criteria');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `is_exclusive` SET TAGS ('dbx_business_glossary_term' = 'Is Exclusive Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `last_refresh_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Refresh Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `lifecycle_stage` SET TAGS ('dbx_business_glossary_term' = 'Lifecycle Stage');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `member_count` SET TAGS ('dbx_business_glossary_term' = 'Member Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `minimum_confidence_score` SET TAGS ('dbx_business_glossary_term' = 'Minimum Confidence Score');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `ml_model_reference` SET TAGS ('dbx_business_glossary_term' = 'Machine Learning (ML) Model Reference');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `ml_model_version` SET TAGS ('dbx_business_glossary_term' = 'Machine Learning (ML) Model Version');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `modified_by` SET TAGS ('dbx_business_glossary_term' = 'Modified By User');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `next_refresh_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Next Refresh Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Segment Notes');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `offer_eligibility_flag` SET TAGS ('dbx_business_glossary_term' = 'Offer Eligibility Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `priority_rank` SET TAGS ('dbx_business_glossary_term' = 'Priority Rank');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_business_glossary_term' = 'Refresh Frequency');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_code` SET TAGS ('dbx_business_glossary_term' = 'Segment Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_description` SET TAGS ('dbx_business_glossary_term' = 'Segment Description');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_name` SET TAGS ('dbx_business_glossary_term' = 'Segment Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_status` SET TAGS ('dbx_business_glossary_term' = 'Segment Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_status` SET TAGS ('dbx_value_regex' = 'active|inactive|archived|draft|pending_approval');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_type` SET TAGS ('dbx_business_glossary_term' = 'Segment Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `segment_type` SET TAGS ('dbx_value_regex' = 'rfm_based|spend_based|lifecycle_stage|engagement_based|redemption_behavior|channel_preference');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `tags` SET TAGS ('dbx_business_glossary_term' = 'Segment Tags');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `target_member_count` SET TAGS ('dbx_business_glossary_term' = 'Target Member Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `tier_qualification_flag` SET TAGS ('dbx_business_glossary_term' = 'Tier Qualification Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`member_segment` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By User');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` SET TAGS ('dbx_subdomain' = 'partner_coalition');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_program_id` SET TAGS ('dbx_business_glossary_term' = 'Partner Program ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `api_endpoint_url` SET TAGS ('dbx_business_glossary_term' = 'API Endpoint URL');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `api_endpoint_url` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `auto_enrollment_flag` SET TAGS ('dbx_business_glossary_term' = 'Auto Enrollment Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `contract_renewal_date` SET TAGS ('dbx_business_glossary_term' = 'Contract Renewal Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `cost_per_point_earned` SET TAGS ('dbx_business_glossary_term' = 'Cost Per Point Earned');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `cost_per_point_earned` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `data_sharing_agreement_reference` SET TAGS ('dbx_business_glossary_term' = 'Data Sharing Agreement Reference');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `earn_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Earn Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `earn_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `earn_rate_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Earn Rate Multiplier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `exclusion_rules` SET TAGS ('dbx_business_glossary_term' = 'Exclusion Rules');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `geographic_scope` SET TAGS ('dbx_business_glossary_term' = 'Geographic Scope');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `integration_method` SET TAGS ('dbx_business_glossary_term' = 'Integration Method');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `last_reconciliation_date` SET TAGS ('dbx_business_glossary_term' = 'Last Reconciliation Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `maximum_earn_per_transaction` SET TAGS ('dbx_business_glossary_term' = 'Maximum Earn Per Transaction');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `member_communication_allowed_flag` SET TAGS ('dbx_business_glossary_term' = 'Member Communication Allowed Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `member_eligibility_criteria` SET TAGS ('dbx_business_glossary_term' = 'Member Eligibility Criteria');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `minimum_transaction_amount` SET TAGS ('dbx_business_glossary_term' = 'Minimum Transaction Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `modified_by_user` SET TAGS ('dbx_business_glossary_term' = 'Modified By User');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_contact_email` SET TAGS ('dbx_business_glossary_term' = 'Partner Contact Email');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_contact_name` SET TAGS ('dbx_business_glossary_term' = 'Partner Contact Name');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_contact_phone` SET TAGS ('dbx_business_glossary_term' = 'Partner Contact Phone');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_contact_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_name` SET TAGS ('dbx_business_glossary_term' = 'Partner Name');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `partner_type` SET TAGS ('dbx_business_glossary_term' = 'Partner Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `performance_sla_target` SET TAGS ('dbx_business_glossary_term' = 'Performance SLA Target');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `promotional_bonus_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Promotional Bonus Eligible Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `redeem_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Redeem Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `redeem_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `redeem_rate_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Redeem Rate Multiplier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `revenue_per_point_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Revenue Per Point Redeemed');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `settlement_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Settlement Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `settlement_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `settlement_frequency` SET TAGS ('dbx_business_glossary_term' = 'Settlement Frequency');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_program` ALTER COLUMN `termination_notice_days` SET TAGS ('dbx_business_glossary_term' = 'Termination Notice Days');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` SET TAGS ('dbx_subdomain' = 'partner_coalition');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `partner_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Partner Transaction ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Member ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `original_transaction_partner_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Original Transaction ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `partner_program_id` SET TAGS ('dbx_business_glossary_term' = 'Partner Program ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `gl_account_id` SET TAGS ('dbx_business_glossary_term' = 'Settlement Gl Account Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `amount` SET TAGS ('dbx_business_glossary_term' = 'Partner Transaction Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `bonus_points` SET TAGS ('dbx_business_glossary_term' = 'Bonus Points');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `commission_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Commission Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `dispute_flag` SET TAGS ('dbx_business_glossary_term' = 'Dispute Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `dispute_reason` SET TAGS ('dbx_business_glossary_term' = 'Dispute Reason');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `member_tier_at_transaction` SET TAGS ('dbx_business_glossary_term' = 'Member Tier at Transaction');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `partner_category` SET TAGS ('dbx_business_glossary_term' = 'Partner Category');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `partner_commission_amount` SET TAGS ('dbx_business_glossary_term' = 'Partner Commission Amount');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `partner_location_code` SET TAGS ('dbx_business_glossary_term' = 'Partner Location Code');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `points_awarded` SET TAGS ('dbx_business_glossary_term' = 'Points Awarded');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `points_expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Points Expiry Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `points_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Points Multiplier');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `points_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Points Redeemed');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `reconciliation_date` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `reconciliation_status` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Status');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `reference` SET TAGS ('dbx_business_glossary_term' = 'Partner Transaction Reference Number');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `reversal_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Reversal Reason Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `reversal_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Reversal Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `settlement_batch_number` SET TAGS ('dbx_business_glossary_term' = 'Settlement Batch ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `settlement_date` SET TAGS ('dbx_business_glossary_term' = 'Settlement Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_channel` SET TAGS ('dbx_business_glossary_term' = 'Transaction Channel');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_channel` SET TAGS ('dbx_value_regex' = 'in_store|online|mobile_app|call_center|kiosk');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Transaction Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_date` SET TAGS ('dbx_business_glossary_term' = 'Transaction Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_status` SET TAGS ('dbx_business_glossary_term' = 'Transaction Processing Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_status` SET TAGS ('dbx_value_regex' = 'pending|confirmed|rejected|cancelled');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Transaction Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_type` SET TAGS ('dbx_business_glossary_term' = 'Transaction Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `transaction_type` SET TAGS ('dbx_value_regex' = 'earn|redemption|reversal|adjustment');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`partner_transaction` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` SET TAGS ('dbx_subdomain' = 'member_engagement');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referral_id` SET TAGS ('dbx_business_glossary_term' = 'Referral Identifier (ID)');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Associate Identifier (ID)');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `originating_referral_id` SET TAGS ('dbx_business_glossary_term' = 'Originating Referral Id');
...
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `channel` SET TAGS ('dbx_business_glossary_term' = 'Referral Channel');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referral_code` SET TAGS ('dbx_business_glossary_term' = 'Referral Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referral_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,12}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `conversion_status` SET TAGS ('dbx_business_glossary_term' = 'Conversion Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `conversion_status` SET TAGS ('dbx_value_regex' = 'pending|enrolled|qualified|rewarded|expired|declined');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `enrollment_date` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Expiry Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `first_purchase_amount` SET TAGS ('dbx_business_glossary_term' = 'First Purchase Amount');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `first_purchase_currency_code` SET TAGS ('dbx_business_glossary_term' = 'First Purchase Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `first_purchase_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `first_purchase_date` SET TAGS ('dbx_business_glossary_term' = 'First Purchase Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `fraud_detection_score` SET TAGS ('dbx_business_glossary_term' = 'Fraud Detection Score');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `fraud_flag` SET TAGS ('dbx_business_glossary_term' = 'Fraud Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Referral Notes');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `qualification_criteria` SET TAGS ('dbx_business_glossary_term' = 'Qualification Criteria');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `qualification_date` SET TAGS ('dbx_business_glossary_term' = 'Qualification Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `qualification_met_flag` SET TAGS ('dbx_business_glossary_term' = 'Qualification Met Flag');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referee_reward_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Referee Reward Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referee_reward_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referee_reward_date` SET TAGS ('dbx_business_glossary_term' = 'Referee Reward Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referee_reward_type` SET TAGS ('dbx_business_glossary_term' = 'Referee Reward Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referee_reward_type` SET TAGS ('dbx_value_regex' = 'welcome_bonus|bonus_points|discount_voucher|gift_card|free_shipping|merchandise');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referee_reward_value` SET TAGS ('dbx_business_glossary_term' = 'Referee Reward Value');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referral_date` SET TAGS ('dbx_business_glossary_term' = 'Referral Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referral_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Referral Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referrer_reward_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Referrer Reward Currency Code');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referrer_reward_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referrer_reward_date` SET TAGS ('dbx_business_glossary_term' = 'Referrer Reward Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referrer_reward_type` SET TAGS ('dbx_business_glossary_term' = 'Referrer Reward Type');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referrer_reward_type` SET TAGS ('dbx_value_regex' = 'bonus_points|tier_credit|gift_card|discount_voucher|cash_back|merchandise');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `referrer_reward_value` SET TAGS ('dbx_business_glossary_term' = 'Referrer Reward Value');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `source` SET TAGS ('dbx_business_glossary_term' = 'Referral Source');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`referral` ALTER COLUMN `viral_coefficient_contribution` SET TAGS ('dbx_business_glossary_term' = 'Viral Coefficient Contribution');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` SET TAGS ('dbx_subdomain' = 'campaign_deployment');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` SET TAGS ('dbx_association_edges' = 'loyalty.engagement_campaign,ecommerce.storefront');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `campaign_storefront_deployment_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Storefront Deployment ID');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `engagement_campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Storefront Deployment - Engagement Campaign Id');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Storefront Deployment - Storefront Id');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `deployment_status` SET TAGS ('dbx_business_glossary_term' = 'Deployment Status');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_budget_allocation` SET TAGS ('dbx_business_glossary_term' = 'Storefront Budget Allocation');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_conversion_rate` SET TAGS ('dbx_business_glossary_term' = 'Storefront Conversion Rate');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_end_date` SET TAGS ('dbx_business_glossary_term' = 'Storefront End Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_enrollment_count` SET TAGS ('dbx_business_glossary_term' = 'Storefront Enrollment Count');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_launch_date` SET TAGS ('dbx_business_glossary_term' = 'Storefront Launch Date');
ALTER TABLE `vibe_retail_v1`.`loyalty`.`campaign_storefront_deployment` ALTER COLUMN `storefront_participation_count` SET TAGS ('dbx_business_glossary_term' = 'Storefront Participation Count');
