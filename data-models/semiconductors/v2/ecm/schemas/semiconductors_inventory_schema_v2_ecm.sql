...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` (
    ...
    `fabrication_wafer_lot_id` BIGINT COMMENT 'SSOT FK reference to canonical fabrication.fabrication_wafer_lot; this table is a secondary view and must not duplicate master data.',
...
) COMMENT 'Master record for a wafer lot (batch of wafers) moving through the FAB as work-in-process inventory. Tracks lot ID, wafer count, process node, product code, lot type (production/engineering/qualification), priority class, current operation step, WIP status (active/hold/complete/scrapped), start date, target completion date, hold flags, cumulative scrap count, good wafer count, and MES lot reference. SSOT for WIP lot identity and traceability across FEOL, MOL, and BEOL process stages within the inventory domain. References SSOT: fabrication.fabrication_wafer_lot';
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`raw_material` (
    ...
    `unit_of_measure_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`die_bank` (
    ...
    `primary_storage_location_id` BIGINT COMMENT 'FK to inventory.storage_location.storage_location_id — Die banks are stored at specific locations (cleanroom storage, cold storage). Location tracking is critical for environmental compliance and retrieval.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` (
    ...
    `storage_location_id` BIGINT COMMENT 'FK to inventory.storage_location.storage_location_id — High-value photomasks must track their storage location for retrieval and environmental control.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`stock_balance` (
    ...
    `storage_location_id` BIGINT COMMENT 'FK to inventory.storage_location.storage_location_id — Stock balance is always held AT a specific storage location. This is a fundamental dimension of inventory position — you cannot have a meaningful stock balance without knowing WHERE the stock is. Day-',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` (
    ...
    `fabrication_lot_hold_id` BIGINT COMMENT 'SSOT FK reference to canonical fabrication.fabrication_lot_hold; this table is a secondary view and must not duplicate master data.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_kgd_certification` (
    ...
    `quality_kgd_certification_id` BIGINT COMMENT 'Foreign key to SSOT quality.quality_kgd_certification establishing single source of truth',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` (
    ...
    `fabrication_lot_genealogy_id` BIGINT COMMENT 'SSOT FK reference to canonical fabrication.fabrication_lot_genealogy; this table is a secondary view and must not duplicate master data.',
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`die_bank` ADD CONSTRAINT `fk_inventory_die_bank_primary_storage_location_id` FOREIGN KEY (`primary_storage_location_id`) REFERENCES `vibe_semiconductors_v1`.`inventory`.`storage_location`(`storage_location_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` SET TAGS ('dbx_subdomain' = 'lot_tracking');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` SET TAGS ('dbx_ssot' = 'secondary');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `fab_run_card_id` SET TAGS ('dbx_business_glossary_term' = 'Run Card Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `fabrication_wafer_lot_id` SET TAGS ('dbx_ssot_reference' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `primary_inventory_fabrication_wafer_lot_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `wafer_start_authorization_id` SET TAGS ('dbx_business_glossary_term' = 'Wafer Start Authorization ID');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `work_center_id` SET TAGS ('dbx_business_glossary_term' = 'Work Center ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_wafer_lot` ALTER COLUMN `storage_location_code` SET TAGS ('dbx_business_glossary_term' = 'Storage Location Code');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`raw_material` SET TAGS ('dbx_subdomain' = 'material_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`finished_good` SET TAGS ('dbx_subdomain' = 'material_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`die_bank` SET TAGS ('dbx_subdomain' = 'lot_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`die_bank` ALTER COLUMN `primary_storage_location_id` SET TAGS ('dbx_business_glossary_term' = 'Die Storage Location Fk');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`die_bank` ALTER COLUMN `wafer_lot_origin_fk` SET TAGS ('dbx_business_glossary_term' = 'Wafer Lot Origin Fk');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` SET TAGS ('dbx_subdomain' = 'material_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` ALTER COLUMN `storage_location_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Storage Location Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`photomask_asset` ALTER COLUMN `mask_set_name` SET TAGS ('dbx_business_glossary_term' = 'Photomask Set Name');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`storage_location` SET TAGS ('dbx_subdomain' = 'stock_control');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_balance` SET TAGS ('dbx_subdomain' = 'stock_control');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_balance` ALTER COLUMN `material_master_id` SET TAGS ('dbx_business_glossary_term' = 'Material ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_balance` ALTER COLUMN `storage_location_id` SET TAGS ('dbx_business_glossary_term' = 'Stock Storage Location Fk');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`goods_movement` SET TAGS ('dbx_subdomain' = 'stock_control');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`goods_movement` ALTER COLUMN `storage_location_id` SET TAGS ('dbx_business_glossary_term' = 'Storage Location Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`goods_movement` ALTER COLUMN `material_master_id` SET TAGS ('dbx_business_glossary_term' = 'Material ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` SET TAGS ('dbx_subdomain' = 'lot_tracking');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` SET TAGS ('dbx_ssot' = 'secondary');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` ALTER COLUMN `fabrication_lot_hold_id` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` ALTER COLUMN `fabrication_lot_hold_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Hold Initiator ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`physical_inventory` SET TAGS ('dbx_subdomain' = 'stock_control');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`physical_inventory` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Counter Employee ID');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`physical_inventory` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`physical_inventory` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`consignment_stock` SET TAGS ('dbx_subdomain' = 'stock_control');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`consignment_stock` ALTER COLUMN `sku_code` SET TAGS ('dbx_business_glossary_term' = 'Stock Keeping Unit (SKU) Code');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_valuation` SET TAGS ('dbx_subdomain' = 'financial_valuation');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_valuation` ALTER COLUMN `channel_partner_id` SET TAGS ('dbx_business_glossary_term' = 'Outsourced Semiconductor Assembly and Test (OSAT) Partner ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`stock_valuation` ALTER COLUMN `wafer_lot_fk` SET TAGS ('dbx_business_glossary_term' = 'Wafer Lot Fk');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_kgd_certification` SET TAGS ('dbx_subdomain' = 'lot_tracking');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_kgd_certification` SET TAGS ('dbx_ssot' = 'quality.quality_kgd_certification');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_kgd_certification` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Certifying Engineer ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_kgd_certification` ALTER COLUMN `quality_kgd_certification_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` SET TAGS ('dbx_subdomain' = 'lot_tracking');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` SET TAGS ('dbx_ssot' = 'secondary');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` ALTER COLUMN `fabrication_lot_genealogy_id` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` ALTER COLUMN `fabrication_lot_genealogy_id` SET TAGS ('dbx_ssot_ref' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`inventory_lot_genealogy` ALTER COLUMN `inventory_wafer_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Inventory Wafer Lot Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`reservation` SET TAGS ('dbx_subdomain' = 'financial_valuation');
...
ALTER TABLE `vibe_semiconductors_v1`.`inventory`.`reservation` ALTER COLUMN `storage_location_code` SET TAGS ('dbx_business_glossary_term' = 'Storage Location Code');
