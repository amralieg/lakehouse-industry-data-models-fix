...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` (
    `assembly_order_extended_id` BIGINT COMMENT '',
    `assembly_order_id` BIGINT COMMENT '',
    ...
    CONSTRAINT pk_assembly_order_extended PRIMARY KEY(`assembly_order_extended_id`)
) COMMENT '';
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`inspection_result` (
    ...
    `assembly_lot_id` BIGINT COMMENT 'FK to packaging.assembly_lot.assembly_lot_id — Inspection results are recorded per lot at each inspection gate. Required for lot release decisions.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` (
    ...
    `osat_vendor_id` BIGINT COMMENT 'add column osat_vendor_id (BIGINT) with FK to packaging.osat_vendor.osat_vendor_id - packaging lines operate at OSAT vendors but currently only link to fabrication.plant',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` (
    ...
    `employee_id` BIGINT COMMENT 'add column owner_employee_id (BIGINT) with FK to workforce.employee.employee_id - qualification plans need responsible owners',
    `package_type_id` BIGINT COMMENT 'FK to packaging.package_type',
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ADD CONSTRAINT `fk_packaging_assembly_order_extended_assembly_order_id` FOREIGN KEY (`assembly_order_id`) REFERENCES `vibe_semiconductors_v1`.`packaging`.`assembly_order`(`assembly_order_id`);
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ADD CONSTRAINT `fk_packaging_assembly_order_extended_packaging_line_id` FOREIGN KEY (`packaging_line_id`) REFERENCES `vibe_semiconductors_v1`.`packaging`.`packaging_line`(`packaging_line_id`);
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ADD CONSTRAINT `fk_packaging_assembly_order_extended_osat_vendor_id` FOREIGN KEY (`osat_vendor_id`) REFERENCES `vibe_semiconductors_v1`.`packaging`.`osat_vendor`(`osat_vendor_id`);
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ADD CONSTRAINT `fk_packaging_assembly_order_extended_package_type_id` FOREIGN KEY (`package_type_id`) REFERENCES `vibe_semiconductors_v1`.`packaging`.`package_type`(`package_type_id`);
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ADD CONSTRAINT `fk_packaging_assembly_order_extended_assembly_process_flow_id` FOREIGN KEY (`assembly_process_flow_id`) REFERENCES `vibe_semiconductors_v1`.`packaging`.`assembly_process_flow`(`assembly_process_flow_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Order Owner Employee Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `packaging_line_id` SET TAGS ('dbx_business_glossary_term' = 'Packaging Line Identifier (PLI)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `price_agreement_id` SET TAGS ('dbx_business_glossary_term' = 'Price Agreement Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `osat_vendor_id` SET TAGS ('dbx_business_glossary_term' = 'OSAT Partner Identifier (OPID)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `package_type_id` SET TAGS ('dbx_business_glossary_term' = 'Assembly Package Type Id');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `assembly_process_flow_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Assembly Process Flow Id');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `process_flow_id` SET TAGS ('dbx_business_glossary_term' = 'Process Process Flow Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `purchase_order_id` SET TAGS ('dbx_business_glossary_term' = 'Purchase Order Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `quote_id` SET TAGS ('dbx_business_glossary_term' = 'Quote Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `order_id` SET TAGS ('dbx_business_glossary_term' = 'Sales Order Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `sku_id` SET TAGS ('dbx_business_glossary_term' = 'Sku Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `tapeout_id` SET TAGS ('dbx_business_glossary_term' = 'Tapeout Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_order_extended` ALTER COLUMN `test_program_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`package_type` ALTER COLUMN `package_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`osat_vendor` ALTER COLUMN `vendor_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`osat_vendor` ALTER COLUMN `vendor_short_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_process_flow` ALTER COLUMN `flow_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`substrate_bom` ALTER COLUMN `substrate_bom_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_lot` ALTER COLUMN `lot_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_defect` SET TAGS ('dbx_subdomain' = 'assembly_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`package_qualification` SET TAGS ('dbx_subdomain' = 'quality_reliability');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`reliability_stress_test` SET TAGS ('dbx_subdomain' = 'quality_reliability');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`material_lot` SET TAGS ('dbx_subdomain' = 'package_engineering');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`inspection_result` SET TAGS ('dbx_subdomain' = 'quality_reliability');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`inspection_result` ALTER COLUMN `assembly_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Assembly Lot Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Change Owner ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `package_type_id` SET TAGS ('dbx_business_glossary_term' = 'Package Type');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`assembly_change_notice` ALTER COLUMN `change_owner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` ALTER COLUMN `invoice_line_id` SET TAGS ('dbx_ssot_reference' = 'invoice.invoice_line');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`packaging_line` ALTER COLUMN `packaging_line_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` SET TAGS ('dbx_subdomain' = 'quality_reliability');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `osat_partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`packaging`.`qualification_plan` ALTER COLUMN `test_suite_name` SET TAGS ('dbx_pii_detected' = 'true');
