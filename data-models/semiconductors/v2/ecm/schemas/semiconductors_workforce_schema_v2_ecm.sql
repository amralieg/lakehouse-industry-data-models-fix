...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` (
    ...
    `skill_id` BIGINT COMMENT 'add column skill_id (BIGINT) with FK to workforce.skill.skill_id - workforce qualifications validate specific skills but currently only link to employee',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` (
    ...
    `supplier_id` BIGINT COMMENT 'add column supplier_id (BIGINT) with FK to supply.supplier.supplier_id - contractors are engaged through staffing suppliers but currently only links to org_unit',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` (
    ...
    `org_unit_id` BIGINT COMMENT 'add column org_unit_id (BIGINT) with FK to workforce.org_unit.org_unit_id - compensation plans apply to organizational units but currently only self-reference',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`job` (
    ...
    `org_unit_id` BIGINT COMMENT 'add column org_unit_id (BIGINT) with FK to workforce.org_unit.org_unit_id - jobs belong to organizational units in the HR hierarchy',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`shift_pattern` (
    ...
    `fab_site_id` BIGINT COMMENT 'add column fab_site_id (BIGINT) with FK to fabrication.fab_site.fab_site_id - shift patterns are site-specific for fab operations but currently only self-reference',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` (
    ...
    `skill_id` BIGINT COMMENT 'add column skill_id (BIGINT) with FK to workforce.skill.skill_id - training courses develop specific skills but currently only self-reference',
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` ADD CONSTRAINT `fk_workforce_compensation_plan_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`org_unit`(`org_unit_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`job` ADD CONSTRAINT `fk_workforce_job_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_semiconductors_v1`.`workforce`.`org_unit`(`org_unit_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`employee` SET TAGS ('dbx_subdomain' = 'personnel_records');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`position` SET TAGS ('dbx_subdomain' = 'personnel_records');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`position` ALTER COLUMN `job_code` SET TAGS ('dbx_business_glossary_term' = 'Job Code');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` SET TAGS ('dbx_subdomain' = 'personnel_records');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`org_unit` ALTER COLUMN `org_unit_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`competency` SET TAGS ('dbx_subdomain' = 'personnel_records');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` ALTER COLUMN `certification_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`workforce_qualification` ALTER COLUMN `trainer_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`talent_acquisition` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`talent_acquisition` ALTER COLUMN `job_profile_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation` ALTER COLUMN `compensation_plan_id` SET TAGS ('dbx_classification' = 'restricted');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`time_entry` SET TAGS ('dbx_subdomain' = 'compensation_benefits');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` ALTER COLUMN `certification_document_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` ALTER COLUMN `equipment_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`fab_operator_qualification` ALTER COLUMN `qualification_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`site_assignment` ALTER COLUMN `assignment_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` SET TAGS ('dbx_subdomain' = 'fab_operations');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`contractor_engagement` ALTER COLUMN `agency_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`export_control` SET TAGS ('dbx_subdomain' = 'safety_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`export_control` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`safety_event` SET TAGS ('dbx_subdomain' = 'safety_compliance');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`safety_event` ALTER COLUMN `lab_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`compensation_plan` ALTER COLUMN `compensation_plan_status` SET TAGS ('dbx_classification' = 'restricted');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`skill` SET TAGS ('dbx_subdomain' = 'personnel_records');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`skill` ALTER COLUMN `skill_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`job` SET TAGS ('dbx_subdomain' = 'personnel_records');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`shift_pattern` ALTER COLUMN `shift_pattern_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` SET TAGS ('dbx_subdomain' = 'talent_development');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` ALTER COLUMN `course_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`workforce`.`training_course` ALTER COLUMN `instructor_name` SET TAGS ('dbx_pii_detected' = 'true');
