...
-- Generated on: 2026-07-10 12:17:24
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`customer`.`segment` (
    ...
    `employee_id` BIGINT COMMENT 'add column owner_employee_id (BIGINT) with FK to workforce.employee.employee_id - segment is a lookup table with zero outbound FKs; adding ownership improves governance',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`customer`.`address` (
    ...
    `primary_address_account_id` BIGINT COMMENT 'FK to customer.account.account_id — Addresses are associated with customer accounts (ship-to, bill-to, HQ). This is a core master data relationship.',
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`address` ADD CONSTRAINT `fk_customer_address_primary_address_account_id` FOREIGN KEY (`primary_address_account_id`) REFERENCES `vibe_semiconductors_v1`.`customer`.`account`(`account_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`account` ALTER COLUMN `legal_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`account` ALTER COLUMN `account_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`contact` ALTER COLUMN `contact_id` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`contact` ALTER COLUMN `primary_contact_account_id` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`contact` ALTER COLUMN `contact_status` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`contact` ALTER COLUMN `is_key_contact` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`segment` ALTER COLUMN `segment_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`address` ALTER COLUMN `primary_address_account_id` SET TAGS ('dbx_business_glossary_term' = 'Address Account Id');
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`address` ALTER COLUMN `primary_address_account_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`address` ALTER COLUMN `primary_address_account_id` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`address` ALTER COLUMN `address_type` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_design_win` ALTER COLUMN `contact_id` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_design_win` ALTER COLUMN `design_project_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_design_registration` ALTER COLUMN `design_project_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`engagement_activity` ALTER COLUMN `contact_id` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`nda_agreement` ALTER COLUMN `legal_entity_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`account_team` ALTER COLUMN `primary_contact_flag` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`distributor_agreement` ALTER COLUMN `account_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Account Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`credit_profile` ALTER COLUMN `profile_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_sample_request` ALTER COLUMN `contact_id` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`price_agreement` SET TAGS ('dbx_subdomain' = 'account_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`customer_ltb_notification` SET TAGS ('dbx_subdomain' = 'design_engagement');
...
ALTER TABLE `vibe_semiconductors_v1`.`customer`.`tool_allocation` SET TAGS ('dbx_subdomain' = 'account_management');
