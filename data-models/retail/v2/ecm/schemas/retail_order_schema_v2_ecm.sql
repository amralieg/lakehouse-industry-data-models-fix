...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`header` (
    ...
    `location_id` BIGINT COMMENT 'Add column store_location_id (BIGINT) to store.header with FK to store.location.location_id because orders placed in-store must reference the originating store location. P20: connect_table: store.header** - add column store_location_id (BIG',
...
) COMMENT '[SSOT Owner] Authoritative source for order line items. Captures what the customer ordered including SKU, quantity, pricing, and tax details. The commercial record of the transaction.';
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`line_status_history` (
    ...
    `pos_transaction_id` BIGINT COMMENT 'The unique transaction or message identifier from the source system that triggered this status change. Enables end-to-end traceability and troubleshooting.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`payment` (
    ...
    `bnpl_provider` STRING COMMENT 'Free text; common values include klarna, affirm, afterpay, sezzle, etc.',
    ...
    `card_brand` STRING COMMENT 'Free text; common values include visa, mastercard, amex, discover, jcb, unionpay, maestro, diners, rupay, regional/store cards',
    ...
    `digital_wallet_type` STRING COMMENT 'Free text; common values include apple_pay, google_pay, paypal, samsung_pay, etc.. Valid values are `apple_pay|google_pay|samsung_pay|paypal|venmo|other`',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`cancellation` (
    ...
    `primary_cancellation_associate_id` BIGINT COMMENT 'Reference to the customer service agent or employee who processed or approved the cancellation. Null for system-initiated cancellations.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`hold` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`promise` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`order`.`subscription` (
    ...
    `payment_method_id` DECIMAL(18,2) COMMENT 'Reference to the stored payment method used for recurring subscription charges. Links to the customer payment method record.',
...
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ADD CONSTRAINT `fk_order_line_status_history_header_id` FOREIGN KEY (`header_id`) REFERENCES `vibe_retail_v1`.`order`.`header`(`header_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ADD CONSTRAINT `fk_order_line_status_history_order_line_id` FOREIGN KEY (`order_line_id`) REFERENCES `vibe_retail_v1`.`order`.`order_line`(`order_line_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ADD CONSTRAINT `fk_order_line_status_history_pos_transaction_id` FOREIGN KEY (`pos_transaction_id`) REFERENCES `vibe_retail_v1`.`order`.`pos_transaction`(`pos_transaction_id`);
...
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ADD CONSTRAINT `fk_order_hold_header_id` FOREIGN KEY (`header_id`) REFERENCES `vibe_retail_v1`.`order`.`header`(`header_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ADD CONSTRAINT `fk_order_hold_order_line_id` FOREIGN KEY (`order_line_id`) REFERENCES `vibe_retail_v1`.`order`.`order_line`(`order_line_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ADD CONSTRAINT `fk_order_hold_superseded_hold_id` FOREIGN KEY (`superseded_hold_id`) REFERENCES `vibe_retail_v1`.`order`.`hold`(`hold_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ADD CONSTRAINT `fk_order_promise_header_id` FOREIGN KEY (`header_id`) REFERENCES `vibe_retail_v1`.`order`.`header`(`header_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ADD CONSTRAINT `fk_order_promise_order_line_id` FOREIGN KEY (`order_line_id`) REFERENCES `vibe_retail_v1`.`order`.`order_line`(`order_line_id`);
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ADD CONSTRAINT `fk_order_promise_revised_promise_id` FOREIGN KEY (`revised_promise_id`) REFERENCES `vibe_retail_v1`.`order`.`promise`(`promise_id`);
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `actual_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Delivery Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `billing_city` SET TAGS ('dbx_business_glossary_term' = 'Billing City');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `billing_country_code` SET TAGS ('dbx_business_glossary_term' = 'Billing Country Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `billing_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Billing Postal Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `carrier_code` SET TAGS ('dbx_business_glossary_term' = 'Carrier Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `customer_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `customer_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Discount Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `grand_total_amount` SET TAGS ('dbx_business_glossary_term' = 'Grand Total Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `locale` SET TAGS ('dbx_business_glossary_term' = 'Locale');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `order_date` SET TAGS ('dbx_business_glossary_term' = 'Order Date');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `order_number` SET TAGS ('dbx_business_glossary_term' = 'Order Number');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `order_number` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{8,20}$');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `order_status` SET TAGS ('dbx_business_glossary_term' = 'Order Status');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `order_type` SET TAGS ('dbx_business_glossary_term' = 'Order Type');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payment Method');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `payment_status` SET TAGS ('dbx_business_glossary_term' = 'Payment Status');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `promised_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Promised Delivery Date');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `requested_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Requested Delivery Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `shipping_amount` SET TAGS ('dbx_business_glossary_term' = 'Shipping Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `shipping_city` SET TAGS ('dbx_business_glossary_term' = 'Shipping City');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `shipping_country_code` SET TAGS ('dbx_business_glossary_term' = 'Shipping Country Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `shipping_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Shipping Postal Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `special_instructions` SET TAGS ('dbx_business_glossary_term' = 'Special Instructions');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `subtotal_amount` SET TAGS ('dbx_business_glossary_term' = 'Subtotal Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `tracking_number` SET TAGS ('dbx_business_glossary_term' = 'Tracking Number');
ALTER TABLE `vibe_retail_v1`.`order`.`header` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` SET TAGS ('dbx_ssot_role' = 'authoritative');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` SET TAGS ('dbx_ssot_owner' = 'order.order_line');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` SET TAGS ('dbx_ssot_concept' = 'order_line');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `replenishment_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Replenishment Plan Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `actual_ship_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Ship Date');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `backorder_flag` SET TAGS ('dbx_business_glossary_term' = 'Backorder Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `cancellation_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `cancelled_quantity` SET TAGS ('dbx_business_glossary_term' = 'Cancelled Quantity');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `carrier_code` SET TAGS ('dbx_business_glossary_term' = 'Carrier Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Discount Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `expected_ship_date` SET TAGS ('dbx_business_glossary_term' = 'Expected Ship Date');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `extended_price` SET TAGS ('dbx_business_glossary_term' = 'Extended Price');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `fulfillment_method` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Method');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `gift_flag` SET TAGS ('dbx_business_glossary_term' = 'Gift Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `gift_message` SET TAGS ('dbx_business_glossary_term' = 'Gift Message');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `line_number` SET TAGS ('dbx_business_glossary_term' = 'Line Number');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `line_status` SET TAGS ('dbx_business_glossary_term' = 'Line Status');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `margin_amount` SET TAGS ('dbx_business_glossary_term' = 'Margin Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `margin_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `ordered_quantity` SET TAGS ('dbx_business_glossary_term' = 'Ordered Quantity');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `personalization_notes` SET TAGS ('dbx_business_glossary_term' = 'Personalization Notes');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `return_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Return Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `returned_quantity` SET TAGS ('dbx_business_glossary_term' = 'Returned Quantity');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `shipped_quantity` SET TAGS ('dbx_business_glossary_term' = 'Shipped Quantity');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `substitution_flag` SET TAGS ('dbx_business_glossary_term' = 'Substitution Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `tax_jurisdiction_code` SET TAGS ('dbx_business_glossary_term' = 'Tax Jurisdiction Code');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `tax_jurisdiction_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{2,5}$');
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `tax_rate` SET TAGS ('dbx_business_glossary_term' = 'Tax Rate');
...
ALTER TABLE `vibe_retail_v1`.`order`.`order_line` ALTER COLUMN `unit_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Unit Retail Price');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` SET TAGS ('dbx_subdomain' = 'order_management');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `actual_delivery_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Actual Delivery Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `assigned_to_team_code` SET TAGS ('dbx_business_glossary_term' = 'Assigned To Team Code');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `carrier_code` SET TAGS ('dbx_business_glossary_term' = 'Carrier Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `customer_notification_channel` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Channel');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `customer_notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Sent Flag');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `estimated_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Estimated Delivery Date');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `event_sequence_number` SET TAGS ('dbx_business_glossary_term' = 'Event Sequence Number');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `exception_category` SET TAGS ('dbx_business_glossary_term' = 'Exception Category');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `exception_flag` SET TAGS ('dbx_business_glossary_term' = 'Exception Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `fulfillment_node_type` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `order_type` SET TAGS ('dbx_business_glossary_term' = 'Order Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Priority Level');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `resolution_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Resolution Required Flag');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `source_order_channel` SET TAGS ('dbx_business_glossary_term' = 'Source Order Channel');
...
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `triggering_system_code` SET TAGS ('dbx_business_glossary_term' = 'Triggering System Code');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `triggering_user_name` SET TAGS ('dbx_business_glossary_term' = 'Triggering User Name');
ALTER TABLE `vibe_retail_v1`.`order`.`status_history` ALTER COLUMN `triggering_user_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `carrier_service_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Order ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `order_line_id` SET TAGS ('dbx_business_glossary_term' = 'Order Line ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `pos_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Source System Transaction ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Picker ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Shipment ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `tertiary_line_user_associate_id` SET TAGS ('dbx_business_glossary_term' = 'User ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `wave_id` SET TAGS ('dbx_business_glossary_term' = 'Warehouse Wave ID');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `actual_delivery_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Actual Delivery Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `carrier_service_level` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Level');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `carrier_service_level` SET TAGS ('dbx_value_regex' = 'standard|expedited|overnight|same_day|two_day|economy');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `current_status` SET TAGS ('dbx_business_glossary_term' = 'Current Line Status');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `estimated_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Estimated Delivery Date');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `exception_category` SET TAGS ('dbx_business_glossary_term' = 'Exception Category');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `exception_flag` SET TAGS ('dbx_business_glossary_term' = 'Exception Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `fulfillment_node_type` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node Type');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `fulfillment_node_type` SET TAGS ('dbx_value_regex' = 'distribution_center|store|dark_store|micro_fulfillment_center|vendor_direct|third_party_logistics');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `line_sequence_number` SET TAGS ('dbx_business_glossary_term' = 'Line Sequence Number');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Status Transition Notes');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `previous_status` SET TAGS ('dbx_business_glossary_term' = 'Previous Line Status');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `quantity_affected` SET TAGS ('dbx_business_glossary_term' = 'Quantity Affected by Status Change');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `record_created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `record_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `sku` SET TAGS ('dbx_business_glossary_term' = 'Stock Keeping Unit (SKU)');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `sku` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{8,14}$');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `sla_met_flag` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Met Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `sla_target_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Target Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `status_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Status Reason Code');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `status_reason_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{2,20}$');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `status_reason_description` SET TAGS ('dbx_business_glossary_term' = 'Status Reason Description');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `status_transition_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Status Transition Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `system_source` SET TAGS ('dbx_business_glossary_term' = 'System Source');
ALTER TABLE `vibe_retail_v1`.`order`.`line_status_history` ALTER COLUMN `tracking_number` SET TAGS ('dbx_business_glossary_term' = 'Shipment Tracking Number');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `pos_store_location_id` SET TAGS ('dbx_business_glossary_term' = 'Store Location Id');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `business_date` SET TAGS ('dbx_business_glossary_term' = 'Business Date');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `change_amount` SET TAGS ('dbx_business_glossary_term' = 'Change Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `coupon_count` SET TAGS ('dbx_business_glossary_term' = 'Coupon Count');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Discount Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `fiscal_receipt_number` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Receipt Number');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `fulfillment_type` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `item_count` SET TAGS ('dbx_business_glossary_term' = 'Item Count');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `loyalty_card_number` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Card Number');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `loyalty_card_number` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `loyalty_points_earned` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Points Earned');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `loyalty_points_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Points Redeemed');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `manager_override_flag` SET TAGS ('dbx_business_glossary_term' = 'Manager Override Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `payment_method_count` SET TAGS ('dbx_business_glossary_term' = 'Payment Method Count');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `primary_payment_method` SET TAGS ('dbx_business_glossary_term' = 'Primary Payment Method');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `promotion_count` SET TAGS ('dbx_business_glossary_term' = 'Promotion Count');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `receipt_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `receipt_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `register_number` SET TAGS ('dbx_business_glossary_term' = 'Register Number');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `return_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Return Reason Code');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `subtotal_amount` SET TAGS ('dbx_business_glossary_term' = 'Subtotal Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `tender_amount` SET TAGS ('dbx_business_glossary_term' = 'Tender Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `total_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `total_quantity` SET TAGS ('dbx_business_glossary_term' = 'Total Quantity');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `training_mode_flag` SET TAGS ('dbx_business_glossary_term' = 'Training Mode Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `transaction_number` SET TAGS ('dbx_business_glossary_term' = 'Transaction Number');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `transaction_status` SET TAGS ('dbx_business_glossary_term' = 'Transaction Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `transaction_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Transaction Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `transaction_type` SET TAGS ('dbx_business_glossary_term' = 'Transaction Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction` ALTER COLUMN `void_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Void Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor ID');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `category_code` SET TAGS ('dbx_business_glossary_term' = 'Category Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `coupon_code` SET TAGS ('dbx_business_glossary_term' = 'Coupon Code');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `coupon_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,20}$');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `department_code` SET TAGS ('dbx_business_glossary_term' = 'Department Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `extended_price` SET TAGS ('dbx_business_glossary_term' = 'Extended Price');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `fulfillment_type` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `item_description` SET TAGS ('dbx_business_glossary_term' = 'Item Description');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `line_number` SET TAGS ('dbx_business_glossary_term' = 'Line Number');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `loyalty_points_earned` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Points Earned');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `loyalty_points_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Points Redeemed');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `markdown_amount` SET TAGS ('dbx_business_glossary_term' = 'Markdown Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `net_line_amount` SET TAGS ('dbx_business_glossary_term' = 'Net Line Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `private_label_flag` SET TAGS ('dbx_business_glossary_term' = 'Private Label Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `promotion_code` SET TAGS ('dbx_business_glossary_term' = 'Promotion Code');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `promotion_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,20}$');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `quantity_sold` SET TAGS ('dbx_business_glossary_term' = 'Quantity Sold');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `return_flag` SET TAGS ('dbx_business_glossary_term' = 'Return Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `return_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Return Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `scanned_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Scanned Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `serial_number` SET TAGS ('dbx_business_glossary_term' = 'Serial Number');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `tax_code` SET TAGS ('dbx_business_glossary_term' = 'Tax Code');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `tax_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{1,10}$');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `tax_rate` SET TAGS ('dbx_business_glossary_term' = 'Tax Rate');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `total_line_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Line Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_business_glossary_term' = 'Unit of Measure');
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `unit_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Unit Retail Price');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `void_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Void Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `voided_flag` SET TAGS ('dbx_business_glossary_term' = 'Voided Flag');
...
ALTER TABLE `vibe_retail_v1`.`order`.`pos_transaction_line` ALTER COLUMN `weight_unit` SET TAGS ('dbx_business_glossary_term' = 'Weight Unit');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` SET TAGS ('dbx_subdomain' = 'payment_instruments');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `payment_id` SET TAGS ('dbx_business_glossary_term' = 'Payment ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `authorization_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Authorization Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_city` SET TAGS ('dbx_business_glossary_term' = 'Billing City');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_city` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_country_code` SET TAGS ('dbx_business_glossary_term' = 'Billing Country Code');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Billing Postal Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_postal_code` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `billing_state_province` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `capture_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Capture Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `card_brand` SET TAGS ('dbx_business_glossary_term' = 'Payment Card Brand');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `card_brand` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `card_expiry_month` SET TAGS ('dbx_business_glossary_term' = 'Card Expiry Month');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `card_expiry_year` SET TAGS ('dbx_business_glossary_term' = 'Card Expiry Year');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `cardholder_name` SET TAGS ('dbx_business_glossary_term' = 'Cardholder Name');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `cardholder_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `digital_wallet_type` SET TAGS ('dbx_business_glossary_term' = 'Digital Wallet Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `fraud_decision` SET TAGS ('dbx_business_glossary_term' = 'Fraud Decision');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `loyalty_points_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Points Redeemed');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `refund_amount` SET TAGS ('dbx_business_glossary_term' = 'Refund Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `refund_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Refund Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `settlement_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Settlement Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`payment` ALTER COLUMN `void_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Void Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` SET TAGS ('dbx_subdomain' = 'payment_instruments');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Member Identifier (ID)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Approved By User Identifier (ID)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `applied_at_level` SET TAGS ('dbx_business_glossary_term' = 'Applied At Level');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `applied_at_level` SET TAGS ('dbx_value_regex' = 'header|line');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `applied_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Applied Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `approval_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approval Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `discount_code` SET TAGS ('dbx_business_glossary_term' = 'Discount Code');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `discount_type` SET TAGS ('dbx_business_glossary_term' = 'Discount Type');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `final_price` SET TAGS ('dbx_business_glossary_term' = 'Final Price');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `loyalty_points_redeemed` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Points Redeemed');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `method` SET TAGS ('dbx_business_glossary_term' = 'Discount Method');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `original_price` SET TAGS ('dbx_business_glossary_term' = 'Original Price');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `priority_rank` SET TAGS ('dbx_business_glossary_term' = 'Priority Rank');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `stackable_flag` SET TAGS ('dbx_business_glossary_term' = 'Stackable Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `tax_treatment_flag` SET TAGS ('dbx_business_glossary_term' = 'Tax Treatment Flag');
...
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `taxable_amount_adjustment` SET TAGS ('dbx_business_glossary_term' = 'Taxable Amount Adjustment');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `valid_from_date` SET TAGS ('dbx_business_glossary_term' = 'Valid From Date');
ALTER TABLE `vibe_retail_v1`.`order`.`discount` ALTER COLUMN `valid_to_date` SET TAGS ('dbx_business_glossary_term' = 'Valid To Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancellation_id` SET TAGS ('dbx_business_glossary_term' = 'Cancellation ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `order_line_id` SET TAGS ('dbx_business_glossary_term' = 'Order Line ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `approval_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Approval Required Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `approval_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approval Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancellation_number` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Number');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancellation_number` SET TAGS ('dbx_value_regex' = '^CXL-[0-9]{10}$');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancellation_status` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancellation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancelled_amount` SET TAGS ('dbx_business_glossary_term' = 'Cancelled Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `cancelled_quantity` SET TAGS ('dbx_business_glossary_term' = 'Cancelled Quantity');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `customer_notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Sent Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `customer_notification_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `fraud_flag` SET TAGS ('dbx_business_glossary_term' = 'Fraud Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `fraud_score` SET TAGS ('dbx_business_glossary_term' = 'Fraud Score');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `inventory_release_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Inventory Release Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `inventory_released_flag` SET TAGS ('dbx_business_glossary_term' = 'Inventory Released Flag');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `refund_amount` SET TAGS ('dbx_business_glossary_term' = 'Refund Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `refund_currency_code` SET TAGS ('dbx_business_glossary_term' = 'Refund Currency Code');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `refund_currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `refund_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Refund Eligible Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `refund_method` SET TAGS ('dbx_business_glossary_term' = 'Refund Method');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `refund_processed_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Refund Processed Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `restocking_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Restocking Fee Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `reversal_flag` SET TAGS ('dbx_business_glossary_term' = 'Reversal Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `reversal_reason` SET TAGS ('dbx_business_glossary_term' = 'Reversal Reason');
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `reversal_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Reversal Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`cancellation` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` SET TAGS ('dbx_subdomain' = 'order_management');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `hold_id` SET TAGS ('dbx_business_glossary_term' = 'Order Hold Identifier (ID)');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned To User Identifier (ID)');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Order Identifier (ID)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `superseded_hold_id` SET TAGS ('dbx_business_glossary_term' = 'Superseded Hold Id');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `superseded_hold_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `address_verification_status` SET TAGS ('dbx_business_glossary_term' = 'Address Verification Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `assigned_to_team_code` SET TAGS ('dbx_business_glossary_term' = 'Assigned To Team Code');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `auto_release_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Auto Release Eligible Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `auto_release_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Auto Release Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `customer_notification_channel` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Channel');
...
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `customer_notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Sent Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `customer_notification_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `expected_resolution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Expected Resolution Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `fraud_decision` SET TAGS ('dbx_business_glossary_term' = 'Fraud Decision');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `fraud_decision` SET TAGS ('dbx_value_regex' = 'approve|decline|review|challenge');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `fraud_score` SET TAGS ('dbx_business_glossary_term' = 'Fraud Score');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `hold_number` SET TAGS ('dbx_business_glossary_term' = 'Hold Number');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `hold_status` SET TAGS ('dbx_business_glossary_term' = 'Hold Status');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `hold_status` SET TAGS ('dbx_value_regex' = 'active|resolved|expired|cancelled|escalated');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `hold_type` SET TAGS ('dbx_business_glossary_term' = 'Hold Type');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `manual_review_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Manual Review Required Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `payment_authorization_code` SET TAGS ('dbx_business_glossary_term' = 'Payment Authorization Code');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `payment_processor_response` SET TAGS ('dbx_business_glossary_term' = 'Payment Processor Response');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `pickup_expiration_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Pickup Expiration Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `pickup_ready_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Pickup Ready Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Priority Level');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `priority_level` SET TAGS ('dbx_value_regex' = 'low|medium|high|critical');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `reason_code` SET TAGS ('dbx_business_glossary_term' = 'Hold Reason Code');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `reason_description` SET TAGS ('dbx_business_glossary_term' = 'Hold Reason Description');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `resolution_action` SET TAGS ('dbx_business_glossary_term' = 'Resolution Action');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `resolution_action` SET TAGS ('dbx_value_regex' = 'released|cancelled|escalated|expired|manual_override');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `resolution_notes` SET TAGS ('dbx_business_glossary_term' = 'Resolution Notes');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `sla_breach_flag` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Breach Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `sla_target_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Target Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `source_system_hold_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Hold Identifier (ID)');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `start_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Hold Start Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`hold` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` SET TAGS ('dbx_subdomain' = 'order_management');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promise_id` SET TAGS ('dbx_business_glossary_term' = 'Order Promise ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node ID');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Order ID');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `order_line_id` SET TAGS ('dbx_business_glossary_term' = 'Order Line ID');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `revised_promise_id` SET TAGS ('dbx_business_glossary_term' = 'Revised Promise Id');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `actual_delivery_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Actual Delivery Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `calculation_engine_version` SET TAGS ('dbx_business_glossary_term' = 'Calculation Engine Version');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `carrier_service_level` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Level');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `confidence_score` SET TAGS ('dbx_business_glossary_term' = 'Promise Confidence Score');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Promise Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `customer_notification_channel` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Channel');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `customer_notification_channel` SET TAGS ('dbx_value_regex' = 'email|sms|push_notification|in_app|phone_call');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `customer_notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Sent Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `customer_notification_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `cutoff_time_applied` SET TAGS ('dbx_business_glossary_term' = 'Cutoff Time Applied');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `fulfillment_method` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Method');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `fulfillment_method` SET TAGS ('dbx_value_regex' = 'ship_to_home|bopis|ropis|ship_from_store|curbside_pickup|locker_pickup');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `inventory_availability_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Inventory Availability Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `last_revision_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Revision Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `order_channel` SET TAGS ('dbx_business_glossary_term' = 'Order Channel');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `peak_season_flag` SET TAGS ('dbx_business_glossary_term' = 'Peak Season Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promise_number` SET TAGS ('dbx_business_glossary_term' = 'Promise Number');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promise_status` SET TAGS ('dbx_business_glossary_term' = 'Promise Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promise_type` SET TAGS ('dbx_business_glossary_term' = 'Promise Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promised_delivery_date_end` SET TAGS ('dbx_business_glossary_term' = 'Promised Delivery Date End');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promised_delivery_date_start` SET TAGS ('dbx_business_glossary_term' = 'Promised Delivery Date Start');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promised_delivery_time_end` SET TAGS ('dbx_business_glossary_term' = 'Promised Delivery Time End');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `promised_delivery_time_start` SET TAGS ('dbx_business_glossary_term' = 'Promised Delivery Time Start');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `revision_count` SET TAGS ('dbx_business_glossary_term' = 'Revision Count');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `revision_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Revision Reason Code');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `revision_reason_description` SET TAGS ('dbx_business_glossary_term' = 'Revision Reason Description');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `shipping_address_country_code` SET TAGS ('dbx_business_glossary_term' = 'Shipping Address Country Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `shipping_address_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Shipping Address Postal Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `variance_hours` SET TAGS ('dbx_business_glossary_term' = 'Variance Hours');
ALTER TABLE `vibe_retail_v1`.`order`.`promise` ALTER COLUMN `weather_impact_flag` SET TAGS ('dbx_business_glossary_term' = 'Weather Impact Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` SET TAGS ('dbx_subdomain' = 'payment_instruments');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `gift_card_id` SET TAGS ('dbx_business_glossary_term' = 'Gift Card ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `replacement_for_gift_card_id` SET TAGS ('dbx_business_glossary_term' = 'Replacement For Gift Card Id');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `activation_date` SET TAGS ('dbx_business_glossary_term' = 'Activation Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `card_number` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `card_status` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `card_type` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `escheatment_date` SET TAGS ('dbx_business_glossary_term' = 'Escheatment Date');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `escheatment_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Escheatment Eligible Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Expiry Date');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `fraud_flag` SET TAGS ('dbx_business_glossary_term' = 'Fraud Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `fraud_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Fraud Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `issue_date` SET TAGS ('dbx_business_glossary_term' = 'Issue Date');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `issuing_channel` SET TAGS ('dbx_business_glossary_term' = 'Issuing Channel');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `last_transaction_date` SET TAGS ('dbx_business_glossary_term' = 'Last Transaction Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `recipient_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `recipient_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `redemption_count` SET TAGS ('dbx_business_glossary_term' = 'Redemption Count');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `reload_count` SET TAGS ('dbx_business_glossary_term' = 'Reload Count');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `reloadable_flag` SET TAGS ('dbx_business_glossary_term' = 'Reloadable Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `terms_and_conditions_version` SET TAGS ('dbx_business_glossary_term' = 'Terms and Conditions Version');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `total_fees_charged` SET TAGS ('dbx_business_glossary_term' = 'Total Fees Charged');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `total_redeemed_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Redeemed Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card` ALTER COLUMN `total_reloaded_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Reloaded Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` SET TAGS ('dbx_subdomain' = 'payment_instruments');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `gift_card_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Gift Card Transaction ID');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `activation_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Activation Fee Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `authorization_code` SET TAGS ('dbx_business_glossary_term' = 'Authorization Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `business_date` SET TAGS ('dbx_business_glossary_term' = 'Business Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `escheatment_flag` SET TAGS ('dbx_business_glossary_term' = 'Escheatment Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `escheatment_jurisdiction` SET TAGS ('dbx_business_glossary_term' = 'Escheatment Jurisdiction');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `fraud_decision` SET TAGS ('dbx_business_glossary_term' = 'Fraud Decision');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `fraud_score` SET TAGS ('dbx_business_glossary_term' = 'Fraud Score');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `payment_method_type` SET TAGS ('dbx_business_glossary_term' = 'Payment Method Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `reversal_flag` SET TAGS ('dbx_business_glossary_term' = 'Reversal Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `reversal_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Reversal Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `transaction_amount` SET TAGS ('dbx_business_glossary_term' = 'Transaction Amount');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `transaction_number` SET TAGS ('dbx_business_glossary_term' = 'Transaction Number');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `transaction_status` SET TAGS ('dbx_business_glossary_term' = 'Transaction Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `transaction_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Transaction Timestamp');
ALTER TABLE `vibe_retail_v1`.`order`.`gift_card_transaction` ALTER COLUMN `transaction_type` SET TAGS ('dbx_business_glossary_term' = 'Transaction Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` SET TAGS ('dbx_subdomain' = 'order_management');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Member Identifier');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `renewed_from_subscription_id` SET TAGS ('dbx_business_glossary_term' = 'Renewed From Subscription Id');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `renewed_from_subscription_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `replenishment_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Replenishment Plan Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `billing_cycle` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `cancellation_date` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Date');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `cancellation_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Reason Code');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `cancellation_reason_description` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Reason Description');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `carrier_service_level` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Level');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `delivery_frequency` SET TAGS ('dbx_business_glossary_term' = 'Delivery Frequency');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `gift_message` SET TAGS ('dbx_business_glossary_term' = 'Gift Message');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `gift_subscription_flag` SET TAGS ('dbx_business_glossary_term' = 'Gift Subscription Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `last_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Last Delivery Date');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `pause_end_date` SET TAGS ('dbx_business_glossary_term' = 'Pause End Date');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `pause_start_date` SET TAGS ('dbx_business_glossary_term' = 'Pause Start Date');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `promotion_code` SET TAGS ('dbx_business_glossary_term' = 'Promotion Code');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `promotion_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `skip_next_delivery_flag` SET TAGS ('dbx_business_glossary_term' = 'Skip Next Delivery Flag');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `special_instructions` SET TAGS ('dbx_business_glossary_term' = 'Special Instructions');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `subscription_number` SET TAGS ('dbx_business_glossary_term' = 'Subscription Number');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `subscription_number` SET TAGS ('dbx_value_regex' = '^SUB-[0-9]{10}$');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `subscription_status` SET TAGS ('dbx_business_glossary_term' = 'Subscription Status');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `subscription_type` SET TAGS ('dbx_business_glossary_term' = 'Subscription Type');
...
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `total_deliveries_completed` SET TAGS ('dbx_business_glossary_term' = 'Total Deliveries Completed');
ALTER TABLE `vibe_retail_v1`.`order`.`subscription` ALTER COLUMN `total_deliveries_skipped` SET TAGS ('dbx_business_glossary_term' = 'Total Deliveries Skipped');
