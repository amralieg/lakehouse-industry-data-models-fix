...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_bom` (
    ...
    `product_bom_id` BIGINT COMMENT 'add column product_bom_id (BIGINT) with FK to product.product_bom.product_bom_id - manufacturing BOMs should reference the engineering/product BOM they derive from',
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` SET TAGS ('dbx_subdomain' = 'production_planning');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` ALTER COLUMN `regulatory_registration_id` SET TAGS ('dbx_business_glossary_term' = 'Registration Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`batch_record` SET TAGS ('dbx_subdomain' = 'process_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`changeover` SET TAGS ('dbx_subdomain' = 'performance_quality');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`yield_record` SET TAGS ('dbx_subdomain' = 'process_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_confirmation` SET TAGS ('dbx_subdomain' = 'process_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` SET TAGS ('dbx_subdomain' = 'process_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` ALTER COLUMN `work_center_code` SET TAGS ('dbx_business_glossary_term' = 'Work Center Code');
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`process_parameter` ALTER COLUMN `work_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,12}$');
