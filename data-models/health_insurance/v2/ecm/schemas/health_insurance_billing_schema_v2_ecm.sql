...
-- Generated on: 2026-06-22 23:51:42
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` (
    ...
    `obligation_id` BIGINT COMMENT 'Foreign key linking to compliance.regulatory_obligation. Business justification: Regulatory filing of premium invoices required by state insurance premium reporting obligations.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` (
    ...
    `rate_type` DOUBLE COMMENT 'Type of premium rate applied to the line (standard, discount, subsidy, retroactive, or other adjustment).',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` (
    ...
    `obligation_id` BIGINT COMMENT 'Foreign key linking to compliance.regulatory_obligation. Business justification: Premium payment receipts must be reported to regulators for premium receipt compliance.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` (
    `premium_rate_id` DECIMAL(18,2) COMMENT 'System-generated unique identifier for each premium rate record.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` (
    ...
    `premium_payment_id` DECIMAL(18,2) COMMENT 'Identifier of the original premium payment that is being refunded.',
    ...
    `premium_invoice_id` DECIMAL(18,2) COMMENT 'Identifier of an invoice linked to the refund transaction.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` (
    ...
    `obligation_id` BIGINT COMMENT 'Foreign key linking to compliance.regulatory_obligation. Business justification: CMS remittance submissions are tied to specific CMS regulatory obligations.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` (
    ...
    `obligation_id` BIGINT COMMENT 'Foreign key linking to compliance.regulatory_obligation. Business justification: COBRA billing must comply with ERISA/DOL regulatory obligations and be reported.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` (
    ...
    `billing_payer_id` BIGINT COMMENT 'Internal identifier of the entity that made the payment (member, employer, or other).',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` (
    `mlr_rebate_id` DECIMAL(18,2) COMMENT 'System-generated unique identifier for the MLR rebate record.',
    `health_plan_id` BIGINT COMMENT 'Identifier of the health plan to which the rebate applies.',
    `practice_location_id` BIGINT COMMENT 'Identifier of the provider network entity associated with the rebate, if applicable.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` (
    `premium_statement_id` DECIMAL(18,2) COMMENT 'System-generated unique identifier for the premium statement record.',
    ...
    `premium_rate_id` DECIMAL(18,2) COMMENT 'Reference to the premium rate schedule used to calculate the gross premium.',
    `premium_updated_by_user_employee_id` BIGINT COMMENT 'System user identifier who last modified the premium statement record.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` (
    ...
    `health_plan_id` BIGINT COMMENT 'rate schedules must be associated with a health plan',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` (
    ...
    `premium_invoice_id` DECIMAL(18,2) COMMENT 'Identifier of the invoice that is the subject of the dispute.',
    `premium_payment_id` DECIMAL(18,2) COMMENT 'Identifier of the payment that is associated with the disputed invoice, if applicable.',
    ...
    `contract_dispute_id` BIGINT COMMENT 'FK establishing single source of truth linkage to canonical contract.contract_dispute.contract_dispute_id',
    `billing_ssot_contract_dispute_ref_id` BIGINT COMMENT 'Single-source-of-truth reference to canonical dispute record.',
...
) COMMENT 'Master reference table for billing_calendar. Referenced by billing_calendar_id. [FHIR-aligned]';

CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` (
    `billing_payer_id` BIGINT COMMENT 'Primary key for payer',
    ...
    `vendor_id` BIGINT COMMENT 'The vendor vendor id for this record.',
    ...
    `ssot_payer_ref_id` BIGINT COMMENT 'Foreign key linking this duplicate payer record to the single source of truth in claim.payer',
    `vreq_validated` BOOLEAN COMMENT 'Validation marker for VREQ preservation requirement',
    CONSTRAINT pk_billing_payer PRIMARY KEY(`billing_payer_id`)
) COMMENT '[SSOT:payer] Single source of truth (canonical) for the payer concept. Master reference table for payer. Referenced by payer_id. SSOT NOTE: Canonical source of truth for the payer concept is claim.payer; this product is retained as a domain-specific view/duplicate and must defer to the canonical entity. [FHIR-aligned] SSOT duplicate; single source of truth is claim.payer.';
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ADD CONSTRAINT `fk_billing_suspense_account_billing_payer_id` FOREIGN KEY (`billing_payer_id`) REFERENCES `vibe_health_insurance_v1`.`billing`.`billing_payer`(`billing_payer_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ADD CONSTRAINT `fk_billing_billing_dispute_premium_invoice_id` FOREIGN KEY (`premium_invoice_id`) REFERENCES `vibe_health_insurance_v1`.`billing`.`premium_invoice`(`premium_invoice_id`);
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ADD CONSTRAINT `fk_billing_billing_dispute_premium_payment_id` FOREIGN KEY (`premium_payment_id`) REFERENCES `vibe_health_insurance_v1`.`billing`.`premium_payment`(`premium_payment_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ADD CONSTRAINT `fk_billing_billing_payer_parent_payer_id` FOREIGN KEY (`parent_payer_id`) REFERENCES `vibe_health_insurance_v1`.`billing`.`billing_payer`(`billing_payer_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` SET TAGS ('dbx_fhir_resource' = 'Invoice');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` SET TAGS ('dbx_interop' = 'fhir');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Clerk Employee Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `application_id` SET TAGS ('dbx_business_glossary_term' = 'Credentialing Application Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Ledger Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `plan_name` SET TAGS ('dbx_business_glossary_term' = 'Plan Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `plan_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_type' = 'name');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` SET TAGS ('dbx_fhir_resource' = 'Invoice');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` SET TAGS ('dbx_interop' = 'fhir');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` ALTER COLUMN `ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Ledger Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` ALTER COLUMN `pa_request_id` SET TAGS ('dbx_business_glossary_term' = 'Pa Request Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` SET TAGS ('dbx_fhir_resource' = 'PaymentReconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` SET TAGS ('dbx_interop' = 'fhir');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `application_id` SET TAGS ('dbx_business_glossary_term' = 'Credentialing Application Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Ledger Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Processed By Employee Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` SET TAGS ('dbx_fhir_resource' = 'Location');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` ALTER COLUMN `application_id` SET TAGS ('dbx_business_glossary_term' = 'Credentialing Application Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approver ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_allocation` ALTER COLUMN `ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Ledger Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` SET TAGS ('dbx_subdomain' = 'account_collections');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` SET TAGS ('dbx_fhir_resource' = 'Basic');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned Billing Representative');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` SET TAGS ('dbx_subdomain' = 'invoice_management');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` SET TAGS ('dbx_fhir_resource' = 'Basic');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rate_schedule_id` SET TAGS ('dbx_business_glossary_term' = 'Rate Schedule Id');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rate_schedule_id` SET TAGS ('dbx_internal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `age_band` SET TAGS ('dbx_pii_type' = 'demographic');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `plan_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `premium_rate_status` SET TAGS ('dbx_fhir_element' = 'status');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rating_area` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rating_area_reference` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rating_method` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_pii_type' = 'address');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` SET TAGS ('dbx_subdomain' = 'account_collections');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` SET TAGS ('dbx_fhir_resource' = 'Basic');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` SET TAGS ('dbx_subdomain' = 'account_collections');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `retro_adjustment_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Retroactive Adjustment ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (Member ID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_amount` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Amount (USD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_amount` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_number` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Number (External)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_status` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected|posted|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_type` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `adjustment_type` SET TAGS ('dbx_value_regex' = 'add|termination|rate_change|tier_change|dispute_credit|dispute_correction');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `authorization_reference` SET TAGS ('dbx_business_glossary_term' = 'Authorization Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `credit_memo_reference` SET TAGS ('dbx_business_glossary_term' = 'Credit Memo Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = 'USD|CAD|EUR|GBP|JPY|AUD');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `dispute_open_date` SET TAGS ('dbx_business_glossary_term' = 'Dispute Open Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `dispute_status` SET TAGS ('dbx_business_glossary_term' = 'Dispute Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `dispute_status` SET TAGS ('dbx_value_regex' = 'open|under_review|resolved|escalated');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `dispute_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `dispute_type` SET TAGS ('dbx_business_glossary_term' = 'Dispute Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `dispute_type` SET TAGS ('dbx_value_regex' = 'invoice_amount|payment_misapplication|rate_error|retro_adjustment|aptc_discrepancy');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `disputed_amount` SET TAGS ('dbx_business_glossary_term' = 'Disputed Amount (USD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `disputed_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `disputed_amount` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `invoice_reference` SET TAGS ('dbx_business_glossary_term' = 'Invoice Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `original_billing_period_end` SET TAGS ('dbx_business_glossary_term' = 'Original Billing Period End Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `original_billing_period_start` SET TAGS ('dbx_business_glossary_term' = 'Original Billing Period Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `reason_code` SET TAGS ('dbx_business_glossary_term' = 'Reason Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `reason_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `reason_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `record_audit_created` SET TAGS ('dbx_business_glossary_term' = 'Record Audit Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `record_audit_updated` SET TAGS ('dbx_business_glossary_term' = 'Record Audit Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `resolution_date` SET TAGS ('dbx_business_glossary_term' = 'Resolution Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `resolution_notes` SET TAGS ('dbx_business_glossary_term' = 'Resolution Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `resolution_type` SET TAGS ('dbx_business_glossary_term' = 'Resolution Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ALTER COLUMN `resolution_type` SET TAGS ('dbx_value_regex' = 'credit_issued|invoice_corrected|upheld');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` SET TAGS ('dbx_subdomain' = 'payment_processing');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `premium_refund_id` SET TAGS ('dbx_business_glossary_term' = 'Premium Refund ID (PRID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Identifier (EGID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (MID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `policy_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Identifier (PID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `policy_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `policy_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `premium_payment_id` SET TAGS ('dbx_business_glossary_term' = 'Original Payment Identifier (OPID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User Identifier (CBUID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Related Claim Identifier (RCID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `premium_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Related Invoice Identifier (RIID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Refund Approval Status (RAS)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `approval_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `cleared_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Refund Cleared Timestamp (RCT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `is_partial_refund` SET TAGS ('dbx_business_glossary_term' = 'Partial Refund Indicator (PRI)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `is_tax_refund` SET TAGS ('dbx_business_glossary_term' = 'Tax Refund Indicator (TRI)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `issued_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Refund Issued Timestamp (RIT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_business_glossary_term' = 'Refund Lifecycle Status (RLS)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|approved|processed|cancelled|reversed');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `original_payment_amount` SET TAGS ('dbx_business_glossary_term' = 'Original Payment Amount (OPA)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `original_payment_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `original_payment_amount` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `record_audit_created` SET TAGS ('dbx_business_glossary_term' = 'Record Audit Created Timestamp (RACT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `record_audit_updated` SET TAGS ('dbx_business_glossary_term' = 'Record Audit Updated Timestamp (RAUT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_amount` SET TAGS ('dbx_business_glossary_term' = 'Refund Amount (RA)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_amount` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_batch_number` SET TAGS ('dbx_business_glossary_term' = 'Refund Batch Number (RBN)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_batch_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_batch_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_currency` SET TAGS ('dbx_business_glossary_term' = 'Refund Currency Code (RFC)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_method` SET TAGS ('dbx_business_glossary_term' = 'Refund Disbursement Method (RDM)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_method` SET TAGS ('dbx_value_regex' = 'ACH|check|credit_to_account|wire|online|other');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_notes` SET TAGS ('dbx_business_glossary_term' = 'Refund Notes (RN)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_number` SET TAGS ('dbx_business_glossary_term' = 'Refund Transaction Number (RTN)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_processing_fee` SET TAGS ('dbx_business_glossary_term' = 'Refund Processing Fee (RPF)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_processing_fee` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_processing_fee` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Refund Reason Code (RRC)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_reason_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_reason_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_reason_description` SET TAGS ('dbx_business_glossary_term' = 'Refund Reason Description (RRD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_type` SET TAGS ('dbx_business_glossary_term' = 'Refund Type (RT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `refund_type` SET TAGS ('dbx_value_regex' = 'overpayment|termination|rate_correction|plan_cancellation|adjustment|other');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reporting Flag (RRF)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount Refunded (TAR)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `tax_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `tax_amount` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` SET TAGS ('dbx_subdomain' = 'subsidy_reconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` SET TAGS ('dbx_fhir_resource' = 'Basic');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` ALTER COLUMN `qhp_plan_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` SET TAGS ('dbx_subdomain' = 'subsidy_reconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` SET TAGS ('dbx_fhir_resource' = 'PaymentReconciliation');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` ALTER COLUMN `obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` SET TAGS ('dbx_subdomain' = 'invoice_management');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `account_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Account Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `billing_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Calendar Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `renewal_cycle_id` SET TAGS ('dbx_business_glossary_term' = 'Renewal Billing Cycle Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `auto_renewal_flag` SET TAGS ('dbx_business_glossary_term' = 'Auto Renewal Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `billing_frequency_months` SET TAGS ('dbx_business_glossary_term' = 'Billing Frequency in Months');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `billing_method` SET TAGS ('dbx_business_glossary_term' = 'Billing Method (Electronic, Paper, Direct Debit, Credit Card)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `billing_method` SET TAGS ('dbx_value_regex' = 'electronic|paper|direct_debit|credit_card');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_code` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_status` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_status` SET TAGS ('dbx_value_regex' = 'active|inactive|suspended|pending|closed');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_type` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle Type (Monthly, Quarterly, Semi-Annual, Annual)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_type` SET TAGS ('dbx_value_regex' = 'monthly|quarterly|semi_annual|annual');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `default_premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Default Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `cycle_description` SET TAGS ('dbx_business_glossary_term' = 'Description of Billing Cycle Configuration');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Discount Amount Applied to Premium');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_fhir_element' = 'period.end');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_fhir_element' = 'period.start');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_business_glossary_term' = 'Grace Period Days After Due Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_sensitivity' = 'special_category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_fhir_element' = 'extension.us-core-race');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_special_category' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_pii' = 'special_category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `invoice_day_of_month` SET TAGS ('dbx_business_glossary_term' = 'Invoice Generation Day of Month');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `is_pro_rata` SET TAGS ('dbx_business_glossary_term' = 'Pro Rata Billing Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `last_invoice_date` SET TAGS ('dbx_business_glossary_term' = 'Last Invoice Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `net_premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Net Premium Amount After Discounts');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `next_invoice_date` SET TAGS ('dbx_business_glossary_term' = 'Next Invoice Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `payment_due_day_offset` SET TAGS ('dbx_business_glossary_term' = 'Payment Due Day Offset');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `prorated_amount` SET TAGS ('dbx_business_glossary_term' = 'Pro Rata Adjusted Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount Applied to Premium');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `total_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Amount Due for Billing Cycle');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Last Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` SET TAGS ('dbx_subdomain' = 'account_collections');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` SET TAGS ('dbx_fhir_resource' = 'Communication');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `collection_case_id` SET TAGS ('dbx_business_glossary_term' = 'Collection Case ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Case Owner Employee Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Collection Agency ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `action_count` SET TAGS ('dbx_business_glossary_term' = 'Action Count');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `adjustment_amount` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `case_closed_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Case Closed Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `case_number` SET TAGS ('dbx_business_glossary_term' = 'Collection Case Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `case_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `case_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `case_open_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Case Open Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `collection_case_status` SET TAGS ('dbx_business_glossary_term' = 'Collection Case Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `collection_case_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `delinquency_age_days` SET TAGS ('dbx_business_glossary_term' = 'Delinquency Age (Days)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `delinquency_age_days` SET TAGS ('dbx_pii_type' = 'demographic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `delinquent_amount` SET TAGS ('dbx_business_glossary_term' = 'Delinquent Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `final_resolution` SET TAGS ('dbx_business_glossary_term' = 'Final Resolution');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `final_resolution` SET TAGS ('dbx_value_regex' = 'paid_in_full|partial_payment|written_off|bankruptcy|plan_termination');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `last_action_date` SET TAGS ('dbx_business_glossary_term' = 'Last Action Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `last_action_type` SET TAGS ('dbx_business_glossary_term' = 'Last Action Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `last_action_type` SET TAGS ('dbx_value_regex' = 'notice_sent|payment_arranged|legal_action|write_off|reinstated');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `net_amount_due` SET TAGS ('dbx_business_glossary_term' = 'Net Amount Due');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Case Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `payment_plan_arrangement_details` SET TAGS ('dbx_business_glossary_term' = 'Payment Plan Arrangement Details');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `referral_date` SET TAGS ('dbx_business_glossary_term' = 'Referral Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `reinstatement_conditions` SET TAGS ('dbx_business_glossary_term' = 'Reinstatement Conditions');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `reinstatement_conditions` SET TAGS ('dbx_sensitivity' = 'phi');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `reinstatement_conditions` SET TAGS ('dbx_pii_type' = 'health');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `reinstatement_eligibility_flag` SET TAGS ('dbx_business_glossary_term' = 'Reinstatement Eligibility Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `termination_notice_issued_date` SET TAGS ('dbx_business_glossary_term' = 'Termination Notice Issued Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `write_off_amount` SET TAGS ('dbx_business_glossary_term' = 'Write‑Off Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `write_off_approval_reference` SET TAGS ('dbx_business_glossary_term' = 'Write‑Off Approval Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` SET TAGS ('dbx_subdomain' = 'subsidy_reconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `premium_reconciliation_id` SET TAGS ('dbx_business_glossary_term' = 'Premium Reconciliation ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `premium_reconciliation_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `premium_reconciliation_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `cms_remittance_id` SET TAGS ('dbx_business_glossary_term' = 'CMS Remittance Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approver Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Health Plan Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `journal_entry_id` SET TAGS ('dbx_business_glossary_term' = 'Journal Entry Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `member_risk_score_id` SET TAGS ('dbx_business_glossary_term' = 'Member Risk Score Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `approval_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approval Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `apr_rate` SET TAGS ('dbx_business_glossary_term' = 'Annual Premium Rate (APR)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `aptc_subsidy_amount` SET TAGS ('dbx_business_glossary_term' = 'Advance Premium Tax Credit (APTC) Subsidy Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `is_finalized` SET TAGS ('dbx_business_glossary_term' = 'Finalization Indicator');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `mlr_input_flag` SET TAGS ('dbx_business_glossary_term' = 'Medical Loss Ratio Input Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `net_premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Net Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Period End Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Period Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `pm_amount` SET TAGS ('dbx_business_glossary_term' = 'Per Member Per Month Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `premium_reconciliation_status` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `premium_reconciliation_status` SET TAGS ('dbx_value_regex' = 'open|in_review|approved|closed');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `premium_reconciliation_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `reconciliation_number` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `reconciliation_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `reconciliation_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `reconciliation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Event Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `reconciliation_type` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `reconciliation_type` SET TAGS ('dbx_value_regex' = 'monthly|quarterly|annual');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reporting Inclusion Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_business_glossary_term' = 'State Code (US Postal)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_fhir_element' = 'address.state');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `total_adjustments_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Adjustments Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `total_billed_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Billed Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `total_collected_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Collected Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Last Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `variance_amount` SET TAGS ('dbx_business_glossary_term' = 'Premium Variance Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `variance_reason` SET TAGS ('dbx_business_glossary_term' = 'Premium Variance Reason');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` SET TAGS ('dbx_subdomain' = 'account_collections');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `cobra_billing_id` SET TAGS ('dbx_business_glossary_term' = 'COBRA Billing ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Beneficiary ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `admin_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Administrative Fee Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `billing_cycle_month` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle Month');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `billing_issue_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Billing Issue Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `billing_number` SET TAGS ('dbx_business_glossary_term' = 'Billing Number (COBRA)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `billing_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `billing_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `cobra_status` SET TAGS ('dbx_business_glossary_term' = 'COBRA Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `cobra_status` SET TAGS ('dbx_value_regex' = 'elected|active|lapsed|exhausted|terminated');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `cobra_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `compliance_flag_dol` SET TAGS ('dbx_business_glossary_term' = 'DOL Compliance Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `compliance_flag_erisa` SET TAGS ('dbx_business_glossary_term' = 'ERISA Compliance Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `coverage_end_date` SET TAGS ('dbx_business_glossary_term' = 'Coverage End Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `coverage_end_date` SET TAGS ('dbx_fhir_element' = 'period.end');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `coverage_start_date` SET TAGS ('dbx_business_glossary_term' = 'Coverage Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `coverage_start_date` SET TAGS ('dbx_fhir_element' = 'period.start');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `election_reference` SET TAGS ('dbx_business_glossary_term' = 'COBRA Election Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `initial_grace_period_days` SET TAGS ('dbx_business_glossary_term' = 'Initial Grace Period (Days)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `initial_grace_period_days` SET TAGS ('dbx_sensitivity' = 'special_category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `initial_grace_period_days` SET TAGS ('dbx_fhir_element' = 'extension.us-core-race');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `initial_grace_period_days` SET TAGS ('dbx_special_category' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `initial_grace_period_days` SET TAGS ('dbx_pii' = 'special_category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `is_deleted` SET TAGS ('dbx_business_glossary_term' = 'Is Deleted Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `last_payment_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Payment Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `ongoing_grace_period_days` SET TAGS ('dbx_business_glossary_term' = 'Ongoing Grace Period (Days)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `ongoing_grace_period_days` SET TAGS ('dbx_sensitivity' = 'special_category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `ongoing_grace_period_days` SET TAGS ('dbx_fhir_element' = 'extension.us-core-race');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `ongoing_grace_period_days` SET TAGS ('dbx_special_category' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `ongoing_grace_period_days` SET TAGS ('dbx_pii' = 'special_category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_due_date` SET TAGS ('dbx_business_glossary_term' = 'Payment Due Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payment Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'check|credit_card|direct_debit|online|other');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_reference` SET TAGS ('dbx_business_glossary_term' = 'Payment Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_status` SET TAGS ('dbx_business_glossary_term' = 'Payment Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_status` SET TAGS ('dbx_value_regex' = 'pending|paid|failed|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `payment_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Base Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `record_status` SET TAGS ('dbx_business_glossary_term' = 'Record Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `record_status` SET TAGS ('dbx_value_regex' = 'active|inactive');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `record_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `refund_amount` SET TAGS ('dbx_business_glossary_term' = 'Refund Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `retroactive_adjustment_amount` SET TAGS ('dbx_business_glossary_term' = 'Retroactive Adjustment Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `retroactive_adjustment_flag` SET TAGS ('dbx_business_glossary_term' = 'Retroactive Adjustment Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `total_premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Total Premium Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` SET TAGS ('dbx_subdomain' = 'payment_processing');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `edi_820_id` SET TAGS ('dbx_business_glossary_term' = 'EDI 820 Transaction ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `batch_number` SET TAGS ('dbx_business_glossary_term' = 'Batch Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `batch_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `batch_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `business_event_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Business Event Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `business_identifier` SET TAGS ('dbx_business_glossary_term' = 'Business Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `direction` SET TAGS ('dbx_business_glossary_term' = 'Transaction Direction');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `direction` SET TAGS ('dbx_value_regex' = 'inbound|outbound');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `error_code` SET TAGS ('dbx_business_glossary_term' = 'Error Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `error_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `error_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `error_description` SET TAGS ('dbx_business_glossary_term' = 'Error Description');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `invoice_reference` SET TAGS ('dbx_business_glossary_term' = 'Invoice Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `is_reconciled` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `isa_receiver_qualifier_code` SET TAGS ('dbx_business_glossary_term' = 'ISA Receiver Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `isa_receiver_qualifier_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `isa_receiver_qualifier_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `isa_sender_qualifier_code` SET TAGS ('dbx_business_glossary_term' = 'ISA Sender Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `isa_sender_qualifier_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `isa_sender_qualifier_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_business_glossary_term' = 'Lifecycle Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_value_regex' = 'received|validated|applied|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `lifecycle_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_business_glossary_term' = 'Payee National Provider Identifier (NPI)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payee_npi` SET TAGS ('dbx_fhir_element' = 'identifier.npi');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_business_glossary_term' = 'Payer National Provider Identifier (NPI)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payer_npi` SET TAGS ('dbx_fhir_element' = 'identifier.npi');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_amount` SET TAGS ('dbx_business_glossary_term' = 'Payment Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_date` SET TAGS ('dbx_business_glossary_term' = 'Payment Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_method_code` SET TAGS ('dbx_business_glossary_term' = 'Payment Method Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_method_code` SET TAGS ('dbx_value_regex' = 'ACH|Check|CreditCard|Wire');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_method_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_method_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_type` SET TAGS ('dbx_business_glossary_term' = 'Payment Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `payment_type` SET TAGS ('dbx_value_regex' = 'Premium|Refund|Adjustment');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `processing_notes` SET TAGS ('dbx_business_glossary_term' = 'Processing Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `reconciliation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Reconciliation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `record_audit_created` SET TAGS ('dbx_business_glossary_term' = 'Record Audit Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `record_audit_updated` SET TAGS ('dbx_business_glossary_term' = 'Record Audit Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `remittance_advice_number` SET TAGS ('dbx_business_glossary_term' = 'Remittance Advice Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `remittance_advice_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `remittance_advice_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `settlement_date` SET TAGS ('dbx_business_glossary_term' = 'Settlement Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `transaction_set_control_number` SET TAGS ('dbx_business_glossary_term' = 'Transaction Set Identifier (820)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `transaction_set_control_number` SET TAGS ('dbx_value_regex' = '820');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `transaction_set_control_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `transaction_set_control_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` SET TAGS ('dbx_subdomain' = 'payment_processing');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_account_id` SET TAGS ('dbx_business_glossary_term' = 'Suspense Account ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Resolver Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `billing_payer_id` SET TAGS ('dbx_business_glossary_term' = 'Payer Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `amount` SET TAGS ('dbx_business_glossary_term' = 'Payment Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `batch_number` SET TAGS ('dbx_business_glossary_term' = 'Batch Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `batch_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `batch_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `is_amount_mismatch` SET TAGS ('dbx_business_glossary_term' = 'Amount Mismatch Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `is_duplicate` SET TAGS ('dbx_business_glossary_term' = 'Duplicate Payment Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `is_overpayment` SET TAGS ('dbx_business_glossary_term' = 'Overpayment Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Suspense Account Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payer_account_reference` SET TAGS ('dbx_business_glossary_term' = 'Payer Account Reference (PII)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payer_account_reference` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payer_account_reference` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payment_channel` SET TAGS ('dbx_business_glossary_term' = 'Payment Channel');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payment_channel` SET TAGS ('dbx_value_regex' = 'web|mobile|call_center|mail|in_person');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payment Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'check|cash|credit_card|debit_card|electronic_transfer|online_payment');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `receipt_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Payment Receipt Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `resolution_due_date` SET TAGS ('dbx_business_glossary_term' = 'Resolution Due Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `resolution_outcome` SET TAGS ('dbx_business_glossary_term' = 'Resolution Outcome');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `resolution_outcome` SET TAGS ('dbx_value_regex' = 'applied|refunded|written_off|pending|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `resolution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Resolution Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_account_status` SET TAGS ('dbx_business_glossary_term' = 'Suspense Account Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_account_status` SET TAGS ('dbx_value_regex' = 'open|in_process|resolved|closed|cancelled');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_account_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_number` SET TAGS ('dbx_business_glossary_term' = 'Suspense Account Number (SUSPENSE_NUMBER)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_reason` SET TAGS ('dbx_business_glossary_term' = 'Suspense Reason');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `suspense_reason` SET TAGS ('dbx_value_regex' = 'unidentified_payer|amount_mismatch|duplicate_payment|missing_invoice|other');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `transaction_reference` SET TAGS ('dbx_business_glossary_term' = 'Transaction Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`suspense_account` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` SET TAGS ('dbx_subdomain' = 'subsidy_reconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `mlr_rebate_id` SET TAGS ('dbx_business_glossary_term' = 'MLR Rebate ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `practice_location_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `calculation_method` SET TAGS ('dbx_business_glossary_term' = 'Rebate Calculation Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `calculation_method` SET TAGS ('dbx_value_regex' = 'standard|custom');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `calculation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Rebate Calculation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `cms_filing_reference` SET TAGS ('dbx_business_glossary_term' = 'CMS Filing Reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `disbursement_date` SET TAGS ('dbx_business_glossary_term' = 'Rebate Disbursement Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `disbursement_method` SET TAGS ('dbx_business_glossary_term' = 'Rebate Disbursement Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `disbursement_method` SET TAGS ('dbx_value_regex' = 'check|premium_credit|enrollment_reduction');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective From Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Effective Until Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `eligibility_flag` SET TAGS ('dbx_business_glossary_term' = 'Eligibility Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `hhs_submission_status` SET TAGS ('dbx_business_glossary_term' = 'HHS Submission Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `hhs_submission_status` SET TAGS ('dbx_value_regex' = 'submitted|pending|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `hhs_submission_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `line_of_business` SET TAGS ('dbx_business_glossary_term' = 'Line of Business (LOB)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `market_segment` SET TAGS ('dbx_business_glossary_term' = 'Market Segment');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `market_segment` SET TAGS ('dbx_value_regex' = 'individual|small_group|large_group');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `mlr_percentage` SET TAGS ('dbx_business_glossary_term' = 'Medical Loss Ratio Percentage');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `mlr_rebate_status` SET TAGS ('dbx_business_glossary_term' = 'Rebate Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `mlr_rebate_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected|paid');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `mlr_rebate_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Rebate Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `quality_improvement_expenses` SET TAGS ('dbx_business_glossary_term' = 'Quality Improvement Expenses');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `rebate_amount_due` SET TAGS ('dbx_business_glossary_term' = 'Rebate Amount Due');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `rebate_number` SET TAGS ('dbx_business_glossary_term' = 'Rebate Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `rebate_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `rebate_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `reporting_year` SET TAGS ('dbx_business_glossary_term' = 'Reporting Year');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `reporting_year` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_business_glossary_term' = 'State Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{2}$');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_fhir_element' = 'address.state');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `total_incurred_claims` SET TAGS ('dbx_business_glossary_term' = 'Total Incurred Claims');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `total_premium_earned` SET TAGS ('dbx_business_glossary_term' = 'Total Premium Earned');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_method` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_method` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_method` SET TAGS ('dbx_fhir_resource' = 'PaymentReconciliation');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` SET TAGS ('dbx_subdomain' = 'invoice_management');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `premium_statement_id` SET TAGS ('dbx_business_glossary_term' = 'Premium Statement Identifier (ID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Plan Identifier (PLAN_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `identity_id` SET TAGS ('dbx_business_glossary_term' = 'Member Identifier (MEMBER_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `identity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `identity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User Identifier (CREATED_BY_UID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `premium_rate_id` SET TAGS ('dbx_business_glossary_term' = 'Premium Rate Identifier (RATE_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `premium_updated_by_user_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Updated By User Identifier (UPDATED_BY_UID)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `premium_updated_by_user_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `premium_updated_by_user_employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `adjustment_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Reason Code (ADJ_REASON_CD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `adjustment_reason_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `adjustment_reason_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `aptc_amount` SET TAGS ('dbx_business_glossary_term' = 'Advanced Premium Tax Credit Amount (APTC_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `aptc_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `billing_cycle` SET TAGS ('dbx_business_glossary_term' = 'Billing Cycle (BILL_CYCLE)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `coverage_end_date` SET TAGS ('dbx_business_glossary_term' = 'Coverage End Date (COV_END_DT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `coverage_end_date` SET TAGS ('dbx_fhir_element' = 'period.end');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `coverage_start_date` SET TAGS ('dbx_business_glossary_term' = 'Coverage Start Date (COV_START_DT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `coverage_start_date` SET TAGS ('dbx_fhir_element' = 'period.start');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Creation Timestamp (CREATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (CURR_CD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `delivery_method` SET TAGS ('dbx_business_glossary_term' = 'Statement Delivery Method (DELIV_METHOD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `delivery_method` SET TAGS ('dbx_value_regex' = 'mail|email|portal');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `discount_amount` SET TAGS ('dbx_business_glossary_term' = 'Discount Amount (DISCOUNT_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `discount_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `gross_premium_amount` SET TAGS ('dbx_business_glossary_term' = 'Gross Premium Amount (GROSS_PREM)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `gross_premium_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `is_eligible_for_subsidy` SET TAGS ('dbx_business_glossary_term' = 'Subsidy Eligibility Flag (SUBSIDY_ELIG_FLG)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `is_late_payment_flag` SET TAGS ('dbx_business_glossary_term' = 'Late Payment Indicator (LATE_PAY_FLG)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `is_refund` SET TAGS ('dbx_business_glossary_term' = 'Refund Indicator (REFUND_FLG)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `late_fee_amount` SET TAGS ('dbx_business_glossary_term' = 'Late Fee Amount (LATE_FEE_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `late_fee_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `net_premium_due` SET TAGS ('dbx_business_glossary_term' = 'Net Premium Due (NET_PREM_DUE)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `net_premium_due` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Statement Notes (STMT_NOTES)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `payment_channel` SET TAGS ('dbx_business_glossary_term' = 'Payment Channel (PAY_CHANNEL)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `payment_channel` SET TAGS ('dbx_value_regex' = 'web|mobile|call_center|mail|portal');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `payment_due_date` SET TAGS ('dbx_business_glossary_term' = 'Payment Due Date (PAY_DUE_DT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payment Method (PAY_METHOD)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'credit_card|bank_transfer|check|cash|online|other');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `rebate_amount` SET TAGS ('dbx_business_glossary_term' = 'Rebate Amount (REBATE_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `rebate_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `refund_amount` SET TAGS ('dbx_business_glossary_term' = 'Refund Amount (REFUND_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `refund_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_date` SET TAGS ('dbx_business_glossary_term' = 'Statement Date (STMT_DT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_date` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_date` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_number` SET TAGS ('dbx_business_glossary_term' = 'Statement Number (STMT_NO)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_number` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_number` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_pdf_url` SET TAGS ('dbx_business_glossary_term' = 'Statement PDF URL (PDF_URL)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_pdf_url` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_pdf_url` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_status` SET TAGS ('dbx_business_glossary_term' = 'Statement Status (STMT_STATUS)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_status` SET TAGS ('dbx_value_regex' = 'draft|issued|sent|paid|cancelled|void');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_status` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_status` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_type` SET TAGS ('dbx_business_glossary_term' = 'Statement Type (STMT_TYPE)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_type` SET TAGS ('dbx_value_regex' = 'individual|family|group');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_type` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_type` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_version` SET TAGS ('dbx_business_glossary_term' = 'Statement Version (STMT_VER)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_version` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `statement_version` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `subsidy_amount` SET TAGS ('dbx_business_glossary_term' = 'Subsidy Amount (SUBSIDY_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `subsidy_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `tax_amount` SET TAGS ('dbx_business_glossary_term' = 'Tax Amount (TAX_AMT)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `tax_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `total_payments_applied` SET TAGS ('dbx_business_glossary_term' = 'Total Payments Applied (PAYMENTS_APPLIED)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `total_payments_applied` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Update Timestamp (UPDATED_TS)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_subdomain' = 'invoice_management');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rate_schedule_id` SET TAGS ('dbx_business_glossary_term' = 'Rate Schedule ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `applicable_year` SET TAGS ('dbx_business_glossary_term' = 'Applicable Plan Year');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `aptc_amount` SET TAGS ('dbx_business_glossary_term' = 'APTC Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `cobra_rate` SET TAGS ('dbx_business_glossary_term' = 'COBRA Rate');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `coverage_type` SET TAGS ('dbx_business_glossary_term' = 'Coverage Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `coverage_type` SET TAGS ('dbx_value_regex' = 'medical|dental|vision|rx');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rate_schedule_description` SET TAGS ('dbx_business_glossary_term' = 'Schedule Description');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `effective_date` SET TAGS ('dbx_fhir_element' = 'period.start');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `employee_contribution_rate` SET TAGS ('dbx_business_glossary_term' = 'Employee Contribution Rate');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `employer_contribution_rate` SET TAGS ('dbx_business_glossary_term' = 'Employer Contribution Rate');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `family_tier_structure` SET TAGS ('dbx_business_glossary_term' = 'Family Tier Structure');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `filing_date` SET TAGS ('dbx_business_glossary_term' = 'Filing Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `filing_status` SET TAGS ('dbx_business_glossary_term' = 'Filing Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `filing_status` SET TAGS ('dbx_value_regex' = 'filed|pending|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `filing_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `is_default_schedule` SET TAGS ('dbx_business_glossary_term' = 'Default Schedule Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `last_review_date` SET TAGS ('dbx_business_glossary_term' = 'Last Review Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `market_segment` SET TAGS ('dbx_business_glossary_term' = 'Market Segment');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `market_segment` SET TAGS ('dbx_value_regex' = 'individual|group|small_group|large_group');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `plan_code` SET TAGS ('dbx_business_glossary_term' = 'Plan Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `premium_type` SET TAGS ('dbx_business_glossary_term' = 'Premium Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `premium_type` SET TAGS ('dbx_value_regex' = 'base|supplemental|discount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rate_amount` SET TAGS ('dbx_business_glossary_term' = 'Base Rate Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rate_schedule_status` SET TAGS ('dbx_business_glossary_term' = 'Rate Schedule Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rate_schedule_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|retired');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rate_schedule_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_area` SET TAGS ('dbx_business_glossary_term' = 'Rating Area');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_area` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_method` SET TAGS ('dbx_business_glossary_term' = 'Rating Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_method` SET TAGS ('dbx_value_regex' = 'community|age|composite|experience');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_method` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_methodology_details` SET TAGS ('dbx_business_glossary_term' = 'Rating Methodology Details');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_methodology_details` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `regulatory_county` SET TAGS ('dbx_business_glossary_term' = 'Regulatory County');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `regulatory_filing_metadata` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Filing Metadata');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `regulatory_state` SET TAGS ('dbx_business_glossary_term' = 'Regulatory State');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `regulatory_state` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `review_status` SET TAGS ('dbx_business_glossary_term' = 'Review Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `review_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `review_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `schedule_name` SET TAGS ('dbx_business_glossary_term' = 'Rate Schedule Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `schedule_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `schedule_name` SET TAGS ('dbx_pii_type' = 'name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_business_glossary_term' = 'State DOI Filing Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `subsidy_amount` SET TAGS ('dbx_business_glossary_term' = 'Subsidy Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `tobacco_surcharge_flag` SET TAGS ('dbx_business_glossary_term' = 'Tobacco Surcharge Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `tobacco_surcharge_rate` SET TAGS ('dbx_business_glossary_term' = 'Tobacco Surcharge Rate');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `wellness_discount_flag` SET TAGS ('dbx_business_glossary_term' = 'Wellness Discount Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `wellness_discount_rate` SET TAGS ('dbx_business_glossary_term' = 'Wellness Discount Rate');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_subdomain' = 'account_collections');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_of' = 'contract.contract_dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_status' = 'canonical');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot' = 'dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_source' = 'contract.contract_dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_concept' = 'dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_role' = 'reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_canonical' = 'contract.contract_dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_ref' = 'contract.contract_dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_owner' = 'dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_alias_of' = 'vendor.vendor_dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_ssot_group' = 'dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `billing_dispute_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Dispute ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `premium_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Related Invoice ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `premium_payment_id` SET TAGS ('dbx_business_glossary_term' = 'Related Payment ID');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_business_glossary_term' = 'Dispute Initiator Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `contract_dispute_id` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `billing_ssot_contract_dispute_ref_id` SET TAGS ('dbx_business_glossary_term' = 'dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `billing_ssot_contract_dispute_ref_id` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `billing_ssot_contract_dispute_ref_id` SET TAGS ('dbx_ssot_role' = 'reference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `billing_ssot_contract_dispute_ref_id` SET TAGS ('dbx_ssot_group' = 'dispute');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `currency_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `currency_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_category` SET TAGS ('dbx_business_glossary_term' = 'Dispute Category');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_category` SET TAGS ('dbx_value_regex' = 'invoice_amount|payment_misapplication|rate_error|retro_adjustment|aptc_discrepancy');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_number` SET TAGS ('dbx_business_glossary_term' = 'Dispute Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_status` SET TAGS ('dbx_business_glossary_term' = 'Dispute Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_status` SET TAGS ('dbx_value_regex' = 'open|under_review|resolved|escalated|closed');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `dispute_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `disputed_amount` SET TAGS ('dbx_business_glossary_term' = 'Disputed Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `initiator_type` SET TAGS ('dbx_business_glossary_term' = 'Dispute Initiator Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `initiator_type` SET TAGS ('dbx_value_regex' = 'member|employer|provider');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `open_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Dispute Open Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reporting Flag');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `resolution_notes` SET TAGS ('dbx_business_glossary_term' = 'Resolution Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `resolution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Resolution Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `resolution_type` SET TAGS ('dbx_business_glossary_term' = 'Resolution Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `resolution_type` SET TAGS ('dbx_value_regex' = 'credit_issued|invoice_corrected|upheld|partial_credit');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` SET TAGS ('dbx_subdomain' = 'invoice_management');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` SET TAGS ('dbx_fhir_resource' = 'Basic');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `billing_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Calendar Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `parent_billing_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Billing Calendar Id');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `parent_billing_calendar_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_approval_by` SET TAGS ('dbx_business_glossary_term' = 'Calendar Approval By');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_approval_comments` SET TAGS ('dbx_business_glossary_term' = 'Calendar Approval Comments');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_approval_date` SET TAGS ('dbx_business_glossary_term' = 'Calendar Approval Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_approval_status` SET TAGS ('dbx_business_glossary_term' = 'Calendar Approval Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_approval_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_code` SET TAGS ('dbx_business_glossary_term' = 'Calendar Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_created_at` SET TAGS ('dbx_business_glossary_term' = 'Calendar Created At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_description` SET TAGS ('dbx_business_glossary_term' = 'Calendar Cycle Description');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_frequency` SET TAGS ('dbx_business_glossary_term' = 'Calendar Cycle Frequency');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_name` SET TAGS ('dbx_business_glossary_term' = 'Calendar Cycle Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_name` SET TAGS ('dbx_pii_type' = 'name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_unit` SET TAGS ('dbx_business_glossary_term' = 'Calendar Cycle Unit');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_description` SET TAGS ('dbx_business_glossary_term' = 'Calendar Description');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_effective_date` SET TAGS ('dbx_business_glossary_term' = 'Calendar Effective Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_effective_date` SET TAGS ('dbx_fhir_element' = 'period.start');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_end_date` SET TAGS ('dbx_business_glossary_term' = 'Calendar End Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Calendar Expiration Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_frequency` SET TAGS ('dbx_business_glossary_term' = 'Calendar Frequency');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_active` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Active');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_approved` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Approved');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_current` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Current');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_default` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Default');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_legacy` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Legacy');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_public` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Public');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_restricted` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Restricted');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_is_supplemental` SET TAGS ('dbx_business_glossary_term' = 'Calendar Is Supplemental');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_name` SET TAGS ('dbx_business_glossary_term' = 'Calendar Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_name` SET TAGS ('dbx_pii_type' = 'name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_notes` SET TAGS ('dbx_business_glossary_term' = 'Calendar Notes');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_start_date` SET TAGS ('dbx_business_glossary_term' = 'Calendar Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_status` SET TAGS ('dbx_business_glossary_term' = 'Calendar Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_type` SET TAGS ('dbx_business_glossary_term' = 'Calendar Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_type_description` SET TAGS ('dbx_business_glossary_term' = 'Calendar Type Description');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_updated_at` SET TAGS ('dbx_business_glossary_term' = 'Calendar Updated At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version` SET TAGS ('dbx_business_glossary_term' = 'Calendar Version');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_created_at` SET TAGS ('dbx_business_glossary_term' = 'Calendar Version Created At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_created_by` SET TAGS ('dbx_business_glossary_term' = 'Calendar Version Created By');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_number` SET TAGS ('dbx_business_glossary_term' = 'Calendar Version Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_updated_at` SET TAGS ('dbx_business_glossary_term' = 'Calendar Version Updated At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_version_updated_by` SET TAGS ('dbx_business_glossary_term' = 'Calendar Version Updated By');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `fiscal_day` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Day');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `fiscal_month` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Month');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `fiscal_quarter` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Quarter');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `fiscal_week` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Week');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `fiscal_year` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Year');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_subdomain' = 'subsidy_reconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_source' = 'claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_fhir_interop' = 'ready');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_of' = 'claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ecm_canonical' = 'v2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_status' = 'duplicate_deprecated');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot' = 'payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_concept' = 'payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_role' = 'canonical');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_fhir_resource' = 'Organization');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_interop' = 'fhir');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_duplicate' = 'payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_ref' = 'claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_alias_of' = 'claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_specialization' = 'claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_owner' = 'claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_ssot_group' = 'payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_id` SET TAGS ('dbx_business_glossary_term' = 'Payer Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `legal_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Legal Entity Id');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `legal_entity_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `legal_entity_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `parent_payer_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Payer Id');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `parent_payer_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_business_glossary_term' = 'Payer Address Line1');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_fhir_element' = 'address.line');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line1` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_business_glossary_term' = 'Payer Address Line2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_fhir_element' = 'address.line');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_address_line2` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_balance_due` SET TAGS ('dbx_business_glossary_term' = 'Payer Balance Due');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_balance_outstanding` SET TAGS ('dbx_business_glossary_term' = 'Payer Balance Outstanding');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_balance_paid` SET TAGS ('dbx_business_glossary_term' = 'Payer Balance Paid');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_city` SET TAGS ('dbx_business_glossary_term' = 'Payer City');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_city` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_communication_contact_preference` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Contact Preference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_communication_language` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Language');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_communication_language` SET TAGS ('dbx_fhir_element' = 'communication.language');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_communication_method` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_communication_preference` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Preference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_communication_time_zone` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Time Zone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Email');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_pii_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_fhir_element' = 'telecom.email');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_email` SET TAGS ('dbx_fhir' = 'telecom');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_pii' = 'person_name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_fhir_element' = 'name.text');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_name` SET TAGS ('dbx_fhir' = 'name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_fhir_element' = 'telecom.phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_phone` SET TAGS ('dbx_fhir' = 'telecom');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_contact_role` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Role');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_country` SET TAGS ('dbx_business_glossary_term' = 'Payer Country');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_country` SET TAGS ('dbx_fhir_element' = 'address.country');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_created_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Created At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_credit_limit` SET TAGS ('dbx_business_glossary_term' = 'Payer Credit Limit');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_currency` SET TAGS ('dbx_business_glossary_term' = 'Payer Currency');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_ein` SET TAGS ('dbx_business_glossary_term' = 'Payer Ein');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_ein` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_ein` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_business_glossary_term' = 'Payer Email');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_pii_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_fhir_element' = 'telecom.email');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_email` SET TAGS ('dbx_fhir' = 'telecom');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_business_glossary_term' = 'Payer Fax');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_fhir_element' = 'telecom.phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_fax` SET TAGS ('dbx_fhir' = 'telecom');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_language` SET TAGS ('dbx_business_glossary_term' = 'Payer Language');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_language` SET TAGS ('dbx_fhir_element' = 'communication.language');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_last_payment_amount` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_last_payment_date` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_last_payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_last_payment_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_last_payment_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_legal_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Legal Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_legal_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_legal_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_legal_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_payment_terms` SET TAGS ('dbx_business_glossary_term' = 'Payer Payment Terms');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_business_glossary_term' = 'Payer Phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_fhir_element' = 'telecom.phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_phone` SET TAGS ('dbx_fhir' = 'telecom');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Payer Postal Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_fhir_element' = 'address.postalCode');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_fhir' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_state` SET TAGS ('dbx_business_glossary_term' = 'Payer State');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_state` SET TAGS ('dbx_pii_type' = 'address');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_status` SET TAGS ('dbx_fhir_element' = 'status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_tax_number` SET TAGS ('dbx_business_glossary_term' = 'Payer Tax Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_tax_number` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_tax_number` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_tax_number` SET TAGS ('dbx_denormalized_natural_key' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_tax_number` SET TAGS ('dbx_ssot' = 'owning_entity_via_fk');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_time_zone` SET TAGS ('dbx_business_glossary_term' = 'Payer Time Zone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_type` SET TAGS ('dbx_business_glossary_term' = 'Payer Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_updated_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Updated At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_website` SET TAGS ('dbx_business_glossary_term' = 'Payer Website');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `ssot_payer_ref_id` SET TAGS ('dbx_business_glossary_term' = 'Cross-reference to SSOT payer in claim.payer');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `ssot_payer_ref_id` SET TAGS ('dbx_ssot_xref' = 'payer');
