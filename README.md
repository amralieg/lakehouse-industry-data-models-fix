...
Verified end to end on live installs: `restaurants` MVM at 10 rows landed 87 tables with 0 duplicate primary keys and **0 orphans across 506 foreign keys** (338 of them cross-domain), audited directly against `information_schema` rather than trusted from the generator.
