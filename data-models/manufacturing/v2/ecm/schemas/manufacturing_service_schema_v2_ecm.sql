...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`satisfaction_survey` (
    ...
    `service_contract_id` BIGINT COMMENT 'add column service_contract_id (BIGINT) with FK to service.service_contract.service_contract_id - satisfaction surveys measure contract service quality',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`knowledge_article` (
    ...
    `sku_master_id` BIGINT COMMENT 'add column product_sku_master_id (BIGINT) with FK to product.sku_master.sku_master_id - knowledge articles are typically product-specific technical documentation',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`bulletin` (
    ...
    `sku_master_id` BIGINT COMMENT 'add column product_sku_master_id (BIGINT) with FK to product.sku_master.sku_master_id - service bulletins apply to specific products requiring notification',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`remote_diagnostic_session` (
    ...
    `device_registry_id` BIGINT COMMENT 'add column device_registry_id (BIGINT) with FK to automation.device_registry.device_registry_id - remote diagnostics connect to specific IoT devices',
    ...
    `request_id` BIGINT COMMENT 'add column service_request_id (BIGINT) with FK to service.request.request_id - diagnostic sessions are initiated from service requests',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`contract_line` (
    ...
    `equipment_register_id` BIGINT COMMENT 'add column equipment_register_id (BIGINT) with FK to asset.equipment_register.equipment_register_id - service contract lines often cover specific equipment assets',
    `sku_master_id` BIGINT COMMENT 'add column product_sku_master_id (BIGINT) with FK to product.sku_master.sku_master_id - service contract lines must specify which product/SKU is covered',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`service`.`engineer_assignment` (
    ...
    `field_service_order_id` BIGINT COMMENT 'add column field_service_order_id (BIGINT) with FK to service.field_service_order.field_service_order_id - engineer assignments should link to the service order being worked',
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`satisfaction_survey` ADD CONSTRAINT `fk_service_satisfaction_survey_service_contract_id` FOREIGN KEY (`service_contract_id`) REFERENCES `vibe_manufacturing_v1`.`service`.`service_contract`(`service_contract_id`);
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract` SET TAGS ('dbx_subdomain' = 'contract_entitlement');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract` ALTER COLUMN `regulatory_requirement_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Requirement Id (Foreign Key)');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_warranty` SET TAGS ('dbx_subdomain' = 'warranty_coverage');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_rma` SET TAGS ('dbx_subdomain' = 'warranty_coverage');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`installed_base` SET TAGS ('dbx_subdomain' = 'warranty_coverage');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_entitlement` SET TAGS ('dbx_subdomain' = 'contract_entitlement');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`knowledge_article` SET TAGS ('dbx_subdomain' = 'knowledge_support');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`bulletin` SET TAGS ('dbx_subdomain' = 'knowledge_support');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_pm_schedule` SET TAGS ('dbx_subdomain' = 'contract_entitlement');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_contract_line` SET TAGS ('dbx_subdomain' = 'contract_entitlement');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`remote_diagnostic_session` SET TAGS ('dbx_subdomain' = 'request_management');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`contract_line` SET TAGS ('dbx_subdomain' = 'contract_entitlement');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`service_center` SET TAGS ('dbx_subdomain' = 'knowledge_support');
...
ALTER TABLE `vibe_manufacturing_v1`.`service`.`holiday_calendar` SET TAGS ('dbx_subdomain' = 'knowledge_support');
