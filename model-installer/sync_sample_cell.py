...
WIDGETS_ANCHOR = 'dbutils.widgets.text("local_install", "", "7. local install (blank = pull from repo)")'
WIDGETS_ADD = '''
...
def main():
    ...
    src = apply_edit(src, WIDGETS_ANCHOR, WIDGETS_ANCHOR + WIDGETS_ADD, "sample widgets", report)
