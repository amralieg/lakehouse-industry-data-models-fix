-- Schema for Domain: utilization | Business:  | Version: v3_ecm
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` (
    ...
    `originating_pa_request_id` BIGINT COMMENT 'Identifier of the prior authorization request linked to this review.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`utilization`.`um_reviewer` (
    ...
    `record_id` BIGINT COMMENT 'add column credential_record_id (BIGINT) with FK to credential.record.record_id - UM reviewers require clinical credentials for medical necessity determinations',
    `employee_id` BIGINT COMMENT 'add column workforce_employee_id (BIGINT) with FK to workforce.employee.employee_id - UM reviewers are internal staff members requiring workforce linkage',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`utilization`.`um_delegation` (
    ...
    `contract_provider_contract_id` BIGINT COMMENT 'Identifier linking to the contract provider contract',
    ...
    `vendor_id` BIGINT COMMENT 'add column vendor_vendor_id (BIGINT) with FK to vendor.vendor.vendor_id - UM delegation is to external vendor organizations',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`utilization`.`clinical_criteria` (
    ...
    `vendor_id` BIGINT COMMENT 'add column vendor_vendor_id (BIGINT) with FK to vendor.vendor.vendor_id - clinical criteria sets like InterQual/MCG are licensed from vendors',
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ADD CONSTRAINT `fk_utilization_peer_to_peer_review_originating_pa_request_id` FOREIGN KEY (`originating_pa_request_id`) REFERENCES `vibe_health_insurance_v1`.`utilization`.`pa_request`(`pa_request_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_request` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_request` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_request` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_request` ALTER COLUMN `appeal_deadline_date` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_decision` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`auth_service_line` ALTER COLUMN `record_id` SET TAGS ('dbx_business_glossary_term' = 'Credential Record Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`auth_service_line` ALTER COLUMN `vendor_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`concurrent_review` ALTER COLUMN `audit_engagement_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Engagement Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`concurrent_review` ALTER COLUMN `discharge_destination` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`retrospective_review` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`retrospective_review` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`retrospective_review` ALTER COLUMN `provider_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`retrospective_review` ALTER COLUMN `provider_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`retrospective_review` ALTER COLUMN `compliance_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`retrospective_review` ALTER COLUMN `retro_review_deadline_flag` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` SET TAGS ('dbx_subdomain' = 'clinical_review');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `originating_pa_request_id` SET TAGS ('dbx_business_glossary_term' = 'Associated Prior Authorization Request ID');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `originating_pa_request_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `originating_pa_request_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `pa_request_id` SET TAGS ('dbx_renamed_from' = 'pa_request_id');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Requesting Provider Provider Provider Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `provider_id` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `deadline_compliance_flag` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`peer_to_peer_review` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`tat_compliance_event` SET TAGS ('dbx_subdomain' = 'program_oversight');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`tat_compliance_event` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`tat_compliance_event` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`tat_compliance_event` ALTER COLUMN `provider_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`tat_compliance_event` ALTER COLUMN `provider_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`tat_compliance_event` ALTER COLUMN `regulatory_reporting_period` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_case` SET TAGS ('dbx_subdomain' = 'program_oversight');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_case` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_case` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Contract Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_case` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_case` ALTER COLUMN `assigned_nurse_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_case` ALTER COLUMN `primary_provider_npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_reviewer` SET TAGS ('dbx_subdomain' = 'program_oversight');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_reviewer` ALTER COLUMN `compliance_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_reviewer` ALTER COLUMN `license_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_notification` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID (PROV_ID)');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_notification` ALTER COLUMN `provider_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_notification` ALTER COLUMN `provider_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`pa_notification` ALTER COLUMN `compliance_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`inpatient_admission` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program` SET TAGS ('dbx_subdomain' = 'program_oversight');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program` ALTER COLUMN `program_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_delegation` SET TAGS ('dbx_subdomain' = 'program_oversight');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_delegation` ALTER COLUMN `delegated_entity_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`medical_policy` SET TAGS ('dbx_subdomain' = 'episode_intelligence');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`medical_policy` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`medical_policy` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`medical_policy` ALTER COLUMN `policy_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`bed_day_review` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`bed_day_review` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`bed_day_review` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Provider Provider Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`bed_day_review` ALTER COLUMN `reviewer_npi` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` SET TAGS ('dbx_subdomain' = 'program_oversight');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` ALTER COLUMN `um_program_enrollment_id` SET TAGS ('dbx_business_glossary_term' = 'Um Program Enrollment - Um Program Enrollment Id');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` ALTER COLUMN `group_id` SET TAGS ('dbx_business_glossary_term' = 'Um Program Enrollment - Employer Group Id');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` ALTER COLUMN `um_program_id` SET TAGS ('dbx_business_glossary_term' = 'Um Program Enrollment - Um Program Id');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` ALTER COLUMN `contribution_strategy` SET TAGS ('dbx_business_glossary_term' = 'Contribution Strategy');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Enrollment End Date');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`um_program_enrollment` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`clinical_criteria` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`clinical_criteria` SET TAGS ('dbx_subdomain' = 'episode_intelligence');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`clinical_criteria` ALTER COLUMN `criteria_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` SET TAGS ('dbx_subdomain' = 'episode_intelligence');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Id');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `primary_diagnosis_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `primary_diagnosis_code` SET TAGS ('dbx_pii_health' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `primary_diagnosis_code` SET TAGS ('dbx_classification' = 'restricted');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `primary_diagnosis_code` SET TAGS ('dbx_pii_pii' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `secondary_diagnosis_codes` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `secondary_diagnosis_codes` SET TAGS ('dbx_pii_health' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `secondary_diagnosis_codes` SET TAGS ('dbx_classification' = 'restricted');
ALTER TABLE `vibe_health_insurance_v1`.`utilization`.`episode_of_care` ALTER COLUMN `secondary_diagnosis_codes` SET TAGS ('dbx_pii_pii' = 'true');
