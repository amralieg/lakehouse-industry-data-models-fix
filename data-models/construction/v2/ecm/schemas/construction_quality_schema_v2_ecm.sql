...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`weld_record` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Weld quality records must link the welding contractor (firm) for compliance and payment verification.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`defect` (
    ...
    `firm_profile_id` BIGINT COMMENT 'System identifier for the contractor or firm responsible for rectifying the defect.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`punch_list` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Punch list responsibility matrix must reference the firm responsible for each item to drive close‑out.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`quality_submittal` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Submittal tracking requires linking each submittal to the originating firm for approval workflow.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`ndt_record` (
    ...
    `craft_worker_id` BIGINT COMMENT 'add column craft_worker_id (BIGINT) with FK to workforce.craft_worker.craft_worker_id - NDT records must identify the certified NDT technician who performed the test',
    ...
    `employee_id` BIGINT COMMENT 'add column employee_id (BIGINT) with FK to hr.employee.employee_id - NDT records need an approver/reviewer responsible for accepting results',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`lab_test` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Lab test results must be tied to the firm that supplied the material for traceability and claim handling.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`quality`.`laboratory` (
    ...
    `construction_project_id` BIGINT COMMENT 'add column construction_project_id (BIGINT) with FK to project.construction_project.construction_project_id - laboratories (especially site labs) serve specific projects for material testing',
...
ALTER TABLE `vibe_construction_v1`.`quality`.`itp` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`itp` ALTER COLUMN `client_inspector_responsible_party` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`inspection` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ncr` ALTER COLUMN `esg_report_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Report Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ncr` ALTER COLUMN `permit_condition_id` SET TAGS ('dbx_pii_health' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ALTER COLUMN `quaternary_corrective_last_modified_by_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By ID');
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ALTER COLUMN `quaternary_corrective_last_modified_by_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ALTER COLUMN `quaternary_corrective_last_modified_by_employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ALTER COLUMN `quaternary_corrective_last_modified_by_employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`corrective_action` ALTER COLUMN `tertiary_corrective_created_by_employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist` ALTER COLUMN `permit_condition_id` SET TAGS ('dbx_pii_health' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `site_construction_project_id` SET TAGS ('dbx_business_glossary_term' = 'Site ID');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `tertiary_checklist_approved_by_employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `inspector_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `inspector_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `inspector_remarks` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `inspector_signature_captured` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `inspector_signature_timestamp` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `witness_required_flag` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `witness_signature_captured` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`checklist_execution` ALTER COLUMN `witness_signature_timestamp` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` SET TAGS ('dbx_subdomain' = 'material_testing');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` ALTER COLUMN `craft_worker_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` ALTER COLUMN `ndt_inspector_certification` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` ALTER COLUMN `weld_position` SET TAGS ('dbx_pii_location' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` ALTER COLUMN `welder_stamp` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` ALTER COLUMN `witness_organization` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`weld_record` ALTER COLUMN `witness_required_flag` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` SET TAGS ('dbx_subdomain' = 'material_testing');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `client_representative_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `client_representative_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `modified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `test_engineer_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `test_engineer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `witness_party` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`acceptance_test` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `assigned_to` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `dlp_expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `identified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `location_building` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `modified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `verified_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
ALTER TABLE `vibe_construction_v1`.`quality`.`defect` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`punch_list` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`punch_list` ALTER COLUMN `client_representative` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`punch_item` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `approved_by_role` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `client_approved_by_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `client_approved_by_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `modified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `prepared_by_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `prepared_by_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `prepared_by_role` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `quality_manager_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `quality_manager_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `reviewed_by_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `reviewed_by_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `reviewed_by_role` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `subcontractor_quality_management` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_plan` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` SET TAGS ('dbx_subdomain' = 'inspection_planning');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `auditee_representative_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `auditee_representative_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `auditor_organization` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `closed_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `lead_auditor_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `lead_auditor_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `modified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_audit` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `contractor_response` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `modified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `reviewer_comments` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `reviewer_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `reviewer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `reviewer_organization` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`quality_submittal` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` SET TAGS ('dbx_subdomain' = 'material_testing');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `craft_worker_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `equipment_serial_number` SET TAGS ('dbx_pii_device' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `modified_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `technician_certification_expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `technician_certification_level` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `technician_certification_number` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `technician_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `technician_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `witness_party` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`ndt_record` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`concrete_pour_record` ALTER COLUMN `carbon_emission_id` SET TAGS ('dbx_business_glossary_term' = 'Carbon Emission Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`concrete_pour_record` ALTER COLUMN `supplier_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` SET TAGS ('dbx_subdomain' = 'material_testing');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `firm_profile_id` SET TAGS ('dbx_business_glossary_term' = 'Contractor Sub Firm Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `laboratory_name` SET TAGS ('dbx_business_glossary_term' = 'Laboratory Name');
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `laboratory_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `laboratory_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `result_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `reviewed_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `sampled_by` SET TAGS ('dbx_business_glossary_term' = 'Sampled By');
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `sampled_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `supplier_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `test_age_days` SET TAGS ('dbx_pii_dob' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `tested_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`lab_test` ALTER COLUMN `witness_required` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` SET TAGS ('dbx_subdomain' = 'material_testing');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` ALTER COLUMN `parent_sample_id` SET TAGS ('dbx_pii_contact' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` ALTER COLUMN `collected_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` ALTER COLUMN `sample_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` ALTER COLUMN `sample_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`sample` ALTER COLUMN `test_result_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` SET TAGS ('dbx_subdomain' = 'material_testing');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `parent_laboratory_id` SET TAGS ('dbx_pii_contact' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `accreditation_expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `capacity_tests_per_day` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `capacity_tests_per_day` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `country_code` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `latitude` SET TAGS ('dbx_pii_location' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `longitude` SET TAGS ('dbx_pii_location' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `laboratory_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `laboratory_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`quality`.`laboratory` ALTER COLUMN `region` SET TAGS ('dbx_pii_address' = 'true');
