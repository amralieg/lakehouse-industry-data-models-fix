-- Schema for Domain: billing | Business:  | Version: v3_ecm
-- Generated on: 2026-07-10 20:47:13
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` (
    ...
    `service_area_id` BIGINT COMMENT 'Foreign key linking to network.service_area. Business justification: Invoices are generated per service area to satisfy network adequacy reporting and state filing requirements.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`account` (
    ...
    `number` STRING COMMENT 'External account number assigned to the billing entity for invoicing and payment processing.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` (
    ...
    `number` STRING COMMENT 'External business identifier for the grace period, used in reporting and member communications.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` (
    ...
    `premium_invoice_id` BIGINT COMMENT 'add column billing_premium_invoice_id (BIGINT) with FK to billing.premium_invoice.premium_invoice_id - retroactive adjustments apply to specific invoices',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` (
    ...
    `health_plan_id` BIGINT COMMENT 'add column plan_health_plan_id (BIGINT) with FK to plan.health_plan.health_plan_id - APTC subsidies are specific to ACA marketplace plans',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` (
    ...
    `inspector_employee_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` (
    ...
    `health_plan_id` BIGINT COMMENT 'add column plan_health_plan_id (BIGINT) with FK to plan.health_plan.health_plan_id - rate schedules must be associated with specific health plans for premium calculation',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` (
    ...
    `claim_payer_id` BIGINT COMMENT 'FK to SSOT owner claim.payer for entity payer',
    ...
    `billing_payer_name` STRING COMMENT 'Human-readable name of the payer entity.',
    `payer_postal_code` STRING COMMENT 'Postal code of the payer',
    ...
    `billing_payer_status` STRING COMMENT 'Current lifecycle status of the payer.',
    ...
    `billing_payer_type` STRING COMMENT 'Category of the payer (e.g., insurer, employer, government, third‑party administrator).',
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` ADD CONSTRAINT `fk_billing_retro_adjustment_premium_invoice_id` FOREIGN KEY (`premium_invoice_id`) REFERENCES `vibe_health_insurance_v1`.`billing`.`premium_invoice`(`premium_invoice_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `member_risk_score_id` SET TAGS ('dbx_business_glossary_term' = 'Member Risk Score Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `service_area_id` SET TAGS ('dbx_business_glossary_term' = 'Service Area Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_invoice` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`invoice_line` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_payment` ALTER COLUMN `adjustment_payment_id` SET TAGS ('dbx_business_glossary_term' = 'Risk Adjustment Payment Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `provider_network_id` SET TAGS ('dbx_business_glossary_term' = 'Network Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Account Number (ACC_NUM)');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `number` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `number` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`account` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` SET TAGS ('dbx_subdomain' = 'rate_configuration');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rating_area` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rating_area_reference` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `rating_method` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_rate` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` SET TAGS ('dbx_subdomain' = 'invoice_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `grace_period_description` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Grace Period Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `number` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `grace_period_status` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`grace_period` ALTER COLUMN `grace_period_type` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`retro_adjustment` SET TAGS ('dbx_subdomain' = 'invoice_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` SET TAGS ('dbx_subdomain' = 'invoice_management');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_refund` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`aptc_subsidy` SET TAGS ('dbx_subdomain' = 'subsidy_compliance');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` SET TAGS ('dbx_subdomain' = 'subsidy_compliance');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cms_remittance` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` SET TAGS ('dbx_subdomain' = 'rate_configuration');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cycle` ALTER COLUMN `grace_period_days` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` SET TAGS ('dbx_subdomain' = 'dispute_collections');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `um_case_id` SET TAGS ('dbx_business_glossary_term' = 'Um Case Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `reinstatement_conditions` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`collection_case` ALTER COLUMN `reinstatement_eligibility_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` SET TAGS ('dbx_subdomain' = 'rate_configuration');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_reconciliation` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` SET TAGS ('dbx_subdomain' = 'dispute_collections');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `initial_grace_period_days` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`cobra_billing` ALTER COLUMN `ongoing_grace_period_days` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` SET TAGS ('dbx_subdomain' = 'subsidy_compliance');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`edi_820` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Provider ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` SET TAGS ('dbx_subdomain' = 'subsidy_compliance');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `reporting_year` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`mlr_rebate` ALTER COLUMN `state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`payment_method` ALTER COLUMN `bank_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` SET TAGS ('dbx_subdomain' = 'dispute_collections');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`premium_statement` ALTER COLUMN `inspector_employee_id` SET TAGS ('dbx_renamed_from' = 'employee_id');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` SET TAGS ('dbx_subdomain' = 'rate_configuration');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_area` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_method` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `rating_methodology_details` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `regulatory_county` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `regulatory_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `schedule_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`rate_schedule` ALTER COLUMN `state_doi_filing_number` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` SET TAGS ('dbx_subdomain' = 'dispute_collections');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_dispute` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` SET TAGS ('dbx_subdomain' = 'rate_configuration');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_cycle_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_calendar` ALTER COLUMN `calendar_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` SET TAGS ('dbx_subdomain' = 'dispute_collections');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_id` SET TAGS ('dbx_ssot_owner' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_id` SET TAGS ('dbx_ssot_entity' = 'payer');
...
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `address_line1` SET TAGS ('dbx_business_glossary_term' = 'Payer Address Line1');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `address_line1` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `address_line1` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `address_line2` SET TAGS ('dbx_business_glossary_term' = 'Payer Address Line2');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `address_line2` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `address_line2` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `balance_due` SET TAGS ('dbx_business_glossary_term' = 'Payer Balance Due');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `balance_outstanding` SET TAGS ('dbx_business_glossary_term' = 'Payer Balance Outstanding');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `balance_paid` SET TAGS ('dbx_business_glossary_term' = 'Payer Balance Paid');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `city` SET TAGS ('dbx_business_glossary_term' = 'Payer City');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `city` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `communication_contact_preference` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Contact Preference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `communication_language` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Language');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `communication_method` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `communication_preference` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Preference');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `communication_time_zone` SET TAGS ('dbx_business_glossary_term' = 'Payer Communication Time Zone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_email` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Email');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_email` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_email` SET TAGS ('dbx_pii_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_phone` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `contact_role` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Role');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `country` SET TAGS ('dbx_business_glossary_term' = 'Payer Country');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `created_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Created At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `credit_limit` SET TAGS ('dbx_business_glossary_term' = 'Payer Credit Limit');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `currency` SET TAGS ('dbx_business_glossary_term' = 'Payer Currency');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `ein` SET TAGS ('dbx_business_glossary_term' = 'Payer Ein');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `ein` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `ein` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `email` SET TAGS ('dbx_business_glossary_term' = 'Payer Email');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `email` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `email` SET TAGS ('dbx_pii_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `fax` SET TAGS ('dbx_business_glossary_term' = 'Payer Fax');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `fax` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `fax` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `language` SET TAGS ('dbx_business_glossary_term' = 'Payer Language');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `last_payment_amount` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Amount');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `last_payment_date` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Date');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `last_payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Method');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `last_payment_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Last Payment Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `legal_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Legal Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `legal_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `legal_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Name');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payer_postal_code` SET TAGS ('dbx_pii_location' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `payment_terms` SET TAGS ('dbx_business_glossary_term' = 'Payer Payment Terms');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `phone` SET TAGS ('dbx_business_glossary_term' = 'Payer Phone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `postal_code` SET TAGS ('dbx_business_glossary_term' = 'Payer Postal Code');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `postal_code` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `postal_code` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `state` SET TAGS ('dbx_business_glossary_term' = 'Payer State');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `state` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Status');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `tax_number` SET TAGS ('dbx_business_glossary_term' = 'Payer Tax Number');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `tax_number` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `tax_number` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `time_zone` SET TAGS ('dbx_business_glossary_term' = 'Payer Time Zone');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `billing_payer_type` SET TAGS ('dbx_business_glossary_term' = 'Payer Type');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `updated_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Updated At');
ALTER TABLE `vibe_health_insurance_v1`.`billing`.`billing_payer` ALTER COLUMN `website` SET TAGS ('dbx_business_glossary_term' = 'Payer Website');
