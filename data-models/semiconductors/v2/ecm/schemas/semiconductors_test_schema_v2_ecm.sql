...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`test`.`ate_configuration` (
    ...
    `site_id` BIGINT COMMENT 'P4: Add column site_id (BIGINT) to shared.ate_configuration with FK to shared.site.site_id because ATE configurations are physically located at test floors/sites. P4: connect_table: shared.ate_configuration** - add column site_id (BIGINT) with ',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`test`.`unit_test_result` (
    ...
    `unit_bin_definition_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`test`.`coverage` (
    ...
    `pct` DECIMAL(18,2) COMMENT 'Overall test coverage percentage',
    `percent` DECIMAL(18,2) COMMENT '',
    ...
    `toggle_coverage` STRING COMMENT 'Toggle coverage percentage',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`test`.`reliability_test_run` (
    ...
    `reliability_test_program_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` (
    ...
    `ate_configuration_id` BIGINT COMMENT '',
    ...
    `program_employee_id` BIGINT COMMENT '',
    `test_program_id` BIGINT COMMENT 'Foreign key linking to the test program',
    `actual_completion_date` DATE COMMENT 'Actual date when the test assignment was completed',
    ...
    `expected_test_duration_hours` DECIMAL(18,2) COMMENT 'Expected duration of the test run in hours',
    `expected_test_time_seconds` DECIMAL(18,2) COMMENT 'Expected test execution time in seconds per unit',
    `insertion_sequence` STRING COMMENT '',
    `insertion_type` STRING COMMENT 'Test insertion type (Wafer Probe, Final Test, etc.)',
    `is_active` BOOLEAN COMMENT '',
    `is_retest_flag` BOOLEAN COMMENT 'Whether this is a retest assignment',
    `notes` STRING COMMENT 'Free-text notes about the assignment',
    `override_reason` STRING COMMENT 'Reason if the standard program assignment was overridden',
    `priority` STRING COMMENT '',
    `priority_level` STRING COMMENT 'Priority level for test scheduling',
    `program_assignment_status` STRING COMMENT 'Current status of the test program assignment for the wafer lot',
    `target_completion_date` DATE COMMENT 'Target date for completing the test assignment',
    `temperature_condition` STRING COMMENT 'Temperature condition for testing (e.g., room, hot, cold, tri-temp)',
    `test_insertion` STRING COMMENT 'Test insertion point (wafer_probe, final_test, burn_in)',
    `test_temperature_c` DECIMAL(18,2) COMMENT 'Test temperature in Celsius',
    `updated_timestamp` TIMESTAMP COMMENT 'Record last update timestamp',
    `assigned_date` DATE COMMENT 'Date of assignment',
    `coverage_percentage` DECIMAL(18,2) COMMENT 'Test coverage percentage',
    `estimated_duration` BIGINT COMMENT 'Estimated duration in hours',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`test`.`test_step` (
    ...
    `step_sequence_number` STRING COMMENT '',
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`unit_test_result` ADD CONSTRAINT `fk_test_unit_test_result_unit_bin_definition_id` FOREIGN KEY (`unit_bin_definition_id`) REFERENCES `vibe_semiconductors_v1`.`test`.`bin_definition`(`bin_definition_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`test_program` ALTER COLUMN `finished_good_id` SET TAGS ('dbx_business_glossary_term' = 'Finished Good Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`ate_configuration` SET TAGS ('dbx_subdomain' = 'equipment_setup');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`probe_card` SET TAGS ('dbx_subdomain' = 'equipment_setup');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`wafer_probe_run` ALTER COLUMN `test_program_id` SET TAGS ('dbx_renamed_from' = 'test_program_id');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`final_test_run` ALTER COLUMN `device_architecture_id` SET TAGS ('dbx_business_glossary_term' = 'Device Architecture Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`parametric_measurement` ALTER COLUMN `fabrication_process_step_id` SET TAGS ('dbx_business_glossary_term' = 'Test Step Identifier (STEP_ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`coverage` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`coverage` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`reliability_test_run` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`reliability_test_run` SET TAGS ('dbx_subdomain' = 'execution_results');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`correlation_study` SET TAGS ('dbx_subdomain' = 'quality_analysis');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`correlation_study` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`insertion` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`insertion` SET TAGS ('dbx_subdomain' = 'equipment_setup');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`insertion` ALTER COLUMN `fab_tool_id` SET TAGS ('dbx_business_glossary_term' = 'Fab Tool Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`adaptive_test_flow` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`adaptive_test_flow` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `program_assignment_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Assignment - Test Program Assignment Id');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `inventory_wafer_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Assignment - Inventory Wafer Lot Id');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned By');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `test_program_id` SET TAGS ('dbx_business_glossary_term' = 'Test Program Assignment - Test Program Id');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `actual_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Completion Date');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `expected_test_duration_hours` SET TAGS ('dbx_business_glossary_term' = 'Expected Test Duration');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `expected_test_time_seconds` SET TAGS ('dbx_business_glossary_term' = 'Expected Test Time');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `is_retest_flag` SET TAGS ('dbx_business_glossary_term' = 'Retest Flag');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Assignment Notes');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Priority Level');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `program_assignment_status` SET TAGS ('dbx_business_glossary_term' = 'Assignment Status');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `target_completion_date` SET TAGS ('dbx_business_glossary_term' = 'Target Completion Date');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `temperature_condition` SET TAGS ('dbx_business_glossary_term' = 'Temperature Condition');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `test_insertion` SET TAGS ('dbx_business_glossary_term' = 'Test Insertion');
ALTER TABLE `vibe_semiconductors_v1`.`test`.`program_assignment` ALTER COLUMN `test_temperature_c` SET TAGS ('dbx_business_glossary_term' = 'Test Temperature');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`test_case` SET TAGS ('dbx_subdomain' = 'quality_analysis');
...
ALTER TABLE `vibe_semiconductors_v1`.`test`.`test_step` SET TAGS ('dbx_subdomain' = 'quality_analysis');
