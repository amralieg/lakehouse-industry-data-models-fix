...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`sales`.`forecast` (
    ...
    `sku_master_id` BIGINT COMMENT 'add column product_sku_master_id (BIGINT) with FK to product.sku_master.sku_master_id - sales forecasts must specify which products are being forecasted',
...
CREATE OR REPLACE TABLE `vibe_manufacturing_v1`.`sales`.`channel_partner` (
    ...
    `customer_account_id` BIGINT COMMENT 'add column customer_account_id (BIGINT) with FK to customer.customer_account.customer_account_id - channel partners are business entities that should link to customer master',
    ...
    `supplier_id` BIGINT COMMENT 'add column supplier_id (BIGINT) with FK to supplier.supplier.supplier_id - channel partners may also be suppliers requiring dual-role linkage',
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`territory` SET TAGS ('dbx_subdomain' = 'channel_performance');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`territory_assignment` SET TAGS ('dbx_subdomain' = 'channel_performance');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`rep` SET TAGS ('dbx_subdomain' = 'channel_performance');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`quota` SET TAGS ('dbx_subdomain' = 'channel_performance');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`channel_partner` SET TAGS ('dbx_subdomain' = 'channel_performance');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`project_rep_assignment` SET TAGS ('dbx_subdomain' = 'channel_performance');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`project_rep_assignment` ALTER COLUMN `rep_id` SET TAGS ('dbx_business_glossary_term' = 'Project Rep Assignment - Sales Rep Id');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`campaign` SET TAGS ('dbx_subdomain' = 'pipeline_management');
...
ALTER TABLE `vibe_manufacturing_v1`.`sales`.`sales_team` SET TAGS ('dbx_subdomain' = 'channel_performance');
