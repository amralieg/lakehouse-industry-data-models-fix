...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` (
    ...
    `center_line` DECIMAL(18,2) COMMENT '',
    ...
    `cp` STRING COMMENT 'Process capability index Cp',
    `cpk` STRING COMMENT 'Process capability index Cpk',
    ...
    `lcl` STRING COMMENT 'Lower control limit shorthand',
    ...
    `ucl` STRING COMMENT 'Upper control limit shorthand',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` (
    ...
    `process_step_id` BIGINT COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` (
    ...
    `qualification_standard` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` (
    ...
    `wafer_map_id` BIGINT COMMENT '',
    `inventory_kgd_certification_id` BIGINT COMMENT 'SSOT FK reference to canonical inventory.inventory_kgd_certification; this table is a secondary view and must not duplicate master data.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` (
    ...
    `compliance_audit_finding_id` BIGINT COMMENT 'FK reference to SSOT owner compliance.compliance_audit_finding resolving cross-domain duplicate',
...
) COMMENT 'Single source of truth (SSOT) for audit findings. Contains the canonical audit finding record referenced by compliance.compliance_audit_finding and other domains requiring audit finding data.';
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` (
    ...
    `evaluation_period_end` DECIMAL(18,2) COMMENT 'Last day of the reporting period covered by the scorecard.',
    `evaluation_period_start` DECIMAL(18,2) COMMENT 'First day of the reporting period covered by the scorecard.',
    ...
    `scorecard_status` DECIMAL(18,2) COMMENT 'Current lifecycle status of the scorecard record.',
    `scorecard_version` DECIMAL(18,2) COMMENT 'Version number of the scorecard for change‑tracking purposes.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` (
    ...
    `quality_employee_id` BIGINT COMMENT 'Identifier of the person who approved the hold release.',
    ...
    `expiration_timestamp` DECIMAL(18,2) COMMENT 'Optional date/time after which the hold is automatically cleared if not released.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` (
    ...
    `expiration_date` DECIMAL(18,2) COMMENT 'Date after which the qualification report is no longer valid (nullable).',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` (
    ...
    `complaint_description` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`wafer_zone` (
    ...
    `wafer_map_id` BIGINT COMMENT 'Parent wafer map (zones subdivide a wafer map).',
    ...
    `defect_density` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`defect_cluster` (
    ...
    `signature_pattern` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` (
    ...
    `employee_id` BIGINT COMMENT '',
    `fab_facility_id` BIGINT COMMENT 'Fab facility where MRB meeting occurs.',
    ...
    `disposition_summary` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` (
    ...
    `employee_id` BIGINT COMMENT 'Document owner employee.',
    ...
    `expiration_date` DECIMAL(18,2) COMMENT 'Date after which the document is no longer valid (nullable for indefinite validity).',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` (
    ...
    `ic_catalog_id` BIGINT COMMENT '',
    `employee_id` BIGINT COMMENT '',
    `parent_test_plan_id` BIGINT COMMENT 'Self-referencing FK on test_plan (related_test_plan_id)',
    ...
    `test_duration_estimate_minutes` DECIMAL(18,2) COMMENT 'Estimated total execution time for the test plan, in minutes.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`quality`.`control_plan` (
    ...
    `employee_id` BIGINT COMMENT '',
    `process_flow_id` BIGINT COMMENT 'Process flow governed by this control plan.',
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` ADD CONSTRAINT `fk_quality_test_plan_parent_test_plan_id` FOREIGN KEY (`parent_test_plan_id`) REFERENCES `vibe_semiconductors_v1`.`quality`.`test_plan`(`test_plan_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` SET TAGS ('dbx_subdomain' = 'inspection_control');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` SET TAGS ('dbx_ssot' = 'quality.inspection_lot');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` ALTER COLUMN `export_license_id` SET TAGS ('dbx_business_glossary_term' = 'Export License Id (Foreign Key)');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` ALTER COLUMN `fabrication_wafer_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Wafer Lot Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`inspection_lot` ALTER COLUMN `ic_design_project_id` SET TAGS ('dbx_business_glossary_term' = 'Ic Design Project Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_record` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_record` SET TAGS ('dbx_ssot' = 'quality.defect_record');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_record` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_record` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_map` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_map` SET TAGS ('dbx_ssot' = 'quality.wafer_map');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_map` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_map` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`yield_record` SET TAGS ('dbx_subdomain' = 'yield_performance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`yield_record` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`yield_record` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`yield_record` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` SET TAGS ('dbx_subdomain' = 'inspection_control');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` SET TAGS ('dbx_ssot' = 'quality.spc_chart');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Operator Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` ALTER COLUMN `wafer_id` SET TAGS ('dbx_business_glossary_term' = 'Wafer Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` ALTER COLUMN `parameter_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` ALTER COLUMN `spc_to_metrology` SET TAGS ('dbx_business_glossary_term' = 'Spc To Metrology');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`spc_chart` ALTER COLUMN `spc_to_spec` SET TAGS ('dbx_business_glossary_term' = 'Spc To Spec');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` SET TAGS ('dbx_subdomain' = 'risk_assurance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` SET TAGS ('dbx_ssot' = 'quality.fmea_record');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` ALTER COLUMN `action_owner` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` ALTER COLUMN `fmea_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`fmea_record` ALTER COLUMN `fmea_to_qualification` SET TAGS ('dbx_business_glossary_term' = 'Fmea To Qualification');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`reliability_test` SET TAGS ('dbx_subdomain' = 'risk_assurance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`reliability_test` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`reliability_test` SET TAGS ('dbx_ssot' = 'quality.reliability_test');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`reliability_test` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`reliability_test` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` SET TAGS ('dbx_subdomain' = 'risk_assurance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` SET TAGS ('dbx_ssot' = 'quality.quality_qualification_program');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` ALTER COLUMN `program_manager` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_qualification_program` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_subdomain' = 'risk_assurance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot' = 'secondary');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot_pair' = 'inventory.inventory_kgd_certification');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot_ref' = 'inventory.inventory_kgd_certification');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot_role' = 'replica');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot_for' = 'inventory.inventory_kgd_certification');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot_owner' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` SET TAGS ('dbx_ssot_authoritative' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` ALTER COLUMN `research_program_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Program Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_kgd_certification` ALTER COLUMN `inventory_kgd_certification_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`dppm_record` SET TAGS ('dbx_subdomain' = 'yield_performance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`dppm_record` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`dppm_record` SET TAGS ('dbx_ssot' = 'quality.dppm_record');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`dppm_record` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`dppm_record` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`capa_record` SET TAGS ('dbx_subdomain' = 'nonconformance_management');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`capa_record` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`capa_record` SET TAGS ('dbx_ssot' = 'quality.capa_record');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`capa_record` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`capa_record` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` SET TAGS ('dbx_subdomain' = 'nonconformance_management');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` SET TAGS ('dbx_ssot' = 'quality.nonconformance_report');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`nonconformance_report` ALTER COLUMN `export_license_id` SET TAGS ('dbx_business_glossary_term' = 'Export License Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_subdomain' = 'audit_governance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot_pair' = 'compliance.compliance_audit_finding');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot_owner' = 'audit_finding');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot' = 'quality.quality_audit_finding');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot_ref' = 'compliance.compliance_audit_finding');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot_role' = 'replica');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot_for' = 'compliance.compliance_audit_finding');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` SET TAGS ('dbx_ssot_authoritative' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` ALTER COLUMN `audit_event_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` ALTER COLUMN `compliance_audit_finding_id` SET TAGS ('dbx_ssot_reference' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_audit_finding` ALTER COLUMN `auditor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` SET TAGS ('dbx_subdomain' = 'audit_governance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` SET TAGS ('dbx_ssot' = 'quality.audit');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` ALTER COLUMN `auditor_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`audit` ALTER COLUMN `auditor_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_metrology_measurement` SET TAGS ('dbx_subdomain' = 'inspection_control');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_metrology_measurement` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_metrology_measurement` SET TAGS ('dbx_ssot' = 'quality.quality_metrology_measurement');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_metrology_measurement` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_metrology_measurement` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` SET TAGS ('dbx_subdomain' = 'audit_governance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` SET TAGS ('dbx_ssot' = 'quality.supplier_quality_scorecard');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`supplier_quality_scorecard` ALTER COLUMN `contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_spec` SET TAGS ('dbx_subdomain' = 'inspection_control');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_spec` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_spec` SET TAGS ('dbx_ssot' = 'quality.quality_spec');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_spec` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_spec` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` SET TAGS ('dbx_subdomain' = 'nonconformance_management');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` SET TAGS ('dbx_ssot' = 'quality.quality_hold');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` ALTER COLUMN `quality_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Hold Release Approver ID');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` ALTER COLUMN `quality_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_hold` ALTER COLUMN `quality_employee_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`failure_analysis_report` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`failure_analysis_report` SET TAGS ('dbx_ssot' = 'quality.failure_analysis_report');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`failure_analysis_report` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`failure_analysis_report` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_notification` SET TAGS ('dbx_subdomain' = 'nonconformance_management');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_notification` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_notification` SET TAGS ('dbx_ssot' = 'quality.quality_notification');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_notification` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_notification` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` SET TAGS ('dbx_subdomain' = 'risk_assurance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` SET TAGS ('dbx_ssot' = 'quality.qualification_report');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` ALTER COLUMN `customer_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`qualification_report` ALTER COLUMN `engineer_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` SET TAGS ('dbx_subdomain' = 'nonconformance_management');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` SET TAGS ('dbx_ssot' = 'quality.customer_complaint');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`customer_complaint` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Employee Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_zone` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_zone` SET TAGS ('dbx_ssot' = 'quality.wafer_zone');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_zone` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_zone` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`wafer_zone` ALTER COLUMN `zone_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_cluster` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_cluster` SET TAGS ('dbx_ssot' = 'quality.defect_cluster');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_cluster` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_cluster` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`defect_cluster` ALTER COLUMN `cluster_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` SET TAGS ('dbx_subdomain' = 'nonconformance_management');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` SET TAGS ('dbx_ssot' = 'quality.mrb_meeting');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` ALTER COLUMN `facilitator_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` ALTER COLUMN `facilitator_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` ALTER COLUMN `meeting_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`mrb_meeting` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` SET TAGS ('dbx_subdomain' = 'audit_governance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` SET TAGS ('dbx_ssot' = 'quality.quality_document');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` ALTER COLUMN `author_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`quality_document` ALTER COLUMN `reviewer_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` SET TAGS ('dbx_subdomain' = 'risk_assurance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` SET TAGS ('dbx_ssot' = 'quality.test_plan');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` SET TAGS ('dbx_ssot_role' = 'authoritative');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` ALTER COLUMN `parent_test_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Related Test Plan Id');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` ALTER COLUMN `parent_test_plan_id` SET TAGS ('dbx_self_ref_fk' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`test_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`control_plan` SET TAGS ('dbx_subdomain' = 'yield_performance');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`control_plan` SET TAGS ('dbx_domain' = 'quality');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`control_plan` SET TAGS ('dbx_ssot' = 'quality.control_plan');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`control_plan` SET TAGS ('dbx_mvm_ssot_resolved' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`quality`.`control_plan` SET TAGS ('dbx_ssot_role' = 'authoritative');
