...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`reference`.`ndc_drug` (
    ...
    `snomed_concept_id` BIGINT COMMENT 'Foreign key linking to reference.snomed_concept. Business justification: ndc_drug.snomed_ct_code is a denormalized STRING storing the SNOMED CT code for the drug substance. The snomed_concept table is the authoritative SNOMED CT catalog within the same reference domain. Re',
...
ALTER TABLE `vibe_healthcare_v1`.`reference`.`cpt_code` SET TAGS ('dbx_subdomain' = 'billing_standards');
...
ALTER TABLE `vibe_healthcare_v1`.`reference`.`hcpcs_code` SET TAGS ('dbx_subdomain' = 'billing_standards');
...
ALTER TABLE `vibe_healthcare_v1`.`reference`.`drg` SET TAGS ('dbx_subdomain' = 'billing_standards');
...
ALTER TABLE `vibe_healthcare_v1`.`reference`.`code_set_version` SET TAGS ('dbx_subdomain' = 'version_management');
...
ALTER TABLE `vibe_healthcare_v1`.`reference`.`crosswalk` SET TAGS ('dbx_subdomain' = 'version_management');
