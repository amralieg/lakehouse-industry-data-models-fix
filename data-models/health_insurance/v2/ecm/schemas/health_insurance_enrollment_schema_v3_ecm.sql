-- Schema for Domain: enrollment | Business:  | Version: v3_ecm
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`enrollment`.`event` (
    ...
    `timestamp` TIMESTAMP COMMENT 'Exact date‑time when the enrollment event occurred in the source system.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`enrollment`.`open_enrollment_period` (
    ...
    `health_plan_id` BIGINT COMMENT 'add column plan_health_plan_id (BIGINT) with FK to plan.health_plan.health_plan_id - open enrollment periods are specific to health plan offerings',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` (
    ...
    `number` STRING COMMENT 'Human-readable identifier for the enrollment batch, often used in reporting and communication.',
    ...
    `batch_status` STRING COMMENT 'Current lifecycle status of the batch.',
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`transaction` ALTER COLUMN `batch_id` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Batch Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`transaction` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`transaction` ALTER COLUMN `raps_submission_id` SET TAGS ('dbx_business_glossary_term' = 'Raps Submission Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`transaction` ALTER COLUMN `regulatory_submission_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Submission Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`transaction` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`event` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`event` ALTER COLUMN `risk_underwriting_case_id` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`event` ALTER COLUMN `timestamp` SET TAGS ('dbx_business_glossary_term' = 'Event Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`open_enrollment_period` ALTER COLUMN `enrollment_deadline_date` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`open_enrollment_period` ALTER COLUMN `period_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`edi_transaction` ALTER COLUMN `file_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`eligibility_verification` ALTER COLUMN `record_id` SET TAGS ('dbx_business_glossary_term' = 'Credential Record Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` SET TAGS ('dbx_subdomain' = 'coverage_elections');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` ALTER COLUMN `notice_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'payroll|credit_card|bank_transfer|check');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` ALTER COLUMN `payment_status` SET TAGS ('dbx_value_regex' = 'paid|unpaid|partial|failed');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` ALTER COLUMN `premium_currency` SET TAGS ('dbx_value_regex' = 'USD|CAD|EUR|GBP|JPY|AUD');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` ALTER COLUMN `premium_frequency` SET TAGS ('dbx_value_regex' = 'monthly|quarterly|annual');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cobra_election` ALTER COLUMN `subsidy_type` SET TAGS ('dbx_value_regex' = 'arp|none');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`plan_election` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`plan_election` SET TAGS ('dbx_subdomain' = 'coverage_elections');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`pend_queue` SET TAGS ('dbx_subdomain' = 'enrollment_processing');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`pend_queue` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`pend_queue` ALTER COLUMN `resolution_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicaid_eligibility` ALTER COLUMN `income_amount` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicaid_eligibility` ALTER COLUMN `income_verification_status` SET TAGS ('dbx_value_regex' = 'verified|unverified|pending');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicaid_eligibility` ALTER COLUMN `income_verification_status` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicaid_eligibility` ALTER COLUMN `state_agency` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicare_entitlement` SET TAGS ('dbx_subdomain' = 'coverage_elections');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicare_entitlement` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`medicare_entitlement` ALTER COLUMN `irmaa_income_bracket` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`reconciliation` SET TAGS ('dbx_subdomain' = 'submission_reconciliation');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`reconciliation` ALTER COLUMN `resolution_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` SET TAGS ('dbx_subdomain' = 'coverage_elections');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `effectuation_deadline` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `marketplace_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `payment_method` SET TAGS ('dbx_value_regex' = 'credit_card|bank_transfer|check|auto_debit');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `payment_status` SET TAGS ('dbx_value_regex' = 'paid|unpaid|partial|failed');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `premium_frequency` SET TAGS ('dbx_value_regex' = 'monthly|quarterly|annually');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `reporting_1095a_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `reporting_1095a_generated_date` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`exchange_enrollment` ALTER COLUMN `subsidy_type` SET TAGS ('dbx_value_regex' = 'aptc|csc|none');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`submission_batch` SET TAGS ('dbx_subdomain' = 'submission_reconciliation');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`enrollment_eligibility_span` ALTER COLUMN `regulatory_obligation_id` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Obligation Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`enrollment_eligibility_span` ALTER COLUMN `member_eligibility_span_id` SET TAGS ('dbx_business_glossary_term' = 'Member Eligibility Span Id (Foreign Key)');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`enrollment_eligibility_span` ALTER COLUMN `member_risk_score_id` SET TAGS ('dbx_business_glossary_term' = 'Member Risk Score Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`enrollment_eligibility_span` ALTER COLUMN `provider_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Care Provider Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` SET TAGS ('dbx_subdomain' = 'submission_reconciliation');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `batch_id` SET TAGS ('dbx_business_glossary_term' = 'Enrollment Batch Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `parent_enrollment_batch_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Enrollment Batch Id');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `parent_enrollment_batch_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `approval_by` SET TAGS ('dbx_business_glossary_term' = 'Batch Approval By');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `approval_comments` SET TAGS ('dbx_business_glossary_term' = 'Batch Approval Comments');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Batch Approval Status');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `approval_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Batch Approval Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `created_at` SET TAGS ('dbx_business_glossary_term' = 'Created At');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `batch_description` SET TAGS ('dbx_business_glossary_term' = 'Batch Description');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `effective_from` SET TAGS ('dbx_business_glossary_term' = 'Effective From');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `effective_until` SET TAGS ('dbx_business_glossary_term' = 'Effective Until');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `error_count` SET TAGS ('dbx_business_glossary_term' = 'Error Count');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_archived` SET TAGS ('dbx_business_glossary_term' = 'Is Archived');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_auto` SET TAGS ('dbx_business_glossary_term' = 'Is Auto');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_deleted` SET TAGS ('dbx_business_glossary_term' = 'Is Deleted');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_live` SET TAGS ('dbx_business_glossary_term' = 'Is Live');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_manual` SET TAGS ('dbx_business_glossary_term' = 'Is Manual');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_retroactive` SET TAGS ('dbx_business_glossary_term' = 'Is Retroactive');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `is_test` SET TAGS ('dbx_business_glossary_term' = 'Is Test');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `load_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Batch Load Timestamp');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `load_user` SET TAGS ('dbx_business_glossary_term' = 'Batch Load User');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Batch Notes');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Batch Number');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `priority` SET TAGS ('dbx_business_glossary_term' = 'Batch Priority');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Batch Priority Level');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `processing_duration_seconds` SET TAGS ('dbx_business_glossary_term' = 'Processing Duration Seconds');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `processing_end` SET TAGS ('dbx_business_glossary_term' = 'Processing End');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `processing_start` SET TAGS ('dbx_business_glossary_term' = 'Processing Start');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `reference_number` SET TAGS ('dbx_business_glossary_term' = 'Batch Reference Number');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `reference_type` SET TAGS ('dbx_business_glossary_term' = 'Batch Reference Type');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `source` SET TAGS ('dbx_business_glossary_term' = 'Batch Source');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `source_system_batch_reference` SET TAGS ('dbx_business_glossary_term' = 'Source System Batch Reference');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `batch_status` SET TAGS ('dbx_business_glossary_term' = 'Status');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `success_count` SET TAGS ('dbx_business_glossary_term' = 'Success Count');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `total_adjustments` SET TAGS ('dbx_business_glossary_term' = 'Total Adjustments');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `total_enrollments` SET TAGS ('dbx_business_glossary_term' = 'Total Enrollments');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `total_reinstatements` SET TAGS ('dbx_business_glossary_term' = 'Total Reinstatements');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `total_reinstatements` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `total_terminations` SET TAGS ('dbx_business_glossary_term' = 'Total Terminations');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `batch_type` SET TAGS ('dbx_business_glossary_term' = 'Batch Type');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `updated_at` SET TAGS ('dbx_business_glossary_term' = 'Updated At');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `updated_by` SET TAGS ('dbx_business_glossary_term' = 'Updated By');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `version` SET TAGS ('dbx_business_glossary_term' = 'Batch Version');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`batch` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cms_submission` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cms_submission` SET TAGS ('dbx_subdomain' = 'submission_reconciliation');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cms_submission` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cms_submission` ALTER COLUMN `submission_batch_id` SET TAGS ('dbx_business_glossary_term' = 'Submission Batch ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cms_submission` ALTER COLUMN `raf_score_impact` SET TAGS ('dbx_business_glossary_term' = 'RAF Score Impact');
...
ALTER TABLE `vibe_health_insurance_v1`.`enrollment`.`cms_submission` ALTER COLUMN `submission_file_name` SET TAGS ('dbx_pii_flag' = 'true');
