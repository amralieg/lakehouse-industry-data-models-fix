-- Schema for Domain: supply | Business: Water_Utilities | Version: v2_ecm
-- Generated on: 2026-07-10 18:43:52
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`material_master` (
    ...
    `material_wtp_facility_id` BIGINT COMMENT 'Reference to the water treatment plant (WTP) or wastewater treatment plant (WWTP) where this material is stocked and used. Materials may be plant-specific for operational segregation.',
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`goods_receipt` (
    ...
    `goods_material_material_master_id` BIGINT COMMENT 'Reference to the material master record for the item received. Links to chemicals, spare parts, equipment, or other materials.',
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`inventory_stock` (
    ...
    `inventory_wtp_facility_id` BIGINT COMMENT 'Reference to the plant or facility where the storage location resides. Links to WTP, WWTP, or operations center.',
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`stock_movement` (
    ...
    `stock_material_material_master_id` BIGINT COMMENT 'Reference to the material being moved. Links to the material master record for chemicals, spare parts, or other inventory items.',
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`warehouse_location` (
    ...
    `cost_center_id` BIGINT COMMENT 'add column cost_center_id (BIGINT) with FK to finance.cost_center.cost_center_id - warehouse operations are tracked against cost centers',
    `facility_id` BIGINT COMMENT 'add column facility_id (BIGINT) with FK to treatment.facility.facility_id - warehouses are typically co-located with treatment facilities or operational centers',
    ...
    `facility_type` STRING COMMENT 'Classification of the warehouse facility based on its operational purpose. Central warehouse serves inventory; WTP (Water Treatment Plant) and WWTP (Wastewater Treatment Plant) chemical stores hold treatment chemicals; field storerooms support distribution network maintenance; maintenance depots support asset management; emergency stockpiles hold critical spare parts.. Valid values are `central_warehouse|wtp_chemical_store|wwtp_chemical_store|field_storeroom|maintenance_depot|emergency_stockpile`',
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`material_requisition` (
    ...
    `material_registry_id` BIGINT COMMENT 'Reference to the asset or equipment for which the material is being requisitioned. Links to asset registry for maintenance context.',
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` (
    ...
    `parent_procurement_category_id_legacy` BIGINT COMMENT 'Reference to the parent category in the hierarchical taxonomy. Null for top-level categories.',
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor` ALTER COLUMN `country_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor` ALTER COLUMN `vendor_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor` ALTER COLUMN `name_short` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor` ALTER COLUMN `state_province` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`material_master` ALTER COLUMN `material_wtp_facility_id` SET TAGS ('dbx_business_glossary_term' = 'Plant Identifier (ID)');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`material_master` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`material_master` ALTER COLUMN `moving_average_price` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`material_master` ALTER COLUMN `standard_price` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`purchase_order` ALTER COLUMN `buyer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`purchase_order` ALTER COLUMN `delivery_country_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`purchase_order` ALTER COLUMN `requestor_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`po_line_item` ALTER COLUMN `requisitioner_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`goods_receipt` SET TAGS ('dbx_subdomain' = 'procurement_operations');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`goods_receipt` ALTER COLUMN `receiving_personnel_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`goods_receipt` ALTER COLUMN `total_amount` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`goods_receipt` ALTER COLUMN `unit_price` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`inventory_stock` ALTER COLUMN `stock_value_amount` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`stock_movement` ALTER COLUMN `user_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`warehouse_location` ALTER COLUMN `country_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`warehouse_location` ALTER COLUMN `location_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_contract` ALTER COLUMN `total_contract_value` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor_invoice` SET TAGS ('dbx_subdomain' = 'vendor_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor_performance` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`vendor_performance` ALTER COLUMN `evaluator_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`rfq` ALTER COLUMN `buyer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`approved_vendor_list` ALTER COLUMN `reviewing_authority_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` ALTER COLUMN `parent_procurement_category_id` SET TAGS ('dbx_self_ref_fk' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` ALTER COLUMN `annual_spend_amount` SET TAGS ('dbx_confidential' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` ALTER COLUMN `category_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` ALTER COLUMN `responsible_buyer_email` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` ALTER COLUMN `responsible_buyer_email` SET TAGS ('dbx_pii_email' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`procurement_category` ALTER COLUMN `responsible_buyer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`project_vendor_engagement` ALTER COLUMN `design_firm_name` SET TAGS ('dbx_pii_name' = 'true');
