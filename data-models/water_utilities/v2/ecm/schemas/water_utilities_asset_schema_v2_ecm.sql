-- Schema for Domain: asset | Business: Water_Utilities | Version: v2_ecm
-- Generated on: 2026-07-10 18:43:48
...
CREATE OR REPLACE TABLE `vibe_water_utilities_v1`.`asset`.`inspection_checklist` (
    ...
    `asset_class_id` BIGINT COMMENT 'add column asset_class_id (BIGINT) with FK to asset.asset_class.asset_class_id - inspection checklists are designed for specific asset classes',
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`inspection_checklist` ADD CONSTRAINT `fk_asset_inspection_checklist_asset_class_id` FOREIGN KEY (`asset_class_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`asset_class`(`asset_class_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`registry` SET TAGS ('dbx_subdomain' = 'infrastructure_registry');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`registry` ALTER COLUMN `asset_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`asset_class` SET TAGS ('dbx_subdomain' = 'infrastructure_registry');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`asset_class` ALTER COLUMN `class_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`location` SET TAGS ('dbx_subdomain' = 'infrastructure_registry');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`location` ALTER COLUMN `city` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`location` ALTER COLUMN `country_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`location` ALTER COLUMN `location_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`location` ALTER COLUMN `state_province` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`condition_assessment` ALTER COLUMN `inspector_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`criticality_rating` SET TAGS ('dbx_subdomain' = 'infrastructure_registry');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`criticality_rating` ALTER COLUMN `public_health_impact_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`pm_schedule` ALTER COLUMN `schedule_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`asset_meter` SET TAGS ('dbx_subdomain' = 'maintenance_operations');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`asset_meter` ALTER COLUMN `meter_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`asset_meter` ALTER COLUMN `pi_tag_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`warranty` SET TAGS ('dbx_subdomain' = 'lifecycle_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`warranty` ALTER COLUMN `vendor_contact_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`depreciation_schedule` SET TAGS ('dbx_subdomain' = 'infrastructure_registry');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`acquisition` SET TAGS ('dbx_subdomain' = 'lifecycle_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`acquisition` ALTER COLUMN `grant_program_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`disposal` SET TAGS ('dbx_subdomain' = 'lifecycle_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`disposal` ALTER COLUMN `buyer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`inspection_event` SET TAGS ('dbx_subdomain' = 'inspection_compliance');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`inspection_event` ALTER COLUMN `inspector_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`document` SET TAGS ('dbx_subdomain' = 'lifecycle_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`document` ALTER COLUMN `author_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`document` ALTER COLUMN `file_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`procurement_mapping` SET TAGS ('dbx_subdomain' = 'lifecycle_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`asset_sampling_point` SET TAGS ('dbx_subdomain' = 'inspection_compliance');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`grant_funding` SET TAGS ('dbx_subdomain' = 'lifecycle_management');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`compliance_requirement` SET TAGS ('dbx_subdomain' = 'inspection_compliance');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`inspection_checklist` SET TAGS ('dbx_subdomain' = 'inspection_compliance');
...
ALTER TABLE `vibe_water_utilities_v1`.`asset`.`inspection_checklist` ALTER COLUMN `inspection_checklist_name` SET TAGS ('dbx_pii_name' = 'true');
