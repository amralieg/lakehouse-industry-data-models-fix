...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`price_zone` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`rule` (
    ...
    `exception_count` STRING COMMENT 'Number of exceptions generated by this rule',
    ...
    `impact_estimate_amount` DECIMAL(18,2) COMMENT 'Estimated revenue impact of applying this rule',
    `is_system_generated` BOOLEAN COMMENT 'Whether rule was auto-generated by pricing engine',
    `last_execution_timestamp` TIMESTAMP COMMENT 'Last time the rule was executed',
    ...
    `simulation_run_code` STRING COMMENT 'Reference to pricing simulation that validated this rule',
    ...
    `version` STRING COMMENT 'Version number of the rule',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`price_approval` (
    ...
    `price_associate_id` BIGINT COMMENT 'Reference to the associate (employee) responsible for the price approval record; foreign key identifier linking to the associated workforce associate for this price approval.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`margin_target` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`price_override` (
    ...
    `sku_price_id` BIGINT COMMENT 'Original SKU price',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`price_strategy` (
    ...
    `category_id` BIGINT COMMENT 'Reference to the merchandise subcategory to which this pricing strategy applies. Most granular merchandise hierarchy scope for a strategy. Nullable when strategy is scoped at category or department level.',
    ...
    `price_category_id` BIGINT COMMENT 'Reference to the merchandise category within the department to which this pricing strategy applies. Enables category-level pricing governance per Oracle RPM hierarchy. Nullable when strategy is scoped at department level only.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` (
    ...
    `sku_id` BIGINT COMMENT 'SKU analyzed',
    ...
    `primary_price_sku_id` BIGINT COMMENT 'Identifier for the SKU being analyzed for price sensitivity. Links to the product master.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` (
    ...
    `associate_id` BIGINT COMMENT 'Identifier for the user who approved the price change, if approval was required. Null for auto-approved or system-generated changes.',
    ...
    `price_associate_id` BIGINT COMMENT 'Identifier for the user who initiated or approved the price change. Null for system-generated changes.',
    ...
    `sku_price_id` BIGINT COMMENT 'SKU price audited',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`rule_application` (
    ...
    `sku_price_id` BIGINT COMMENT 'Resulting SKU price',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`pricing`.`cost_zone` (
    ...
    `cost_created_by_user_associate_id` BIGINT COMMENT 'Identifier of the user who created the cost zone record.',
    `cost_last_modified_by_user_associate_id` BIGINT COMMENT 'Identifier of the user who last modified the cost zone record.',
    ...
    `vendor_id` BIGINT COMMENT 'Vendor for this cost zone',
...
-- ========= FOREIGN KEYS =========
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ADD CONSTRAINT `fk_pricing_price_list_price_strategy_id` FOREIGN KEY (`price_strategy_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_strategy`(`price_strategy_id`);
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ADD CONSTRAINT `fk_pricing_markdown_price_strategy_id` FOREIGN KEY (`price_strategy_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_strategy`(`price_strategy_id`);
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ADD CONSTRAINT `fk_pricing_cost_price_cost_zone_id` FOREIGN KEY (`cost_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`cost_zone`(`cost_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ADD CONSTRAINT `fk_pricing_rule_price_strategy_id` FOREIGN KEY (`price_strategy_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_strategy`(`price_strategy_id`);
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ADD CONSTRAINT `fk_pricing_competitive_price_price_strategy_id` FOREIGN KEY (`price_strategy_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_strategy`(`price_strategy_id`);
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ADD CONSTRAINT `fk_pricing_margin_target_price_strategy_id` FOREIGN KEY (`price_strategy_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_strategy`(`price_strategy_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ADD CONSTRAINT `fk_pricing_margin_target_price_zone_id` FOREIGN KEY (`price_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_zone`(`price_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ADD CONSTRAINT `fk_pricing_price_override_price_zone_id` FOREIGN KEY (`price_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_zone`(`price_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ADD CONSTRAINT `fk_pricing_price_override_sku_price_id` FOREIGN KEY (`sku_price_id`) REFERENCES `vibe_retail_v1`.`pricing`.`sku_price`(`sku_price_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ADD CONSTRAINT `fk_pricing_price_strategy_price_zone_id` FOREIGN KEY (`price_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_zone`(`price_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ADD CONSTRAINT `fk_pricing_price_sensitivity_price_strategy_id` FOREIGN KEY (`price_strategy_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_strategy`(`price_strategy_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ADD CONSTRAINT `fk_pricing_price_sensitivity_price_zone_id` FOREIGN KEY (`price_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_zone`(`price_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ADD CONSTRAINT `fk_pricing_price_sensitivity_prior_price_sensitivity_id` FOREIGN KEY (`prior_price_sensitivity_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_sensitivity`(`price_sensitivity_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_markdown_id` FOREIGN KEY (`markdown_id`) REFERENCES `vibe_retail_v1`.`pricing`.`markdown`(`markdown_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_price_approval_id` FOREIGN KEY (`price_approval_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_approval`(`price_approval_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_price_change_id` FOREIGN KEY (`price_change_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_change`(`price_change_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_price_list_id` FOREIGN KEY (`price_list_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_list`(`price_list_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_price_zone_id` FOREIGN KEY (`price_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_zone`(`price_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_reversal_price_audit_log_id` FOREIGN KEY (`reversal_price_audit_log_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_audit_log`(`price_audit_log_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_rule_id` FOREIGN KEY (`rule_id`) REFERENCES `vibe_retail_v1`.`pricing`.`rule`(`rule_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ADD CONSTRAINT `fk_pricing_price_audit_log_sku_price_id` FOREIGN KEY (`sku_price_id`) REFERENCES `vibe_retail_v1`.`pricing`.`sku_price`(`sku_price_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ADD CONSTRAINT `fk_pricing_rule_application_rule_id` FOREIGN KEY (`rule_id`) REFERENCES `vibe_retail_v1`.`pricing`.`rule`(`rule_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ADD CONSTRAINT `fk_pricing_rule_application_sku_price_id` FOREIGN KEY (`sku_price_id`) REFERENCES `vibe_retail_v1`.`pricing`.`sku_price`(`sku_price_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ADD CONSTRAINT `fk_pricing_zone_price_list_assignment_price_list_id` FOREIGN KEY (`price_list_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_list`(`price_list_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ADD CONSTRAINT `fk_pricing_zone_price_list_assignment_price_zone_id` FOREIGN KEY (`price_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`price_zone`(`price_zone_id`);
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ADD CONSTRAINT `fk_pricing_cost_zone_parent_cost_zone_id` FOREIGN KEY (`parent_cost_zone_id`) REFERENCES `vibe_retail_v1`.`pricing`.`cost_zone`(`cost_zone_id`);

-- ========= TAGS =========
ALTER SCHEMA `vibe_retail_v1`.`pricing` SET TAGS ('dbx_division' = 'business');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` SET TAGS ('dbx_subdomain' = 'price_management');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_list_id` SET TAGS ('dbx_business_glossary_term' = 'Price List ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_strategy_id` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_list_code` SET TAGS ('dbx_business_glossary_term' = 'Price List Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `country_code` SET TAGS ('dbx_business_glossary_term' = 'Country Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `department_code` SET TAGS ('dbx_business_glossary_term' = 'Department Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `department_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{1,20}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_list_description` SET TAGS ('dbx_business_glossary_term' = 'Price List Description');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `division_code` SET TAGS ('dbx_business_glossary_term' = 'Division Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `division_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{1,20}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `external_reference_code` SET TAGS ('dbx_business_glossary_term' = 'External Reference Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `is_default` SET TAGS ('dbx_business_glossary_term' = 'Is Default Price List');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `is_taxable` SET TAGS ('dbx_business_glossary_term' = 'Is Taxable');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `list_type` SET TAGS ('dbx_business_glossary_term' = 'Price List Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `list_type` SET TAGS ('dbx_value_regex' = 'EDLP|HI_LO|PROMOTIONAL|CLEARANCE|CLUB_MEMBER|COMPETITIVE');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `loyalty_tier_code` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Tier Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_list_name` SET TAGS ('dbx_business_glossary_term' = 'Price List Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_list_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `next_review_date` SET TAGS ('dbx_business_glossary_term' = 'Next Review Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Price List Notes');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `price_list_status` SET TAGS ('dbx_business_glossary_term' = 'Price List Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `review_frequency` SET TAGS ('dbx_business_glossary_term' = 'Price Review Frequency');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `rounding_rule` SET TAGS ('dbx_business_glossary_term' = 'Price Rounding Rule');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `rounding_rule` SET TAGS ('dbx_value_regex' = 'NEAREST_CENT|ROUND_UP|ROUND_DOWN|CHARM_PRICING|NONE');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `source_system_code` SET TAGS ('dbx_value_regex' = 'RPM|SAP_SD|SFCC|ORMS|MANUAL');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_list` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `base_price_multiplier` SET TAGS ('dbx_business_glossary_term' = 'Base Price Multiplier');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `base_price_multiplier` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `channel_applicability` SET TAGS ('dbx_business_glossary_term' = 'Channel Applicability');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `country_code` SET TAGS ('dbx_business_glossary_term' = 'Country Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `fulfillment_node_count` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node Count');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `is_competitive_zone` SET TAGS ('dbx_business_glossary_term' = 'Is Competitive Zone Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `is_default_zone` SET TAGS ('dbx_business_glossary_term' = 'Is Default Zone Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `is_ecommerce_enabled` SET TAGS ('dbx_business_glossary_term' = 'Is E-Commerce Enabled Flag');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `market_tier` SET TAGS ('dbx_business_glossary_term' = 'Market Tier');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `price_change_lead_days` SET TAGS ('dbx_business_glossary_term' = 'Price Change Lead Time (Days)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `pricing_strategy` SET TAGS ('dbx_business_glossary_term' = 'Pricing Strategy');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `pricing_strategy` SET TAGS ('dbx_value_regex' = 'EDLP|Hi-Lo|cost_plus|competitive|dynamic');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `region_code` SET TAGS ('dbx_business_glossary_term' = 'Region Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `sap_pricing_condition_group` SET TAGS ('dbx_business_glossary_term' = 'SAP Pricing Condition Group');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `store_count` SET TAGS ('dbx_business_glossary_term' = 'Store Count');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `tax_jurisdiction_code` SET TAGS ('dbx_business_glossary_term' = 'Tax Jurisdiction Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `tax_jurisdiction_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{2,20}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_code` SET TAGS ('dbx_business_glossary_term' = 'Price Zone Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{2,20}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_description` SET TAGS ('dbx_business_glossary_term' = 'Price Zone Description');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_hierarchy_level` SET TAGS ('dbx_business_glossary_term' = 'Zone Hierarchy Level');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_name` SET TAGS ('dbx_business_glossary_term' = 'Price Zone Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_status` SET TAGS ('dbx_business_glossary_term' = 'Price Zone Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|archived');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_type` SET TAGS ('dbx_business_glossary_term' = 'Price Zone Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_zone` ALTER COLUMN `zone_type` SET TAGS ('dbx_value_regex' = 'regional|competitive|urban|rural|omnichannel|ecommerce');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` SET TAGS ('dbx_subdomain' = 'price_management');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_list_id` SET TAGS ('dbx_business_glossary_term' = 'Price List ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `channel_price_variance` SET TAGS ('dbx_business_glossary_term' = 'Channel Price Variance');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `channel_type` SET TAGS ('dbx_business_glossary_term' = 'Channel Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `competitor_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `competitor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `markdown_amount` SET TAGS ('dbx_business_glossary_term' = 'Markdown Amount');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `original_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Original Retail Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `original_retail_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_ceiling` SET TAGS ('dbx_business_glossary_term' = 'Price Ceiling');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_ceiling` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_change_reason` SET TAGS ('dbx_business_glossary_term' = 'Price Change Reason');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_floor` SET TAGS ('dbx_business_glossary_term' = 'Price Floor');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_floor` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_per_unit_display` SET TAGS ('dbx_business_glossary_term' = 'Price Per Unit Display');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_resolution_priority` SET TAGS ('dbx_business_glossary_term' = 'Price Resolution Priority');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_type` SET TAGS ('dbx_business_glossary_term' = 'Price Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `price_type` SET TAGS ('dbx_value_regex' = 'edlp|hi_lo|clearance|competitive_match|markdown|promotional');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`sku_price` ALTER COLUMN `tax_code` SET TAGS ('dbx_business_glossary_term' = 'Tax Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` SET TAGS ('dbx_subdomain' = 'price_management');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `price_change_id` SET TAGS ('dbx_business_glossary_term' = 'Price Change ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `policy_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `rule_id` SET TAGS ('dbx_business_glossary_term' = 'Price Rule ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `change_category` SET TAGS ('dbx_business_glossary_term' = 'Price Change Category');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `change_category` SET TAGS ('dbx_value_regex' = 'retail_price_change|supplier_cost_change|landed_cost_adjustment|freight_surcharge');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `change_type` SET TAGS ('dbx_business_glossary_term' = 'Price Change Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `competitive_reference_price` SET TAGS ('dbx_business_glossary_term' = 'Competitive Reference Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `competitive_reference_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `competitor_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `competitor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Price Change Effective Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `event_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Price Change Event Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `execution_mode` SET TAGS ('dbx_business_glossary_term' = 'Price Change Execution Mode');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `execution_mode` SET TAGS ('dbx_value_regex' = 'manual|batch|real_time');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `new_cost` SET TAGS ('dbx_business_glossary_term' = 'New Cost');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `new_retail_price` SET TAGS ('dbx_business_glossary_term' = 'New Retail Price');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `pricing_strategy` SET TAGS ('dbx_business_glossary_term' = 'Pricing Strategy');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `prior_cost` SET TAGS ('dbx_business_glossary_term' = 'Prior Cost');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `prior_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Prior Retail Price');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `retail_price_change_amount` SET TAGS ('dbx_business_glossary_term' = 'Retail Price Change Amount');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_change` ALTER COLUMN `supplier_reference_number` SET TAGS ('dbx_business_glossary_term' = 'Supplier Reference Number');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` SET TAGS ('dbx_subdomain' = 'price_management');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `markdown_id` SET TAGS ('dbx_business_glossary_term' = 'Markdown ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `category_id` SET TAGS ('dbx_business_glossary_term' = 'Category ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Location ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `price_strategy_id` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `actual_exit_date` SET TAGS ('dbx_business_glossary_term' = 'Actual Exit Date');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `channel` SET TAGS ('dbx_value_regex' = 'in_store|online|omnichannel|bopis');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `clearance_closure_date` SET TAGS ('dbx_business_glossary_term' = 'Clearance Closure Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `clearance_initiation_date` SET TAGS ('dbx_business_glossary_term' = 'Clearance Initiation Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `clearance_stage` SET TAGS ('dbx_business_glossary_term' = 'Clearance Stage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `clearance_stage` SET TAGS ('dbx_value_regex' = 'not_clearance|first_reduction|second_reduction|final_reduction');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code (ISO 4217)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `disposition_method` SET TAGS ('dbx_business_glossary_term' = 'Disposition Method');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `disposition_method` SET TAGS ('dbx_value_regex' = 'in_store_clearance|online_clearance|rtv|liquidation|donation');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Markdown Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Markdown Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `is_competitive_response` SET TAGS ('dbx_business_glossary_term' = 'Competitive Response Indicator');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `is_dead_stock` SET TAGS ('dbx_business_glossary_term' = 'Dead Stock Indicator');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `markdown_number` SET TAGS ('dbx_business_glossary_term' = 'Markdown Number');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `markdown_number` SET TAGS ('dbx_value_regex' = '^MD-[0-9]{8,12}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `markdown_status` SET TAGS ('dbx_business_glossary_term' = 'Markdown Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `markdown_type` SET TAGS ('dbx_business_glossary_term' = 'Markdown Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `original_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Original Retail Price');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `planned_exit_date` SET TAGS ('dbx_business_glossary_term' = 'Planned Exit Date');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `sell_through_target_pct` SET TAGS ('dbx_business_glossary_term' = 'Sell-Through Target Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `source_system_code` SET TAGS ('dbx_value_regex' = 'RPM|ORMS|SAP|SFCC|MANUAL');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `units_remaining` SET TAGS ('dbx_business_glossary_term' = 'Units Remaining');
ALTER TABLE `vibe_retail_v1`.`pricing`.`markdown` ALTER COLUMN `units_sold` SET TAGS ('dbx_business_glossary_term' = 'Units Sold at Markdown Price');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_price_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Price ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `base_cost` SET TAGS ('dbx_business_glossary_term' = 'Base Cost');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_change_reason` SET TAGS ('dbx_business_glossary_term' = 'Cost Change Reason');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_notes` SET TAGS ('dbx_business_glossary_term' = 'Cost Notes');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_per_inner_pack` SET TAGS ('dbx_business_glossary_term' = 'Cost Per Inner Pack');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_per_inner_pack` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_status` SET TAGS ('dbx_business_glossary_term' = 'Cost Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `cost_type` SET TAGS ('dbx_business_glossary_term' = 'Cost Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `country_of_origin` SET TAGS ('dbx_business_glossary_term' = 'Country of Origin Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `freight_cost` SET TAGS ('dbx_business_glossary_term' = 'Freight Cost');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `freight_cost` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `handling_cost` SET TAGS ('dbx_business_glossary_term' = 'Handling Cost');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `other_cost` SET TAGS ('dbx_business_glossary_term' = 'Other Cost');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `supplier_code` SET TAGS ('dbx_business_glossary_term' = 'Supplier Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `supplier_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9-]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_price` ALTER COLUMN `supplier_deal_code` SET TAGS ('dbx_business_glossary_term' = 'Supplier Deal Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` SET TAGS ('dbx_subdomain' = 'price_management');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `compliance_program_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Program Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Department ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `applicable_days_of_week` SET TAGS ('dbx_business_glossary_term' = 'Applicable Days of Week');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Rule Approved By');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `approved_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `approved_by` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Rule Approval Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `channel` SET TAGS ('dbx_business_glossary_term' = 'Sales Channel');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `competitor_price_index` SET TAGS ('dbx_business_glossary_term' = 'Competitor Price Index');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Rule Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Rule Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `execution_mode` SET TAGS ('dbx_business_glossary_term' = 'Rule Execution Mode');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `execution_mode` SET TAGS ('dbx_value_regex' = 'manual|batch|real_time|near_real_time');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `priority` SET TAGS ('dbx_business_glossary_term' = 'Rule Priority');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `rounding_rule` SET TAGS ('dbx_business_glossary_term' = 'Price Rounding Rule');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `rounding_rule` SET TAGS ('dbx_value_regex' = 'none|nearest_cent|charm_99|charm_95|nearest_dollar|custom');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `rule_status` SET TAGS ('dbx_business_glossary_term' = 'Pricing Rule Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `rule_status` SET TAGS ('dbx_value_regex' = 'draft|active|inactive|suspended|expired');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `rule_type` SET TAGS ('dbx_business_glossary_term' = 'Pricing Rule Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `sell_through_target_pct` SET TAGS ('dbx_business_glossary_term' = 'Sell-Through Rate Target Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `sku_scope` SET TAGS ('dbx_business_glossary_term' = 'SKU (Stock Keeping Unit) Scope');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `sku_scope` SET TAGS ('dbx_value_regex' = 'all_skus|category|department|specific_sku|price_zone');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `source_system_rule_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Rule ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `stackable` SET TAGS ('dbx_business_glossary_term' = 'Rule Stackable Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `time_of_day_end` SET TAGS ('dbx_business_glossary_term' = 'Time-of-Day Rule End Time');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `time_of_day_end` SET TAGS ('dbx_value_regex' = '^([01]d|2[0-3]):[0-5]d$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule` ALTER COLUMN `time_of_day_start` SET TAGS ('dbx_business_glossary_term' = 'Time-of-Day Rule Start Time');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitive_price_id` SET TAGS ('dbx_business_glossary_term' = 'Competitive Price ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `digital_catalog_id` SET TAGS ('dbx_business_glossary_term' = 'Digital Catalog Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `pci_assessment_id` SET TAGS ('dbx_business_glossary_term' = 'Pci Assessment Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `category_code` SET TAGS ('dbx_business_glossary_term' = 'Product Category Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_channel` SET TAGS ('dbx_business_glossary_term' = 'Competitor Channel');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_pack_size` SET TAGS ('dbx_business_glossary_term' = 'Competitor Pack Size');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_product_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Product Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_product_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_promo_type` SET TAGS ('dbx_value_regex' = 'tpr|clearance|loyalty_price|bundle|coupon|rollback');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `competitor_unit_of_measure` SET TAGS ('dbx_business_glossary_term' = 'Competitor Unit of Measure');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `data_source_type` SET TAGS ('dbx_business_glossary_term' = 'Data Source Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `data_source_vendor` SET TAGS ('dbx_business_glossary_term' = 'Data Source Vendor');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `department_code` SET TAGS ('dbx_business_glossary_term' = 'Department Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `match_confidence_score` SET TAGS ('dbx_business_glossary_term' = 'Match Confidence Score');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `match_type` SET TAGS ('dbx_business_glossary_term' = 'Match Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `normalized_unit_price` SET TAGS ('dbx_business_glossary_term' = 'Normalized Unit Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `normalized_unit_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `observation_date` SET TAGS ('dbx_business_glossary_term' = 'Observation Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `observation_quality_flag` SET TAGS ('dbx_business_glossary_term' = 'Observation Quality Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `observation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Observation Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `previous_competitor_price` SET TAGS ('dbx_business_glossary_term' = 'Previous Competitor Price');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `previous_observation_date` SET TAGS ('dbx_business_glossary_term' = 'Previous Observation Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `price_gap` SET TAGS ('dbx_business_glossary_term' = 'Price Gap');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `price_gap_trend` SET TAGS ('dbx_business_glossary_term' = 'Price Gap Trend');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`competitive_price` ALTER COLUMN `response_implemented_date` SET TAGS ('dbx_business_glossary_term' = 'Response Implemented Date');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` SET TAGS ('dbx_subdomain' = 'governance_compliance');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `price_approval_id` SET TAGS ('dbx_business_glossary_term' = 'Price Approval ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Department ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `policy_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `price_change_id` SET TAGS ('dbx_business_glossary_term' = 'Price Change ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `primary_price_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Requestor ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `approval_channel` SET TAGS ('dbx_business_glossary_term' = 'Approval Channel');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `approval_number` SET TAGS ('dbx_value_regex' = '^PA-[0-9]{4}-[0-9]{6}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Price Approval Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'pending|approved|rejected|escalated|cancelled|expired');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `approval_tier` SET TAGS ('dbx_value_regex' = 'category_manager|merchandise_director|vp_merchandising|cfo|auto_approved');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `approval_type` SET TAGS ('dbx_value_regex' = 'price_change|markdown|price_list_activation|promotional_price|clearance');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `business_justification` SET TAGS ('dbx_business_glossary_term' = 'Business Justification');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `competitor_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `competitor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `escalation_tier` SET TAGS ('dbx_business_glossary_term' = 'Escalation Tier');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `escalation_tier` SET TAGS ('dbx_value_regex' = 'category_manager|merchandise_director|vp_merchandising|cfo');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `price_zone_code` SET TAGS ('dbx_business_glossary_term' = 'Price Zone Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `pricing_strategy` SET TAGS ('dbx_business_glossary_term' = 'Pricing Strategy');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_approval` ALTER COLUMN `rejection_reason` SET TAGS ('dbx_business_glossary_term' = 'Rejection Reason');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` SET TAGS ('dbx_subdomain' = 'cost_intelligence');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `margin_target_id` SET TAGS ('dbx_business_glossary_term' = 'Margin Target ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `buyer_id` SET TAGS ('dbx_business_glossary_term' = 'Buyer ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `category_id` SET TAGS ('dbx_business_glossary_term' = 'Subcategory ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Department ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `margin_category_id` SET TAGS ('dbx_business_glossary_term' = 'Category ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `brand_classification` SET TAGS ('dbx_business_glossary_term' = 'Brand Classification');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `markdown_optimization_strategy` SET TAGS ('dbx_business_glossary_term' = 'Markdown Optimization Strategy');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `planning_period_label` SET TAGS ('dbx_business_glossary_term' = 'Planning Period Label');
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `planning_period_type` SET TAGS ('dbx_business_glossary_term' = 'Planning Period Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `source_system_ref_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Reference ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`margin_target` ALTER COLUMN `target_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` SET TAGS ('dbx_subdomain' = 'governance_compliance');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `price_override_id` SET TAGS ('dbx_business_glossary_term' = 'Price Override ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Store ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `loyalty_membership_id` SET TAGS ('dbx_business_glossary_term' = 'Membership Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `loyalty_program_id` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Program ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `pos_terminal_id` SET TAGS ('dbx_business_glossary_term' = 'Point of Sale (POS) Terminal ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `pos_transaction_id` SET TAGS ('dbx_business_glossary_term' = 'Transaction ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `approval_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approval Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `competitor_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `competitor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `competitor_price` SET TAGS ('dbx_business_glossary_term' = 'Competitor Price');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `original_price` SET TAGS ('dbx_business_glossary_term' = 'Original Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `original_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_amount` SET TAGS ('dbx_business_glossary_term' = 'Override Amount');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_limit_threshold` SET TAGS ('dbx_business_glossary_term' = 'Override Limit Threshold');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_limit_threshold` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_percentage` SET TAGS ('dbx_business_glossary_term' = 'Override Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_percentage` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_price` SET TAGS ('dbx_business_glossary_term' = 'Override Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_reference_number` SET TAGS ('dbx_business_glossary_term' = 'Override Reference Number');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_status` SET TAGS ('dbx_business_glossary_term' = 'Override Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Override Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `override_type` SET TAGS ('dbx_business_glossary_term' = 'Override Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `reason_code` SET TAGS ('dbx_business_glossary_term' = 'Override Reason Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `reason_description` SET TAGS ('dbx_business_glossary_term' = 'Override Reason Description');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `shrinkage_related` SET TAGS ('dbx_business_glossary_term' = 'Shrinkage Related Flag');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `void_reason` SET TAGS ('dbx_business_glossary_term' = 'Void Reason');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_override` ALTER COLUMN `void_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Void Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` SET TAGS ('dbx_subdomain' = 'cost_intelligence');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_strategy_id` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `category_id` SET TAGS ('dbx_business_glossary_term' = 'Subcategory ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Department ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_category_id` SET TAGS ('dbx_business_glossary_term' = 'Category ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `channel_scope` SET TAGS ('dbx_business_glossary_term' = 'Channel Scope');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `competitor_benchmark_set` SET TAGS ('dbx_business_glossary_term' = 'Competitor Benchmark Set');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_strategy_description` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Description');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `fiscal_year` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Year');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `markdown_optimization_enabled` SET TAGS ('dbx_business_glossary_term' = 'Markdown Optimization Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Notes');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_change_approval_required` SET TAGS ('dbx_business_glossary_term' = 'Price Change Approval Required Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_review_frequency` SET TAGS ('dbx_business_glossary_term' = 'Price Review Frequency');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `price_strategy_status` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `season_code` SET TAGS ('dbx_business_glossary_term' = 'Season Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `source_system_code` SET TAGS ('dbx_value_regex' = 'RPM|SAP_SD|ORMS|MANUAL');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `strategy_code` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `strategy_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{2,30}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `strategy_name` SET TAGS ('dbx_business_glossary_term' = 'Price Strategy Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_strategy` ALTER COLUMN `strategy_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` SET TAGS ('dbx_subdomain' = 'cost_intelligence');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `price_sensitivity_id` SET TAGS ('dbx_business_glossary_term' = 'Price Sensitivity ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `category_id` SET TAGS ('dbx_business_glossary_term' = 'Category ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `segment_id` SET TAGS ('dbx_business_glossary_term' = 'Customer Segment ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `primary_price_sku_id` SET TAGS ('dbx_business_glossary_term' = 'Stock Keeping Unit (SKU) ID');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `prior_price_sensitivity_id` SET TAGS ('dbx_business_glossary_term' = 'Prior Price Sensitivity Id');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `privacy_assessment_id` SET TAGS ('dbx_business_glossary_term' = 'Privacy Assessment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `analysis_notes` SET TAGS ('dbx_business_glossary_term' = 'Analysis Notes');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `analysis_period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Analysis Period End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `analysis_period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Analysis Period Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `analysis_status` SET TAGS ('dbx_business_glossary_term' = 'Analysis Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approved Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `baseline_demand_units` SET TAGS ('dbx_business_glossary_term' = 'Baseline Demand Units');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `competitive_response_factor` SET TAGS ('dbx_business_glossary_term' = 'Competitive Response Factor');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `confidence_level_pct` SET TAGS ('dbx_business_glossary_term' = 'Confidence Level Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `cross_price_elasticity` SET TAGS ('dbx_business_glossary_term' = 'Cross-Price Elasticity');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `current_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Current Retail Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `demand_curve_intercept` SET TAGS ('dbx_business_glossary_term' = 'Demand Curve Intercept');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `demand_curve_slope` SET TAGS ('dbx_business_glossary_term' = 'Demand Curve Slope');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `elasticity_classification` SET TAGS ('dbx_business_glossary_term' = 'Elasticity Classification');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `elasticity_classification` SET TAGS ('dbx_value_regex' = 'elastic|inelastic|unitary|perfectly_elastic|perfectly_inelastic');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `elasticity_coefficient` SET TAGS ('dbx_business_glossary_term' = 'Price Elasticity Coefficient');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `markdown_sensitivity_score` SET TAGS ('dbx_business_glossary_term' = 'Markdown Sensitivity Score');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `model_type` SET TAGS ('dbx_business_glossary_term' = 'Model Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `model_type` SET TAGS ('dbx_value_regex' = 'linear|log_linear|exponential|polynomial|machine_learning');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `optimal_price_point` SET TAGS ('dbx_business_glossary_term' = 'Optimal Price Point');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `profit_maximizing_price` SET TAGS ('dbx_business_glossary_term' = 'Profit Maximizing Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `promotional_elasticity` SET TAGS ('dbx_business_glossary_term' = 'Promotional Elasticity');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `revenue_maximizing_price` SET TAGS ('dbx_business_glossary_term' = 'Revenue Maximizing Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `sample_size` SET TAGS ('dbx_business_glossary_term' = 'Sample Size');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `seasonality_adjustment_factor` SET TAGS ('dbx_business_glossary_term' = 'Seasonality Adjustment Factor');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_sensitivity` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` SET TAGS ('dbx_data_type' = 'Master');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` SET TAGS ('dbx_subdomain' = 'governance_compliance');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `price_audit_log_id` SET TAGS ('dbx_business_glossary_term' = 'Price Audit Log ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `markdown_id` SET TAGS ('dbx_business_glossary_term' = 'Markdown Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `policy_id` SET TAGS ('dbx_business_glossary_term' = 'Policy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `price_approval_id` SET TAGS ('dbx_business_glossary_term' = 'Price Approval Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `price_change_id` SET TAGS ('dbx_business_glossary_term' = 'Price Change ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Price Zone ID');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `reversal_price_audit_log_id` SET TAGS ('dbx_business_glossary_term' = 'Reversal Price Audit Log Id');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `actor_role` SET TAGS ('dbx_business_glossary_term' = 'Actor Role');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `actor_type` SET TAGS ('dbx_business_glossary_term' = 'Actor Type');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `actor_username` SET TAGS ('dbx_business_glossary_term' = 'Actor Username');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `actor_username` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `actor_username` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `approval_tier` SET TAGS ('dbx_business_glossary_term' = 'Approval Tier');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `approver_username` SET TAGS ('dbx_business_glossary_term' = 'Approver Username');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `approver_username` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `approver_username` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `audit_action` SET TAGS ('dbx_business_glossary_term' = 'Audit Action');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `audit_event_type` SET TAGS ('dbx_business_glossary_term' = 'Audit Event Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `audit_notes` SET TAGS ('dbx_business_glossary_term' = 'Audit Notes');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `audit_status` SET TAGS ('dbx_business_glossary_term' = 'Audit Status');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `business_justification` SET TAGS ('dbx_business_glossary_term' = 'Business Justification');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `change_reason_code` SET TAGS ('dbx_business_glossary_term' = 'Change Reason Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `channel` SET TAGS ('dbx_business_glossary_term' = 'Channel');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `competitive_reference_price` SET TAGS ('dbx_business_glossary_term' = 'Competitive Reference Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `competitor_name` SET TAGS ('dbx_business_glossary_term' = 'Competitor Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `competitor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `event_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Event Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Expiry Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `is_auto_approved` SET TAGS ('dbx_business_glossary_term' = 'Is Auto Approved');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `is_escalated` SET TAGS ('dbx_business_glossary_term' = 'Is Escalated');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `is_margin_breach` SET TAGS ('dbx_business_glossary_term' = 'Is Margin Breach');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `is_override` SET TAGS ('dbx_business_glossary_term' = 'Is Override');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `margin_impact` SET TAGS ('dbx_business_glossary_term' = 'Margin Impact');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `margin_impact` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `new_cost_price` SET TAGS ('dbx_business_glossary_term' = 'New Cost Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `new_cost_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `new_margin_percent` SET TAGS ('dbx_business_glossary_term' = 'New Margin Percent');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `new_margin_percent` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `new_retail_price` SET TAGS ('dbx_business_glossary_term' = 'New Retail Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `override_reason` SET TAGS ('dbx_business_glossary_term' = 'Override Reason');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `price_change_amount` SET TAGS ('dbx_business_glossary_term' = 'Price Change Amount');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `price_change_percent` SET TAGS ('dbx_business_glossary_term' = 'Price Change Percent');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `pricing_strategy_type` SET TAGS ('dbx_business_glossary_term' = 'Pricing Strategy Type');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `prior_cost_price` SET TAGS ('dbx_business_glossary_term' = 'Prior Cost Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `prior_cost_price` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `prior_margin_percent` SET TAGS ('dbx_business_glossary_term' = 'Prior Margin Percent');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `prior_margin_percent` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `prior_retail_price` SET TAGS ('dbx_business_glossary_term' = 'Prior Retail Price');
ALTER TABLE `vibe_retail_v1`.`pricing`.`price_audit_log` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Source System Code');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` SET TAGS ('dbx_subdomain' = 'price_management');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `rule_id` SET TAGS ('dbx_business_glossary_term' = 'Pricing Rule Application - Pricing Rule Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `adjustment_method` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Method');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `adjustment_value` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Value');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `application_status` SET TAGS ('dbx_business_glossary_term' = 'Application Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `created_date` SET TAGS ('dbx_business_glossary_term' = 'Application Created Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Application Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Application Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `execution_sequence` SET TAGS ('dbx_business_glossary_term' = 'Execution Sequence Number');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_business_glossary_term' = 'Application Last Modified By');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `last_modified_date` SET TAGS ('dbx_business_glossary_term' = 'Application Last Modified Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `override_permitted` SET TAGS ('dbx_business_glossary_term' = 'Override Permitted Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `rule_priority` SET TAGS ('dbx_business_glossary_term' = 'Rule Execution Priority');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `stackable_flag` SET TAGS ('dbx_business_glossary_term' = 'Stackable Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`rule_application` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Application Created By');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` SET TAGS ('dbx_subdomain' = 'price_management');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` SET TAGS ('dbx_association_edges' = 'pricing.price_list,pricing.price_zone');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `zone_price_list_assignment_id` SET TAGS ('dbx_business_glossary_term' = 'Zone Price List Assignment Identifier');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `price_list_id` SET TAGS ('dbx_business_glossary_term' = 'Zone Price List Assignment - Price List Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `price_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Zone Price List Assignment - Price Zone Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Assignment Approval Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Assignment Approver');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Assignment Approval Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `assigned_by` SET TAGS ('dbx_business_glossary_term' = 'Assignment Creator');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `assigned_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Assignment Creation Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `assignment_reason` SET TAGS ('dbx_business_glossary_term' = 'Assignment Reason Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `currency_conversion_rate` SET TAGS ('dbx_business_glossary_term' = 'Assignment Currency Conversion Rate');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Assignment Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Assignment Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `external_reference_code` SET TAGS ('dbx_business_glossary_term' = 'Assignment External Reference');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Assignment Active Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `override_rules` SET TAGS ('dbx_business_glossary_term' = 'Zone-Specific Override Rules');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `priority_rank` SET TAGS ('dbx_business_glossary_term' = 'Assignment Priority Rank');
ALTER TABLE `vibe_retail_v1`.`pricing`.`zone_price_list_assignment` ALTER COLUMN `source_system_code` SET TAGS ('dbx_business_glossary_term' = 'Assignment Source System');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` SET TAGS ('dbx_subdomain' = 'cost_intelligence');
...
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Associate Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_created_by_user_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User Associate Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_last_modified_by_user_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By User Associate Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `parent_cost_zone_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Cost Zone Id');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `annual_revenue_amount` SET TAGS ('dbx_business_glossary_term' = 'Annual Revenue Amount');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `annual_revenue_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `annual_volume_units` SET TAGS ('dbx_business_glossary_term' = 'Annual Volume Units');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `approval_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Approval Required Flag');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `approval_threshold_amount` SET TAGS ('dbx_business_glossary_term' = 'Approval Threshold Amount');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_zone_code` SET TAGS ('dbx_business_glossary_term' = 'Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `competitive_intensity` SET TAGS ('dbx_business_glossary_term' = 'Competitive Intensity');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_adjustment_factor` SET TAGS ('dbx_business_glossary_term' = 'Cost Adjustment Factor');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_review_frequency` SET TAGS ('dbx_business_glossary_term' = 'Cost Review Frequency');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `country_code` SET TAGS ('dbx_business_glossary_term' = 'Country Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `default_cost_method` SET TAGS ('dbx_business_glossary_term' = 'Default Cost Method');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_zone_description` SET TAGS ('dbx_business_glossary_term' = 'Description');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `duty_factor_percentage` SET TAGS ('dbx_business_glossary_term' = 'Duty Factor Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `freight_factor_percentage` SET TAGS ('dbx_business_glossary_term' = 'Freight Factor Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `geographic_scope` SET TAGS ('dbx_business_glossary_term' = 'Geographic Scope');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `hierarchy_level` SET TAGS ('dbx_business_glossary_term' = 'Hierarchy Level');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `last_cost_review_date` SET TAGS ('dbx_business_glossary_term' = 'Last Cost Review Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `minimum_margin_percentage` SET TAGS ('dbx_business_glossary_term' = 'Minimum Margin Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_zone_name` SET TAGS ('dbx_business_glossary_term' = 'Name');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_zone_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `next_cost_review_date` SET TAGS ('dbx_business_glossary_term' = 'Next Cost Review Date');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `overhead_factor_percentage` SET TAGS ('dbx_business_glossary_term' = 'Overhead Factor Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `pricing_strategy` SET TAGS ('dbx_business_glossary_term' = 'Pricing Strategy');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_zone_status` SET TAGS ('dbx_business_glossary_term' = 'Status');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `store_count` SET TAGS ('dbx_business_glossary_term' = 'Store Count');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `target_margin_percentage` SET TAGS ('dbx_business_glossary_term' = 'Target Margin Percentage');
ALTER TABLE `vibe_retail_v1`.`pricing`.`cost_zone` ALTER COLUMN `cost_zone_type` SET TAGS ('dbx_business_glossary_term' = 'Type');
