...
-- Generated on: 2026-07-10 12:17:27
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`order`.`amendment` (
    ...
    `employee_id` BIGINT COMMENT 'add column amended_by_employee_id (BIGINT) with FK to workforce.employee.employee_id - order amendments require audit trail of who authorized the change',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`order`.`rma` (
    ...
    `assembly_lot_id` BIGINT COMMENT 'add column packaging_assembly_lot_id (BIGINT) with FK to packaging.assembly_lot.assembly_lot_id - RMAs trace returned material to specific assembly lots for root cause',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`order`.`blanket_order` (
    ...
    `family_id` BIGINT COMMENT 'add column product_family_id (BIGINT) with FK to product.family.family_id - blanket orders cover product families for volume commitments',
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order` ALTER COLUMN `experimental_lot_id` SET TAGS ('dbx_business_glossary_term' = 'Experimental Lot Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order` ALTER COLUMN `ip_core_development_id` SET TAGS ('dbx_business_glossary_term' = 'Ip Core Development Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_line` SET TAGS ('dbx_subdomain' = 'sales_fulfillment');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`wafer_start_authorization` SET TAGS ('dbx_subdomain' = 'commitment_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`mpw_order` SET TAGS ('dbx_subdomain' = 'commitment_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`mpw_order` ALTER COLUMN `design_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`die_bank_order` SET TAGS ('dbx_subdomain' = 'commitment_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`die_bank_order` ALTER COLUMN `order_id` SET TAGS ('dbx_business_glossary_term' = 'Die Order Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`allocation_record` SET TAGS ('dbx_subdomain' = 'commitment_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`amendment` SET TAGS ('dbx_subdomain' = 'sales_fulfillment');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`amendment` ALTER COLUMN `amended_field_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`nre_order` SET TAGS ('dbx_subdomain' = 'commitment_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_nre_milestone` SET TAGS ('dbx_subdomain' = 'commitment_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_nre_milestone` ALTER COLUMN `milestone_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`rma` SET TAGS ('dbx_subdomain' = 'shipment_delivery');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`blanket_order` SET TAGS ('dbx_subdomain' = 'sales_fulfillment');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_hold` SET TAGS ('dbx_subdomain' = 'sales_fulfillment');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_hold` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Hold Owner ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_hold` ALTER COLUMN `owner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`order_hold` ALTER COLUMN `release_approver_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`order`.`lot_assignment` SET TAGS ('dbx_subdomain' = 'shipment_delivery');
