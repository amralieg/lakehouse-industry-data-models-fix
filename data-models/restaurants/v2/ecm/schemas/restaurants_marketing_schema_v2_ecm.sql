...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`marketing_lto` (
    ...
    `menu_item_id` BIGINT COMMENT '',
    `actual_revenue` STRING COMMENT '',
    `actual_sales` DECIMAL(18,2) COMMENT '',
    `actual_sales_amount` DECIMAL(18,2) COMMENT '',
    `actual_units_sold` STRING COMMENT '',
    `created_at` TIMESTAMP COMMENT '',
    `created_timestamp` TIMESTAMP COMMENT '',
    `currency_code` STRING COMMENT 'ISO 4217 three-letter currency code (e.g., USD, EUR, GBP) denoting the monetary unit applied to amounts on this marketing lto record.',
    `marketing_lto_description` STRING COMMENT '',
    `end_date` DATE COMMENT '',
    `expected_lift_pct` DECIMAL(18,2) COMMENT '',
    `expected_lift_percent` DECIMAL(18,2) COMMENT 'Business attribute expected_lift_percent for marketing.marketing_lto',
    `is_active` BOOLEAN COMMENT '',
    `lto_code` STRING COMMENT '',
    `lto_description` STRING COMMENT '',
    `lto_name` STRING COMMENT '',
    `lto_status` STRING COMMENT '',
    `projected_lift_pct` DECIMAL(18,2) COMMENT '',
    `projected_lift_percent` DECIMAL(18,2) COMMENT '',
    `projected_revenue` DECIMAL(18,2) COMMENT '',
    `promo_price` DECIMAL(18,2) COMMENT '',
    `promotional_price` DECIMAL(18,2) COMMENT '',
    `source_system_code` STRING COMMENT '',
    `start_date` DATE COMMENT '',
    `marketing_lto_status` STRING COMMENT '',
    `target_audience` STRING COMMENT 'Business attribute target_audience for marketing_lto',
    `target_revenue` DECIMAL(18,2) COMMENT 'Business attribute target_revenue derived from business context.',
    `target_revenue_amount` DECIMAL(18,2) COMMENT 'Target revenue amount',
    `target_sales` DECIMAL(18,2) COMMENT '',
    `target_sales_lift` DECIMAL(18,2) COMMENT '',
    `target_segment` STRING COMMENT 'Business attribute target_segment for marketing.marketing_lto',
    `target_units` STRING COMMENT '',
    `target_units_sold` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` (
    ...
    `payment_status` DECIMAL(18,2) COMMENT 'Current payment processing status for the media buy.',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`media_channel` (
    ...
    `campaign_id` BIGINT COMMENT 'Connect marketing.media_channel by adding column campaign_id (BIGINT) with FK to marketing.campaign.campaign_id because media channels are isolated reference tables. P7: connect_table: marketing.media_channel** - add column campaign_id (BIG',
    ...
    `cost_model` DECIMAL(18,2) COMMENT 'Pricing model for media buying on the channel.',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`ad_creative` (
    ...
    `duration_seconds` DECIMAL(18,2) COMMENT 'Length of the creative in seconds; applicable to video and audio assets.',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`promotion` (
    ...
    `total_redemption_limit` DECIMAL(18,2) COMMENT 'Overall cap on the number of redemptions across all guests.',
    `updated_timestamp` TIMESTAMP COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`marketing_guest_segment` (
    ...
    `marketing_guest_segment_description` STRING COMMENT '',
    `effective_start_date` DATE COMMENT 'Effective start date',
    `estimated_reach` STRING COMMENT '',
    `estimated_size` STRING COMMENT 'Business attribute estimated_size derived from business context.',
    `is_active` BOOLEAN COMMENT '',
    `member_count` STRING COMMENT 'Estimated members in segment',
    `reached_size` STRING COMMENT '',
    ...
    `targeting_criteria` STRING COMMENT '',
    `updated_timestamp` TIMESTAMP COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`fund` (
    ...
    `legal_entity_id` BIGINT COMMENT 'FK to finance.legal_entity.legal_entity_id',
    ...
    `governance_model` STRING COMMENT 'Governance model controlling fund collection and disbursement (e.g. national, co-op, local).',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`digital_campaign_performance` (
    ...
    `bidding_strategy` DECIMAL(18,2) COMMENT 'Algorithmic bidding model applied to the campaign.',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`campaign_spend` (
    `campaign_spend_id` DECIMAL(18,2) COMMENT 'Unique system-generated identifier for each campaign spend record.',
    ...
    `budget_line_item_code` DECIMAL(18,2) COMMENT 'Code of the budget line item to which this spend is allocated.',
    ...
    `campaign_spend_status` DECIMAL(18,2) COMMENT 'Current processing status of the spend record.',
    ...
    `cost_center_code` DECIMAL(18,2) COMMENT 'Internal cost center to which the spend is charged.',
    ...
    `payment_status` DECIMAL(18,2) COMMENT 'Status of payment against the vendor invoice.',
    `spend_amount` DECIMAL(18,2) COMMENT 'Total gross amount of the spend before taxes, discounts, or adjustments.',
    `spend_category` DECIMAL(18,2) COMMENT 'Classification of spend type for budgeting and reporting.',
    `spend_description` DECIMAL(18,2) COMMENT 'Free‑text description providing context for the spend.',
    `spend_reference` DECIMAL(18,2) COMMENT 'External reference code or number assigned to the spend entry by the finance system.',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`influencer` (
    ...
    `campaign_id` BIGINT COMMENT 'Connect marketing.influencer by adding column campaign_id (BIGINT) with FK to marketing.campaign.campaign_id because the influencer table only connects via influencer_activation. P8: connect_table: marketing.influencer** - add column campai',
    ...
    `payment_terms` DECIMAL(18,2) COMMENT 'Text describing payment schedule and method (e.g., net‑30, upfront).',
...
CREATE OR REPLACE TABLE `vibe_restaurants_v1`.`marketing`.`influencer_activation` (
    ...
    `payment_currency` DECIMAL(18,2) COMMENT 'Three‑letter ISO 4217 code of the currency used for influencer payment.',
    ...
    `total_engagement` DECIMAL(18,2) COMMENT 'Aggregate of likes, comments, and shares for the activation.',
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign` ALTER COLUMN `campaign_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign` ALTER COLUMN `campaign_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_execution` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`marketing_lto` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`marketing_lto` ALTER COLUMN `lto_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_plan` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_plan` ALTER COLUMN `agency_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_plan` ALTER COLUMN `brand_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_plan` ALTER COLUMN `brand_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` ALTER COLUMN `procurement_supplier_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Identifier');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` ALTER COLUMN `agency_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` ALTER COLUMN `placement_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_buy` ALTER COLUMN `publisher_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_channel` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`media_channel` ALTER COLUMN `media_channel_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`ad_creative` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`ad_creative` ALTER COLUMN `creative_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`promotion` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`promotion` ALTER COLUMN `food_safety_audit_id` SET TAGS ('dbx_business_glossary_term' = 'Food Safety Audit Id (Foreign Key)');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`promotion` ALTER COLUMN `promotion_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`promotion_redemption` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`marketing_guest_segment` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`marketing_guest_segment` ALTER COLUMN `segment_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`marketing_guest_segment` ALTER COLUMN `segment_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`local_store_marketing` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`local_store_marketing` SET TAGS ('dbx_subdomain' = 'promotional_engagement');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`local_store_marketing` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`local_store_marketing` ALTER COLUMN `compliance_flag` SET TAGS ('dbx_type_corrected' = 'BOOLEAN');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`local_store_marketing` ALTER COLUMN `initiative_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`fund` SET TAGS ('dbx_subdomain' = 'audience_targeting');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`fund` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`fund` ALTER COLUMN `fund_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`fund_contribution` SET TAGS ('dbx_subdomain' = 'audience_targeting');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`fund_contribution` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`digital_campaign_performance` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`digital_campaign_performance` ALTER COLUMN `ad_group_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_spend` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_spend` ALTER COLUMN `procurement_supplier_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor ID');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_spend` ALTER COLUMN `vendor_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`coupon` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`coupon` ALTER COLUMN `coupon_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`influencer` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`influencer_activation` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`campaign_roi` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`content_template` SET TAGS ('dbx_subdomain' = 'media_buying');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`content_template` SET TAGS ('dbx_structure_locked' = 'v2');
...
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`content_template` ALTER COLUMN `template_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_restaurants_v1`.`marketing`.`content_template` ALTER COLUMN `template_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
