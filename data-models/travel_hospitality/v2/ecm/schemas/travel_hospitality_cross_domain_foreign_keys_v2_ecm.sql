-- Cross-Domain Foreign Keys for Business: Travel_Hospitality | Version: v2_ecm
-- Generated on: 2026-07-10 20:57:58
-- Total cross-domain FK constraints: 1385
--
-- EXECUTION ORDER:
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`commission_accrual` ADD CONSTRAINT `fk_channel_commission_accrual_regulatory_filing_id` FOREIGN KEY (`regulatory_filing_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`regulatory_filing`(`regulatory_filing_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`metasearch_listing` ADD CONSTRAINT `fk_channel_metasearch_listing_account_id` FOREIGN KEY (`account_id`) REFERENCES `vibe_travel_hospitality_v1`.`event`.`account`(`account_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`metasearch_listing` ADD CONSTRAINT `fk_channel_metasearch_listing_platform_account_id` FOREIGN KEY (`platform_account_id`) REFERENCES `vibe_travel_hospitality_v1`.`event`.`account`(`account_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_negotiated_rate` ADD CONSTRAINT `fk_channel_channel_negotiated_rate_tmc_corporate_account_id` FOREIGN KEY (`tmc_corporate_account_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`corporate_account`(`corporate_account_id`);

-- ========= channel --> inventory (5 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`ota_partner` ADD CONSTRAINT `fk_channel_ota_partner_brand_id` FOREIGN KEY (`brand_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`brand`(`brand_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_contract` ADD CONSTRAINT `fk_channel_channel_contract_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`campaign`(`campaign_id`);
...
-- ========= channel --> procurement (9 constraint(s)) =========
-- Requires: channel schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel` ADD CONSTRAINT `fk_channel_channel_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`ota_partner` ADD CONSTRAINT `fk_channel_ota_partner_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`gds_connection` ADD CONSTRAINT `fk_channel_gds_connection_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_contract` ADD CONSTRAINT `fk_channel_channel_contract_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_contract` ADD CONSTRAINT `fk_channel_channel_contract_vendor_contract_id` FOREIGN KEY (`vendor_contract_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_contract`(`vendor_contract_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`metasearch_listing` ADD CONSTRAINT `fk_channel_metasearch_listing_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`channel_negotiated_rate` ADD CONSTRAINT `fk_channel_channel_negotiated_rate_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`package_rate` ADD CONSTRAINT `fk_channel_package_rate_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`channel`.`ota_campaign_participation` ADD CONSTRAINT `fk_channel_ota_campaign_participation_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`audit` ADD CONSTRAINT `fk_compliance_audit_ap_invoice_id` FOREIGN KEY (`ap_invoice_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ap_invoice`(`ap_invoice_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`third_party_due_diligence` ADD CONSTRAINT `fk_compliance_third_party_due_diligence_corporate_account_id` FOREIGN KEY (`corporate_account_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`corporate_account`(`corporate_account_id`);
...
-- ========= compliance --> loyalty (6 constraint(s)) =========
-- Requires: compliance schema, loyalty schema
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`audit` ADD CONSTRAINT `fk_compliance_audit_program_config_id` FOREIGN KEY (`program_config_id`) REFERENCES `vibe_travel_hospitality_v1`.`loyalty`.`program_config`(`program_config_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_created_by_user_employee_id` FOREIGN KEY (`created_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_updated_by_user_employee_id` FOREIGN KEY (`updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`permit_renewal` ADD CONSTRAINT `fk_compliance_permit_renewal_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`audit_finding` ADD CONSTRAINT `fk_compliance_audit_finding_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`corrective_action` ADD CONSTRAINT `fk_compliance_corrective_action_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident` ADD CONSTRAINT `fk_compliance_health_safety_incident_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident` ADD CONSTRAINT `fk_compliance_health_safety_incident_tertiary_health_updated_by_user_employee_id` FOREIGN KEY (`tertiary_health_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`incident_investigation` ADD CONSTRAINT `fk_compliance_incident_investigation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`incident_investigation` ADD CONSTRAINT `fk_compliance_incident_investigation_tertiary_incident_updated_by_user_employee_id` FOREIGN KEY (`tertiary_incident_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`privacy_incident` ADD CONSTRAINT `fk_compliance_privacy_incident_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`privacy_incident` ADD CONSTRAINT `fk_compliance_privacy_incident_tertiary_privacy_updated_by_user_employee_id` FOREIGN KEY (`tertiary_privacy_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`dpia` ADD CONSTRAINT `fk_compliance_dpia_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`dpia` ADD CONSTRAINT `fk_compliance_dpia_updated_by_user_employee_id` FOREIGN KEY (`updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`food_safety_cert` ADD CONSTRAINT `fk_compliance_food_safety_cert_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`food_safety_cert` ADD CONSTRAINT `fk_compliance_food_safety_cert_tertiary_food_updated_by_user_employee_id` FOREIGN KEY (`tertiary_food_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`fire_safety_record` ADD CONSTRAINT `fk_compliance_fire_safety_record_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`ada_assessment` ADD CONSTRAINT `fk_compliance_ada_assessment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion` ADD CONSTRAINT `fk_compliance_compliance_training_completion_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion` ADD CONSTRAINT `fk_compliance_compliance_training_completion_tertiary_compliance_updated_by_user_employee_id` FOREIGN KEY (`tertiary_compliance_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`risk_register` ADD CONSTRAINT `fk_compliance_risk_register_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`risk_register` ADD CONSTRAINT `fk_compliance_risk_register_primary_risk_owner_employee_id` FOREIGN KEY (`primary_risk_owner_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`risk_register` ADD CONSTRAINT `fk_compliance_risk_register_updated_by_user_employee_id` FOREIGN KEY (`updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`regulatory_filing` ADD CONSTRAINT `fk_compliance_regulatory_filing_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy` ADD CONSTRAINT `fk_compliance_policy_created_by_user_employee_id` FOREIGN KEY (`created_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy` ADD CONSTRAINT `fk_compliance_policy_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy` ADD CONSTRAINT `fk_compliance_policy_updated_by_user_employee_id` FOREIGN KEY (`updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_quaternary_policy_created_by_user_employee_id` FOREIGN KEY (`quaternary_policy_created_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_quinary_policy_updated_by_user_employee_id` FOREIGN KEY (`quinary_policy_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`policy_acknowledgment` ADD CONSTRAINT `fk_compliance_policy_acknowledgment_tertiary_policy_escalated_to_user_employee_id` FOREIGN KEY (`tertiary_policy_escalated_to_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`third_party_due_diligence` ADD CONSTRAINT `fk_compliance_third_party_due_diligence_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`environmental_compliance` ADD CONSTRAINT `fk_compliance_environmental_compliance_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`whistleblower_report` ADD CONSTRAINT `fk_compliance_whistleblower_report_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`whistleblower_report` ADD CONSTRAINT `fk_compliance_whistleblower_report_tertiary_whistleblower_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_whistleblower_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_primary_sanction_employee_id` FOREIGN KEY (`primary_sanction_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_reviewer_employee_id` FOREIGN KEY (`reviewer_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`sanction_screening` ADD CONSTRAINT `fk_compliance_sanction_screening_updated_by_user_employee_id` FOREIGN KEY (`updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_last_modified_by_user_employee_id` FOREIGN KEY (`last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`compliance_calendar` ADD CONSTRAINT `fk_compliance_compliance_calendar_primary_compliance_responsible_owner_employee_id` FOREIGN KEY (`primary_compliance_responsible_owner_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`compliance`.`audit_finding` ADD CONSTRAINT `fk_compliance_audit_finding_reservation_booking_id` FOREIGN KEY (`reservation_booking_id`) REFERENCES `vibe_travel_hospitality_v1`.`reservation`.`reservation_booking`(`reservation_booking_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_group_block` ADD CONSTRAINT `fk_event_event_group_block_channel_id` FOREIGN KEY (`channel_id`) REFERENCES `vibe_travel_hospitality_v1`.`channel`.`channel`(`channel_id`);

-- ========= event --> compliance (13 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_group_block` ADD CONSTRAINT `fk_event_event_group_block_obligation_id` FOREIGN KEY (`obligation_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`obligation`(`obligation_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_contract` ADD CONSTRAINT `fk_event_event_contract_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`attendee` ADD CONSTRAINT `fk_event_attendee_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`experience_enrollment` ADD CONSTRAINT `fk_event_experience_enrollment_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`profile`(`profile_id`);
...
-- ========= event --> marketing (9 constraint(s)) =========
-- Requires: event schema, marketing schema
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`account` ADD CONSTRAINT `fk_event_account_guest_segment_id` FOREIGN KEY (`guest_segment_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`guest_segment`(`guest_segment_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_content_asset_id` FOREIGN KEY (`content_asset_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`content_asset`(`content_asset_id`);
...
-- ========= event --> procurement (16 constraint(s)) =========
-- Requires: event schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`account` ADD CONSTRAINT `fk_event_account_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`proposal` ADD CONSTRAINT `fk_event_proposal_approved_by_employee_id` FOREIGN KEY (`approved_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`proposal` ADD CONSTRAINT `fk_event_proposal_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_booking` ADD CONSTRAINT `fk_event_event_booking_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_space_allocation` ADD CONSTRAINT `fk_event_event_space_allocation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_banquet_captain_employee_id` FOREIGN KEY (`banquet_captain_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_modified_by_user_employee_id` FOREIGN KEY (`modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_contract` ADD CONSTRAINT `fk_event_event_contract_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`lost_business` ADD CONSTRAINT `fk_event_lost_business_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_class_enrollment` ADD CONSTRAINT `fk_event_event_class_enrollment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo_attendant_assignment` ADD CONSTRAINT `fk_event_beo_attendant_assignment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`staffing_assignment` ADD CONSTRAINT `fk_event_staffing_assignment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= event --> property (21 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo_attendant_assignment` ADD CONSTRAINT `fk_event_beo_attendant_assignment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`experience_enrollment` ADD CONSTRAINT `fk_event_experience_enrollment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`treatment_allocation` ADD CONSTRAINT `fk_event_treatment_allocation_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`staffing_assignment` ADD CONSTRAINT `fk_event_staffing_assignment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_group_block` ADD CONSTRAINT `fk_event_event_group_block_ssot_reservation_group_block_fk` FOREIGN KEY (`ssot_reservation_group_block_fk`) REFERENCES `vibe_travel_hospitality_v1`.`reservation`.`reservation_group_block`(`reservation_group_block_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`event_booking` ADD CONSTRAINT `fk_event_event_booking_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`spa_facility`(`facility_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`beo` ADD CONSTRAINT `fk_event_beo_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`spa_facility`(`facility_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`event`.`attendee` ADD CONSTRAINT `fk_event_attendee_membership_id` FOREIGN KEY (`membership_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`membership`(`membership_id`);
...
-- ========= experience --> compliance (6 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`reputation_alert` ADD CONSTRAINT `fk_experience_reputation_alert_whistleblower_report_id` FOREIGN KEY (`whistleblower_report_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`whistleblower_report`(`whistleblower_report_id`);
...
-- ========= experience --> procurement (18 constraint(s)) =========
-- Requires: experience schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_feedback` ADD CONSTRAINT `fk_experience_guest_feedback_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_feedback` ADD CONSTRAINT `fk_experience_guest_feedback_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`vendor`(`vendor_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_case` ADD CONSTRAINT `fk_experience_service_case_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_case` ADD CONSTRAINT `fk_experience_service_case_tertiary_service_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_service_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`case_activity` ADD CONSTRAINT `fk_experience_case_activity_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_recovery_action` ADD CONSTRAINT `fk_experience_service_recovery_action_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_recovery_action` ADD CONSTRAINT `fk_experience_service_recovery_action_quaternary_service_last_modified_by_employee_id` FOREIGN KEY (`quaternary_service_last_modified_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`service_recovery_action` ADD CONSTRAINT `fk_experience_service_recovery_action_tertiary_service_created_by_employee_id` FOREIGN KEY (`tertiary_service_created_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`experience_special_request` ADD CONSTRAINT `fk_experience_experience_special_request_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`amenity_fulfillment` ADD CONSTRAINT `fk_experience_amenity_fulfillment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_interaction` ADD CONSTRAINT `fk_experience_guest_interaction_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_interaction` ADD CONSTRAINT `fk_experience_guest_interaction_tertiary_guest_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_guest_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`guest_experience_enrollment` ADD CONSTRAINT `fk_experience_guest_experience_enrollment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`reputation_alert` ADD CONSTRAINT `fk_experience_reputation_alert_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
-- ========= experience --> property (26 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`experience`.`touchpoint` ADD CONSTRAINT `fk_experience_touchpoint_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
-- ========= finance --> procurement (29 constraint(s)) =========
-- Requires: finance schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`profit_center` ADD CONSTRAINT `fk_finance_profit_center_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_quaternary_journal_last_modified_by_user_employee_id` FOREIGN KEY (`quaternary_journal_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`journal_entry` ADD CONSTRAINT `fk_finance_journal_entry_tertiary_journal_posted_by_user_employee_id` FOREIGN KEY (`tertiary_journal_posted_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`ar_payment` ADD CONSTRAINT `fk_finance_ar_payment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`budget_line` ADD CONSTRAINT `fk_finance_budget_line_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`budget_line` ADD CONSTRAINT `fk_finance_budget_line_position_id` FOREIGN KEY (`position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`position`(`position_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`management_fee` ADD CONSTRAINT `fk_finance_management_fee_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`owner_distribution` ADD CONSTRAINT `fk_finance_owner_distribution_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`payment_run` ADD CONSTRAINT `fk_finance_payment_run_created_by_user_employee_id` FOREIGN KEY (`created_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`payment_run` ADD CONSTRAINT `fk_finance_payment_run_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`capex_request` ADD CONSTRAINT `fk_finance_capex_request_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`capex_request` ADD CONSTRAINT `fk_finance_capex_request_requestor_employee_id` FOREIGN KEY (`requestor_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_run` ADD CONSTRAINT `fk_finance_allocation_run_approved_by_user_employee_id` FOREIGN KEY (`approved_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_run` ADD CONSTRAINT `fk_finance_allocation_run_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_rule_set` ADD CONSTRAINT `fk_finance_allocation_rule_set_created_by_user_employee_id` FOREIGN KEY (`created_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_rule_set` ADD CONSTRAINT `fk_finance_allocation_rule_set_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`allocation_rule_set` ADD CONSTRAINT `fk_finance_allocation_rule_set_last_modified_by_user_employee_id` FOREIGN KEY (`last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= finance --> property (31 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`finance`.`finance_budget` ADD CONSTRAINT `fk_finance_budget_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
-- ========= finance --> workforce (1 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check` ADD CONSTRAINT `fk_fnb_pos_check_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`banquet_event_order` ADD CONSTRAINT `fk_fnb_banquet_event_order_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`banquet_event_order` ADD CONSTRAINT `fk_fnb_banquet_event_order_function_space_id_fk` FOREIGN KEY (`function_space_id_fk`) REFERENCES `vibe_travel_hospitality_v1`.`event`.`function_space`(`function_space_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`discount` ADD CONSTRAINT `fk_fnb_discount_ledger_id` FOREIGN KEY (`ledger_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ledger`(`ledger_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`room_service_order` ADD CONSTRAINT `fk_fnb_room_service_order_campaign_offer_id` FOREIGN KEY (`campaign_offer_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`campaign_offer`(`campaign_offer_id`);
...
-- ========= fnb --> procurement (31 constraint(s)) =========
-- Requires: fnb schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`fnb_outlet` ADD CONSTRAINT `fk_fnb_fnb_outlet_category_id` FOREIGN KEY (`category_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`category`(`category_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`fnb_outlet` ADD CONSTRAINT `fk_fnb_fnb_outlet_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`menu` ADD CONSTRAINT `fk_fnb_menu_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check` ADD CONSTRAINT `fk_fnb_pos_check_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check` ADD CONSTRAINT `fk_fnb_pos_check_tertiary_pos_manager_employee_id` FOREIGN KEY (`tertiary_pos_manager_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`pos_check_line` ADD CONSTRAINT `fk_fnb_pos_check_line_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`void_transaction` ADD CONSTRAINT `fk_fnb_void_transaction_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`room_service_order` ADD CONSTRAINT `fk_fnb_room_service_order_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`banquet_menu_package` ADD CONSTRAINT `fk_fnb_banquet_menu_package_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`stock_transaction` ADD CONSTRAINT `fk_fnb_stock_transaction_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`discount` ADD CONSTRAINT `fk_fnb_discount_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`food_safety_inspection` ADD CONSTRAINT `fk_fnb_food_safety_inspection_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`waste_log` ADD CONSTRAINT `fk_fnb_waste_log_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`fnb_supply_agreement` ADD CONSTRAINT `fk_fnb_fnb_supply_agreement_supply_agreement_id` FOREIGN KEY (`supply_agreement_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_supply_agreement`(`supply_agreement_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`fnb_supply_agreement` ADD CONSTRAINT `fk_fnb_fnb_supply_agreement_ssot_supply_agreement_fk` FOREIGN KEY (`ssot_supply_agreement_fk`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_supply_agreement`(`supply_agreement_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`storage_location` ADD CONSTRAINT `fk_fnb_storage_location_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_counter_employee_id` FOREIGN KEY (`counter_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`physical_count` ADD CONSTRAINT `fk_fnb_physical_count_supervisor_employee_id` FOREIGN KEY (`supervisor_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= fnb --> property (15 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`fnb`.`recipe_ingredient` ADD CONSTRAINT `fk_fnb_recipe_ingredient_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`guest_group_block` ADD CONSTRAINT `fk_guest_guest_group_block_ar_invoice_id` FOREIGN KEY (`ar_invoice_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ar_invoice`(`ar_invoice_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`guest_enrollment` ADD CONSTRAINT `fk_guest_guest_enrollment_loyalty_enrollment_id` FOREIGN KEY (`loyalty_enrollment_id`) REFERENCES `vibe_travel_hospitality_v1`.`loyalty`.`loyalty_enrollment`(`loyalty_enrollment_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`preference` ADD CONSTRAINT `fk_guest_preference_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`guest_group_block` ADD CONSTRAINT `fk_guest_guest_group_block_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`vip_designation` ADD CONSTRAINT `fk_guest_vip_designation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`vip_designation` ADD CONSTRAINT `fk_guest_vip_designation_quaternary_vip_assigned_host_employee_id` FOREIGN KEY (`quaternary_vip_assigned_host_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`vip_designation` ADD CONSTRAINT `fk_guest_vip_designation_tertiary_vip_approved_by_employee_id` FOREIGN KEY (`tertiary_vip_approved_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`note` ADD CONSTRAINT `fk_guest_note_assigned_staff_employee_id` FOREIGN KEY (`assigned_staff_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`note` ADD CONSTRAINT `fk_guest_note_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`note` ADD CONSTRAINT `fk_guest_note_resolved_by_staff_employee_id` FOREIGN KEY (`resolved_by_staff_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`identity_document` ADD CONSTRAINT `fk_guest_identity_document_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`profile_merge_history` ADD CONSTRAINT `fk_guest_profile_merge_history_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`relationship` ADD CONSTRAINT `fk_guest_relationship_created_by_staff_employee_id` FOREIGN KEY (`created_by_staff_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`relationship` ADD CONSTRAINT `fk_guest_relationship_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`relationship` ADD CONSTRAINT `fk_guest_relationship_last_modified_by_staff_employee_id` FOREIGN KEY (`last_modified_by_staff_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`guest`.`privacy_request` ADD CONSTRAINT `fk_guest_privacy_request_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= guest --> property (13 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_assignment` ADD CONSTRAINT `fk_housekeeping_hk_assignment_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`linen_management` ADD CONSTRAINT `fk_housekeeping_linen_management_environmental_compliance_id` FOREIGN KEY (`environmental_compliance_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`environmental_compliance`(`environmental_compliance_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`housekeeping_training_completion` ADD CONSTRAINT `fk_housekeeping_housekeeping_training_completion_ssot_compliance_training_completion_fk` FOREIGN KEY (`ssot_compliance_training_completion_fk`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`compliance_training_completion`(`compliance_training_completion_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_assignment` ADD CONSTRAINT `fk_housekeeping_hk_assignment_guest_feedback_id` FOREIGN KEY (`guest_feedback_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`guest_feedback`(`guest_feedback_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection` ADD CONSTRAINT `fk_housekeeping_inspection_service_recovery_action_id` FOREIGN KEY (`service_recovery_action_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`service_recovery_action`(`service_recovery_action_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_reputation_alert_id` FOREIGN KEY (`reputation_alert_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`reputation_alert`(`reputation_alert_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_service_case_id` FOREIGN KEY (`service_case_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`service_case`(`service_case_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`lost_and_found` ADD CONSTRAINT `fk_housekeeping_lost_and_found_experience_special_request_id` FOREIGN KEY (`experience_special_request_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`experience_special_request`(`experience_special_request_id`);
...
-- ========= housekeeping --> guest (9 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`supply_consumption` ADD CONSTRAINT `fk_housekeeping_supply_consumption_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`profile`(`profile_id`);
...
-- ========= housekeeping --> procurement (35 constraint(s)) =========
-- Requires: housekeeping schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_assignment` ADD CONSTRAINT `fk_housekeeping_hk_assignment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`cleaning_task` ADD CONSTRAINT `fk_housekeeping_cleaning_task_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection` ADD CONSTRAINT `fk_housekeeping_inspection_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection` ADD CONSTRAINT `fk_housekeeping_inspection_inspector_employee_id` FOREIGN KEY (`inspector_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`inspection_deficiency` ADD CONSTRAINT `fk_housekeeping_inspection_deficiency_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_handoff` ADD CONSTRAINT `fk_housekeeping_maintenance_handoff_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_schedule` ADD CONSTRAINT `fk_housekeeping_hk_schedule_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`hk_schedule` ADD CONSTRAINT `fk_housekeeping_hk_schedule_tertiary_hk_modified_by_user_employee_id` FOREIGN KEY (`tertiary_hk_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`attendant` ADD CONSTRAINT `fk_housekeeping_attendant_position_id` FOREIGN KEY (`position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`position`(`position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`linen_management` ADD CONSTRAINT `fk_housekeeping_linen_management_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`supply_consumption` ADD CONSTRAINT `fk_housekeeping_supply_consumption_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`lost_and_found` ADD CONSTRAINT `fk_housekeeping_lost_and_found_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_primary_deep_employee_id` FOREIGN KEY (`primary_deep_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`laundry_order` ADD CONSTRAINT `fk_housekeeping_laundry_order_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`laundry_order` ADD CONSTRAINT `fk_housekeeping_laundry_order_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`public_area` ADD CONSTRAINT `fk_housekeeping_public_area_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_inspected_by_employee_id` FOREIGN KEY (`inspected_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_procurement_work_order_id` FOREIGN KEY (`procurement_work_order_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_requested_by_employee_id` FOREIGN KEY (`requested_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_work_order_ssot_id` FOREIGN KEY (`work_order_ssot_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_work_order_work_order_id` FOREIGN KEY (`work_order_work_order_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`work_order` ADD CONSTRAINT `fk_housekeeping_work_order_ssot_work_order_fk` FOREIGN KEY (`ssot_work_order_fk`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`team` ADD CONSTRAINT `fk_housekeeping_team_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_request` ADD CONSTRAINT `fk_housekeeping_maintenance_request_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_request` ADD CONSTRAINT `fk_housekeeping_maintenance_request_inspector_employee_id` FOREIGN KEY (`inspector_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_request` ADD CONSTRAINT `fk_housekeeping_maintenance_request_reported_by_employee_id` FOREIGN KEY (`reported_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`maintenance_handoff` ADD CONSTRAINT `fk_housekeeping_maintenance_handoff_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`spa_facility`(`facility_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`housekeeping`.`deep_clean_plan` ADD CONSTRAINT `fk_housekeeping_deep_clean_plan_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`spa_facility`(`facility_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_status` ADD CONSTRAINT `fk_inventory_room_status_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_amenity` ADD CONSTRAINT `fk_inventory_room_amenity_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`out_of_order` ADD CONSTRAINT `fk_inventory_out_of_order_ledger_id` FOREIGN KEY (`ledger_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ledger`(`ledger_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`availability_snapshot` ADD CONSTRAINT `fk_inventory_availability_snapshot_experiment_id` FOREIGN KEY (`experiment_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`experiment`(`experiment_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_block` ADD CONSTRAINT `fk_inventory_room_block_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`campaign`(`campaign_id`);
...
-- ========= inventory --> procurement (17 constraint(s)) =========
-- Requires: inventory schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_status` ADD CONSTRAINT `fk_inventory_room_status_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_status` ADD CONSTRAINT `fk_inventory_room_status_room_updated_by_user_employee_id` FOREIGN KEY (`room_updated_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_block` ADD CONSTRAINT `fk_inventory_room_block_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_block` ADD CONSTRAINT `fk_inventory_room_block_tertiary_room_modified_by_user_employee_id` FOREIGN KEY (`tertiary_room_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_block` ADD CONSTRAINT `fk_inventory_room_block_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`vendor`(`vendor_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`out_of_order` ADD CONSTRAINT `fk_inventory_out_of_order_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`out_of_order` ADD CONSTRAINT `fk_inventory_out_of_order_tertiary_out_closed_by_user_employee_id` FOREIGN KEY (`tertiary_out_closed_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`inventory_overbooking_policy` ADD CONSTRAINT `fk_inventory_inventory_overbooking_policy_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`inventory_overbooking_policy` ADD CONSTRAINT `fk_inventory_inventory_overbooking_policy_tertiary_inventory_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_inventory_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`los_restriction` ADD CONSTRAINT `fk_inventory_los_restriction_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`channel_inventory_map` ADD CONSTRAINT `fk_inventory_channel_inventory_map_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`change_audit` ADD CONSTRAINT `fk_inventory_change_audit_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_amenity` ADD CONSTRAINT `fk_inventory_room_amenity_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
-- ========= inventory --> property (15 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`room_material_installation` ADD CONSTRAINT `fk_inventory_room_material_installation_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`inventory`.`block_wash_factor_application` ADD CONSTRAINT `fk_inventory_block_wash_factor_application_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`member` ADD CONSTRAINT `fk_loyalty_member_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`promotion` ADD CONSTRAINT `fk_loyalty_promotion_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`member` ADD CONSTRAINT `fk_loyalty_member_member_profile_id` FOREIGN KEY (`member_profile_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`profile`(`profile_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`tier_history` ADD CONSTRAINT `fk_loyalty_tier_history_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`points_ledger` ADD CONSTRAINT `fk_loyalty_points_ledger_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`accrual_rule` ADD CONSTRAINT `fk_loyalty_accrual_rule_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`redemption_rule` ADD CONSTRAINT `fk_loyalty_redemption_rule_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`loyalty_enrollment` ADD CONSTRAINT `fk_loyalty_loyalty_enrollment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`benefit_entitlement` ADD CONSTRAINT `fk_loyalty_benefit_entitlement_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`benefit_entitlement` ADD CONSTRAINT `fk_loyalty_benefit_entitlement_tertiary_benefit_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_benefit_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`benefit_redemption` ADD CONSTRAINT `fk_loyalty_benefit_redemption_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`promotion` ADD CONSTRAINT `fk_loyalty_promotion_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`program_config` ADD CONSTRAINT `fk_loyalty_program_config_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`member_segment` ADD CONSTRAINT `fk_loyalty_member_segment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`certificate` ADD CONSTRAINT `fk_loyalty_certificate_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`loyalty`.`promotion_distribution` ADD CONSTRAINT `fk_loyalty_promotion_distribution_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`campaign` ADD CONSTRAINT `fk_marketing_campaign_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`guest_communication` ADD CONSTRAINT `fk_marketing_guest_communication_privacy_incident_id` FOREIGN KEY (`privacy_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`privacy_incident`(`privacy_incident_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`campaign` ADD CONSTRAINT `fk_marketing_campaign_vendor_contract_id` FOREIGN KEY (`vendor_contract_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_contract`(`vendor_contract_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`campaign_execution` ADD CONSTRAINT `fk_marketing_campaign_execution_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`guest_segment` ADD CONSTRAINT `fk_marketing_guest_segment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`survey_program` ADD CONSTRAINT `fk_marketing_survey_program_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`survey_program` ADD CONSTRAINT `fk_marketing_survey_program_tertiary_survey_modified_by_user_employee_id` FOREIGN KEY (`tertiary_survey_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`brand` ADD CONSTRAINT `fk_marketing_brand_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`consent` ADD CONSTRAINT `fk_marketing_consent_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`experiment` ADD CONSTRAINT `fk_marketing_experiment_approved_by_user_employee_id` FOREIGN KEY (`approved_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`experiment` ADD CONSTRAINT `fk_marketing_experiment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`experiment` ADD CONSTRAINT `fk_marketing_experiment_modified_by_user_employee_id` FOREIGN KEY (`modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`marketing_calendar` ADD CONSTRAINT `fk_marketing_marketing_calendar_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`marketing_calendar` ADD CONSTRAINT `fk_marketing_marketing_calendar_tertiary_marketing_modified_by_user_employee_id` FOREIGN KEY (`tertiary_marketing_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= marketing --> property (10 constraint(s)) =========
-- Requires: marketing schema, property schema
ALTER TABLE `vibe_travel_hospitality_v1`.`marketing`.`campaign_offer` ADD CONSTRAINT `fk_marketing_campaign_offer_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_contract` ADD CONSTRAINT `fk_procurement_vendor_contract_obligation_id` FOREIGN KEY (`obligation_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`obligation`(`obligation_id`);

-- ========= procurement --> experience (4 constraint(s)) =========
-- Requires: procurement schema, experience schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`vendor_program_participation` ADD CONSTRAINT `fk_procurement_vendor_program_participation_experience_program_id` FOREIGN KEY (`experience_program_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`program`(`program_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`vendor_program_participation` ADD CONSTRAINT `fk_procurement_vendor_program_participation_program_id` FOREIGN KEY (`program_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`program`(`program_id`);
...
-- ========= procurement --> finance (7 constraint(s)) =========
-- Requires: procurement schema, finance schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`employee` ADD CONSTRAINT `fk_procurement_employee_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`org_unit` ADD CONSTRAINT `fk_procurement_org_unit_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`work_order` ADD CONSTRAINT `fk_procurement_work_order_fixed_asset_id` FOREIGN KEY (`fixed_asset_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`fixed_asset`(`fixed_asset_id`);

-- ========= procurement --> loyalty (1 constraint(s)) =========
-- Requires: procurement schema, loyalty schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`program_assignment` ADD CONSTRAINT `fk_procurement_program_assignment_loyalty_enrollment_id` FOREIGN KEY (`loyalty_enrollment_id`) REFERENCES `vibe_travel_hospitality_v1`.`loyalty`.`loyalty_enrollment`(`loyalty_enrollment_id`);

-- ========= procurement --> property (19 constraint(s)) =========
-- Requires: procurement schema, property schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`employee` ADD CONSTRAINT `fk_procurement_employee_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`position` ADD CONSTRAINT `fk_procurement_position_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`org_unit` ADD CONSTRAINT `fk_procurement_org_unit_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`work_order` ADD CONSTRAINT `fk_procurement_work_order_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_contract` ADD CONSTRAINT `fk_procurement_vendor_contract_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);

-- ========= procurement --> spa (2 constraint(s)) =========
-- Requires: procurement schema, spa schema
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_therapist_certification` ADD CONSTRAINT `fk_procurement_therapist_certification_spa_therapist_certification_id` FOREIGN KEY (`spa_therapist_certification_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`spa_therapist_certification`(`therapist_certification_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`procurement`.`procurement_therapist_certification` ADD CONSTRAINT `fk_procurement_therapist_certification_treatment_id` FOREIGN KEY (`treatment_id`) REFERENCES `vibe_travel_hospitality_v1`.`spa`.`treatment`(`treatment_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`hierarchy` ADD CONSTRAINT `fk_property_hierarchy_revenue_center_id` FOREIGN KEY (`revenue_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`fnb`.`revenue_center`(`revenue_center_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`seasonal_calendar` ADD CONSTRAINT `fk_property_seasonal_calendar_banquet_menu_package_id` FOREIGN KEY (`banquet_menu_package_id`) REFERENCES `vibe_travel_hospitality_v1`.`fnb`.`banquet_menu_package`(`banquet_menu_package_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_outlet` ADD CONSTRAINT `fk_property_property_outlet_cleaning_standard_id` FOREIGN KEY (`cleaning_standard_id`) REFERENCES `vibe_travel_hospitality_v1`.`housekeeping`.`cleaning_standard`(`cleaning_standard_id`);

-- ========= property --> procurement (8 constraint(s)) =========
-- Requires: property schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_facility` ADD CONSTRAINT `fk_property_property_facility_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`pip_item` ADD CONSTRAINT `fk_property_pip_item_vendor_contract_id` FOREIGN KEY (`vendor_contract_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`procurement_contract`(`vendor_contract_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_outlet` ADD CONSTRAINT `fk_property_property_outlet_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`property`.`property_outlet` ADD CONSTRAINT `fk_property_property_outlet_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
...
-- ========= reservation --> inventory (2 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`booking_status_history` ADD CONSTRAINT `fk_reservation_booking_status_history_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`cancellation` ADD CONSTRAINT `fk_reservation_cancellation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`reservation_group_block` ADD CONSTRAINT `fk_reservation_reservation_group_block_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`reservation_rate_plan` ADD CONSTRAINT `fk_reservation_reservation_rate_plan_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`reservation_special_request` ADD CONSTRAINT `fk_reservation_reservation_special_request_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`deposit_ledger` ADD CONSTRAINT `fk_reservation_deposit_ledger_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`waitlist` ADD CONSTRAINT `fk_reservation_waitlist_converted_by_user_employee_id` FOREIGN KEY (`converted_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`waitlist` ADD CONSTRAINT `fk_reservation_waitlist_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`waitlist` ADD CONSTRAINT `fk_reservation_waitlist_modified_by_user_employee_id` FOREIGN KEY (`modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`room_assignment` ADD CONSTRAINT `fk_reservation_room_assignment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`room_assignment` ADD CONSTRAINT `fk_reservation_room_assignment_tertiary_room_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_room_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`reservation`.`walk_record` ADD CONSTRAINT `fk_reservation_walk_record_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= reservation --> property (13 constraint(s)) =========
...
-- ========= revenue --> channel (9 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_negotiated_rate` ADD CONSTRAINT `fk_revenue_revenue_negotiated_rate_channel_negotiated_rate_id` FOREIGN KEY (`channel_negotiated_rate_id`) REFERENCES `vibe_travel_hospitality_v1`.`channel`.`channel_negotiated_rate`(`channel_negotiated_rate_id`);

-- ========= revenue --> compliance (6 constraint(s)) =========
-- Requires: revenue schema, compliance schema
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_rate_plan` ADD CONSTRAINT `fk_revenue_revenue_rate_plan_obligation_id` FOREIGN KEY (`obligation_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`obligation`(`obligation_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitive_set` ADD CONSTRAINT `fk_revenue_competitive_set_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`policy`(`policy_id`);
...
-- ========= revenue --> experience (5 constraint(s)) =========
-- Requires: revenue schema, experience schema
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`performance_actuals` ADD CONSTRAINT `fk_revenue_performance_actuals_gss_score_id` FOREIGN KEY (`gss_score_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`gss_score`(`gss_score_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_budget` ADD CONSTRAINT `fk_revenue_revenue_budget_gss_score_id` FOREIGN KEY (`gss_score_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`gss_score`(`gss_score_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`strategy` ADD CONSTRAINT `fk_revenue_strategy_gss_score_id` FOREIGN KEY (`gss_score_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`gss_score`(`gss_score_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`segment_program_eligibility` ADD CONSTRAINT `fk_revenue_segment_program_eligibility_experience_program_id` FOREIGN KEY (`experience_program_id`) REFERENCES `vibe_travel_hospitality_v1`.`experience`.`program`(`program_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pricing_override` ADD CONSTRAINT `fk_revenue_pricing_override_ledger_id` FOREIGN KEY (`ledger_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ledger`(`ledger_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`demand_forecast` ADD CONSTRAINT `fk_revenue_demand_forecast_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`performance_actuals` ADD CONSTRAINT `fk_revenue_performance_actuals_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitive_set` ADD CONSTRAINT `fk_revenue_competitive_set_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_budget` ADD CONSTRAINT `fk_revenue_revenue_budget_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_budget` ADD CONSTRAINT `fk_revenue_revenue_budget_ssot_budget_fk` FOREIGN KEY (`ssot_budget_fk`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`displacement_analysis` ADD CONSTRAINT `fk_revenue_displacement_analysis_ledger_id` FOREIGN KEY (`ledger_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ledger`(`ledger_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`strategy` ADD CONSTRAINT `fk_revenue_strategy_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`total_revenue_actuals` ADD CONSTRAINT `fk_revenue_total_revenue_actuals_budget_id` FOREIGN KEY (`budget_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`finance_budget`(`budget_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`demand_forecast` ADD CONSTRAINT `fk_revenue_demand_forecast_fnb_outlet_id` FOREIGN KEY (`fnb_outlet_id`) REFERENCES `vibe_travel_hospitality_v1`.`fnb`.`fnb_outlet`(`fnb_outlet_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pickup_report` ADD CONSTRAINT `fk_revenue_pickup_report_fnb_outlet_id` FOREIGN KEY (`fnb_outlet_id`) REFERENCES `vibe_travel_hospitality_v1`.`fnb`.`fnb_outlet`(`fnb_outlet_id`);
...
-- ========= revenue --> loyalty (9 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_negotiated_rate` ADD CONSTRAINT `fk_revenue_revenue_negotiated_rate_campaign_id` FOREIGN KEY (`campaign_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`campaign`(`campaign_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_rate_plan` ADD CONSTRAINT `fk_revenue_revenue_rate_plan_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`dynamic_rate_rule` ADD CONSTRAINT `fk_revenue_dynamic_rate_rule_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pricing_override` ADD CONSTRAINT `fk_revenue_pricing_override_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pricing_override` ADD CONSTRAINT `fk_revenue_pricing_override_primary_pricing_employee_id` FOREIGN KEY (`primary_pricing_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`rate_availability` ADD CONSTRAINT `fk_revenue_rate_availability_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`demand_forecast` ADD CONSTRAINT `fk_revenue_demand_forecast_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`inventory_control` ADD CONSTRAINT `fk_revenue_inventory_control_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`performance_actuals` ADD CONSTRAINT `fk_revenue_performance_actuals_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitive_set` ADD CONSTRAINT `fk_revenue_competitive_set_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`str_benchmark` ADD CONSTRAINT `fk_revenue_str_benchmark_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitor_rate` ADD CONSTRAINT `fk_revenue_competitor_rate_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`pickup_report` ADD CONSTRAINT `fk_revenue_pickup_report_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_overbooking_policy` ADD CONSTRAINT `fk_revenue_revenue_overbooking_policy_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_budget` ADD CONSTRAINT `fk_revenue_revenue_budget_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`revenue_negotiated_rate` ADD CONSTRAINT `fk_revenue_revenue_negotiated_rate_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`total_revenue_actuals` ADD CONSTRAINT `fk_revenue_total_revenue_actuals_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`revenue`.`competitor_rate` ADD CONSTRAINT `fk_revenue_competitor_rate_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`retail_inventory` ADD CONSTRAINT `fk_spa_retail_inventory_health_safety_incident_id` FOREIGN KEY (`health_safety_incident_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`health_safety_incident`(`health_safety_incident_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_ada_assessment_id` FOREIGN KEY (`ada_assessment_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`ada_assessment`(`ada_assessment_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_fire_safety_record_id` FOREIGN KEY (`fire_safety_record_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`fire_safety_record`(`fire_safety_record_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_permit_id` FOREIGN KEY (`permit_id`) REFERENCES `vibe_travel_hospitality_v1`.`compliance`.`permit`(`permit_id`);

-- ========= spa --> experience (4 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`retail_inventory` ADD CONSTRAINT `fk_spa_retail_inventory_ap_invoice_id` FOREIGN KEY (`ap_invoice_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ap_invoice`(`ap_invoice_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`membership` ADD CONSTRAINT `fk_spa_membership_ar_invoice_id` FOREIGN KEY (`ar_invoice_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`ar_invoice`(`ar_invoice_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_fixed_asset_id` FOREIGN KEY (`fixed_asset_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`fixed_asset`(`fixed_asset_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_profit_center_id` FOREIGN KEY (`profit_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`profit_center`(`profit_center_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`day_pass` ADD CONSTRAINT `fk_spa_day_pass_pos_check_id` FOREIGN KEY (`pos_check_id`) REFERENCES `vibe_travel_hospitality_v1`.`fnb`.`pos_check`(`pos_check_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_class_enrollment` ADD CONSTRAINT `fk_spa_class_enrollment_profile_id` FOREIGN KEY (`profile_id`) REFERENCES `vibe_travel_hospitality_v1`.`guest`.`profile`(`profile_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_class_enrollment` ADD CONSTRAINT `fk_spa_class_enrollment_room_id` FOREIGN KEY (`room_id`) REFERENCES `vibe_travel_hospitality_v1`.`inventory`.`room`(`room_id`);

-- ========= spa --> loyalty (6 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`appointment_package` ADD CONSTRAINT `fk_spa_appointment_package_attribution_event_id` FOREIGN KEY (`attribution_event_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`attribution_event`(`attribution_event_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`day_pass` ADD CONSTRAINT `fk_spa_day_pass_guest_communication_id` FOREIGN KEY (`guest_communication_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`guest_communication`(`guest_communication_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`golf_tee_time` ADD CONSTRAINT `fk_spa_golf_tee_time_guest_communication_id` FOREIGN KEY (`guest_communication_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`guest_communication`(`guest_communication_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_content_asset_id` FOREIGN KEY (`content_asset_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`content_asset`(`content_asset_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_brand_id` FOREIGN KEY (`brand_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`brand`(`brand_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_class_enrollment` ADD CONSTRAINT `fk_spa_class_enrollment_survey_response_id` FOREIGN KEY (`survey_response_id`) REFERENCES `vibe_travel_hospitality_v1`.`marketing`.`survey_response`(`survey_response_id`);

-- ========= spa --> procurement (31 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`therapist` ADD CONSTRAINT `fk_spa_therapist_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`therapist` ADD CONSTRAINT `fk_spa_therapist_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`therapist` ADD CONSTRAINT `fk_spa_therapist_position_id` FOREIGN KEY (`position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`position`(`position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`appointment` ADD CONSTRAINT `fk_spa_appointment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`appointment_package` ADD CONSTRAINT `fk_spa_appointment_package_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`charge` ADD CONSTRAINT `fk_spa_charge_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`charge` ADD CONSTRAINT `fk_spa_charge_voided_by_user_employee_id` FOREIGN KEY (`voided_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`retail_transaction` ADD CONSTRAINT `fk_spa_retail_transaction_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`membership_visit` ADD CONSTRAINT `fk_spa_membership_visit_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`fitness_class` ADD CONSTRAINT `fk_spa_fitness_class_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`fitness_class` ADD CONSTRAINT `fk_spa_fitness_class_modified_by_user_employee_id` FOREIGN KEY (`modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`fitness_class_session` ADD CONSTRAINT `fk_spa_fitness_class_session_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`golf_tee_time` ADD CONSTRAINT `fk_spa_golf_tee_time_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`amenity_pricing` ADD CONSTRAINT `fk_spa_amenity_pricing_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`amenity_pricing` ADD CONSTRAINT `fk_spa_amenity_pricing_tertiary_amenity_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_amenity_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`cancellation_log` ADD CONSTRAINT `fk_spa_cancellation_log_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`wellness_program` ADD CONSTRAINT `fk_spa_wellness_program_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`wellness_program` ADD CONSTRAINT `fk_spa_wellness_program_tertiary_wellness_last_modified_by_user_employee_id` FOREIGN KEY (`tertiary_wellness_last_modified_by_user_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`group_booking` ADD CONSTRAINT `fk_spa_group_booking_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`product_line` ADD CONSTRAINT `fk_spa_product_line_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_class_enrollment` ADD CONSTRAINT `fk_spa_class_enrollment_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);

-- ========= spa --> property (35 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`program_treatment` ADD CONSTRAINT `fk_spa_program_treatment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`package_treatment` ADD CONSTRAINT `fk_spa_package_treatment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_facility` ADD CONSTRAINT `fk_spa_facility_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`spa_class_enrollment` ADD CONSTRAINT `fk_spa_class_enrollment_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);

-- ========= spa --> reservation (5 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`group_booking` ADD CONSTRAINT `fk_spa_group_booking_reservation_group_block_id` FOREIGN KEY (`reservation_group_block_id`) REFERENCES `vibe_travel_hospitality_v1`.`reservation`.`reservation_group_block`(`reservation_group_block_id`);

-- ========= spa --> revenue (7 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`spa`.`package` ADD CONSTRAINT `fk_spa_package_market_segment_id` FOREIGN KEY (`market_segment_id`) REFERENCES `vibe_travel_hospitality_v1`.`revenue`.`market_segment`(`market_segment_id`);
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ADD CONSTRAINT `fk_workforce_benefit_plan_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_travel_hospitality_v1`.`finance`.`cost_center`(`cost_center_id`);
...
-- ========= workforce --> procurement (20 constraint(s)) =========
-- Requires: workforce schema, procurement schema
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`disciplinary_action` ADD CONSTRAINT `fk_workforce_disciplinary_action_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`disciplinary_action` ADD CONSTRAINT `fk_workforce_disciplinary_action_tertiary_disciplinary_hr_business_partner_employee_id` FOREIGN KEY (`tertiary_disciplinary_hr_business_partner_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ADD CONSTRAINT `fk_workforce_job_requisition_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ADD CONSTRAINT `fk_workforce_job_requisition_position_id` FOREIGN KEY (`position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`position`(`position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ADD CONSTRAINT `fk_workforce_job_requisition_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`job_requisition` ADD CONSTRAINT `fk_workforce_job_requisition_tertiary_job_approved_by_employee_id` FOREIGN KEY (`tertiary_job_approved_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`leave_request` ADD CONSTRAINT `fk_workforce_leave_request_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`leave_request` ADD CONSTRAINT `fk_workforce_leave_request_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`leave_request` ADD CONSTRAINT `fk_workforce_leave_request_primary_leave_employee_id` FOREIGN KEY (`primary_leave_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`payroll_run` ADD CONSTRAINT `fk_workforce_payroll_run_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`performance_review` ADD CONSTRAINT `fk_workforce_performance_review_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`performance_review` ADD CONSTRAINT `fk_workforce_performance_review_position_id` FOREIGN KEY (`position_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`position`(`position_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`performance_review` ADD CONSTRAINT `fk_workforce_performance_review_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`performance_review` ADD CONSTRAINT `fk_workforce_performance_review_reviewer_employee_id` FOREIGN KEY (`reviewer_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`shift_template` ADD CONSTRAINT `fk_workforce_shift_template_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`shift_template` ADD CONSTRAINT `fk_workforce_shift_template_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ADD CONSTRAINT `fk_workforce_time_entry_org_unit_id` FOREIGN KEY (`org_unit_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`org_unit`(`org_unit_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ADD CONSTRAINT `fk_workforce_time_entry_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ADD CONSTRAINT `fk_workforce_time_entry_tertiary_time_edited_by_employee_id` FOREIGN KEY (`tertiary_time_edited_by_employee_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`employee`(`employee_id`);
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`time_entry` ADD CONSTRAINT `fk_workforce_time_entry_work_order_id` FOREIGN KEY (`work_order_id`) REFERENCES `vibe_travel_hospitality_v1`.`procurement`.`work_order`(`work_order_id`);

-- ========= workforce --> property (12 constraint(s)) =========
...
ALTER TABLE `vibe_travel_hospitality_v1`.`workforce`.`benefit_plan` ADD CONSTRAINT `fk_workforce_benefit_plan_property_id` FOREIGN KEY (`property_id`) REFERENCES `vibe_travel_hospitality_v1`.`property`.`property`(`property_id`);
