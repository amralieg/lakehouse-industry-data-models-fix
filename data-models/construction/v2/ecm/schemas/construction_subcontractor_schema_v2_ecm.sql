...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`subcontractor`.`back_charge` (
    ...
    `wbs_element_id` BIGINT COMMENT 'add column wbs_element_id (BIGINT) with FK to project.wbs_element.wbs_element_id - back charges must be coded to a WBS element for proper cost allocation',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` (
    ...
    `wbs_element_id` BIGINT COMMENT 'add column wbs_element_id (BIGINT) with FK to project.wbs_element.wbs_element_id - EOT claims from subcontractors impact specific WBS elements',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`subcontractor`.`final_account` (
    ...
    `agreement_id` BIGINT COMMENT 'add column agreement_id (BIGINT) with FK to contract.agreement.agreement_id - final accounts reconcile against the head contract agreement',
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_change_order` SET TAGS ('dbx_subdomain' = 'contract_modifications');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_change_order` ALTER COLUMN `subcontractor_change_order_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_change_order` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_change_order` ALTER COLUMN `co_title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`back_charge` SET TAGS ('dbx_subdomain' = 'contract_modifications');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`back_charge` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`back_charge` ALTER COLUMN `deduction_applied_amount` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`back_charge` ALTER COLUMN `deduction_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` SET TAGS ('dbx_subdomain' = 'claims_settlement');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` ALTER COLUMN `subcontractor_eot_claim_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Submitted By Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`subcontractor_eot_claim` ALTER COLUMN `assessed_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` SET TAGS ('dbx_subdomain' = 'claims_settlement');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Prepared By Employee Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `contractor_signatory_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `contractor_signatory_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `contractor_signatory_title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `contractor_signature_date` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `subcontractor_signatory_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `subcontractor_signatory_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `subcontractor_signatory_title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`final_account` ALTER COLUMN `subcontractor_signature_date` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` SET TAGS ('dbx_subdomain' = 'claims_settlement');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `performance_scorecard_id` SET TAGS ('dbx_business_glossary_term' = 'Performance Scorecard ID');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `agreement_id` SET TAGS ('dbx_business_glossary_term' = 'Agreement Id (Foreign Key)');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `construction_project_id` SET TAGS ('dbx_business_glossary_term' = 'Construction Project ID');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Evaluator Employee Id (Foreign Key)');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `firm_profile_id` SET TAGS ('dbx_business_glossary_term' = 'Subcontractor ID');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|approved|rejected');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `bid_eligibility_status` SET TAGS ('dbx_business_glossary_term' = 'Bid Eligibility Status');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `bid_eligibility_status` SET TAGS ('dbx_value_regex' = 'eligible|restricted|ineligible');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `change_order_disputes` SET TAGS ('dbx_business_glossary_term' = 'Change Order (CO) Disputes');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `commercial_conduct_score` SET TAGS ('dbx_business_glossary_term' = 'Commercial Conduct Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `evaluation_date` SET TAGS ('dbx_business_glossary_term' = 'Evaluation Date');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `evaluation_period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Evaluation Period End Date');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `evaluation_period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Evaluation Period Start Date');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `evaluator_comments` SET TAGS ('dbx_business_glossary_term' = 'Evaluator Comments');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `evaluator_role` SET TAGS ('dbx_business_glossary_term' = 'Evaluator Role');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `follow_up_due_date` SET TAGS ('dbx_business_glossary_term' = 'Follow-Up Due Date');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `follow_up_required` SET TAGS ('dbx_business_glossary_term' = 'Follow-Up Required Flag');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `hse_compliance_violations` SET TAGS ('dbx_business_glossary_term' = 'Health Safety and Environment (HSE) Compliance Violations');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `hse_lti_count` SET TAGS ('dbx_business_glossary_term' = 'Lost Time Injury (LTI) Count');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `hse_score` SET TAGS ('dbx_business_glossary_term' = 'Health Safety and Environment (HSE) Performance Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `hse_trir` SET TAGS ('dbx_business_glossary_term' = 'Total Recordable Incident Rate (TRIR)');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `improvement_areas` SET TAGS ('dbx_business_glossary_term' = 'Improvement Areas');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `overall_rating` SET TAGS ('dbx_business_glossary_term' = 'Overall Performance Rating');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `overall_rating` SET TAGS ('dbx_value_regex' = 'outstanding|exceeds_expectations|meets_expectations|needs_improvement|unsatisfactory');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `overall_score` SET TAGS ('dbx_business_glossary_term' = 'Overall Performance Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `prequalification_impact` SET TAGS ('dbx_business_glossary_term' = 'Prequalification Impact');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `prequalification_impact` SET TAGS ('dbx_value_regex' = 'renew|conditional_renewal|review_required|disqualify');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `productivity_rate` SET TAGS ('dbx_business_glossary_term' = 'Productivity Rate');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `productivity_score` SET TAGS ('dbx_business_glossary_term' = 'Productivity Performance Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `productivity_units_completed` SET TAGS ('dbx_business_glossary_term' = 'Productivity Units Completed');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `quality_ncr_count` SET TAGS ('dbx_business_glossary_term' = 'Non-Conformance Report (NCR) Count');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `quality_ncr_rate` SET TAGS ('dbx_business_glossary_term' = 'Non-Conformance Report (NCR) Rate');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `quality_score` SET TAGS ('dbx_business_glossary_term' = 'Quality Performance Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `recommended_action` SET TAGS ('dbx_business_glossary_term' = 'Recommended Action');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `recommended_action` SET TAGS ('dbx_value_regex' = 'continue|monitor|improve|watch_list|disqualify|suspend');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `rfi_response_timeliness_score` SET TAGS ('dbx_business_glossary_term' = 'Request for Information (RFI) Response Timeliness Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `schedule_adherence_spi` SET TAGS ('dbx_business_glossary_term' = 'Schedule Performance Index (SPI)');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `schedule_score` SET TAGS ('dbx_business_glossary_term' = 'Schedule Performance Score');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `strengths` SET TAGS ('dbx_business_glossary_term' = 'Performance Strengths');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `subcontractor_acknowledgement_date` SET TAGS ('dbx_business_glossary_term' = 'Subcontractor Acknowledgement Date');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `subcontractor_acknowledgement_date` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `subcontractor_response` SET TAGS ('dbx_business_glossary_term' = 'Subcontractor Response');
ALTER TABLE `vibe_construction_v1`.`subcontractor`.`performance_scorecard` ALTER COLUMN `subcontractor_response` SET TAGS ('dbx_pii_flag' = 'true');
