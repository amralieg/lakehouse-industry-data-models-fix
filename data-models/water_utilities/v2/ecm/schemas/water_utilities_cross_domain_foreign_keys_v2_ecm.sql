-- Cross-Domain Foreign Keys for Business: Water_Utilities | Version: v2_ecm
-- Generated on: 2026-07-10 18:43:53
-- Total cross-domain FK constraints: 1357
--
-- EXECUTION ORDER:
...
ALTER TABLE `vibe_water_utilities_v1`.`billing`.`dispute` ADD CONSTRAINT `fk_billing_dispute_lab_sample_id` FOREIGN KEY (`lab_sample_id`) REFERENCES `vibe_water_utilities_v1`.`laboratory`.`lab_sample`(`lab_sample_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`billing`.`invoice_line` ADD CONSTRAINT `fk_billing_invoice_line_cip_project_id` FOREIGN KEY (`cip_project_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`cip_project`(`cip_project_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`billing`.`invoice` ADD CONSTRAINT `fk_billing_invoice_water_sample_id` FOREIGN KEY (`water_sample_id`) REFERENCES `vibe_water_utilities_v1`.`quality`.`water_sample`(`water_sample_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`billing`.`dispute` ADD CONSTRAINT `fk_billing_dispute_analytical_result_id` FOREIGN KEY (`analytical_result_id`) REFERENCES `vibe_water_utilities_v1`.`quality`.`analytical_result`(`analytical_result_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`billing`.`billing_cycle` ADD CONSTRAINT `fk_billing_billing_cycle_territory_id` FOREIGN KEY (`territory_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`territory`(`territory_id`);
...
-- ========= compliance --> laboratory (17 constraint(s)) =========
...
-- ========= compliance --> supply (11 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`compliance`.`overflow_event` ADD CONSTRAINT `fk_compliance_overflow_event_sewer_network_id` FOREIGN KEY (`sewer_network_id`) REFERENCES `vibe_water_utilities_v1`.`wastewater`.`sewer_network`(`sewer_network_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`customer`.`customer_account` ADD CONSTRAINT `fk_customer_customer_account_billing_account_id` FOREIGN KEY (`billing_account_id`) REFERENCES `vibe_water_utilities_v1`.`billing`.`billing_account`(`billing_account_id`);
...
-- ========= customer --> service (15 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`customer`.`segment` ADD CONSTRAINT `fk_customer_segment_territory_id` FOREIGN KEY (`territory_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`territory`(`territory_id`);
...
-- ========= customer --> workforce (22 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`distribution`.`pump_station` ADD CONSTRAINT `fk_distribution_pump_station_regulatory_inspection_id` FOREIGN KEY (`regulatory_inspection_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`regulatory_inspection`(`regulatory_inspection_id`);
...
-- ========= distribution --> laboratory (1 constraint(s)) =========
...
-- ========= distribution --> quality (5 constraint(s)) =========
...
-- ========= distribution --> service (3 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`distribution`.`maintenance_zone` ADD CONSTRAINT `fk_distribution_maintenance_zone_territory_id` FOREIGN KEY (`territory_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`territory`(`territory_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`finance`.`ap_payment` ADD CONSTRAINT `fk_finance_ap_payment_invoice_id` FOREIGN KEY (`invoice_id`) REFERENCES `vibe_water_utilities_v1`.`billing`.`invoice`(`invoice_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`finance`.`finance_budget` ADD CONSTRAINT `fk_finance_finance_budget_cip_project_id` FOREIGN KEY (`cip_project_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`cip_project`(`cip_project_id`);
...
-- ========= finance --> wastewater (3 constraint(s)) =========
-- Requires: finance schema, wastewater schema
ALTER TABLE `vibe_water_utilities_v1`.`finance`.`ar_transaction` ADD CONSTRAINT `fk_finance_ar_transaction_industrial_user_permit_id` FOREIGN KEY (`industrial_user_permit_id`) REFERENCES `vibe_water_utilities_v1`.`wastewater`.`industrial_user_permit`(`industrial_user_permit_id`);
...
-- ========= laboratory --> asset (3 constraint(s)) =========
...
-- ========= laboratory --> compliance (4 constraint(s)) =========
...
-- ========= laboratory --> project (5 constraint(s)) =========
...
-- ========= metering --> billing (4 constraint(s)) =========
...
-- ========= metering --> compliance (3 constraint(s)) =========
...
-- ========= metering --> customer (15 constraint(s)) =========
...
-- ========= metering --> distribution (9 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`metering`.`accuracy_test` ADD CONSTRAINT `fk_metering_accuracy_test_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`cost_center`(`cost_center_id`);
...
-- ========= metering --> workforce (10 constraint(s)) =========
...
-- ========= project --> compliance (8 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`project`.`project_permit` ADD CONSTRAINT `fk_project_project_permit_secondary_ssot_permit_id` FOREIGN KEY (`secondary_ssot_permit_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
...
-- ========= project --> finance (27 constraint(s)) =========
...
-- ========= project --> laboratory (6 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`project`.`asset_handover` ADD CONSTRAINT `fk_project_asset_handover_agreement_id` FOREIGN KEY (`agreement_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`agreement`(`agreement_id`);
ALTER TABLE `vibe_water_utilities_v1`.`project`.`funding_allocation` ADD CONSTRAINT `fk_project_funding_allocation_tariff_id` FOREIGN KEY (`tariff_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`tariff`(`tariff_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`project`.`inspection_report` ADD CONSTRAINT `fk_project_inspection_report_inspection_vendor_id` FOREIGN KEY (`inspection_vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);
...
-- ========= project --> workforce (22 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`quality`.`monitoring_context` ADD CONSTRAINT `fk_quality_monitoring_context_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`quality`.`water_system` ADD CONSTRAINT `fk_quality_water_system_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`quality`.`turbidity_reading` ADD CONSTRAINT `fk_quality_turbidity_reading_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`quality`.`effluent_quality` ADD CONSTRAINT `fk_quality_effluent_quality_special_contract_id` FOREIGN KEY (`special_contract_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`special_contract`(`special_contract_id`);
...
-- ========= quality --> treatment (11 constraint(s)) =========
...
-- ========= service --> billing (9 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`service`.`order` ADD CONSTRAINT `fk_service_order_invoice_id` FOREIGN KEY (`invoice_id`) REFERENCES `vibe_water_utilities_v1`.`billing`.`invoice`(`invoice_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`service`.`order` ADD CONSTRAINT `fk_service_order_order_customer_customer_account_id` FOREIGN KEY (`order_customer_customer_account_id`) REFERENCES `vibe_water_utilities_v1`.`customer`.`customer_account`(`customer_account_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`service`.`service_program_enrollment` ADD CONSTRAINT `fk_service_service_program_enrollment_secondary_ssot_program_enrollment_id` FOREIGN KEY (`secondary_ssot_program_enrollment_id`) REFERENCES `vibe_water_utilities_v1`.`customer`.`customer_program_enrollment`(`customer_program_enrollment_id`);
ALTER TABLE `vibe_water_utilities_v1`.`service`.`service_program_enrollment` ADD CONSTRAINT `fk_service_service_program_enrollment_program_enrollment_id` FOREIGN KEY (`program_enrollment_id`) REFERENCES `vibe_water_utilities_v1`.`customer`.`customer_program_enrollment`(`customer_program_enrollment_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`warehouse_location` ADD CONSTRAINT `fk_supply_warehouse_location_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`supply`.`warehouse_location` ADD CONSTRAINT `fk_supply_warehouse_location_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_water_utilities_v1`.`treatment`.`facility`(`facility_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`backwash_event` ADD CONSTRAINT `fk_treatment_backwash_event_pm_schedule_id` FOREIGN KEY (`pm_schedule_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`pm_schedule`(`pm_schedule_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`backwash_event` ADD CONSTRAINT `fk_treatment_backwash_event_work_order_id` FOREIGN KEY (`work_order_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_registry_id` FOREIGN KEY (`registry_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`registry`(`registry_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_membrane_registry_id` FOREIGN KEY (`membrane_registry_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`registry`(`registry_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_work_order_id` FOREIGN KEY (`work_order_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`uv_disinfection_event` ADD CONSTRAINT `fk_treatment_uv_disinfection_event_work_order_id` FOREIGN KEY (`work_order_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`work_order`(`work_order_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_control_setpoint` ADD CONSTRAINT `fk_treatment_process_control_setpoint_pm_schedule_id` FOREIGN KEY (`pm_schedule_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`pm_schedule`(`pm_schedule_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_control_setpoint` ADD CONSTRAINT `fk_treatment_process_control_setpoint_work_order_id` FOREIGN KEY (`work_order_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_work_order_id` FOREIGN KEY (`work_order_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`work_order`(`work_order_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`scada_tag` ADD CONSTRAINT `fk_treatment_scada_tag_registry_id` FOREIGN KEY (`registry_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`registry`(`registry_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_maintenance_plan` ADD CONSTRAINT `fk_treatment_process_maintenance_plan_job_plan_id` FOREIGN KEY (`job_plan_id`) REFERENCES `vibe_water_utilities_v1`.`asset`.`job_plan`(`job_plan_id`);
...
-- ========= treatment --> compliance (10 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_regulatory_agency_id` FOREIGN KEY (`regulatory_agency_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`regulatory_agency`(`regulatory_agency_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_compliance_violation_id` FOREIGN KEY (`compliance_violation_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_violation`(`compliance_violation_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`mor_submission` ADD CONSTRAINT `fk_treatment_mor_submission_mor_id` FOREIGN KEY (`mor_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`mor`(`mor_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_compliance_monitoring` ADD CONSTRAINT `fk_treatment_process_compliance_monitoring_permit_condition_id` FOREIGN KEY (`permit_condition_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`permit_condition`(`permit_condition_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`permit_compliance_obligation` ADD CONSTRAINT `fk_treatment_permit_compliance_obligation_regulatory_requirement_id` FOREIGN KEY (`regulatory_requirement_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`regulatory_requirement`(`regulatory_requirement_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_reading` ADD CONSTRAINT `fk_treatment_process_reading_pressure_zone_id` FOREIGN KEY (`pressure_zone_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`pressure_zone`(`pressure_zone_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`ct_compliance_record` ADD CONSTRAINT `fk_treatment_ct_compliance_record_pressure_zone_id` FOREIGN KEY (`pressure_zone_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`pressure_zone`(`pressure_zone_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`backwash_event` ADD CONSTRAINT `fk_treatment_backwash_event_pressure_zone_id` FOREIGN KEY (`pressure_zone_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`pressure_zone`(`pressure_zone_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`source_water_intake` ADD CONSTRAINT `fk_treatment_source_water_intake_storage_tank_id` FOREIGN KEY (`storage_tank_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`storage_tank`(`storage_tank_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_pressure_zone_id` FOREIGN KEY (`pressure_zone_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`pressure_zone`(`pressure_zone_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`uv_disinfection_event` ADD CONSTRAINT `fk_treatment_uv_disinfection_event_pressure_zone_id` FOREIGN KEY (`pressure_zone_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`pressure_zone`(`pressure_zone_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`sludge_production` ADD CONSTRAINT `fk_treatment_sludge_production_dma_id` FOREIGN KEY (`dma_id`) REFERENCES `vibe_water_utilities_v1`.`distribution`.`dma`(`dma_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_dose_event` ADD CONSTRAINT `fk_treatment_chemical_dose_event_general_ledger_id` FOREIGN KEY (`general_ledger_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`general_ledger`(`general_ledger_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`finished_water_production` ADD CONSTRAINT `fk_treatment_finished_water_production_finance_budget_id` FOREIGN KEY (`finance_budget_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`finance_budget`(`finance_budget_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_fixed_asset_id` FOREIGN KEY (`fixed_asset_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`fixed_asset`(`fixed_asset_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`sludge_production` ADD CONSTRAINT `fk_treatment_sludge_production_general_ledger_id` FOREIGN KEY (`general_ledger_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`general_ledger`(`general_ledger_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_inventory` ADD CONSTRAINT `fk_treatment_chemical_inventory_general_ledger_id` FOREIGN KEY (`general_ledger_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`general_ledger`(`general_ledger_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_general_ledger_id` FOREIGN KEY (`general_ledger_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`general_ledger`(`general_ledger_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`mor_submission` ADD CONSTRAINT `fk_treatment_mor_submission_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_water_utilities_v1`.`finance`.`cost_center`(`cost_center_id`);

-- ========= treatment --> laboratory (3 constraint(s)) =========
-- Requires: treatment schema, laboratory schema
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`source_water_intake` ADD CONSTRAINT `fk_treatment_source_water_intake_lab_sample_id` FOREIGN KEY (`lab_sample_id`) REFERENCES `vibe_water_utilities_v1`.`laboratory`.`lab_sample`(`lab_sample_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`sludge_production` ADD CONSTRAINT `fk_treatment_sludge_production_lab_sample_id` FOREIGN KEY (`lab_sample_id`) REFERENCES `vibe_water_utilities_v1`.`laboratory`.`lab_sample`(`lab_sample_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_lab_sample_id` FOREIGN KEY (`lab_sample_id`) REFERENCES `vibe_water_utilities_v1`.`laboratory`.`lab_sample`(`lab_sample_id`);
...
-- ========= treatment --> project (12 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_dose_event` ADD CONSTRAINT `fk_treatment_chemical_dose_event_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`ct_compliance_record` ADD CONSTRAINT `fk_treatment_ct_compliance_record_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`filter_run` ADD CONSTRAINT `fk_treatment_filter_run_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`finished_water_production` ADD CONSTRAINT `fk_treatment_finished_water_production_cip_project_id` FOREIGN KEY (`cip_project_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`cip_project`(`cip_project_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`source_water_intake` ADD CONSTRAINT `fk_treatment_source_water_intake_cip_project_id` FOREIGN KEY (`cip_project_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`cip_project`(`cip_project_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`uv_disinfection_event` ADD CONSTRAINT `fk_treatment_uv_disinfection_event_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`sludge_production` ADD CONSTRAINT `fk_treatment_sludge_production_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_control_setpoint` ADD CONSTRAINT `fk_treatment_process_control_setpoint_commissioning_activity_id` FOREIGN KEY (`commissioning_activity_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`commissioning_activity`(`commissioning_activity_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_change_order_id` FOREIGN KEY (`change_order_id`) REFERENCES `vibe_water_utilities_v1`.`project`.`change_order`(`change_order_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_reading` ADD CONSTRAINT `fk_treatment_process_reading_exceedance_id` FOREIGN KEY (`exceedance_id`) REFERENCES `vibe_water_utilities_v1`.`quality`.`exceedance`(`exceedance_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`ct_compliance_record` ADD CONSTRAINT `fk_treatment_ct_compliance_record_ct_calculation_id` FOREIGN KEY (`ct_calculation_id`) REFERENCES `vibe_water_utilities_v1`.`quality`.`ct_calculation`(`ct_calculation_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_control_setpoint` ADD CONSTRAINT `fk_treatment_process_control_setpoint_contaminant_limit_id` FOREIGN KEY (`contaminant_limit_id`) REFERENCES `vibe_water_utilities_v1`.`quality`.`contaminant_limit`(`contaminant_limit_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_control_setpoint` ADD CONSTRAINT `fk_treatment_process_control_setpoint_point_id` FOREIGN KEY (`point_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`point`(`point_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`scada_tag` ADD CONSTRAINT `fk_treatment_scada_tag_point_id` FOREIGN KEY (`point_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`point`(`point_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`facility_service_allocation` ADD CONSTRAINT `fk_treatment_facility_service_allocation_facility_territory_id` FOREIGN KEY (`facility_territory_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`territory`(`territory_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`facility_service_allocation` ADD CONSTRAINT `fk_treatment_facility_service_allocation_point_id` FOREIGN KEY (`point_id`) REFERENCES `vibe_water_utilities_v1`.`service`.`point`(`point_id`);

-- ========= treatment --> supply (14 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_dose_event` ADD CONSTRAINT `fk_treatment_chemical_dose_event_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_dose_event` ADD CONSTRAINT `fk_treatment_chemical_dose_event_primary_chemical_supplier_vendor_id` FOREIGN KEY (`primary_chemical_supplier_vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`filter_run` ADD CONSTRAINT `fk_treatment_filter_run_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`material_master`(`material_master_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`backwash_event` ADD CONSTRAINT `fk_treatment_backwash_event_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`material_master`(`material_master_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`membrane_performance` ADD CONSTRAINT `fk_treatment_membrane_performance_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`material_master`(`material_master_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`uv_disinfection_event` ADD CONSTRAINT `fk_treatment_uv_disinfection_event_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`material_master`(`material_master_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_inventory` ADD CONSTRAINT `fk_treatment_chemical_inventory_warehouse_location_id` FOREIGN KEY (`warehouse_location_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`warehouse_location`(`warehouse_location_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical` ADD CONSTRAINT `fk_treatment_chemical_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`filter_unit` ADD CONSTRAINT `fk_treatment_filter_unit_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);

-- ========= treatment --> workforce (33 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`chemical_dose_event` ADD CONSTRAINT `fk_treatment_chemical_dose_event_chemical_operator_employee_id` FOREIGN KEY (`chemical_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`ct_compliance_record` ADD CONSTRAINT `fk_treatment_ct_compliance_record_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`ct_compliance_record` ADD CONSTRAINT `fk_treatment_ct_compliance_record_ct_operator_employee_id` FOREIGN KEY (`ct_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`filter_run` ADD CONSTRAINT `fk_treatment_filter_run_filter_operator_employee_id` FOREIGN KEY (`filter_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`backwash_event` ADD CONSTRAINT `fk_treatment_backwash_event_backwash_operator_employee_id` FOREIGN KEY (`backwash_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`finished_water_production` ADD CONSTRAINT `fk_treatment_finished_water_production_finished_employee_id` FOREIGN KEY (`finished_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`finished_water_production` ADD CONSTRAINT `fk_treatment_finished_water_production_primary_finished_employee_id` FOREIGN KEY (`primary_finished_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`source_water_intake` ADD CONSTRAINT `fk_treatment_source_water_intake_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`source_water_intake` ADD CONSTRAINT `fk_treatment_source_water_intake_source_operator_employee_id` FOREIGN KEY (`source_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`uv_disinfection_event` ADD CONSTRAINT `fk_treatment_uv_disinfection_event_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`uv_disinfection_event` ADD CONSTRAINT `fk_treatment_uv_disinfection_event_uv_operator_employee_id` FOREIGN KEY (`uv_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`sludge_production` ADD CONSTRAINT `fk_treatment_sludge_production_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`sludge_production` ADD CONSTRAINT `fk_treatment_sludge_production_sludge_operator_employee_id` FOREIGN KEY (`sludge_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_control_setpoint` ADD CONSTRAINT `fk_treatment_process_control_setpoint_process_operator_employee_id` FOREIGN KEY (`process_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`treatment_violation` ADD CONSTRAINT `fk_treatment_treatment_violation_treatment_operator_employee_id` FOREIGN KEY (`treatment_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`mor_submission` ADD CONSTRAINT `fk_treatment_mor_submission_mor_operator_employee_id` FOREIGN KEY (`mor_operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`mor_submission` ADD CONSTRAINT `fk_treatment_mor_submission_mor_supervisor_employee_id` FOREIGN KEY (`mor_supervisor_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`facility_project` ADD CONSTRAINT `fk_treatment_facility_project_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`operator_qualification` ADD CONSTRAINT `fk_treatment_operator_qualification_certification_id` FOREIGN KEY (`certification_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`certification`(`certification_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`operator_qualification` ADD CONSTRAINT `fk_treatment_operator_qualification_operator_employee_id` FOREIGN KEY (`operator_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`treatment`.`process_compliance_monitoring` ADD CONSTRAINT `fk_treatment_process_compliance_monitoring_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= wastewater --> compliance (18 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`iup_compliance_sample` ADD CONSTRAINT `fk_wastewater_iup_compliance_sample_compliance_violation_id` FOREIGN KEY (`compliance_violation_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_violation`(`compliance_violation_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`watershed` ADD CONSTRAINT `fk_wastewater_watershed_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_compliance_permit_id` FOREIGN KEY (`compliance_permit_id`) REFERENCES `vibe_water_utilities_v1`.`compliance`.`compliance_permit`(`compliance_permit_id`);

-- ========= wastewater --> customer (8 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`sewer_service_connection` ADD CONSTRAINT `fk_wastewater_sewer_service_connection_segment_id` FOREIGN KEY (`segment_id`) REFERENCES `vibe_water_utilities_v1`.`customer`.`segment`(`segment_id`);
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`grease_interceptor` ADD CONSTRAINT `fk_wastewater_grease_interceptor_customer_account_id` FOREIGN KEY (`customer_account_id`) REFERENCES `vibe_water_utilities_v1`.`customer`.`customer_account`(`customer_account_id`);
...
-- ========= wastewater --> laboratory (12 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_lab_sample_id` FOREIGN KEY (`lab_sample_id`) REFERENCES `vibe_water_utilities_v1`.`laboratory`.`lab_sample`(`lab_sample_id`);
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_laboratory_id` FOREIGN KEY (`laboratory_id`) REFERENCES `vibe_water_utilities_v1`.`laboratory`.`laboratory`(`laboratory_id`);
...
-- ========= wastewater --> service (3 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`industrial_user_permit` ADD CONSTRAINT `fk_wastewater_industrial_user_permit_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`sewer_repair` ADD CONSTRAINT `fk_wastewater_sewer_repair_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`material_master`(`material_master_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_material_master_id` FOREIGN KEY (`material_master_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`material_master`(`material_master_id`);
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_vendor_id` FOREIGN KEY (`vendor_id`) REFERENCES `vibe_water_utilities_v1`.`supply`.`vendor`(`vendor_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`iup_compliance_sample` ADD CONSTRAINT `fk_wastewater_iup_compliance_sample_facility_id` FOREIGN KEY (`facility_id`) REFERENCES `vibe_water_utilities_v1`.`treatment`.`facility`(`facility_id`);
...
-- ========= wastewater --> workforce (19 constraint(s)) =========
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`sso_event` ADD CONSTRAINT `fk_wastewater_sso_event_crew_id` FOREIGN KEY (`crew_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`crew`(`crew_id`);
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`cso_event` ADD CONSTRAINT `fk_wastewater_cso_event_crew_id` FOREIGN KEY (`crew_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`crew`(`crew_id`);
...
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
ALTER TABLE `vibe_water_utilities_v1`.`wastewater`.`dmr_result` ADD CONSTRAINT `fk_wastewater_dmr_result_dmr_modified_by_user_employee_id` FOREIGN KEY (`dmr_modified_by_user_employee_id`) REFERENCES `vibe_water_utilities_v1`.`workforce`.`employee`(`employee_id`);
