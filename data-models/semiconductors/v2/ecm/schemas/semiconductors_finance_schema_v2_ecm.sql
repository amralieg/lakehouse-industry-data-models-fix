...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`gl_account` (
    ...
    `parent_gl_account_id` BIGINT COMMENT 'add column parent_gl_account_id (BIGINT) with FK to finance.gl_account.gl_account_id - GL accounts have hierarchical chart-of-accounts structure but currently have zero outbound FKs',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` (
    ...
    `fabrication_area_id` BIGINT COMMENT 'Identifier of the fab facility that owns the asset.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`wafer_cost_model` (
    ...
    `fabrication_technology_node_id` BIGINT COMMENT 'add column fabrication_technology_node_id (BIGINT) with FK to fabrication.fabrication_technology_node.fabrication_technology_node_id - wafer cost models are node-specific but only link to process flow',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`standard_cost` (
    ...
    `ic_catalog_id` BIGINT COMMENT 'add column ic_catalog_id (BIGINT) with FK to product.ic_catalog.ic_catalog_id - standard costs are calculated per product but currently missing direct product link',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`transfer_price` (
    ...
    `legal_entity_id` BIGINT COMMENT 'add column legal_entity_id (BIGINT) with FK to finance.legal_entity.legal_entity_id - transfer prices exist between legal entities for intercompany transactions',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`finance`.`allocation_cycle` (
    ...
    `cost_center_id` BIGINT COMMENT 'add column cost_center_id (BIGINT) with FK to finance.cost_center.cost_center_id - allocation cycles target specific cost centers but currently only self-reference',
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`gl_account` ADD CONSTRAINT `fk_finance_gl_account_parent_gl_account_id` FOREIGN KEY (`parent_gl_account_id`) REFERENCES `vibe_semiconductors_v1`.`finance`.`gl_account`(`gl_account_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_center` ALTER COLUMN `cost_center_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`gl_account` SET TAGS ('dbx_subdomain' = 'ledger_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`gl_account` ALTER COLUMN `account_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`profit_center` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`profit_center` ALTER COLUMN `profit_center_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry` SET TAGS ('dbx_subdomain' = 'ledger_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`journal_entry_line` SET TAGS ('dbx_subdomain' = 'ledger_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` SET TAGS ('dbx_subdomain' = 'asset_capital');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` ALTER COLUMN `requester_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`capex_request` ALTER COLUMN `vendor_name` SET TAGS ('dbx_pii_detected' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`fixed_asset` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`fixed_asset` SET TAGS ('dbx_subdomain' = 'asset_capital');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`fixed_asset` ALTER COLUMN `asset_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` SET TAGS ('dbx_subdomain' = 'asset_capital');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`asset_depreciation` ALTER COLUMN `fabrication_area_id` SET TAGS ('dbx_business_glossary_term' = 'Fabrication Facility Identifier (ID)');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`internal_order` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wbs_element` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wbs_element` ALTER COLUMN `wbs_element_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`cost_allocation` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wafer_cost_model` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`wafer_cost_model` ALTER COLUMN `model_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_agreement` SET TAGS ('dbx_subdomain' = 'revenue_pricing');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` SET TAGS ('dbx_subdomain' = 'revenue_pricing');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`finance_nre_milestone` ALTER COLUMN `milestone_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_plan` SET TAGS ('dbx_subdomain' = 'budget_planning');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`budget_line` SET TAGS ('dbx_subdomain' = 'budget_planning');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` SET TAGS ('dbx_subdomain' = 'asset_capital');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` ALTER COLUMN `auditor_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`rd_capitalization` ALTER COLUMN `related_ip_core_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_transaction` SET TAGS ('dbx_subdomain' = 'intercompany_consolidation');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_entry` SET TAGS ('dbx_subdomain' = 'intercompany_consolidation');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`standard_cost` SET TAGS ('dbx_subdomain' = 'revenue_pricing');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`transfer_price` SET TAGS ('dbx_subdomain' = 'revenue_pricing');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`tax_provision` SET TAGS ('dbx_subdomain' = 'intercompany_consolidation');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`depreciation_run` SET TAGS ('dbx_subdomain' = 'asset_capital');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`depreciation_run` ALTER COLUMN `schedule_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_unit` SET TAGS ('dbx_subdomain' = 'intercompany_consolidation');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_unit` ALTER COLUMN `consolidation_unit_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_group` SET TAGS ('dbx_subdomain' = 'intercompany_consolidation');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`consolidation_group` ALTER COLUMN `group_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`allocation_cycle` SET TAGS ('dbx_subdomain' = 'cost_accounting');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`allocation_cycle` ALTER COLUMN `cycle_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_agreement` SET TAGS ('dbx_subdomain' = 'intercompany_consolidation');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`intercompany_agreement` ALTER COLUMN `agreement_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`amortization_schedule` SET TAGS ('dbx_subdomain' = 'asset_capital');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` SET TAGS ('dbx_subdomain' = 'budget_planning');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `dba_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `primary_contact_detail` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`finance`.`legal_entity` ALTER COLUMN `primary_contact_method` SET TAGS ('dbx_pii_detected' = 'true');
