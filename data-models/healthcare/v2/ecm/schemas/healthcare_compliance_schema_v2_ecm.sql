...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` (
    ...
    `parent_compliance_program_id` BIGINT COMMENT 'Self-referential link to parent compliance program.',
    `quality_program_id` BIGINT COMMENT '',
    `accreditation_expiration_date` DECIMAL(18,2) COMMENT 'Date when program accreditation expires.',
    `accreditation_status` STRING COMMENT 'Current accreditation status of the program.',
    `audit_frequency` STRING COMMENT 'How often the program is audited (e.g., annually, quarterly).',
    `charter_document` STRING COMMENT 'Reference to the program charter document.',
    `contact_email` STRING COMMENT 'Email contact for the compliance program.',
    `contact_phone` STRING COMMENT 'Phone contact for the compliance program.',
    `created_timestamp` TIMESTAMP COMMENT 'When the program record was created.',
    `effective_date` DATE COMMENT 'Date when the program becomes effective.',
    `expiration_date` DECIMAL(18,2) COMMENT 'Date when the program expires.',
    `external_auditor_name` STRING COMMENT 'Name of the external auditor for the program.',
    ...
    `merged_with_quality_quality_program` STRING COMMENT '',
    `modified_by` STRING COMMENT 'User who last modified the program record.',
    `modified_timestamp` TIMESTAMP COMMENT 'When the program record was last modified.',
    ...
    `notes` STRING COMMENT 'Additional notes about the compliance program.',
    `objectives` STRING COMMENT 'Objectives of the compliance program.',
    `penalty_exposure_amount` DECIMAL(18,2) COMMENT 'Potential financial penalty exposure for non-compliance.',
    `policy_count` STRING COMMENT 'Number of policies associated with the program.',
    `program_code` STRING COMMENT 'Unique code identifying the compliance program.',
    `program_name` STRING COMMENT 'Name of the compliance program.',
    `program_scope` STRING COMMENT 'Scope of the compliance program.',
    `program_status` STRING COMMENT 'Current status of the compliance program.',
    `program_type` STRING COMMENT 'Type of compliance program (e.g., HIPAA, OSHA).',
    `regulatory_framework` STRING COMMENT 'Regulatory framework the program addresses.',
    ...
    `review_frequency_months` STRING COMMENT 'Frequency of program reviews in months.',
    `risk_level` STRING COMMENT 'Risk level associated with the program.',
    `ssot_canonical_reference` STRING COMMENT 'Distinct entity; counterpart quality.quality_program serves a separate domain context',
    `ssot_reconciliation_status` STRING COMMENT 'SSOT review: kept distinct from quality.quality_program (documented as separate business concepts)',
    `training_frequency_months` STRING COMMENT 'Frequency of required training in months.',
    ...
    `created_by` STRING COMMENT 'User who created the program record.',
    CONSTRAINT pk_compliance_program PRIMARY KEY(`compliance_program_id`)
) COMMENT 'Organizational compliance programs tracking regulatory frameworks, audit schedules, and program governance.';
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`obligation` (
    ...
    `code_set_version_id` BIGINT COMMENT 'Link to the code set version applicable to this obligation.',
    ...
    `regulatory_change_id` BIGINT COMMENT 'Link to the regulatory change that triggered this obligation.',
    `regulatory_requirement_id` BIGINT COMMENT 'Link to the underlying regulatory requirement.',
    `training_id` BIGINT COMMENT 'Link to required training for this obligation.',
    ...
    `attestation_required` BOOLEAN COMMENT 'Indicates if attestation is required.',
    ...
    `control_activity` STRING COMMENT 'Control activity associated with the obligation.',
    `corrective_action_required` BOOLEAN COMMENT 'Indicates if corrective action is required.',
    `created_timestamp` TIMESTAMP COMMENT 'When the obligation record was created.',
    ...
    `escalation_required` BOOLEAN COMMENT 'Indicates if escalation is required.',
    `escalation_threshold_days` STRING COMMENT 'Number of days before escalation is triggered.',
    `evidence_required` BOOLEAN COMMENT 'Indicates if evidence is required.',
    ...
    `expiration_date` DECIMAL(18,2) COMMENT 'Date when the obligation expires.',
    `external_audit_scope` BOOLEAN COMMENT 'Indicates if the obligation is in scope for external audit.',
    `finding_count` STRING COMMENT 'Number of findings associated with the obligation.',
    `is_active` BOOLEAN COMMENT 'Indicates if the obligation is currently active.',
    `last_audit_date` DATE COMMENT 'Date of the most recent audit.',
    `last_audit_result` STRING COMMENT 'Outcome of the most recent audit.',
    `modified_timestamp` TIMESTAMP COMMENT 'When the obligation record was last modified.',
    `obligation_name` STRING COMMENT 'Name of the obligation.',
    `next_review_date` DATE COMMENT 'Scheduled date for the next review.',
    `notes` STRING COMMENT 'Additional notes about the obligation.',
    `obligation_number` STRING COMMENT 'Unique number identifying the obligation.',
    ...
    `recurrence_pattern` STRING COMMENT 'Pattern of recurrence for the obligation.',
    `regulatory_authority` STRING COMMENT 'Regulatory authority governing the obligation.',
    `regulatory_citation` STRING COMMENT 'Citation of the regulatory requirement.',
    `risk_rating` STRING COMMENT 'Risk rating of the obligation.',
    CONSTRAINT pk_obligation PRIMARY KEY(`obligation_id`)
) COMMENT 'Specific compliance obligations derived from regulatory requirements and program mandates.';
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` (
    ...
    `code_set_version_id` BIGINT COMMENT 'Link to the code set version applicable to this policy.',
    `superseded_compliance_policy_id` BIGINT COMMENT 'Self-referential link to the policy this one supersedes.',
    ...
    `author_contact_email` STRING COMMENT 'Email of the policy author.',
    `author_name` STRING COMMENT 'Name of the policy author.',
    `confidentiality_level` STRING COMMENT 'Confidentiality level of the policy.',
    `created_timestamp` TIMESTAMP COMMENT 'When the policy record was created.',
    ...
    `enforcement_mechanism` STRING COMMENT 'Mechanism for enforcing the policy.',
    `expiration_date` DECIMAL(18,2) COMMENT 'Date when the policy expires.',
    ...
    `modified_timestamp` TIMESTAMP COMMENT 'When the policy record was last modified.',
    ...
    `policy_number` STRING COMMENT 'Unique number identifying the policy.',
    ...
    `purpose` STRING COMMENT 'Purpose of the policy.',
    `regulatory_requirement_satisfied` STRING COMMENT 'Regulatory requirement satisfied by the policy.',
    ...
    `retired_reason` STRING COMMENT 'Reason the policy was retired.',
    `retired_timestamp` TIMESTAMP COMMENT 'When the policy was retired.',
    `review_cycle_months` STRING COMMENT 'Frequency of policy reviews in months.',
    `scope_of_application` STRING COMMENT 'Scope of the policy application.',
...
) COMMENT 'Organizational compliance policies governing behavior, procedures, and regulatory adherence.';
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` (
    ...
    `employee_id` BIGINT COMMENT 'Employee who approved this policy version.',
    `compliance_policy_id` BIGINT COMMENT 'Link to the parent compliance policy.',
    `primary_policy_employee_id` BIGINT COMMENT 'Employee who owns this policy version.',
    `primary_superseded_version_policy_version_id` BIGINT COMMENT 'Link to the policy version this one supersedes.',
    `reviewer_employee_id` BIGINT COMMENT 'Employee who reviewed this policy version.',
    ...
    `comment_log` STRING COMMENT 'Log of comments on this version.',
    `distribution_list` STRING COMMENT 'List of recipients for this version.',
    `document_checksum` STRING COMMENT 'Checksum for document integrity verification.',
    `document_url` STRING COMMENT 'URL where the version document is stored.',
    `effective_date` DATE COMMENT 'Date when the version becomes effective.',
    `expiration_date` DECIMAL(18,2) COMMENT 'Date when the version expires.',
    `language_code` STRING COMMENT 'Language code for the version.',
    `next_review_due_date` DATE COMMENT 'Scheduled date for the next review.',
    `policy_type` STRING COMMENT 'Type of policy.',
    `publication_date` DATE COMMENT 'Date when the version was published.',
    `regulatory_citation` STRING COMMENT 'Citation of the regulatory requirement.',
    `regulatory_driver` STRING COMMENT 'Regulatory driver for the version.',
    `retirement_date` DATE COMMENT 'Date when the version was retired.',
    `retirement_reason` STRING COMMENT 'Reason the version was retired.',
    `review_cycle_months` STRING COMMENT 'Frequency of reviews in months.',
    `review_date` DATE COMMENT 'Date of the most recent review.',
    ...
    `training_required_flag` BOOLEAN COMMENT 'Indicates if training is required.',
    `version_created_timestamp` TIMESTAMP COMMENT 'When the version record was created.',
    `version_modified_timestamp` TIMESTAMP COMMENT 'When the version record was last modified.',
    `version_number` STRING COMMENT 'Version number.',
    `version_status` STRING COMMENT 'Current status of the version.',
    `version_title` STRING COMMENT 'Title of the version.',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`audit` (
    ...
    `accreditation_decision` STRING COMMENT 'Decision on accreditation resulting from the audit.',
    ...
    `audit_type` STRING COMMENT 'Type of audit (e.g., internal, external).',
    `auditing_body` STRING COMMENT 'Organization conducting the audit.',
    `corrective_action_plan_due_date` DATE COMMENT 'Due date for corrective action plan.',
    `corrective_action_plan_required` BOOLEAN COMMENT 'Indicates if corrective action plan is required.',
    ...
    `created_timestamp` TIMESTAMP COMMENT 'When the audit record was created.',
    ...
    `external_auditor_organization` STRING COMMENT 'Organization of the external auditor.',
    `findings_count` STRING COMMENT 'Total number of findings.',
    `follow_up_completion_date` DATE COMMENT 'Date when follow-up was completed.',
    `follow_up_due_date` DATE COMMENT 'Due date for follow-up.',
    ...
    `last_modified_timestamp` TIMESTAMP COMMENT 'When the audit record was last modified.',
    `lead_auditor_email` STRING COMMENT 'Email of the lead auditor.',
    `lead_auditor_name` STRING COMMENT 'Name of the lead auditor.',
    `methodology` STRING COMMENT 'Methodology used for the audit.',
    `modified_by_user` STRING COMMENT 'User who last modified the audit record.',
    `monetary_penalty_amount` DECIMAL(18,2) COMMENT 'Amount of monetary penalty.',
    ...
    `regulatory_framework` STRING COMMENT 'Regulatory framework being audited.',
    ...
    `scheduled_end_date` DATE COMMENT 'Scheduled end date for the audit.',
    `scheduled_start_date` DATE COMMENT 'Scheduled start date for the audit.',
    `scope` STRING COMMENT 'Scope of the audit.',
    `team_size` STRING COMMENT 'Size of the audit team.',
    `trigger` STRING COMMENT 'Trigger that initiated the audit.',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` (
    ...
    `employee_id` BIGINT COMMENT 'Reference to the employee, auditor, or security analyst who identified and documented this risk.',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` (
    ...
    `research_regulatory_submission_id` BIGINT COMMENT 'FK to research regulatory submission for SSOT linkage',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`attestation` (
    ...
    `employee_id` BIGINT COMMENT 'Identifier of the compliance officer or manager who reviewed and approved the attestation. Links to the employee responsible for verification.',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` (
    `databricks_governance_id` BIGINT COMMENT 'Primary key for databricks_governance',
    `mpi_record_id` BIGINT COMMENT '',
    `applicable_domain` STRING COMMENT 'Domain(s) this rule applies to. Use * for all domains or comma-separated domain names.',
    `applicable_pii_level` STRING COMMENT 'PII classification level this rule targets: pii_phi, pii_pii, pii_sensitive, pii_de_identified, or none.',
    `created_timestamp` TIMESTAMP COMMENT 'Timestamp when this governance rule was created.',
    `delta_property_key` STRING COMMENT 'Delta table property key (e.g., delta.enableChangeDataFeed, delta.logRetentionDuration) when rule_category is delta_property.',
    `delta_property_value` DECIMAL(18,2) COMMENT 'Recommended value for the Delta table property.',
    `effective_date` DATE COMMENT 'Date this governance rule becomes effective.',
    `governance_rule_code` BIGINT COMMENT 'Unique identifier for each governance rule or configuration entry.',
    `is_active` BOOLEAN COMMENT 'Whether this governance rule is currently active and enforced.',
    `masking_function_name` STRING COMMENT 'Name of the dynamic data masking function for non-production environments.',
    `output_format_type` STRING COMMENT 'Output format specification: sql_ddl, rdf_turtle, dbml, metric_view, csv_excel, readme.',
    `retention_duration_days` DECIMAL(18,2) COMMENT 'Number of days for data retention when rule_category is retention_policy. HIPAA minimum is 2190 (6 years).',
    `retention_regulation` STRING COMMENT 'Regulatory citation requiring this retention period (e.g., HIPAA 45 CFR 164.530(j), 21 CFR 312.62, state statute).',
    `rls_function_name` STRING COMMENT 'Name of the Row-Level Security function when rule_category is rls_predicate.',
    `rls_predicate_sql` STRING COMMENT 'SQL predicate body for the RLS function implementing access control logic.',
    `rule_category` STRING COMMENT 'Category of governance rule: unity_catalog_tag, rls_predicate, delta_property, retention_policy, output_format, pii_classification.',
    `rule_definition` STRING COMMENT 'Full definition or SQL/configuration snippet implementing the governance rule.',
    `rule_name` STRING COMMENT 'Human-readable name of the governance rule (e.g., pii_phi_tag, rls_care_site_filter, delta_cdf_enabled).',
    `unity_catalog_tag_key` STRING COMMENT 'Unity Catalog tag key for column-level classification (e.g., pii_phi, pii_pii, pii_sensitive).',
    `unity_catalog_tag_value` DECIMAL(18,2) COMMENT 'Unity Catalog tag value (typically true or a classification descriptor).',
    `updated_timestamp` TIMESTAMP COMMENT 'Timestamp when this governance rule was last updated.',
    CONSTRAINT pk_databricks_governance PRIMARY KEY(`databricks_governance_id`)
) COMMENT 'Databricks-specific governance configuration product documenting Unity Catalog tag definitions (pii_phi, pii_pii, pii_sensitive, pii_de_identified), Row-Level Security predicate patterns, Delta table property recommendations for HIPAA compliance, data retention annotations, and multi-format output specifications (SQL DDL, RDF/Turtle, DBML, metric views, CSV/Excel, README).';
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_compliance_program_id` FOREIGN KEY (`compliance_program_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`compliance_program`(`compliance_program_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ADD CONSTRAINT `fk_compliance_obligation_parent_obligation_id` FOREIGN KEY (`parent_obligation_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`obligation`(`obligation_id`);
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ADD CONSTRAINT `fk_compliance_training_prerequisite_training_id` FOREIGN KEY (`prerequisite_training_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`training`(`training_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ADD CONSTRAINT `fk_compliance_training_completion_reattempted_training_completion_id` FOREIGN KEY (`reattempted_training_completion_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`training_completion`(`training_completion_id`);
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` ADD CONSTRAINT `fk_compliance_conflict_of_interest_prior_conflict_of_interest_id` FOREIGN KEY (`prior_conflict_of_interest_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`conflict_of_interest`(`conflict_of_interest_id`);
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ADD CONSTRAINT `fk_compliance_attestation_reattested_attestation_id` FOREIGN KEY (`reattested_attestation_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`attestation`(`attestation_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ADD CONSTRAINT `fk_compliance_attestation_training_completion_id` FOREIGN KEY (`training_completion_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`training_completion`(`training_completion_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` ADD CONSTRAINT `fk_compliance_regulatory_change_compliance_program_id` FOREIGN KEY (`compliance_program_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`compliance_program`(`compliance_program_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` ADD CONSTRAINT `fk_compliance_regulatory_change_superseded_regulatory_change_id` FOREIGN KEY (`superseded_regulatory_change_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`regulatory_change`(`regulatory_change_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ADD CONSTRAINT `fk_compliance_monitoring_activity_compliance_policy_id` FOREIGN KEY (`compliance_policy_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`compliance_policy`(`compliance_policy_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ADD CONSTRAINT `fk_compliance_monitoring_activity_compliance_program_id` FOREIGN KEY (`compliance_program_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`compliance_program`(`compliance_program_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ADD CONSTRAINT `fk_compliance_monitoring_activity_follow_up_monitoring_activity_id` FOREIGN KEY (`follow_up_monitoring_activity_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`monitoring_activity`(`monitoring_activity_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ADD CONSTRAINT `fk_compliance_monitoring_activity_obligation_id` FOREIGN KEY (`obligation_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`obligation`(`obligation_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` ADD CONSTRAINT `fk_compliance_program_policy_assignment_compliance_policy_id` FOREIGN KEY (`compliance_policy_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`compliance_policy`(`compliance_policy_id`);
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` ADD CONSTRAINT `fk_compliance_program_policy_assignment_compliance_program_id` FOREIGN KEY (`compliance_program_id`) REFERENCES `vibe_healthcare_v1`.`compliance`.`compliance_program`(`compliance_program_id`);
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` SET TAGS ('pii_compliance' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` SET TAGS ('pii_program' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` SET TAGS ('pii_governance' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `budget_id` SET TAGS ('pii_business_glossary_term' = 'Budget');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `parent_compliance_program_id` SET TAGS ('pii_business_glossary_term' = 'Parent Program');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `quality_program_id` SET TAGS ('pii_ssot' = 'link');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `accreditation_expiration_date` SET TAGS ('pii_business_glossary_term' = 'Accreditation Expiration');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `accreditation_expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `contact_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `contact_phone` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `external_auditor_name` SET TAGS ('pii_business_glossary_term' = 'External Auditor');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `external_auditor_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `penalty_exposure_amount` SET TAGS ('pii_business_glossary_term' = 'Penalty Exposure');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `program_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `reporting_required_flag` SET TAGS ('pii_business_glossary_term' = 'Reporting Required');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `review_frequency_months` SET TAGS ('pii_business_glossary_term' = 'Review Frequency');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `training_frequency_months` SET TAGS ('pii_business_glossary_term' = 'Training Frequency');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `training_required_flag` SET TAGS ('pii_business_glossary_term' = 'Training Required');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_program` ALTER COLUMN `vibe_reconciled_flag` SET TAGS ('pii_ssot' = 'reconciliation');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` SET TAGS ('pii_compliance' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` SET TAGS ('pii_obligation' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` SET TAGS ('pii_requirement' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `code_set_version_id` SET TAGS ('pii_business_glossary_term' = 'Code Set Version');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `compliance_program_id` SET TAGS ('pii_business_glossary_term' = 'Compliance Program');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `cost_center_id` SET TAGS ('pii_business_glossary_term' = 'Cost Center');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `parent_obligation_id` SET TAGS ('pii_business_glossary_term' = 'Parent Obligation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `regulatory_change_id` SET TAGS ('pii_business_glossary_term' = 'Regulatory Change');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `regulatory_requirement_id` SET TAGS ('pii_business_glossary_term' = 'Regulatory Requirement');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `training_id` SET TAGS ('pii_business_glossary_term' = 'Training');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `escalation_threshold_days` SET TAGS ('pii_business_glossary_term' = 'Escalation Threshold');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `evidence_retention_years` SET TAGS ('pii_business_glossary_term' = 'Evidence Retention');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `obligation_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`obligation` ALTER COLUMN `procedure_reference` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` SET TAGS ('pii_compliance' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` SET TAGS ('pii_policy' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` SET TAGS ('pii_governance' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `code_set_version_id` SET TAGS ('pii_business_glossary_term' = 'Code Set Version');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `superseded_compliance_policy_id` SET TAGS ('pii_business_glossary_term' = 'Superseded Policy');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `attestation_required_flag` SET TAGS ('pii_business_glossary_term' = 'Attestation Required');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `author_contact_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `author_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `document_location_url` SET TAGS ('pii_business_glossary_term' = 'Document Location');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `policy_number` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `policy_number` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `public_facing_flag` SET TAGS ('pii_business_glossary_term' = 'Public Facing');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `related_procedure_references` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `review_cycle_months` SET TAGS ('pii_business_glossary_term' = 'Review Cycle');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `supersedes_policy_number` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `supersedes_policy_number` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `title` SET TAGS ('pii_business_glossary_term' = 'Title');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `training_frequency_months` SET TAGS ('pii_business_glossary_term' = 'Training Frequency');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_policy` ALTER COLUMN `training_required_flag` SET TAGS ('pii_business_glossary_term' = 'Training Required');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` SET TAGS ('pii_compliance' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` SET TAGS ('pii_policy' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` SET TAGS ('pii_version' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `employee_id` SET TAGS ('pii_business_glossary_term' = 'Approver');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `compliance_policy_id` SET TAGS ('pii_business_glossary_term' = 'Compliance Policy');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `primary_policy_employee_id` SET TAGS ('pii_business_glossary_term' = 'Policy Owner');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `primary_superseded_version_policy_version_id` SET TAGS ('pii_business_glossary_term' = 'Superseded Version');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `reviewer_employee_id` SET TAGS ('pii_business_glossary_term' = 'Reviewer');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `attestation_required_flag` SET TAGS ('pii_business_glossary_term' = 'Attestation Required');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `regulatory_driver` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `regulatory_driver` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `review_cycle_months` SET TAGS ('pii_business_glossary_term' = 'Review Cycle');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_version` ALTER COLUMN `training_required_flag` SET TAGS ('pii_business_glossary_term' = 'Training Required');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` SET TAGS ('pii_compliance' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` SET TAGS ('pii_audit' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` SET TAGS ('pii_review' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `cost_center_id` SET TAGS ('pii_business_glossary_term' = 'Audited Cost Center');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `care_site_id` SET TAGS ('pii_business_glossary_term' = 'Care Site');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `follow_up_audit_id` SET TAGS ('pii_business_glossary_term' = 'Follow-Up Audit');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `payer_id` SET TAGS ('pii_business_glossary_term' = 'Payer');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `accreditation_expiration_date` SET TAGS ('pii_business_glossary_term' = 'Accreditation Expiration');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `accreditation_expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `corrective_action_plan_due_date` SET TAGS ('pii_business_glossary_term' = 'CAP Due Date');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `corrective_action_plan_required` SET TAGS ('pii_business_glossary_term' = 'CAP Required');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `corrective_action_plan_submitted_date` SET TAGS ('pii_business_glossary_term' = 'CAP Submitted Date');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `lead_auditor_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `lead_auditor_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit` ALTER COLUMN `audit_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `drg_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `icd_code_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `icd_code_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `accreditation_impact_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `actual_resolution_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `auditor_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `financial_penalty_risk_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `patient_safety_impact_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `patient_safety_impact_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `responsible_party_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `responsible_party_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `root_cause_category` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`audit_finding` ALTER COLUMN `target_resolution_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `icd_code_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `icd_code_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `hipaa_privacy_incident_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `hipaa_security_risk_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `patient_safety_impact_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `patient_safety_impact_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `responsible_owner_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `responsible_owner_name` SET TAGS ('pii_type' = 'person_name');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `responsible_owner_name` SET TAGS ('pii_classification' = 'person_name');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `responsible_owner_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`corrective_action_plan` ALTER COLUMN `root_cause_analysis_summary` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `hipaa_privacy_incident_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `parent_hipaa_privacy_incident_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_access_log_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_access_log_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `affected_individuals_count` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `breach_determination_date` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `breach_determination_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `breach_determination_outcome` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `breach_determination_outcome` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `disciplinary_action_taken_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `discovery_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `incident_category` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `incident_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `incident_description` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `incident_type` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `individual_notification_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `individual_notification_required_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `investigation_summary` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `investigation_summary` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `law_enforcement_case_number` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `law_enforcement_case_number` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `law_enforcement_notified_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `lessons_learned` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `location_of_incident` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `media_notification_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `media_notification_required_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `mitigation_measures` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `ocr_case_number` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `ocr_case_number` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `ocr_submission_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_involved_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_involved_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_type` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_type` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_volume_records` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `phi_volume_records` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `policy_violation_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `privacy_officer_assigned` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `privacy_officer_assigned` SET TAGS ('pii_pii' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `remediation_actions_taken` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `reported_by_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `risk_assessment_summary` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_privacy_incident` ALTER COLUMN `root_cause` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` ALTER COLUMN `hipaa_security_risk_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` ALTER COLUMN `prior_hipaa_security_risk_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` ALTER COLUMN `hipaa_privacy_incident_id` SET TAGS ('pii_sensitive' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` ALTER COLUMN `employee_id` SET TAGS ('pii_business_glossary_term' = 'Identified By Employee Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` ALTER COLUMN `affected_ephi_system` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hipaa_security_risk` ALTER COLUMN `affected_ephi_system` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` SET TAGS ('pii_subdomain' = 'training_attestation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `icd_code_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `icd_code_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `accreditation_body` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `accreditation_number` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `content_author` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `content_author` SET TAGS ('pii_pii' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `content_owner` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `content_owner` SET TAGS ('pii_pii' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `training_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training` ALTER COLUMN `vendor_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` SET TAGS ('pii_subdomain' = 'training_attestation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `accreditation_body` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `certificate_number` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `credit_type` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `instructor_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `training_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `waiver_approved_by` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`training_completion` ALTER COLUMN `waiver_approved_by` SET TAGS ('pii_pii' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` ALTER COLUMN `public_health_report_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` ALTER COLUMN `attestation_officer_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` ALTER COLUMN `ssot_canonical_reference` SET TAGS ('pii_business_glossary_term' = 'SSOT Canonical Reference');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` ALTER COLUMN `ssot_reconciliation_status` SET TAGS ('pii_business_glossary_term' = 'SSOT Reconciliation Status');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` ALTER COLUMN `submitting_entity_npi` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`compliance_regulatory_submission` ALTER COLUMN `vibe_reconciled_flag` SET TAGS ('pii_ssot' = 'reconciliation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `exclusion_screening_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `employee_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `prior_exclusion_screening_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `npi_registry_id` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `exclusion_authority` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `exclusion_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `exclusion_type` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `exclusion_waiver_state` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `resolution_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_business_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_date_of_birth` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_date_of_birth` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_date_of_birth` SET TAGS ('pii_sensitive' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_date_of_birth` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_first_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_last_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_middle_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screened_ssn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`exclusion_screening` ALTER COLUMN `screening_vendor_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` ALTER COLUMN `conflict_of_interest_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` ALTER COLUMN `prior_conflict_of_interest_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` ALTER COLUMN `department_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` ALTER COLUMN `disclosed_entity_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`conflict_of_interest` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `hotline_report_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `original_hotline_report_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `employee_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `tertiary_hotline_employee_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `allegation_category` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `allegation_category` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `allegation_description` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `allegation_description` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `allegation_subcategory` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `assigned_investigator_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `case_notes` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `incident_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `incident_date_range_end` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `incident_date_range_start` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `individual_implicated_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `investigation_completion_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `investigation_start_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `investigation_status` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `reporter_contact_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `reporter_contact_phone` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `reporter_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`hotline_report` ALTER COLUMN `resolution_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `investigation_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `hotline_report_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `message_log_id` SET TAGS ('pii_business_glossary_term' = 'Message Log Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `parent_investigation_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `phi_access_log_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `phi_access_log_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `hipaa_privacy_incident_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `breach_notification_required_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `disciplinary_action_taken_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `financial_impact_amount` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `investigation_number` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `investigation_status` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `investigation_type` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `investigator_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `patient_count` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `patient_count` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `patient_involved_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`investigation` ALTER COLUMN `patient_involved_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` ALTER COLUMN `npi_registry_id` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` ALTER COLUMN `commercial_reasonableness_rationale` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` ALTER COLUMN `designated_health_services_involved` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` ALTER COLUMN `legal_reviewer_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`stark_arrangement` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_safety_program` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_safety_program` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_safety_program` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_safety_program` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_safety_program` ALTER COLUMN `program_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_safety_program` ALTER COLUMN `related_procedure_references` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `ndc_drug_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `procedure_event_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `incident_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `incident_resolution_date` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `investigation_notes` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `procedure_being_performed` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `root_cause_analysis_completed_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_hbv_status` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_hbv_status` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_hcv_status` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_hcv_status` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_hiv_status` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_hiv_status` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_known_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_known_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_tested_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`osha_exposure_incident` ALTER COLUMN `source_patient_tested_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` ALTER COLUMN `condition_code_id` SET TAGS ('pii_business_glossary_term' = 'Condition Code Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` ALTER COLUMN `condition_code_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` ALTER COLUMN `certification_expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` ALTER COLUMN `condition_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` ALTER COLUMN `responsible_officer_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`cms_condition_status` ALTER COLUMN `surveyor_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_status_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `prior_accreditation_status_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_award_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_certificate_number` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_cost_amount` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_cycle_years` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_decision_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_level` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_scope` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accreditation_status` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `accrediting_body_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `contact_person_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `contact_person_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `contact_person_phone` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `contact_person_title` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `contact_person_title` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `exclusions` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`accreditation_status` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `breach_notification_required_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `breach_notification_timeframe_days` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `business_associate_address` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `business_associate_contact_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `business_associate_contact_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `business_associate_contact_phone` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `business_associate_signatory_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `covered_entity_signatory_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `insurance_coverage_amount` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `insurance_coverage_amount` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `insurance_required_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `insurance_required_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `phi_retention_period_years` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `phi_retention_period_years` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `phi_types_shared` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `phi_types_shared` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `return_or_destroy_phi_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`business_associate_agreement` ALTER COLUMN `return_or_destroy_phi_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `scheduling_appointment_id` SET TAGS ('pii_business_glossary_term' = 'Scheduling Appointment Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `visit_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `available_on_website_flag` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `department_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `ip_address` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `npp_expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`notice_of_privacy_practices` ALTER COLUMN `witness_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` SET TAGS ('pii_subdomain' = 'privacy_security');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `phi_access_log_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `phi_access_log_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `member_enrollment_id` SET TAGS ('pii_business_glossary_term' = 'Member Enrollment Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `member_enrollment_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `member_enrollment_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `parent_phi_access_log_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `parent_phi_access_log_id` SET TAGS ('pii_sensitive' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `scheduling_appointment_id` SET TAGS ('pii_business_glossary_term' = 'Scheduling Appointment Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `visit_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `breach_determination` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `breach_determination` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `breach_reported_date` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `ip_address` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `patient_consent_on_file` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `patient_consent_on_file` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `patient_relationship` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `patient_relationship` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `user_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`phi_access_log` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ALTER COLUMN `employee_id` SET TAGS ('pii_business_glossary_term' = 'Reviewer Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ALTER COLUMN `attesting_individual_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ALTER COLUMN `attesting_individual_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`attestation` ALTER COLUMN `ip_address` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` ALTER COLUMN `implementation_deadline` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_change` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` SET TAGS ('pii_subdomain' = 'audit_investigation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ALTER COLUMN `icd_code_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ALTER COLUMN `icd_code_id` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ALTER COLUMN `activity_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ALTER COLUMN `compliance_rate_percentage` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`monitoring_activity` ALTER COLUMN `lead_monitor_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` SET TAGS ('pii_subdomain' = 'program_governance');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`program_policy_assignment` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_regulatory_impact` SET TAGS ('pii_data_type' = 'association_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_regulatory_impact` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_regulatory_impact` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_regulatory_impact` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_regulatory_impact` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_payer_applicability` SET TAGS ('pii_data_type' = 'association_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_payer_applicability` SET TAGS ('pii_subdomain' = 'program_governance');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_payer_applicability` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_payer_applicability` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`policy_payer_applicability` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_requirement` SET TAGS ('pii_subdomain' = 'regulatory_accreditation');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_requirement` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_requirement` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_requirement` ALTER COLUMN `expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_requirement` ALTER COLUMN `regulation_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`regulatory_requirement` ALTER COLUMN `vibe_added_flag` SET TAGS ('pii_vibe_added' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_data_type' = 'reference_data');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_subdomain' = 'program_governance');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_tier' = 'ecm');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_governance' = 'databricks');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_output_formats' = 'sql_ddl');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_rdf_turtle' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_dbml' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_csv_excel' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` SET TAGS ('pii_readme' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `databricks_governance_id` SET TAGS ('pii_business_glossary_term' = 'databricks_governance Identifier');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `applicable_domain` SET TAGS ('pii_business_glossary_term' = 'Applicable Domain');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `applicable_pii_level` SET TAGS ('pii_business_glossary_term' = 'PII Classification Level');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `created_timestamp` SET TAGS ('pii_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `delta_property_key` SET TAGS ('pii_business_glossary_term' = 'Delta Table Property Key');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `delta_property_value` SET TAGS ('pii_business_glossary_term' = 'Delta Table Property Value');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `effective_date` SET TAGS ('pii_business_glossary_term' = 'Rule Effective Date');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `governance_rule_code` SET TAGS ('pii_business_glossary_term' = 'Governance Rule Identifier');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `governance_rule_code` SET TAGS ('pii_pk' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `is_active` SET TAGS ('pii_business_glossary_term' = 'Rule Active Flag');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `masking_function_name` SET TAGS ('pii_business_glossary_term' = 'Dynamic Masking Function');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `masking_function_name` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `masking_function_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `output_format_type` SET TAGS ('pii_business_glossary_term' = 'Output Format Type');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `retention_duration_days` SET TAGS ('pii_business_glossary_term' = 'Retention Duration Days');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `retention_duration_days` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `retention_regulation` SET TAGS ('pii_business_glossary_term' = 'Retention Regulation Reference');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rls_function_name` SET TAGS ('pii_business_glossary_term' = 'RLS Function Name');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rls_function_name` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rls_function_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rls_predicate_sql` SET TAGS ('pii_business_glossary_term' = 'RLS Predicate SQL');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rule_category` SET TAGS ('pii_business_glossary_term' = 'Governance Rule Category');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rule_definition` SET TAGS ('pii_business_glossary_term' = 'Governance Rule Definition');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rule_name` SET TAGS ('pii_business_glossary_term' = 'Governance Rule Name');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rule_name` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `rule_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `unity_catalog_tag_key` SET TAGS ('pii_business_glossary_term' = 'Unity Catalog Tag Key');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `unity_catalog_tag_value` SET TAGS ('pii_business_glossary_term' = 'Unity Catalog Tag Value');
ALTER TABLE `vibe_healthcare_v1`.`compliance`.`databricks_governance` ALTER COLUMN `updated_timestamp` SET TAGS ('pii_business_glossary_term' = 'Updated Timestamp');
