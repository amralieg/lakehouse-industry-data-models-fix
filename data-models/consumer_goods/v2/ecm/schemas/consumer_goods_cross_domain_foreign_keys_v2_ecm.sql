...
-- Generated on: 2026-07-10 13:03:48
-- Total cross-domain FK constraints: 1148
--
-- EXECUTION ORDER:
--   1. Run ALL domain schema files first (any order).
--   2. Run this file LAST.
--
-- PREREQUISITE DOMAINS: consumer, customer, distribution, finance, inventory, logistics, manufacturing, marketing, procurement, product, promotion, quality, regulatory, research, sales, supply, sustainability, workforce
...
-- ========= consumer --> inventory (2 constraint(s)) =========
...
-- ========= consumer --> marketing (16 constraint(s)) =========
...
-- ========= consumer --> procurement (3 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`dtc_order` ADD CONSTRAINT `fk_consumer_dtc_order_dtc_purchase_order_id` FOREIGN KEY (`dtc_purchase_order_id`) REFERENCES `vibe_consumer_goods_v1`.`procurement`.`purchase_order`(`purchase_order_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`consumer`.`loyalty_account` ADD CONSTRAINT `fk_consumer_loyalty_account_carbon_offset_id` FOREIGN KEY (`carbon_offset_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`carbon_offset`(`carbon_offset_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`distribution`.`inbound_receipt_line` ADD CONSTRAINT `fk_distribution_inbound_receipt_line_stock_position_id` FOREIGN KEY (`stock_position_id`) REFERENCES `vibe_consumer_goods_v1`.`inventory`.`stock_position`(`stock_position_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`distribution`.`pack_task` ADD CONSTRAINT `fk_distribution_pack_task_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `vibe_consumer_goods_v1`.`product`.`sku`(`sku_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`distribution`.`inventory_position` ADD CONSTRAINT `fk_distribution_inventory_position_compliance_obligation_id` FOREIGN KEY (`compliance_obligation_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`compliance_obligation`(`compliance_obligation_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`distribution`.`outbound_order` ADD CONSTRAINT `fk_distribution_outbound_order_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`distribution`.`distribution_shipment` ADD CONSTRAINT `fk_distribution_distribution_shipment_carbon_offset_id` FOREIGN KEY (`carbon_offset_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`carbon_offset`(`carbon_offset_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`finance`.`contract_party` ADD CONSTRAINT `fk_finance_contract_party_trade_account_id` FOREIGN KEY (`trade_account_id`) REFERENCES `vibe_consumer_goods_v1`.`sales`.`trade_account`(`trade_account_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`inventory`.`stock_position` ADD CONSTRAINT `fk_inventory_stock_position_marketing_brand_id` FOREIGN KEY (`marketing_brand_id`) REFERENCES `vibe_consumer_goods_v1`.`marketing`.`marketing_brand`(`marketing_brand_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`inventory`.`stock_movement` ADD CONSTRAINT `fk_inventory_stock_movement_campaign_flight_id` FOREIGN KEY (`campaign_flight_id`) REFERENCES `vibe_consumer_goods_v1`.`marketing`.`campaign_flight`(`campaign_flight_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`inventory`.`stock_hold` ADD CONSTRAINT `fk_inventory_stock_hold_marketing_brand_id` FOREIGN KEY (`marketing_brand_id`) REFERENCES `vibe_consumer_goods_v1`.`marketing`.`marketing_brand`(`marketing_brand_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`inventory`.`stock_position` ADD CONSTRAINT `fk_inventory_stock_position_po_line_id` FOREIGN KEY (`po_line_id`) REFERENCES `vibe_consumer_goods_v1`.`procurement`.`po_line`(`po_line_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`inventory`.`stock_position` ADD CONSTRAINT `fk_inventory_stock_position_research_formulation_id` FOREIGN KEY (`research_formulation_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`research_formulation`(`research_formulation_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`inventory`.`intransit_shipment` ADD CONSTRAINT `fk_inventory_intransit_shipment_research_formulation_id` FOREIGN KEY (`research_formulation_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`research_formulation`(`research_formulation_id`);
...
-- ========= logistics --> distribution (8 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`logistics_shipment` ADD CONSTRAINT `fk_logistics_logistics_shipment_batch_record_id` FOREIGN KEY (`batch_record_id`) REFERENCES `vibe_consumer_goods_v1`.`manufacturing`.`batch_record`(`batch_record_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`logistics_shipment` ADD CONSTRAINT `fk_logistics_logistics_shipment_campaign_flight_id` FOREIGN KEY (`campaign_flight_id`) REFERENCES `vibe_consumer_goods_v1`.`marketing`.`campaign_flight`(`campaign_flight_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`logistics_shipment` ADD CONSTRAINT `fk_logistics_logistics_shipment_marketing_event_id` FOREIGN KEY (`marketing_event_id`) REFERENCES `vibe_consumer_goods_v1`.`marketing`.`marketing_event`(`marketing_event_id`);
...
-- ========= logistics --> sustainability (3 constraint(s)) =========
-- Requires: logistics schema, sustainability schema
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`carrier` ADD CONSTRAINT `fk_logistics_carrier_esg_commitment_id` FOREIGN KEY (`esg_commitment_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`esg_commitment`(`esg_commitment_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`logistics`.`third_party_provider` ADD CONSTRAINT `fk_logistics_third_party_provider_esg_commitment_id` FOREIGN KEY (`esg_commitment_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`esg_commitment`(`esg_commitment_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`manufacturing`.`production_order` ADD CONSTRAINT `fk_manufacturing_production_order_regulatory_registration_id` FOREIGN KEY (`regulatory_registration_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`regulatory_registration`(`regulatory_registration_id`);
...
-- ========= manufacturing --> workforce (18 constraint(s)) =========
...
-- ========= marketing --> product (16 constraint(s)) =========
...
-- ========= marketing --> sustainability (6 constraint(s)) =========
-- Requires: marketing schema, sustainability schema
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_brand` ADD CONSTRAINT `fk_marketing_marketing_brand_esg_commitment_id` FOREIGN KEY (`esg_commitment_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`esg_commitment`(`esg_commitment_id`);
...
-- ========= marketing --> workforce (21 constraint(s)) =========
...
-- ========= procurement --> marketing (2 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`procurement`.`approved_supplier_list` ADD CONSTRAINT `fk_procurement_approved_supplier_list_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `vibe_consumer_goods_v1`.`product`.`sku`(`sku_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`procurement`.`goods_receipt` ADD CONSTRAINT `fk_procurement_goods_receipt_sds_id` FOREIGN KEY (`sds_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`sds`(`sds_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`procurement`.`approved_supplier_list` ADD CONSTRAINT `fk_procurement_approved_supplier_list_sds_id` FOREIGN KEY (`sds_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`sds`(`sds_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`procurement`.`supplier` ADD CONSTRAINT `fk_procurement_supplier_esg_commitment_id` FOREIGN KEY (`esg_commitment_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`esg_commitment`(`esg_commitment_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`product`.`sku` ADD CONSTRAINT `fk_product_sku_sku_marketing_brand_id` FOREIGN KEY (`sku_marketing_brand_id`) REFERENCES `vibe_consumer_goods_v1`.`marketing`.`marketing_brand`(`marketing_brand_id`);
...
-- ========= product --> regulatory (4 constraint(s)) =========
-- Requires: product schema, regulatory schema
ALTER TABLE `vibe_consumer_goods_v1`.`product`.`gtin_registry` ADD CONSTRAINT `fk_product_gtin_registry_jurisdiction_id` FOREIGN KEY (`jurisdiction_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`jurisdiction`(`jurisdiction_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`product`.`certification` ADD CONSTRAINT `fk_product_certification_regulatory_registration_id` FOREIGN KEY (`regulatory_registration_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`regulatory_registration`(`regulatory_registration_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`product`.`product_registration` ADD CONSTRAINT `fk_product_product_registration_jurisdiction_id` FOREIGN KEY (`jurisdiction_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`jurisdiction`(`jurisdiction_id`);
...
-- ========= product --> sustainability (1 constraint(s)) =========
-- Requires: product schema, sustainability schema
ALTER TABLE `vibe_consumer_goods_v1`.`product`.`sku` ADD CONSTRAINT `fk_product_sku_product_lca_id` FOREIGN KEY (`product_lca_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`product_lca`(`product_lca_id`);
...
-- ========= promotion --> research (9 constraint(s)) =========
-- Requires: promotion schema, research schema
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_event` ADD CONSTRAINT `fk_promotion_promotion_event_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ADD CONSTRAINT `fk_promotion_promotion_accrual_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`post_event_analysis` ADD CONSTRAINT `fk_promotion_post_event_analysis_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
-- ========= promotion --> sustainability (2 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`event_sku` ADD CONSTRAINT `fk_promotion_event_sku_carbon_emission_id` FOREIGN KEY (`carbon_emission_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`carbon_emission`(`carbon_emission_id`);

-- ========= promotion --> workforce (28 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`audit_checklist` ADD CONSTRAINT `fk_quality_audit_checklist_manufacturing_facility_id` FOREIGN KEY (`manufacturing_facility_id`) REFERENCES `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility`(`manufacturing_facility_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ADD CONSTRAINT `fk_quality_batch_release_prototype_id` FOREIGN KEY (`prototype_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`prototype`(`prototype_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`product_complaint` ADD CONSTRAINT `fk_quality_product_complaint_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`inspection_lot` ADD CONSTRAINT `fk_quality_inspection_lot_carbon_emission_id` FOREIGN KEY (`carbon_emission_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`carbon_emission`(`carbon_emission_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`quality`.`batch_release` ADD CONSTRAINT `fk_quality_batch_release_batch_modified_by_user_employee_id` FOREIGN KEY (`batch_modified_by_user_employee_id`) REFERENCES `vibe_consumer_goods_v1`.`workforce`.`employee`(`employee_id`);
...
-- ========= research --> consumer (4 constraint(s)) =========
...
-- ========= research --> product (16 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`research`.`research_packaging_spec` ADD CONSTRAINT `fk_research_research_packaging_spec_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `vibe_consumer_goods_v1`.`product`.`sku`(`sku_id`);
...
-- ========= research --> sustainability (5 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`research`.`research_packaging_spec` ADD CONSTRAINT `fk_research_research_packaging_spec_packaging_profile_id` FOREIGN KEY (`packaging_profile_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`packaging_profile`(`packaging_profile_id`);
...
-- ========= sales --> customer (2 constraint(s)) =========
-- Requires: sales schema, customer schema
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`edi_trading_partner` ADD CONSTRAINT `fk_sales_edi_trading_partner_channel_classification_id` FOREIGN KEY (`channel_classification_id`) REFERENCES `vibe_consumer_goods_v1`.`customer`.`channel_classification`(`channel_classification_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`order` ADD CONSTRAINT `fk_sales_order_channel_classification_id` FOREIGN KEY (`channel_classification_id`) REFERENCES `vibe_consumer_goods_v1`.`customer`.`channel_classification`(`channel_classification_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`trade_account` ADD CONSTRAINT `fk_sales_trade_account_inventory_storage_location_id` FOREIGN KEY (`inventory_storage_location_id`) REFERENCES `vibe_consumer_goods_v1`.`inventory`.`inventory_storage_location`(`inventory_storage_location_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`distribution_point` ADD CONSTRAINT `fk_sales_distribution_point_manufacturing_facility_id` FOREIGN KEY (`manufacturing_facility_id`) REFERENCES `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility`(`manufacturing_facility_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`return_order` ADD CONSTRAINT `fk_sales_return_order_purchase_order_id` FOREIGN KEY (`purchase_order_id`) REFERENCES `vibe_consumer_goods_v1`.`procurement`.`purchase_order`(`purchase_order_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_assortment` ADD CONSTRAINT `fk_sales_account_assortment_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_pricing_agreement` ADD CONSTRAINT `fk_sales_account_pricing_agreement_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`pricing_agreement` ADD CONSTRAINT `fk_sales_pricing_agreement_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`return_order` ADD CONSTRAINT `fk_sales_return_order_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`distribution_point` ADD CONSTRAINT `fk_sales_distribution_point_rd_project_id` FOREIGN KEY (`rd_project_id`) REFERENCES `vibe_consumer_goods_v1`.`research`.`rd_project`(`rd_project_id`);
...
-- ========= sales --> sustainability (7 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`account_compliance_record` ADD CONSTRAINT `fk_sales_account_compliance_record_esg_commitment_id` FOREIGN KEY (`esg_commitment_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`esg_commitment`(`esg_commitment_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`sales`.`pricing_agreement` ADD CONSTRAINT `fk_sales_pricing_agreement_esg_commitment_id` FOREIGN KEY (`esg_commitment_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`esg_commitment`(`esg_commitment_id`);
...
-- ========= supply --> research (3 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sku_planning_param` ADD CONSTRAINT `fk_supply_sku_planning_param_product_lca_id` FOREIGN KEY (`product_lca_id`) REFERENCES `vibe_consumer_goods_v1`.`sustainability`.`product_lca`(`product_lca_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`sustainability`.`circular_initiative` ADD CONSTRAINT `fk_sustainability_circular_initiative_manufacturing_facility_id` FOREIGN KEY (`manufacturing_facility_id`) REFERENCES `vibe_consumer_goods_v1`.`manufacturing`.`manufacturing_facility`(`manufacturing_facility_id`);
...
-- ========= sustainability --> regulatory (4 constraint(s)) =========
...
ALTER TABLE `vibe_consumer_goods_v1`.`sustainability`.`social_impact_program` ADD CONSTRAINT `fk_sustainability_social_impact_program_region_id` FOREIGN KEY (`region_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`region`(`region_id`);
ALTER TABLE `vibe_consumer_goods_v1`.`sustainability`.`biodiversity_impact` ADD CONSTRAINT `fk_sustainability_biodiversity_impact_regulatory_region_id` FOREIGN KEY (`regulatory_region_id`) REFERENCES `vibe_consumer_goods_v1`.`regulatory`.`regulatory_region`(`regulatory_region_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`org_unit` ADD CONSTRAINT `fk_workforce_org_unit_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_consumer_goods_v1`.`finance`.`cost_center`(`cost_center_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`workforce`.`work_location` ADD CONSTRAINT `fk_workforce_work_location_cost_center_id` FOREIGN KEY (`cost_center_id`) REFERENCES `vibe_consumer_goods_v1`.`finance`.`cost_center`(`cost_center_id`);
