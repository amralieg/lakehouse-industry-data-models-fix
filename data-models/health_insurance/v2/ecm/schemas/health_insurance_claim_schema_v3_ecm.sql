-- Schema for Domain: claim | Business:  | Version: v3_ecm
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`header` (
    ...
    `origin_group_id` BIGINT COMMENT 'Foreign key linking to employer.employer_group. Business justification: Required for employer‑sponsored plan cost reporting and ACA employer reporting; each claim must be attributed to the employer group that provided the coverage.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`line` (
    ...
    `number` STRING COMMENT 'Sequential number of the line within the claim.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`diagnosis` (
    ...
    `identity_id` BIGINT COMMENT 'add column member_identity_id (BIGINT) with FK to member.identity.identity_id - diagnoses are associated with specific members',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`procedure` (
    ...
    `identity_id` BIGINT COMMENT 'add column member_identity_id (BIGINT) with FK to member.identity.identity_id - procedures are performed on specific members',
    `service_area_id` BIGINT COMMENT 'Foreign key linking to network.service_area. Business justification: Supports network adequacy compliance reporting by linking procedure location to the defined service area of the provider network.',
    ...
    `timestamp` TIMESTAMP COMMENT 'Exact date‑time when the procedure was performed, captured to the second.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`adjudication` (
    ...
    `number` STRING COMMENT 'External reference number assigned to the adjudication for audit and communication purposes.',
    ...
    `timestamp` TIMESTAMP COMMENT 'Date and time when the adjudication decision was generated.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`denial` (
    ...
    `number` STRING COMMENT 'External business identifier assigned to the denial, used in communications and reporting.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`payment` (
    ...
    `payment_party_id` BIGINT COMMENT 'Unique identifier of the entity receiving the payment (provider NPI or member ID).',
    `party_id` BIGINT COMMENT 'Identifier of the entity funding the payment (usually the health plan).',
    ...
    `number` STRING COMMENT 'External payment reference number used in remittance advice and provider communications.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`ibnr` (
    ...
    `health_plan_id` BIGINT COMMENT 'add column plan_health_plan_id (BIGINT) with FK to plan.health_plan.health_plan_id - IBNR reserves are tracked by health plan',
    `pool_id` BIGINT COMMENT 'add column risk_pool_id (BIGINT) with FK to risk.pool.pool_id - IBNR reserves are calculated at risk pool level',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` (
    ...
    `number` STRING COMMENT 'Business identifier assigned to the subrogation case.',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`drg` (
    ...
    `facility_id` BIGINT COMMENT 'add column provider_facility_id (BIGINT) with FK to provider.facility.facility_id - DRG assignments are specific to facility admissions',
...
CREATE OR REPLACE TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` (
    ...
    `vendor_id` BIGINT COMMENT 'add column vendor_vendor_id (BIGINT) with FK to vendor.vendor.vendor_id - external payers are third-party entities that should link to vendor master',
    `billing_payer_id` BIGINT COMMENT '',
    ...
    `claim_payer_name` STRING COMMENT 'Legal name of the payer organization.',
    ...
    `claim_payer_status` STRING COMMENT 'Current lifecycle status of the payer.',
    `tax_number` STRING COMMENT 'Employer Identification Number (EIN) for the payer.',
    `claim_payer_type` STRING COMMENT 'Category of the payer entity.',
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ADD CONSTRAINT `fk_claim_payment_payment_claim_header_id` FOREIGN KEY (`payment_claim_header_id`) REFERENCES `vibe_health_insurance_v1`.`claim`.`header`(`header_id`);
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`header` SET TAGS ('dbx_subdomain' = 'submission_processing');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`header` SET TAGS ('dbx_refactored' = 'split_fks');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`header` ALTER COLUMN `origin_group_id` SET TAGS ('dbx_business_glossary_term' = 'Employer Group Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`header` ALTER COLUMN `header_rendering_provider_id` SET TAGS ('dbx_business_glossary_term' = 'Header Rendering Provider Id');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`header` ALTER COLUMN `subscriber_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`line` SET TAGS ('dbx_subdomain' = 'submission_processing');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`line` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Line Sequence Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`diagnosis` SET TAGS ('dbx_subdomain' = 'submission_processing');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`procedure` SET TAGS ('dbx_subdomain' = 'submission_processing');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`procedure` ALTER COLUMN `service_area_id` SET TAGS ('dbx_business_glossary_term' = 'Service Area Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`procedure` ALTER COLUMN `surgeon_name` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`procedure` ALTER COLUMN `timestamp` SET TAGS ('dbx_business_glossary_term' = 'Procedure Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication` ALTER COLUMN `journal_entry_id` SET TAGS ('dbx_business_glossary_term' = 'Journal Entry Id (Foreign Key)');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Adjudication Number (External Identifier)');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication` ALTER COLUMN `timestamp` SET TAGS ('dbx_business_glossary_term' = 'Adjudication Timestamp');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`eob` ALTER COLUMN `provider_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjustment` SET TAGS ('dbx_subdomain' = 'recovery_resolution');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjustment` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`denial` ALTER COLUMN `appeal_deadline_date` SET TAGS ('dbx_pii_government_id' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`denial` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Denial Number (DENIAL_NUM)');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`cob` SET TAGS ('dbx_subdomain' = 'recovery_resolution');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`cob` ALTER COLUMN `secondary_payer_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `payment_claim_header_id` SET TAGS ('dbx_business_glossary_term' = 'Claim Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `payment_party_id` SET TAGS ('dbx_business_glossary_term' = 'Payee Identifier');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `payment_party_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `payment_party_id` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `party_id` SET TAGS ('dbx_business_glossary_term' = 'Payer Identifier');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `clearinghouse_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `gl_posting_date` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Payment Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`payment` ALTER COLUMN `trace_number` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`ibnr` SET TAGS ('dbx_subdomain' = 'recovery_resolution');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`ibnr` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`ibnr` ALTER COLUMN `health_plan_id` SET TAGS ('dbx_pii' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` SET TAGS ('dbx_subdomain' = 'recovery_resolution');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` ALTER COLUMN `accident_city` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` ALTER COLUMN `accident_state_code` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` ALTER COLUMN `number` SET TAGS ('dbx_business_glossary_term' = 'Subrogation Number');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` ALTER COLUMN `regulatory_reporting_flag` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`subrogation` ALTER COLUMN `reporting_state_code` SET TAGS ('dbx_pii_personal' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`drg` SET TAGS ('dbx_subdomain' = 'recovery_resolution');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`drg` ALTER COLUMN `payment_currency` SET TAGS ('dbx_value_regex' = 'USD|EUR|GBP|CAD|JPY|CHF');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`accumulator` SET TAGS ('dbx_subdomain' = 'benefit_tracking');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` SET TAGS ('dbx_subdomain' = 'payment_settlement');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` ALTER COLUMN `provider_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Contract ID');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` ALTER COLUMN `geographic_county` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` ALTER COLUMN `geographic_state` SET TAGS ('dbx_pii_person_data' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` ALTER COLUMN `rate_source` SET TAGS ('dbx_value_regex' = 'CMS|Plan|Contract');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` ALTER COLUMN `rate_type` SET TAGS ('dbx_value_regex' = 'procedure|drug|bundle|service');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`adjudication_rate` ALTER COLUMN `adjudication_rate_status` SET TAGS ('dbx_value_regex' = 'active|inactive|retired|pending');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`attachment` SET TAGS ('dbx_subdomain' = 'submission_processing');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`attachment` ALTER COLUMN `file_name` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`status_event` SET TAGS ('dbx_subdomain' = 'submission_processing');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` SET TAGS ('dbx_subdomain' = 'benefit_tracking');
...
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `billing_payer_id` SET TAGS ('dbx_ssot_reference' = 'billing.billing_payer');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_balance` SET TAGS ('dbx_business_glossary_term' = 'Payer Account Balance');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_balance` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_balance` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_currency` SET TAGS ('dbx_business_glossary_term' = 'Payer Account Currency');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_number` SET TAGS ('dbx_business_glossary_term' = 'Payer Account Number');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_number` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_number` SET TAGS ('dbx_pii_financial' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `account_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Account Status');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `address_line1` SET TAGS ('dbx_business_glossary_term' = 'Payer Address Line1');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `address_line1` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `address_line1` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `address_line2` SET TAGS ('dbx_business_glossary_term' = 'Payer Address Line2');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `address_line2` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `address_line2` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `business_number` SET TAGS ('dbx_business_glossary_term' = 'Payer Business Number');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `business_number` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `business_number` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `city` SET TAGS ('dbx_business_glossary_term' = 'Payer City');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `city` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_email` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Email');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_email` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_email` SET TAGS ('dbx_pii_email' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Name');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_phone` SET TAGS ('dbx_business_glossary_term' = 'Payer Contact Phone');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contact_phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contract_end_date` SET TAGS ('dbx_business_glossary_term' = 'Payer Contract End Date');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contract_number` SET TAGS ('dbx_business_glossary_term' = 'Payer Contract Number');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contract_start_date` SET TAGS ('dbx_business_glossary_term' = 'Payer Contract Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `contract_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Contract Status');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `country` SET TAGS ('dbx_business_glossary_term' = 'Payer Country');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `coverage_end_date` SET TAGS ('dbx_business_glossary_term' = 'Payer Coverage End Date');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `coverage_start_date` SET TAGS ('dbx_business_glossary_term' = 'Payer Coverage Start Date');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `created_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Created At');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `deleted_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Deleted At');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `lei` SET TAGS ('dbx_business_glossary_term' = 'Payer Lei');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `lei` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `lei` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `logo_url` SET TAGS ('dbx_business_glossary_term' = 'Payer Logo Url');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `claim_payer_name` SET TAGS ('dbx_business_glossary_term' = 'Payer Name');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `claim_payer_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `claim_payer_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Payer Notes');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `payment_cycle` SET TAGS ('dbx_business_glossary_term' = 'Payer Payment Cycle');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `payment_frequency` SET TAGS ('dbx_business_glossary_term' = 'Payer Payment Frequency');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `payment_method` SET TAGS ('dbx_business_glossary_term' = 'Payer Payment Method');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `payment_terms` SET TAGS ('dbx_business_glossary_term' = 'Payer Payment Terms');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `rating` SET TAGS ('dbx_business_glossary_term' = 'Payer Rating');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `rating` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `rating_source` SET TAGS ('dbx_business_glossary_term' = 'Payer Rating Source');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `rating_source` SET TAGS ('dbx_pii_personal' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `risk_category` SET TAGS ('dbx_business_glossary_term' = 'Payer Risk Category');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `risk_score` SET TAGS ('dbx_business_glossary_term' = 'Payer Risk Score');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `state` SET TAGS ('dbx_business_glossary_term' = 'Payer State');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `state` SET TAGS ('dbx_pii_person_data' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `claim_payer_status` SET TAGS ('dbx_business_glossary_term' = 'Payer Status');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `tax_number` SET TAGS ('dbx_business_glossary_term' = 'Payer Tax Number');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `tax_number` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `tax_number` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `claim_payer_type` SET TAGS ('dbx_business_glossary_term' = 'Payer Type');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `updated_at` SET TAGS ('dbx_business_glossary_term' = 'Payer Updated At');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `website` SET TAGS ('dbx_business_glossary_term' = 'Payer Website');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `zip` SET TAGS ('dbx_business_glossary_term' = 'Payer Zip');
ALTER TABLE `vibe_health_insurance_v1`.`claim`.`claim_payer` ALTER COLUMN `zip` SET TAGS ('dbx_pii_address' = 'true');
