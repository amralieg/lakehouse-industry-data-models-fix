...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`payment_certificate` (
    ...
    `invoice_date` DECIMAL(18,2) COMMENT 'Date the invoice was issued.',
    `invoice_number` DECIMAL(18,2) COMMENT 'Reference to the invoice generated for this certificate.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` (
    ...
    `finance_retention_ledger_id` BIGINT COMMENT 'Reference to single source of truth finance.finance_retention_ledger (SSOT dedup).',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`amendment` (
    ...
    `payment_schedule_new_date` DECIMAL(18,2) COMMENT 'New date for the next payment after amendment.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`dispute` (
    ...
    `arbitration_reference` DECIMAL(18,2) COMMENT 'Reference number for any arbitration proceeding linked to the dispute.',
    ...
    `legal_cost_currency` DECIMAL(18,2) COMMENT 'Currency of the legal cost amount.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`advance_payment` (
    ...
    `exchange_rate_date` DECIMAL(18,2) COMMENT 'Date on which the exchange rate was determined.',
    ...
    `payment_number` DECIMAL(18,2) COMMENT 'Business identifier assigned to the advance payment, used in contracts and accounting.',
    `payment_terms` DECIMAL(18,2) COMMENT 'Contractual terms governing the advance payment (e.g., 30 days net).',
    ...
    `repayment_end_date` DECIMAL(18,2) COMMENT 'Date by which the full advance payment must be recovered.',
    `repayment_frequency` DECIMAL(18,2) COMMENT 'Frequency at which repayments are scheduled.',
    `repayment_schedule_description` DECIMAL(18,2) COMMENT 'Free‑text description of the repayment schedule (e.g., monthly installments, milestone‑based).',
    `repayment_start_date` DECIMAL(18,2) COMMENT 'Date when the contractor must begin repaying the advance payment.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`closeout` (
    ...
    `final_payment_certificate_number` DECIMAL(18,2) COMMENT 'Reference number of the final payment certificate issued to the contractor.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`contractual_notice` (
    ...
    `agreement_id` BIGINT COMMENT 'Foreign key reference to contract.agreement.agreement_id',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`contract`.`change_order_activity_impact` (
    ...
    `assessed_by` STRING COMMENT 'Person who assessed the activity impact.',
    `assessed_by_name` STRING COMMENT 'Business attribute assessed_by_name for change_order_activity_impact',
    `assessment_date` DATE COMMENT 'Date the impact assessment was performed.',
    `cost_impact_amount` DECIMAL(18,2) COMMENT 'Business attribute cost_impact_amount for change_order_activity_impact',
    `cost_variance` DECIMAL(18,2) COMMENT 'Cost delta attributable to the change order.',
    `cost_variance_amount` DECIMAL(18,2) COMMENT '',
    `created_timestamp` TIMESTAMP COMMENT 'Record creation timestamp.',
    `currency_code` STRING COMMENT 'Currency for monetary amounts.',
    `disposition` STRING COMMENT 'Business attribute disposition for change_order_activity_impact',
    `float_consumed_days` STRING COMMENT '',
    ...
    `is_approved` BOOLEAN COMMENT 'Whether the impact has been formally approved.',
    `is_critical_path` BOOLEAN COMMENT 'Whether impacted activity is on the critical path.',
    `is_critical_path_affected` BOOLEAN COMMENT '',
    `original_cost` DECIMAL(18,2) COMMENT 'Original cost prior to the change order.',
    `original_finish_date` DATE COMMENT 'Original activity finish date.',
    `original_start_date` DATE COMMENT 'Original activity start date.',
    `quantity_impact` DECIMAL(18,2) COMMENT 'Business attribute quantity_impact for change_order_activity_impact',
    `remarks` STRING COMMENT 'Free-text notes on the impact.',
    `resource_impact_notes` STRING COMMENT '',
...
ALTER TABLE `vibe_construction_v1`.`contract`.`agreement` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`party` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_subdomain' = 'contract_administration');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_curated' = 'v2');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_ssot' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_ssot_pair' = 'contract.contract_scope');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_ssot_status' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_ssot_pair_resolved' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_ssot_canonical' = 'contract.contract_scope');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` SET TAGS ('dbx_ssot_role' = 'owner');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_scope` ALTER COLUMN `scope_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_subdomain' = 'milestone_obligations');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_curated' = 'v2');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot_ref' = 'project.project_milestone');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot_pair' = 'contract.contract_milestone');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot_status' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot_pair_resolved' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot_canonical' = 'contract.contract_milestone');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_milestone` SET TAGS ('dbx_ssot_role' = 'duplicate');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`payment_schedule` SET TAGS ('dbx_subdomain' = 'financial_security');
ALTER TABLE `vibe_construction_v1`.`contract`.`payment_schedule` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`payment_certificate` SET TAGS ('dbx_subdomain' = 'financial_security');
ALTER TABLE `vibe_construction_v1`.`contract`.`payment_certificate` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_subdomain' = 'change_claims');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_curated' = 'v2');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_ssot' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_ssot_pair' = 'contract.contract_change_order');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_ssot_status' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_ssot_pair_resolved' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_ssot_canonical' = 'contract.contract_change_order');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_change_order` SET TAGS ('dbx_ssot_role' = 'owner');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_subdomain' = 'change_claims');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_curated' = 'v2');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot_pair' = 'contract.contract_eot_claim');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot_status' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot_pair_resolved' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot_canonical' = 'contract.contract_eot_claim');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot_for' = 'schedule.schedule_eot_claim');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_eot_claim` SET TAGS ('dbx_ssot_role' = 'owner');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`ld_assessment` SET TAGS ('dbx_subdomain' = 'change_claims');
ALTER TABLE `vibe_construction_v1`.`contract`.`ld_assessment` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`ld_assessment` ALTER COLUMN `milestone_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_subdomain' = 'financial_security');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_curated' = 'v2');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_ref' = 'finance.finance_retention_ledger');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_pair' = 'contract.contract_retention_ledger');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_status' = 'canonical');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_pair_resolved' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_canonical' = 'contract.contract_retention_ledger');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_reference' = 'finance.finance_retention_ledger');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` SET TAGS ('dbx_ssot_role' = 'duplicate');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` ALTER COLUMN `finance_retention_ledger_id` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` ALTER COLUMN `finance_retention_ledger_id` SET TAGS ('dbx_ssot_fk' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_retention_ledger` ALTER COLUMN `finance_retention_ledger_id` SET TAGS ('dbx_ssot_owner' = 'finance.finance_retention_ledger');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`dlp_register` SET TAGS ('dbx_subdomain' = 'milestone_obligations');
ALTER TABLE `vibe_construction_v1`.`contract`.`dlp_register` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`amendment` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`amendment` ALTER COLUMN `amendment_id` SET TAGS ('dbx_key_role' = 'primary');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`bond_guarantee` SET TAGS ('dbx_subdomain' = 'financial_security');
ALTER TABLE `vibe_construction_v1`.`contract`.`bond_guarantee` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`insurance_register` SET TAGS ('dbx_subdomain' = 'financial_security');
ALTER TABLE `vibe_construction_v1`.`contract`.`insurance_register` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`subcontract` SET TAGS ('dbx_subdomain' = 'subcontract_management');
ALTER TABLE `vibe_construction_v1`.`contract`.`subcontract` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`subcontract_payment` SET TAGS ('dbx_subdomain' = 'subcontract_management');
ALTER TABLE `vibe_construction_v1`.`contract`.`subcontract_payment` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`dispute` SET TAGS ('dbx_subdomain' = 'change_claims');
ALTER TABLE `vibe_construction_v1`.`contract`.`dispute` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`advance_payment` SET TAGS ('dbx_subdomain' = 'financial_security');
ALTER TABLE `vibe_construction_v1`.`contract`.`advance_payment` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`closeout` SET TAGS ('dbx_subdomain' = 'contract_administration');
ALTER TABLE `vibe_construction_v1`.`contract`.`closeout` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contractual_notice` SET TAGS ('dbx_subdomain' = 'contract_administration');
ALTER TABLE `vibe_construction_v1`.`contract`.`contractual_notice` SET TAGS ('dbx_curated' = 'v2');
ALTER TABLE `vibe_construction_v1`.`contract`.`contractual_notice` SET TAGS ('dbx_fk_added' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`change_order_activity_impact` SET TAGS ('dbx_subdomain' = 'change_claims');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`change_order_activity_impact` SET TAGS ('dbx_curated' = 'v2');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`change_order_activity_impact` ALTER COLUMN `assessed_by_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_insurance_certificate` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_insurance_certificate` SET TAGS ('dbx_subdomain' = 'contract_administration');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_insurance_certificate` ALTER COLUMN `certificate_holder_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_insurance_certificate` ALTER COLUMN `certificate_holder_name` SET TAGS ('dbx_mask_non_prod' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_insurance_certificate` ALTER COLUMN `certificate_holder_name` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_construction_v1`.`contract`.`contract_insurance_certificate` ALTER COLUMN `certificate_holder_name` SET TAGS ('dbx_mask_nonprod' = 'true');
