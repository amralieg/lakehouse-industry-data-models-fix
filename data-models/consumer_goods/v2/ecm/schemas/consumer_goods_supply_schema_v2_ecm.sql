...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`plan` (
    ...
    `cost_center_id` DECIMAL(18,2) COMMENT 'Foreign key linking to finance.cost_center. Business justification: Cost allocation of each supply plan to a finance cost center for budgeting and variance analysis; planners routinely charge production plans to cost centers.',
    ...
    `trade_account_id` BIGINT COMMENT 'Foreign key linking to sales.trade_account. Business justification: REQUIRED: Store‑specific supply plan ties replenishment to the owning trade_account; essential for execution and KPI reporting.',
    ...
    `horizon_end_date` DATE COMMENT '',
    `horizon_start_date` DATE COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`forecast_accuracy` (
    ...
    `forecast_version_id` BIGINT COMMENT '',
    ...
    `bias_percentage` DECIMAL(18,2) COMMENT '',
    ...
    `mape_percentage` DECIMAL(18,2) COMMENT '',
    ...
    `measurement_period_end_date` DATE COMMENT '',
    `measurement_period_start_date` DATE COMMENT '',
    ...
    `source_system_record_code` STRING COMMENT '',
    `forecast_accuracy_status` STRING COMMENT '',
    ...
    `wmape_percentage` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`consensus_demand` (
    ...
    `consensus_demand_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`constraint` (
    ...
    `cost_center_id` DECIMAL(18,2) COMMENT 'Foreign key linking to finance.cost_center. Business justification: Supply constraints often generate cost impacts; linking to a cost center enables financial impact reporting and mitigation budgeting.',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` (
    ...
    `cost_center_id` DECIMAL(18,2) COMMENT 'Foreign key linking to finance.cost_center. Business justification: Risk mitigation actions are funded through specific cost centers; the link supports risk‑related expense tracking and SOX reporting.',
    ...
    `source_system_record_code` STRING COMMENT '',
    `risk_register_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`planning_exception` (
    ...
    `exception_message` STRING COMMENT '',
    ...
    `raised_timestamp` TIMESTAMP COMMENT '',
    ...
    `source_system_record_code` STRING COMMENT '',
    `planning_exception_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`inventory_projection` (
    ...
    `projected_available_quantity` DECIMAL(18,2) COMMENT '',
    `projected_days_of_supply` DECIMAL(18,2) COMMENT '',
    ...
    `source_system_record_code` STRING COMMENT '',
    `inventory_projection_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`demand_event` (
    ...
    `event_quantity_impact` DECIMAL(18,2) COMMENT '',
    ...
    `source_system_record_code` STRING COMMENT '',
    `demand_event_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` (
    ...
    `in_full_target_percentage` DECIMAL(18,2) COMMENT '',
    ...
    `on_time_target_percentage` DECIMAL(18,2) COMMENT '',
    ...
    `percentage` DECIMAL(18,2) COMMENT '',
    ...
    `source_system_record_code` STRING COMMENT '',
    `otif_target_status` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` (
    ...
    `drp_last_successful_run_id` BIGINT COMMENT 'Identifier of the most recent successful DRP run preceding this one.',
    `employee_id` BIGINT COMMENT 'Identifier of the planner (person or team) responsible for initiating the DRP run.',
    `planning_run_id` BIGINT COMMENT '',
    ...
    `last_updated_timestamp` TIMESTAMP COMMENT '',
    `net_requirement_quantity` DECIMAL(18,2) COMMENT '',
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`forecast_version` ADD CONSTRAINT `fk_supply_forecast_version_baseline_version_id` FOREIGN KEY (`baseline_version_id`) REFERENCES `vibe_consumer_goods_v1`.`supply`.`forecast_version`(`forecast_version_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sop_cycle` ADD CONSTRAINT `fk_supply_sop_cycle_network_node_id` FOREIGN KEY (`network_node_id`) REFERENCES `vibe_consumer_goods_v1`.`supply`.`network_node`(`network_node_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ADD CONSTRAINT `fk_supply_planning_period_network_node_id` FOREIGN KEY (`network_node_id`) REFERENCES `vibe_consumer_goods_v1`.`supply`.`network_node`(`network_node_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ADD CONSTRAINT `fk_supply_drp_run_drp_last_successful_run_id` FOREIGN KEY (`drp_last_successful_run_id`) REFERENCES `vibe_consumer_goods_v1`.`supply`.`drp_run`(`drp_run_id`);
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`demand_plan` ALTER COLUMN `esg_commitment_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Commitment Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`plan` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`plan` ALTER COLUMN `regulatory_registration_id` SET TAGS ('dbx_business_glossary_term' = 'Registration Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`plan` ALTER COLUMN `network_node_id` SET TAGS ('dbx_business_glossary_term' = 'Source Location Identifier (ID)');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`plan` ALTER COLUMN `trade_account_id` SET TAGS ('dbx_business_glossary_term' = 'Trade Account Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`plan` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`plan` ALTER COLUMN `record_source` SET TAGS ('dbx_business_glossary_term' = 'Record Source');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`forecast_version` ALTER COLUMN `baseline_version_id` SET TAGS ('dbx_business_glossary_term' = 'Baseline Version Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`forecast_version` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`forecast_accuracy` ALTER COLUMN `forecast_version` SET TAGS ('dbx_business_glossary_term' = 'Forecast Version');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`inventory_policy` SET TAGS ('dbx_subdomain' = 'inventory_strategy');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`inventory_policy` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`safety_stock` SET TAGS ('dbx_subdomain' = 'inventory_strategy');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`safety_stock` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` SET TAGS ('dbx_ssot_owner' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` SET TAGS ('dbx_ssot_role' = 'canonical');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` SET TAGS ('dbx_ssot_reference' = 'inventory.inventory_replenishment_order');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` ALTER COLUMN `supply_replenishment_order_id` SET TAGS ('dbx_ssot_superseded_by' = 'inventory.inventory_replenishment_order');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` ALTER COLUMN `supply_replenishment_order_id` SET TAGS ('dbx_ssot_status' = 'duplicate_resolved');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` ALTER COLUMN `regulatory_registration_id` SET TAGS ('dbx_business_glossary_term' = 'Registration Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`supply_replenishment_order` ALTER COLUMN `record_source` SET TAGS ('dbx_business_glossary_term' = 'Record Source');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`atp_record` SET TAGS ('dbx_subdomain' = 'supply_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sop_cycle` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Cycle Owner ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sop_cycle` ALTER COLUMN `cycle_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sop_cycle` ALTER COLUMN `cycle_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sop_cycle` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sop_cycle` ALTER COLUMN `record_source` SET TAGS ('dbx_business_glossary_term' = 'Record Source');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`constraint` SET TAGS ('dbx_subdomain' = 'network_configuration');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` SET TAGS ('dbx_subdomain' = 'network_configuration');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Primary Risk Owner Employee Id');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` ALTER COLUMN `employee_id` SET TAGS ('dbx_internal' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` ALTER COLUMN `network_node_id` SET TAGS ('dbx_business_glossary_term' = 'Supply Network Node Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`risk_register` ALTER COLUMN `record_source` SET TAGS ('dbx_business_glossary_term' = 'Record Source');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_exception` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned Planner Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_exception` ALTER COLUMN `network_node_id` SET TAGS ('dbx_business_glossary_term' = 'Location Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_exception` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_exception` ALTER COLUMN `planning_run_code` SET TAGS ('dbx_business_glossary_term' = 'Planning Run Identifier (ID)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_exception` ALTER COLUMN `record_source` SET TAGS ('dbx_business_glossary_term' = 'Record Source');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`sku_planning_param` SET TAGS ('dbx_subdomain' = 'inventory_strategy');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`inventory_projection` SET TAGS ('dbx_subdomain' = 'inventory_strategy');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`inventory_projection` ALTER COLUMN `planning_run_code` SET TAGS ('dbx_business_glossary_term' = 'Planning Run ID');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`demand_event` ALTER COLUMN `event_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`demand_event` ALTER COLUMN `event_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` SET TAGS ('dbx_subdomain' = 'inventory_strategy');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `network_node_id` SET TAGS ('dbx_business_glossary_term' = 'Supply Network Node Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_pii_type' = 'person_name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_name` SET TAGS ('dbx_pii_type' = 'person_name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_owner_name` SET TAGS ('dbx_sensitivity' = 'person_name');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_owner_name` SET TAGS ('dbx_pii_type' = 'person_name');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_owner_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_owner_name` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_owner_name` SET TAGS ('dbx_mask_non_prod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`otif_target` ALTER COLUMN `target_owner_name` SET TAGS ('dbx_pii_kind' = 'person_name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`atp_rule` SET TAGS ('dbx_subdomain' = 'supply_execution');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`atp_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`atp_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`atp_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`atp_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_pii_type' = 'person_name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ALTER COLUMN `period_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ALTER COLUMN `period_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ALTER COLUMN `period_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ALTER COLUMN `period_name` SET TAGS ('dbx_pii_type' = 'person_name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`planning_period` ALTER COLUMN `record_source` SET TAGS ('dbx_business_glossary_term' = 'Record Source');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `drp_run_id` SET TAGS ('dbx_business_glossary_term' = 'Drp Run Identifier');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `drp_last_successful_run_id` SET TAGS ('dbx_business_glossary_term' = 'Last Successful Run Id');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `drp_last_successful_run_id` SET TAGS ('dbx_self_ref_relationship' = 'last_successful_run');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `run_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `run_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `run_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `run_name` SET TAGS ('dbx_pii_type' = 'person_name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `scenario_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `scenario_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `scenario_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_consumer_goods_v1`.`supply`.`drp_run` ALTER COLUMN `scenario_name` SET TAGS ('dbx_pii_type' = 'person_name');
