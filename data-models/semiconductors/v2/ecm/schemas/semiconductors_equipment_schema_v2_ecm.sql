...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` (
    ...
    `fabrication_process_recipe_id` BIGINT COMMENT 'SSOT FK reference to canonical fabrication.fabrication_process_recipe; this table is a secondary view and must not duplicate master data.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` (
    ...
    `control_parameter` STRING COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`tool_capex` (
    ...
    `capex_request_id` BIGINT COMMENT '',
    ...
    `capex_amount_usd` DECIMAL(18,2) COMMENT '',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` (
    ...
    `compliance_status` STRING COMMENT 'Compliance status (Compliant, Non-Compliant, Under Review)',
    `composition_source` STRING COMMENT '',
    ...
    `declaration_date` DATE COMMENT 'Date the composition was declared or last verified',
    `exceeds_threshold_flag` BOOLEAN COMMENT 'Whether the concentration exceeds the regulatory threshold',
    `exemption_code` STRING COMMENT 'Applicable regulatory exemption code if any',
    `homogeneous_material` STRING COMMENT 'Name of the homogeneous material within the part containing the substance',
    `is_restricted_flag` BOOLEAN COMMENT 'Whether the substance is on a restricted substances list',
    `is_restricted_substance` BOOLEAN COMMENT '',
    `is_svhc_flag` BOOLEAN COMMENT 'Whether the substance is a Substance of Very High Concern under REACH',
    `material_category` STRING COMMENT 'Category of the material containing the substance',
    `measurement_method` STRING COMMENT 'Analytical method used to determine concentration',
    `part_weight_fraction` DECIMAL(18,2) COMMENT 'Weight fraction of the substance relative to total part weight',
    `reach_reportable_flag` BOOLEAN COMMENT '',
    `reach_svhc_flag` BOOLEAN COMMENT '',
    `regulation_reference` STRING COMMENT 'Reference to the applicable regulation (e.g., REACH, RoHS)',
    `reporting_date` DATE COMMENT 'Date when the composition was reported or measured',
    `restricted_flag` BOOLEAN COMMENT '',
    `rohs_compliant_flag` BOOLEAN COMMENT '',
    `source_document` STRING COMMENT 'Reference to the SDS or material declaration document',
    `substance_name` STRING COMMENT 'Chemical name of the substance',
    `threshold_limit` DECIMAL(18,2) COMMENT 'Regulatory threshold limit for the substance',
    ...
    `weight_mg` DECIMAL(18,2) COMMENT '',
    `weight_percent` DECIMAL(18,2) COMMENT '',
    `concentration_percentage` DECIMAL(18,2) COMMENT 'Concentration percentage',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` (
    ...
    `process_site_map_id` BIGINT COMMENT 'FK reference to SSOT owner process.site_map',
    ...
    `equipment_site_map_description` STRING COMMENT 'Free‑form text describing the site, its purpose, and notable characteristics.',
    ...
    `equipment_site_map_status` STRING COMMENT 'Current operational status of the site.',
...
) COMMENT 'Master reference table for site_map. Referenced by site_map_id. References SSOT: process.site_map';
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` (
    ...
    `fab_site_id` BIGINT COMMENT 'P2: Add column fabrication_fab_site_id (BIGINT) to fabrication.fab with FK to fabrication.fab_site.fab_site_id because fabrication.fab references only maintenance. P2: connect_table: fabrication.fab** - add column fabrication_fab_site_id (BIGINT)',
    ...
    `equipment_fab_code` STRING COMMENT 'Business‑assigned code used to reference the fab in external systems.',
    ...
    `equipment_fab_description` STRING COMMENT 'Free‑form description of the fabs capabilities and purpose.',
    `environmental_certifications` STRING COMMENT 'Environmental compliance certifications (e.g., ISO 14001).',
    `fab_code` STRING COMMENT '',
    `fab_name` STRING COMMENT '',
    ...
    `equipment_fab_name` STRING COMMENT 'Human‑readable name of the fab.',
    ...
    `equipment_fab_status` STRING COMMENT 'Current operational status of the fab.',
    `equipment_fab_type` STRING COMMENT 'Classification of fab based on process focus.',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` (
    ...
    `supplier_id` BIGINT COMMENT 'P9: Add column supplier_id (BIGINT) to supply.maintenance_contract with FK to supply.supplier.supplier_id because maintenance contracts are with equipment suppliers. P9: connect_table: supply.maintenance_contract** - add column suppli',
    `vendor_supplier_id` BIGINT COMMENT 'Unique identifier of the equipment vendor providing the maintenance service.',
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ADD CONSTRAINT `fk_equipment_maintenance_plan_fab_tool_id` FOREIGN KEY (`fab_tool_id`) REFERENCES `vibe_semiconductors_v1`.`equipment`.`fab_tool`(`fab_tool_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fab_tool` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_chamber` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_qualification` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`pm_schedule` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`pm_schedule` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Created By User ID');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_event` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_event` ALTER COLUMN `ar_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Ar Invoice Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_downtime` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`calibration_record` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`calibration_record` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Technician Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_alarm` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_alarm` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_alarm` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Operator Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` SET TAGS ('dbx_ssot' = 'secondary');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Last Used By');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` ALTER COLUMN `fabrication_process_recipe_id` SET TAGS ('dbx_ssot_reference' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` ALTER COLUMN `fabrication_process_recipe_id` SET TAGS ('dbx_ssot_ref' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` ALTER COLUMN `recipe_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` ALTER COLUMN `recipe_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_process_recipe` ALTER COLUMN `recipe_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`recipe_execution` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`recipe_execution` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`recipe_execution` ALTER COLUMN `eccn_classification_id` SET TAGS ('dbx_business_glossary_term' = 'Eccn Classification Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`recipe_execution` ALTER COLUMN `invoice_line_id` SET TAGS ('dbx_business_glossary_term' = 'Invoice Line Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Operator Identifier');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` ALTER COLUMN `parameter_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` ALTER COLUMN `parameter_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spc_control` ALTER COLUMN `parameter_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`oee_record` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`oee_record` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spare_part` SET TAGS ('dbx_subdomain' = 'maintenance_operations');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`spare_part` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`metrology_run` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`metrology_run` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`metrology_run` ALTER COLUMN `tool_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`metrology_run` ALTER COLUMN `tool_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`metrology_run` ALTER COLUMN `tool_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` SET TAGS ('dbx_subdomain' = 'tool_assets');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` ALTER COLUMN `ar_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Ar Invoice Id (Foreign Key)');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` ALTER COLUMN `escalation_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` ALTER COLUMN `escalation_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` ALTER COLUMN `escalation_contact_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_warranty` ALTER COLUMN `escalation_contact_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_installation` SET TAGS ('dbx_subdomain' = 'tool_assets');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_installation` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_installation` ALTER COLUMN `installation_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_installation` ALTER COLUMN `installation_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_installation` ALTER COLUMN `installation_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` ALTER COLUMN `parameter_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` ALTER COLUMN `parameter_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` ALTER COLUMN `parameter_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` ALTER COLUMN `source_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` ALTER COLUMN `source_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`fdc_event` ALTER COLUMN `source_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_capex` SET TAGS ('dbx_subdomain' = 'tool_assets');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_capex` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` SET TAGS ('dbx_subdomain' = 'tool_assets');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` ALTER COLUMN `certification_name` SET TAGS ('dbx_business_glossary_term' = 'Certification Name');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` ALTER COLUMN `certification_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` ALTER COLUMN `certification_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` ALTER COLUMN `certification_name` SET TAGS ('dbx_pii_class' = 'person_name');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`tool_safety_cert` ALTER COLUMN `certification_number` SET TAGS ('dbx_business_glossary_term' = 'Certification Number (CERT NO)');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` SET TAGS ('dbx_subdomain' = 'process_control');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` SET TAGS ('dbx_domain_verified' = 'equipment');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `part_substance_composition_id` SET TAGS ('dbx_business_glossary_term' = 'Part Substance Composition - Part Substance Id');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `spare_part_id` SET TAGS ('dbx_business_glossary_term' = 'Part Substance Composition - Spare Part Id');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `substance_inventory_id` SET TAGS ('dbx_business_glossary_term' = 'Part Substance Composition - Substance Inventory Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `concentration` SET TAGS ('dbx_business_glossary_term' = 'Concentration Percentage');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `exceeds_threshold_flag` SET TAGS ('dbx_business_glossary_term' = 'Exceeds Threshold');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `is_restricted_flag` SET TAGS ('dbx_business_glossary_term' = 'Restricted Flag');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `is_svhc_flag` SET TAGS ('dbx_business_glossary_term' = 'SVHC Flag');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `material_category` SET TAGS ('dbx_business_glossary_term' = 'Material Category');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `measurement_method` SET TAGS ('dbx_business_glossary_term' = 'Measurement Method');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `part_weight_fraction` SET TAGS ('dbx_business_glossary_term' = 'Part Weight Fraction');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `regulation_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulation Reference');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `reporting_date` SET TAGS ('dbx_business_glossary_term' = 'Reporting Date');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `source_document` SET TAGS ('dbx_business_glossary_term' = 'Source Document');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `threshold_limit` SET TAGS ('dbx_business_glossary_term' = 'Threshold Limit');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`part_substance_composition` ALTER COLUMN `usage_volume_kg` SET TAGS ('dbx_business_glossary_term' = 'Annual Usage Volume');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` ALTER COLUMN `ip_address` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` ALTER COLUMN `mac_address` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` ALTER COLUMN `sensor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` ALTER COLUMN `sensor_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`sensor` ALTER COLUMN `sensor_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `fab_tool_id` SET TAGS ('dbx_business_glossary_term' = 'Fab Tool Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `updated_by` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `vendor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `vendor_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `vendor_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_plan` ALTER COLUMN `created_by` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` SET TAGS ('dbx_subdomain' = 'process_control');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` SET TAGS ('dbx_ssot' = 'secondary');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` SET TAGS ('dbx_domain_verified' = 'equipment');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` SET TAGS ('dbx_ssot_owner' = 'process.site_map');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` SET TAGS ('dbx_ssot_authoritative' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `equipment_site_map_id` SET TAGS ('dbx_ssot_reference' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `equipment_site_map_description` SET TAGS ('dbx_business_glossary_term' = 'Description');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `manager_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `manager_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `manager_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `manager_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `manager_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `site_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `site_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `site_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_site_map` ALTER COLUMN `equipment_site_map_status` SET TAGS ('dbx_business_glossary_term' = 'Status');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` SET TAGS ('dbx_subdomain' = 'tool_assets');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_code` SET TAGS ('dbx_business_glossary_term' = 'Code');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_description` SET TAGS ('dbx_business_glossary_term' = 'Description');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `manager_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `manager_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `manager_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `manager_name` SET TAGS ('dbx_pii_class' = 'person_name');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_name` SET TAGS ('dbx_business_glossary_term' = 'Name');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_name` SET TAGS ('dbx_pii_class' = 'person_name');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `primary_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `primary_contact_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `primary_contact_name` SET TAGS ('dbx_pii_class' = 'person_name');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `primary_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `primary_contact_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `primary_contact_phone` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_status` SET TAGS ('dbx_business_glossary_term' = 'Status');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`equipment_fab` ALTER COLUMN `equipment_fab_type` SET TAGS ('dbx_business_glossary_term' = 'Type');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` SET TAGS ('dbx_domain_verified' = 'equipment');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` ALTER COLUMN `vendor_supplier_id` SET TAGS ('dbx_business_glossary_term' = 'Vendor Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` ALTER COLUMN `vendor_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` ALTER COLUMN `vendor_name` SET TAGS ('dbx_mask_nonprod' = 'true');
ALTER TABLE `vibe_semiconductors_v1`.`equipment`.`maintenance_contract` ALTER COLUMN `vendor_name` SET TAGS ('dbx_pii_class' = 'person_name');
