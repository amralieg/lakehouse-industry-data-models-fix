...
-- ========= TABLES =========
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`kpi_value` (
    ...
    `data_source` STRING COMMENT 'The originating system or data source from which this KPI value was calculated or ingested (e.g., the retail analytics platform, Oracle Retail, Blue Yonder, manual entry).',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`report_definition` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` (
    ...
    `dashboard_created_by_user_associate_id` BIGINT COMMENT 'Identifier of the user who created this widget.',
    `dashboard_modified_by_user_associate_id` BIGINT COMMENT 'Identifier of the user who last modified this widget.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` (
    ...
    `primary_replacement_metric_dimension_id` BIGINT COMMENT 'Reference to the metric_dimension_id of the dimension that replaces this deprecated dimension. Null if no replacement exists. Supports migration planning and backward compatibility mapping.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`dq_rule` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`dq_result` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`dq_issue` (
    ...
    `parent_dq_issue_id` BIGINT COMMENT 'Self-referencing FK on dq_issue (related_dq_issue_id)',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` (
    ...
    `primary_replacement_semantic_layer_entity_id` BIGINT COMMENT 'Foreign key reference to the semantic layer entity that replaces this deprecated entity. Null for active entities or deprecated entities without a direct replacement.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`report_subscription` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`access_policy` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` (
    ...
    `data_source` STRING COMMENT 'Source system or data feed that provided this hierarchy node record (e.g., the customer master data system, SAP S/4HANA FI/CO, Oracle Retail Merchandising System). Used for data lineage and reconciliation.',
    ...
    `external_system_name` STRING COMMENT 'Name of the source operational system that owns this hierarchy node (e.g., SAP S/4HANA, Oracle Retail Merchandising System, the customer master data system). Used for data lineage and troubleshooting.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` (
...
) COMMENT '[SSOT Owner] Authoritative source for KPI targets across the enterprise. Defines target values, thresholds, and measurement parameters for all business KPIs regardless of domain.';

CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`alert` (
    ...
    `data_source` STRING COMMENT 'Source system or data product that provided the KPI measurement triggering this alert (e.g., the retail analytics platform, Oracle Retail, Blue Yonder).',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`self_service_query` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`glossary_term` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`report_composition` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` (
...
-- ========= FOREIGN KEYS =========
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ADD CONSTRAINT `fk_analytics_kpi_definition_parent_kpi_definition_id` FOREIGN KEY (`parent_kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ADD CONSTRAINT `fk_analytics_kpi_value_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ADD CONSTRAINT `fk_analytics_kpi_value_prior_period_kpi_value_id` FOREIGN KEY (`prior_period_kpi_value_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_value`(`kpi_value_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ADD CONSTRAINT `fk_analytics_kpi_value_reporting_hierarchy_id` FOREIGN KEY (`reporting_hierarchy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`reporting_hierarchy`(`reporting_hierarchy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ADD CONSTRAINT `fk_analytics_kpi_value_retail_calendar_id` FOREIGN KEY (`retail_calendar_id`) REFERENCES `vibe_retail_v1`.`analytics`.`retail_calendar`(`retail_calendar_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ADD CONSTRAINT `fk_analytics_kpi_value_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ADD CONSTRAINT `fk_analytics_report_definition_parent_report_definition_id` FOREIGN KEY (`parent_report_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_definition`(`report_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ADD CONSTRAINT `fk_analytics_report_definition_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ADD CONSTRAINT `fk_analytics_report_definition_semantic_metric_id` FOREIGN KEY (`semantic_metric_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_metric`(`semantic_metric_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ADD CONSTRAINT `fk_analytics_dashboard_config_access_policy_id` FOREIGN KEY (`access_policy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`access_policy`(`access_policy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ADD CONSTRAINT `fk_analytics_dashboard_config_cloned_from_dashboard_config_id` FOREIGN KEY (`cloned_from_dashboard_config_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dashboard_config`(`dashboard_config_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ADD CONSTRAINT `fk_analytics_dashboard_widget_dashboard_config_id` FOREIGN KEY (`dashboard_config_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dashboard_config`(`dashboard_config_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ADD CONSTRAINT `fk_analytics_dashboard_widget_dq_rule_id` FOREIGN KEY (`dq_rule_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_rule`(`dq_rule_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ADD CONSTRAINT `fk_analytics_dashboard_widget_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ADD CONSTRAINT `fk_analytics_dashboard_widget_parent_dashboard_widget_id` FOREIGN KEY (`parent_dashboard_widget_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dashboard_widget`(`dashboard_widget_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ADD CONSTRAINT `fk_analytics_dashboard_widget_report_definition_id` FOREIGN KEY (`report_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_definition`(`report_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ADD CONSTRAINT `fk_analytics_dashboard_widget_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ADD CONSTRAINT `fk_analytics_metric_dimension_parent_metric_dimension_id` FOREIGN KEY (`parent_metric_dimension_id`) REFERENCES `vibe_retail_v1`.`analytics`.`metric_dimension`(`metric_dimension_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ADD CONSTRAINT `fk_analytics_metric_dimension_primary_replacement_metric_dimension_id` FOREIGN KEY (`primary_replacement_metric_dimension_id`) REFERENCES `vibe_retail_v1`.`analytics`.`metric_dimension`(`metric_dimension_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ADD CONSTRAINT `fk_analytics_dq_rule_parent_dq_rule_id` FOREIGN KEY (`parent_dq_rule_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_rule`(`dq_rule_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ADD CONSTRAINT `fk_analytics_dq_rule_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ADD CONSTRAINT `fk_analytics_dq_result_dq_rule_id` FOREIGN KEY (`dq_rule_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_rule`(`dq_rule_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ADD CONSTRAINT `fk_analytics_dq_result_previous_dq_result_id` FOREIGN KEY (`previous_dq_result_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_result`(`dq_result_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ADD CONSTRAINT `fk_analytics_dq_result_retail_calendar_id` FOREIGN KEY (`retail_calendar_id`) REFERENCES `vibe_retail_v1`.`analytics`.`retail_calendar`(`retail_calendar_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ADD CONSTRAINT `fk_analytics_dq_result_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ADD CONSTRAINT `fk_analytics_dq_issue_dq_result_id` FOREIGN KEY (`dq_result_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_result`(`dq_result_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ADD CONSTRAINT `fk_analytics_dq_issue_dq_rule_id` FOREIGN KEY (`dq_rule_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_rule`(`dq_rule_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ADD CONSTRAINT `fk_analytics_dq_issue_parent_dq_issue_id` FOREIGN KEY (`parent_dq_issue_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_issue`(`dq_issue_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ADD CONSTRAINT `fk_analytics_semantic_layer_entity_parent_semantic_layer_entity_id` FOREIGN KEY (`parent_semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ADD CONSTRAINT `fk_analytics_semantic_layer_entity_primary_replacement_semantic_layer_entity_id` FOREIGN KEY (`primary_replacement_semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ADD CONSTRAINT `fk_analytics_semantic_metric_derived_from_semantic_metric_id` FOREIGN KEY (`derived_from_semantic_metric_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_metric`(`semantic_metric_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ADD CONSTRAINT `fk_analytics_semantic_metric_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ADD CONSTRAINT `fk_analytics_report_subscription_access_policy_id` FOREIGN KEY (`access_policy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`access_policy`(`access_policy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ADD CONSTRAINT `fk_analytics_report_subscription_dashboard_config_id` FOREIGN KEY (`dashboard_config_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dashboard_config`(`dashboard_config_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ADD CONSTRAINT `fk_analytics_report_subscription_report_definition_id` FOREIGN KEY (`report_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_definition`(`report_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ADD CONSTRAINT `fk_analytics_report_subscription_superseded_report_subscription_id` FOREIGN KEY (`superseded_report_subscription_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_subscription`(`report_subscription_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ADD CONSTRAINT `fk_analytics_access_policy_parent_access_policy_id` FOREIGN KEY (`parent_access_policy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`access_policy`(`access_policy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ADD CONSTRAINT `fk_analytics_retail_calendar_prior_year_retail_calendar_id` FOREIGN KEY (`prior_year_retail_calendar_id`) REFERENCES `vibe_retail_v1`.`analytics`.`retail_calendar`(`retail_calendar_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ADD CONSTRAINT `fk_analytics_reporting_hierarchy_parent_reporting_hierarchy_id` FOREIGN KEY (`parent_reporting_hierarchy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`reporting_hierarchy`(`reporting_hierarchy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ADD CONSTRAINT `fk_analytics_analytics_kpi_target_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ADD CONSTRAINT `fk_analytics_analytics_kpi_target_reporting_hierarchy_id` FOREIGN KEY (`reporting_hierarchy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`reporting_hierarchy`(`reporting_hierarchy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ADD CONSTRAINT `fk_analytics_analytics_kpi_target_retail_calendar_id` FOREIGN KEY (`retail_calendar_id`) REFERENCES `vibe_retail_v1`.`analytics`.`retail_calendar`(`retail_calendar_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ADD CONSTRAINT `fk_analytics_analytics_kpi_target_revised_analytics_kpi_target_id` FOREIGN KEY (`revised_analytics_kpi_target_id`) REFERENCES `vibe_retail_v1`.`analytics`.`analytics_kpi_target`(`analytics_kpi_target_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ADD CONSTRAINT `fk_analytics_analytics_kpi_target_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_access_policy_id` FOREIGN KEY (`access_policy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`access_policy`(`access_policy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_dq_result_id` FOREIGN KEY (`dq_result_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dq_result`(`dq_result_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_escalated_from_alert_id` FOREIGN KEY (`escalated_from_alert_id`) REFERENCES `vibe_retail_v1`.`analytics`.`alert`(`alert_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_reporting_hierarchy_id` FOREIGN KEY (`reporting_hierarchy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`reporting_hierarchy`(`reporting_hierarchy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_retail_calendar_id` FOREIGN KEY (`retail_calendar_id`) REFERENCES `vibe_retail_v1`.`analytics`.`retail_calendar`(`retail_calendar_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ADD CONSTRAINT `fk_analytics_alert_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_access_policy_id` FOREIGN KEY (`access_policy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`access_policy`(`access_policy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_dashboard_config_id` FOREIGN KEY (`dashboard_config_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dashboard_config`(`dashboard_config_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_forked_from_self_service_query_id` FOREIGN KEY (`forked_from_self_service_query_id`) REFERENCES `vibe_retail_v1`.`analytics`.`self_service_query`(`self_service_query_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_report_definition_id` FOREIGN KEY (`report_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_definition`(`report_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_semantic_metric_id` FOREIGN KEY (`semantic_metric_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_metric`(`semantic_metric_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ADD CONSTRAINT `fk_analytics_self_service_query_workspace_id` FOREIGN KEY (`workspace_id`) REFERENCES `vibe_retail_v1`.`analytics`.`workspace`(`workspace_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_dashboard_config_id` FOREIGN KEY (`dashboard_config_id`) REFERENCES `vibe_retail_v1`.`analytics`.`dashboard_config`(`dashboard_config_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_metric_dimension_id` FOREIGN KEY (`metric_dimension_id`) REFERENCES `vibe_retail_v1`.`analytics`.`metric_dimension`(`metric_dimension_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_parent_glossary_term_id` FOREIGN KEY (`parent_glossary_term_id`) REFERENCES `vibe_retail_v1`.`analytics`.`glossary_term`(`glossary_term_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_report_definition_id` FOREIGN KEY (`report_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_definition`(`report_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ADD CONSTRAINT `fk_analytics_glossary_term_semantic_metric_id` FOREIGN KEY (`semantic_metric_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_metric`(`semantic_metric_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ADD CONSTRAINT `fk_analytics_kpi_dimensionality_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ADD CONSTRAINT `fk_analytics_kpi_dimensionality_metric_dimension_id` FOREIGN KEY (`metric_dimension_id`) REFERENCES `vibe_retail_v1`.`analytics`.`metric_dimension`(`metric_dimension_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ADD CONSTRAINT `fk_analytics_report_composition_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ADD CONSTRAINT `fk_analytics_report_composition_report_definition_id` FOREIGN KEY (`report_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`report_definition`(`report_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ADD CONSTRAINT `fk_analytics_metric_entity_dependency_semantic_layer_entity_id` FOREIGN KEY (`semantic_layer_entity_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_layer_entity`(`semantic_layer_entity_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ADD CONSTRAINT `fk_analytics_metric_entity_dependency_semantic_metric_id` FOREIGN KEY (`semantic_metric_id`) REFERENCES `vibe_retail_v1`.`analytics`.`semantic_metric`(`semantic_metric_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ADD CONSTRAINT `fk_analytics_sla_kpi_measurement_kpi_definition_id` FOREIGN KEY (`kpi_definition_id`) REFERENCES `vibe_retail_v1`.`analytics`.`kpi_definition`(`kpi_definition_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ADD CONSTRAINT `fk_analytics_workspace_access_policy_id` FOREIGN KEY (`access_policy_id`) REFERENCES `vibe_retail_v1`.`analytics`.`access_policy`(`access_policy_id`);
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ADD CONSTRAINT `fk_analytics_workspace_parent_workspace_id` FOREIGN KEY (`parent_workspace_id`) REFERENCES `vibe_retail_v1`.`analytics`.`workspace`(`workspace_id`);

-- ========= TAGS =========
ALTER SCHEMA `vibe_retail_v1`.`analytics` SET TAGS ('dbx_division' = 'corporate');
ALTER SCHEMA `vibe_retail_v1`.`analytics` SET TAGS ('dbx_domain' = 'analytics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Definition ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `compliance_program_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Program Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `parent_kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Kpi Definition Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `parent_kpi_definition_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `aggregation_method` SET TAGS ('dbx_business_glossary_term' = 'Aggregation Method');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `benchmark_source` SET TAGS ('dbx_business_glossary_term' = 'Benchmark Source');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `benchmark_value` SET TAGS ('dbx_business_glossary_term' = 'Benchmark Value');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `calculation_formula` SET TAGS ('dbx_business_glossary_term' = 'Calculation Formula');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `change_log` SET TAGS ('dbx_business_glossary_term' = 'Change Log');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `dashboard_usage_count` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Usage Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `data_lineage_description` SET TAGS ('dbx_business_glossary_term' = 'Data Lineage Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `data_quality_rule` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Rule');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `data_source_domain` SET TAGS ('dbx_business_glossary_term' = 'Data Source Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `data_type` SET TAGS ('dbx_business_glossary_term' = 'Data Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `data_type` SET TAGS ('dbx_value_regex' = 'decimal|integer|percentage|boolean');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `is_lagging_indicator` SET TAGS ('dbx_business_glossary_term' = 'Is Lagging Indicator');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `is_leading_indicator` SET TAGS ('dbx_business_glossary_term' = 'Is Leading Indicator');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `is_published_externally` SET TAGS ('dbx_business_glossary_term' = 'Is Published Externally');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `kpi_code` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `kpi_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `kpi_description` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `kpi_name` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `kpi_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By User');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `maximum_acceptable_value` SET TAGS ('dbx_business_glossary_term' = 'Maximum Acceptable Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `minimum_acceptable_value` SET TAGS ('dbx_business_glossary_term' = 'Minimum Acceptable Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `owning_business_function` SET TAGS ('dbx_business_glossary_term' = 'Owning Business Function');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `regulatory_requirement` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Requirement');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `reporting_frequency` SET TAGS ('dbx_business_glossary_term' = 'Reporting Frequency');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `steward_email` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `steward_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `target_threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Target Threshold Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `time_grain` SET TAGS ('dbx_business_glossary_term' = 'Time Grain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `trend_direction` SET TAGS ('dbx_business_glossary_term' = 'Trend Direction');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_definition` ALTER COLUMN `version_number` SET TAGS ('dbx_value_regex' = '^[0-9]+.[0-9]+$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `kpi_value_id` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Value ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `adjustment_id` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `engagement_campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Engagement Campaign Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Fulfillment Node Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `fulfillment_order_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Order Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `gl_account_id` SET TAGS ('dbx_business_glossary_term' = 'Gl Account Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `item_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Item Hierarchy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Definition ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `liquidation_batch_id` SET TAGS ('dbx_business_glossary_term' = 'Liquidation Batch Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Location Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `prior_period_kpi_value_id` SET TAGS ('dbx_business_glossary_term' = 'Prior Period Kpi Value Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `reporting_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Reporting Hierarchy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `retail_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Retail Calendar Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Business Entity ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `sku_id` SET TAGS ('dbx_business_glossary_term' = 'Sku Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `stock_ledger_id` SET TAGS ('dbx_business_glossary_term' = 'Stock Ledger Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `stock_position_id` SET TAGS ('dbx_business_glossary_term' = 'Stock Position Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `purchase_order_id` SET TAGS ('dbx_business_glossary_term' = 'Supply Purchase Order Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `actual_value` SET TAGS ('dbx_business_glossary_term' = 'Actual Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `alert_severity` SET TAGS ('dbx_business_glossary_term' = 'Alert Severity');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `alert_severity` SET TAGS ('dbx_value_regex' = 'info|warning|critical|none');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `alert_triggered_flag` SET TAGS ('dbx_business_glossary_term' = 'Alert Triggered Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'draft|pending_review|approved|rejected');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approved Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `business_entity_type` SET TAGS ('dbx_business_glossary_term' = 'Business Entity Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `calculation_method` SET TAGS ('dbx_business_glossary_term' = 'Calculation Method');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `calculation_method` SET TAGS ('dbx_value_regex' = 'computed|ingested|manual|aggregated');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `calculation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Calculation Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `confidence_interval_lower` SET TAGS ('dbx_business_glossary_term' = 'Confidence Interval Lower Bound');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `confidence_interval_upper` SET TAGS ('dbx_business_glossary_term' = 'Confidence Interval Upper Bound');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `data_freshness_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Data Freshness Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `data_source` SET TAGS ('dbx_business_glossary_term' = 'Data Source');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `forecast_model_version` SET TAGS ('dbx_business_glossary_term' = 'Forecast Model Version');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `is_forecast` SET TAGS ('dbx_business_glossary_term' = 'Is Forecast Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `measurement_period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Measurement Period End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `measurement_period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Measurement Period Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `performance_status` SET TAGS ('dbx_business_glossary_term' = 'Performance Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `performance_status` SET TAGS ('dbx_value_regex' = 'exceeds_target|meets_target|below_target|critical|not_applicable');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `period_type` SET TAGS ('dbx_business_glossary_term' = 'Period Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `period_type` SET TAGS ('dbx_value_regex' = 'daily|weekly|monthly|quarterly|yearly|custom');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `prior_period_value` SET TAGS ('dbx_business_glossary_term' = 'Prior Period Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `prior_period_variance_amount` SET TAGS ('dbx_business_glossary_term' = 'Prior Period Variance Amount');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `prior_period_variance_percentage` SET TAGS ('dbx_business_glossary_term' = 'Prior Period Variance Percentage');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `sample_size` SET TAGS ('dbx_business_glossary_term' = 'Sample Size');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `target_value` SET TAGS ('dbx_business_glossary_term' = 'Target Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `trend_direction` SET TAGS ('dbx_business_glossary_term' = 'Trend Direction');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `trend_direction` SET TAGS ('dbx_value_regex' = 'improving|stable|declining|volatile|insufficient_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_business_glossary_term' = 'Unit of Measure (UOM)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `variance_amount` SET TAGS ('dbx_business_glossary_term' = 'Variance Amount');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_value` ALTER COLUMN `variance_percentage` SET TAGS ('dbx_business_glossary_term' = 'Variance Percentage');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Report Definition ID');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `parent_report_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Report Definition Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `access_control_group` SET TAGS ('dbx_business_glossary_term' = 'Access Control Group');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `approval_date` SET TAGS ('dbx_business_glossary_term' = 'Approval Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Approval Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `average_execution_time_seconds` SET TAGS ('dbx_business_glossary_term' = 'Average Execution Time (Seconds)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `certification_date` SET TAGS ('dbx_business_glossary_term' = 'Certification Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `contains_financial_data` SET TAGS ('dbx_business_glossary_term' = 'Contains Financial Data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `contains_pii` SET TAGS ('dbx_business_glossary_term' = 'Contains Personally Identifiable Information (PII)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `data_domains_consumed` SET TAGS ('dbx_business_glossary_term' = 'Data Domains Consumed');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `data_retention_days` SET TAGS ('dbx_business_glossary_term' = 'Data Retention Days');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `delivery_format` SET TAGS ('dbx_business_glossary_term' = 'Delivery Format');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `deprecation_date` SET TAGS ('dbx_business_glossary_term' = 'Deprecation Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `dimension_count` SET TAGS ('dbx_business_glossary_term' = 'Dimension Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Documentation Uniform Resource Locator (URL)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `governance_classification` SET TAGS ('dbx_business_glossary_term' = 'Governance Classification');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `governance_classification` SET TAGS ('dbx_value_regex' = 'public|internal|confidential|restricted');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `is_certified` SET TAGS ('dbx_business_glossary_term' = 'Is Certified');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `owning_team` SET TAGS ('dbx_business_glossary_term' = 'Owning Team');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `publication_date` SET TAGS ('dbx_business_glossary_term' = 'Publication Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `refresh_cadence` SET TAGS ('dbx_business_glossary_term' = 'Refresh Cadence');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `regulatory_scope` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Scope');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_category` SET TAGS ('dbx_business_glossary_term' = 'Report Category');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_code` SET TAGS ('dbx_business_glossary_term' = 'Report Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_description` SET TAGS ('dbx_business_glossary_term' = 'Report Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_name` SET TAGS ('dbx_business_glossary_term' = 'Report Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_owner_email` SET TAGS ('dbx_business_glossary_term' = 'Report Owner Email');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_owner_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_status` SET TAGS ('dbx_business_glossary_term' = 'Report Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `report_type` SET TAGS ('dbx_business_glossary_term' = 'Report Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `retirement_date` SET TAGS ('dbx_business_glossary_term' = 'Retirement Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `source_data_products` SET TAGS ('dbx_business_glossary_term' = 'Source Data Products');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `tags` SET TAGS ('dbx_business_glossary_term' = 'Report Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `target_audience` SET TAGS ('dbx_business_glossary_term' = 'Target Audience');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_definition` ALTER COLUMN `version_number` SET TAGS ('dbx_value_regex' = '^[0-9]+.[0-9]+.[0-9]+$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `cloned_from_dashboard_config_id` SET TAGS ('dbx_business_glossary_term' = 'Cloned From Dashboard Config Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `access_tier` SET TAGS ('dbx_business_glossary_term' = 'Access Tier');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `certification_date` SET TAGS ('dbx_business_glossary_term' = 'Certification Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `certification_status` SET TAGS ('dbx_business_glossary_term' = 'Certification Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `compliance_tags` SET TAGS ('dbx_business_glossary_term' = 'Compliance Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_code` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_description` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_name` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_email` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Owner Email');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_name` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Owner Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_name` SET TAGS ('dbx_mask_in_nonprod' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_owner_name` SET TAGS ('dbx_mask_non_prod' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `dashboard_type` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `data_source_references` SET TAGS ('dbx_business_glossary_term' = 'Data Source References');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `filter_defaults` SET TAGS ('dbx_business_glossary_term' = 'Filter Defaults');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `last_accessed_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Accessed Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `layout_configuration` SET TAGS ('dbx_business_glossary_term' = 'Layout Configuration');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `owning_business_unit` SET TAGS ('dbx_business_glossary_term' = 'Owning Business Unit');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `publication_status` SET TAGS ('dbx_business_glossary_term' = 'Publication Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `published_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Published Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `refresh_schedule` SET TAGS ('dbx_business_glossary_term' = 'Refresh Schedule');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `refresh_time` SET TAGS ('dbx_business_glossary_term' = 'Refresh Time');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `target_persona` SET TAGS ('dbx_business_glossary_term' = 'Target Persona');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `technical_contact_email` SET TAGS ('dbx_business_glossary_term' = 'Technical Contact Email');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `technical_contact_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `technical_contact_name` SET TAGS ('dbx_business_glossary_term' = 'Technical Contact Name');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `technical_contact_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `usage_count` SET TAGS ('dbx_business_glossary_term' = 'Usage Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_config` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `dashboard_widget_id` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Widget ID');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `parent_dashboard_widget_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Dashboard Widget Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `report_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Report Definition ID');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `business_domain` SET TAGS ('dbx_business_glossary_term' = 'Business Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `conditional_formatting_rules` SET TAGS ('dbx_business_glossary_term' = 'Conditional Formatting Rules');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `data_query_reference` SET TAGS ('dbx_business_glossary_term' = 'Data Query Reference');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `dashboard_widget_description` SET TAGS ('dbx_business_glossary_term' = 'Widget Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `display_order` SET TAGS ('dbx_business_glossary_term' = 'Display Order');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `drill_through_enabled` SET TAGS ('dbx_business_glossary_term' = 'Drill-Through Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `drill_through_target` SET TAGS ('dbx_business_glossary_term' = 'Drill-Through Target');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `export_enabled` SET TAGS ('dbx_business_glossary_term' = 'Export Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `export_formats` SET TAGS ('dbx_business_glossary_term' = 'Export Formats');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `filter_configuration` SET TAGS ('dbx_business_glossary_term' = 'Filter Configuration');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `filter_enabled` SET TAGS ('dbx_business_glossary_term' = 'Filter Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `height` SET TAGS ('dbx_business_glossary_term' = 'Widget Height');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `last_refresh_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Refresh Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `position_x` SET TAGS ('dbx_business_glossary_term' = 'Position X Coordinate');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `position_y` SET TAGS ('dbx_business_glossary_term' = 'Position Y Coordinate');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `refresh_behavior` SET TAGS ('dbx_business_glossary_term' = 'Refresh Behavior');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `refresh_behavior` SET TAGS ('dbx_value_regex' = 'manual|auto|on_load|scheduled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `refresh_interval_seconds` SET TAGS ('dbx_business_glossary_term' = 'Refresh Interval Seconds');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `tags` SET TAGS ('dbx_business_glossary_term' = 'Widget Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `tooltip_text` SET TAGS ('dbx_business_glossary_term' = 'Tooltip Text');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `usage_count` SET TAGS ('dbx_business_glossary_term' = 'Usage Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `visibility_scope` SET TAGS ('dbx_business_glossary_term' = 'Visibility Scope');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `visibility_scope` SET TAGS ('dbx_value_regex' = 'public|private|role_based|user_specific');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `visualization_type` SET TAGS ('dbx_business_glossary_term' = 'Visualization Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `widget_name` SET TAGS ('dbx_business_glossary_term' = 'Widget Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `widget_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `widget_title` SET TAGS ('dbx_business_glossary_term' = 'Widget Title');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `widget_type` SET TAGS ('dbx_business_glossary_term' = 'Widget Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `widget_type` SET TAGS ('dbx_value_regex' = 'chart|table|scorecard|map|sparkline|gauge');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dashboard_widget` ALTER COLUMN `width` SET TAGS ('dbx_business_glossary_term' = 'Widget Width');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` SET TAGS ('dbx_subdomain' = 'performance_metrics');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `parent_metric_dimension_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Metric Dimension Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `associated_domain` SET TAGS ('dbx_business_glossary_term' = 'Associated Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `business_owner` SET TAGS ('dbx_business_glossary_term' = 'Business Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `business_rules` SET TAGS ('dbx_business_glossary_term' = 'Business Rules');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `cardinality_estimate` SET TAGS ('dbx_business_glossary_term' = 'Cardinality Estimate');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `cardinality_estimate` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `compliance_tags` SET TAGS ('dbx_business_glossary_term' = 'Compliance Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `data_quality_rules` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Rules');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `default_sort_order` SET TAGS ('dbx_business_glossary_term' = 'Default Sort Order');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `deprecated_flag` SET TAGS ('dbx_business_glossary_term' = 'Deprecated Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `deprecation_date` SET TAGS ('dbx_business_glossary_term' = 'Deprecation Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `dimension_code` SET TAGS ('dbx_business_glossary_term' = 'Dimension Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `dimension_description` SET TAGS ('dbx_business_glossary_term' = 'Dimension Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `dimension_name` SET TAGS ('dbx_business_glossary_term' = 'Dimension Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `dimension_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `dimension_type` SET TAGS ('dbx_business_glossary_term' = 'Dimension Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `display_format` SET TAGS ('dbx_business_glossary_term' = 'Display Format');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `drill_enabled` SET TAGS ('dbx_business_glossary_term' = 'Drill Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `filter_enabled` SET TAGS ('dbx_business_glossary_term' = 'Filter Enabled Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `grain_description` SET TAGS ('dbx_business_glossary_term' = 'Grain Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `hierarchy_levels` SET TAGS ('dbx_business_glossary_term' = 'Hierarchy Levels');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `is_conformed` SET TAGS ('dbx_business_glossary_term' = 'Is Conformed Dimension Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `is_slowly_changing` SET TAGS ('dbx_business_glossary_term' = 'Is Slowly Changing Dimension (SCD) Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_business_glossary_term' = 'Refresh Frequency');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_value_regex' = 'real_time|hourly|daily|weekly|monthly|on_demand');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `security_classification` SET TAGS ('dbx_business_glossary_term' = 'Security Classification');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `technical_owner` SET TAGS ('dbx_business_glossary_term' = 'Technical Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `usage_count` SET TAGS ('dbx_business_glossary_term' = 'Usage Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_dimension` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` SET TAGS ('dbx_subdomain' = 'data_governance');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `parent_dq_rule_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Dq Rule Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approved Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `blocking_flag` SET TAGS ('dbx_business_glossary_term' = 'Blocking Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `business_justification` SET TAGS ('dbx_business_glossary_term' = 'Business Justification');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Documentation URL');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `effective_from_date` SET TAGS ('dbx_business_glossary_term' = 'Effective From Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `effective_to_date` SET TAGS ('dbx_business_glossary_term' = 'Effective To Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `execution_frequency` SET TAGS ('dbx_business_glossary_term' = 'Execution Frequency');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `execution_layer` SET TAGS ('dbx_business_glossary_term' = 'Execution Layer');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `execution_layer` SET TAGS ('dbx_value_regex' = 'bronze|silver|gold');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `last_execution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Execution Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `last_violation_count` SET TAGS ('dbx_business_glossary_term' = 'Last Violation Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `modified_by` SET TAGS ('dbx_business_glossary_term' = 'Modified By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `notification_enabled` SET TAGS ('dbx_business_glossary_term' = 'Notification Enabled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `notification_recipients` SET TAGS ('dbx_business_glossary_term' = 'Notification Recipients');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `quarantine_enabled` SET TAGS ('dbx_business_glossary_term' = 'Quarantine Enabled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `regulatory_reference` SET TAGS ('dbx_business_glossary_term' = 'Regulatory Reference');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `remediation_action` SET TAGS ('dbx_business_glossary_term' = 'Remediation Action');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `remediation_owner` SET TAGS ('dbx_business_glossary_term' = 'Remediation Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_code` SET TAGS ('dbx_business_glossary_term' = 'Rule Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_description` SET TAGS ('dbx_business_glossary_term' = 'Rule Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_logic` SET TAGS ('dbx_business_glossary_term' = 'Rule Logic');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_business_glossary_term' = 'Rule Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_priority` SET TAGS ('dbx_business_glossary_term' = 'Rule Priority');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_status` SET TAGS ('dbx_business_glossary_term' = 'Rule Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_tags` SET TAGS ('dbx_business_glossary_term' = 'Rule Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_type` SET TAGS ('dbx_business_glossary_term' = 'Rule Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_type` SET TAGS ('dbx_value_regex' = 'completeness|uniqueness|validity|consistency|timeliness|referential_integrity');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `rule_version` SET TAGS ('dbx_business_glossary_term' = 'Rule Version');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `severity_level` SET TAGS ('dbx_business_glossary_term' = 'Severity Level');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `severity_level` SET TAGS ('dbx_value_regex' = 'critical|major|minor|warning');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `target_attribute` SET TAGS ('dbx_business_glossary_term' = 'Target Attribute');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `target_domain` SET TAGS ('dbx_business_glossary_term' = 'Target Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `target_product` SET TAGS ('dbx_business_glossary_term' = 'Target Product');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `threshold_operator` SET TAGS ('dbx_business_glossary_term' = 'Threshold Operator');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `threshold_unit` SET TAGS ('dbx_business_glossary_term' = 'Threshold Unit');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `threshold_unit` SET TAGS ('dbx_value_regex' = 'percentage|count|ratio');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Threshold Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_rule` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` SET TAGS ('dbx_subdomain' = 'data_governance');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `financial_period_id` SET TAGS ('dbx_business_glossary_term' = 'Financial Period Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `previous_dq_result_id` SET TAGS ('dbx_business_glossary_term' = 'Previous Dq Result Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Target Semantic Layer Entity Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `sku_id` SET TAGS ('dbx_business_glossary_term' = 'Target Sku Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `batch_code` SET TAGS ('dbx_business_glossary_term' = 'Data Quality (DQ) Batch ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `data_snapshot_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Data Snapshot Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `data_trust_score` SET TAGS ('dbx_business_glossary_term' = 'Data Trust Score');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `execution_duration_seconds` SET TAGS ('dbx_business_glossary_term' = 'Execution Duration in Seconds');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `execution_error_message` SET TAGS ('dbx_business_glossary_term' = 'Execution Error Message');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `execution_status` SET TAGS ('dbx_business_glossary_term' = 'Execution Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `execution_status` SET TAGS ('dbx_value_regex' = 'completed|failed|timeout|cancelled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `execution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Rule Execution Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `failure_rate_percent` SET TAGS ('dbx_business_glossary_term' = 'Failure Rate Percentage');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `failure_reason` SET TAGS ('dbx_business_glossary_term' = 'Failure Reason');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Notification Sent Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `pass_fail_status` SET TAGS ('dbx_business_glossary_term' = 'Pass/Fail Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `pass_fail_status` SET TAGS ('dbx_value_regex' = 'pass|fail|warning|error');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `previous_failure_rate_percent` SET TAGS ('dbx_business_glossary_term' = 'Previous Failure Rate Percentage');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `records_evaluated_count` SET TAGS ('dbx_business_glossary_term' = 'Records Evaluated Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `records_failed_count` SET TAGS ('dbx_business_glossary_term' = 'Records Failed Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `records_passed_count` SET TAGS ('dbx_business_glossary_term' = 'Records Passed Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `remediation_action` SET TAGS ('dbx_business_glossary_term' = 'Remediation Action Taken');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `remediation_action` SET TAGS ('dbx_value_regex' = 'none|alert_sent|ticket_created|auto_corrected|quarantined|rejected');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `remediation_owner` SET TAGS ('dbx_business_glossary_term' = 'Remediation Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `rule_name` SET TAGS ('dbx_business_glossary_term' = 'Data Quality (DQ) Rule Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `rule_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `rule_type` SET TAGS ('dbx_business_glossary_term' = 'Data Quality (DQ) Rule Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `rule_type` SET TAGS ('dbx_value_regex' = 'completeness|accuracy|consistency|validity|uniqueness|timeliness');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `sample_failed_keys` SET TAGS ('dbx_business_glossary_term' = 'Sample Failed Record Keys');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `schedule_type` SET TAGS ('dbx_business_glossary_term' = 'Schedule Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `schedule_type` SET TAGS ('dbx_value_regex' = 'scheduled|on_demand|event_triggered|continuous');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `severity_level` SET TAGS ('dbx_business_glossary_term' = 'Data Quality (DQ) Severity Level');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `severity_level` SET TAGS ('dbx_value_regex' = 'critical|high|medium|low');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `sla_compliance_flag` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Compliance Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `target_attribute` SET TAGS ('dbx_business_glossary_term' = 'Target Attribute');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `target_domain` SET TAGS ('dbx_business_glossary_term' = 'Target Data Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `target_product` SET TAGS ('dbx_business_glossary_term' = 'Target Data Product');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Quality Threshold Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_result` ALTER COLUMN `trend_direction` SET TAGS ('dbx_business_glossary_term' = 'Quality Trend Direction');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` SET TAGS ('dbx_subdomain' = 'data_governance');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `parent_dq_issue_id` SET TAGS ('dbx_business_glossary_term' = 'Related Dq Issue Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `stock_position_id` SET TAGS ('dbx_business_glossary_term' = 'Stock Position Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `purchase_order_id` SET TAGS ('dbx_business_glossary_term' = 'Supply Purchase Order Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `affected_attribute` SET TAGS ('dbx_business_glossary_term' = 'Affected Attribute Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `affected_record_count` SET TAGS ('dbx_business_glossary_term' = 'Affected Record Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `assigned_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Assignment Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `assigned_to` SET TAGS ('dbx_business_glossary_term' = 'Assigned To User');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `business_impact` SET TAGS ('dbx_business_glossary_term' = 'Business Impact Assessment');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `closed_by` SET TAGS ('dbx_business_glossary_term' = 'Closed By User');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `closed_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Closure Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `compliance_framework` SET TAGS ('dbx_business_glossary_term' = 'Compliance Framework');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `compliance_impact_flag` SET TAGS ('dbx_business_glossary_term' = 'Compliance Impact Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `data_lineage_path` SET TAGS ('dbx_business_glossary_term' = 'Data Lineage Path');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `data_product` SET TAGS ('dbx_business_glossary_term' = 'Data Product Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `dq_issue_description` SET TAGS ('dbx_business_glossary_term' = 'Issue Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `detected_by` SET TAGS ('dbx_business_glossary_term' = 'Detected By User');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `detected_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Detection Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `detection_method` SET TAGS ('dbx_business_glossary_term' = 'Detection Method');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `detection_method` SET TAGS ('dbx_value_regex' = 'automated_rule|manual_review|user_report|reconciliation|audit|monitoring_alert');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `domain` SET TAGS ('dbx_business_glossary_term' = 'Data Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `dq_issue_status` SET TAGS ('dbx_business_glossary_term' = 'Issue Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `dq_issue_status` SET TAGS ('dbx_value_regex' = 'open|in_progress|resolved|closed|accepted|rejected');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `issue_number` SET TAGS ('dbx_business_glossary_term' = 'Data Quality (DQ) Issue Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `issue_number` SET TAGS ('dbx_value_regex' = '^DQ-[0-9]{6,10}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `issue_type` SET TAGS ('dbx_business_glossary_term' = 'Data Quality (DQ) Issue Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `issue_type` SET TAGS ('dbx_value_regex' = 'completeness|accuracy|consistency|validity|timeliness|uniqueness');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `prevention_action` SET TAGS ('dbx_business_glossary_term' = 'Prevention Action Plan');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `recurrence_flag` SET TAGS ('dbx_business_glossary_term' = 'Recurrence Flag');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `resolution_description` SET TAGS ('dbx_business_glossary_term' = 'Resolution Description');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `root_cause_category` SET TAGS ('dbx_business_glossary_term' = 'Root Cause Category');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `root_cause_description` SET TAGS ('dbx_business_glossary_term' = 'Root Cause Description');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `severity` SET TAGS ('dbx_value_regex' = 'critical|high|medium|low');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `sla_due_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Due Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `title` SET TAGS ('dbx_business_glossary_term' = 'Issue Title');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`dq_issue` ALTER COLUMN `verification_notes` SET TAGS ('dbx_business_glossary_term' = 'Verification Notes');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Semantic Layer Entity ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `parent_semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Semantic Layer Entity Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `approval_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Approval Required Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `business_definition` SET TAGS ('dbx_business_glossary_term' = 'Business Definition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `calculation_logic` SET TAGS ('dbx_business_glossary_term' = 'Calculation Logic');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `consumption_tier` SET TAGS ('dbx_business_glossary_term' = 'Consumption Tier');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `data_quality_score` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Score');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_business_glossary_term' = 'Data Steward Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `deprecation_reason` SET TAGS ('dbx_business_glossary_term' = 'Deprecation Reason');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `entity_name` SET TAGS ('dbx_business_glossary_term' = 'Entity Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `entity_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `entity_type` SET TAGS ('dbx_business_glossary_term' = 'Entity Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `entity_type` SET TAGS ('dbx_value_regex' = 'dimension|measure|metric|fact|aggregate|derived');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `grain_definition` SET TAGS ('dbx_business_glossary_term' = 'Grain Definition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `is_financial_flag` SET TAGS ('dbx_business_glossary_term' = 'Contains Financial Data Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `is_pii_flag` SET TAGS ('dbx_business_glossary_term' = 'Contains PII (Personally Identifiable Information) Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By User');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `last_refresh_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Refresh Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `platform_object_code` SET TAGS ('dbx_business_glossary_term' = 'Platform Object Identifier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `platform_type` SET TAGS ('dbx_business_glossary_term' = 'Semantic Layer Platform Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_business_glossary_term' = 'Refresh Frequency');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_value_regex' = 'real_time|hourly|daily|weekly|monthly|on_demand');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `related_kpi_definitions` SET TAGS ('dbx_business_glossary_term' = 'Related KPI (Key Performance Indicator) Definitions');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `sample_query` SET TAGS ('dbx_business_glossary_term' = 'Sample Query');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `tags` SET TAGS ('dbx_business_glossary_term' = 'Entity Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `underlying_table_reference` SET TAGS ('dbx_business_glossary_term' = 'Underlying Physical Table Reference');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `unique_user_count_last_30_days` SET TAGS ('dbx_business_glossary_term' = 'Unique User Count Last 30 Days');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `usage_count_last_30_days` SET TAGS ('dbx_business_glossary_term' = 'Usage Count Last 30 Days');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_layer_entity` ALTER COLUMN `version` SET TAGS ('dbx_business_glossary_term' = 'Entity Version');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `semantic_metric_id` SET TAGS ('dbx_business_glossary_term' = 'Semantic Metric ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `derived_from_semantic_metric_id` SET TAGS ('dbx_business_glossary_term' = 'Derived From Semantic Metric Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `aggregation_method` SET TAGS ('dbx_business_glossary_term' = 'Aggregation Method');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `alert_threshold_lower` SET TAGS ('dbx_business_glossary_term' = 'Alert Threshold Lower');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `alert_threshold_upper` SET TAGS ('dbx_business_glossary_term' = 'Alert Threshold Upper');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `base_measure` SET TAGS ('dbx_business_glossary_term' = 'Base Measure');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `benchmark_available_flag` SET TAGS ('dbx_business_glossary_term' = 'Benchmark Available Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `benchmark_source` SET TAGS ('dbx_business_glossary_term' = 'Benchmark Source');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `business_definition` SET TAGS ('dbx_business_glossary_term' = 'Business Definition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `business_owner` SET TAGS ('dbx_business_glossary_term' = 'Business Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `calculation_expression` SET TAGS ('dbx_business_glossary_term' = 'Calculation Expression');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `calculation_layer` SET TAGS ('dbx_business_glossary_term' = 'Calculation Layer');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `calculation_layer` SET TAGS ('dbx_value_regex' = 'bronze|silver|gold|semantic');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `certification_status` SET TAGS ('dbx_business_glossary_term' = 'Certification Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `certification_status` SET TAGS ('dbx_value_regex' = 'draft|under_review|certified|deprecated');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `certified_by` SET TAGS ('dbx_business_glossary_term' = 'Certified By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `certified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Certified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `dashboard_count` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `data_quality_rule` SET TAGS ('dbx_business_glossary_term' = 'Data Quality Rule');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `data_source_table` SET TAGS ('dbx_business_glossary_term' = 'Data Source Table');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `decimal_precision` SET TAGS ('dbx_business_glossary_term' = 'Decimal Precision');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `dimension_list` SET TAGS ('dbx_business_glossary_term' = 'Dimension List');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `documentation_url` SET TAGS ('dbx_business_glossary_term' = 'Documentation Uniform Resource Locator (URL)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `filter_expression` SET TAGS ('dbx_business_glossary_term' = 'Filter Expression');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `last_refresh_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Refresh Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `metric_code` SET TAGS ('dbx_business_glossary_term' = 'Metric Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `metric_name` SET TAGS ('dbx_business_glossary_term' = 'Metric Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `metric_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `metric_type` SET TAGS ('dbx_business_glossary_term' = 'Metric Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `metric_type` SET TAGS ('dbx_value_regex' = 'simple|ratio|derived|cumulative|compound');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_business_glossary_term' = 'Refresh Frequency');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `refresh_frequency` SET TAGS ('dbx_value_regex' = 'real_time|hourly|daily|weekly|monthly');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `tags` SET TAGS ('dbx_business_glossary_term' = 'Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `technical_owner` SET TAGS ('dbx_business_glossary_term' = 'Technical Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `time_grain` SET TAGS ('dbx_business_glossary_term' = 'Time Grain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `time_grain` SET TAGS ('dbx_value_regex' = 'daily|weekly|monthly|quarterly|yearly');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `trend_direction_indicator` SET TAGS ('dbx_business_glossary_term' = 'Trend Direction Indicator');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `trend_direction_indicator` SET TAGS ('dbx_value_regex' = 'higher_is_better|lower_is_better|target_is_optimal');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_business_glossary_term' = 'Unit of Measure (UOM)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `usage_frequency` SET TAGS ('dbx_business_glossary_term' = 'Usage Frequency');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `usage_frequency` SET TAGS ('dbx_value_regex' = 'high|medium|low');
ALTER TABLE `vibe_retail_v1`.`analytics`.`semantic_metric` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `report_subscription_id` SET TAGS ('dbx_business_glossary_term' = 'Report Subscription ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `access_policy_id` SET TAGS ('dbx_business_glossary_term' = 'Analytics Access Policy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `compliance_program_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Program Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `dashboard_config_id` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Config Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `demand_forecast_id` SET TAGS ('dbx_business_glossary_term' = 'Demand Forecast Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `report_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Report Definition ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `superseded_report_subscription_id` SET TAGS ('dbx_business_glossary_term' = 'Superseded Report Subscription Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `attachment_filename_pattern` SET TAGS ('dbx_business_glossary_term' = 'Attachment Filename Pattern');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `attachment_filename_pattern` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `cancellation_reason` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Reason');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `cancellation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `data_refresh_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Data Refresh Required Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_channel` SET TAGS ('dbx_business_glossary_term' = 'Delivery Channel');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_count` SET TAGS ('dbx_business_glossary_term' = 'Delivery Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_email_address` SET TAGS ('dbx_business_glossary_term' = 'Delivery Email Address');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_email_address` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_message_body` SET TAGS ('dbx_business_glossary_term' = 'Delivery Message Body');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_message_subject` SET TAGS ('dbx_business_glossary_term' = 'Delivery Message Subject');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_schedule_expression` SET TAGS ('dbx_business_glossary_term' = 'Delivery Schedule Expression');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_schedule_type` SET TAGS ('dbx_business_glossary_term' = 'Delivery Schedule Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `delivery_timezone` SET TAGS ('dbx_business_glossary_term' = 'Delivery Timezone');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `failed_delivery_count` SET TAGS ('dbx_business_glossary_term' = 'Failed Delivery Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `filter_parameters_json` SET TAGS ('dbx_business_glossary_term' = 'Filter Parameters JSON');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `include_empty_results_flag` SET TAGS ('dbx_business_glossary_term' = 'Include Empty Results Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `is_shared_subscription` SET TAGS ('dbx_business_glossary_term' = 'Is Shared Subscription');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `last_delivery_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Delivery Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `last_failure_reason` SET TAGS ('dbx_business_glossary_term' = 'Last Failure Reason');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `next_scheduled_delivery_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Next Scheduled Delivery Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `notification_on_failure_flag` SET TAGS ('dbx_business_glossary_term' = 'Notification On Failure Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `output_format` SET TAGS ('dbx_business_glossary_term' = 'Output Format');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Priority Level');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `subscription_end_date` SET TAGS ('dbx_business_glossary_term' = 'Subscription End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `subscription_name` SET TAGS ('dbx_business_glossary_term' = 'Subscription Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `subscription_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `subscription_start_date` SET TAGS ('dbx_business_glossary_term' = 'Subscription Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_subscription` ALTER COLUMN `subscription_status` SET TAGS ('dbx_business_glossary_term' = 'Subscription Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` SET TAGS ('dbx_subdomain' = 'data_governance');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `parent_access_policy_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Access Policy Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `parent_access_policy_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `access_level` SET TAGS ('dbx_business_glossary_term' = 'Access Level');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `approval_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Approval Required Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `approval_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Approval Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `approved_by` SET TAGS ('dbx_business_glossary_term' = 'Approved By');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `assigned_group` SET TAGS ('dbx_business_glossary_term' = 'Assigned Group');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `assigned_role` SET TAGS ('dbx_business_glossary_term' = 'Assigned Role');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `business_justification` SET TAGS ('dbx_business_glossary_term' = 'Business Justification');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `compliance_framework` SET TAGS ('dbx_business_glossary_term' = 'Compliance Framework');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `data_classification_constraint` SET TAGS ('dbx_business_glossary_term' = 'Data Classification Constraint');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `department_scope_restriction` SET TAGS ('dbx_business_glossary_term' = 'Department Scope Restriction');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `enforcement_mode` SET TAGS ('dbx_business_glossary_term' = 'Enforcement Mode');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `filter_expression` SET TAGS ('dbx_business_glossary_term' = 'Filter Expression');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `last_access_review_date` SET TAGS ('dbx_business_glossary_term' = 'Last Access Review Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `masking_rule` SET TAGS ('dbx_business_glossary_term' = 'Masking Rule');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `next_review_due_date` SET TAGS ('dbx_business_glossary_term' = 'Next Review Due Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_code` SET TAGS ('dbx_business_glossary_term' = 'Policy Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_description` SET TAGS ('dbx_business_glossary_term' = 'Policy Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_name` SET TAGS ('dbx_business_glossary_term' = 'Policy Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_status` SET TAGS ('dbx_business_glossary_term' = 'Policy Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `policy_type` SET TAGS ('dbx_business_glossary_term' = 'Policy Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `priority_rank` SET TAGS ('dbx_business_glossary_term' = 'Priority Rank');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `region_scope_restriction` SET TAGS ('dbx_business_glossary_term' = 'Region Scope Restriction');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `risk_level` SET TAGS ('dbx_business_glossary_term' = 'Risk Level');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `store_scope_restriction` SET TAGS ('dbx_business_glossary_term' = 'Store Scope Restriction');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `target_object_name` SET TAGS ('dbx_business_glossary_term' = 'Target Object Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `target_object_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `target_object_type` SET TAGS ('dbx_business_glossary_term' = 'Target Object Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `target_schema_name` SET TAGS ('dbx_business_glossary_term' = 'Target Schema Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `target_schema_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`access_policy` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` SET TAGS ('dbx_subdomain' = 'data_governance');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `retail_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Retail Calendar ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `prior_year_retail_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Prior Year Retail Calendar Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `calendar_date` SET TAGS ('dbx_business_glossary_term' = 'Calendar Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `calendar_day_of_month` SET TAGS ('dbx_business_glossary_term' = 'Calendar Day of Month');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `calendar_day_of_year` SET TAGS ('dbx_business_glossary_term' = 'Calendar Day of Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `calendar_month` SET TAGS ('dbx_business_glossary_term' = 'Calendar Month');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `calendar_quarter` SET TAGS ('dbx_business_glossary_term' = 'Calendar Quarter');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `calendar_year` SET TAGS ('dbx_business_glossary_term' = 'Calendar Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `comparable_date_prior_year` SET TAGS ('dbx_business_glossary_term' = 'Comparable Date Prior Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `comparable_week_prior_year` SET TAGS ('dbx_business_glossary_term' = 'Comparable Week Prior Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `day_abbreviation` SET TAGS ('dbx_business_glossary_term' = 'Day Abbreviation');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `day_name` SET TAGS ('dbx_business_glossary_term' = 'Day Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `day_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_day_of_period` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Day of Period');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_day_of_week` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Day of Week');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_day_of_year` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Day of Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_period` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Period');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Period End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Period Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_quarter` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Quarter');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_week` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Week');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_week_end_date` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Week End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_week_of_period` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Week of Period');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_week_start_date` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Week Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_year` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_year_end_date` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Year End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `fiscal_year_start_date` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Year Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `holiday_name` SET TAGS ('dbx_business_glossary_term' = 'Holiday Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `holiday_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_current_date` SET TAGS ('dbx_business_glossary_term' = 'Is Current Date Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_cyber_monday_week` SET TAGS ('dbx_business_glossary_term' = 'Is Cyber Monday Week Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_holiday` SET TAGS ('dbx_business_glossary_term' = 'Is Holiday Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_holiday_shopping_period` SET TAGS ('dbx_business_glossary_term' = 'Is Holiday Shopping Period Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_leap_year` SET TAGS ('dbx_business_glossary_term' = 'Is Leap Year Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_weekday` SET TAGS ('dbx_business_glossary_term' = 'Is Weekday Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `is_weekend` SET TAGS ('dbx_business_glossary_term' = 'Is Weekend Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `iso_week` SET TAGS ('dbx_business_glossary_term' = 'ISO Week Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `iso_year` SET TAGS ('dbx_business_glossary_term' = 'ISO Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `month_abbreviation` SET TAGS ('dbx_business_glossary_term' = 'Month Abbreviation');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `month_name` SET TAGS ('dbx_business_glossary_term' = 'Month Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`retail_calendar` ALTER COLUMN `month_name` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` SET TAGS ('dbx_subdomain' = 'data_governance');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `reporting_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Reporting Hierarchy ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `parent_reporting_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Reporting Hierarchy Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `attributes_json` SET TAGS ('dbx_business_glossary_term' = 'Attributes JSON');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `data_source` SET TAGS ('dbx_business_glossary_term' = 'Data Source');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `external_system_name` SET TAGS ('dbx_business_glossary_term' = 'External System Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `external_system_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `hierarchy_name` SET TAGS ('dbx_business_glossary_term' = 'Hierarchy Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `hierarchy_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `hierarchy_type` SET TAGS ('dbx_business_glossary_term' = 'Hierarchy Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `last_updated_by` SET TAGS ('dbx_business_glossary_term' = 'Last Updated By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `leaf_node_flag` SET TAGS ('dbx_business_glossary_term' = 'Leaf Node Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `level_name` SET TAGS ('dbx_business_glossary_term' = 'Level Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `level_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `level_number` SET TAGS ('dbx_business_glossary_term' = 'Level Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_description` SET TAGS ('dbx_business_glossary_term' = 'Node Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_identifier` SET TAGS ('dbx_business_glossary_term' = 'Node Identifier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_name` SET TAGS ('dbx_business_glossary_term' = 'Node Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_owner` SET TAGS ('dbx_business_glossary_term' = 'Node Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_path` SET TAGS ('dbx_business_glossary_term' = 'Node Path');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_status` SET TAGS ('dbx_business_glossary_term' = 'Node Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `node_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|deprecated|merged');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `parent_node_identifier` SET TAGS ('dbx_business_glossary_term' = 'Parent Node Identifier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `reporting_calendar_type` SET TAGS ('dbx_business_glossary_term' = 'Reporting Calendar Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `reporting_calendar_type` SET TAGS ('dbx_value_regex' = 'gregorian|retail_454|retail_445|fiscal');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `rollup_method` SET TAGS ('dbx_business_glossary_term' = 'Rollup Method');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `root_node_flag` SET TAGS ('dbx_business_glossary_term' = 'Root Node Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `sort_order` SET TAGS ('dbx_business_glossary_term' = 'Sort Order');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `time_zone` SET TAGS ('dbx_business_glossary_term' = 'Time Zone');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `version_number` SET TAGS ('dbx_business_glossary_term' = 'Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`reporting_hierarchy` ALTER COLUMN `created_by` SET TAGS ('dbx_business_glossary_term' = 'Created By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` SET TAGS ('dbx_ssot_role' = 'authoritative');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` SET TAGS ('dbx_ssot_owner' = 'analytics.analytics_kpi_target');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` SET TAGS ('dbx_ssot_concept' = 'kpi_target');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `analytics_kpi_target_id` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Target ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `compliance_program_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Program Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Store Department Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `format_id` SET TAGS ('dbx_business_glossary_term' = 'Store Format Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Fulfillment Node Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `plan_id` SET TAGS ('dbx_business_glossary_term' = 'Incentive Plan ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `inventory_node_id` SET TAGS ('dbx_business_glossary_term' = 'Inventory Node Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `item_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Item Hierarchy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Definition ID');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `revised_analytics_kpi_target_id` SET TAGS ('dbx_business_glossary_term' = 'Revised Analytics Kpi Target Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_owner_user_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Target Owner User ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `tertiary_analytics_last_updated_by_user_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Last Updated By User ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `approval_status` SET TAGS ('dbx_business_glossary_term' = 'Target Approval Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `approval_status` SET TAGS ('dbx_value_regex' = 'draft|pending_approval|approved|rejected|revised');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `approved_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Target Approval Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `business_entity_type` SET TAGS ('dbx_business_glossary_term' = 'Business Entity Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `business_entity_type` SET TAGS ('dbx_value_regex' = 'store|category|region|channel|department|supplier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Target Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `data_source` SET TAGS ('dbx_business_glossary_term' = 'Target Data Source');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Target Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Target Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `fiscal_period` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Period');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `fiscal_year` SET TAGS ('dbx_business_glossary_term' = 'Fiscal Year');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `floor_threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Floor Threshold Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `incentive_eligible_flag` SET TAGS ('dbx_business_glossary_term' = 'Incentive Eligible Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Active Target Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Target Record Last Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Target Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Target Period End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Target Period Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `revision_reason` SET TAGS ('dbx_business_glossary_term' = 'Target Revision Reason');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `stretch_target_value` SET TAGS ('dbx_business_glossary_term' = 'Stretch Target Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_basis` SET TAGS ('dbx_business_glossary_term' = 'Target Basis');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_owner_role` SET TAGS ('dbx_business_glossary_term' = 'Target Owner Role');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_setting_method` SET TAGS ('dbx_business_glossary_term' = 'Target Setting Method');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_setting_method` SET TAGS ('dbx_value_regex' = 'top_down|bottom_up|algorithmic|historical|benchmark');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_value` SET TAGS ('dbx_business_glossary_term' = 'Target Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `target_version` SET TAGS ('dbx_business_glossary_term' = 'Target Version Number');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_business_glossary_term' = 'Unit of Measure (UOM)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`analytics_kpi_target` ALTER COLUMN `variance_alert_threshold_percent` SET TAGS ('dbx_business_glossary_term' = 'Variance Alert Threshold Percentage');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `alert_id` SET TAGS ('dbx_business_glossary_term' = 'Analytics Alert ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `access_policy_id` SET TAGS ('dbx_business_glossary_term' = 'Analytics Access Policy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `adjustment_id` SET TAGS ('dbx_business_glossary_term' = 'Adjustment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `audit_finding_id` SET TAGS ('dbx_business_glossary_term' = 'Audit Finding Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `campaign_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `escalated_from_alert_id` SET TAGS ('dbx_business_glossary_term' = 'Escalated From Alert Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Shipment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `item_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Item Hierarchy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Key Performance Indicator (KPI) Definition ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `location_id` SET TAGS ('dbx_business_glossary_term' = 'Location Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `margin_target_id` SET TAGS ('dbx_business_glossary_term' = 'Margin Target Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `markdown_id` SET TAGS ('dbx_business_glossary_term' = 'Markdown Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `osha_incident_id` SET TAGS ('dbx_business_glossary_term' = 'Osha Incident Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned To User ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `profile_id` SET TAGS ('dbx_business_glossary_term' = 'Profile Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `replenishment_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Replenishment Plan Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `reporting_hierarchy_id` SET TAGS ('dbx_business_glossary_term' = 'Reporting Hierarchy Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `retail_calendar_id` SET TAGS ('dbx_business_glossary_term' = 'Retail Calendar Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Business Entity ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `sku_id` SET TAGS ('dbx_business_glossary_term' = 'Sku Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `sku_price_id` SET TAGS ('dbx_business_glossary_term' = 'Sku Price Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `stock_position_id` SET TAGS ('dbx_business_glossary_term' = 'Stock Position Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `purchase_order_id` SET TAGS ('dbx_business_glossary_term' = 'Supply Purchase Order Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `acknowledged_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Acknowledged Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `actual_value` SET TAGS ('dbx_business_glossary_term' = 'Actual Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `alert_status` SET TAGS ('dbx_business_glossary_term' = 'Alert Status');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `alert_type` SET TAGS ('dbx_business_glossary_term' = 'Alert Type');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `business_entity_type` SET TAGS ('dbx_business_glossary_term' = 'Business Entity Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `data_source` SET TAGS ('dbx_business_glossary_term' = 'Data Source');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `escalation_level` SET TAGS ('dbx_business_glossary_term' = 'Escalation Level');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `false_positive_flag` SET TAGS ('dbx_business_glossary_term' = 'False Positive Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `last_updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `measurement_period_end_date` SET TAGS ('dbx_business_glossary_term' = 'Measurement Period End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `measurement_period_start_date` SET TAGS ('dbx_business_glossary_term' = 'Measurement Period Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `alert_name` SET TAGS ('dbx_business_glossary_term' = 'Alert Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `alert_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `notification_channel` SET TAGS ('dbx_business_glossary_term' = 'Notification Channel');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Notification Sent Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `period_type` SET TAGS ('dbx_business_glossary_term' = 'Period Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `priority_score` SET TAGS ('dbx_business_glossary_term' = 'Priority Score');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `recipient_list` SET TAGS ('dbx_business_glossary_term' = 'Recipient List');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `recipient_list` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `related_alert_count` SET TAGS ('dbx_business_glossary_term' = 'Related Alert Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `resolution_duration_minutes` SET TAGS ('dbx_business_glossary_term' = 'Resolution Duration Minutes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `resolution_notes` SET TAGS ('dbx_business_glossary_term' = 'Resolution Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `resolution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Resolution Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `severity_level` SET TAGS ('dbx_business_glossary_term' = 'Severity Level');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `suppression_flag` SET TAGS ('dbx_business_glossary_term' = 'Suppression Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `suppression_reason` SET TAGS ('dbx_business_glossary_term' = 'Suppression Reason');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Threshold Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `trigger_condition` SET TAGS ('dbx_business_glossary_term' = 'Trigger Condition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `triggered_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Triggered Timestamp');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `variance_amount` SET TAGS ('dbx_business_glossary_term' = 'Variance Amount');
ALTER TABLE `vibe_retail_v1`.`analytics`.`alert` ALTER COLUMN `variance_percentage` SET TAGS ('dbx_business_glossary_term' = 'Variance Percentage');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `forked_from_self_service_query_id` SET TAGS ('dbx_business_glossary_term' = 'Forked From Self Service Query Id');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Semantic Layer Entity Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `semantic_metric_id` SET TAGS ('dbx_business_glossary_term' = 'Semantic Metric Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `web_session_id` SET TAGS ('dbx_business_glossary_term' = 'Session ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `workspace_id` SET TAGS ('dbx_business_glossary_term' = 'Workspace ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `access_granted_by_policy` SET TAGS ('dbx_business_glossary_term' = 'Access Granted By Policy');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `aggregation_functions` SET TAGS ('dbx_business_glossary_term' = 'Aggregation Functions');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `bi_tool` SET TAGS ('dbx_business_glossary_term' = 'Business Intelligence (BI) Tool');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `cache_hit` SET TAGS ('dbx_business_glossary_term' = 'Cache Hit');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `compute_cost_usd` SET TAGS ('dbx_business_glossary_term' = 'Compute Cost (USD)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `contains_pii` SET TAGS ('dbx_business_glossary_term' = 'Contains Personally Identifiable Information (PII)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `data_classification` SET TAGS ('dbx_business_glossary_term' = 'Data Classification');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `data_classification` SET TAGS ('dbx_value_regex' = 'restricted|confidential|internal|public');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `data_scanned_bytes` SET TAGS ('dbx_business_glossary_term' = 'Data Scanned (Bytes)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `error_message` SET TAGS ('dbx_business_glossary_term' = 'Error Message');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `execution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Execution Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `export_format` SET TAGS ('dbx_business_glossary_term' = 'Export Format');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `export_format` SET TAGS ('dbx_value_regex' = 'csv|excel|pdf|json|parquet|none');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `filter_criteria` SET TAGS ('dbx_business_glossary_term' = 'Filter Criteria');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `join_count` SET TAGS ('dbx_business_glossary_term' = 'Join Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_complexity_score` SET TAGS ('dbx_business_glossary_term' = 'Query Complexity Score');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_duration_seconds` SET TAGS ('dbx_business_glossary_term' = 'Query Duration (Seconds)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_name` SET TAGS ('dbx_business_glossary_term' = 'Query Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_optimization_applied` SET TAGS ('dbx_business_glossary_term' = 'Query Optimization Applied');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_purpose` SET TAGS ('dbx_business_glossary_term' = 'Query Purpose');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_purpose` SET TAGS ('dbx_value_regex' = 'ad_hoc_analysis|reporting|dashboard_refresh|data_exploration|model_training|data_quality_check');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_status` SET TAGS ('dbx_business_glossary_term' = 'Query Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_status` SET TAGS ('dbx_value_regex' = 'success|failed|timeout|cancelled|partial');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_text` SET TAGS ('dbx_business_glossary_term' = 'Query Text');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_type` SET TAGS ('dbx_business_glossary_term' = 'Query Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `query_type` SET TAGS ('dbx_value_regex' = 'sql|semantic|natural_language|visual_builder|saved_query');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `result_set_size_mb` SET TAGS ('dbx_business_glossary_term' = 'Result Set Size (MB)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `rows_returned` SET TAGS ('dbx_business_glossary_term' = 'Rows Returned');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `saved_query_flag` SET TAGS ('dbx_business_glossary_term' = 'Saved Query Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `shared_flag` SET TAGS ('dbx_business_glossary_term' = 'Shared Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `target_data_product` SET TAGS ('dbx_business_glossary_term' = 'Target Data Product');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `target_domain` SET TAGS ('dbx_business_glossary_term' = 'Target Domain');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `user_department` SET TAGS ('dbx_business_glossary_term' = 'User Department');
ALTER TABLE `vibe_retail_v1`.`analytics`.`self_service_query` ALTER COLUMN `user_role` SET TAGS ('dbx_business_glossary_term' = 'User Role');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` SET TAGS ('dbx_subdomain' = 'data_governance');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_business_glossary_term' = 'Glossary Term Identifier (ID)');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'r'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'m'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'a'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'k'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `glossary_term_id` SET TAGS ('dbx_']']' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `dashboard_config_id` SET TAGS ('dbx_business_glossary_term' = 'Dashboard Config Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'l'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'f'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'r'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_'k'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `parent_glossary_term_id` SET TAGS ('dbx_']']' = 'true');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `approved_by` SET TAGS ('dbx_['dbx_pii_name'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `approved_by` SET TAGS ('dbx_'sensitivity' = 'pii]');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'' = '');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'n'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'t'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'v'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `associated_report_names` SET TAGS ('dbx_']']' = 'true');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'c'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'' = '');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'o'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'n'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'f'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'d'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'t'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'a'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'l'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'m'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'v'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'b'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'x'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_']'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'dbx_pii_email'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_email` SET TAGS ('dbx_'sensitivity' = 'pii]');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'' = '');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'n'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'t'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'v'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'d'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'b'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'x'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'a'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'m'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_']'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'dbx_pii_name'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'mask_in_nonprod' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `business_owner_name` SET TAGS ('dbx_'mask_non_prod' = 'true]');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'c'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'' = '');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'o'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'n'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'f'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'d'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'t'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'a'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'l'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'m'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'v'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'b'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'x'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_']'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'dbx_pii_email'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_email` SET TAGS ('dbx_'sensitivity' = 'pii]');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'' = '');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'n'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'t'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'v'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'d'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'b'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'x'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'_'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'a'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'m'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_']'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'dbx_pii_name'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `data_steward_name` SET TAGS ('dbx_'sensitivity' = 'pii]');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_['['' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_"'"' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'s'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'' = '');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'e'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'n'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'i'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'t'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'v'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'y'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_'p'' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `term_name` SET TAGS ('dbx_']']' = 'true');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `usage_frequency` SET TAGS ('dbx_value_regex' = 'high|medium|low');
ALTER TABLE `vibe_retail_v1`.`analytics`.`glossary_term` ALTER COLUMN `version_number` SET TAGS ('dbx_value_regex' = '^[0-9]+.[0-9]+$');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` SET TAGS ('dbx_association_edges' = 'analytics.kpi_definition,analytics.metric_dimension');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `kpi_dimensionality_id` SET TAGS ('dbx_business_glossary_term' = 'KPI Dimensionality Configuration ID');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Kpi Dimensionality - Kpi Definition Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `metric_dimension_id` SET TAGS ('dbx_business_glossary_term' = 'Kpi Dimensionality - Metric Dimension Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `aggregation_level` SET TAGS ('dbx_business_glossary_term' = 'Aggregation Level');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `configuration_notes` SET TAGS ('dbx_business_glossary_term' = 'Configuration Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `configured_by` SET TAGS ('dbx_business_glossary_term' = 'Configuration Owner');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `default_filter_value` SET TAGS ('dbx_business_glossary_term' = 'Default Filter Value');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `dimension_value_filter` SET TAGS ('dbx_business_glossary_term' = 'Dimension Value Filter');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `dimensionality` SET TAGS ('dbx_business_glossary_term' = 'Dimensionality');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `display_format` SET TAGS ('dbx_business_glossary_term' = 'Display Format Override');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `drill_enabled` SET TAGS ('dbx_business_glossary_term' = 'Drill-Down Enabled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Configuration Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Configuration Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Active Configuration Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `is_required_dimension` SET TAGS ('dbx_business_glossary_term' = 'Required Dimension Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`kpi_dimensionality` ALTER COLUMN `sort_order` SET TAGS ('dbx_business_glossary_term' = 'Dimension Sort Order');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` SET TAGS ('dbx_association_edges' = 'analytics.kpi_definition,analytics.report_definition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `report_composition_id` SET TAGS ('dbx_business_glossary_term' = 'Report Composition Identifier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Report Composition - Kpi Definition Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `report_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Report Composition - Report Definition Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `added_date` SET TAGS ('dbx_business_glossary_term' = 'KPI Added Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `composition_status` SET TAGS ('dbx_business_glossary_term' = 'Composition Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `conditional_formatting_rules` SET TAGS ('dbx_business_glossary_term' = 'Conditional Formatting Rules');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `configured_by` SET TAGS ('dbx_business_glossary_term' = 'Configured By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `display_order` SET TAGS ('dbx_business_glossary_term' = 'Display Order');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `drill_down_enabled` SET TAGS ('dbx_business_glossary_term' = 'Drill Down Enabled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `filter_defaults` SET TAGS ('dbx_business_glossary_term' = 'Filter Defaults');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `is_primary_metric` SET TAGS ('dbx_business_glossary_term' = 'Primary Metric Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `removed_date` SET TAGS ('dbx_business_glossary_term' = 'KPI Removed Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `section_name` SET TAGS ('dbx_business_glossary_term' = 'Report Section Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `section_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `target_threshold_override` SET TAGS ('dbx_business_glossary_term' = 'Target Threshold Override');
ALTER TABLE `vibe_retail_v1`.`analytics`.`report_composition` ALTER COLUMN `visualization_type` SET TAGS ('dbx_business_glossary_term' = 'Visualization Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` SET TAGS ('dbx_subdomain' = 'semantic_catalog');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` SET TAGS ('dbx_association_edges' = 'analytics.semantic_layer_entity,analytics.semantic_metric');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `metric_entity_dependency_id` SET TAGS ('dbx_business_glossary_term' = 'Metric Entity Dependency Identifier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `semantic_layer_entity_id` SET TAGS ('dbx_business_glossary_term' = 'Metric Entity Dependency - Semantic Layer Entity Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `semantic_metric_id` SET TAGS ('dbx_business_glossary_term' = 'Metric Entity Dependency - Semantic Metric Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `aggregation_role` SET TAGS ('dbx_business_glossary_term' = 'Aggregation Role');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `calculation_order` SET TAGS ('dbx_business_glossary_term' = 'Calculation Order');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `dependency_type` SET TAGS ('dbx_business_glossary_term' = 'Dependency Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `entity_alias` SET TAGS ('dbx_business_glossary_term' = 'Entity Alias');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `filter_expression` SET TAGS ('dbx_business_glossary_term' = 'Filter Expression');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `is_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Is Required Flag');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `join_condition` SET TAGS ('dbx_business_glossary_term' = 'Join Condition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `join_type` SET TAGS ('dbx_business_glossary_term' = 'Join Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`metric_entity_dependency` ALTER COLUMN `modified_by` SET TAGS ('dbx_business_glossary_term' = 'Modified By');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` SET TAGS ('dbx_subdomain' = 'performance_metrics');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` SET TAGS ('dbx_association_edges' = 'analytics.kpi_definition,supplychain.sla_definition');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `sla_kpi_measurement_id` SET TAGS ('dbx_business_glossary_term' = 'SLA KPI Measurement Identifier');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `kpi_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Sla Kpi Measurement - Kpi Definition Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `sla_definition_id` SET TAGS ('dbx_business_glossary_term' = 'Sla Kpi Measurement - Supply Chain Sla Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `alert_threshold_value` SET TAGS ('dbx_business_glossary_term' = 'Alert Threshold');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `breach_penalty_rate` SET TAGS ('dbx_business_glossary_term' = 'Breach Penalty Rate');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Creation Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Measurement Effective End Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Measurement Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `is_primary_kpi` SET TAGS ('dbx_business_glossary_term' = 'Primary KPI Indicator');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `last_modified_by` SET TAGS ('dbx_business_glossary_term' = 'Last Modified By User');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `measurement_frequency` SET TAGS ('dbx_business_glossary_term' = 'Measurement Frequency');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `measurement_status` SET TAGS ('dbx_business_glossary_term' = 'Measurement Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `measurement_weight` SET TAGS ('dbx_business_glossary_term' = 'KPI Weight in SLA Scorecard');
ALTER TABLE `vibe_retail_v1`.`analytics`.`sla_kpi_measurement` ALTER COLUMN `measurement_window_days` SET TAGS ('dbx_business_glossary_term' = 'Measurement Window');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` SET TAGS ('dbx_subdomain' = 'reporting_intelligence');
...
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `account_id` SET TAGS ('dbx_business_glossary_term' = 'Billing Account Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `org_unit_id` SET TAGS ('dbx_business_glossary_term' = 'Business Unit Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `department_id` SET TAGS ('dbx_business_glossary_term' = 'Owner Department Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `parent_workspace_id` SET TAGS ('dbx_business_glossary_term' = 'Parent Workspace Id');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `parent_workspace_id` SET TAGS ('dbx_self_ref_fk' = 'true');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `access_level` SET TAGS ('dbx_business_glossary_term' = 'Access Level');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `activation_date` SET TAGS ('dbx_business_glossary_term' = 'Activation Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `archive_after_days` SET TAGS ('dbx_business_glossary_term' = 'Archive After Days');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `archived_date` SET TAGS ('dbx_business_glossary_term' = 'Archived Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `asset_count` SET TAGS ('dbx_business_glossary_term' = 'Asset Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `auto_archive_enabled` SET TAGS ('dbx_business_glossary_term' = 'Auto Archive Enabled');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `workspace_code` SET TAGS ('dbx_business_glossary_term' = 'Workspace Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `compliance_framework` SET TAGS ('dbx_business_glossary_term' = 'Compliance Framework');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `created_by_user_code` SET TAGS ('dbx_business_glossary_term' = 'Created By User Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `data_residency_country` SET TAGS ('dbx_business_glossary_term' = 'Data Residency Country');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `workspace_description` SET TAGS ('dbx_business_glossary_term' = 'Description');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `environment_type` SET TAGS ('dbx_business_glossary_term' = 'Environment Type');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `expiration_date` SET TAGS ('dbx_business_glossary_term' = 'Expiration Date');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `is_default` SET TAGS ('dbx_business_glossary_term' = 'Is Default');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `is_template` SET TAGS ('dbx_business_glossary_term' = 'Is Template');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `last_accessed_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Accessed Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `last_modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Last Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `max_member_limit` SET TAGS ('dbx_business_glossary_term' = 'Max Member Limit');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `member_count` SET TAGS ('dbx_business_glossary_term' = 'Member Count');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `modified_by_user_code` SET TAGS ('dbx_business_glossary_term' = 'Modified By User Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `workspace_name` SET TAGS ('dbx_business_glossary_term' = 'Workspace Name');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `workspace_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `owner_user_code` SET TAGS ('dbx_business_glossary_term' = 'Owner User Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Priority Level');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `region_code` SET TAGS ('dbx_business_glossary_term' = 'Region Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `retention_policy_days` SET TAGS ('dbx_business_glossary_term' = 'Retention Policy Days');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `storage_quota_gb` SET TAGS ('dbx_business_glossary_term' = 'Storage Quota Gb');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `storage_used_gb` SET TAGS ('dbx_business_glossary_term' = 'Storage Used Gb');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `tags` SET TAGS ('dbx_business_glossary_term' = 'Tags');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `template_source_code` SET TAGS ('dbx_business_glossary_term' = 'Template Source Code');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `visibility_scope` SET TAGS ('dbx_business_glossary_term' = 'Visibility Scope');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `workspace_status` SET TAGS ('dbx_business_glossary_term' = 'Workspace Status');
ALTER TABLE `vibe_retail_v1`.`analytics`.`workspace` ALTER COLUMN `workspace_type` SET TAGS ('dbx_business_glossary_term' = 'Workspace Type');
