...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` (
    ...
    `employee_id` BIGINT COMMENT 'Identifier of the user who approved this schedule template. Null if not yet approved or approval is not required.',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` (
    `or_block_id` BIGINT COMMENT 'Primary key for or_block',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` (
    `appointment_status_history_id` BIGINT COMMENT 'Primary key for appointment_status_history',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` (
    `block_utilization_id` BIGINT COMMENT 'Primary key for block_utilization',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` (
    `patient_preference_id` BIGINT COMMENT 'Primary key for patient_preference',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` (
    `recall_list_id` BIGINT COMMENT 'Primary key for recall_list',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` (
    ...
    `employee_id` BIGINT COMMENT 'Identifier of the user who cancelled this availability record.',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` (
    `surgical_case_team_id` BIGINT COMMENT 'Primary key for surgical_case_team',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` (
    `equipment_reservation_id` BIGINT COMMENT 'Primary key for equipment_reservation',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`case_material_usage` (
    `case_material_usage_id` BIGINT COMMENT 'Primary key for case_material_usage',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_prior_auth_requirement` (
    `appointment_prior_auth_requirement_id` BIGINT COMMENT 'Primary key for appointment_prior_auth_requirement',
...
CREATE OR REPLACE TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` (
    `scheduling_appointment_id` BIGINT COMMENT 'Surrogate primary key for scheduling.scheduling_appointment',
    `merged_with_radiology_radiology_appointment` STRING COMMENT 'SSOT reconciliation attribute added by vibe cross-domain dedup pass.',
    `mvm_alias_name` STRING COMMENT 'MVM-tier alias name (appointment) for this ECM product, ensuring ECM is a true superset of the MVM.',
    `mvm_ecm_reconciled_flag` BOOLEAN COMMENT 'True when this ECM product has been reconciled against its MVM alias.',
    `reconciled_from_mvm` STRING COMMENT 'Added during ECM/MVM reconciliation vibe pass.',
    `reconciliation_source` STRING COMMENT 'Added during ECM/MVM reconciliation vibe pass.',
    `ssot_canonical_reference` STRING COMMENT 'Distinct entity; counterpart radiology.radiology_appointment serves a separate domain context',
    `ssot_reconciliation_status` STRING COMMENT 'SSOT review: kept distinct from radiology.radiology_appointment (documented as separate business concepts)',
    `vibe_placeholder` STRING COMMENT 'Placeholder attribute pending full re-derivation.',
    `vibe_reconciled_flag` BOOLEAN COMMENT 'Added during ECM/MVM reconciliation vibe pass.',
    CONSTRAINT pk_scheduling_appointment PRIMARY KEY(`scheduling_appointment_id`)
) COMMENT 'MVM alias: appointment (ECM superset of MVM).';
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `allows_telehealth` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `allows_telehealth` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `appointment_type_status` SET TAGS ('pii_value_regex' = 'active|inactive|suspended|retired');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `billing_class` SET TAGS ('pii_value_regex' = 'professional|facility|technical|global');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `care_setting` SET TAGS ('pii_value_regex' = 'outpatient|inpatient|emergency|telehealth|home_health|ambulatory_surgery');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `appointment_type_code` SET TAGS ('pii_value_regex' = '^[A-Z0-9_]{2,20}$');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `default_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `maximum_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `minimum_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `appointment_type_name` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `appointment_type_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `patient_class` SET TAGS ('pii_value_regex' = 'new_patient|established_patient|return_patient|referral');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `patient_class` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `patient_class` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_type` ALTER COLUMN `preparation_instructions` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` SET TAGS ('pii_subdomain' = 'resource_capacity');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `care_site_id` SET TAGS ('pii_business_glossary_term' = 'Facility ID');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `compliance_policy_id` SET TAGS ('pii_business_glossary_term' = 'Policy Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `schedulable_resource_id` SET TAGS ('pii_business_glossary_term' = 'Resource ID');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `employee_id` SET TAGS ('pii_business_glossary_term' = 'Approved By User ID');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `employee_id` SET TAGS ('pii_confidential' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `org_unit_id` SET TAGS ('pii_business_glossary_term' = 'Department Code');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `approval_status` SET TAGS ('pii_value_regex' = 'pending|approved|rejected|expired');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `approved_timestamp` SET TAGS ('pii_business_glossary_term' = 'Approved Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `auto_confirm_flag` SET TAGS ('pii_business_glossary_term' = 'Auto Confirm Flag');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `buffer_time_minutes` SET TAGS ('pii_business_glossary_term' = 'Buffer Time Minutes');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `care_setting` SET TAGS ('pii_value_regex' = 'outpatient|inpatient|emergency|surgical|telehealth|home_health');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `insurance_type_accepted` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `insurance_type_accepted` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `max_slots_per_session` SET TAGS ('pii_business_glossary_term' = 'Maximum Slots Per Session');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `modified_timestamp` SET TAGS ('pii_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `no_show_tracking_enabled_flag` SET TAGS ('pii_business_glossary_term' = 'No Show Tracking Enabled Flag');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `notes` SET TAGS ('pii_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `overbooking_allowed_flag` SET TAGS ('pii_business_glossary_term' = 'Overbooking Allowed Flag');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `patient_class` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `patient_class` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `priority_level` SET TAGS ('pii_value_regex' = 'routine|urgent|emergent|elective');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `provider_npi` SET TAGS ('pii_business_glossary_term' = 'National Provider Identifier (NPI)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `provider_npi` SET TAGS ('pii_value_regex' = '^[0-9]{10}$');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `provider_npi` SET TAGS ('pii_confidential' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `provider_npi` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `provider_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `recurrence_pattern` SET TAGS ('pii_value_regex' = 'daily|weekly|biweekly|monthly|rotating|custom');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `reminder_enabled_flag` SET TAGS ('pii_business_glossary_term' = 'Reminder Enabled Flag');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `session_duration_minutes` SET TAGS ('pii_business_glossary_term' = 'Session Duration Minutes');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `session_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `slot_duration_minutes` SET TAGS ('pii_business_glossary_term' = 'Slot Duration Minutes');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `slot_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `source_system_code` SET TAGS ('pii_business_glossary_term' = 'Source System ID');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `telehealth_enabled_flag` SET TAGS ('pii_business_glossary_term' = 'Telehealth Enabled Flag');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `telehealth_enabled_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `telehealth_enabled_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `template_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `template_status` SET TAGS ('pii_value_regex' = 'active|inactive|draft|suspended|retired|pending');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `template_type` SET TAGS ('pii_value_regex' = 'provider|resource|facility|equipment|room|staff');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedule_template` ALTER COLUMN `waitlist_enabled_flag` SET TAGS ('pii_business_glossary_term' = 'Waitlist Enabled Flag');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` SET TAGS ('pii_data_type' = 'transactional_data');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `care_site_id` SET TAGS ('pii_business_glossary_term' = 'Facility Identifier (ID)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `clinician_id` SET TAGS ('pii_business_glossary_term' = 'Provider Identifier (ID)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `equipment_asset_id` SET TAGS ('pii_business_glossary_term' = 'Equipment Identifier (ID)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `research_study_id` SET TAGS ('pii_business_glossary_term' = 'Research Study Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `room_id` SET TAGS ('pii_business_glossary_term' = 'Room Identifier (ID)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `schedule_template_id` SET TAGS ('pii_business_glossary_term' = 'Schedule Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `block_type` SET TAGS ('pii_value_regex' = 'administrative|personal|maintenance|training|meeting|other');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `care_setting` SET TAGS ('pii_value_regex' = 'outpatient|inpatient|emergency|surgical|telehealth|home_health');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `comment` SET TAGS ('pii_business_glossary_term' = 'Slot Comment');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `created_datetime` SET TAGS ('pii_business_glossary_term' = 'Created Date and Time');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `hold_expiration_datetime` SET TAGS ('pii_business_glossary_term' = 'Hold Expiration Date and Time');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `hold_expiration_datetime` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `hold_status` SET TAGS ('pii_value_regex' = 'available|held|released|expired');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `insurance_eligibility` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `insurance_eligibility` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `last_modified_datetime` SET TAGS ('pii_business_glossary_term' = 'Last Modified Date and Time');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `max_capacity` SET TAGS ('pii_business_glossary_term' = 'Maximum Capacity');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `max_capacity` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `max_capacity` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `online_booking_enabled_flag` SET TAGS ('pii_business_glossary_term' = 'Online Booking Enabled Flag');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `overbook_allowed_flag` SET TAGS ('pii_business_glossary_term' = 'Overbook Allowed Flag');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `patient_type_eligibility` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `patient_type_eligibility` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `remaining_capacity` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `slot_duration_minutes` SET TAGS ('pii_business_glossary_term' = 'Slot Duration in Minutes');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `slot_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `slot_end_datetime` SET TAGS ('pii_business_glossary_term' = 'Slot End Date and Time');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `slot_identifier` SET TAGS ('pii_business_glossary_term' = 'Slot Business Identifier');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `slot_start_datetime` SET TAGS ('pii_business_glossary_term' = 'Slot Start Date and Time');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `slot_status` SET TAGS ('pii_value_regex' = 'free|busy|busy-unavailable|busy-tentative|entered-in-error');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `specialty` SET TAGS ('pii_business_glossary_term' = 'Provider Specialty');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`open_slot` ALTER COLUMN `waitlist_enabled_flag` SET TAGS ('pii_business_glossary_term' = 'Waitlist Enabled Flag');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `prior_authorization_id` SET TAGS ('pii_business_glossary_term' = 'Claim Prior Authorization Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `clinical_order_id` SET TAGS ('pii_business_glossary_term' = 'Originating Order Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `clinical_order_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `cost_center_id` SET TAGS ('pii_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `diagnosis_id` SET TAGS ('pii_business_glossary_term' = 'Clinical Diagnosis Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `diagnosis_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `drg_id` SET TAGS ('pii_business_glossary_term' = 'Drg Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `drg_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `health_plan_id` SET TAGS ('pii_business_glossary_term' = 'Health Plan Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `health_plan_id` SET TAGS ('pii_restricted' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `health_plan_id` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `health_plan_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `health_plan_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `hipaa_privacy_incident_id` SET TAGS ('pii_business_glossary_term' = 'Hipaa Privacy Incident Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `invoice_id` SET TAGS ('pii_business_glossary_term' = 'Invoice Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `malpractice_coverage_id` SET TAGS ('pii_business_glossary_term' = 'Malpractice Coverage Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `or_suite_id` SET TAGS ('pii_business_glossary_term' = 'Operating Room (OR) Identifier');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `payer_id` SET TAGS ('pii_business_glossary_term' = 'Payer Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `icd_code_id` SET TAGS ('pii_business_glossary_term' = 'Pre Op Diagnosis Icd Code Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `icd_code_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `lab_order_id` SET TAGS ('pii_business_glossary_term' = 'Preop Lab Order Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `lab_order_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_business_glossary_term' = 'Primary Procedure Cpt Code Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `privileging_id` SET TAGS ('pii_business_glossary_term' = 'Privileging Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `research_study_id` SET TAGS ('pii_business_glossary_term' = 'Research Study Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `surgical_bom_id` SET TAGS ('pii_business_glossary_term' = 'Surgical Bom Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `treatment_consent_id` SET TAGS ('pii_business_glossary_term' = 'Treatment Consent Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `treatment_consent_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `visit_id` SET TAGS ('pii_business_glossary_term' = 'Visit Identifier (ID)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `actual_duration_minutes` SET TAGS ('pii_business_glossary_term' = 'Actual Duration in Minutes');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `actual_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `actual_end_time` SET TAGS ('pii_business_glossary_term' = 'Actual End Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `actual_start_time` SET TAGS ('pii_business_glossary_term' = 'Actual Start Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `add_on_case_indicator` SET TAGS ('pii_business_glossary_term' = 'Add-On Case Indicator');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `anesthesia_type` SET TAGS ('pii_value_regex' = 'general|regional|local|monitored_anesthesia_care|sedation|none');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `asa_classification` SET TAGS ('pii_business_glossary_term' = 'American Society of Anesthesiologists (ASA) Physical Status Classification');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `asa_classification` SET TAGS ('pii_value_regex' = 'I|II|III|IV|V|VI');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `block_owner_npi` SET TAGS ('pii_business_glossary_term' = 'Block Owner National Provider Identifier (NPI)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `block_owner_npi` SET TAGS ('pii_value_regex' = '^[0-9]{10}$');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `block_owner_npi` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `block_owner_npi` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `block_time_indicator` SET TAGS ('pii_business_glossary_term' = 'Block Time Indicator');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `cancellation_timestamp` SET TAGS ('pii_business_glossary_term' = 'Cancellation Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `case_number` SET TAGS ('pii_business_glossary_term' = 'Surgical Case Number');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `case_number` SET TAGS ('pii_value_regex' = '^[A-Z0-9]{8,20}$');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `case_status` SET TAGS ('pii_business_glossary_term' = 'Surgical Case Status');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `case_type` SET TAGS ('pii_business_glossary_term' = 'Surgical Case Type');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `case_type` SET TAGS ('pii_value_regex' = 'inpatient|outpatient|ambulatory|emergency|trauma|transplant');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `consent_obtained_indicator` SET TAGS ('pii_business_glossary_term' = 'Informed Consent Obtained Indicator');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `consent_obtained_indicator` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `consent_obtained_indicator` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `consent_timestamp` SET TAGS ('pii_business_glossary_term' = 'Consent Obtained Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `consent_timestamp` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `consent_timestamp` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `estimated_duration_minutes` SET TAGS ('pii_business_glossary_term' = 'Estimated Duration in Minutes');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `estimated_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `facility_code` SET TAGS ('pii_value_regex' = '^[A-Z0-9]{3,10}$');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `implant_required` SET TAGS ('pii_business_glossary_term' = 'Implant Required Indicator');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `last_modified_timestamp` SET TAGS ('pii_business_glossary_term' = 'Record Last Modified Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `laterality` SET TAGS ('pii_business_glossary_term' = 'Surgical Laterality');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `laterality` SET TAGS ('pii_value_regex' = 'left|right|bilateral|not_applicable');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `mrn` SET TAGS ('pii_business_glossary_term' = 'Medical Record Number (MRN)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `mrn` SET TAGS ('pii_value_regex' = '^[A-Z0-9]{6,12}$');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `mrn` SET TAGS ('pii_restricted' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `patient_class` SET TAGS ('pii_value_regex' = 'inpatient|outpatient|observation|same_day_surgery|extended_recovery');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `patient_class` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `patient_class` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `post_op_diagnosis` SET TAGS ('pii_business_glossary_term' = 'Post-Operative Diagnosis');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `post_op_diagnosis` SET TAGS ('pii_confidential' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `post_op_diagnosis` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `post_op_diagnosis` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `record_number` SET TAGS ('pii_business_glossary_term' = 'Consent Record Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `requires_blood_products` SET TAGS ('pii_business_glossary_term' = 'Requires Blood Products Indicator');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `requires_icu_bed` SET TAGS ('pii_business_glossary_term' = 'Requires Intensive Care Unit (ICU) Bed Indicator');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `scheduled_date` SET TAGS ('pii_business_glossary_term' = 'Scheduled Surgery Date');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `scheduled_end_time` SET TAGS ('pii_business_glossary_term' = 'Scheduled End Timestamp');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `scheduled_start_time` SET TAGS ('pii_business_glossary_term' = 'Scheduled Start Timestamp');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `secondary_procedure_codes` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `service_line` SET TAGS ('pii_business_glossary_term' = 'Surgical Service Line');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `site_marked_indicator` SET TAGS ('pii_business_glossary_term' = 'Surgical Site Marked Indicator');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `specialty` SET TAGS ('pii_business_glossary_term' = 'Surgical Specialty');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `timeout_completed_indicator` SET TAGS ('pii_business_glossary_term' = 'Surgical Timeout Completed Indicator');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `urgency_level` SET TAGS ('pii_business_glossary_term' = 'Case Urgency Level');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case` ALTER COLUMN `urgency_level` SET TAGS ('pii_value_regex' = 'elective|urgent|emergent|trauma');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `budget_id` SET TAGS ('pii_business_glossary_term' = 'Budget Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `cdm_entry_id` SET TAGS ('pii_business_glossary_term' = 'Cdm Entry Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `block_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `block_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `minimum_utilization_threshold_pct` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`or_block` ALTER COLUMN `target_utilization_threshold_pct` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` SET TAGS ('pii_data_type' = 'master_data');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` SET TAGS ('pii_subdomain' = 'resource_capacity');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `training_completion_id` SET TAGS ('pii_business_glossary_term' = 'Training Completion Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `accepts_new_patients` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `accepts_new_patients` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `credentialing_expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `default_slot_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `license_number` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `license_state` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `resource_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `room_capacity` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `room_configuration` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `sterilization_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`schedulable_resource` ALTER COLUMN `telehealth_enabled` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`resource_assignment` SET TAGS ('pii_subdomain' = 'resource_capacity');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`resource_assignment` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`resource_assignment` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`resource_assignment` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`resource_assignment` ALTER COLUMN `procedure_event_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`resource_assignment` ALTER COLUMN `duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `compliance_policy_id` SET TAGS ('pii_business_glossary_term' = 'Policy Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `encounter_authorization_id` SET TAGS ('pii_business_glossary_term' = 'Authorization Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `health_plan_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `insurance_coverage_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `insurance_coverage_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `population_health_gap_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `icd_code_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `preferred_contact_channel` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `preferred_contact_channel` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`waitlist_entry` ALTER COLUMN `telehealth_eligible_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `financial_impact_flag` SET TAGS ('pii_sensitive' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `initiated_by_user_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `patient_contact_method` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `patient_contact_method` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `patient_contacted_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `patient_contacted_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `patient_response` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `patient_response` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_status_history` ALTER COLUMN `system_generated` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `diagnosis_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `department_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `facility_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `patient_response` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `patient_response` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `provider_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `recipient_email_address` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_reminder` ALTER COLUMN `recipient_phone_number` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` SET TAGS ('pii_subdomain' = 'resource_capacity');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `capacity_utilization_id` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `employee_id` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `employee_id` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `actual_utilization_rate_pct` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `provider_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `target_utilization_rate_pct` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`capacity_utilization` ALTER COLUMN `variance_utilization_pct` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` ALTER COLUMN `procedure_minutes` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` ALTER COLUMN `target_utilization_percentage` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` ALTER COLUMN `utilization_percentage` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`block_utilization` ALTER COLUMN `utilization_variance_percentage` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` SET TAGS ('pii_data_type' = 'reference_data');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `applies_to_telehealth` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `gender_restriction` SET TAGS ('pii_sensitive' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `gender_restriction` SET TAGS ('pii_uc_classification' = 'sensitive');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `insurance_type_required` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `insurance_type_required` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `maximum_patient_age_years` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `maximum_patient_age_years` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `minimum_patient_age_years` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `minimum_patient_age_years` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `patient_class` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `patient_class` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_rule` ALTER COLUMN `rule_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `patient_preference_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `patient_preference_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `demographics_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `demographics_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `clinician_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `clinician_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `employee_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `employee_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `tertiary_patient_modified_by_user_employee_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `tertiary_patient_modified_by_user_employee_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `gender_preference_provider` SET TAGS ('pii_sensitive' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `gender_preference_provider` SET TAGS ('pii_uc_classification' = 'sensitive');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `preferred_contact_channel` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `preferred_contact_channel` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `telehealth_eligible_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`patient_preference` ALTER COLUMN `telehealth_preference` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` SET TAGS ('pii_subdomain' = 'patient_engagement');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` SET TAGS ('pii_'ecm_member' = 'true]');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `telehealth_session_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `telehealth_session_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `compliance_policy_id` SET TAGS ('pii_business_glossary_term' = 'Policy Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `credential_id` SET TAGS ('pii_business_glossary_term' = 'Credential Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `fhir_resource_log_id` SET TAGS ('pii_business_glossary_term' = 'Fhir Resource Log Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `hipaa_privacy_incident_id` SET TAGS ('pii_business_glossary_term' = 'Hipaa Privacy Incident Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `telehealth_authorization_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `telehealth_consent_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `actual_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `consent_datetime` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `consent_datetime` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `consent_obtained_flag` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `consent_obtained_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `patient_browser` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `patient_browser` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `patient_device_type` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `patient_device_type` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `patient_operating_system` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `platform_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`telehealth_session` ALTER COLUMN `scheduled_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` SET TAGS ('pii_subdomain' = 'patient_engagement');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `demographics_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `demographics_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `icd_code_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `health_plan_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `immunization_id` SET TAGS ('pii_business_glossary_term' = 'Immunization Id (Foreign Key)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `immunization_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `immunization_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `insurance_coverage_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `insurance_coverage_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `cpt_code_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `procedure_event_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `subject_enrollment_id` SET TAGS ('pii_business_glossary_term' = 'Subject Enrollment Id (Foreign Key)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `patient_response` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `patient_response` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `patient_response_date` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `patient_response_date` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`recall_list` ALTER COLUMN `recall_expiration_date` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` SET TAGS ('pii_subdomain' = 'resource_capacity');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `employee_id` SET TAGS ('pii_business_glossary_term' = 'Cancelled By User ID');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `accepts_new_patients` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `accepts_new_patients` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `insurance_type_accepted` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `insurance_type_accepted` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `patient_class` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `patient_class` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `remaining_capacity` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`provider_availability` ALTER COLUMN `telehealth_enabled` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `anesthesiologist_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `assisting_surgeon_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `license_number` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `license_state` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `participation_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `primary_surgeon_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `primary_surgeon_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `replacement_team_member_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `supervising_provider_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `team_member_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`surgical_case_team` ALTER COLUMN `team_member_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `demographics_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `demographics_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `diagnosis_id` SET TAGS ('pii_uc_classification' = 'phi');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `encounter_authorization_id` SET TAGS ('pii_business_glossary_term' = 'Authorization Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `health_plan_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `insurance_coverage_id` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `insurance_coverage_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `clinician_id` SET TAGS ('pii_business_glossary_term' = 'Referring Provider Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `org_unit_id` SET TAGS ('pii_business_glossary_term' = 'Requested Department Identifier (ID)');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `appointment_type_id` SET TAGS ('pii_business_glossary_term' = 'Requested Appointment Type Identifier (ID)');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `icd_code_id` SET TAGS ('pii_phi' = 'true');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `mrn` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `preferred_contact_channel` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `preferred_contact_channel` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`booking_queue` ALTER COLUMN `telehealth_eligible_flag` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` ALTER COLUMN `procedure_event_id` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` ALTER COLUMN `actual_duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` ALTER COLUMN `duration_minutes` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` ALTER COLUMN `procedure_code` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` ALTER COLUMN `procedure_description` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`equipment_reservation` ALTER COLUMN `requesting_provider_npi` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`case_material_usage` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`case_material_usage` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_prior_auth_requirement` SET TAGS ('pii_subdomain' = 'booking_rules');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_prior_auth_requirement` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`appointment_prior_auth_requirement` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` SET TAGS ('pii_['model_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` SET TAGS ('pii_'ecm_member' = 'true]');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `confirmation_deadline_hours` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `contact_email` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `contact_phone` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `include_insurance_reminder` SET TAGS ('pii_phi' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `include_insurance_reminder` SET TAGS ('pii_uc_classification' = 'phi');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `preparation_instructions` SET TAGS ('pii_vibe_rate_typing' = 'decimal');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`reminder_template` ALTER COLUMN `template_name` SET TAGS ('pii_uc_classification' = 'pii');
...
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` SET TAGS ('pii_subdomain' = 'booking_rules');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` SET TAGS ('pii_ssot' = 'canonical');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` SET TAGS ('pii_mvm_alias' = 'appointment');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` SET TAGS ('pii_tier' = 'ECM');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` SET TAGS ('pii_mvm_included' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` ALTER COLUMN `mvm_alias_name` SET TAGS ('pii_reconciliation' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` ALTER COLUMN `mvm_alias_name` SET TAGS ('pii_pii' = 'true');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` ALTER COLUMN `mvm_alias_name` SET TAGS ('pii_uc_classification' = 'pii');
ALTER TABLE `vibe_healthcare_v1`.`scheduling`.`scheduling_appointment` ALTER COLUMN `mvm_ecm_reconciled_flag` SET TAGS ('pii_reconciliation' = 'true');
