...
-- Generated on: 2026-07-10 12:17:29
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`materials_research` (
    ...
    `project_id` BIGINT COMMENT 'add column project_id (BIGINT) with FK to research.project.project_id - materials research is conducted within R&D projects',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`patent_filing` (
    ...
    `employee_id` BIGINT COMMENT 'add column employee_id (BIGINT) with FK to workforce.employee.employee_id - patent filings need a responsible attorney/engineer for prosecution tracking',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`pdk_development` (
    ...
    `project_id` BIGINT COMMENT 'add column project_id (BIGINT) with FK to research.project.project_id - PDK development efforts are managed as projects',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`packaging_research` (
    ...
    `project_id` BIGINT COMMENT 'add column project_id (BIGINT) with FK to research.project.project_id - packaging research is conducted within R&D projects',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`competitive_benchmark` (
    ...
    `ic_catalog_id` BIGINT COMMENT 'add column ic_catalog_id (BIGINT) with FK to product.ic_catalog.ic_catalog_id - competitive benchmarks compare against specific products in the catalog',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`government_grant` (
    ...
    `research_program_id` BIGINT COMMENT 'add column research_program_id (BIGINT) with FK to research.research_program.research_program_id - government grants (CHIPS Act) fund specific research programs but currently only links to employee',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`test_structure` (
    ...
    `fabrication_technology_node_id` BIGINT COMMENT 'add column fabrication_technology_node_id (BIGINT) with FK to fabrication.fabrication_technology_node.fabrication_technology_node_id - test structures are designed for specific technology nodes',
...
CREATE OR REPLACE TABLE `vibe_semiconductors_v1`.`research`.`test_suite` (
    ...
    `design_ip_core_id` BIGINT COMMENT 'Identifier of the intellectual property (e.g., patent) associated with the test suite.',
    `research_program_id` BIGINT COMMENT 'add column research_program_id (BIGINT) with FK to research.research_program.research_program_id - test suites support research programs but currently only self-reference',
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`pdk_development` ADD CONSTRAINT `fk_research_pdk_development_project_id` FOREIGN KEY (`project_id`) REFERENCES `vibe_semiconductors_v1`.`research`.`project`(`project_id`);
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_program` ALTER COLUMN `program_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_program` ALTER COLUMN `technical_lead_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`project` ALTER COLUMN `collaboration_partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`project` ALTER COLUMN `project_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_technology_node` ALTER COLUMN `foundry_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_technology_node` ALTER COLUMN `node_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`technology_roadmap` ALTER COLUMN `competitor_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`technology_roadmap` ALTER COLUMN `roadmap_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`experimental_lot` ALTER COLUMN `principal_investigator_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_integration_run` ALTER COLUMN `contact_resistance_ohm` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_integration_run` ALTER COLUMN `experiment_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_integration_run` ALTER COLUMN `research_program_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`device_architecture` ALTER COLUMN `architecture_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`materials_research` SET TAGS ('dbx_subdomain' = 'materials_innovation');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`materials_research` ALTER COLUMN `material_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`materials_research` ALTER COLUMN `supplier_vendor_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`invention_disclosure` ALTER COLUMN `primary_inventor_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`collaboration` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`collaboration` ALTER COLUMN `consortium_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`collaboration` ALTER COLUMN `government_program_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`collaboration` ALTER COLUMN `collaboration_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`collaboration` ALTER COLUMN `partner_institution_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`tapeout_experiment` ALTER COLUMN `chip_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`tapeout_experiment` ALTER COLUMN `tapeout_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`characterization_result` SET TAGS ('dbx_subdomain' = 'experimental_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`pdk_development` ALTER COLUMN `pdk_custodian_email` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`pdk_development` ALTER COLUMN `pdk_custodian_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`pdk_development` ALTER COLUMN `pdk_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_milestone` ALTER COLUMN `approving_authority_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_milestone` ALTER COLUMN `milestone_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`publication` ALTER COLUMN `collaboration_partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`publication` ALTER COLUMN `issn` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`budget_allocation` ALTER COLUMN `allocation_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`budget_allocation` ALTER COLUMN `approving_authority_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`budget_allocation` ALTER COLUMN `collaboration_partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`budget_allocation` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,12}$');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`budget_allocation` ALTER COLUMN `grant_program_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`budget_allocation` ALTER COLUMN `granting_agency_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`packaging_research` SET TAGS ('dbx_subdomain' = 'materials_innovation');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`packaging_research` ALTER COLUMN `collaboration_partner_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`packaging_research` ALTER COLUMN `packaging_technology_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`yield_learning_record` SET TAGS ('dbx_subdomain' = 'experimental_execution');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`yield_learning_record` ALTER COLUMN `learning_engineer_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`competitive_benchmark` ALTER COLUMN `approved_by_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`competitive_benchmark` ALTER COLUMN `benchmark_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`competitive_benchmark` ALTER COLUMN `competitor_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`competitive_benchmark` ALTER COLUMN `competitor_product_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`government_grant` ALTER COLUMN `program_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_flow_experiment` ALTER COLUMN `flow_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`compliance_assessment` SET TAGS ('dbx_subdomain' = 'program_management');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`test_structure` SET TAGS ('dbx_subdomain' = 'test_characterization');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`test_structure` ALTER COLUMN `structure_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_split` ALTER COLUMN `equipment_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`process_split` ALTER COLUMN `process_split_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_test_plan` SET TAGS ('dbx_subdomain' = 'test_characterization');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`research_test_plan` ALTER COLUMN `plan_name` SET TAGS ('dbx_pii_detected' = 'true');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`test_suite` SET TAGS ('dbx_subdomain' = 'test_characterization');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`test_suite` ALTER COLUMN `design_ip_core_id` SET TAGS ('dbx_business_glossary_term' = 'Related Ip Id');
...
ALTER TABLE `vibe_semiconductors_v1`.`research`.`test_suite` ALTER COLUMN `test_suite_name` SET TAGS ('dbx_pii_detected' = 'true');
