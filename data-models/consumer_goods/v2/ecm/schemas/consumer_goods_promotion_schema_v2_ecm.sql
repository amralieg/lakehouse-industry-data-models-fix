...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_event` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` SET TAGS ('dbx_subdomain' = 'funding_settlement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `accrual_number` SET TAGS ('dbx_value_regex' = '^ACR-[0-9]{10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `accrual_status` SET TAGS ('dbx_value_regex' = 'open|pending_approval|approved|settled|reversed|cancelled');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `accrual_type` SET TAGS ('dbx_value_regex' = 'scan_back|bill_back|off_invoice|lump_sum|volume_rebate|performance_bonus');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_value_regex' = '^CC[0-9]{6}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `deduction_claim_number` SET TAGS ('dbx_value_regex' = '^DED-[0-9]{10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_accrual` ALTER COLUMN `payment_reference_number` SET TAGS ('dbx_value_regex' = '^PAY-[0-9]{10}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_deduction` SET TAGS ('dbx_subdomain' = 'funding_settlement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`deduction_settlement` SET TAGS ('dbx_subdomain' = 'funding_settlement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promotion_rebate_agreement` SET TAGS ('dbx_subdomain' = 'funding_settlement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`rebate_settlement` SET TAGS ('dbx_subdomain' = 'funding_settlement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`post_event_analysis` ALTER COLUMN `rd_project_id` SET TAGS ('dbx_business_glossary_term' = 'Rd Project Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`promoted_price` SET TAGS ('dbx_subdomain' = 'consumer_offers');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`pos_redemption` SET TAGS ('dbx_subdomain' = 'consumer_offers');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`consumer_offer` SET TAGS ('dbx_subdomain' = 'consumer_offers');
...
ALTER TABLE `vibe_consumer_goods_v1`.`promotion`.`flight_allocation` SET TAGS ('dbx_subdomain' = 'consumer_offers');
