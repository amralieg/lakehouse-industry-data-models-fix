...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`master` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Required for Procurements Approved Supplier List process; links each material to the firm approved to supply it, enabling sourcing decisions and compliance checks.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`stock_movement` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Goods receipt must capture which firm delivered the material for invoicing, compliance, and traceability per construction site delivery logs.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`stock_transfer` (
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`batch_lot` (
    ...
    `master_id` BIGINT COMMENT 'add column master_id (BIGINT) with FK to material.master.master_id - batch/lot records must reference the material master they belong to',
    ...
    `project_site_assignment_id` BIGINT COMMENT 'Identifier of the construction site where the material is applied.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`material_boq_line` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Needed for BOQ line allocation; assigns a firm responsible for delivering the material, used in cost tracking and contract award reports.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`requisition` (
    ...
    `firm_profile_id` BIGINT COMMENT 'Foreign key linking to bid.firm_profile. Business justification: Requisition may be directed to a specific firm; linking enables automated purchase order routing and firm performance tracking.',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`physical_inventory` (
    ...
    `construction_project_id` BIGINT COMMENT 'add column construction_project_id (BIGINT) with FK to project.construction_project.construction_project_id - inventory counts are project-relevant for material reconciliation',
    `master_id` BIGINT COMMENT 'Unique identifier of the material being counted.',
    `warehouse_id` BIGINT COMMENT 'add column warehouse_id (BIGINT) with FK to material.warehouse.warehouse_id - physical inventory counts occur at specific warehouse locations',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`specification` (
    `specification_id` BIGINT COMMENT 'Primary key for specification',
    `construction_project_id` BIGINT COMMENT 'add column construction_project_id (BIGINT) with FK to project.construction_project.construction_project_id - material specifications are often project-specific with unique requirements',
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`wastage` (
...
CREATE OR REPLACE TABLE `vibe_construction_v1`.`material`.`mto_header` (
    ...
    `construction_project_id` BIGINT COMMENT 'add column construction_project_id (BIGINT) with FK to project.construction_project.construction_project_id - material take-off headers are always project-specific',
    `project_site_assignment_id` BIGINT COMMENT 'Identifier of the site or warehouse receiving the materials.',
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_transfer` ADD CONSTRAINT `fk_material_stock_transfer_warehouse_id` FOREIGN KEY (`warehouse_id`) REFERENCES `vibe_construction_v1`.`material`.`warehouse`(`warehouse_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`stock_transfer` ADD CONSTRAINT `fk_material_stock_transfer_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`stock_transfer` ADD CONSTRAINT `fk_material_stock_transfer_source_warehouse_id` FOREIGN KEY (`source_warehouse_id`) REFERENCES `vibe_construction_v1`.`material`.`warehouse`(`warehouse_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ADD CONSTRAINT `fk_material_conformance_certificate_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`material_boq_line` ADD CONSTRAINT `fk_material_material_boq_line_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ADD CONSTRAINT `fk_material_physical_inventory_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ADD CONSTRAINT `fk_material_physical_inventory_warehouse_id` FOREIGN KEY (`warehouse_id`) REFERENCES `vibe_construction_v1`.`material`.`warehouse`(`warehouse_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ADD CONSTRAINT `fk_material_specification_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ADD CONSTRAINT `fk_material_approved_material_list_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ADD CONSTRAINT `fk_material_wastage_master_id` FOREIGN KEY (`master_id`) REFERENCES `vibe_construction_v1`.`material`.`master`(`master_id`);
ALTER TABLE `vibe_construction_v1`.`material`.`hazmat_register` ADD CONSTRAINT `fk_material_hazmat_register_warehouse_id` FOREIGN KEY (`warehouse_id`) REFERENCES `vibe_construction_v1`.`material`.`warehouse`(`warehouse_id`);
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` SET TAGS ('dbx_subdomain' = 'inventory_control');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `firm_profile_id` SET TAGS ('dbx_business_glossary_term' = 'Approved Supplier Sub Firm Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `cost_per_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `lead_time_days` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `leeds_credit_applicability` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `manufacturer_country` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `manufacturer_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `material_origin_country` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `master_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `master_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`master` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `capacity_area_sqm` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `capacity_area_sqm` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `capacity_weight_tonnes` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `capacity_weight_tonnes` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `certification_expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `country_code` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `gps_accuracy_meters` SET TAGS ('dbx_pii_location' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`warehouse` ALTER COLUMN `warehouse_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_level` ALTER COLUMN `cost_per_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_level` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_movement` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_movement` ALTER COLUMN `tax_amount` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_movement` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_movement` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`goods_issue` ALTER COLUMN `craft_worker_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`goods_issue` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`goods_issue` ALTER COLUMN `tax_amount` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`goods_issue` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_transfer` ALTER COLUMN `carrier_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`stock_transfer` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` SET TAGS ('dbx_subdomain' = 'quality_traceability');
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ALTER COLUMN `project_site_assignment_id` SET TAGS ('dbx_business_glossary_term' = 'Site Identifier');
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ALTER COLUMN `expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ALTER COLUMN `unit_volume` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`batch_lot` ALTER COLUMN `unit_weight` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` SET TAGS ('dbx_subdomain' = 'quality_traceability');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ALTER COLUMN `submission_id` SET TAGS ('dbx_business_glossary_term' = 'Bid Submission Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ALTER COLUMN `certificate_title` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ALTER COLUMN `expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`conformance_certificate` ALTER COLUMN `measured_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`material_boq_line` ALTER COLUMN `firm_profile_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned Sub Firm Id (Foreign Key)');
...
ALTER TABLE `vibe_construction_v1`.`material`.`material_boq_line` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`material_boq_line` ALTER COLUMN `unit_rate` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_line` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_line` ALTER COLUMN `estimated_unit_price` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_line` ALTER COLUMN `expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_line` ALTER COLUMN `lead_time_days` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_line` ALTER COLUMN `required_by_date` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_line` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` SET TAGS ('dbx_subdomain' = 'quantity_planning');
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `requisition_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Requester ID');
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `requisition_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `requisition_employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `requisition_employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `is_emergency` SET TAGS ('dbx_pii_contact' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `required_by_date` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`requisition` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ALTER COLUMN `audit_created_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ALTER COLUMN `audit_updated_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ALTER COLUMN `counter_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ALTER COLUMN `counter_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ALTER COLUMN `expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`physical_inventory` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` SET TAGS ('dbx_subdomain' = 'quality_traceability');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `approved_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `cost_per_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `lead_time_days` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `leeds_credit_applicability` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `min_modulus_of_elasticity_gpa` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `min_modulus_of_elasticity_gpa` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `specification_name` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`specification` ALTER COLUMN `specification_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` SET TAGS ('dbx_subdomain' = 'quality_traceability');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `compliance_certificate_expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `cost_per_unit` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `material_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `material_origin_country` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `material_origin_state` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `updated_by` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `warranty_expiry_date` SET TAGS ('dbx_pii_financial' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`approved_material_list` ALTER COLUMN `created_by` SET TAGS ('dbx_pii_identifier' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` SET TAGS ('dbx_subdomain' = 'quantity_planning');
...
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `craft_worker_id` SET TAGS ('dbx_pii_identifier' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `wastage_employee_id` SET TAGS ('dbx_business_glossary_term' = 'Approved By User ID');
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `wastage_employee_id` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `wastage_employee_id` SET TAGS ('dbx_pii' = 'true');
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `wastage_employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `regulatory_compliance_flag` SET TAGS ('dbx_value_regex' = 'compliant|non_compliant|exempt');
...
ALTER TABLE `vibe_construction_v1`.`material`.`wastage` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`hazmat_register` SET TAGS ('dbx_subdomain' = 'quality_traceability');
...
ALTER TABLE `vibe_construction_v1`.`material`.`hazmat_register` ALTER COLUMN `employee_id` SET TAGS ('dbx_pii_flag' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`hazmat_register` ALTER COLUMN `material_name` SET TAGS ('dbx_pii_name' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`hazmat_register` ALTER COLUMN `unit_of_measure` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_header` ALTER COLUMN `project_site_assignment_id` SET TAGS ('dbx_business_glossary_term' = 'Destination Site Id');
...
ALTER TABLE `vibe_construction_v1`.`material`.`mto_header` ALTER COLUMN `parent_mto_header_id` SET TAGS ('dbx_pii_contact' = 'true');
