-- Schema for Domain: fulfillment | Business:  | Version: v2_ecm
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_order` (
    ...
    `fulfillment_order_header_id` BIGINT COMMENT 'Reference to the originating order header',
    `fulfillment_profile_id` BIGINT COMMENT 'Reference to the customer who placed the originating order. Required for customer communication and service.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`shipment` (
    ...
    `outbound_shipment_id` BIGINT COMMENT 'Foreign key linking to supplychain.outbound_shipment. Business justification: Same physical shipment tracked in both domains. supplychain.shipment is customer-facing view; outbound_shipment is DC logistics view. Essential for unified shipment visibility, freight reconciliation,',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`pack_task` (
    ...
    `associate_id` BIGINT COMMENT 'Associate assigned to pack',
    `pack_associate_id` BIGINT COMMENT 'Identifier of the warehouse associate assigned to perform the packing operation. Used for productivity tracking and quality accountability.',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`exception` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`sla` (
    ...
    `fulfillment_order_id` BIGINT COMMENT 'Order this SLA applies to',
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` (
...
CREATE OR REPLACE TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` (
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ADD CONSTRAINT `fk_fulfillment_delivery_route_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ADD CONSTRAINT `fk_fulfillment_delivery_route_carrier_service_id` FOREIGN KEY (`carrier_service_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier_service`(`carrier_service_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ADD CONSTRAINT `fk_fulfillment_delivery_route_fulfillment_node_id` FOREIGN KEY (`fulfillment_node_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`fulfillment_node`(`fulfillment_node_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ADD CONSTRAINT `fk_fulfillment_delivery_stop_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ADD CONSTRAINT `fk_fulfillment_delivery_stop_delivery_route_id` FOREIGN KEY (`delivery_route_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`delivery_route`(`delivery_route_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ADD CONSTRAINT `fk_fulfillment_delivery_stop_shipment_id` FOREIGN KEY (`shipment_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`shipment`(`shipment_id`);
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ADD CONSTRAINT `fk_fulfillment_exception_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ADD CONSTRAINT `fk_fulfillment_exception_fulfillment_line_id` FOREIGN KEY (`fulfillment_line_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`fulfillment_line`(`fulfillment_line_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ADD CONSTRAINT `fk_fulfillment_exception_fulfillment_node_id` FOREIGN KEY (`fulfillment_node_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`fulfillment_node`(`fulfillment_node_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ADD CONSTRAINT `fk_fulfillment_exception_fulfillment_order_id` FOREIGN KEY (`fulfillment_order_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`fulfillment_order`(`fulfillment_order_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ADD CONSTRAINT `fk_fulfillment_shipment_tracking_event_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ADD CONSTRAINT `fk_fulfillment_shipment_tracking_event_carrier_service_id` FOREIGN KEY (`carrier_service_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier_service`(`carrier_service_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ADD CONSTRAINT `fk_fulfillment_shipment_tracking_event_shipment_id` FOREIGN KEY (`shipment_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`shipment`(`shipment_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ADD CONSTRAINT `fk_fulfillment_shipment_tracking_event_shipment_package_id` FOREIGN KEY (`shipment_package_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`shipment_package`(`shipment_package_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ADD CONSTRAINT `fk_fulfillment_sla_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ADD CONSTRAINT `fk_fulfillment_sla_carrier_service_id` FOREIGN KEY (`carrier_service_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier_service`(`carrier_service_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ADD CONSTRAINT `fk_fulfillment_sla_fulfillment_node_id` FOREIGN KEY (`fulfillment_node_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`fulfillment_node`(`fulfillment_node_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ADD CONSTRAINT `fk_fulfillment_sla_fulfillment_order_id` FOREIGN KEY (`fulfillment_order_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`fulfillment_order`(`fulfillment_order_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ADD CONSTRAINT `fk_fulfillment_carrier_rate_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ADD CONSTRAINT `fk_fulfillment_carrier_rate_carrier_service_id` FOREIGN KEY (`carrier_service_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier_service`(`carrier_service_id`);
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ADD CONSTRAINT `fk_fulfillment_proof_of_delivery_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ADD CONSTRAINT `fk_fulfillment_proof_of_delivery_shipment_id` FOREIGN KEY (`shipment_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`shipment`(`shipment_id`);
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ADD CONSTRAINT `fk_fulfillment_carrier_facility_contract_carrier_id` FOREIGN KEY (`carrier_id`) REFERENCES `vibe_retail_v1`.`fulfillment`.`carrier`(`carrier_id`);
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_order` ALTER COLUMN `compliance_program_id` SET TAGS ('dbx_business_glossary_term' = 'Compliance Program Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_order` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_order` ALTER COLUMN `fulfillment_profile_id` SET TAGS ('dbx_business_glossary_term' = 'Customer ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_order` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Picker Employee ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_order` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` SET TAGS ('dbx_ssot_authoritative_owner' = 'order.order_line');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` SET TAGS ('dbx_ssot_role' = 'non_authoritative');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` SET TAGS ('dbx_ssot_owner' = 'order.order_line');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` SET TAGS ('dbx_ssot_authoritative_source' = 'order.order_line');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` SET TAGS ('dbx_ssot_reference' = 'order.order_line');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` ALTER COLUMN `handling_unit_id` SET TAGS ('dbx_business_glossary_term' = 'Carton ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Picker ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_line` ALTER COLUMN `lot_number` SET TAGS ('dbx_business_glossary_term' = 'Lot Number');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment` SET TAGS ('dbx_subdomain' = 'shipment_tracking');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment` ALTER COLUMN `environmental_event_id` SET TAGS ('dbx_business_glossary_term' = 'Environmental Event Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment` ALTER COLUMN `outbound_shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Distribution Shipment Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment` ALTER COLUMN `ship_to_address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment` ALTER COLUMN `ship_to_address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_package` SET TAGS ('dbx_subdomain' = 'shipment_tracking');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_package` ALTER COLUMN `outbound_shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Distribution Shipment Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` SET TAGS ('dbx_subdomain' = 'warehouse_operations');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Assigned Associate ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` ALTER COLUMN `wave_id` SET TAGS ('dbx_business_glossary_term' = 'Wave ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` ALTER COLUMN `original_sku` SET TAGS ('dbx_business_glossary_term' = 'Original Stock Keeping Unit (SKU)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` ALTER COLUMN `original_sku` SET TAGS ('dbx_value_regex' = '^[A-Z0-9-]{6,20}$');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` ALTER COLUMN `sku` SET TAGS ('dbx_business_glossary_term' = 'Stock Keeping Unit (SKU)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pick_task` ALTER COLUMN `sku` SET TAGS ('dbx_value_regex' = '^[A-Z0-9-]{6,20}$');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pack_task` SET TAGS ('dbx_subdomain' = 'warehouse_operations');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`pack_task` ALTER COLUMN `pack_associate_id` SET TAGS ('dbx_business_glossary_term' = 'Packer ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` SET TAGS ('dbx_subdomain' = 'last_mile');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `delivery_route_id` SET TAGS ('dbx_business_glossary_term' = 'Delivery Route ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `carrier_service_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Center ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `outbound_shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Outbound Shipment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Driver ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `safety_inspection_id` SET TAGS ('dbx_business_glossary_term' = 'Safety Inspection Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `actual_departure_time` SET TAGS ('dbx_business_glossary_term' = 'Actual Departure Time');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `actual_distance_km` SET TAGS ('dbx_business_glossary_term' = 'Actual Distance (Kilometers)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `actual_duration_minutes` SET TAGS ('dbx_business_glossary_term' = 'Actual Duration (Minutes)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `actual_return_time` SET TAGS ('dbx_business_glossary_term' = 'Actual Return Time');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `cancellation_reason` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Reason');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `cancellation_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Cancellation Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `completed_stops` SET TAGS ('dbx_business_glossary_term' = 'Completed Stops');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `completion_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Completion Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `dispatch_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Dispatch Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `estimated_duration_minutes` SET TAGS ('dbx_business_glossary_term' = 'Estimated Duration (Minutes)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `failed_stops` SET TAGS ('dbx_business_glossary_term' = 'Failed Stops');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `hazmat_flag` SET TAGS ('dbx_business_glossary_term' = 'Hazardous Materials (HAZMAT) Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `optimization_algorithm` SET TAGS ('dbx_business_glossary_term' = 'Optimization Algorithm');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `optimization_version` SET TAGS ('dbx_business_glossary_term' = 'Optimization Version');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `planned_departure_time` SET TAGS ('dbx_business_glossary_term' = 'Planned Departure Time');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `planned_return_time` SET TAGS ('dbx_business_glossary_term' = 'Planned Return Time');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_date` SET TAGS ('dbx_business_glossary_term' = 'Route Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_name` SET TAGS ('dbx_business_glossary_term' = 'Route Name');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_notes` SET TAGS ('dbx_business_glossary_term' = 'Route Notes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_number` SET TAGS ('dbx_business_glossary_term' = 'Route Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_number` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,20}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_priority` SET TAGS ('dbx_business_glossary_term' = 'Route Priority');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_priority` SET TAGS ('dbx_value_regex' = 'high|medium|low');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_status` SET TAGS ('dbx_business_glossary_term' = 'Route Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_status` SET TAGS ('dbx_value_regex' = 'planned|assigned|in_progress|completed|partial|cancelled');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_type` SET TAGS ('dbx_business_glossary_term' = 'Route Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_type` SET TAGS ('dbx_value_regex' = 'last_mile|ship_from_store|bopis|ropis|dark_store');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `route_zone` SET TAGS ('dbx_business_glossary_term' = 'Route Zone');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `temperature_controlled_flag` SET TAGS ('dbx_business_glossary_term' = 'Temperature Controlled Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `total_distance_km` SET TAGS ('dbx_business_glossary_term' = 'Total Distance (Kilometers)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `total_packages` SET TAGS ('dbx_business_glossary_term' = 'Total Packages');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `total_stops` SET TAGS ('dbx_business_glossary_term' = 'Total Stops');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `total_volume_m3` SET TAGS ('dbx_business_glossary_term' = 'Total Volume (Cubic Meters)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `total_weight_kg` SET TAGS ('dbx_business_glossary_term' = 'Total Weight (Kilograms)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `vehicle_code` SET TAGS ('dbx_business_glossary_term' = 'Vehicle ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `vehicle_type` SET TAGS ('dbx_business_glossary_term' = 'Vehicle Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_route` ALTER COLUMN `vehicle_type` SET TAGS ('dbx_value_regex' = 'van|truck|bike|scooter|car|cargo_bike');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` SET TAGS ('dbx_subdomain' = 'last_mile');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_stop_id` SET TAGS ('dbx_business_glossary_term' = 'Delivery Stop ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Driver ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_route_id` SET TAGS ('dbx_business_glossary_term' = 'Delivery Route ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Order ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `outbound_order_id` SET TAGS ('dbx_business_glossary_term' = 'Outbound Order Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `profile_id` SET TAGS ('dbx_business_glossary_term' = 'Customer ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Shipment ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `access_instructions` SET TAGS ('dbx_business_glossary_term' = 'Access Instructions');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `actual_arrival_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Actual Arrival Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `actual_departure_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Actual Departure Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `actual_service_time_minutes` SET TAGS ('dbx_business_glossary_term' = 'Actual Service Time in Minutes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line1` SET TAGS ('dbx_business_glossary_term' = 'Delivery Address Line 1');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line1` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line1` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line2` SET TAGS ('dbx_business_glossary_term' = 'Delivery Address Line 2');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line2` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line2` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_city` SET TAGS ('dbx_business_glossary_term' = 'Delivery City');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_city` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_city` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_completion_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Delivery Completion Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_country_code` SET TAGS ('dbx_business_glossary_term' = 'Delivery Country Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_latitude` SET TAGS ('dbx_business_glossary_term' = 'Delivery Latitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_latitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_location_type` SET TAGS ('dbx_business_glossary_term' = 'Delivery Location Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_longitude` SET TAGS ('dbx_business_glossary_term' = 'Delivery Longitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_longitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_outcome` SET TAGS ('dbx_business_glossary_term' = 'Delivery Outcome');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Delivery Postal Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_postal_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_postal_code` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_state_province` SET TAGS ('dbx_business_glossary_term' = 'Delivery State or Province');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_state_province` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `delivery_state_province` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `driver_notes` SET TAGS ('dbx_business_glossary_term' = 'Driver Notes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `estimated_service_time_minutes` SET TAGS ('dbx_business_glossary_term' = 'Estimated Service Time in Minutes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `planned_arrival_window_end` SET TAGS ('dbx_business_glossary_term' = 'Planned Arrival Window End');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `planned_arrival_window_start` SET TAGS ('dbx_business_glossary_term' = 'Planned Arrival Window Start');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_capture_method` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) Capture Method');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_capture_method` SET TAGS ('dbx_value_regex' = 'mobile_app|handheld_scanner|kiosk|web_portal|automated_system');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_capture_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) Capture Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_gps_latitude` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) GPS Latitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_gps_latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_gps_latitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_gps_longitude` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) GPS Longitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_gps_longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_gps_longitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_photo_image_url` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) Photo Image URL');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_pin_code` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) PIN Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_pin_code` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_signature_image_url` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) Signature Image URL');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_verification_status` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) Verification Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `pod_verification_status` SET TAGS ('dbx_value_regex' = 'verified|pending_verification|verification_failed|disputed|not_required');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_name` SET TAGS ('dbx_business_glossary_term' = 'Recipient Name');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_phone` SET TAGS ('dbx_business_glossary_term' = 'Recipient Phone Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_phone` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_phone` SET TAGS ('dbx_pii_phone' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `recipient_phone` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `stop_sequence_number` SET TAGS ('dbx_business_glossary_term' = 'Stop Sequence Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `stop_status` SET TAGS ('dbx_business_glossary_term' = 'Stop Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `stop_type` SET TAGS ('dbx_business_glossary_term' = 'Stop Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `stop_type` SET TAGS ('dbx_value_regex' = 'customer_delivery|bopis_pickup|ropis_pickup|return_pickup|dark_store_transfer');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`delivery_stop` ALTER COLUMN `vehicle_code` SET TAGS ('dbx_business_glossary_term' = 'Vehicle ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier` SET TAGS ('dbx_data_type' = 'master_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier` SET TAGS ('dbx_subdomain' = 'carrier_management');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier` ALTER COLUMN `certification_id` SET TAGS ('dbx_business_glossary_term' = 'Certification Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_service` SET TAGS ('dbx_subdomain' = 'carrier_management');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` SET TAGS ('dbx_subdomain' = 'warehouse_operations');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` SET TAGS ('dbx_ssot_authoritative_owner' = 'inventory.inventory_node');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` SET TAGS ('dbx_ssot_role' = 'non_authoritative');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` SET TAGS ('dbx_ssot_owner' = 'inventory.inventory_node');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` SET TAGS ('dbx_ssot_reference' = 'inventory.inventory_node');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` SET TAGS ('dbx_ssot_authoritative_source' = 'inventory.inventory_node');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` ALTER COLUMN `food_safety_plan_id` SET TAGS ('dbx_business_glossary_term' = 'Food Safety Plan Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`fulfillment_node` ALTER COLUMN `profit_center_id` SET TAGS ('dbx_business_glossary_term' = 'Profit Center Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`bopis_appointment` ALTER COLUMN `ar_invoice_id` SET TAGS ('dbx_business_glossary_term' = 'Ar Invoice Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`bopis_appointment` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Pickup Associate ID');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` SET TAGS ('dbx_subdomain' = 'order_execution');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_id` SET TAGS ('dbx_business_glossary_term' = 'Exception Identifier');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Exception Owner ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `cost_center_id` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `fulfillment_line_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Order Line ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `fulfillment_order_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Order ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `service_case_id` SET TAGS ('dbx_business_glossary_term' = 'Service Case Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_code` SET TAGS ('dbx_business_glossary_term' = 'Exception Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `corrective_action_plan` SET TAGS ('dbx_business_glossary_term' = 'Corrective Action Plan');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `customer_notification_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `customer_notified_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notified Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_description` SET TAGS ('dbx_business_glossary_term' = 'Exception Description');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `detected_at_stage` SET TAGS ('dbx_business_glossary_term' = 'Detected At Stage');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `escalation_level` SET TAGS ('dbx_business_glossary_term' = 'Escalation Level');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_number` SET TAGS ('dbx_business_glossary_term' = 'Exception Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_status` SET TAGS ('dbx_business_glossary_term' = 'Exception Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_status` SET TAGS ('dbx_value_regex' = 'open|in_progress|resolved|escalated|cancelled');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Exception Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `exception_type` SET TAGS ('dbx_business_glossary_term' = 'Exception Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `financial_impact_amount` SET TAGS ('dbx_business_glossary_term' = 'Financial Impact Amount');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `financial_impact_amount` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `owner_type` SET TAGS ('dbx_business_glossary_term' = 'Exception Owner Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `priority` SET TAGS ('dbx_business_glossary_term' = 'Priority');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `priority` SET TAGS ('dbx_value_regex' = 'critical|high|medium|low');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `quantity_affected` SET TAGS ('dbx_business_glossary_term' = 'Quantity Affected');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `resolution_action` SET TAGS ('dbx_business_glossary_term' = 'Resolution Action');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `resolution_duration_minutes` SET TAGS ('dbx_business_glossary_term' = 'Resolution Duration Minutes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `resolution_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Resolution Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `root_cause_category` SET TAGS ('dbx_business_glossary_term' = 'Root Cause Category');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `sku` SET TAGS ('dbx_business_glossary_term' = 'Stock Keeping Unit (SKU)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `sla_breach_flag` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Breach Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `sla_target_resolution_minutes` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Target Resolution Minutes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `tracking_number` SET TAGS ('dbx_business_glossary_term' = 'Tracking Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`exception` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` SET TAGS ('dbx_subdomain' = 'shipment_tracking');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `shipment_tracking_event_id` SET TAGS ('dbx_business_glossary_term' = 'Shipment Tracking Event ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `carrier_service_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Shipment ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `shipment_package_id` SET TAGS ('dbx_business_glossary_term' = 'Package ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `carrier_event_code` SET TAGS ('dbx_business_glossary_term' = 'Carrier Event Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `carrier_event_description` SET TAGS ('dbx_business_glossary_term' = 'Carrier Event Description');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `carrier_facility_code` SET TAGS ('dbx_business_glossary_term' = 'Carrier Facility Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `data_source_system` SET TAGS ('dbx_business_glossary_term' = 'Data Source System');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `data_source_type` SET TAGS ('dbx_business_glossary_term' = 'Data Source Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `data_source_type` SET TAGS ('dbx_value_regex' = 'carrier_api|edi_214|webhook|manual_entry|scrape');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `delivery_signature_name` SET TAGS ('dbx_business_glossary_term' = 'Delivery Signature Name');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `delivery_signature_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `delivery_signature_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `delivery_signature_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Delivery Signature Required Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `estimated_delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Estimated Delivery Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_city` SET TAGS ('dbx_business_glossary_term' = 'Event Location City');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_country_code` SET TAGS ('dbx_business_glossary_term' = 'Event Location Country Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Event Location Postal Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_postal_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_postal_code` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_location_state` SET TAGS ('dbx_business_glossary_term' = 'Event Location State or Province');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_sequence_number` SET TAGS ('dbx_business_glossary_term' = 'Event Sequence Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Event Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `event_type` SET TAGS ('dbx_business_glossary_term' = 'Tracking Event Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `exception_code` SET TAGS ('dbx_business_glossary_term' = 'Exception Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `exception_description` SET TAGS ('dbx_business_glossary_term' = 'Exception Description');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `latitude` SET TAGS ('dbx_business_glossary_term' = 'Event Location Latitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `latitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `latitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `longitude` SET TAGS ('dbx_business_glossary_term' = 'Event Location Longitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `longitude` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `longitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `notification_sent_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Sent Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `notification_sent_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Notification Sent Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `received_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Data Received Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `scan_type` SET TAGS ('dbx_business_glossary_term' = 'Scan Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `scan_type` SET TAGS ('dbx_value_regex' = 'automated|manual|mobile|rfid');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `source_record_reference` SET TAGS ('dbx_business_glossary_term' = 'Source System Record ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `tracking_number` SET TAGS ('dbx_business_glossary_term' = 'Carrier Tracking Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`shipment_tracking_event` ALTER COLUMN `weight_actual_kg` SET TAGS ('dbx_business_glossary_term' = 'Actual Weight in Kilograms');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` SET TAGS ('dbx_subdomain' = 'last_mile');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `sla_id` SET TAGS ('dbx_business_glossary_term' = 'Sla Identifier');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `carrier_service_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `fulfillment_node_id` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `category_id` SET TAGS ('dbx_business_glossary_term' = 'Product Category ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `applies_to_holidays` SET TAGS ('dbx_business_glossary_term' = 'Applies to Holidays Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `applies_to_weekdays` SET TAGS ('dbx_business_glossary_term' = 'Applies to Weekdays Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `applies_to_weekends` SET TAGS ('dbx_business_glossary_term' = 'Applies to Weekends Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `breach_threshold_hours` SET TAGS ('dbx_business_glossary_term' = 'Breach Threshold Hours');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `breach_threshold_percentage` SET TAGS ('dbx_business_glossary_term' = 'Breach Threshold Percentage');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `carrier_cutoff_time` SET TAGS ('dbx_business_glossary_term' = 'Carrier Cutoff Time');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `sla_code` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `sla_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9_-]{3,20}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `compliance_notes` SET TAGS ('dbx_business_glossary_term' = 'Compliance Notes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `country_code` SET TAGS ('dbx_business_glossary_term' = 'Country Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `effective_end_date` SET TAGS ('dbx_business_glossary_term' = 'Effective End Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `effective_start_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Start Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `escalation_rule` SET TAGS ('dbx_business_glossary_term' = 'Escalation Rule');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `excluded_dates` SET TAGS ('dbx_business_glossary_term' = 'Excluded Dates');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `fulfillment_method` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Method');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `geographic_scope` SET TAGS ('dbx_business_glossary_term' = 'Geographic Scope');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `geographic_scope` SET TAGS ('dbx_value_regex' = 'GLOBAL|NATIONAL|REGIONAL|LOCAL');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `is_active` SET TAGS ('dbx_business_glossary_term' = 'Is Active Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `loyalty_tier` SET TAGS ('dbx_business_glossary_term' = 'Loyalty Tier');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `sla_name` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Name');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `sla_name` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `node_type` SET TAGS ('dbx_business_glossary_term' = 'Fulfillment Node Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `node_type` SET TAGS ('dbx_value_regex' = 'STORE|DC|DARK_STORE|MFC|VENDOR|3PL');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `order_channel` SET TAGS ('dbx_business_glossary_term' = 'Order Channel');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `order_channel` SET TAGS ('dbx_value_regex' = 'WEB|MOBILE_APP|IN_STORE|CALL_CENTER|MARKETPLACE|SOCIAL_COMMERCE');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `order_cutoff_time` SET TAGS ('dbx_business_glossary_term' = 'Order Cutoff Time');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `order_value_max` SET TAGS ('dbx_business_glossary_term' = 'Maximum Order Value');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `order_value_min` SET TAGS ('dbx_business_glossary_term' = 'Minimum Order Value');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `postal_code_pattern` SET TAGS ('dbx_business_glossary_term' = 'Postal Code Pattern');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `postal_code_pattern` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `postal_code_pattern` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `priority_level` SET TAGS ('dbx_business_glossary_term' = 'Priority Level');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `priority_level` SET TAGS ('dbx_value_regex' = 'CRITICAL|HIGH|MEDIUM|LOW');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `promised_hours_to_deliver` SET TAGS ('dbx_business_glossary_term' = 'Promised Hours to Deliver');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `promised_hours_to_ready` SET TAGS ('dbx_business_glossary_term' = 'Promised Hours to Ready');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `promised_hours_to_ship` SET TAGS ('dbx_business_glossary_term' = 'Promised Hours to Ship');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `region_code` SET TAGS ('dbx_business_glossary_term' = 'Region Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `sla_type` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `updated_by` SET TAGS ('dbx_business_glossary_term' = 'Updated By User');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`sla` ALTER COLUMN `updated_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Updated Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` SET TAGS ('dbx_data_type' = 'reference_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` SET TAGS ('dbx_subdomain' = 'carrier_management');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `carrier_rate_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Rate ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `carrier_service_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Service Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `base_rate_amount` SET TAGS ('dbx_business_glossary_term' = 'Base Rate Amount');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `contract_number` SET TAGS ('dbx_business_glossary_term' = 'Contract Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `contract_number` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `currency_code` SET TAGS ('dbx_business_glossary_term' = 'Currency Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `currency_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `destination_country_code` SET TAGS ('dbx_business_glossary_term' = 'Destination Country Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `destination_country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `destination_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Destination Postal Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `destination_postal_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `destination_postal_code` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `dimensional_weight_factor` SET TAGS ('dbx_business_glossary_term' = 'Dimensional Weight Factor');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Effective Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Expiry Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `extended_area_surcharge` SET TAGS ('dbx_business_glossary_term' = 'Extended Area Surcharge');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `fuel_surcharge_rate` SET TAGS ('dbx_business_glossary_term' = 'Fuel Surcharge Rate');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `is_hazmat_eligible` SET TAGS ('dbx_business_glossary_term' = 'Is Hazardous Materials (HAZMAT) Eligible');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `is_international` SET TAGS ('dbx_business_glossary_term' = 'Is International');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `minimum_charge_amount` SET TAGS ('dbx_business_glossary_term' = 'Minimum Charge Amount');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `negotiated_discount_percentage` SET TAGS ('dbx_business_glossary_term' = 'Negotiated Discount Percentage');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `negotiated_discount_percentage` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `notes` SET TAGS ('dbx_business_glossary_term' = 'Notes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `origin_country_code` SET TAGS ('dbx_business_glossary_term' = 'Origin Country Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `origin_country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `origin_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Origin Postal Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `origin_postal_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `origin_postal_code` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `oversized_package_surcharge` SET TAGS ('dbx_business_glossary_term' = 'Oversized Package Surcharge');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_per_kg` SET TAGS ('dbx_business_glossary_term' = 'Rate Per Kilogram');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_source` SET TAGS ('dbx_business_glossary_term' = 'Rate Source');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_source` SET TAGS ('dbx_value_regex' = 'carrier_api|manual_entry|contract_upload|rate_shop|third_party');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_status` SET TAGS ('dbx_business_glossary_term' = 'Rate Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_status` SET TAGS ('dbx_value_regex' = 'active|inactive|pending|expired|suspended');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_type` SET TAGS ('dbx_business_glossary_term' = 'Rate Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_type` SET TAGS ('dbx_value_regex' = 'base|negotiated|published|spot|contract');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_version` SET TAGS ('dbx_business_glossary_term' = 'Rate Version');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `rate_zone` SET TAGS ('dbx_business_glossary_term' = 'Rate Zone');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `residential_delivery_surcharge` SET TAGS ('dbx_business_glossary_term' = 'Residential Delivery Surcharge');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `saturday_delivery_surcharge` SET TAGS ('dbx_business_glossary_term' = 'Saturday Delivery Surcharge');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `service_level` SET TAGS ('dbx_business_glossary_term' = 'Service Level');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `signature_required_surcharge` SET TAGS ('dbx_business_glossary_term' = 'Signature Required Surcharge');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `transit_days` SET TAGS ('dbx_business_glossary_term' = 'Transit Days');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `weight_break_max_kg` SET TAGS ('dbx_business_glossary_term' = 'Weight Break Maximum (kg)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_rate` ALTER COLUMN `weight_break_min_kg` SET TAGS ('dbx_business_glossary_term' = 'Weight Break Minimum (kg)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `buyer_id` SET TAGS ('dbx_business_glossary_term' = 'Buyer Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `third_party_assessment_id` SET TAGS ('dbx_business_glossary_term' = 'Third Party Assessment Id (Foreign Key)');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line1` SET TAGS ('dbx_business_glossary_term' = 'Ship To Address Line 1');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line1` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line1` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line1` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line2` SET TAGS ('dbx_business_glossary_term' = 'Ship To Address Line 2');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line2` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line2` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_address_line2` SET TAGS ('dbx_sensitivity' = 'pii');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_city` SET TAGS ('dbx_business_glossary_term' = 'Ship To City');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_city` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_city` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_country_code` SET TAGS ('dbx_business_glossary_term' = 'Ship To Country Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_country_code` SET TAGS ('dbx_value_regex' = '^[A-Z]{3}$');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_postal_code` SET TAGS ('dbx_business_glossary_term' = 'Ship To Postal Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_postal_code` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_postal_code` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_state_province` SET TAGS ('dbx_business_glossary_term' = 'Ship To State or Province');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_state_province` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `ship_to_state_province` SET TAGS ('dbx_pii_address' = 'true');
...
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`drop_ship_order` ALTER COLUMN `vendor_tracking_number` SET TAGS ('dbx_business_glossary_term' = 'Vendor Tracking Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` SET TAGS ('dbx_data_type' = 'transactional_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` SET TAGS ('dbx_subdomain' = 'shipment_tracking');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `proof_of_delivery_id` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `associate_id` SET TAGS ('dbx_business_glossary_term' = 'Driver ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `header_id` SET TAGS ('dbx_business_glossary_term' = 'Order ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `outbound_shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Distribution Shipment Id (Foreign Key)');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `shipment_id` SET TAGS ('dbx_business_glossary_term' = 'Shipment ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `age_verification_completed_flag` SET TAGS ('dbx_business_glossary_term' = 'Age Verification Completed Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `age_verification_required_flag` SET TAGS ('dbx_business_glossary_term' = 'Age Verification Required Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `created_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Created Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `customer_notified_flag` SET TAGS ('dbx_business_glossary_term' = 'Customer Notified Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_date` SET TAGS ('dbx_business_glossary_term' = 'Delivery Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_exception_code` SET TAGS ('dbx_business_glossary_term' = 'Delivery Exception Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_instructions_followed_flag` SET TAGS ('dbx_business_glossary_term' = 'Delivery Instructions Followed Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_latitude` SET TAGS ('dbx_business_glossary_term' = 'Delivery Location Latitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_latitude` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_latitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_location_type` SET TAGS ('dbx_business_glossary_term' = 'Delivery Location Type');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_longitude` SET TAGS ('dbx_business_glossary_term' = 'Delivery Location Longitude');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_longitude` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_longitude` SET TAGS ('dbx_pii_address' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_notes` SET TAGS ('dbx_business_glossary_term' = 'Delivery Notes');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_photo_url` SET TAGS ('dbx_business_glossary_term' = 'Delivery Photo URL');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_photo_url` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_status` SET TAGS ('dbx_business_glossary_term' = 'Delivery Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_status` SET TAGS ('dbx_value_regex' = 'delivered|partial_delivery|refused|undeliverable|returned|damaged');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_stop_reference` SET TAGS ('dbx_business_glossary_term' = 'Delivery Stop Reference Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `delivery_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Actual Delivery Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `dispute_filed_flag` SET TAGS ('dbx_business_glossary_term' = 'Delivery Dispute Filed Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `dispute_resolution_status` SET TAGS ('dbx_business_glossary_term' = 'Dispute Resolution Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `dispute_resolution_status` SET TAGS ('dbx_value_regex' = 'open|under_review|resolved_customer_favor|resolved_carrier_favor|closed');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `gps_accuracy_meters` SET TAGS ('dbx_business_glossary_term' = 'GPS Accuracy in Meters');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `id_verification_method` SET TAGS ('dbx_business_glossary_term' = 'Identification Verification Method');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `id_verification_method` SET TAGS ('dbx_value_regex' = 'drivers_license|passport|government_id|digital_id|none');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `modified_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Record Modified Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `notification_channel` SET TAGS ('dbx_business_glossary_term' = 'Notification Channel');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `notification_channel` SET TAGS ('dbx_value_regex' = 'sms|email|push_notification|in_app|voice_call');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `notification_timestamp` SET TAGS ('dbx_business_glossary_term' = 'Customer Notification Timestamp');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `package_condition` SET TAGS ('dbx_business_glossary_term' = 'Package Condition at Delivery');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `package_condition` SET TAGS ('dbx_value_regex' = 'intact|damaged|opened|wet|crushed|other');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `pin_confirmation_code` SET TAGS ('dbx_business_glossary_term' = 'PIN Confirmation Code');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `pin_confirmation_code` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `pod_capture_method` SET TAGS ('dbx_business_glossary_term' = 'Proof of Delivery (POD) Capture Method');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `pod_capture_method` SET TAGS ('dbx_value_regex' = 'mobile_app|handheld_scanner|tablet|kiosk|web_portal|manual_entry');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `recipient_name` SET TAGS ('dbx_business_glossary_term' = 'Recipient Full Name');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `recipient_name` SET TAGS ('dbx_restricted' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `recipient_name` SET TAGS ('dbx_pii_name' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `recipient_relationship` SET TAGS ('dbx_business_glossary_term' = 'Recipient Relationship to Customer');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `signature_captured_flag` SET TAGS ('dbx_business_glossary_term' = 'Signature Captured Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `signature_image_url` SET TAGS ('dbx_business_glossary_term' = 'Signature Image URL');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `signature_image_url` SET TAGS ('dbx_confidential' = 'true');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `sla_met_flag` SET TAGS ('dbx_business_glossary_term' = 'Service Level Agreement (SLA) Met Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `temperature_at_delivery_celsius` SET TAGS ('dbx_business_glossary_term' = 'Temperature at Delivery in Celsius');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `temperature_compliant_flag` SET TAGS ('dbx_business_glossary_term' = 'Temperature Compliance Flag');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`proof_of_delivery` ALTER COLUMN `tracking_number` SET TAGS ('dbx_business_glossary_term' = 'Carrier Tracking Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` SET TAGS ('dbx_data_type' = 'association_data');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` SET TAGS ('dbx_subdomain' = 'carrier_management');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` SET TAGS ('dbx_association_edges' = 'fulfillment.carrier,supplychain.dc_facility');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `carrier_facility_contract_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Facility Contract ID');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `dc_facility_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Facility Contract - Dc Facility Id');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `carrier_id` SET TAGS ('dbx_business_glossary_term' = 'Carrier Facility Contract - Fulfillment Carrier Id');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `assigned_dock_doors` SET TAGS ('dbx_business_glossary_term' = 'Assigned Dock Doors');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `contract_number` SET TAGS ('dbx_business_glossary_term' = 'Contract Number');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `contract_status` SET TAGS ('dbx_business_glossary_term' = 'Contract Status');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `created_date` SET TAGS ('dbx_business_glossary_term' = 'Record Created Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `daily_pickup_schedule` SET TAGS ('dbx_business_glossary_term' = 'Daily Pickup Schedule');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `effective_date` SET TAGS ('dbx_business_glossary_term' = 'Contract Effective Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `expiry_date` SET TAGS ('dbx_business_glossary_term' = 'Contract Expiry Date');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `facility_discount_percentage` SET TAGS ('dbx_business_glossary_term' = 'Facility Volume Discount');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `facility_specific_base_rate` SET TAGS ('dbx_business_glossary_term' = 'Facility-Specific Base Rate');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `max_daily_volume_packages` SET TAGS ('dbx_business_glossary_term' = 'Maximum Daily Package Volume');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `priority_rank` SET TAGS ('dbx_business_glossary_term' = 'Carrier Priority Rank');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `rate_tier` SET TAGS ('dbx_business_glossary_term' = 'Facility Rate Tier');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `service_levels_enabled` SET TAGS ('dbx_business_glossary_term' = 'Enabled Service Levels');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `sla_on_time_percentage` SET TAGS ('dbx_business_glossary_term' = 'On-Time Delivery SLA');
ALTER TABLE `vibe_retail_v1`.`fulfillment`.`carrier_facility_contract` ALTER COLUMN `updated_date` SET TAGS ('dbx_business_glossary_term' = 'Record Updated Date');
