...
-- Generated on: 2026-07-10 13:03:44
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`marketing`.`influencer` (
    ...
    `tier` STRING COMMENT 'Classification tier based on follower count: Nano (<10K), Micro (10K-100K), Macro (100K-1M), Mega (1M+), Celebrity (established public figure).. Valid values are `Nano|Micro|Macro|Mega|Celebrity`',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`marketing`.`consumer_segment` (
    ...
    `marketing_brand_id` BIGINT COMMENT 'add column marketing_brand_id (BIGINT) with FK to marketing.marketing_brand.marketing_brand_id - consumer segments are typically brand-specific in CPG marketing',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`marketing`.`agency` (
    ...
    `supplier_id` BIGINT COMMENT 'add column supplier_id (BIGINT) with FK to procurement.supplier.supplier_id - agencies are external vendors and should link to supplier master for contract and payment management',
...
CREATE OR REPLACE TABLE `vibe_consumer_goods_v1`.`marketing`.`event_participation` (
    ...
    `trade_account_id` BIGINT COMMENT 'add column trade_account_id (BIGINT) with FK to sales.trade_account.trade_account_id - event participation in CPG often involves trade accounts/retailers',
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_brand` ALTER COLUMN `esg_commitment_id` SET TAGS ('dbx_business_glossary_term' = 'Esg Commitment Id (Foreign Key)');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`media_plan` ALTER COLUMN `agency_name` SET TAGS ('dbx_business_glossary_term' = 'Agency Name');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`creative_asset` SET TAGS ('dbx_subdomain' = 'brand_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`influencer` ALTER COLUMN `tier` SET TAGS ('dbx_business_glossary_term' = 'Influencer Tier Classification');
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`influencer` ALTER COLUMN `tier` SET TAGS ('dbx_value_regex' = 'Nano|Micro|Macro|Mega|Celebrity');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`brand_health_tracker` SET TAGS ('dbx_subdomain' = 'brand_management');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`agency` SET TAGS ('dbx_subdomain' = 'partner_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_budget` ALTER COLUMN `budget_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{6,20}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_budget` ALTER COLUMN `budget_status` SET TAGS ('dbx_value_regex' = 'draft|submitted|approved|active|frozen|closed');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_budget` ALTER COLUMN `budget_type` SET TAGS ('dbx_value_regex' = 'annual|quarterly|campaign|project|tactical|strategic');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_budget` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_business_glossary_term' = 'Cost Center Code');
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_budget` ALTER COLUMN `cost_center_code` SET TAGS ('dbx_value_regex' = '^[A-Z0-9]{4,12}$');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`sponsorship` SET TAGS ('dbx_subdomain' = 'partner_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_event` SET TAGS ('dbx_subdomain' = 'partner_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`marketing_offset_allocation` SET TAGS ('dbx_subdomain' = 'partner_engagement');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`campaign_assignment` ALTER COLUMN `employee_id` SET TAGS ('dbx_business_glossary_term' = 'Campaign Assignment - Employee Id');
...
ALTER TABLE `vibe_consumer_goods_v1`.`marketing`.`event_participation` SET TAGS ('dbx_subdomain' = 'partner_engagement');
